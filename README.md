...
1. **[everything-claude-code](https://github.com/affaan-m/everything-claude-code)** - ⭐ 157,641
   The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.

2. **[dify](https://github.com/langgenius/dify)** - ⭐ 137,937
   Production-ready platform for agentic workflow development.

3. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 132,087
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

4. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 101,391
   An open-source AI agent that brings the power of Gemini directly into your terminal.

5. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 84,850
   A collection of MCP servers.

6. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 83,829
   Model Context Protocol Servers

7. **[netdata](https://github.com/netdata/netdata)** - ⭐ 78,469
   The fastest path to AI-powered full stack observability, even for lean teams.

8. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 78,198
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

9. **[lobehub](https://github.com/lobehub/lobehub)** - ⭐ 75,236
...
11. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 58,395
   The all-in-one AI productivity accelerator. On device and privacy first with no annoying setup or configuration.

12. **[awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)** - ⭐ 54,093
   A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows

13. **[context7](https://github.com/upstash/context7)** - ⭐ 52,823
   Context7 Platform -- Up-to-date code documentation for LLMs and AI code editors

14. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 51,708
   ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS, and smart alerts.🎯 告别信息过载，你的 AI 舆情监控助手与热点筛选工具！聚合多平台热点 +  RSS 订阅，支持关键词精准筛选。AI 智能筛选新闻 + AI 翻译 +  AI 分析简报直推手机，也支持接入 MCP 架构，赋能 AI 自然语言对话分析、情感洞察与趋势预测等。支持 Docker ，数据本地/云端自持。集成微信/飞书/钉钉/Telegram/邮件/ntfy/bark/slack 等渠道智能推送。

15. **[mempalace](https://github.com/MemPalace/mempalace)** - ⭐ 46,671
   The best-benchmarked open-source AI memory system. And it's free.

16. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 45,857
...
17. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 45,477
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex, OpenCode, openclaw & Gemini CLI.

18. **[mempalace](https://github.com/milla-jovovich/mempalace)** - ⭐ 40,200
   The highest-scoring AI memory system ever benchmarked. And it's free.

19. **[cherry-studio](https://github.com/CherryHQ/cherry-studio)** - ⭐ 37,347
...
20. **[goose](https://github.com/block/goose)** - ⭐ 37,288
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

21. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 37,265
   🕷️ An adaptive Web Scraping framework that handles everything from a single request to a full-scale crawl!

22. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 35,653
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

23. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 35,311
   Chrome DevTools for coding agents

24. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 33,579
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

25. **[antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills)** - ⭐ 33,292
   Installable GitHub library of 1,400+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and more. Includes installer CLI, bundles, workflows, and official/community skill collections.

26. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 33,116
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

27. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 33,113
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

28. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,848
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

29. **[ruflo](https://github.com/ruvnet/ruflo)** - ⭐ 32,009
   🌊 The leading agent orchestration platform for Claude. Deploy intelligent multi-agent swarms, coordinate autonomous workflows, and build conversational AI systems. Features    enterprise-grade architecture, distributed swarm intelligence, RAG integration, and native Claude Code / Codex Integration

30. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 30,918
   Playwright MCP server

31. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 30,053
   AI Agent Assistant that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨

32. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 29,419
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

33. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 28,891
   GitHub's official MCP Server

34. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 27,794
   Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed workbench to help you build AI agents that turn intent into action.

35. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 26,474
   An autonomous agent that conducts deep research on any data using any LLM providers

36. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 25,690
   An MCP-based chatbot | 一个基于MCP的聊天机器人

37. **[gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin)** - ⭐ 24,578
...
38. **[fastmcp](https://github.com/PrefectHQ/fastmcp)** - ⭐ 24,567
   🚀 The fast, Pythonic way to build MCP servers and clients.

39. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 23,824
   Build and run agents you can see, understand and trust.

40. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 23,574
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

41. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 23,039
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

42. **[serena](https://github.com/oraios/serena)** - ⭐ 23,008
   A powerful MCP toolkit for coding, providing semantic retrieval and editing capabilities  - the IDE for your agent

43. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 22,902
   🚀 The fast, Pythonic way to build MCP servers and clients

44. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 22,649
   The official Python SDK for Model Context Protocol servers and clients

45. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 21,727
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

46. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 20,734
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

47. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 19,818

48. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 18,212
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

49. **[Agent-Reach](https://github.com/Panniantong/Agent-Reach)** - ⭐ 17,532
   Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.

50. **[nuclear](https://github.com/nukeop/nuclear)** - ⭐ 17,230
   Streaming music player that finds free music for you

51. **[page-agent](https://github.com/alibaba/page-agent)** - ⭐ 17,065
   JavaScript in-page GUI agent. Control web interfaces with natural language.

52. **[claude-plugins-official](https://github.com/anthropics/claude-plugins-official)** - ⭐ 17,047
   Official, Anthropic-managed directory of high quality Claude Code Plugins.

53. **[openfang](https://github.com/RightNow-AI/openfang)** - ⭐ 16,657
   Open-source Agent Operating System

54. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 16,015
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

55. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 15,880
...
57. **[mcp-toolbox](https://github.com/googleapis/mcp-toolbox)** - ⭐ 14,603
   MCP Toolbox for Databases is an open source MCP server for databases.

58. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 14,559
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

59. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 14,374
   MCP server to provide Figma layout information to AI coding agents like Cursor

60. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 13,975
   MCP Toolbox for Databases is an open source MCP server for databases.

61. **[electerm](https://github.com/electerm/electerm)** - ⭐ 13,900
   📻Terminal/ssh/sftp/ftp/telnet/serialport/RDP/VNC/Spice client(linux, mac, win)

62. **[filestash](https://github.com/mickael-kerjean/filestash)** - ⭐ 13,423
   :file_folder: What Dropbox should have been if it was based on SFTP, S3, FTP, SMB, NFS, WebDAV, Git, and more

63. **[casdoor](https://github.com/casdoor/casdoor)** - ⭐ 13,370
   An open-source Agent-first Identity and Access Management (IAM) /LLM MCP & agent gateway and auth server with web UI supporting OpenClaw, MCP, OAuth, OIDC, SAML, CAS, LDAP, SCIM, WebAuthn, TOTP, MFA, Face ID, Google Workspace, Azure AD

64. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 13,355
   Memory for 24/7 proactive agents like openclaw (moltbot, clawdbot).

65. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 12,868
   MCP for xiaohongshu.com

66. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 12,826
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

67. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 12,189
   The official TypeScript SDK for Model Context Protocol servers and clients

68. **[kubeshark](https://github.com/kubeshark/kubeshark)** - ⭐ 11,871
   eBPF-powered network observability for Kubernetes. Indexes L4/L7 traffic with full K8s context, decrypts TLS without keys. Queryable by AI agents via MCP and humans via dashboard.

69. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,807
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

70. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 11,432
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

71. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 11,335
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

72. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 11,226
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

73. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 11,009
   Yet another WebUI for Nginx

74. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 10,809
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书作品文件

75. **[code-review-graph](https://github.com/tirth8205/code-review-graph)** - ⭐ 10,364
   Local knowledge graph for Claude Code. Builds a persistent map of your codebase so Claude reads only what matters — 6.8× fewer tokens on reviews and up to 49× on daily coding tasks.

76. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 10,105
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

77. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

78. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 9,775
   The fullstack MCP framework to develop MCP Apps for ChatGPT / Claude & MCP Servers for AI Agents.

79. **[superset](https://github.com/superset-sh/superset)** - ⭐ 9,650
   Code Editor for the AI Agents Era - Run an army of Claude Code, Codex, etc. on your machine

80. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 9,461
   Visual testing tool for MCP servers

81. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 9,276
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

82. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 8,782
   Official MCP Servers for AWS

83. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 8,591
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

84. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 8,534
   Unity MCP acts as a bridge, allowing AI assistants (like Claude, Cursor) to interact directly with your Unity Editor via a local MCP (Model Context Protocol) Client. Give your LLM tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

85. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 8,409
   MCP Server for Ghidra

86. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 8,269
   Build effective agents using Model Context Protocol and simple workflow patterns

87. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 8,131
   AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework

88. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 8,107
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

89. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 8,092
   🧑‍🚀 全世界最好的LLM资料总结（多模态生成、Agent、辅助编程、AI审稿、数据处理、模型训练、模型推理、o1 模型、MCP、小语言模型、视觉语言模型） | Summary of the world's best LLM resources. 

90. **[webiny-js](https://github.com/webiny/webiny-js)** - ⭐ 7,961
   Open-source, self-hosted CMS platform on AWS serverless (Lambda, DynamoDB, S3). TypeScript framework with multi-tenancy, lifecycle hooks, GraphQL API, and AI-assisted development via MCP server. Built for developers at large organizations.

91. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,925
   Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project

92. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 7,566
...
93. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 7,487
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

94. **[context-mode](https://github.com/mksglu/context-mode)** - ⭐ 7,329
   Context window optimization for AI coding agents. Sandboxes tool output, 98% reduction. 12 platforms

95. **[oh-my-opencode](https://github.com/code-yeongyu/oh-my-opencode)** - ⭐ 7,289
...
96. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 7,194
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

97. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 6,877
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

98. **[Auto-claude-code-research-in-sleep](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep)** - ⭐ 6,759
   ARIS ⚔️ (Auto-Research-In-Sleep) — Lightweight Markdown-only skills for autonomous ML research: cross-model review loops, idea discovery, and experiment automation. No framework, no lock-in — works with Claude Code, Codex, OpenClaw, or any LLM agent.

99. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,682
   A community driven registry service for Model Context Protocol (MCP) servers.

100. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 6,656
   TalkToFigma: MCP integration between AI Agent (Cursor, Claude Code) and Figma, allowing Agentic AI to communicate with Figma for reading designs and modifying them programmatically.

101. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,386
   A collection of MCP clients.

102. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 6,350
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

103. **[refly](https://github.com/refly-ai/refly)** - ⭐ 6,135
   The first open-source agent skills builder. 🦞

104. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 6,124
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

105. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 6,068
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

106. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 5,938
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

107. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,902
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

108. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 5,817
   Context-aware AI assistant for your desktop. Ready to respond intelligently, seamlessly integrating multiple LLMs and MCP tools.

109. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,709
   Klavis AI:  MCP integration platforms that let AI agents use tools reliably at any scale

110. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 5,634
   A model-driven approach to building AI agents in just a few lines of code.

111. **[jscpd](https://github.com/kucherenko/jscpd)** - ⭐ 5,521
   Copy/paste detector for programming source code. 

112. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,510
   WhatsApp MCP server

113. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 5,490
   A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines

114. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,436
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

115. **[microsandbox](https://github.com/superradcompany/microsandbox)** - ⭐ 5,404
   🧱 secure, local, cross-platform and programmable sandboxes for AI agents

116. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,396
   Awesome MCP Servers - A curated list of Model Context Protocol servers

117. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 5,351
   Learn AI and LLMs from scratch using free resources

118. **[CodePilot](https://github.com/op7418/CodePilot)** - ⭐ 5,286
...
119. **[XcodeBuildMCP](https://github.com/getsentry/XcodeBuildMCP)** - ⭐ 5,216
   A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.

120. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 5,174
   opensource secure local-first sandboxes for ai agents

121. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 5,158
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

122. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 5,118
   MCP Server for Computer Use in Windows

123. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 4,999
   Install, run and deploy your own decentralized AI agent service

124. **[osaurus](https://github.com/osaurus-ai/osaurus)** - ⭐ 4,957
   Own your AI. The native macOS harness for AI agents -- any model, persistent memory, autonomous execution, cryptographic identity. Built in Swift. Fully offline. Open source.

125. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 4,943
   MCP server for Atlassian tools (Confluence, Jira)

126. **[unidbg](https://github.com/zhkl0228/unidbg)** - ⭐ 4,911
   Allows you to emulate an Android native library, and an experimental  iOS emulation

127. **[aci](https://github.com/aipotheosis-labs/aci)** - ⭐ 4,755
   ACI.dev is the open source tool-calling platform that hooks up 600+ tools into any agentic IDE or custom AI agent through direct function calling or a unified MCP server. The birthplace of VibeOps.

128. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,752
   Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset management, MCP, and more.

129. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,721
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

130. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 4,637
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

131. **[bb-browser](https://github.com/epiral/bb-browser)** - ⭐ 4,578
   Your browser is the API. CLI + MCP server for AI agents to control Chrome with your login state.

132. **[deep-research](https://github.com/u14app/deep-research)** - ⭐ 4,558
   Use any LLMs (Large Language Models) for Deep Research. Support SSE API and MCP server.

133. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 4,555
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

134. **[byterover-cli](https://github.com/campfirein/byterover-cli)** - ⭐ 4,533
   ByteRover CLI (brv) - The portable memory layer for  autonomous coding agents (formerly Cipher)

135. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,495
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

136. **[Anthropic-Cybersecurity-Skills](https://github.com/mukul975/Anthropic-Cybersecurity-Skills)** - ⭐ 4,456
   754 structured cybersecurity skills for AI agents · Mapped to 5 frameworks: MITRE ATT&CK, NIST CSF 2.0, MITRE ATLAS, D3FEND & NIST AI RMF · agentskills.io standard · Works with Claude Code, GitHub Copilot, Codex CLI, Cursor, Gemini CLI & 20+ platforms · 26 security domains · Apache 2.0

137. **[claude-seo](https://github.com/AgriciDaniel/claude-seo)** - ⭐ 4,396
   Universal SEO skill for Claude Code. 19 sub-skills, 12 subagents, 3 extensions (DataForSEO, Firecrawl, Banana). Technical SEO, E-E-A-T, schema, GEO/AEO, backlinks, local SEO, maps intelligence, Google APIs, and PDF/Excel reporting.

138. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 4,366
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

139. **[Olares](https://github.com/beclab/Olares)** - ⭐ 4,353
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

140. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 4,286
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

141. **[httprunner](https://github.com/httprunner/httprunner)** - ⭐ 4,267
   HttpRunner 是一款开源的 API/UI 测试框架，简单易用，功能强大，具有丰富的插件化机制和高度的可扩展能力。

142. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 4,251
   Exa MCP for web search and web crawling!

143. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 4,219
   Official Notion MCP Server

144. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 4,199
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

145. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 4,145
   A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.

146. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 4,137
   A simple, secure MCP-to-OpenAPI proxy server

147. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 4,126
   A Model Context Protocol (MCP) server that provides structured spec-driven development workflow tools for AI-assisted software development, featuring a real-time web dashboard and VSCode extension for monitoring and managing your project's progress directly in your development environment.

148. **[mission-control](https://github.com/builderz-labs/mission-control)** - ⭐ 4,114
   Self-hosted AI agent orchestration platform: dispatch tasks, run multi-agent workflows, monitor spend, and govern operations from one mission control dashboard.

149. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 4,088
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

150. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 4,058
   An Agentic Framework for Reflective PowerPoint Generation

151. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 4,026
   Tutorials, Guides and Agent Skills Directories

152. **[EverOS](https://github.com/EverMind-AI/EverOS)** - ⭐ 4,005
   Build, evaluate, and integrate long-term memory for self-evolving agents.

153. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 3,998
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

154. **[excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp)** - ⭐ 3,987
   Fast and streamable Excalidraw MCP App

155. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,966
   🤖 A visualization mcp & skills contains 25+ visual charts using @antvis. Using for chart generation and data analysis.

156. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 3,957
...
157. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 3,947
   RikkaHub is an Android APP that supports for multiple LLM providers.

158. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 3,936
   Claude Code Guide - Setup, Commands, workflows, agents, skills & tips-n-tricks go from beginner to power user!

159. **[directories](https://github.com/leerob/directories)** - ⭐ 3,915
   Find rules and MCP servers

160. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,906
   A curated list of Model Context Protocol (MCP) servers

161. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,896
   The Cursor & Windsurf community, find rules and MCPs

162. **[mcp](https://github.com/google/mcp)** - ⭐ 3,883
   Google 💚 MCP

163. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,861
   🔍 导出并模糊搜索 Telegram 聊天记录 | Export and fuzzy search your Telegram chat history

164. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 3,826
   Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

165. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,768
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP, and Chatwoot. Built with Golang for efficient memory use. 

166. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,764
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

167. **[atmosphere](https://github.com/Atmosphere/atmosphere)** - ⭐ 3,751
...
168. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,744
   Code, Build and Evaluate agents - excellent Model and Skills/MCP/ACP Support

169. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,734
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

170. **[MemOS](https://github.com/MemTensor/MemOS)** - ⭐ 3,710
...
171. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,701
   A Model Context Protocol server for Excel file manipulation

172. **[Continuous-Claude-v3](https://github.com/parcadei/Continuous-Claude-v3)** - ⭐ 3,694
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

173. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,637
...
174. **[core](https://github.com/opensumi/core)** - ⭐ 3,624
   A framework helps you quickly build AI Native IDE products. MCP Client, supports Model Context Protocol (MCP) tools via MCP server.

175. **[notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli)** - ⭐ 3,618

176. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,612

177. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,575
   An AI Gateway, registry, and proxy that sits in front of any MCP, A2A, or REST/gRPC APIs, exposing a unified endpoint with centralized discovery, guardrails and management. Optimizes Agent & Tool calling, and supports plugins.

178. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 3,575
   Enterprise AI Platform with guardrails, MCP registry, gateway & orchestrator

179. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 3,554
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

180. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 3,548
...
181. **[EverMemOS](https://github.com/EverMind-AI/EverMemOS)** - ⭐ 3,546
   A memory OS that makes your OpenClaw agents more personal while saving tokens.

182. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,486
   LangChain 🔌 MCP

183. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 3,465
   A full-stack AI Red Teaming platform securing AI ecosystems via OpenClaw Security Scan, Agent Scan, Skills Scan, MCP scan, AI Infra scan and LLM jailbreak evaluation.

184. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,456
   Model Context Protocol(MCP) 编程极速入门

185. **[AionUi](https://github.com/iOfficeAI/AionUi)** - ⭐ 3,452
...
186. **[boost](https://github.com/laravel/boost)** - ⭐ 3,409
   Laravel-focused MCP server for augmenting your AI powered local development experience.

187. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 3,377
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

188. **[claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar)** - ⭐ 3,377
...
189. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 3,371
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

190. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 3,371
...
191. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,362
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

192. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,317
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

193. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 3,312
   CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security tools, an intelligent orchestration engine, role-based testing with predefined security roles, a skills system with specialized testing skills, and comprehensive lifecycle management capabilities.

194. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 3,307
   The official Rust SDK for the Model Context Protocol

195. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,273
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

196. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,258
   Allow LLMs to control a browser with Browserbase and Stagehand

197. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,248
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

198. **[SimpleMem](https://github.com/aiming-lab/SimpleMem)** - ⭐ 3,232
   SimpleMem: Efficient Lifelong Memory for LLM Agents — Text & Multimodal

199. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 3,131
   An event-driven framework designed to build and orchestrate multi-agent AI systems. It enables seamless integration of AI agents with real-world data sources and systems, facilitating complex, multi-step workflows.

200. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 3,125
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

201. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 3,082
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

202. **[oh-my-pi](https://github.com/can1357/oh-my-pi)** - ⭐ 3,049
   ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more

203. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 3,041
   A TypeScript framework for building MCP servers.

204. **[Generative-Media-Skills](https://github.com/SamurAIGPT/Generative-Media-Skills)** - ⭐ 3,028
   Multi-modal Generative Media Skills for AI Agents (Claude Code, Cursor, Gemini CLI). High-quality image, video, and audio generation powered by muapi.ai.

205. **[core](https://github.com/cheshire-cat-ai/core)** - ⭐ 3,022
   AI agent microservice

206. **[n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp)** - ⭐ 3,004
   n8n custom node for MCP

207. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,971
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

208. **[CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext)** - ⭐ 2,970
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

209. **[drawio-mcp](https://github.com/jgraph/drawio-mcp)** - ⭐ 2,954

210. **[awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents)** - ⭐ 2,918
   162 production-ready AI agent templates for OpenClaw. SOUL.md configs across 19 categories. Submit yours!

211. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,868
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

212. **[ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch)** - ⭐ 2,850
   Learn it. Build it. Ship it for others.

213. **[harbor](https://github.com/av/harbor)** - ⭐ 2,832
   One command brings a complete pre-wired LLM stack with hundreds of services to explore.

214. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 2,824
   MCP server for Grafana

215. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,748
   A single hub to find Claude Skills, Agents, Commands, Hooks, Plugins, and Marketplace collections to extend Claude Code, Claude Desktop, Agent SDK and OpenClaw

216. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,746
   A mcp server to allow LLMS gain context about shadcn ui component structure,usage and installation,compaitable with react,svelte 5,vue & React Native

217. **[goclaw](https://github.com/nextlevelbuilder/goclaw)** - ⭐ 2,745
   GoClaw - GoClaw is OpenClaw rebuilt in Go — with multi-tenant isolation, 5-layer security, and native concurrency. Deploy AI agent teams at scale without compromising on safety.

218. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,612
   Connect Supabase to your AI assistants

219. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,590
   A Model Context Protocol server for converting almost anything to Markdown

220. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 2,580
   Zero-dependency, token-efficient database MCP server for Postgres, MySQL, SQL Server, MariaDB, SQLite.

221. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,577
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

222. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 2,572
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

223. **[engram](https://github.com/Gentleman-Programming/engram)** - ⭐ 2,569
   Persistent memory system for AI coding agents. Agent-agnostic Go binary with SQLite + FTS5, MCP server, HTTP API, CLI, and TUI.

224. **[kreuzberg](https://github.com/Goldziher/kreuzberg)** - ⭐ 2,561
...
225. **[moltis](https://github.com/moltis-org/moltis)** - ⭐ 2,561
...
226. **[nunu](https://github.com/go-nunu/nunu)** - ⭐ 2,553
   A CLI tool for building Go applications.

227. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 2,541
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

228. **[slackdump](https://github.com/rusq/slackdump)** - ⭐ 2,540
   Save or export your private and public Slack messages, threads, files, and users locally without admin privileges.

229. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,539
   A Model Context Protocol server for searching and analyzing arXiv papers

230. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 2,536
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

231. **[claude-context-mode](https://github.com/mksglu/claude-context-mode)** - ⭐ 2,522
   MCP is the protocol for tool access. We're the virtualization layer for context.

232. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,456
   A metasearch library that aggregates results from diverse web search services

233. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,425
   A bridge between Streamable HTTP and stdio MCP transports

234. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,422
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

235. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,412

236. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 2,400
   Next Generation Agentic Proxy for AI Agents and MCP servers

237. **[ouroboros](https://github.com/Q00/ouroboros)** - ⭐ 2,386
   Stop prompting. Start specifying.

238. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 2,298
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

239. **[code-graph-rag](https://github.com/vitali87/code-graph-rag)** - ⭐ 2,286
   The ultimate RAG for your monorepo. Query, understand, and edit multi-language codebases with the power of AI and knowledge graphs

240. **[openpencil](https://github.com/ZSeven-W/openpencil)** - ⭐ 2,274
   The world's first open-source AI-native vector design tool and the first to feature concurrent Agent Teams. Design-as-Code. Turn prompts into UI directly on the live canvas. A modern alternative to Pencil.

241. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 2,267
   The Unofficial and Awesome Home Assistant MCP Server

242. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 2,227
   This is the official website for TuriX Computer-use-Agent

243. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 2,216
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

244. **[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** - ⭐ 2,190
   LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

245. **[chatmcp](https://github.com/daodao97/chatmcp)** - ⭐ 2,189
   ChatMCP is an AI chat client implementing the Model Context Protocol (MCP).

246. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 2,163
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

247. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 2,158
   AI Skills, MCP Tools, and CLI for Unity Engine. Full AI develop and test loop. Use cli for quick setup. Efficient token usage, advanced tools. Any C# method may be turned into a tool by a single line. Works with Claude Code, Gemini, Copilot, Cursor and any other absolutely for free.

248. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 2,143
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

249. **[agent-scan](https://github.com/snyk/agent-scan)** - ⭐ 2,134
   Security scanner for AI agents, MCP servers and agent skills.

250. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 2,124
   Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tasks, Search & Drive with AI - Comprehensive Google Workspace / G Suite MCP Server & CLI Tool

251. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 2,112
   ⭐ All-in-one AI companion! Super Agent Party = Self hosted neuro sama + openclaw! ⭐ 全能AI伴侣！超级智能体派对 = 自托管neuro sama + openclaw!

252. **[claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection)** - ⭐ 2,098
   Claude Code Subagents & Commands Collection + CLI Tool

253. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 2,098
...
254. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 2,089
   The official MCP server implementation for the Perplexity API Platform

255. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 2,087
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

256. **[fusio](https://github.com/apioo/fusio)** - ⭐ 2,084
   Self-Hosted API Management for Builders

257. **[mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager)** - ⭐ 2,082
   Shrimp Task Manager is a task tool built for AI Agents, emphasizing chain-of-thought, reflection, and style consistency. It converts natural language into structured dev tasks with dependency tracking and iterative refinement, enabling agent-like developer behavior in reasoning AI systems.

258. **[ext-apps](https://github.com/modelcontextprotocol/ext-apps)** - ⭐ 2,069
   Official repo for spec & SDK of MCP Apps protocol - standard for UIs embedded AI chatbots, served by MCP servers

259. **[DevDocs](https://github.com/cyberagiinc/DevDocs)** - ⭐ 2,059
   Completely free, private, UI based Tech Documentation MCP server. Designed for coders and software developers in mind. Easily integrate into Cursor, Windsurf, Cline, Roo Code, Claude Desktop App 

260. **[skills](https://github.com/microsoft/skills)** - ⭐ 2,058
   Skills, MCP servers, Custom Agents, Agents.md for SDKs to ground Coding Agents

261. **[agent-deck](https://github.com/asheshgoplani/agent-deck)** - ⭐ 2,056
   Terminal session manager for AI coding agents. One TUI for Claude, Gemini, OpenCode, Codex, and more.

262. **[Aix-DB](https://github.com/apconw/Aix-DB)** - ⭐ 2,047
   Aix-DB 基于 LangChain/LangGraph 框架，结合 MCP Skills 多智能体协作架构，实现自然语言到数据洞察的端到端转换。

263. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 2,008
   A unified hub for centrally managing and dynamically orchestrating multiple MCP servers/APIs into separate endpoints with flexible routing strategies

264. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 2,005
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

265. **[fli](https://github.com/punitarani/fli)** - ⭐ 2,000
   Google Flights MCP and Python Library

266. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,993
   directory for Awesome MCP Servers

267. **[mcp2cli](https://github.com/knowsuchagency/mcp2cli)** - ⭐ 1,968
   Turn any MCP, OpenAPI, or GraphQL server into a CLI — at runtime, with zero codegen

268. **[mcp-server](https://github.com/financial-datasets/mcp-server)** - ⭐ 1,962
   An MCP server for interacting with the Financial Datasets stock market API.

269. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,958
   A Unified MCP Server Management App (MCP Manager).

270. **[beelzebub](https://github.com/beelzebub-labs/beelzebub)** - ⭐ 1,951
   A secure low code honeypot framework, leveraging AI for System Virtualization.

271. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 1,951
...
272. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,949
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

273. **[mcp-cli](https://github.com/IBM/mcp-cli)** - ⭐ 1,945

274. **[witsy](https://github.com/Kochava-Studios/witsy)** - ⭐ 1,940
   Witsy: desktop AI assistant / universal MCP client

275. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 1,940
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

276. **[witsy](https://github.com/nbonamy/witsy)** - ⭐ 1,928
   Witsy: desktop AI assistant / universal MCP client

277. **[FireRed-OpenStoryline](https://github.com/FireRedTeam/FireRed-OpenStoryline)** - ⭐ 1,918
...
278. **[Vibe-Trading](https://github.com/HKUDS/Vibe-Trading)** - ⭐ 1,910
   "Vibe-Trading: Your Personal Trading Agent"

279. **[esp32_nat_router](https://github.com/martin-ger/esp32_nat_router)** - ⭐ 1,906
   An AI-enabled NAT Router/Firewall for the ESP32

280. **[beelzebub](https://github.com/mariocandela/beelzebub)** - ⭐ 1,904
   A secure low code honeypot framework, leveraging AI for System Virtualization.

281. **[yomo](https://github.com/yomorun/yomo)** - ⭐ 1,895
   🦖 Serverless AI Agent Framework with Geo-distributed Edge AI Infra.

282. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,891

283. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,880
   Asynchronous coordination layer for AI coding agents: identities, inboxes, searchable threads, and advisory file leases over FastMCP + Git + SQLite

284. **[vexa](https://github.com/Vexa-ai/vexa)** - ⭐ 1,877
   Open-source meeting transcription API for Google Meet, Microsoft Teams & Zoom. Auto-join bots, real-time WebSocket transcripts, MCP server for AI agents. Self-host or use hosted SaaS.

285. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,875
   MCP server for interacting with the iOS simulator

286. **[claude-peers-mcp](https://github.com/louislva/claude-peers-mcp)** - ⭐ 1,868
   Allow all your Claude Codes to message each other ad-hoc!

287. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 1,866
...
288. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,852
   Development platform to debug, chat, inspect, and evaluate MCP servers, MCP apps, and ChatGPT apps.

289. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 1,850

290. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,843
   Desktop Extensions: One-click local MCP server installation in desktop apps

291. **[tradingview-mcp](https://github.com/tradesdontlie/tradingview-mcp)** - ⭐ 1,840
   AI-assisted TradingView chart analysis — connect Claude Code to your TradingView Desktop for personal workflow automation

292. **[sanic-web](https://github.com/apconw/sanic-web)** - ⭐ 1,817
...
293. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,792
...
294. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,788
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

295. **[onecli](https://github.com/onecli/onecli)** - ⭐ 1,787
   Open-source credential vault, give your AI agents access to services without exposing keys.

296. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,783
   MAI-UI: Real-World Centric Foundation GUI Agents ranging from 2B to 235B

297. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,778
   Plugin for JADX to integrate MCP server

298. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,770
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

299. **[contextplus](https://github.com/ForLoopCodes/contextplus)** - ⭐ 1,767
   Semantic Intelligence for Large-Scale Engineering. Context+ is an MCP server designed for developers who demand 99% accuracy. By combining RAG, Tree-sitter AST, Spectral Clustering, and Obsidian-style linking, Context+ turns a massive codebase into a searchable, hierarchical feature graph.

300. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,763
   Production ready MCP server with real-time search, extract, map & crawl.

301. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,760
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

302. **[unreal-mcp](https://github.com/chongdashu/unreal-mcp)** - ⭐ 1,752
   Enable AI assistant clients like Cursor, Windsurf and Claude Desktop to control Unreal Engine through natural language using the Model Context Protocol (MCP).

303. **[plik](https://github.com/root-gg/plik)** - ⭐ 1,745
   Plik is a temporary file upload system (Wetransfer like) in Go.

304. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 1,743
...
305. **[py-gpt](https://github.com/szczyglis-dev/py-gpt)** - ⭐ 1,733
   Desktop AI Assistant powered by GPT-5, GPT-4, o1, o3, Gemini, Claude, Ollama, DeepSeek, Perplexity, Grok, Bielik, chat, vision, voice, RAG, image and video generation, agents, tools, MCP, plugins, speech synthesis and recognition, web search, memory, presets, assistants,and more. Linux, Windows, Mac

306. **[rocketride-server](https://github.com/rocketride-org/rocketride-server)** - ⭐ 1,719
   High-performance AI pipeline engine with a C++ core and 50+ Python-extensible nodes. Build, debug, and scale LLM workflows with 13+ model providers, 8+ vector databases, and agent orchestration, all from your IDE. Includes VS Code extension, TypeScript/Python SDKs, and Docker deployment.

307. **[interactive-feedback-mcp](https://github.com/noopstudios/interactive-feedback-mcp)** - ⭐ 1,717
   Interactive User Feedback MCP

308. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,716
   ToolHive is an enterprise-grade platform for running and managing Model Context Protocol (MCP) servers.

309. **[kubb](https://github.com/kubb-labs/kubb)** - ⭐ 1,687
   🧩 The Ultimate Toolkit for Generating Type-Safe API Clients, Hooks, and Validators.

310. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,686
   MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

311. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,677
   Open-source persistent memory for AI agent pipelines (LangGraph, CrewAI, AutoGen) and Claude. REST API + knowledge graph + autonomous consolidation.

312. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,670
   Make RSS 📰 great again with AI 🧠✨!! 【29元500次sonnet，下方wx扫码联系】

313. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,664
   Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatGPT, Claude) connect to using MCP

314. **[dembrandt](https://github.com/dembrandt/dembrandt)** - ⭐ 1,646
   Extract any website’s design system into tokens in seconds: logo, colors, typography, borders & more. One command.

315. **[pilot-shell](https://github.com/maxritter/pilot-shell)** - ⭐ 1,645
   Make Claude Code production-ready — spec-driven plans, enforced quality gates, persistent knowledge

316. **[codemcp](https://github.com/ezyang/codemcp)** - ⭐ 1,615
   Coding assistant MCP for Claude Desktop

317. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 1,615
   The ultimate all-in-one guide to mastering Claude Code. From setup, prompt engineering, commands, hooks, workflows, automation, and integrations, to MCP servers, tools, and the BMAD method—packed with step-by-step tutorials, real-world examples, and expert strategies to make this the global go-to repo for Claude mastery.

318. **[grepai](https://github.com/yoanbernabeu/grepai)** - ⭐ 1,615
   Semantic Search & Call Graphs for AI Agents (100% Local)

319. **[n8n-mcp-server](https://github.com/leonardsellem/n8n-mcp-server)** - ⭐ 1,601
   MCP server that provides tools and resources for interacting with n8n API

320. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,594
   Model Context Protocol (MCP) plugin to connect with Unity Editor — designed for Cursor, Claude Code, Codex, Windsurf and other IDEs

321. **[jcodemunch-mcp](https://github.com/jgravelle/jcodemunch-mcp)** - ⭐ 1,588
   The leading, most token-efficient MCP server for GitHub source code exploration via tree-sitter AST parsing

322. **[Continuous-Claude-v2](https://github.com/parcadei/Continuous-Claude-v2)** - ⭐ 1,575
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

323. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,571
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

324. **[codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)** - ⭐ 1,566
   High-performance code intelligence MCP server. Indexes codebases into a persistent knowledge graph — average repo in milliseconds. 66 languages, sub-ms queries, 99% fewer tokens. Single static binary, zero dependencies.

325. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 1,560
...
326. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,553
...
327. **[mcptools](https://github.com/f/mcptools)** - ⭐ 1,552
   A command-line interface for interacting with MCP (Model Context Protocol) servers using both stdio and HTTP transport.

328. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,542
   A Model Context Protocol server that provides read-only access to MySQL databases. This server enables LLMs to inspect database schemas and execute read-only queries.

329. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,535
   The most powerful MCP Slack Server with no permission requirements, Apps support, GovSlack, DMs, Group DMs and smart history fetch logic.

330. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,519
   An MCP server that installs other MCP servers for you

331. **[NagaAgent](https://github.com/RTGS2017/NagaAgent)** - ⭐ 1,512
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

332. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,511
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

333. **[better-agents](https://github.com/langwatch/better-agents)** - ⭐ 1,505
   Standards for building agents, better

334. **[figma-console-mcp](https://github.com/southleft/figma-console-mcp)** - ⭐ 1,501
   Your design system as an API. Connect AI to Figma for extraction, creation, and debugging.

335. **[claudian](https://github.com/YishenTu/claudian)** - ⭐ 1,493
   An Obsidian plugin that embeds Claude Code as an AI collaborator in your vault

336. **[MCP-Reborn](https://github.com/Hexeption/MCP-Reborn)** - ⭐ 1,492
   MCP-Reborn is an MCP (Mod Coder Pack) for Minecraft for making modded clients and researching its code. (1.13-1.21.4)

337. **[OB1](https://github.com/NateBJones-Projects/OB1)** - ⭐ 1,491
...
338. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,485
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

339. **[ai](https://github.com/stripe/ai)** - ⭐ 1,472
   One-stop shop for building AI-powered products and businesses with Stripe.

340. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,458
   Security scanner for AI agents, MCP servers and agent skills.

341. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,455
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

342. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,451
   The official PHP SDK for Model Context Protocol servers and clients. Maintained in collaboration with The PHP Foundation.

343. **[tavily-key-generator](https://github.com/skernelx/tavily-key-generator)** - ⭐ 1,449
   Multi-service toolkit for Tavily and Firecrawl signup automation, key validation, and isolated proxy pools.

344. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 1,445
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

345. **[korean-law-mcp](https://github.com/chrisryugj/korean-law-mcp)** - ⭐ 1,444
   국가법령정보MCP | 법제처 41개 API → 15개 MCP 도구. 법령·판례·조례·조약을 AI로 검색·조회·분석 | 41 Korean legal APIs → 15 MCP tools

346. **[hotpath-rs](https://github.com/pawurb/hotpath-rs)** - ⭐ 1,442
   Rust Performance Profiler & Channels Monitoring Toolkit (TUI, MCP)

347. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,428
   🔌 Plug-and-play library to enable agents to call MCP and UTCP tools via code execution. 

348. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,419
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

349. **[claude-pilot](https://github.com/maxritter/claude-pilot)** - ⭐ 1,418
...
350. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,403
   Make your own story. User-friendly software for LLM roleplaying

351. **[mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes)** - ⭐ 1,377
   MCP Server for kubernetes management commands

352. **[mcp-brasil](https://github.com/jxnxts/mcp-brasil)** - ⭐ 1,375
   MCP Server para 41 APIs públicas brasileiras

353. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 1,374
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

354. **[mcp-obsidian](https://github.com/smithery-ai/mcp-obsidian)** - ⭐ 1,373
   A connector for Claude Desktop to read and search an Obsidian vault.

355. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,373

356. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 1,367
   First gitlab mcp for you

357. **[cocoindex-code](https://github.com/cocoindex-io/cocoindex-code)** - ⭐ 1,361
...
358. **[data-api-builder](https://github.com/Azure/data-api-builder)** - ⭐ 1,359
   Data API builder provides modern REST, GraphQL endpoints and MCP tools to your Azure Databases and on-prem stores.

359. **[awesome-claude-plugins](https://github.com/ComposioHQ/awesome-claude-plugins)** - ⭐ 1,357
...
360. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,352
   docker mcp CLI plugin / MCP Gateway

361. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,349
   The official Swift SDK for Model Context Protocol servers and clients.

362. **[ghost-os](https://github.com/ghostwright/ghost-os)** - ⭐ 1,349
   Full computer-use for AI agents. Self-learning workflows. Native macOS. No screenshots required.

363. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,347
   告别AI提前终止烦恼，助力AI更加持久

364. **[LitterBox](https://github.com/BlackSnufkin/LitterBox)** - ⭐ 1,346
   A secure sandbox environment for malware developers and red teamers to test payloads against detection mechanisms before deployment. Integrates with LLM agents via MCP for enhanced analysis capabilities.

365. **[GrokSearch](https://github.com/GuDaStudio/GrokSearch)** - ⭐ 1,346
   Integrate Grok's powerful real-time search capabilities into Claude via the MCP protocol!

366. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,345
   An official Qdrant Model Context Protocol (MCP) server implementation

367. **[claude-code-rust](https://github.com/lorryjovens-hub/claude-code-rust)** - ⭐ 1,340
...
368. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,337
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

369. **[ShipSwift](https://github.com/signerlabs/ShipSwift)** - ⭐ 1,334
   AI-native SwiftUI component library with full-stack recipes — connect via MCP for instant access.

370. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,329
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

371. **[paperbanana](https://github.com/llmsresearch/paperbanana)** - ⭐ 1,328
   Open source implementation and extension of Google Research’s PaperBanana for automated academic figures, diagrams, and research visuals, expanded to new domains like slide generation.

372. **[blitz-mac](https://github.com/blitzdotdev/blitz-mac)** - ⭐ 1,327
   Native macOS App Store Connect tool with MCP. Submit iOS apps to App Store with AI agents 

373. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,325
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

374. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 1,320
   Official data.gouv.fr Model Context Protocol (MCP) server that allows AI chatbots to search, explore, and analyze datasets from the French national Open Data platform, directly through conversation.

375. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,309
   The official ElevenLabs MCP server

376. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,296
   The python library for research and development in NLP, multimodal LLMs, Agents, ML, Knowledge Graphs, and more.

377. **[headroom](https://github.com/chopratejas/headroom)** - ⭐ 1,293
   The Context Optimization Layer for LLM Applications

378. **[sourcey](https://github.com/sourcey/sourcey)** - ⭐ 1,288
   Precision documentation from OpenAPI, MCP, Doxygen, and Markdown guides. Static HTML you own.

379. **[awesome-claude-code-toolkit](https://github.com/rohitg00/awesome-claude-code-toolkit)** - ⭐ 1,284
...
380. **[damn-vulnerable-MCP-server](https://github.com/harishsg993010/damn-vulnerable-MCP-server)** - ⭐ 1,278
   Damn Vulnerable MCP Server

381. **[OpenContracts](https://github.com/Open-Source-Legal/OpenContracts)** - ⭐ 1,277
...
382. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 1,274
   Build MCP Agents

383. **[phantom](https://github.com/ghostwright/phantom)** - ⭐ 1,271
...
384. **[sre](https://github.com/SmythOS/sre)** - ⭐ 1,254
   The SmythOS Runtime Environment (SRE) is an open-source, cloud-native runtime for agentic AI. Secure, modular, and production-ready, it lets developers build, run, and manage intelligent agents across local, cloud, and edge environments.

385. **[relaticle](https://github.com/relaticle/relaticle)** - ⭐ 1,250
   Open-source CRM with native AI agent support. 30 MCP tools, REST API, self-hosted. Built with Laravel & Filament

386. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 1,239
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

387. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,237
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

388. **[web-eval-agent](https://github.com/refreshdotdev/web-eval-agent)** - ⭐ 1,236
   An MCP server that autonomously evaluates web applications. 

389. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,235
   The TypeScript MCP framework

390. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 1,233
   Claude Code as one-shot MCP server to have an agent in your agent.

391. **[cli](https://github.com/TanStack/cli)** - ⭐ 1,230
   The official TanStack CLI - Project Scaffolding, MCP Server, Agent Skills Installation, etc

392. **[web-eval-agent](https://github.com/withRefresh/web-eval-agent)** - ⭐ 1,226
   An MCP server that autonomously evaluates web applications. 

393. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,225
   The Grafbase GraphQL Federation Gateway

394. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 1,225
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

395. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 1,225
   Model Context Protocol for WinDBG

396. **[RisuAI](https://github.com/kwaroran/RisuAI)** - ⭐ 1,222
   Make your own story. User-friendly software for LLM roleplaying

397. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,219
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

398. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,218
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

399. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 1,214
   Claude Code 中文开发套件 - 为中国开发者定制的零门槛 AI 编程环境。一键安装完整中文化体验，集成 MCP 服务器、智能上下文管理、安全扫描，支持免翻墙访问。让 AI 编程更简单。

400. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,212
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

401. **[browserwing](https://github.com/browserwing/browserwing)** - ⭐ 1,210
...
402. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,210
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

403. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,200
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

404. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 1,176
   文颜 MCP Server 可以让 AI 自动将 Markdown 文章排版后发布至微信公众号。

405. **[fast-mcp](https://github.com/yjacquin/fast-mcp)** - ⭐ 1,165
   A Ruby Implementation of the Model Context Protocol

406. **[ros-mcp-server](https://github.com/robotmcp/ros-mcp-server)** - ⭐ 1,163
   Connect AI models like Claude & GPT with robots using MCP and ROS.

407. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 1,162
...
408. **[sceneview](https://github.com/sceneview/sceneview)** - ⭐ 1,162
...
409. **[repowise](https://github.com/repowise-dev/repowise)** - ⭐ 1,161
...
410. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 1,152
   Draw.io Model Context Protocol (MCP) Server

411. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 1,148
   A guide on how to use the Figma MCP server

412. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 1,147
   Programmable Context for the AI Stack. Build. Version. Deploy. The full lifecycle platform for Context Graphs.

413. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 1,144
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

414. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 1,144
...
415. **[tuui](https://github.com/AI-QL/tuui)** - ⭐ 1,140
   A desktop MCP client designed as a tool unitary utility integration, accelerating AI adoption through the Model Context Protocol (MCP) and enabling cross-vendor LLM API orchestration.

416. **[amical](https://github.com/amicalhq/amical)** - ⭐ 1,134
   🎙️ AI Dictation App - Open Source and Local-first ⚡ Type 3x faster, no keyboard needed. 🆓 Powered by open source models, works offline, fast and accurate.

417. **[executor](https://github.com/RhysSullivan/executor)** - ⭐ 1,132
...
418. **[tabularis](https://github.com/debba/tabularis)** - ⭐ 1,122
...
419. **[Gearboy](https://github.com/drhelius/Gearboy)** - ⭐ 1,116
...
420. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 1,107
...
421. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 1,100
   trpc-agent-go is a powerful Go framework for building intelligent agent systems using large language models (LLMs) and tools.

422. **[mcp-cli](https://github.com/philschmid/mcp-cli)** - ⭐ 1,097
   Lighweight CLI to interact with MCP servers

423. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 1,094
   MCP integration for Google Calendar to manage events.

424. **[724-office](https://github.com/wangziqi06/724-office)** - ⭐ 1,092
...
425. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,086
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

426. **[mcpvault](https://github.com/bitbonsai/mcpvault)** - ⭐ 1,086
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

427. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 1,079
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

428. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 1,079
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

429. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 1,079
   MCP, CLI, Skills for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

430. **[agents](https://github.com/inkeep/agents)** - ⭐ 1,078
   Create AI Agents in a No-Code Visual Builder or TypeScript SDK with full 2-way sync. For shipping AI assistants and multi-agent AI workflows.

431. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 1,077
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

432. **[minutes](https://github.com/silverstein/minutes)** - ⭐ 1,077
   Every meeting, every idea, every voice note — searchable by your AI. Open-source, privacy-first conversation memory layer.

433. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 1,076
...
434. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 1,066
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

435. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 1,064
   A repository of servers and clients from the Model Context Protocol tutorials

436. **[ai-engineering-interview-questions](https://github.com/amitshekhariitbhu/ai-engineering-interview-questions)** - ⭐ 1,054
   Your Cheat Sheet for AI Engineering Interview – Questions and Answers.

437. **[lets-learn-mcp-python](https://github.com/microsoft/lets-learn-mcp-python)** - ⭐ 1,052
   MCP Python Tutorial 

438. **[WebMCP](https://github.com/MiguelsPizza/WebMCP)** - ⭐ 1,052
   Bringing the power of MCP to the web

439. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 1,048
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

440. **[xiaoyaosearch](https://github.com/dtsola/xiaoyaosearch)** - ⭐ 1,045
...
441. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 1,042
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

442. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 1,042
   Remote MCP Servers

443. **[minima](https://github.com/dmayboroda/minima)** - ⭐ 1,041
   On-premises conversational RAG with configurable containers

444. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 1,041
   A curated list of Model Context Protocol (MCP) servers 

445. **[SearChat](https://github.com/sear-chat/SearChat)** - ⭐ 1,041
   Search + Chat = SearChat(AI Chat with Search), Support OpenAI/Anthropic/VertexAI/Gemini, DeepResearch, SearXNG, Docker.  AI对话式搜索引擎，支持DeepResearch, 支持OpenAI/Anthropic/VertexAI/Gemini接口、聚合搜索引擎SearXNG，支持Docker一键部署。

446. **[mcp-server-chatsum](https://github.com/chatmcp/mcp-server-chatsum)** - ⭐ 1,034
   Query and Summarize your chat messages.

447. **[mirobody](https://github.com/thetahealth/mirobody)** - ⭐ 1,034
   Your Data, Your AI — Health, Finance & More. Open Source, Privacy-First.

448. **[search_with_ai](https://github.com/yokingma/search_with_ai)** - ⭐ 1,025
...
449. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 1,022
   MCP server for fetch web page content using Playwright headless browser.

450. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 1,018
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

451. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 1,017
   🪐 🔧 Model Context Protocol (MCP) Server for Jupyter.

452. **[tools](https://github.com/strands-agents/tools)** - ⭐ 1,016
   A set of tools that gives agents powerful capabilities.

453. **[Horizon](https://github.com/Thysrael/Horizon)** - ⭐ 1,006
   Automated AI news aggregator & summarizer. Generates daily briefings in English & Chinese. | 全自动 AI 科技新闻聚合与摘要生成器。

454. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 1,003
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

455. **[keeper.sh](https://github.com/ridafkih/keeper.sh)** - ⭐ 997
   Calendar sync tool & universal calendar MCP server. Aggregate, sync and control calendars on Google, Outlook, Office 365, iCloud, CalDAV or ICS.

456. **[open-webSearch](https://github.com/Aas-ee/open-webSearch)** - ⭐ 992
   Multi-engine MCP server, CLI, and local daemon for agent web search and content retrieval — skill-guided workflows, no API keys.

457. **[CloudBase-MCP](https://github.com/TencentCloudBase/CloudBase-MCP)** - ⭐ 991
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app. 

458. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 988
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

459. **[muapi-cli](https://github.com/SamurAIGPT/muapi-cli)** - ⭐ 979
   Official CLI for muapi.ai — generate images, videos & audio from the terminal. MCP server, 14 AI models, npm + pip installable.

460. **[awesome-devops-mcp-servers](https://github.com/rohitg00/awesome-devops-mcp-servers)** - ⭐ 975
   A curated list of awesome MCP servers focused on DevOps tools and capabilities.

461. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 975
   Expose llms-txt to IDEs for development

462. **[devops-ai-guidelines](https://github.com/VersusControl/devops-ai-guidelines)** - ⭐ 974
   First AI Journey for DevOps - with comprehensive learning paths, practical tips, and enterprise guidelines

463. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 969
   Bridge between Ollama and MCP servers, enabling local LLMs to use Model Context Protocol tools

464. **[nocturne_memory](https://github.com/Dataojitori/nocturne_memory)** - ⭐ 968
   A lightweight, rollbackable, and visual Long-Term Memory Server for MCP Agents. Say goodbye to Vector RAG and amnesia. Empower your AI with persistent, graph-like structured memory across any model, session, or tool. Drop-in replacement for OpenClaw.

465. **[reactuse](https://github.com/childrentime/reactuse)** - ⭐ 967
...
466. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 963
   Self-hosted MCP Gateway for AI agents

467. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 960
...
468. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 952
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

469. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 951
   A security scanner for your LLM agentic workflows

470. **[burp-ai-agent](https://github.com/six2dez/burp-ai-agent)** - ⭐ 950
   Burp Suite extension that adds built-in MCP tooling, AI-assisted analysis, privacy controls, passive and active scanning and more

471. **[MassGen](https://github.com/massgen/MassGen)** - ⭐ 949
...
472. **[mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains)** - ⭐ 947
   A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio

473. **[claude-delegator](https://github.com/jarrodwatts/claude-delegator)** - ⭐ 941
   Delegate tasks to Codex and Gemini directly from within Claude Code.

474. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 935
   Neo4j Labs Model Context Protocol servers

475. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 934
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

476. **[better-icons](https://github.com/better-auth/better-icons)** - ⭐ 932
   Skill and MCP server for searching and retrieving icons

477. **[skybridge](https://github.com/alpic-ai/skybridge)** - ⭐ 929
   Skybridge is a framework for building ChatGPT & MCP Apps

478. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 926
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

479. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 923
   OpenAPI Tool Servers

480. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 922
   A middleware to provide an openAI compatible endpoint that can call MCP tools

481. **[mcp-browser-use](https://github.com/Saik0s/mcp-browser-use)** - ⭐ 920

482. **[cs](https://github.com/boyter/cs)** - ⭐ 917
...
483. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 916
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

484. **[chatgpt-cli](https://github.com/kardolus/chatgpt-cli)** - ⭐ 915
...
485. **[weave](https://github.com/Ataraxy-Labs/weave)** - ⭐ 913
...
486. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 910
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

487. **[CloudBase-AI-ToolKit](https://github.com/TencentCloudBase/CloudBase-AI-ToolKit)** - ⭐ 909
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app in one click.

488. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 909
   MCP server helping models to understand your Vite/Nuxt app better.

489. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 909
...
490. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 907
   The Typescript MCP Framework

491. **[superpowers-zh](https://github.com/jnMetaCode/superpowers-zh)** - ⭐ 905
   🦸 AI 编程超能力 · 中文增强版 — superpowers（116k+ ⭐）完整汉化 + 6 个中国原创 skills，让 Claude Code / Copilot CLI / Hermes Agent / Cursor / Windsurf / Kiro / Gemini CLI 等 16 款 AI 编程工具真正会干活

492. **[AI-Gateway](https://github.com/Azure-Samples/AI-Gateway)** - ⭐ 903
...
493. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 903
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

494. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 902

495. **[opennews-mcp](https://github.com/6551Team/opennews-mcp)** - ⭐ 902
   News Aggregation · AI Ratings · Trading Signals · Real-time Updates

496. **[codesight](https://github.com/Houseofmvps/codesight)** - ⭐ 901
   Universal AI context generator. Saves thousands of tokens per conversation in Claude Code, Cursor, Copilot, Codex, and more.

497. **[iwe](https://github.com/iwe-org/iwe)** - ⭐ 897
   Markdown memory system for you and your AI agent

498. **[memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp)** - ⭐ 893
   A Model Context Protocol (MCP) server implementation for remote memory bank management, inspired by Cline Memory Bank.

499. **[SocratiCode](https://github.com/giancarloerra/SocratiCode)** - ⭐ 893
   Enterprise-grade (40m+ lines) codebase intelligence in a zero-setup, private and local Plugin/Skill or MCP: managed indexing, hybrid semantic search, polyglot code dependency graphs, cross-project/repo & branch-aware search, and DB/API/infra knowledge. Benchmark: 61% less tokens, 84% fewer calls, 37x faster than standard AI grep.

500. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 891

501. **[shellfirm](https://github.com/kaplanelad/shellfirm)** - ⭐ 890
   Safety guardrails for ai coding agents and human terminal commands

502. **[openapi-mcp-server](https://github.com/janwilmake/openapi-mcp-server)** - ⭐ 887
   Allow AI to wade through complex OpenAPIs using Simple Language

503. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 887
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

504. **[mcp-scanner](https://github.com/cisco-ai-defense/mcp-scanner)** - ⭐ 886
   Scan MCP servers for potential threats & security findings.

505. **[MCProtocolLib](https://github.com/GeyserMC/MCProtocolLib)** - ⭐ 884
   A library for communication with a Minecraft client/server.

506. **[aso-skills](https://github.com/Eronred/aso-skills)** - ⭐ 884
...
507. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 883
...
508. **[awesome-mcp-list](https://github.com/MobinX/awesome-mcp-list)** - ⭐ 881
   A concise list for mcp servers

509. **[awesome-openclaw](https://github.com/SamurAIGPT/awesome-openclaw)** - ⭐ 881
   A curated list of OpenClaw resources, tools, skills, tutorials & articles. OpenClaw (formerly Moltbot / Clawdbot) — open-source self-hosted AI agent for WhatsApp, Telegram, Discord & 50+ integrations.

510. **[mcp-notion-server](https://github.com/suekou/mcp-notion-server)** - ⭐ 879

511. **[mcp-sequential-thinking](https://github.com/arben-adm/mcp-sequential-thinking)** - ⭐ 877

512. **[excalidraw-mcp-app](https://github.com/antonpk1/excalidraw-mcp-app)** - ⭐ 876
   Excalidraw MCP App Server — hand-drawn diagrams for Claude

513. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 874
   Wassette: A security-oriented runtime that runs WebAssembly Components via MCP

514. **[hyper-mcp](https://github.com/hyper-mcp-rs/hyper-mcp)** - ⭐ 872
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

515. **[kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server)** - ⭐ 869
   Published in CNCF Landscape: A MCP server for Kubernetes.

516. **[statespace](https://github.com/statespace-tech/statespace)** - ⭐ 869
   Shareable data apps for AI agents

517. **[arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)** - ⭐ 860
   The best way to create, deploy, and share MCP Servers

518. **[PrismerCloud](https://github.com/Prismer-AI/PrismerCloud)** - ⭐ 856
   Prismer Cloud

519. **[open-cowork](https://github.com/OpenCoworkAI/open-cowork)** - ⭐ 855
   Open-source AI agent desktop app for Windows & macOS. One-click install Claude Code, MCP tools, and Skills — with sandbox isolation, multi-model support, and Feishu/Slack integration.

520. **[vllm-mlx](https://github.com/waybarrios/vllm-mlx)** - ⭐ 848
   OpenAI and Anthropic compatible server for Apple Silicon. Run LLMs and vision-language models (Llama, Qwen-VL, LLaVA) with continuous batching, MCP tool calling, and multimodal support. Native MLX backend, 400+ tok/s. Works with Claude Code.

521. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 842
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

522. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 840
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

523. **[hyper-mcp](https://github.com/tuananh/hyper-mcp)** - ⭐ 835
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

524. **[hyper-mcp](https://github.com/joseph-wortmann/hyper-mcp)** - ⭐ 834
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

525. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 832
   A minimalistic MCP client with a good feature set.

526. **[annas-mcp](https://github.com/iosifache/annas-mcp)** - ⭐ 832
   MCP server and CLI tool for searching and downloading documents from Anna's Archive

527. **[server](https://github.com/php-mcp/server)** - ⭐ 830
   Core PHP implementation for the Model Context Protocol (MCP) server

528. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 826
   Simple, modular, and observable Go framework for backend applications.

529. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 826
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

530. **[sentrux](https://github.com/sentrux/sentrux)** - ⭐ 823
...
531. **[golf](https://github.com/golf-mcp/golf)** - ⭐ 819
   Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents 

532. **[bank-api](https://github.com/erwinkramer/bank-api)** - ⭐ 819
   The Bank API is a design reference project suitable to bootstrap development for a compliant and modern API.

533. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 818
   Browse the web, directly from Cursor etc.

534. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 818
   A local sandbox for your AI agents

535. **[browser-use-mcp-server](https://github.com/kontext-security/browser-use-mcp-server)** - ⭐ 818
   Browse the web, directly from Cursor etc.

536. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 818
...
537. **[supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server)** - ⭐ 817
   Query MCP enables end-to-end management of Supabase via chat interface: read & write query executions, management API support, automatic migration versioning, access to logs and much more.

538. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 812
   Model-agnostic plug-n-play LangChain/LangGraph agents powered entirely by MCP tools over HTTP/SSE.

539. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 811
   MCP server integration for DaVinci Resolve

540. **[context-space](https://github.com/context-space/context-space)** - ⭐ 810
   Ultimate Context Engineering Infrastructure, starting from MCPs and Integrations

541. **[toolfront](https://github.com/statespace-tech/toolfront)** - ⭐ 809
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

542. **[MODULAR-RAG-MCP-SERVER](https://github.com/jerry-ai-dev/MODULAR-RAG-MCP-SERVER)** - ⭐ 809
...
543. **[glean](https://github.com/LeslieLeung/glean)** - ⭐ 808
   A self-hosted RSS reader and personal knowledge management tool.

544. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 807
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

545. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 806
   一款轻量级、跨平台的 Mini Kubernetes AI Dashboard，支持大模型+智能体+MCP(支持设置操作权限)，集成多集群管理、智能分析、实时异常检测等功能，支持多架构并可单文件部署，助力高效集群管理与运维优化。

546. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 803
   一个将ACE(Augment Context Engine) 做成MCP的项目

547. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 796
   A flexible multi-interface AI agent framework for building agents with reasoning, tool use, memory, deep research, blockchain interaction, MCP, and agents-as-a-service.

548. **[flow-like](https://github.com/TM9657/flow-like)** - ⭐ 793
   Flow-Like: Strongly Typed Enterprise Scale Workflows. Built for scalability, speed, seamless AI integration and rich customization.

549. **[Context](https://github.com/indragiek/Context)** - ⭐ 791
   Native macOS client for Model Context Protocol (MCP)

550. **[vllora](https://github.com/vllora/vllora)** - ⭐ 789
   Debug your AI agents

551. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 789
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

552. **[js-reverse-mcp](https://github.com/zhizhuodemao/js-reverse-mcp)** - ⭐ 789
   为 AI Agent 设计的 JS 逆向 MCP Server，内置反检测，基于 chrome-devtools-mcp 重构 | JS reverse engineering MCP server with agent-first tool design and built-in anti-detection. Rebuilt from chrome-devtools-mcp.

553. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 787
   Vibetest MCP - automated QA testing using Browser-Use agents

554. **[secpipe](https://github.com/FuzzingLabs/secpipe)** - ⭐ 785
   MCP server for AI-driven security pipelines

555. **[stitch-mcp](https://github.com/davideast/stitch-mcp)** - ⭐ 785
   A CLI for moving AI-generated UI designs from Google’s Stitch platform into your development workflow.

556. **[AITreasureBox](https://github.com/superiorlu/AITreasureBox)** - ⭐ 784
   🤖 Automatically collected AI repos, tools, websites, papers & tutorials. 实用AI百宝箱 💎

557. **[nekro-agent](https://github.com/KroMiose/nekro-agent)** - ⭐ 782
...
558. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 781
   The official Ruby SDK for the Model Context Protocol.

559. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 781
...
560. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 779
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

561. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 778
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

562. **[drift](https://github.com/dadbodgeoff/drift)** - ⭐ 774
   Codebase intelligence for AI. Detects patterns & conventions + remembers decisions across sessions. MCP server for any IDE. Offline CLI.

563. **[gemini-skill](https://github.com/WJZ-P/gemini-skill)** - ⭐ 770
...
564. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 768
   A simple, locally hosted Web Search MCP server for use with Local LLMs

565. **[runno](https://github.com/taybenlor/runno)** - ⭐ 765
   Sandboxed runtime for programming languages and WASI binaries. Works in the browser, on your server, or via MCP.

566. **[mcp-marketplace](https://github.com/cline/mcp-marketplace)** - ⭐ 763
...
567. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 763
   MCP Server For Turkish Legal Databases

568. **[context-portal](https://github.com/GreatScottyMac/context-portal)** - ⭐ 761
...
569. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 757
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

570. **[mcp](https://github.com/hyperbrowserai/mcp)** - ⭐ 755
   A MCP server implementation for hyperbrowser

571. **[qiaomu-anything-to-notebooklm](https://github.com/joeseesun/qiaomu-anything-to-notebooklm)** - ⭐ 755
   Claude Skill: Multi-source content processor for NotebookLM. Supports WeChat articles, web pages, YouTube, PDF, Markdown, search queries → Podcast/PPT/MindMap/Quiz etc.

572. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 754
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

573. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 753
   Connect ClickHouse to your AI assistants.

574. **[kordoc](https://github.com/chrisryugj/kordoc)** - ⭐ 746
   모두 파싱해버리겠다 — HWP, HWPX, PDF, XLSX, DOCX → Markdown. CLI + MCP Server

575. **[lisa.py](https://github.com/ant4g0nist/lisa.py)** - ⭐ 745
   LLDB MCP Integration + other helpful commands

576. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 745
...
577. **[universal-db-mcp](https://github.com/Anarkh-Lee/universal-db-mcp)** - ⭐ 743
...
578. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 740
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

579. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 740
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

580. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 739
   A flexible HTTP fetching Model Context Protocol server.

581. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 739
   gcloud MCP server

582. **[openmcp-client](https://github.com/LSTM-Kirigaya/openmcp-client)** - ⭐ 738
   All in one vscode plugin for mcp developer

583. **[LangAlpha](https://github.com/ginlix-ai/LangAlpha)** - ⭐ 733
   Claude Code for Finance

584. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 732
...
585. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 731
   Clojure MCP

586. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 729
   FreeCAD MCP(Model Context Protocol) server

587. **[work-iq](https://github.com/microsoft/work-iq)** - ⭐ 729
   MCP Server and CLI for accessing Work IQ

588. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 727
   An MCP server that provides control over Android devices via adb

589. **[samples](https://github.com/strands-agents/samples)** - ⭐ 726
   Agent samples built using the Strands Agents SDK.

590. **[anything-to-notebooklm](https://github.com/joeseesun/anything-to-notebooklm)** - ⭐ 724
   Claude Skill: Multi-source content processor for NotebookLM. Supports WeChat articles, web pages, YouTube, PDF, Markdown, search queries → Podcast/PPT/MindMap/Quiz etc.

591. **[mcp](https://github.com/laravel/mcp)** - ⭐ 724
   Rapidly build MCP servers for your Laravel applications.

592. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 723
   Next.js Development for Coding Agent

593. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 722
...
594. **[xmcp](https://github.com/xdevplatform/xmcp)** - ⭐ 717
   MCP server for the X API

595. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 717
...
596. **[passage-of-time-mcp](https://github.com/jlumbroso/passage-of-time-mcp)** - ⭐ 713
...
597. **[codedb](https://github.com/justrach/codedb)** - ⭐ 713
...
598. **[obot](https://github.com/obot-platform/obot)** - ⭐ 712
   Complete MCP Platform -- Hosting, Registry, Gateway, and Chat Client

599. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 711
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

600. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 703
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

601. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 701
...
602. **[Wax](https://github.com/christopherkarani/Wax)** - ⭐ 701
...
603. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 699
   MCP server for Docker

604. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 699
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

605. **[langgraph-mcp-agents](https://github.com/teddynote-lab/langgraph-mcp-agents)** - ⭐ 694
...
606. **[room](https://github.com/quoroom-ai/room)** - ⭐ 693
...
607. **[ai-setup](https://github.com/caliber-ai-org/ai-setup)** - ⭐ 692
...
608. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 690
   Google Search Console Insights with Claude AI for SEOs

609. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 690
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

610. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 683
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

611. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 682
   A simple MCP server for Obsidian

612. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 681
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

613. **[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)** - ⭐ 678
...
614. **[mcp-proxy](https://github.com/tbxark/mcp-proxy)** - ⭐ 677
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

615. **[mcp-server](https://github.com/PortSwigger/mcp-server)** - ⭐ 676
   MCP Server for Burp

616. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 673
   A simple CLI to run LLM prompt and implement MCP client.

617. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 671
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

618. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 671
   Laravel API for Ai Agents and humans.

619. **[cli](https://github.com/smithery-ai/cli)** - ⭐ 670
   Install, manage and develop MCP servers and skills for agents

620. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 669
...
621. **[routa](https://github.com/phodal/routa)** - ⭐ 667
...
622. **[generative-ui](https://github.com/CopilotKit/generative-ui)** - ⭐ 666
   Generative UI examples for: AG-UI, A2UI/Open-JSON-UI, and MCP Apps.

623. **[axon](https://github.com/harshkedia177/axon)** - ⭐ 663
...
624. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 661
   AgentX 致力于让小白也能无门槛通过自然语言打造属于自己的 Agent。AgentX 采用了自研 MCP 网关，模型高可用组件打造高可用

625. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 661
   飞书/Lark官方 OpenAPI MCP

626. **[clihub](https://github.com/thellimist/clihub)** - ⭐ 658
   Turn any MCP server into CLI

627. **[RAGLight](https://github.com/Bessouat40/RAGLight)** - ⭐ 657
   RAGLight is a modular framework for Retrieval-Augmented Generation (RAG). It makes it easy to plug in different LLMs, embeddings, and vector stores, and now includes seamless MCP integration to connect external tools and data sources.

628. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 655
   The YaCy Grid Master Connect Program

629. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 655
   Shell and coding agent on mcp clients

630. **[llm-search](https://github.com/snexus/llm-search)** - ⭐ 651
   Querying local documents, powered by LLM

631. **[AgentChat](https://github.com/Shy2593666979/AgentChat)** - ⭐ 651
...
632. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 649
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

633. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 648
...
634. **[wren-engine](https://github.com/Canner/wren-engine)** - ⭐ 646
   The open context engine for AI agents support 15+ data sources. Built on Rust and Apache DataFusion.

635. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 646
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

636. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 645
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

637. **[cupertino](https://github.com/mihaelamj/cupertino)** - ⭐ 644
   A local Apple Documentation crawler and MCP server. Written in Swift.

638. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 643
   EnrichMCP is a python framework for building data driven MCP servers

639. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 643

640. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 643
   MCP Server for SearXNG

641. **[FofaMap](https://github.com/asaotomo/FofaMap)** - ⭐ 642
...
642. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 642
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

643. **[claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus)** - ⭐ 641
...
644. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 641

645. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 641
   "AnyTool: Universal Tool-Use Layer for AI Agents"

646. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 640
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

647. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 639
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

648. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 637
   Official Jina AI Remote MCP Server

649. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 637
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

650. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 636
   An MCP server for interacting with Sentry via LLMs.

651. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 635
   MCP configuration to connect AI agent to a Linux machine.

652. **[azure-skills](https://github.com/microsoft/azure-skills)** - ⭐ 635
   Official agent plugin providing skills and MCP server configurations for Azure scenarios.

653. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 634
...
654. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 633
   Talk to a Cloudflare Worker from Claude Desktop!

655. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 630
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

656. **[MCP-Nest](https://github.com/rekog-labs/MCP-Nest)** - ⭐ 627
   A NestJS module to effortlessly create Model Context Protocol (MCP) servers for exposing AI tools, resources, and prompts.

657. **[mcp-proxy](https://github.com/TBXark/mcp-proxy)** - ⭐ 624
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

658. **[notebooklm-mcp](https://github.com/jacob-bd/notebooklm-mcp)** - ⭐ 624

659. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 622
   mem-agent mcp server

660. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 622
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

661. **[agent-kit](https://github.com/KeyID-AI/agent-kit)** - ⭐ 618
   Give Claude/Cursor email powers. 27 MCP tools — inbox, send, reply, contacts, search. Free, no signup.

662. **[codeg](https://github.com/xintaofei/codeg)** - ⭐ 617
...
663. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 616
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

664. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 616
   Claude Code LSP: enhance your Claude Code experience with non-IDE dependent LSP integration.

665. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 616
   A comprehensive collection of Model Context Protocol (MCP) servers

666. **[lean-ctx](https://github.com/yvgude/lean-ctx)** - ⭐ 613
...
667. **[tome](https://github.com/runebookai/tome)** - ⭐ 609
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

668. **[Overture](https://github.com/SixHq/Overture)** - ⭐ 609
   Overture is an open-source, locally running web interface delivered as an MCP (Model Context Protocol) server that visually maps out the execution plan of any AI coding agent as an interactive flowchart/graph before the agent begins writing code. 

669. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 608
   A coding agent and general agent harness for building and orchestrating agentic applications.

670. **[awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers)** - ⭐ 607
...
671. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 606
   GitOps on Autopilot Mode

672. **[apple-doc-mcp](https://github.com/MightyDillah/apple-doc-mcp)** - ⭐ 605
   MCP server providing seamless access to Apple Developer Documentation with smart search and wildcard support

673. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 605
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

674. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 604
   Daydreams is a set of tools for building agents for commerce

675. **[idea-reality-mcp](https://github.com/mnemox-ai/idea-reality-mcp)** - ⭐ 603
   Pre-build reality check for AI coding agents. Scans GitHub, HN, npm, PyPI, Product Hunt. MCP server. 290+ stars.

676. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 602
   Convert Any OpenAPI V3 API to MCP Server

677. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 601
    Feishu / Lark 飞书文档与任务管理工具，支持 MCP 服务器和 CLI + Skill 两种使用方式，可无缝集成 Cursor、Claude Code、Cline 等 AI 编码工具

678. **[LetsFG](https://github.com/LetsFG/LetsFG)** - ⭐ 601
...
679. **[claude_agent_teams_ui](https://github.com/777genius/claude_agent_teams_ui)** - ⭐ 599
...
680. **[spotify-mcp](https://github.com/varunneal/spotify-mcp)** - ⭐ 595
   MCP to connect your LLM with Spotify.

681. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 594
   The .NET library to build AI agents with 30+ built-in connectors.

682. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 594
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

683. **[FantasyPremierLeague](https://github.com/joreilly/FantasyPremierLeague)** - ⭐ 593
   Fantasy Premier League Kotlin/Compose Multiplatform sample 

684. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 593
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

685. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 591
   MCP server to deploy apps to Cloud Run

686. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 590
   Diagram generation for understanding codebases and system architecture using Nano Banana Pro.

687. **[FLUJO](https://github.com/mario-andreschak/FLUJO)** - ⭐ 588
   MCP-Hub and -Inspector, Multi-Model Workflow and Chat Interface 

688. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 585
...
689. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 585
...
690. **[tradememory-protocol](https://github.com/mnemox-ai/tradememory-protocol)** - ⭐ 584
...
691. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 583
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

692. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 583
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

693. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 582
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

694. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 582
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

695. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 581

696. **[atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server)** - ⭐ 581
   Remote MCP Server that securely connects Jira and Confluence with your LLM, IDE, or agent platform of choice.

697. **[mcp-server-neon](https://github.com/neondatabase/mcp-server-neon)** - ⭐ 580
   MCP server for interacting with Neon Management API and databases

698. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 580
   MCP Server for Metasploit

699. **[MeiGen-AI-Design-MCP](https://github.com/jau123/MeiGen-AI-Design-MCP)** - ⭐ 580
...
700. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 579
   LangGraph solution template for MCP

701. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 579
...
702. **[evo-ai](https://github.com/EvolutionAPI/evo-ai)** - ⭐ 576
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

703. **[ScienceClaw](https://github.com/beita6969/ScienceClaw)** - ⭐ 576
   🔬🦞 A self-evolving AI research colleague for scientists. 285 skills, zero hallucination, persistent memory.

704. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 574
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

705. **[line-bot-mcp-server](https://github.com/line/line-bot-mcp-server)** - ⭐ 574
   MCP server that integrates the LINE Messaging API to connect an AI Agent to the LINE Official Account.

706. **[docling-mcp](https://github.com/docling-project/docling-mcp)** - ⭐ 574
   Making docling agentic through MCP

707. **[GhidrAssistMCP](https://github.com/symgraph/GhidrAssistMCP)** - ⭐ 573
   An MCP extension for Ghidra

708. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 572
   A model-driven approach to building AI agents in just a few lines of code. 

709. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 572
   MCP-NixOS - Model Context Protocol Server for NixOS resources

710. **[mcp-pointer](https://github.com/etsd-tech/mcp-pointer)** - ⭐ 571
   MCP tool: let you point at DOM elements for your favorite agentic coding tool. Let AI see what you see.

711. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 570
   A Model Context Protocol (MCP) that allows Claude Desktop and other AI tools (Claude Code, Cursor, Antigravity, etc.) to read, analyze, and modify Figma designs

712. **[codexia](https://github.com/milisp/codexia)** - ⭐ 568
   Agent Workstation for Codex CLI + Claude Code — with task scheduler, git worktree & remote control, skills management

713. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 566
   A MCP server for Home Assistant

714. **[figma-mcp-go](https://github.com/vkhanhqui/figma-mcp-go)** - ⭐ 566
   Figma MCP for free users — no rate limits, full read/write, text to designs, designs to code

715. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 565
   A tool that converts OpenAPI specifications to MCP server

716. **[opentwitter-mcp](https://github.com/6551Team/opentwitter-mcp)** - ⭐ 565
   Twitter/X Data · User Profiles · Tweet Search · Follower Events · KOL Tracking

717. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 564

718. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 561
   MCP to allow AI agents to control Unreal

719. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 558
   An Mcp client inside Emacs

720. **[argo](https://github.com/xark-argo/argo)** - ⭐ 557
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

721. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 556
   Vite plugin that enables a MCP server helping models to understand your Vue app better.

722. **[caswaf](https://github.com/casbin/caswaf)** - ⭐ 555
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

723. **[casbin-gateway](https://github.com/casbin/casbin-gateway)** - ⭐ 555
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

724. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 555
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

725. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 554
   Open Source Voice Agent Platform

726. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 553
   Security scanner for MCP servers

727. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 553
   MCP Server for Turkish & American Stock Exchange and Fund Data

728. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 550
   An MCP Multimodal AI Agent with eyes and ears!

729. **[tsidp](https://github.com/tailscale/tsidp)** - ⭐ 550
   A simple OIDC / OAuth Identity Provider (IdP) server for your tailnet.

730. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 549
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

731. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 544
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

732. **[Mantic.sh](https://github.com/marcoaapfortes/Mantic.sh)** - ⭐ 543
   A structural code search engine for Al agents.

733. **[bm.md](https://github.com/miantiao-me/bm.md)** - ⭐ 543
   更好用的 Markdown 排版助手｜一键适配微信公众号、网页与图片。

734. **[probe](https://github.com/probelabs/probe)** - ⭐ 542
   AI-friendly semantic code search engine for large codebases. Combines ripgrep speed with tree-sitter AST parsing. Powers AI coding assistants with precise, context-aware code understanding.

735. **[mcp-google-ads](https://github.com/cohnen/mcp-google-ads)** - ⭐ 542
   An MCP tool that connects Google Ads with Claude AI/Cursor and others, allowing you to analyze your advertising data through natural language conversations. This integration gives you access to campaign information, performance metrics, keyword analytics, and ad management—all through simple chat with Claude, Cursor or Windsurf.

736. **[tda](https://github.com/irockel/tda)** - ⭐ 541
   TDA - Thread Dump Analyzer (for Java). Analyze your Thread Dumps with a GUI or use it as MCP Server.

737. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 540
   AI-based stock analysis and trading system

738. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 539
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

739. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 538
   A MCP (Model Context Protocol) server for interacting with dbt.

740. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 537
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

741. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 536

742. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 536
   SonarQube MCP Server

743. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 535
...
744. **[work-iq-mcp](https://github.com/microsoft/work-iq-mcp)** - ⭐ 534
   MCP Server and CLI for accessing Work IQ

745. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 534
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

746. **[dolphin-mcp](https://github.com/QuixiAI/dolphin-mcp)** - ⭐ 534

747. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 533
   A Model Context Protocol server for IDA

748. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 532

749. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 531
   微信读书MCP

750. **[FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP)** - ⭐ 531
...
751. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 530
   MCP Server for interacting with Android Devices.

752. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 529
   MCP server for querying Apple Health data with natural language and SQL

753. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 528
   An MCP server to query any Postgres database in natural language.

754. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 528
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

755. **[ethora](https://github.com/dappros/ethora)** - ⭐ 527
...
756. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 527
   MCP server for document format conversion using pandoc.

757. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 527
   LLM + MCP + RAG = Magic

758. **[MemoMind](https://github.com/24kchengYe/MemoMind)** - ⭐ 526
...
759. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 526
...
760. **[mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub)** - ⭐ 525
   A growing collection of MCP servers bringing offensive security tools to AI assistants. Nmap, Ghidra, Nuclei, SQLMap, Hashcat and more.

761. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 525
   ❤️ Generate mermaid diagram and chart with AI MCP dynamically.

762. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 523
   Universal MCP-Server for your Databases optimized for LLMs and AI-Agents.

763. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 521
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

764. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 521
...
765. **[MimikaStudio](https://github.com/BoltzmannEntropy/MimikaStudio)** - ⭐ 520
   MimikaStudio - A local-first application for macOS (Apple Silicon) + Agentic MCP Support

766. **[UnityMCP](https://github.com/jackwrichards/UnityMCP)** - ⭐ 518

767. **[talk-to-girlfriend-ai](https://github.com/arlanrakh/talk-to-girlfriend-ai)** - ⭐ 517
   im busy building ai agents so why not let an ai talk to my girlfriend? (i am single) 

768. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 515
...
769. **[mcp-youtube](https://github.com/anaisbetts/mcp-youtube)** - ⭐ 515
   A Model-Context Protocol Server for YouTube

770. **[MindOS](https://github.com/GeminiLight/MindOS)** - ⭐ 514
...
771. **[desktop](https://github.com/openyak/desktop)** - ⭐ 513
   Yak is all you need

772. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 512
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

773. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 511

774. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 510
   An MCP extension for Ghidra

775. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 510
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

776. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 509
   A comprehensive Model Context Protocol (MCP) server that enables AI assistants to control Unreal Engine through the native C++ Automation Bridge plugin. Built with TypeScript and C++.

777. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

778. **[claude-debugs-for-you](https://github.com/jasonjmcghee/claude-debugs-for-you)** - ⭐ 507
   Enable any LLM (e.g. Claude) to interactively debug any language for you via MCP and a VS Code Extension

779. **[MCPSpy](https://github.com/alex-ilgayev/MCPSpy)** - ⭐ 505
   MCP Monitoring with eBPF

780. **[colab-mcp](https://github.com/googlecolab/colab-mcp)** - ⭐ 505
   An MCP server for interacting with Google Colab

781. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 504
   Yes Mcp server in bash

782. **[resend-mcp](https://github.com/resend/resend-mcp)** - ⭐ 500
   The official MCP server to send emails and interact with Resend

783. **[claude-code-mastery](https://github.com/TheDecipherist/claude-code-mastery)** - ⭐ 499
   The complete guide to Claude Code: CLAUDE.md, hooks, skills, MCP servers, and commands

784. **[human-skill-tree](https://github.com/24kchengYe/human-skill-tree)** - ⭐ 498
...
785. **[webclaw](https://github.com/0xMassi/webclaw)** - ⭐ 498
   Fast, local-first web content extraction for LLMs. Scrape, crawl, extract structured data — all from Rust. CLI, REST API, and MCP server.

786. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 497
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

787. **[UnrealClaude](https://github.com/Natfii/UnrealClaude)** - ⭐ 496
   Claude Code CLI integration for Unreal Engine 5.7 - Get AI coding assistance with built-in UE5.7 documentation context directly in the editor.

788. **[youtube-mcp-server](https://github.com/ZubeidHendricks/youtube-mcp-server)** - ⭐ 494
   MCP Server for YouTube API, enabling video management, Shorts creation, and advanced analytics

789. **[PentestAgent](https://github.com/GH05TCREW/PentestAgent)** - ⭐ 493
...
790. **[rails_ai_agents](https://github.com/ThibautBaissac/rails_ai_agents)** - ⭐ 492
   Specialized AI skills, agents, rules and hooks for modern Rails AI driven-development + Spec-Driven-Development kit + MCP

791. **[joinly](https://github.com/joinly-ai/joinly)** - ⭐ 492
   Make your meetings accessible to AI Agents

792. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 491

793. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 490
   BioMCP: Biomedical Model Context Protocol

794. **[JSReverser-MCP](https://github.com/NoOne-hub/JSReverser-MCP)** - ⭐ 490
...
795. **[concierge](https://github.com/concierge-hq/concierge)** - ⭐ 489
   🚀 Universal SDK for building next-gen MCP servers

796. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 489
   MaverickMCP - Personal Stock Analysis MCP Server

797. **[oxideterm](https://github.com/AnalyseDeCircuit/oxideterm)** - ⭐ 489
...
798. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 486
   ReMinecraftPE - A custom experience based on Minecraft PE as of 2011.

799. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 486
   MCP Server to interact with Google Gsuite prodcuts

800. **[open-multi-agent-canvas](https://github.com/CopilotKit/open-multi-agent-canvas)** - ⭐ 486
   The open-source multi-agent chat interface that lets you manage multiple agents in one dynamic conversation and add MCP servers for deep research

801. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 484
   A VSCode extension that lets you find and install Agent Skills and MCP Apps to use with GitHub Copilot, Claude Code, and Codex CLI.

802. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 484
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

803. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 481
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

804. **[OpenContext](https://github.com/0xranx/OpenContext)** - ⭐ 481
   A personal context store for AI agents and assistants—reuse your existing coding agent CLI (Codex/Claude/OpenCode) with built‑in Skills/tools and a desktop GUI to capture, search, and reuse project knowledge across agents and repos.

805. **[awesome-copilot-agents](https://github.com/Code-and-Sorts/awesome-copilot-agents)** - ⭐ 481
...
806. **[zerobox](https://github.com/afshinm/zerobox)** - ⭐ 480
...
807. **[MCP-Zero](https://github.com/xfey/MCP-Zero)** - ⭐ 479
   MCP-Zero: Active Tool Discovery for Autonomous LLM Agents

808. **[vestige](https://github.com/samvallad33/vestige)** - ⭐ 477
...
809. **[director](https://github.com/director-run/director)** - ⭐ 476
   MCP Playbooks for AI agents

810. **[director](https://github.com/fdmtl/director)** - ⭐ 476
   MCP Playbooks for AI agents

811. **[ScienceClaw](https://github.com/AgentTeam-TaichuAI/ScienceClaw)** - ⭐ 476
...
812. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 475
   小红书MCP服务 x-s x-t js逆向

813. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 474
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

814. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 473
   The only general AI agent that does NOT requires extra API key, giving you full control on your local and remote MacOs from Claude Desktop App

815. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 473
   The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat.

816. **[kraken-cli](https://github.com/krakenfx/kraken-cli)** - ⭐ 473
   The first AI-native CLI for trading crypto, stocks, forex, and derivatives.

817. **[fim-one](https://github.com/fim-ai/fim-one)** - ⭐ 472
   LLM-powered Agent Runtime with Dynamic DAG Planning & Concurrent Execution

818. **[laravel](https://github.com/php-mcp/laravel)** - ⭐ 471
   An SDK building Laravel MCP servers

819. **[mcp-bench](https://github.com/Accenture/mcp-bench)** - ⭐ 471
   MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers

820. **[aser](https://github.com/AmeNetwork/aser)** - ⭐ 470
   Aser is a lightweight, self-assembling AI Agent frame.

821. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 469
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

822. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 469
   A docker MCP Server (modelcontextprotocol)

823. **[CoexistAI](https://github.com/SPThole/CoexistAI)** - ⭐ 469
   CoexistAI is a modular, developer-friendly research assistant framework . It enables you to build, search, summarize, and automate research workflows using LLMs, web search, Reddit, YouTube, and mapping tools—all with simple MCP tool calls or API calls or Python functions. 

824. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 467
...
825. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 467
   Official Docker MCP registry 

826. **[doctor](https://github.com/sisig-ai/doctor)** - ⭐ 465
   Doctor is a tool for discovering, crawl, and indexing web sites to be exposed as an MCP server for LLM agents.

827. **[mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck)** - ⭐ 464
   Local MCP server for DuckDB and MotherDuck

828. **[cordum](https://github.com/cordum-io/cordum)** - ⭐ 464
...
829. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 464
...
830. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 462

831. **[docfork](https://github.com/docfork/docfork)** - ⭐ 459
   Docfork - Context for AI Coding Agents.

832. **[mcp-cli](https://github.com/apify/mcp-cli)** - ⭐ 459
...
833. **[blockrun-mcp](https://github.com/BlockRunAI/blockrun-mcp)** - ⭐ 459
   Live data for AI agents — search, research, markets, crypto, X/Twitter. Pay-per-call via x402 micropayments.

834. **[open-harness](https://github.com/MaxGfeller/open-harness)** - ⭐ 459
   A code-first, composable SDK to build powerful AI agents

835. **[kmcp](https://github.com/kagent-dev/kmcp)** - ⭐ 454
   CLI tool and Kubernetes Controller for building, testing and deploying MCP servers

836. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 452
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

837. **[roam-code](https://github.com/Cranot/roam-code)** - ⭐ 449
...
838. **[welsonjs](https://github.com/gnh1201/welsonjs)** - ⭐ 449
   WelsonJS - Build a Windows app on the Windows built-in JavaScript engine

839. **[applescript-mcp](https://github.com/peakmojo/applescript-mcp)** - ⭐ 448
   MCP server that execute applescript giving you full control of your Mac

840. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 448
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

841. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 446
   Govern & Secure your AI

842. **[nexus](https://github.com/nexus-ai-labs/nexus)** - ⭐ 446
   Govern & Secure your AI

843. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 446
   基于NET搭建-AI知识库智能体-现代化Saas企业级前后端分离架构：前端Vue3、IDS4单点登录、多缓存、自动任务、分布式、一库多租户、日志、授权和鉴权、CAP集成事件、SignalR、领域事件、MCP协议服务、IOC模块化注入、Quartz自动任务、多短信集成、AI、AgentFramework智能体、AISemanticKernel集成、RAG检索增强、本地离线AI模型调用、API多版本、单元测试、RabbitMQ、Skills技能使用、AI知识库、AI联网搜索

844. **[mcp-send-email](https://github.com/resend/mcp-send-email)** - ⭐ 444
   Send emails directly from Cursor with this email sending MCP server

845. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 444
...
846. **[awesome-mcp-devtools](https://github.com/punkpeye/awesome-mcp-devtools)** - ⭐ 443
   A curated list of developer tools, SDKs, libraries, and testing utilities for Model Context Protocol (MCP) server development.

847. **[yutu](https://github.com/eat-pray-ai/yutu)** - ⭐ 440
   The AI-powered toolkit that grows your YouTube channel on autopilot.

848. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 439
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

849. **[puppeteer-mcp-server](https://github.com/merajmehrabi/puppeteer-mcp-server)** - ⭐ 437
   This MCP server provides browser automation capabilities through Puppeteer, allowing interaction with both new browser instances and existing Chrome windows.

850. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 437
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

851. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 432
   kratos transport layer extension, support: rabbitmq,kafka,rocketmq,activemq,apollo,mcp,tcp,websocket...

852. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 429
   A CLI inspector for the Model Context Protocol

853. **[mcp-server-spec-driven-development](https://github.com/formulahendry/mcp-server-spec-driven-development)** - ⭐ 428
   Spec-Driven Development MCP Server, not just Vibe Coding

854. **[mcpstore](https://github.com/whillhill/mcpstore)** - ⭐ 428
   开盒即用的优雅管理mcp服务 | 结合Agent框架 | 作者听劝 | 已发布pypi | Vue页面demo 

855. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 428
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

856. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 428
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

857. **[ZeroToken](https://github.com/AMOS144/ZeroToken)** - ⭐ 427
...
858. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 426
...
859. **[nexus](https://github.com/Nexus-Router/nexus)** - ⭐ 424
   Govern & Secure your AI

860. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 424
...
861. **[mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb)** - ⭐ 424
   Search Airbnb using your AI Agent

862. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 423

863. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 423
...
864. **[claude-codepro](https://github.com/maxritter/claude-codepro)** - ⭐ 422
...
865. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 421
   Baidu Map MCP Server

866. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 420
   lunar.dev: Agent native MCP Gateway for governance and security

867. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 420
   Things.app MCP Server

868. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 419
   Unlock 650+ MCP servers tools in your favorite agentic framework.

869. **[codex-mcp-server](https://github.com/tuannvm/codex-mcp-server)** - ⭐ 419
   MCP server wrapper for OpenAI Codex CLI that enables Claude Code to leverage Codex's AI capabilities directly.

870. **[ship-safe](https://github.com/asamassekou10/ship-safe)** - ⭐ 417
   CLI security scanner built for the agentic era. Detects CI/CD misconfigs, agent permission risks, MCP tool injection, hardcoded secrets, and DMCA-flagged AI dependencies.

871. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 414
...
872. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 414
   Memento MCP: A Knowledge Graph Memory System for LLMs

873. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 413
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

874. **[prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server)** - ⭐ 412
   A Model Context Protocol (MCP) server that enables AI agents and LLMs to query and analyze Prometheus metrics through standardized interfaces.

875. **[llmwiki](https://github.com/lucasastorian/llmwiki)** - ⭐ 412
...
876. **[speakeasy](https://github.com/speakeasy-api/speakeasy)** - ⭐ 410
...
877. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 410
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

878. **[freee-mcp](https://github.com/freee/freee-mcp)** - ⭐ 410
   Model Context Protocol (MCP) server for freee API integration

879. **[edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp)** - ⭐ 409
   An MCP service designed for deploying HTML content to EdgeOne Pages and obtaining an accessible public URL.

880. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 409
...
881. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 404
   The safest way to make REST calls in C# with an MCP Generator

882. **[Lynkr](https://github.com/Fast-Editor/Lynkr)** - ⭐ 404
   Streamline your workflow with Lynkr, a CLI tool that acts as an HTTP proxy for efficient code interactions using Claude Code CLI.

883. **[claude-code-skills](https://github.com/levnikolaevich/claude-code-skills)** - ⭐ 404
...
884. **[distributed-load-testing-on-aws](https://github.com/aws-solutions/distributed-load-testing-on-aws)** - ⭐ 403
...
885. **[everything-claude-code-zh](https://github.com/xu-xiang/everything-claude-code-zh)** - ⭐ 403
...
886. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 402
   An example agent demonstrating streaming, tool use, and interactivity from your terminal. This agent builder can help you to build your own agents and tools.

887. **[Security-Detections-MCP](https://github.com/MHaggis/Security-Detections-MCP)** - ⭐ 401
   MCP to help Defenders Detection Engineer Harder and Smarter

888. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 400
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

889. **[open-skills](https://github.com/instavm/open-skills)** - ⭐ 400
   OpenSkills: Run Claude Skills Locally using any LLM

890. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 400
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

891. **[Proxima](https://github.com/Zen4-bit/Proxima)** - ⭐ 400
   Multi-AI MCP Server - Connect ChatGPT, Claude, Gemini & Perplexity to your coding tools without any API

892. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 399
   An implementation of Model Context Protocol (MCP) server for Argo CD.

893. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 397
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

894. **[travel-hacking-toolkit](https://github.com/borski/travel-hacking-toolkit)** - ⭐ 397
...
895. **[pi-mcp-adapter](https://github.com/nicobailon/pi-mcp-adapter)** - ⭐ 396
   Token-efficient MCP adapter for Pi coding agent

896. **[mcp](https://github.com/mondaycom/mcp)** - ⭐ 395
   Enable AI agents to work reliably - giving them secure access to structured data, tools to take action, and the context needed to make smart decisions.

897. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 394
   An experiment in software planning using MCP

898. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 394
...
899. **[mcp-code-graph](https://github.com/JudiniLabs/mcp-code-graph)** - ⭐ 392
   MCP Server for code graph analysis and visualization by CodeGPT

900. **[station](https://github.com/cloudshipai/station)** - ⭐ 391
   Station is our open-source runtime that lets teams deploy agents on their own infrastructure with full control.

901. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 391
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

902. **[Agentfy](https://github.com/Agentfy-io/Agentfy)** - ⭐ 391
...
903. **[memora](https://github.com/agentic-box/memora)** - ⭐ 391
   Give your AI agents persistent memory.

904. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 390
   Local Groq Desktop chat app with MCP support

905. **[polymarket-mcp-server](https://github.com/caiovicentino/polymarket-mcp-server)** - ⭐ 390
   🤖 AI-Powered MCP Server for Polymarket - Enable Claude to trade prediction markets with 45 tools, real-time monitoring, and enterprise-grade safety features

906. **[mcp-server](https://github.com/e2b-dev/mcp-server)** - ⭐ 389
   Giving Claude ability to run code with E2B via MCP (Model Context Protocol)

907. **[stitch](https://github.com/gemini-cli-extensions/stitch)** - ⭐ 389
   The Stitch extension for Gemini CLI enables you to interact with the Stitch MCP server using natural language commands. 

908. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 389
...
909. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 388
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

910. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 388
   An MCP server for loading skills (shim for non-claude clients).

911. **[agentshield](https://github.com/affaan-m/agentshield)** - ⭐ 388
   AI agent security scanner. Detect vulnerabilities in agent configurations, MCP servers, and tool permissions. Available as CLI, GitHub Action, ECC plugin, and GitHub App integration. 🛡️

912. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 386
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

913. **[lsbot](https://github.com/ruilisi/lsbot)** - ⭐ 386
   Lean & Secure Bot

914. **[todoist-mcp-server](https://github.com/abhiz123/todoist-mcp-server)** - ⭐ 386
   MCP server for Todoist integration enabling natural language task management with Claude

915. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 386
   An MCP implementation for Selenium WebDriver

916. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 386
   MCP server for JADX-AI Plugin

917. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 386
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

918. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 385
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

919. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 385
   F2C MCP Server

920. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 384
   Control your Android devices with AI using Model Context Protocol

921. **[automation-mcp](https://github.com/ashwwwin/automation-mcp)** - ⭐ 383
   Control your Mac with detailed mouse, keyboard, screen, and window management capabilities.

922. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 383

923. **[mq](https://github.com/harehare/mq)** - ⭐ 383
   A jq-like Markdown query language for command-line processing

924. **[clawreins](https://github.com/pegasi-ai/clawreins)** - ⭐ 383
   Runtime security for OpenClaw agents. Scan, fix, monitor.

925. **[n8n-claw](https://github.com/freddy-schuetz/n8n-claw)** - ⭐ 383
...
926. **[Context-Engine](https://github.com/Context-Engine-AI/Context-Engine)** - ⭐ 382
   Context-Engine MCP - Agentic Context Compression Suite

927. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 382
   A centralized reverse-proxy platform for MCP servers — manage, group, and export as Skills from a single endpoint.

928. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 380
   Model Context Protocol server for GraphQL

929. **[mcp-k8s-go](https://github.com/strowk/mcp-k8s-go)** - ⭐ 379
   MCP server connecting to Kubernetes

930. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 379
   Xiaozhi MCP sample program

931. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 379
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

932. **[bagel](https://github.com/Extelligence-ai/bagel)** - ⭐ 378
   Chat with your robotics, drone, and IoT data — ChatGPT for the physical world.

933. **[sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh)** - ⭐ 378
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

934. **[skylos](https://github.com/duriantaco/skylos)** - ⭐ 378
...
935. **[google-ads-mcp](https://github.com/googleads/google-ads-mcp)** - ⭐ 378

936. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 377
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

937. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 377
   Talk with your notes in Claude. RAG over your Apple Notes using Model Context Protocol.

938. **[skillport](https://github.com/gotalab/skillport)** - ⭐ 377
   Bring Agent Skills to Any AI Agent and Coding Agent — via CLI or MCP. Manage once, serve anywhere.

939. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 376
   A macOS AppleScript MCP server

940. **[tentix](https://github.com/labring/tentix)** - ⭐ 376
...
941. **[daymon](https://github.com/daymonio/daymon)** - ⭐ 375
   Daymon puts your favorite AI to work 24/7. It schedules, remembers, and orchestrates your own virtual team. Free.

942. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 375
   MCP Server implementation for Ableton Live OSC control

943. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 375
   MCP server for searching and retrieving Claude Agent Skills using vector search

944. **[garmin_mcp](https://github.com/Taxuspt/garmin_mcp)** - ⭐ 375
   MCP server to access Garmin data

945. **[graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server)** - ⭐ 374
   Model Context Protocol (MCP) Server for Graphlit Platform

946. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 374
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

947. **[mnemo](https://github.com/MnemoAI/mnemo)** - ⭐ 374
   A MCP-Ready Intelligence Engine for Data & Agent-as-a-Service.

948. **[RenderDocMCP](https://github.com/halby24/RenderDocMCP)** - ⭐ 374

949. **[evm-mcp-server](https://github.com/mcpdotdirect/evm-mcp-server)** - ⭐ 373
   MCP server that provides LLMs with tools for interacting with EVM networks

950. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 373
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

951. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 372
   Docfork MCP - Up-to-date Docs for AI Agents.

952. **[memorix](https://github.com/AVIDS2/memorix)** - ⭐ 372
...
953. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 371
   MCP Server implementation for Xcode integration

954. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 371
   MCP server retrieving transcripts of YouTube videos

955. **[lingti-bot](https://github.com/ruilisi/lingti-bot)** - ⭐ 370
   🐕⚡「极简至上 效率为王 秒级接入 一链即用」的 AI Bot

956. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 369
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

957. **[PlanExe](https://github.com/PlanExeOrg/PlanExe)** - ⭐ 369
   Create a plan from a description in minutes

958. **[mcp2mqtt](https://github.com/mcp2everything/mcp2mqtt)** - ⭐ 368
   本项目通过将 MCP 协议转换为 MQTT 协议，我们能够利用强大的大型语言模型（LLMs），就能轻松操控您的智能家居、机器人或其他硬件设备。

959. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 368
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

960. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 368
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

961. **[devopness](https://github.com/devopness/devopness)** - ⭐ 366
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

962. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 366
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

963. **[mcp](https://github.com/IBM/mcp)** - ⭐ 366
   A collection of Model Context Protocol (MCP) servers, clients and developer tools by IBM.

964. **[opentabs](https://github.com/opentabs-dev/opentabs)** - ⭐ 366
   Browser automation clicks buttons. OpenTabs calls APIs.

965. **[VTCode](https://github.com/vinhnx/VTCode)** - ⭐ 365
   VT Code - Semantic coding agent in the terminal

966. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 365
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

967. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 365
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

968. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 365
   Model Context Protocol SDK for PHP

969. **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** - ⭐ 365
...
970. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 364
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

971. **[CAAL](https://github.com/CoreWorxLab/CAAL)** - ⭐ 364
   Local voice assistant that learns new abilities via auto-discovered n8n workflows exposed as tools via MCP

972. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 364
   Elixir Model Context Protocol (MCP) SDK

973. **[mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops)** - ⭐ 363
   An MCP server for Azure DevOps

974. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 362
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

975. **[apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server)** - ⭐ 361
   A MCP Server for APK Tool (Part of Android Reverse Engineering MCP Suites)

976. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 361
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

977. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 360
   Lean Theorem Prover MCP

978. **[robloxstudio-mcp](https://github.com/boshyxd/robloxstudio-mcp)** - ⭐ 360
   Create agentic AI workflows in ROBLOX Studio

979. **[run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda)** - ⭐ 359
   Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda functions

980. **[studio](https://github.com/decocms/studio)** - ⭐ 358
   Open-source control plane for your AI agents. Connect tools, hire agents, track every token and dollar

981. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 358
...
982. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 358
...
983. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 357
   deep, reliable and confidential coding-context

984. **[pinion-os](https://github.com/chu2bard/pinion-os)** - ⭐ 357
   Client SDK, Claude plugin and skill framework for the Pinion protocol. x402 micropayments on Base.

985. **[Gearsystem](https://github.com/drhelius/Gearsystem)** - ⭐ 357
   Sega Master System / Game Gear / SG-1000 emulator, debugger and embedded MCP server for macOS, Windows, Linux, BSD and RetroArch.

986. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 356
   MCP server for Bazi (八字) information

987. **[vtcode](https://github.com/vinhnx/vtcode)** - ⭐ 355
   VT Code - Semantic coding agent in the terminal

988. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 355
   MCP Server for interacting with Salesforce instances

989. **[hookdeck-cli](https://github.com/hookdeck/hookdeck-cli)** - ⭐ 353
...
990. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 352
   BloodHound-MCP-AI is integration that connects BloodHound with AI through Model Context Protocol, allowing security professionals to analyze Active Directory attack paths using natural language instead of complex Cypher queries.

991. **[swarmclaw](https://github.com/swarmclawai/swarmclaw)** - ⭐ 352
...
992. **[zypher-agent](https://github.com/corespeed-io/zypher-agent)** - ⭐ 351
   A minimal yet powerful framework for creating AI agents with full control over tools, providers, and execution flow.

993. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 350

994. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 348
   RhinoMCP connects Rhino 3D to AI Agent through the Model Context Protocol (MCP)

995. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 347
   AI-Powered Revit Modeling

996. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 347
   MCP server to expose VS Code editing features to an LLM for AI coding

997. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 344
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

998. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 344
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

999. **[minthcm](https://github.com/minthcm/minthcm)** - ⭐ 344
   First AI‑enabled open-source Human Capital Management system that you can start using today.

1000. **[boltmcp](https://github.com/boltmcp/boltmcp)** - ⭐ 343

1001. **[mcp](https://github.com/cloudflare/mcp)** - ⭐ 343
   MCP server for the Cloudflare API

1002. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 342
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

1003. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 342
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

1004. **[Aegis](https://github.com/Justin0504/Aegis)** - ⭐ 341
...
1005. **[MaaMCP](https://github.com/MAA-AI/MaaMCP)** - ⭐ 341
   基于 MaaFramework 的 MCP 服务器 为 AI 助手提供 Android 设备和 Windows 桌面自动化能力

1006. **[mcp-database-server](https://github.com/executeautomation/mcp-database-server)** - ⭐ 341
   MCP Database Server is a new MCP Server which helps connect with Sqlite, SqlServer and Posgresql Databases

1007. **[agent-skills](https://github.com/microsoft/agent-skills)** - ⭐ 340
   Skills, MCP servers, Custom Coding Agents, Agents.md for SDKs to ground Coding Agents

1008. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 340
...
1009. **[real-estate-mcp](https://github.com/tae0y/real-estate-mcp)** - ⭐ 340
   🏠 Ask Claude about Korean apartment prices — powered by 국토교통부 open API

1010. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 340
   MCP server for Claude to access Outlook data via Microsoft Graph API

1011. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 340
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

1012. **[MemoryMesh](https://github.com/CheMiguel23/MemoryMesh)** - ⭐ 339
   A knowledge graph server that uses the Model Context Protocol (MCP) to provide structured memory persistence for AI models.

1013. **[gptr-mcp](https://github.com/assafelovic/gptr-mcp)** - ⭐ 339
   MCP server for enabling LLM applications to perform deep research via the MCP protocol

1014. **[mcsmcp](https://github.com/microsoft/mcsmcp)** - ⭐ 338
   Lab for creating an MCP Server and using it in Microsoft Copilot Studio.

1015. **[mesh](https://github.com/decocms/mesh)** - ⭐ 337
   One secure endpoint for every MCP server. Deploy anywhere.

1016. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 336
   Example of an MCP server with custom tools that can be called directly from cursor

1017. **[moling](https://github.com/gojue/moling)** - ⭐ 336
   MoLing is a computer-use and browser-use based MCP server. It is a locally deployed, dependency-free office AI assistant.

1018. **[mssql_mcp_server](https://github.com/RichardHan/mssql_mcp_server)** - ⭐ 336
...
1019. **[wexin-read-mcp](https://github.com/Bwkyd/wexin-read-mcp)** - ⭐ 335
   能够让大模型阅读微信公众号文章，使用浏览器模拟绕过反爬虫。

1020. **[open-mcp](https://github.com/wegotdocs/open-mcp)** - ⭐ 333

1021. **[laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server)** - ⭐ 332
   A Laravel package for implementing secure Model Context Protocol servers using Streamable HTTP and SSE transport, providing real-time communication and a scalable tool system for enterprise environments.

1022. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 332
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

1023. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 331
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

1024. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 331
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

1025. **[tinystruct](https://github.com/tinystruct/tinystruct)** - ⭐ 331
...
1026. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 331
   Mapbox Model Context Protocol (MCP) server

1027. **[redd-archiver](https://github.com/19-84/redd-archiver)** - ⭐ 330
...
1028. **[css-mcp](https://github.com/stolinski/css-mcp)** - ⭐ 330

1029. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 329
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

1030. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 328
   IAM Policy Autopilot is an open source static code analysis tool that helps you quickly create baseline AWS IAM policies that you can refine as your application evolves. This tool is available as a command-line utility and MCP server for use within AI coding assistants for quickly building IAM policies.

1031. **[pipelock](https://github.com/luckyPipewrench/pipelock)** - ⭐ 327
...
1034. **[ida-mcp-rs](https://github.com/blacktop/ida-mcp-rs)** - ⭐ 325
   Headless IDA Pro MCP Server

1035. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 324
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

1036. **[ssh-mcp-server](https://github.com/classfang/ssh-mcp-server)** - ⭐ 324
   基于 SSH 的 MCP 服务 🧙‍♀️。已被MCP官方收录 🎉。 SSH MCP Server 🧙‍♀️. It has been included in the community MCP repository 🎉.

1037. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 324
   Semantic code searcher and codebase utility

1038. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 323
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

1039. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 323
   Source code of minecraft 1.12

1040. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 323
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

1041. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 323
   A Model Context Protocol server for building an investor agent

1042. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 322
...
1043. **[emcee](https://github.com/mattt/emcee)** - ⭐ 321
   MCP generator for OpenAPIs 🫳🎤💥

1044. **[cymbal-air-toolbox-demo](https://github.com/GoogleCloudPlatform/cymbal-air-toolbox-demo)** - ⭐ 321
...
1045. **[napi](https://github.com/nanoapi-io/napi)** - ⭐ 321
   Software architecture tooling for the AI age

1046. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 320

1047. **[pydantic-resolve](https://github.com/allmonday/pydantic-resolve)** - ⭐ 319
   A universal data composition tool that generates JSON RPC, GraphQL, and even MCP.

1048. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 319
   An MCP server to create secure code sandbox environment for executing code within Docker containers. This MCP server provides AI applications with a safe and isolated environment for running code while maintaining security through containerization.

1049. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 318
   This is a Minecraft Base Client

1050. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 318
...
1051. **[deep-research-mcp](https://github.com/teelaitila/deep-research-mcp)** - ⭐ 317

1052. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 317
   Repo of skills for autogen studio using model context protocol (mcp)

1053. **[telegram-mcp](https://github.com/chaindead/telegram-mcp)** - ⭐ 317
   Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.

1054. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 316
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

1055. **[generator](https://github.com/context-hub/generator)** - ⭐ 316
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

1056. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 316
   Model Context Protocol server for DeepSeek's advanced language models

1057. **[gemini-kit](https://github.com/nth5693/gemini-kit)** - ⭐ 314
   🚀 19 AI Agents + 44 Commands for Gemini CLI - Code 10x faster with auto planning, testing, review & security

1058. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 314
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1059. **[coolify-mcp](https://github.com/StuMason/coolify-mcp)** - ⭐ 314
   MCP server for Coolify — 38 optimized tools for managing self-hosted PaaS through AI assistants

1060. **[octo-terminal-releases](https://github.com/johunsang/octo-terminal-releases)** - ⭐ 313
...
1061. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 313

1062. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 313
   MCP server for Windows OS automation

1063. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 313
   Django MCP Server is a Django extensions to easily enable AI Agents to interact with Django Apps through the Model Context Protocol it works equally well on WSGI and ASGI

1064. **[agents](https://github.com/astronomer/agents)** - ⭐ 312
   AI agent tooling for data engineering workflows.

1065. **[openclaw-claude-code](https://github.com/Enderfga/openclaw-claude-code)** - ⭐ 312
...
1066. **[PerformanceMonitor](https://github.com/erikdarlingdata/PerformanceMonitor)** - ⭐ 312
...
1067. **[vmlx](https://github.com/jjang-ai/vmlx)** - ⭐ 312
   vMLX - Home of JANG_Q - Cont Batch, Prefix, Paged, KV Cache Quant, VL - Powers MLX Studio. Image gen/edit, OpenAI/Anth

1068. **[opencode-studio](https://github.com/Microck/opencode-studio)** - ⭐ 311
   web GUI for securely managing local OpenCode configuration

1069. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 309

1070. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 309
...
1071. **[mcp-server-12306](https://github.com/drfccv/mcp-server-12306)** - ⭐ 308
   12306 MCP Server​​ 是一个基于 ​​Model Context Protocol (MCP)​​ 的高性能火车票查询后端系统。它通过标准化接口提供官方 12306 的实时数据服务，包括余票查询、车站信息、列车经停站、中转换乘方案等核心功能。

1072. **[token-savior](https://github.com/Mibayy/token-savior)** - ⭐ 307
...
1073. **[nanobanana-mcp-server](https://github.com/zhongweili/nanobanana-mcp-server)** - ⭐ 306
   AI image generation MCP server powered by Google Gemini, with smart model selection and 4K output

1074. **[ddddocr](https://github.com/86maid/ddddocr)** - ⭐ 305
...
1075. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 305
   Turn any openapi file into an mcp server, with just the tools you need.

1076. **[sdk](https://github.com/smithery-ai/sdk)** - ⭐ 305
   Smithery helps AI agents access external services via a unified gateway.

1077. **[mcp-neovim-server](https://github.com/bigcodegen/mcp-neovim-server)** - ⭐ 305
   Control Neovim using Model Context Protocol (MCP) and the official neovim/node-client JavaScript library

1078. **[AIDA](https://github.com/Vasco0x4/AIDA)** - ⭐ 305
   AI-Driven Security Assessment - Connect AI to 400+ pentesting tools via MCP

1079. **[appium-mcp](https://github.com/appium/appium-mcp)** - ⭐ 305
   Appium MCP on Steroids!

1080. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 305
...
1081. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 305
   api router for MCP Servers

1082. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 305
   CAD MCP Server

1083. **[mcp-linker](https://github.com/milisp/mcp-linker)** - ⭐ 304
   mcp store manager, add & syncs MCP server configurations across clients like Claude code, Cursor💡mcphub

1084. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 304
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

1085. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 303
   A working pattern for SSE-based MCP clients and servers

1086. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 303
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

1087. **[imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp)** - ⭐ 303
   An MCP server providing tools for image processing operations

1088. **[DebugMCP](https://github.com/microsoft/DebugMCP)** - ⭐ 303
   Gift your VS Code agent a real debugger: breakpoints, stepping, inspection.

1089. **[Lucid](https://github.com/get-Lucid/Lucid)** - ⭐ 302
   An intelligence layer grounding autonomous agents in verified, real-time knowledge at scale.

1090. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 302
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

1091. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 302
   Obsidian MCP (Model Context Protocol) Server

1092. **[codemogger](https://github.com/glommer/codemogger)** - ⭐ 302
   Codemogger is a code indexing library and MCP server for AI coding agents

1093. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 301
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

1094. **[Dex](https://github.com/davekilleen/Dex)** - ⭐ 301
   Your AI Chief of Staff — a personal operating system starter kit that adapts to your role. No coding required.

1095. **[meta-ads-analyzer](https://github.com/mathiaschu/meta-ads-analyzer)** - ⭐ 300
   Meta Ads Analyzer skill + MCP server for Claude Code. Breakdown Effect, Learning Phase, and expert-level campaign diagnosis.

1096. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 299
   Agentic RAG for any scenario. Customize sources, depth, and width

1097. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 299
   An MCP server for Massive.com Financial Market Data

1098. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 299
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

1099. **[daan](https://github.com/pluveto/daan)** - ⭐ 298
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

1100. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 298
   MCP Server for Odoo

1101. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 298
   MCP implementation of Claude Code capabilities and more

1102. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 298
   SpringAI，LLM，MCP，Embedding

1103. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 298
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

1104. **[certctl](https://github.com/shankar0123/certctl)** - ⭐ 297
...
1105. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 296
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

1106. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 296
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

1107. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 296
   Discover Exceptional MCP Servers

1108. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 296
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

1109. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 295
   The specification for the Universal Tool Calling Protocol

1110. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 295
...
1111. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 295
   Minimal MCP Server for Aider

1112. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 294
   Lightweight MCP server for Spotify

1113. **[consult7](https://github.com/szeider/consult7)** - ⭐ 293
   MCP server to consult a language model with large context size

1114. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 292
...
1115. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 292
...
1116. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 291

1117. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 291

1118. **[perplexity-mcp](https://github.com/jsonallen/perplexity-mcp)** - ⭐ 291
   A Model Context Protocol (MCP) server that provides web search functionality using Perplexity AI's API.

1119. **[EDDI](https://github.com/labsai/EDDI)** - ⭐ 291
...
1120. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 291
   MCP Server for Tree-sitter

1121. **[agency-orchestrator](https://github.com/jnMetaCode/agency-orchestrator)** - ⭐ 291
...
1122. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 290
   Standardized environment infrastructure for Agentic AI development.

1123. **[pageindex-mcp](https://github.com/VectifyAI/pageindex-mcp)** - ⭐ 290
...
1124. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 290
   MCP stdio server for frida

1125. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 289
...
1126. **[claude-code-tool-manager](https://github.com/tylergraydev/claude-code-tool-manager)** - ⭐ 289
   GUI app to manage MCP servers for Claude Code

1127. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 289
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1128. **[nova-proximity](https://github.com/Nova-Hunting/nova-proximity)** - ⭐ 287
   Nova-Proximity is a MCP and Agent Skills security scanner powered with NOVA

1129. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 287
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

1130. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 287
...
1131. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 286
   MCP server for OpenAI o3 web search

1132. **[mcp-manager](https://github.com/amxv/mcp-manager)** - ⭐ 286
   simple web ui to manage mcp (model context protocol) servers in the claude app

1133. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 286
   Home Assistant MCP Server

1134. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 286
...
1135. **[desktop](https://github.com/agentify-sh/desktop)** - ⭐ 286
...
1136. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 285
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

1137. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 285
   Code to process many kinds of content by an author into an MCP server

1138. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 284
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

1139. **[alfanous](https://github.com/Alfanous-team/alfanous)** - ⭐ 284
   Alfanous is an Arabic search engine API provides the simple and advanced search in Quran , more features and many interfaces...

1140. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 284
   MCP server for browser automation using Playwright

1141. **[awesome-fintech](https://github.com/moov-io/awesome-fintech)** - ⭐ 284
   A curated collection of open source fintech libraries and resources.

1142. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 284
   A list of open-source AI projects you can use to generate income easily.

1143. **[deeppowers](https://github.com/deeppowers/deeppowers)** - ⭐ 283
...
1144. **[laravel-claude-code-setup](https://github.com/laraben/laravel-claude-code-setup)** - ⭐ 283
   One-command setup for AI-powered Laravel development with Claude Code and MCP servers

1145. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 282
   Bringing Human Capabilities to AI Agents

1146. **[unity-cli-loop](https://github.com/hatayama/unity-cli-loop)** - ⭐ 282
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1147. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 282
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

1148. **[agentic-ai-apis](https://github.com/cporter202/agentic-ai-apis)** - ⭐ 282
...
1149. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 282
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

1150. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 281
   Agentic RAG for any scenario. Customize sources, depth, and width

1151. **[jcode](https://github.com/1jehuang/jcode)** - ⭐ 281
   Coding Agent Harness

1152. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 281
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1153. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 280
   simple web ui to manage mcp (model context protocol) servers in the claude app

1154. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 280
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

1155. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 280
   Apache Doris MCP Server

1156. **[MCP-handle](https://github.com/WeatherPal-AI/MCP-handle)** - ⭐ 278
   MCP integration platforms making AI-Agents developers focusing on their own tasks

1157. **[kindly-web-search-mcp-server](https://github.com/Shelpuk-AI-Technology-Consulting/kindly-web-search-mcp-server)** - ⭐ 278
...
1158. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 277
   Apollo MCP Server

1159. **[next-lens](https://github.com/1weiho/next-lens)** - ⭐ 277
   A CLI that scans Next.js routes and provides quick insights from your terminal, web UI, and MCP.

1160. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 277
   A Model Context Protocol Server for MongoDB

1161. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 277
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

1162. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 277
   Model Context Protocol server implementation for Reddit

1163. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 277
   Volcengine MCP Servers

1164. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 276
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

1165. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 276
   Context-Engine MCP - Agentic Context Compression Suite

1166. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 276
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

1167. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 275
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

1168. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 275
   Model Context Protocol (MCP) Server for dify workflows

1169. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 275
   MCP server for TouchDesigner

1170. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 274
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

1171. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 274
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

1172. **[STS2MCP](https://github.com/Gennadiyev/STS2MCP)** - ⭐ 273
   Full agentic runs for Slay the Spire 2. A mod that exposes in-game state, and the MCP server for the mod.

1173. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 272
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

1174. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 272
   This MCP server provides documentation about Strands Agents to your GenAI tools, so you can use your favorite AI coding assistant to vibe-code Strands Agents.

1175. **[proximity](https://github.com/Nova-Hunting/proximity)** - ⭐ 271
   Proximity is a MCP security scanner powered with NOVA

1176. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 271
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

1177. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 271
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1178. **[BitFun](https://github.com/GCWing/BitFun)** - ⭐ 270
...
1179. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 270
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

1180. **[vibing-steampunk](https://github.com/oisee/vibing-steampunk)** - ⭐ 270
   vs-punk: ADT to MCP bridge - Vibe code in ABAP / AMDP

1181. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 270
   Lightweight agent orchestration dev tool that lives in your repo

1182. **[jinni](https://github.com/smat-dev/jinni)** - ⭐ 269
   Bring your project into LLM context - tool and MCP server

1183. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 269
   Proximity is a MCP security scanner powered with NOVA

1184. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 269
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

1185. **[ai-agents-from-zero](https://github.com/didilili/ai-agents-from-zero)** - ⭐ 268
...
1186. **[api-agent](https://github.com/agoda-com/api-agent)** - ⭐ 268
   Universal MCP server for GraphQL/REST APIs

1187. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 268

1188. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 268
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

1189. **[oreilly-ai-agents](https://github.com/sinanuozdemir/oreilly-ai-agents)** - ⭐ 267
   An introduction to the world of AI Agents

1190. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 266
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

1191. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 265
   小智AI客户端，目前主要用于MCP的对接

1192. **[flyto-core](https://github.com/flytohub/flyto-core)** - ⭐ 265
   The open-source execution engine for AI agents. 412 modules, MCP-native, triggers, queue, versioning, metering.

1193. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 265
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

1194. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 265
   A collection of MCP servers

1195. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 264
...
1196. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 264
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

1197. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 263
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1198. **[domain-check](https://github.com/saidutt46/domain-check)** - ⭐ 261
...
1199. **[Ori-Mnemos](https://github.com/aayoawoyemi/Ori-Mnemos)** - ⭐ 261
   Local-first persistent agentic memory powered by Recursive Memory Harness (RMH). Open source must win.

1200. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 260
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

1201. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 259
...
1202. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 259
   A MCP server for our beloved terminal multiplexer tmux.

1203. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 259
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1204. **[corpusos](https://github.com/Corpus-OS/corpusos)** - ⭐ 258
...
1205. **[agentrove](https://github.com/Mng-dev-ai/agentrove)** - ⭐ 258
...
1206. **[h1-brain](https://github.com/PatrikFehrenbach/h1-brain)** - ⭐ 258
   MCP server that connects AI assistants to HackerOne for bug bounty hunting

1207. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 258
   AWS MCP Proxy Server

1208. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 258
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

1209. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 257
...
1210. **[api200](https://github.com/API-200/api200)** - ⭐ 256
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

1211. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 256
...
1212. **[swiss-ai-call-agent](https://github.com/Chrissotino/swiss-ai-call-agent)** - ⭐ 256
...
1213. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 255
   A code reasoning MCP server, a fork of sequential-thinking

1214. **[agent-craft](https://github.com/Annyfee/agent-craft)** - ⭐ 255
   AI Agent 教学仓库 | 系统化 LangChain、RAG、LangGraph、MCP 全栈实战代码 | 万字博客详解 | 开源可运行示例 | 从零构建智能体

1215. **[claude-code-organizer](https://github.com/mcpware/claude-code-organizer)** - ⭐ 255
...
1216. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 254
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

1217. **[agentregistry](https://github.com/agentregistry-dev/agentregistry)** - ⭐ 254
   Fast-track AI innovation with a centralized, trusted, curated registry

1218. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 254
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

1219. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 254
   Lightweight C++ MCP (Model Context Protocol) SDK

1220. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

1221. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 253
...
1222. **[medusa](https://github.com/Pantheon-Security/medusa)** - ⭐ 253
...
1223. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 252
...
1224. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 252
   hydra-ai

1225. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 251
   Zerodha Kite MCP server

1226. **[unifi-mcp](https://github.com/sirkirby/unifi-mcp)** - ⭐ 251
   MCP servers for the UniFi suite of applications, Network, Protect, Access, and Drive

1227. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 251
   A SEC EDGAR MCP (Model Context Protocol) Server

1228. **[ThinkWatch](https://github.com/ThinkWatchProject/ThinkWatch)** - ⭐ 251
...
1229. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 250
   Penpot's official MCP Server

1230. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 250
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

1231. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 250
   A TypeScript streamable HTTP and SSE proxy for MCP servers that use stdio transport.

1232. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 249
   MCP server implementation for Google's Gemini API

1233. **[forgetful](https://github.com/ScottRBK/forgetful)** - ⭐ 249
   Opensource Memory for Agents

1234. **[call.md](https://github.com/video-db/call.md)** - ⭐ 249
...
1235. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 249
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1236. **[MoltBrain](https://github.com/nhevers/MoltBrain)** - ⭐ 248
   Long-term memory layer for OpenClaw & MoltBook agents that learns and recalls your project context automatically.

1237. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 248
   MCP server(s) for Aipolabs ACI.dev

1238. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 248
   MCP Interface for Video Jungle

1239. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 248
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

1240. **[JoySafeter](https://github.com/jd-opensource/JoySafeter)** - ⭐ 248
...
1241. **[claude-recall](https://github.com/nhevers/claude-recall)** - ⭐ 247
   Long-term memory layer for MoltBot & Claude Code that learns and recalls your project context automatically

1242. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 247
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

1243. **[dat](https://github.com/hexinfo/dat)** - ⭐ 247
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

1244. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 247
   Turn any MCP server into a Python module

1245. **[data-go-mcp-servers](https://github.com/Koomook/data-go-mcp-servers)** - ⭐ 247
   Korea public data portal (data.go.kr) API MCP servers

1246. **[polymarket-paper-trader](https://github.com/agent-next/polymarket-paper-trader)** - ⭐ 246
...
1247. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 245
...
1248. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 245
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1249. **[vurb.ts](https://github.com/vinkius-labs/vurb.ts)** - ⭐ 245
...
1250. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 245
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1251. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 244
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

1252. **[chat-mcp](https://github.com/AI-QL/chat-mcp)** - ⭐ 244
   A Desktop Chat App that leverages MCP(Model Context Protocol) to interface with other LLMs.

1253. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 244
   🔥 Model Context Protocol (MCP) server for Firebase.

1254. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 244
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

1255. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 244
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1256. **[embodied-claude](https://github.com/lifemate-ai/embodied-claude)** - ⭐ 243
   Claudeに身体性を与えるMCP群

1257. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 243
   The evaluation benchmark on MCP servers

1258. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 243
   An experimental MCP Server for foundry built for Solidity devs

1259. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 243
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

1260. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 242
...
1261. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 242
   MCP Server for Telegram

1262. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 242
   Code Runner MCP Server

1263. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 241
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

1264. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 241
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

1265. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 241
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

1266. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 241
   MCP Server for ServiceNow

1267. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 240
   Simplified Gemini for Claude Code. 

1268. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 240
   Easy guide to installing Claude Code MCPs globally on your machine.

1269. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 240
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

1270. **[mcp-foundry](https://github.com/microsoft-foundry/mcp-foundry)** - ⭐ 240
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

1271. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 239
   Playwright MCP fork that works with Cloudflare Browser Rendering

1272. **[PIXRA](https://github.com/dodufish/PIXRA)** - ⭐ 239
   Pixelize the real world on-chain

1273. **[AgentRecall](https://github.com/Goldentrii/AgentRecall)** - ⭐ 239
...
1274. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 238

1275. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 238
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

1276. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 238
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

1277. **[google-meta-ads-ga4-mcp](https://github.com/irinabuht12-oss/google-meta-ads-ga4-mcp)** - ⭐ 238
...
1278. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 236
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

1279. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 236
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

1280. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 236
...
1281. **[marionette_mcp](https://github.com/leancodepl/marionette_mcp)** - ⭐ 236
...
1282. **[lokka](https://github.com/merill/lokka)** - ⭐ 236
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

1283. **[claude-config-editor](https://github.com/gagarinyury/claude-config-editor)** - ⭐ 236
...
1284. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 235
...
1285. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 235
   Tableau's official MCP Server. Helping Agents see and understand data.

1286. **[mcp-dev-latam](https://github.com/codespar/mcp-dev-latam)** - ⭐ 235
   MCP servers for Brazilian services — payments, fiscal, banking, communication. Generated by CodeSpar.

1287. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 234
   MCP server for Anki via AnkiConnect

1288. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 233
   Model Context Protocol for x64dbg & x32dbg

1289. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 232
   A Model Context Protocol (MCP) server that enables natural language queries to databases

1290. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 232
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

1291. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 232
...
1292. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 232
...
1293. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 232
...
1294. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 231
   Creates a simple MCP tool server with "streaming" HTTP.

1295. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 231
   A Model Context Protocol (MCP) server for interacting with Twitter.

1296. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 231
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1297. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 231
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

1298. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 230
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

1299. **[remote-swe-agents](https://github.com/aws-samples/remote-swe-agents)** - ⭐ 230
   Autonomous SWE agent working in the cloud!

1300. **[domainstack.io](https://github.com/jakejarvis/domainstack.io)** - ⭐ 230
   🧰 All-in-one domain name intelligence as a service

1301. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 229
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

1302. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 229
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

1303. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 229
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1304. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 228
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

1305. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 228
...
1306. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

1307. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 227
...
1308. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 227
   Penpot MCP server

1309. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 227
   mindmap, mcp server, artifact

1310. **[Windows-MCP.Net](https://github.com/shuyu-labs/Windows-MCP.Net)** - ⭐ 227
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

1311. **[jebmcp](https://github.com/flankerhqd/jebmcp)** - ⭐ 227

1312. **[mcp-engine-public](https://github.com/maxanatsko/mcp-engine-public)** - ⭐ 227
...
1313. **[godot-mcp-pro](https://github.com/youichi-uda/godot-mcp-pro)** - ⭐ 227
...
1314. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 226
   Model Context Protocol Servers for Milvus

1315. **[LycheeMem](https://github.com/LycheeMem/LycheeMem)** - ⭐ 226
   Lightweight Long-Term Memory for LLM Agents.

1316. **[novamira](https://github.com/use-novamira/novamira)** - ⭐ 226
   MCP server that gives AI agents full access to WordPress through PHP execution and filesystem operations

1317. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 225
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

1318. **[agent-skills](https://github.com/jdrhyne/agent-skills)** - ⭐ 225
   A collection of AI agent skills for Clawdbot, Claude Code, Codex

1319. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 225
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1320. **[CoWork-OS](https://github.com/CoWork-OS/CoWork-OS)** - ⭐ 225
...
1321. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 224
   Model Context Protocol server to run commands (tool: `runProcess`)

1322. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 224
   Your own Claude Code UI, sandbox, in-browser VS Code, terminal, multi-provider support (Anthropic, OpenAI, GitHub Copilot, OpenRouter), custom skills, and MCP servers.

1323. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 224
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

1324. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 224
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

1325. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 224
   Homeassistant MCP server for 小智AI

1326. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 223
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

1327. **[skyll](https://github.com/assafelovic/skyll)** - ⭐ 223
   A tool for autonomous agents like OpenClaw to discover and learn skills autonomously

1328. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 223
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

1329. **[AutoResearch-SibylSystem](https://github.com/Sibyl-Research-Team/AutoResearch-SibylSystem)** - ⭐ 223
   Fully Autonomous AI Research System with Self-Evolution, built natively on Claude Code

1330. **[arcticdb_mcp](https://github.com/YMuskrat/arcticdb_mcp)** - ⭐ 222
   MCP server for ArcticDB

1331. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 222

1332. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 222
...
1333. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 222

1334. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 222
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

1335. **[ATaC](https://github.com/ATaC-team/ATaC)** - ⭐ 222
   Record and Replay AI Agent Trajectories.

1336. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 222
   Local-first RAG server for developers. Semantic + keyword search for code and technical docs. Works with MCP or CLI. Fully private, zero setup.

1337. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 221

1338. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 220
   Hugging Face MCP Server

1339. **[godot-mcp](https://github.com/tomyud1/godot-mcp)** - ⭐ 220
   MCP Server and Godot Plugin for AI-assisted game development

1340. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 220
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1341. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
1342. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 219
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

1343. **[mcp-dev-brasil](https://github.com/codespar/mcp-dev-brasil)** - ⭐ 219
   MCP servers for Brazilian services — payments, fiscal, banking, communication. Generated by CodeSpar.

1344. **[registry-broker-skills](https://github.com/hashgraph-online/registry-broker-skills)** - ⭐ 219
   AI agent skills for the Universal Registry - search, chat, and register 72,000+ agents across 14+ protocols. Works with Claude, Codex, Cursor, OpenClaw, and any AI assistant.

1345. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 219
   IMAP and SMTP via MCP Server

1346. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 218
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

1347. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 218
   Razorpay's Official MCP Server

1348. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 217

1349. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 216

1350. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 216
   The MCP Engine is a Power BI tool that lets AI assistants like Claude interact with your Power BI models programmatically: read your model structure, run DAX queries, create and modify measures, manage relationships, and perform advanced analytics - all through natural conversation.

1351. **[computer-use-mcp](https://github.com/domdomegg/computer-use-mcp)** - ⭐ 215
   💻 Give AI models complete control of your computer (probably a bad idea)

1352. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 214
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

1353. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 214
   Agent MCP for ffmpeg

1354. **[airbroke](https://github.com/icoretech/airbroke)** - ⭐ 214
   🔥 Lightweight, Airbrake/Sentry-compatible, PostgreSQL-based Open Source Error Catcher

1355. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 214
   🔎 A MCP server for Unsplash image search.

1356. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 214
   Connect your AI to your APIs on Postman

1357. **[swarmvault](https://github.com/swarmclawai/swarmvault)** - ⭐ 214
...
1358. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 213
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

1359. **[claude-context-local](https://github.com/FarhanAliRaza/claude-context-local)** - ⭐ 213
...
1360. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 213
   Run and monitor MCP servers locally

1361. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 212
...
1362. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 212
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1363. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 211
   Pure Rust implementation of MCP server for headless terminal 

1364. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 211
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

1365. **[Context-Engineering-for-Multi-Agent-Systems](https://github.com/Denis2054/Context-Engineering-for-Multi-Agent-Systems)** - ⭐ 211
...
1366. **[claude-in-mobile](https://github.com/AlexGladkov/claude-in-mobile)** - ⭐ 211
...
1367. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 210
   An MCP server to use Sora video generation APIs

1368. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 210

1369. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 210
   A Multi-modal MCP client for voice powered agentic workflows

1370. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 210
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

1371. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 210
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

1372. **[Claude-code-ChatInWindows](https://github.com/LKbaba/Claude-code-ChatInWindows)** - ⭐ 210
...
1373. **[open-webui-plugins](https://github.com/Classic298/open-webui-plugins)** - ⭐ 210
   A curated collection of Open WebUI plugins - tools, skills, filters, pipes, and actions that extend your AI chat experience.

1374. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 210
   Sketchup Model Context Protocol

1375. **[mcp-todoist](https://github.com/greirson/mcp-todoist)** - ⭐ 210
   MCP server that connects Claude to Todoist for natural language task and project   management with bulk operations

1376. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 209

1377. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 209
   ModelContextProtocol for Figma's REST API

1378. **[jetski](https://github.com/hyprmcp/jetski)** - ⭐ 209
...
1379. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 209
   Neo4j official MCP Server

1380. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 208
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1381. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 208
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

1382. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 208
   interactive programming of melodies, producing MIDI 

1383. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 208
   A ReAct-Based Highly Robust Autonomous Agent (Harness) Framework.

1384. **[pasal](https://github.com/ilhamfp/pasal)** - ⭐ 208
...
1385. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 207
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

1386. **[uLoopMCP](https://github.com/hatayama/uLoopMCP)** - ⭐ 207
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1387. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 207
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

1388. **[mcp-launchpad](https://github.com/kenneth-liao/mcp-launchpad)** - ⭐ 207
...
1389. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 207
...
1390. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 207
   Self-hosted AI RAG + MCP Platform

1391. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 207
...
1392. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 207
   Tools to allow LLM clients to interact with Linux systems remotely

1393. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 206
   MCP security wrapper

1394. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 206
   MCP server for Dynatrace Observability

1395. **[AutomatedEmulation](https://github.com/iknowjason/AutomatedEmulation)** - ⭐ 206
...
1396. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 206
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1397. **[AutoRedTeam-Orchestrator](https://github.com/Coff0xc/AutoRedTeam-Orchestrator)** - ⭐ 206
...
1398. **[burp-mcp-agents](https://github.com/six2dez/burp-mcp-agents)** - ⭐ 205
   Practical setup guides and helpers to connect Burp Suite MCP Server to multiple AI backends (Codex, Gemini, Ollama, ...).

1399. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 205

1400. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

1401. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 205
   Model Context Protocol tool support for LangChain

1402. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 205
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

1403. **[claude-self-reflect](https://github.com/ramakay/claude-self-reflect)** - ⭐ 205
   Claude forgets everything. This fixes that. 🔗 www.npmjs.com/package/claude-self-reflect

1404. **[radare2-mcp](https://github.com/radareorg/radare2-mcp)** - ⭐ 205
   MCP stdio server for radare2

1405. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 205
...
1406. **[mcp-fusion](https://github.com/vinkius-labs/mcp-fusion)** - ⭐ 204
   MCP Fusion - The framework for AI-native MCP servers. 

1407. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 204
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

1408. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 204
   A MCP Server for the RAG Web Browser Actor

1409. **[sap-skills](https://github.com/secondsky/sap-skills)** - ⭐ 204
...
1410. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 204
   A Model Context Protocol (MCP) server providing access to Google Search Console

1411. **[XActions](https://github.com/nirholas/XActions)** - ⭐ 204
...
1412. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 203
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

1413. **[facebook-ads-library-mcp](https://github.com/proxy-intell/facebook-ads-library-mcp)** - ⭐ 203
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1414. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 203
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1415. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 203
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1416. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 202
   A Tiny Terminal Chat App for AI Models with MCP Client Support

1417. **[CrowdSentinels-AI-MCP](https://github.com/thomasxm/CrowdSentinels-AI-MCP)** - ⭐ 202
   AI-powered threat hunting and incident response MCP server for Elasticsearch/OpenSearch

1418. **[ai-skills](https://github.com/sanjay3290/ai-skills)** - ⭐ 202
   Collection of agent skills for AI coding assistants

1419. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 202
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1420. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 201
   R MCP Server

1421. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 201
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

1422. **[Geargrafx](https://github.com/drhelius/Geargrafx)** - ⭐ 201
...
1423. **[docsagent](https://github.com/docsagent/docsagent)** - ⭐ 201
...
1424. **[ai-code-interface.el](https://github.com/tninja/ai-code-interface.el)** - ⭐ 201
   Unified Emacs interface supporting OpenAI Codex, GitHub Copilot CLI, Claude Code, Gemini CLI, Opencode, and more

1425. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 201
   这是一个专为开发企业级MCP server而设计的通用开发框架

1426. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 201
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1427. **[purple](https://github.com/erickochen/purple)** - ⭐ 201
...
1428. **[awesome-osint-mcp-servers](https://github.com/soxoj/awesome-osint-mcp-servers)** - ⭐ 201
   A curated list of OSINT MCP servers. Pull requests are welcomed!

1429. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

1430. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 200
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

1431. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 200
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

1432. **[RelaMind](https://github.com/El-12stu/RelaMind)** - ⭐ 200
   基于 AI 的个人成长轨迹分析系统，通过记录生活、回顾历史、分析模式帮助用户更好地理解自己，实现持续成长。包含智能路由、RAG 检索、自主任务智能体等功能。

1433. **[codefire-app](https://github.com/websitebutlers/codefire-app)** - ⭐ 200
...
1434. **[copilot-plugins](https://github.com/github/copilot-plugins)** - ⭐ 200
   The official GitHub Copilot plugins collection — MCP servers, skills, hooks, and other extensibility tools for GitHub Copilot.

1435. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 200
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1436. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 199
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

1437. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 199
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

1438. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 199
...
1439. **[wavefront](https://github.com/rootflo/wavefront)** - ⭐ 198
   🔥🔥🔥 Enterprise AI middleware, alternative to unifyapps, n8n, lyzr

1440. **[STS2-Agent](https://github.com/CharTyr/STS2-Agent)** - ⭐ 198
   杀戮尖塔2的MOD，将杀戮尖塔2的游戏状态与操作暴露为本地 HTTP API 包装成 MCP Server，供支持 MCP 的AI客户端直接调用

1441. **[EdgeBox](https://github.com/BIGPPWONG/EdgeBox)** - ⭐ 197
...
1442. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 197
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

1443. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 197
   Manage / Proxy / Secure your MCP Servers

1444. **[markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server)** - ⭐ 196
   An MCP server for converting Markdown to interactive mind maps with export support (PNG/JPG/SVG).

1445. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

1446. **[unifi-network-mcp](https://github.com/sirkirby/unifi-network-mcp)** - ⭐ 196
   MCP server implementation for the UniFi network application

1447. **[drawio2go](https://github.com/Menghuan1918/drawio2go)** - ⭐ 196
   A modern DrawIO editor application.  AI-Powered, Human-AI Collaboration | AI 加持，人机共绘drawio

1448. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 196
...
1449. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 196
   Discord MCP Server for Claude Integration

1450. **[integrate-mcp-with-copilot](https://github.com/skills/integrate-mcp-with-copilot)** - ⭐ 196
   Learn how to use MCP Servers with GitHub Copilot

1451. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

1452. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 195
...
1453. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 195
   MCP Server for Wazuh SIEM

1454. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 195
...
1455. **[flutter-skill](https://github.com/ai-dashboad/flutter-skill)** - ⭐ 195
...
1456. **[bluebox](https://github.com/VectorlyApp/bluebox)** - ⭐ 194
   Index the world's undocumented APIs

1457. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 194
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

1458. **[mcp-agent-graph](https://github.com/keta1930/mcp-agent-graph)** - ⭐ 194
   MCP Agent Graph is a Multi-Agent System built on the principles of Context Engineering

1459. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 194
   Go protobuf compiler extension to turn any gRPC service into an MCP server

1460. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 194

1461. **[agent-graph](https://github.com/keta1930/agent-graph)** - ⭐ 194
   Agent Graph is a Multi-Agent System built on the principles of Context Engineering

1462. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 194
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1463. **[binary-ninja-headless-mcp](https://github.com/mrphrazer/binary-ninja-headless-mcp)** - ⭐ 194
   Headless Binary Ninja MCP server — giving AI agents deep reverse-engineering capabilities via 180 tools.

1464. **[agent-skills-hub](https://github.com/zhuyansen/agent-skills-hub)** - ⭐ 194
...
1465. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 193
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

1466. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 193
   Absurdly easy Model Context Protocol Servers in Typescript

1467. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 193
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1468. **[shodh-memory](https://github.com/varun29ankuS/shodh-memory)** - ⭐ 193
...
1469. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 192
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1470. **[mcp-proxy-server](https://github.com/ptbsare/mcp-proxy-server)** - ⭐ 192
   This server acts as a central hub for Model Context Protocol (MCP) resource servers.

1471. **[hevy-mcp](https://github.com/chrisdoc/hevy-mcp)** - ⭐ 192
   Manage your Hevy workouts, routines, folders, and exercise templates. Create and update sessions faster, organize plans, and search exercises to build workouts quickly. Stay synced with changes so your training log is always up to date.

1472. **[elementor-mcp](https://github.com/msrbuilds/elementor-mcp)** - ⭐ 192
...
1475. **[sap-ai-mcp-servers](https://github.com/marianfoo/sap-ai-mcp-servers)** - ⭐ 191
   A complete list of SAP MCP Servers and SAP AI Skills

1476. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 190
...
1477. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 190
   Supabase MCP server created in Python.

1478. **[memory-graph](https://github.com/memory-graph/memory-graph)** - ⭐ 190
   A graph DB-based MCP memory server for coding agents with intelligent relationship tracking

1479. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 189
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

1480. **[gigabrain](https://github.com/legendaryvibecoder/gigabrain)** - ⭐ 189
   Local-first memory layer for OpenClaw, Codex App, and Codex CLI: capture, recall, dedupe, and native sync.

1481. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 189
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

1482. **[osint-tools-mcp-server](https://github.com/frishtik/osint-tools-mcp-server)** - ⭐ 189
   MCP server exposing multiple OSINT tools for AI assistants like Claude

1483. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 189
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1484. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 188
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

1485. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 188
   This extension enables developers to implement the MCP server features easily.

1486. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 188
   An MCP server to search for flights.

1487. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 187

1488. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

1489. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

1490. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

1491. **[memov](https://github.com/memovai/memov)** - ⭐ 187
...
1492. **[jarvis](https://github.com/isair/jarvis)** - ⭐ 187
...
1493. **[omem](https://github.com/ourmem/omem)** - ⭐ 187
...
1494. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 187
   Supercharge AI Agents, Safely

1495. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 186
   Model Context Protocol Servers in Quarkus

1496. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
   多平台 文生图/图生图 等能力接入MCP

1497. **[SharpToolsMCP](https://github.com/kooshi/SharpToolsMCP)** - ⭐ 186
   A suite of MCP tools for AIs to analyze and modify C# solutions with high signal, Roslyn powered context.

1498. **[nextcloud-mcp-server](https://github.com/cbcoutinho/nextcloud-mcp-server)** - ⭐ 186
   Nextcloud MCP Server

1499. **[aleph](https://github.com/Hmbown/aleph)** - ⭐ 186
   Skill + MCP server to turn your agent into an RLM. Load context, iterate with search/code/think tools, converge on answers.

1500. **[agentseal](https://github.com/AgentSeal/agentseal)** - ⭐ 186
   Security toolkit for AI agents. Scan your machine for dangerous skills and MCP configs, monitor for supply chain attacks, test prompt injection resistance, and audit live MCP servers for tool poisoning.

1501. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 185
   Official Magic UI MCP server.

1502. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 185
   A TypeScript framework for building MCP servers elegantly

1503. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 185
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1504. **[docs](https://github.com/strands-agents/docs)** - ⭐ 185
   Documentation for the Strands Agents SDK. A model-driven approach to building AI agents in just a few lines of code. 

1505. **[ClaudeR](https://github.com/IMNMV/ClaudeR)** - ⭐ 185
...
1506. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 185
   Chat application with multi-agents system supports multi-models and MCP

1507. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 184
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

1508. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

1509. **[siconos](https://github.com/siconos/siconos)** - ⭐ 184
   Simulation framework for nonsmooth dynamical systems

1510. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 184
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1511. **[gemini-mcp](https://github.com/RLabs-Inc/gemini-mcp)** - ⭐ 184
   MCP Server that enables Claude code to interact with Gemini

1512. **[mevzuat-mcp](https://github.com/saidsurucu/mevzuat-mcp)** - ⭐ 184
   MCP Server for Searching Turkish Legislation

1513. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 183
   MCP for calling Siri Shorcuts from LLMs

1514. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 183
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

1515. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 183
   A simple CLI to install MCP servers into any client - auth included!

1516. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 183
   MCP Server for the Bilibili API, supporting various operations.

1517. **[aelf-skills](https://github.com/AElfProject/aelf-skills)** - ⭐ 182
   Unified aelf skills hub for discovery, routing, bootstrap, and health checks across OpenClaw, Codex, Cursor, and Claude Code.

1518. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
1519. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

1520. **[lucid-agents](https://github.com/daydreamsai/lucid-agents)** - ⭐ 182
...
1521. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 182
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

1522. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 182
   Typescript SDK to build MCP servers in an agnostic way

1523. **[open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp)** - ⭐ 182
   An OpenStreetMap MCP server implementation that enhances LLM capabilities with location-based services and geospatial data.

1524. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 182
   Examples of using Pipedream's MCP server in your app or AI agent.

1525. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 182
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1526. **[4D-ARE](https://github.com/ybeven/4D-ARE)** - ⭐ 181
...
1527. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 181
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

1528. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 181
   Official MCP server for Tripo

1529. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 181
   Official Railway MCP Server for interacting with your Railway account

1530. **[openchrome](https://github.com/shaun0927/openchrome)** - ⭐ 181
   Open-source browser automation MCP server. Control your real Chrome from any AI agent.

1531. **[spring-ai-playground](https://github.com/JM-Lab/spring-ai-playground)** - ⭐ 180
...
1532. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 180

1533. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 180
   Server-enforced workflow discipline for AI agents. An MCP server providing persistent work items, dependency graphs, quality gates, and actor attribution. Schemas define what agents must produce — the server blocks the call if they don't. Works with any MCP-compatible client.

1534. **[OpenCode-Everything-You-Need-to-Know](https://github.com/wesammustafa/OpenCode-Everything-You-Need-to-Know)** - ⭐ 180
...
1535. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 179
   An MCP server for Anki

1536. **[xiaoi](https://github.com/xvhuan/xiaoi)** - ⭐ 179
   小爱音箱语音通知工具：提供 CLI/TUI/MCP/Webhook 一键播报与控制音量，支持 PM2 常驻部署，支持docker部署。

1537. **[icm](https://github.com/rtk-ai/icm)** - ⭐ 179
   Permanent memory for AI agents. Single binary, zero dependencies, MCP native.

1538. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

1539. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

1540. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 178
   A MCP server to search for accurate academic articles.

1541. **[Revornix](https://github.com/Qingyon-AI/Revornix)** - ⭐ 178
...
1542. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 178
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1543. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 178
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1544. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 178
...
1545. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 177
   DataForSEO API modelcontextprotocol server 

1546. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 176
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1547. **[agent-trade-kit](https://github.com/okx/agent-trade-kit)** - ⭐ 176
   OKX trading MCP server — connect AI agents to spot, swap, futures, options & grid bots via the Model Context Protocol.  

1548. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 176
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1549. **[Charles-mcp](https://github.com/heizaheiza/Charles-mcp)** - ⭐ 176
   Charles Proxy MCP server for AI agents with live capture, structured traffic analysis, and agent-friendly tool contracts

1550. **[claude-historian-mcp](https://github.com/Vvkmnn/claude-historian-mcp)** - ⭐ 175
   📜 An MCP server for conversation history search and retrieval in Claude Code

1551. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 175
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

1552. **[Companion](https://github.com/mattt/Companion)** - ⭐ 175
   Your neighborhood friendly MCP utility for macOS, iOS, and visionOS

1553. **[aghub](https://github.com/AkaraChen/aghub)** - ⭐ 175
   One hub for every AI coding agent. Unified configuration management for 22+ assistants.

1554. **[mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition)** - ⭐ 175
...
1555. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 174
   A mongo db server for the model context protocol (MCP)

1556. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 174
   MCP server to work with Telegram through MTProto

1557. **[awesome-x402](https://github.com/xpaysh/awesome-x402)** - ⭐ 174
   🚀 Curated list of x402 resources: HTTP 402 Payment Required protocol for blockchain payments, crypto micropayments, AI agents, API monetization. Includes SDKs (TypeScript, Python, Rust), examples, facilitators (Coinbase, Cloudflare), MCP integration, tutorials. Accept USDC payments with one line of code. Perfect for AI agent economy.

1558. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 174

1559. **[mcp-toolbox-sdk-python](https://github.com/googleapis/mcp-toolbox-sdk-python)** - ⭐ 174
   Python SDK for interacting with the MCP Toolbox for Databases. 

1560. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 174
   MCP Server for Google Slides

1561. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 174
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1562. **[command](https://github.com/scopecraft/command)** - ⭐ 173
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

1563. **[tomcp](https://github.com/Ami3466/tomcp)** - ⭐ 173
   Turn any website or doc into an MCP server

1564. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 173
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1565. **[cachebro](https://github.com/glommer/cachebro)** - ⭐ 173
   File cache with diff tracking for AI coding agents. Drop-in MCP server that cuts token usage by 26%.

1566. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 173

1567. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 173
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1568. **[notebooklm-skill](https://github.com/claude-world/notebooklm-skill)** - ⭐ 173
...
1569. **[gbox](https://github.com/babelcloud/gbox)** - ⭐ 172
   Cli and MCP for gbox. Enable AI agents to operate Android/Browser/Desktop like human.

1570. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 172
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

1571. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 172
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

1572. **[gate22](https://github.com/aipotheosis-labs/gate22)** - ⭐ 172
...
1573. **[MCP-Salesforce](https://github.com/smn2gnt/MCP-Salesforce)** - ⭐ 172
   MCP Salesforce connector

1574. **[bear-notes-mcp](https://github.com/vasylenko/bear-notes-mcp)** - ⭐ 172
   MCP Server for Bear note taking app available as Claude Desktop extension or standalone server for any other AI tool

1575. **[readwise-skills](https://github.com/readwiseio/readwise-skills)** - ⭐ 172
...
1576. **[clix](https://github.com/spideystreet/clix)** - ⭐ 171
   X from terminal. No API keys needed. Just plug your AI Agent.

1577. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 171
   MCP Server for Postgres

1578. **[seo-research-mcp](https://github.com/egebese/seo-research-mcp)** - ⭐ 171
...
1579. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 171
...
1580. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 171
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1581. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 170
   One MCP Server, All Your Apps, Privacy First

1582. **[Text2Sql.Net](https://github.com/AIDotNet/Text2Sql.Net)** - ⭐ 170
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1583. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 170
   MCPSDK.dev(ToolSDK.ai)'s Awesome MCP Servers and Packages Registry and Database with Structured JSON configurations. Supports OAuth2.1, DCR...

1584. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 170
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1585. **[mcp-server-tauri](https://github.com/hypothesi/mcp-server-tauri)** - ⭐ 170
   A Model Context Protocol (MCP) server and plugin for Tauri v2 development

1586. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 169
   Turn a web server into an MCP server in one click without making any code changes.

1587. **[y-gui](https://github.com/luohy15/y-gui)** - ⭐ 169
   A Tiny Web Chat App for AI Models with MCP Client Support

1588. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 169
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1589. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 169
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1590. **[sunpeak](https://github.com/Sunpeak-AI/sunpeak)** - ⭐ 169
   Local-first MCP App framework for ChatGPT Apps, Claude, and more.

1591. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 169
...
1592. **[comfy-pilot](https://github.com/ConstantineB6/comfy-pilot)** - ⭐ 169
   MCP server + embedded terminal that lets Claude Code see and edit your ComfyUI workflows

1593. **[mcp-redmine](https://github.com/runekaagaard/mcp-redmine)** - ⭐ 169
   A redmine MCP server covering close to 100% of redmines API

1594. **[sibyl-research-system](https://github.com/Sibyl-Research-Team/sibyl-research-system)** - ⭐ 168
   Fully Autonomous AI Research System with Self-Evolution, built natively on Claude Code

1595. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 168
   Command line interface for MCP clients with secure execution and customizable security policies

1596. **[c4-genai-suite](https://github.com/codecentric/c4-genai-suite)** - ⭐ 168
   c4 GenAI Suite

1597. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 168
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1598. **[scrumboy](https://github.com/markrai/scrumboy)** - ⭐ 168
   a self-hosted project management & Kanban solution + Instant shareable boards

1599. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 167
   Model Context Protocol For R

1600. **[refref](https://github.com/amicalhq/refref)** - ⭐ 167
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1601. **[agnix](https://github.com/agent-sh/agnix)** - ⭐ 167
...
1602. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 167
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1603. **[toolbase](https://github.com/Toolbase-AI/toolbase)** - ⭐ 166
   A desktop application that adds powerful tools to Claude and AI platforms

1604. **[codex-mcp-server](https://github.com/cexll/codex-mcp-server)** - ⭐ 166
   Codex Mcp Server 

1605. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 166
...
1606. **[CyberStrike](https://github.com/CyberStrikeus/CyberStrike)** - ⭐ 166
...
1607. **[PolyMCP](https://github.com/poly-mcp/PolyMCP)** - ⭐ 166
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1608. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 166
   StarRocks MCP (Model Context Protocol) Server

1609. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 165
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1610. **[In-Memoria](https://github.com/pi22by7/In-Memoria)** - ⭐ 165
   Persistent Intelligence Infrastructure for AI Agents

1611. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 165
...
1612. **[data-verify-mcp](https://github.com/CCCpan/data-verify-mcp)** - ⭐ 164
   中国数据核验 MCP Server | 身份核验/企业查询/车辆信息/OCR识别/风险评估 | 10个Tool覆盖5大类 | 微信: chenganp | 邮箱: 345048305@qq.com

1613. **[awesome-a2a](https://github.com/pab1it0/awesome-a2a)** - ⭐ 164
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place. 

1614. **[recall](https://github.com/joseairosa/recall)** - ⭐ 164
   Persistent cross-session memory for Claude & AI agents. Self-host on Redis/Valkey, or use the managed SaaS at recallmcp.com.

1615. **[dify-mcp-client](https://github.com/3dify-project/dify-mcp-client)** - ⭐ 164
   MCP Client as an Agent Strategy Plugin. Support GUI operation via UI-TARS-SDK.

1616. **[PerformanceStudio](https://github.com/erikdarlingdata/PerformanceStudio)** - ⭐ 164
...
1617. **[mcp-codex-dev](https://github.com/FYZAFH/mcp-codex-dev)** - ⭐ 163
   MCP Server for Codex CLI integration - stateful code writing and review workflows

1618. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 163
   MCP server for searching and querying PubMed medical papers/research database

1619. **[ironcurtain](https://github.com/provos/ironcurtain)** - ⭐ 163
   A secure* runtime for autonomous AI agents. Policy from plain-English constitutions. (*https://ironcurtain.dev)

1620. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 163
   MariaDB MCP (Model Context Protocol) server implementation

1621. **[Axon.MCP.Server](https://github.com/ali-kamali/Axon.MCP.Server)** - ⭐ 162
...
1622. **[open-responses-server](https://github.com/teabranch/open-responses-server)** - ⭐ 162
   Wraps any OpenAI API interface as Responses with MCPs support so it supports Codex. Adding any missing stateful features. Ollama and Vllm compliant.

1623. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 162

1624. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 161
...
1625. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 161
...
1626. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 161
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1627. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 161
   MCP (Model Context Protocol) server for Weaviate

1628. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 161
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1629. **[Text2Sql.Net](https://github.com/shuyu-labs/Text2Sql.Net)** - ⭐ 160
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1630. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 160
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1631. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 160
   Model Context Protocol (MCP) server for constraint optimization and solving"

1632. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 160
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1633. **[memorizer](https://github.com/petabridge/memorizer)** - ⭐ 160
   Vector-search powered agent memory MCP server

1634. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 160
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1635. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 160
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1636. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 160
...
1637. **[awesome-ai-for-economists](https://github.com/hanlulong/awesome-ai-for-economists)** - ⭐ 160
...
1638. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 160
   Scrapeless Mcp Server

1639. **[eShopLite](https://github.com/Azure-Samples/eShopLite)** - ⭐ 160
   eShopLite is a set of reference .NET applications implementing an eCommerce site with features like Semantic Search, MCP, Reasoning models and more.

1640. **[Wazuh-MCP-Server](https://github.com/gensecaihq/Wazuh-MCP-Server)** - ⭐ 160
...
1641. **[lumen](https://github.com/ory/lumen)** - ⭐ 160
...
1642. **[cve-mcp-server](https://github.com/mukul975/cve-mcp-server)** - ⭐ 160
   Production-grade MCP server giving Claude 27 security intelligence tools across 21 APIs — CVE lookup, EPSS scoring, CISA KEV, MITRE ATT&CK, Shodan, VirusTotal, and more.

1643. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 159
   A Model Context Protocol server for MySQL database operations

1644. **[mcp-summarizer](https://github.com/0xshellming/mcp-summarizer)** - ⭐ 159
   MCP Server for AI Summarization

1645. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 159
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1646. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 159
   小红书MCP服务器 | 秒级工具调用执行，笔记用户搜索、通知消息监控等；打造2026最简单、最快速、最精准、最好用的小红书MCPServer！

1647. **[monarch-mcp-server](https://github.com/robcerda/monarch-mcp-server)** - ⭐ 159
   MCP Server for use with Monarch Money

1648. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 158
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1649. **[mcp-client-slackbot](https://github.com/sooperset/mcp-client-slackbot)** - ⭐ 158
   Simple Slackbot MCP Client

1650. **[claude-code-open](https://github.com/kill136/claude-code-open)** - ⭐ 158
   Open source AI coding platform with Web IDE, multi-agent system, 37+ tools, MCP protocol. MIT licensed.

1651. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 158

1652. **[QMT-MCP](https://github.com/guangxiangdebizi/QMT-MCP)** - ⭐ 158
    QMT-MCP 模块化量化交易助手

1653. **[security-investigator](https://github.com/SCStelz/security-investigator)** - ⭐ 158
...
1654. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 157
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1655. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 157
   A WhatsApp bot that can participate in group conversations, powered by AI. The bot monitors group messages and responds when mentioned.

1656. **[solana-mcp](https://github.com/sendaifun/solana-mcp)** - ⭐ 157
   A Model Context Protocol server for interacting with the Solana blockchain, powered by the Solana Agent Kit (https://github.com/sendaifun/solana-agent-kit)

1657. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 157
   Instagram Direct messages MCP

1658. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 156
   An MCP server for fetching URLs / Youtube video transcript.

1659. **[refref](https://github.com/refrefhq/refref)** - ⭐ 156
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1660. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 156
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1661. **[bocha-search-mcp](https://github.com/BochaAI/bocha-search-mcp)** - ⭐ 156
   Bocha Search MCP Server.

1662. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 156
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1663. **[turbo-flow](https://github.com/marcuspat/turbo-flow)** - ⭐ 156
...
1664. **[apple-health-mcp-server](https://github.com/the-momentum/apple-health-mcp-server)** - ⭐ 156
   MCP server for querying Apple Health data with natural language using DuckDB under the hood.

1665. **[alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server)** - ⭐ 155

1666. **[chatgpt-copilot](https://github.com/feiskyer/chatgpt-copilot)** - ⭐ 155
   ChatGPT Copilot Extension for Visual Studio Code

1667. **[payram-mcp](https://github.com/PayRam/payram-mcp)** - ⭐ 155
   Connect to hosted payram helper at: https://mcp.payram.com

1668. **[AI-company](https://github.com/CronusL-1141/AI-company)** - ⭐ 155
...
1669. **[web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp)** - ⭐ 155
   Deep Research for crypto - free & fully local

1670. **[mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck)** - ⭐ 155
   An MCP server that acts as a bridge to query multiple OpenAI-compatible LLMs with MCP tool access. Just like rubber duck debugging, explain your problems to various AI "ducks" who can actually research and get different perspectives!

1671. **[mcp-crash-course](https://github.com/emarco177/mcp-crash-course)** - ⭐ 155
...
1672. **[knowledge-base-server](https://github.com/willynikes2/knowledge-base-server)** - ⭐ 155
...
1673. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 154
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1674. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 154
   A simple MCP server to search for documentation (tutorial)

1675. **[mcp-server-metamcp](https://github.com/metatool-ai/mcp-server-metamcp)** - ⭐ 154
   MCP Server MetaMCP manages all your other MCPs in one MCP.

1676. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 154
   Make MCP Server

1677. **[WeChat-MCP](https://github.com/BiboyQG/WeChat-MCP)** - ⭐ 154
   WeChat-MCP: let Openclaw/Claude/ChatGPT and other AI assistants read and reply to WeChat for you

1678. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 154
   A Model Context Protocol server for Hopper Disassembler

1679. **[dedalus-mcp-python](https://github.com/dedalus-labs/dedalus-mcp-python)** - ⭐ 153
   A simple and performant Model Context Protocol framework for Python.

1680. **[lyraios](https://github.com/GalaxyLLMCI/lyraios)** - ⭐ 153
...
1681. **[GEmojiSharp](https://github.com/hlaueriksson/GEmojiSharp)** - ⭐ 153
   :octocat: GitHub Emoji for C#, dotnet and beyond

1682. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 153
   Manage Your Kubernetes Cluster with k8s mcp-server

1683. **[domscribe](https://github.com/patchorbit/domscribe)** - ⭐ 153
...
1684. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 153

1685. **[meta-mcp](https://github.com/brijr/meta-mcp)** - ⭐ 153
   MCP Server for connecting to the Meta Marketing API

1686. **[mcp-ssh-manager](https://github.com/bvisible/mcp-ssh-manager)** - ⭐ 153
...
1687. **[ollama-mcp](https://github.com/rawveg/ollama-mcp)** - ⭐ 153
   An MCP Server for Ollama

1688. **[relay](https://github.com/prism-php/relay)** - ⭐ 152
   An MCP client tool for Prism

1689. **[mengram](https://github.com/alibaizhanov/mengram)** - ⭐ 152
...
1690. **[mcp-gateway](https://github.com/lightconetech/mcp-gateway)** - ⭐ 152
   A gateway demo for MCP SSE Server

1691. **[agentanycast](https://github.com/AgentAnycast/agentanycast)** - ⭐ 152
   Connect AI agents across any network — zero config, encrypted, skill-based routing

1692. **[claude-code-karma](https://github.com/JayantDevkar/claude-code-karma)** - ⭐ 152
   Dashboard for monitoring claude code sessions. 

1693. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 152
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1694. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 152
   Salesforce MCP Server

1695. **[mikrotik-mcp](https://github.com/jeff-nasseri/mikrotik-mcp)** - ⭐ 152
   MCP server for Mikrotik

1696. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 152
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1697. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 151
   MCP server for Unreal Engine 5

1698. **[aicode-toolkit](https://github.com/AgiFlow/aicode-toolkit)** - ⭐ 151
   Toolkit for Coding Agents to work reliably with repo of any size.

1699. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 151
   MCP Server for using any LLM as a Tool

1700. **[claude-desktop-extension-bear-notes](https://github.com/vasylenko/claude-desktop-extension-bear-notes)** - ⭐ 151
   Claude Desktop extension with bundled MCP Server for Bear note taking app

1701. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 151
   Catch MCP server issues before your agents do.

1702. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 151
   Serper MCP Server supporting search and webpage scraping

1703. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 151
   Dynamically expose tools from proxied servers based on an Agent Persona

1704. **[akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp)** - ⭐ 151
   MCP server that provides access to Chinese stock market data using akshare-one

1705. **[FirstData](https://github.com/MLT-OSS/FirstData)** - ⭐ 151
   The World's Most Comprehensive, Authoritative, and Structured Open Source Data Source Knowledge Base

1706. **[hanzi-browse](https://github.com/hanzili/hanzi-browse)** - ⭐ 151
   let any ai agent use the local browser

1707. **[ida-multi-mcp](https://github.com/MeroZemory/ida-multi-mcp)** - ⭐ 151
   Multi-instance IDA Pro MCP server — analyze multiple binaries simultaneously through a single MCP endpoint.

1708. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 150
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1709. **[aai-gateway](https://github.com/gybob/aai-gateway)** - ⭐ 150
   Install MCP servers and skills once, share across all your AI agents — with 90% less context overhead.

1710. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 150
   MCP Server for Apache Spark History Server. The bridge between Agentic AI and Apache Spark.

1711. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 150
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1712. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 150
   MCP server to download entire websites

1713. **[mcp-victoriametrics](https://github.com/VictoriaMetrics/mcp-victoriametrics)** - ⭐ 150
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1714. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 150
   Let LLMs control embedded devices via the Model Context Protocol.

1715. **[Express-REST-API-and-MCP-Server-Framework](https://github.com/iolufemi/Express-REST-API-and-MCP-Server-Framework)** - ⭐ 149
...
1716. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 149
   🚀🎬灵活、高效、可扩展，专属剪辑配音工具箱，释放创作潜力 . Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1717. **[UnityMCPIntegration](https://github.com/quazaai/UnityMCPIntegration)** - ⭐ 149
   Enable AI Agents to Control Unity

1718. **[quick-data-mcp](https://github.com/disler/quick-data-mcp)** - ⭐ 149
   Prompt focused MCP Server for .json and .csv agentic data analytics for Claude Code

1719. **[regenerator2000](https://github.com/ricardoquesada/regenerator2000)** - ⭐ 149
...
1720. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 149
   MCP server for discord bot

1721. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 149
   MCP server for interaction with Bitwarden.

1722. **[LMStudio-MCP](https://github.com/infinitimeless/LMStudio-MCP)** - ⭐ 149
   A Model Control Protocol (MCP) server that allows Claude to communicate with locally running LLM models via LM Studio.

1723. **[MCPHub-Desktop](https://github.com/Jeamee/MCPHub-Desktop)** - ⭐ 148
   Desktop APP for Discover and Install MCP Servers

1724. **[eion](https://github.com/eiondb/eion)** - ⭐ 148
   Shared Memory Storage for Multi-Agent Systems

1725. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 148
   A Model Context Protocol server for calculating.

1726. **[plan-cascade](https://github.com/Taoidle/plan-cascade)** - ⭐ 148
...
1727. **[kom](https://github.com/weibaohui/kom)** - ⭐ 148
   kom 是一个用于 Kubernetes 操作的工具，SDK级的kubectl、client-go的使用封装。并且支持作为管理k8s 的 MCP server。 它提供了一系列功能来管理 Kubernetes 资源，包括创建、更新、删除和获取资源，甚至使用SQL查询k8s资源。这个项目支持多种 Kubernetes 资源类型的操作，并能够处理自定义资源定义（CRD）。 通过使用 kom，你可以轻松地进行资源的增删改查和日志获取以及操作POD内文件等动作。

1728. **[paiml-mcp-agent-toolkit](https://github.com/paiml/paiml-mcp-agent-toolkit)** - ⭐ 148
   Pragmatic AI Labs MCP Agent Toolkit - An MCP Server designed to make code with agents more deterministic

1729. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 148
   Connect any Open Data to any LLM with Model Context Protocol.

1730. **[raindrop-mcp](https://github.com/adeze/raindrop-mcp)** - ⭐ 148
   Raindrop MCP Server

1731. **[comet-mcp](https://github.com/hanzili/comet-mcp)** - ⭐ 148
   MCP Server connecting to Perplexity Comet browser

1732. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 148
   A PubMed MCP server.

1733. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 148
   Model Context Protocol server implementation for Figma API

1734. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 148
...
1735. **[QuickDesk](https://github.com/barry-ran/QuickDesk)** - ⭐ 148
...
1736. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 148
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1737. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 148
   Model Context Protocol (MCP) with TikTok integration

1738. **[ultimate_mcp_client](https://github.com/Dicklesworthstone/ultimate_mcp_client)** - ⭐ 147
...
1739. **[decipher-research-agent](https://github.com/mtwn105/decipher-research-agent)** - ⭐ 147
   Turn topics, links, and files into AI-generated research notebooks — summarize, explore, and ask anything.

1740. **[meta_skill](https://github.com/Dicklesworthstone/meta_skill)** - ⭐ 147
...
1741. **[mcp-bridge](https://github.com/firekula/mcp-bridge)** - ⭐ 147
   这是一个为 Cocos Creator 设计的 MCP (Model Context Protocol) 桥接插件，用于连接外部 AI 工具与 Cocos Creator 编辑器，实现对场景、节点等资源的自动化操作。

1742. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 147
...
1743. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 146
   An MCP server that provides access to Postman.

1744. **[openwebui-extensions](https://github.com/Fu-Jie/openwebui-extensions)** - ⭐ 146
...
1745. **[claude-prompts](https://github.com/minipuft/claude-prompts)** - ⭐ 146
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1746. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 146
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1747. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 146
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1748. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 146
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1749. **[mcp_server_exe](https://github.com/shadowcz007/mcp_server_exe)** - ⭐ 145
   小智 & Cursor 的 MCP 启动器 - MCP For Cursor&xiaozhi。打包成可执行文件。Turn MCP server into an executable file

1750. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 145
   Goku is an HTTP load testing application written in Rust 

1751. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 145
   MSSQL Server MCP implementation written in C#

1752. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 145
...
1753. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 145
...
1754. **[zig-mcp](https://github.com/zig-wasm/zig-mcp)** - ⭐ 145
   Model Context Protocol (MCP) server that provides up-to-date documentation for the Zig programming language standard library and builtin functions

1755. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 144
   A MCP Server for creating Powerpoint Presentations

1756. **[uaip](https://github.com/concierge-hq/uaip)** - ⭐ 144
...
1757. **[isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)** - ⭐ 144
   Isaac Simulation MCP Extension and Server

1758. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 144
...
1759. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 144
   Model Context Protocol (MCP) server for the Zotero API, in Python

1760. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 144
   Model Context Protocol Server for Swift

1761. **[Gemini-mcp](https://github.com/LKbaba/Gemini-mcp)** - ⭐ 143
   MCP server implementation for Google's Gemini API

1762. **[mcp-servers](https://github.com/charIesding/mcp-servers)** - ⭐ 143
   mcp server implementations

1763. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 143
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1764. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 142
   TypeScript-first framework for the Model Context Protocol (MCP). You write clean, typed code; FrontMCP handles the protocol, transport, DI, session/auth, and execution flow.

1765. **[mcp-k8s](https://github.com/silenceper/mcp-k8s)** - ⭐ 142
   A Kubernetes MCP (Model Control Protocol) server that enables interaction with Kubernetes clusters through MCP tools.

1766. **[openagent](https://github.com/Th0rgal/openagent)** - ⭐ 142
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

1767. **[mcpd](https://github.com/mozilla-ai/mcpd)** - ⭐ 142
...
1768. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 142
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1769. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 142
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1770. **[MCP-X](https://github.com/TimeCyber/MCP-X)** - ⭐ 142
...
1771. **[affine-mcp-server](https://github.com/DAWNCR0W/affine-mcp-server)** - ⭐ 142
...
1772. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 142
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1773. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 141
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1774. **[jupyter-ai-agents](https://github.com/datalayer/jupyter-ai-agents)** - ⭐ 141
   🪐 🤖 AI Agents for JupyterLab with 🔧 MCP tools - Chat interface for optimized notebook interaction and code execution.

1775. **[rust-mcp-filesystem](https://github.com/rust-mcp-stack/rust-mcp-filesystem)** - ⭐ 141
   Blazing-fast, asynchronous MCP server for seamless filesystem operations.

1776. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 141
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1777. **[Hegelion](https://github.com/Hmbown/Hegelion)** - ⭐ 140
   Dialectical reasoning architecture for LLMs (Thesis → Antithesis → Synthesis)

1778. **[mcp-server-datadog](https://github.com/winor30/mcp-server-datadog)** - ⭐ 140

1779. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 140
   MCP server for Israel Government Data

1780. **[mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket)** - ⭐ 140
   Node.js/TypeScript MCP server for Atlassian Bitbucket. Enables AI systems (LLMs) to interact with workspaces, repositories, and pull requests via tools (list, get, comment, search). Connects AI directly to version control workflows through the standard MCP interface.

1781. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 140
...
1782. **[graphiti-mcp-server](https://github.com/gifflet/graphiti-mcp-server)** - ⭐ 139
   Graphiti MCP Server

1783. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 139
...
1784. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 139
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1785. **[ksail](https://github.com/devantler-tech/ksail)** - ⭐ 139
   Tool for creating, maintaining and operating Kubernetes clusters with ease.

1786. **[forgemax](https://github.com/postrv/forgemax)** - ⭐ 139
   Code Mode inspired local sandboxed MCP Gateway - collapses N servers x M tools into 2 tools (~1,000 tokens)

1787. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 139
...
1788. **[antigravity-link-extension](https://github.com/cafeTechne/antigravity-link-extension)** - ⭐ 139
...
1789. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 138
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1790. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 138
   Simple MCP Server Implementation

1791. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 138
   MCP server for seamless document format conversion and processing

1792. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 138
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1793. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 138
   Quickly reads webpages and converts to markdown for fast, token efficient web scraping

1794. **[Awesome-MCP](https://github.com/AlexMili/Awesome-MCP)** - ⭐ 138
   Awesome ModelContextProtocol resources - A curated list of MCP resources

1795. **[mcp-endpoint-server](https://github.com/xinnan-tech/mcp-endpoint-server)** - ⭐ 137
   xiaozhi mcp接入点服务器，用于自定义mcp服务注册，方便拓展小智服务端工具调用

1796. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 137
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1797. **[Gitingest-MCP](https://github.com/puravparab/Gitingest-MCP)** - ⭐ 137
   mcp server for gitingest

1798. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 137
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1799. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 137
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1800. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 137
   Simple API & React framework, fully type safe, OpenAPI, RSC, MCP, type safe client, streaming with SSE

1801. **[-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)** - ⭐ 136
      Convert any MCP server into a Claude Skill with 90% context savings

1802. **[design-systems-mcp](https://github.com/southleft/design-systems-mcp)** - ⭐ 136
   I'm your specialized design systems assistant. Ask me about components, tokens, patterns, and best practices.

1803. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 135
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1804. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 135
   MCP server for interacting with the Aseprite API

1805. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 135
...
1806. **[ChatPPT-MCP](https://github.com/YOOTeam/ChatPPT-MCP)** - ⭐ 135
...
1807. **[mcp-toolkit](https://github.com/nuxt-modules/mcp-toolkit)** - ⭐ 134
   Create MCP servers directly in your Nuxt application. Define tools, resources, and prompts with a simple and intuitive API.

1808. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 134
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1809. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1810. **[mcp-linear](https://github.com/tacticlaunch/mcp-linear)** - ⭐ 134
...
1811. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 134
   A powerful MCP server for intelligently reading Java source code (For Jar and local project).

1812. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 134
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1813. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 133
   An MCP server implementing the think tool for Claude

1814. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1815. **[dify-plugin-agent-mcp_sse](https://github.com/junjiem/dify-plugin-agent-mcp_sse)** - ⭐ 133
   Dify 1.0 Plugin Support MCP Tools Agent strategies

1816. **[linkedin-mcp-server](https://github.com/eliasbiondo/linkedin-mcp-server)** - ⭐ 133
...
1817. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 132
...
1818. **[ragrabbit](https://github.com/madarco/ragrabbit)** - ⭐ 132
   Open Source, Self-Hosted, AI Search and LLM.txt for your website

1819. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 132
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1820. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 132
   Docker Hub MCP Server

1821. **[narsil-mcp](https://github.com/postrv/narsil-mcp)** - ⭐ 132
   Rust MCP server for comprehensive code intelligence - 90 tools, 32 languages, security scanning, call graphs, and more

1822. **[orchestkit](https://github.com/yonatangross/orchestkit)** - ⭐ 132
...
1823. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 132
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1824. **[magg](https://github.com/sitbon/magg)** - ⭐ 131
   Magg: The MCP Aggregator

1825. **[mcp-server-asana](https://github.com/roychri/mcp-server-asana)** - ⭐ 131

1826. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 130
   BrowserStack's Official MCP Server

1827. **[mcp-server-ccxt](https://github.com/doggybee/mcp-server-ccxt)** - ⭐ 130
   High-performance CCXT MCP server for cryptocurrency exchange integration

1828. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 130
   It's time to push beyond MCP Servers... Right?

1829. **[mcp-ts-core](https://github.com/cyanheads/mcp-ts-core)** - ⭐ 129
   Agent-native TypeScript framework for building MCP servers. Build tools, not infrastructure.

1830. **[mcp-devtools](https://github.com/sammcj/mcp-devtools)** - ⭐ 129
   A modular MCP server that provides commonly used developer tools for AI coding agents

1831. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 129
   A collection of crypto MCP servers.

1832. **[exstruct](https://github.com/harumiWeb/exstruct)** - ⭐ 129
...
1833. **[laravel-toon](https://github.com/mischasigtermans/laravel-toon)** - ⭐ 129
   TOON encoding for Laravel. Encode data for AI/LLMs with ~50% fewer tokens than JSON.

1834. **[indonesia-gov-apis](https://github.com/suryast/indonesia-gov-apis)** - ⭐ 129
...
1835. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 129
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1836. **[reddit-mcp-server](https://github.com/eliasbiondo/reddit-mcp-server)** - ⭐ 129
...
1837. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 128
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1838. **[specs-workflow-mcp](https://github.com/kingkongshot/specs-workflow-mcp)** - ⭐ 128
   Intelligent spec workflow management MCP server

1839. **[linear-mcp](https://github.com/cline/linear-mcp)** - ⭐ 128
   a private MCP server for accessing Linear

1840. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 128
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1841. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 128
   Buttplug.io Model Context Protocol (MCP) Server

1842. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 128
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1843. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 128
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1844. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 128
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1845. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 128
   Model Context Protocol for Actual Budget API

1846. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 127
   A Model Context Protocol server implementation for operations on AWS resources

1847. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 127
   JetBrains MCP Server Plugin

1848. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 127

1849. **[portainer-mcp](https://github.com/portainer/portainer-mcp)** - ⭐ 127
   Portainer MCP server

1850. **[computer-control-mcp](https://github.com/AB498/computer-control-mcp)** - ⭐ 127
   MCP server that provides computer control capabilities, like mouse, keyboard, OCR, etc. using PyAutoGUI, RapidOCR, ONNXRuntime. Similar to 'computer-use' by Anthropic. With Zero External Dependencies.

1851. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 127
   Dart AI Model Context Protocol (MCP) server

1852. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 127
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1853. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 126
   MCP server for understanding AWS spend

1854. **[claude-prompts-mcp](https://github.com/minipuft/claude-prompts-mcp)** - ⭐ 126
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1855. **[sysplant](https://github.com/x42en/sysplant)** - ⭐ 126
   Your Windows syscall hooking factory - feat Canterlot's Gate - All accessible over MCP

1856. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 126
   A Model Context Protocol (MCP) for Jupyter Notebook

1857. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 126
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1858. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 126
   blazigly fast gRPC/MCP client & server implementation in zig

1859. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 126
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1860. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1861. **[aws-lambda-mcp-cookbook](https://github.com/ran-isenberg/aws-lambda-mcp-cookbook)** - ⭐ 125
...
1862. **[cloudflare-mcp](https://github.com/mattzcarey/cloudflare-mcp)** - ⭐ 125
   unofficial mcp server for cloudflare api

1863. **[web-scout-mcp](https://github.com/pinkpixel-dev/web-scout-mcp)** - ⭐ 125
   A powerful MCP server extension providing web search and content extraction capabilities. Integrates DuckDuckGo search functionality and URL content extraction into your MCP environment, enabling AI assistants to search the web and extract webpage content programmatically.

1864. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 125
   A Model Context Protocol Server to manipulate *.xcodeproj

1865. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 125
   A Model Context Protocol server that provides access to BigQuery

1866. **[charlotte](https://github.com/TickTockBent/charlotte)** - ⭐ 125
   Token-efficient browser MCP server — structured web pages for AI agents, not raw accessibility dumps

1867. **[Gopeak-godot-mcp](https://github.com/HaD0Yun/Gopeak-godot-mcp)** - ⭐ 125
...
1868. **[mcp-client-server](https://github.com/willccbb/mcp-client-server)** - ⭐ 124
   An MCP Server that's also an MCP Client. Useful for letting Claude develop and test MCPs without needing to reset the application.

1869. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 124
   🐉 The fast, PHP way to build MCP servers

1870. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 124
...
1871. **[claudeus-wp-mcp](https://github.com/deus-h/claudeus-wp-mcp)** - ⭐ 124
   Claudeus WordPress MCP Server

1872. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 124
   A Google Tasks Model Context Protocol Server for Claude

1873. **[gm-exec](https://github.com/AnEntrypoint/gm-exec)** - ⭐ 123
   wanna develop an app ❓

1874. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 123
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1875. **[mcp-glootie](https://github.com/AnEntrypoint/mcp-glootie)** - ⭐ 123
   wanna develop an app ❓

1876. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 123
...
1877. **[google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server)** - ⭐ 123
   MCP server for Google Tag Manager

1878. **[ASI](https://github.com/vNeeL-code/ASI)** - ⭐ 123
   Android ✧ Gemma Integration into Android System Intelligence

1879. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 123
...
1880. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 123
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1881. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 123
   Model Context Protocol (MCP) server for the Webflow Data API.

1882. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 123
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1883. **[mcp-gm](https://github.com/AnEntrypoint/mcp-gm)** - ⭐ 122
   wanna develop an app ❓

1884. **[MCP-Workspace-Server](https://github.com/answerlink/MCP-Workspace-Server)** - ⭐ 122
...
1885. **[remote-mcp-functions-dotnet](https://github.com/Azure-Samples/remote-mcp-functions-dotnet)** - ⭐ 122
...
1886. **[env-doctor](https://github.com/mitulgarg/env-doctor)** - ⭐ 122
   Debug your GPU, CUDA, and AI stacks across local, Docker, and CI/CD (CLI and MCP server)

1887. **[mcp-mianshiya-server](https://github.com/yuyuanweb/mcp-mianshiya-server)** - ⭐ 122
   基于 Spring AI 的面试鸭搜索题目的 MCP Server 服务，快速让 AI 搜索企业面试真题和答案

1888. **[mcp-package-version](https://github.com/sammcj/mcp-package-version)** - ⭐ 122
   An MCP server that provides LLMs with the latest stable package versions when coding

1889. **[context-sync](https://github.com/Intina47/context-sync)** - ⭐ 122
...
1890. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 122
...
1891. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 122
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1892. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 122
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1893. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 122
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1894. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 121
   Streams are the future of AI powered by unlimited free tokens.

1895. **[muppet](https://github.com/muppet-dev/muppet)** - ⭐ 121
   MCP Servers SDK for TypeScript

1896. **[n8n-mcp-server](https://github.com/illuminaresolutions/n8n-mcp-server)** - ⭐ 121
   MCP server implementation for n8n workflow automation

1897. **[Taiwan-Health-MCP](https://github.com/healthymind-tech/Taiwan-Health-MCP)** - ⭐ 121

1898. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 121
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1899. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 121
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1900. **[Matryoshka](https://github.com/yogthos/Matryoshka)** - ⭐ 121
   MCP server for token-efficient large document analysis via the use of REPL state

1901. **[mcp-hubspot](https://github.com/baryhuang/mcp-hubspot)** - ⭐ 121
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1902. **[ffmpeg-mcp](https://github.com/egoist/ffmpeg-mcp)** - ⭐ 120
   An MCP server for FFmpeg

1903. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 120
   Google Sheets MCP Server 📊🤖

1904. **[mcp](https://github.com/frappe/mcp)** - ⭐ 120
   Frappe MCP allows Frappe apps to function as MCP servers

1905. **[mcp](https://github.com/taskade/mcp)** - ⭐ 120
   🤖 Taskade MCP · Official MCP server and OpenAPI to MCP codegen. Build AI agent tools from any OpenAPI API and connect to Claude, Cursor, and more.

1906. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 120
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1907. **[augments-mcp-server](https://github.com/augmnt/augments-mcp-server)** - ⭐ 120
   Comprehensive MCP server providing real-time framework documentation access for Claude Code with intelligent caching, multi-source integration, and context-aware assistance.

1908. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 120
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1909. **[google-drive-mcp](https://github.com/piotr-agier/google-drive-mcp)** - ⭐ 120
...
1910. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 119

1911. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 119
   TypeScript template for building Model Context Protocol (MCP) servers. Ships with declarative tools/resources, pluggable auth, multi-backend storage, OpenTelemetry observability, and first-class support for both local and edge (Cloudflare Workers) runtimes.

1912. **[template-repo](https://github.com/AndrewAltimit/template-repo)** - ⭐ 119
...
1913. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 119
   A proxy to use HTTP/SSE MCPs from STDIO clients

1914. **[prism-mcp](https://github.com/dcostenco/prism-mcp)** - ⭐ 119
...
1915. **[esankhyiki-mcp](https://github.com/nso-india/esankhyiki-mcp)** - ⭐ 119
...
1916. **[memorizer-v1](https://github.com/petabridge/memorizer-v1)** - ⭐ 118
   Vector-search powered agent memory MCP server

1917. **[polymarket-mcp](https://github.com/berlinbra/polymarket-mcp)** - ⭐ 118
   MCP Server for PolyMarket API

1918. **[falcon-mcp](https://github.com/CrowdStrike/falcon-mcp)** - ⭐ 118
   Connect AI agents to CrowdStrike Falcon for automated security analysis and threat hunting

1919. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 118
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1920. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 118
...
1921. **[Pare](https://github.com/Dave-London/Pare)** - ⭐ 118
   Dev tools, optimized for agents. Structured, token-efficient MCP servers for git, test runners, npm, Docker, and more.

1922. **[VisionCraft-MCP-Server](https://github.com/augmentedstartups/VisionCraft-MCP-Server)** - ⭐ 117
...
1923. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 117
   An MCP server for InterviewReady

1924. **[kodit](https://github.com/helixml/kodit)** - ⭐ 117
   👩‍💻 MCP server to index external repositories

1925. **[outline-mcp-server](https://github.com/mmmeff/outline-mcp-server)** - ⭐ 117
   It's an MCP server... for Outline (the documentation platform!)

1926. **[diagram-mcp-server](https://github.com/andrewmoshu/diagram-mcp-server)** - ⭐ 117
   An MCP server that seamlessly creates infrastructure diagrams for AWS, Azure, GCP, Kubernetes and more

1927. **[VibeUE](https://github.com/kevinpbuckley/VibeUE)** - ⭐ 117
   Unreal Engine Vibe Coding tool

1928. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 117
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1929. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 117
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

1930. **[yuque-mcp-server](https://github.com/yuque/yuque-mcp-server)** - ⭐ 117
   Yuque MCP Server - Model Context Protocol server for Yuque API

1931. **[pocketbase-mcp](https://github.com/mrwyndham/pocketbase-mcp)** - ⭐ 116
   MCP server for building PocketBase apps really quickly - Need a front end quick consider FastPocket

1932. **[EDT-MCP](https://github.com/DitriXNew/EDT-MCP)** - ⭐ 116
   MCP for 1C:EDT

1933. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 116
...
1934. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 115
   Fast and super efficient Minecraft Server written in C++

1935. **[remote-mcp-apim-functions-python](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)** - ⭐ 115
   Azure API Management as AI Gateway to Remote MCP servers.

1936. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 115
   MCP Server for working with large Oracle databases

1937. **[remote-mcp-functions-python](https://github.com/Azure-Samples/remote-mcp-functions-python)** - ⭐ 115
   Getting Started with Remote MCP Servers using Azure Functions (Python)

1938. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 115
...
1939. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 115
...
1940. **[mcp-server-excel](https://github.com/sbroenne/mcp-server-excel)** - ⭐ 115
   Excel MCP Server & CLI - 23 tools, 214 operations for AI-powered Excel automation via COM API

1941. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 115
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1942. **[swagger-mcp](https://github.com/dcolley/swagger-mcp)** - ⭐ 114
   Swagger to MCP server

1943. **[nitrostack](https://github.com/nitrocloudofficial/nitrostack)** - ⭐ 114
   The full-stack TypeScript framework to build, test, and deploy production-ready MCP servers and AI-native apps.

1944. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 114
   Foxy contexts is a library for building context servers supporting Model Context Protocol

1945. **[brave-search-mcp](https://github.com/mikechao/brave-search-mcp)** - ⭐ 114
...
1946. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 114
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1947. **[awesome-openclaw](https://github.com/vincentkoc/awesome-openclaw)** - ⭐ 114
...
1948. **[firefox-devtools-mcp](https://github.com/mozilla/firefox-devtools-mcp)** - ⭐ 114
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

1949. **[cli](https://github.com/mcpgod/cli)** - ⭐ 113
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1950. **[MCP-oura](https://github.com/YuzeHao2023/MCP-oura)** - ⭐ 113
   MCP server for Oura API integration

1951. **[AgenticGoKit](https://github.com/AgenticGoKit/AgenticGoKit)** - ⭐ 113
...
1952. **[modex](https://github.com/theronic/modex)** - ⭐ 113
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1953. **[mcp-armor](https://github.com/aira-security/mcp-armor)** - ⭐ 113
...
1954. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 113
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1955. **[bernstein](https://github.com/chernistry/bernstein)** - ⭐ 113
   Declarative Agent Orchestration.  Ship while you sleep.

1956. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 113
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1957. **[crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp)** - ⭐ 112
   An MCP server providing a range of cryptocurrency technical analysis indicators and strategies.

1958. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 112
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

1959. **[yfinance-mcp](https://github.com/narumiruna/yfinance-mcp)** - ⭐ 112

1960. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 112
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

1961. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 112
...
1962. **[mcp-arr](https://github.com/aplaceforallmystuff/mcp-arr)** - ⭐ 112
   MCP server for *arr media management suite

1963. **[claude-emporium](https://github.com/Vvkmnn/claude-emporium)** - ⭐ 111
   🏛 [UNDER CONSTRUCTION] A (roman) claude plugin marketplace 

1964. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
1965. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 111
   MCP server for connecting agentic systems to search systems via searXNG

1966. **[spring-documentation-mcp-server](https://github.com/andrlange/spring-documentation-mcp-server)** - ⭐ 111
   Spring Boot based MCP Server provide full Spring Ecosystem Documentation for LLMs

1967. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 111
...
1968. **[mcpauth](https://github.com/mcpauth/mcpauth)** - ⭐ 111
   Authentication for MCP Servers

1969. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 111

1970. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 111
   Open Source MCP Servers for Scientific Research

1971. **[idun-agent-platform](https://github.com/Idun-Group/idun-agent-platform)** - ⭐ 111
...
1972. **[sourcerer-mcp](https://github.com/st3v3nmw/sourcerer-mcp)** - ⭐ 111
   MCP for semantic code search & navigation that reduces token waste

1973. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 110
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1974. **[livebook_tools](https://github.com/thmsmlr/livebook_tools)** - ⭐ 110
   Powertools for livebook.dev — AI Code Editing, MCP Servers, and Running Livebooks from the CLI

1975. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 110
   MCP server for Dash, the macOS documentation browser

1976. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 110
    MCP server providing AI agents with instant access to Apple developer documentation via RAG technology

1977. **[code-pathfinder](https://github.com/shivasurya/code-pathfinder)** - ⭐ 110
...
1978. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 110
...
1979. **[rails-ai-context](https://github.com/crisnahine/rails-ai-context)** - ⭐ 110
...
1980. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 110
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1981. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 110
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1982. **[MiniClaw](https://github.com/8421bit/MiniClaw)** - ⭐ 110
...
1983. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 110
...
1984. **[unity-mcp-server](https://github.com/AnkleBreaker-Studio/unity-mcp-server)** - ⭐ 110
   Unity MCP Server — 268 tools for AI-assisted game development. Connect Claude, Cursor, or any MCP client to Unity Editor & Unity Hub. Scene management, GameObjects, components, builds, profiling, Shader Graph, Amplify, terrain, physics, NavMesh, animation, MPPM multiplayer & more. Free & open source by AnkleBreaker Studio.

1985. **[deterministic-agent-control-protocol](https://github.com/elliot35/deterministic-agent-control-protocol)** - ⭐ 109
...
1986. **[mcp_client](https://github.com/theailanguage/mcp_client)** - ⭐ 109
   MCP Client Implementation using Python, LangGraph and Gemini

1987. **[server-wp-mcp](https://github.com/emzimmer/server-wp-mcp)** - ⭐ 109

1988. **[game-asset-mcp](https://github.com/MubarakHAlketbi/game-asset-mcp)** - ⭐ 109
   An MCP server for creating 2D/3D game assets from text using Hugging Face AI models.

1989. **[kibitz](https://github.com/nick1udwig/kibitz)** - ⭐ 109
   The coding agent for professionals

1990. **[browser-debugger-cli](https://github.com/szymdzum/browser-debugger-cli)** - ⭐ 109
   CLI tool for agents to quickly access browser telemetry (DOM, network, console) via Chrome DevTools Protocol.

1991. **[flexible-graphrag](https://github.com/stevereiner/flexible-graphrag)** - ⭐ 109
...
1992. **[rust-docs-mcp](https://github.com/snowmead/rust-docs-mcp)** - ⭐ 109
   MCP server for agents to explore rust docs, analyze source code, and build with confidence

1993. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 109
...
1994. **[mcp-reticle](https://github.com/soth-ai/mcp-reticle)** - ⭐ 109
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

1995. **[ClawMem](https://github.com/yoloshii/ClawMem)** - ⭐ 109
   On-device memory layer for AI agents. Claude Code, Hermes and OpenClaw. Hooks + MCP server + hybrid RAG search.

1996. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 109
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1997. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

1998. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

1999. **[asyncmcp](https://github.com/bh-rat/asyncmcp)** - ⭐ 108
   Async transport layers for MCP

2000. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 108
   An MCP client for Node.js.

2001. **[payloadcmsmcp](https://github.com/disruption-hub/payloadcmsmcp)** - ⭐ 108
   Payload CMS MCP Server

2002. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 108
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

2003. **[forge-orchestrator](https://github.com/nxtg-ai/forge-orchestrator)** - ⭐ 108
   Forge Orchestrator: Multi-AI task orchestration. File locking, knowledge capture, drift detection. Rust.

2004. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 108
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

2005. **[awesome-context-engineering](https://github.com/jihoo-kim/awesome-context-engineering)** - ⭐ 107
...
2006. **[slack-mcp-server](https://github.com/ubie-oss/slack-mcp-server)** - ⭐ 107
   A Slack MCP server

2007. **[selfhosted-supabase-mcp](https://github.com/HenkDz/selfhosted-supabase-mcp)** - ⭐ 107
   An MCP Server for your Self Hosted Supabase

2008. **[arxiv-latex-mcp](https://github.com/takashiishida/arxiv-latex-mcp)** - ⭐ 107
   MCP server that uses arxiv-to-prompt to fetch and process arXiv LaTeX sources for precise interpretation of mathematical expressions in scientific papers.

2009. **[csharp-runner](https://github.com/sdcb/csharp-runner)** - ⭐ 107
   fast, secure c# runner

2010. **[snippy](https://github.com/Azure-Samples/snippy)** - ⭐ 107
...
2011. **[godot-mcp](https://github.com/tugcantopaloglu/godot-mcp)** - ⭐ 107
   MCP server for full Godot 4.x engine control — 149 tools for AI-driven game development

2012. **[xclaude-plugin](https://github.com/conorluddy/xclaude-plugin)** - ⭐ 106
...
2013. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 106
   An md file as a chat interface and editable history in one.

2014. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 106
   From Java Dev to AI Engineer: Spring AI Fast Track

2015. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 106
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

2016. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 106
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

2017. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 106
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

2018. **[mcpm](https://github.com/MCP-Club/mcpm)** - ⭐ 105
...
2019. **[flowlens-mcp-server](https://github.com/magentic/flowlens-mcp-server)** - ⭐ 105
...
2020. **[typescript-utcp](https://github.com/universal-tool-calling-protocol/typescript-utcp)** - ⭐ 105
...
2025. **[powerbi-mcp](https://github.com/sulaiman013/powerbi-mcp)** - ⭐ 105
   MCP server for natural language interaction with Power BI datasets

2026. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 105
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

2027. **[deep-code-reasoning-mcp](https://github.com/evalops/deep-code-reasoning-mcp)** - ⭐ 105
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

2028. **[arbor](https://github.com/Anandb71/arbor)** - ⭐ 105
   Graph-native code intelligence that replaces embedding-based RAG with deterministic program understanding.

2029. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 105
   Rails Engine with MCP compliant Spec.

2030. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 105
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

2031. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 104
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

2032. **[agentcare-mcp](https://github.com/Kartha-AI/agentcare-mcp)** - ⭐ 104
   MCP Server for EMRs with FHIR

2033. **[freqtrade-mcp](https://github.com/kukapay/freqtrade-mcp)** - ⭐ 104
   An MCP server that integrates with the Freqtrade cryptocurrency trading bot.

2034. **[linggen](https://github.com/linggen/linggen)** - ⭐ 104
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

2035. **[vectorize-mcp-server](https://github.com/vectorize-io/vectorize-mcp-server)** - ⭐ 104
   Official Vectorize MCP Server

2036. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 104
   A Model Context Protocol server that provides knowledge graph management capabilities. 

2037. **[MySearch-Proxy](https://github.com/skernelx/MySearch-Proxy)** - ⭐ 104
   Unified search MCP, proxy console, and skill for Tavily, Firecrawl, and Social / X.

2038. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 104
   first gemini based desktop client for MCP

2039. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 103
   simple web ui to manage mcp (model context protocol) servers in the claude app

2040. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 103
...
2041. **[solana-mcp](https://github.com/solanamcp/solana-mcp)** - ⭐ 103
   Solana Agent Kit MCP Server 

2042. **[ARIES](https://github.com/Chieko-Seren/ARIES)** - ⭐ 103
...
2043. **[http-oauth-mcp-server](https://github.com/NapthaAI/http-oauth-mcp-server)** - ⭐ 103
...
2044. **[chronulus-mcp](https://github.com/ChronulusAI/chronulus-mcp)** - ⭐ 103
   MCP Server for Chronulus AI Forecasting and Prediction Agents

2045. **[alibabacloud-ack-mcp-server](https://github.com/aliyun/alibabacloud-ack-mcp-server)** - ⭐ 103
...
2046. **[alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server)** - ⭐ 103
   AlibabaCloud CloudOps MCP Server

2047. **[wanaku](https://github.com/wanaku-ai/wanaku)** - ⭐ 103
   Wanaku MCP Router

2048. **[go-utcp](https://github.com/universal-tool-calling-protocol/go-utcp)** - ⭐ 103
    Official Go implementation of the UTCP 

2049. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 103
...
2050. **[reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp)** - ⭐ 103
...
2051. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 103
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

2052. **[remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions)** - ⭐ 102
   Landing page for Remote MCP Server efforts in Azure Functions with links to all language stack specific repos.

2053. **[godoc-mcp](https://github.com/mrjoshuak/godoc-mcp)** - ⭐ 102
   go doc mcp server

2054. **[mcp-screenshot-website-fast](https://github.com/just-every/mcp-screenshot-website-fast)** - ⭐ 102
   Quickly screenshots webpages and converts to an LLM friendly size

2055. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 102
   Collection of examples of how to use Model Context Protocol with AWS.

2056. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 102
   This is a Ruby implementation of MCP (Model Context Protocol) client

2057. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 102
...
2058. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 102
   Safe local execution layer for AI agent tools. Build, validate, and publish MCP tools with a no-pass-no-run workflow — cross-platform desktop app powered by Spring AI.

2059. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 102
   Node.js Client Implementation for Model Context Protocol (MCP)

2060. **[google-ai-mode-mcp](https://github.com/PleasePrompto/google-ai-mode-mcp)** - ⭐ 102
...
2061. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 102
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

2062. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 102
   Headless IDA Pro binary analysis via Model Context Protocol

2063. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 101
   BTP CloudFoundry Node.js MCP server for SAP OData services integration

2064. **[nowledge-mem](https://github.com/nowledge-co/nowledge-mem)** - ⭐ 101
   Memory and context manager just works.

2065. **[stock-mcp](https://github.com/huweihua123/stock-mcp)** - ⭐ 101
   专业的金融市场数据 MCP 服务器 - 支持A股/美股/加密货币，原生 MCP 协议，AI Agent 友好

2066. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 101
...
2067. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 100
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

2068. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 100
...
2069. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

2070. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 100
...
2071. **[autodev-codebase](https://github.com/anrgct/autodev-codebase)** - ⭐ 100
...
2072. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 100
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

2073. **[mpm-vibe-coding](https://github.com/halflifezyf2680/mpm-vibe-coding)** - ⭐ 100
...
2074. **[langgraph-ai](https://github.com/piyushagni5/langgraph-ai)** - ⭐ 100
   LangGraph AI Repository

2075. **[mcp-memory-keeper](https://github.com/mkreyman/mcp-memory-keeper)** - ⭐ 100
   MCP server for persistent context management in AI coding assistants

2076. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 100
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

2077. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 100
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

2078. **[winremote-mcp](https://github.com/dddabtc/winremote-mcp)** - ⭐ 100
   Windows Remote MCP Server — 40+ tools for desktop automation, process management, file operations via FastMCP

2079. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 99
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

2080. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

2081. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

2082. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

2083. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

2084. **[lapras-mcp-server](https://github.com/lapras-inc/lapras-mcp-server)** - ⭐ 99
   lapras.com 公式MCP Server

2085. **[heimdall-mcp-server](https://github.com/lcbcFoo/heimdall-mcp-server)** - ⭐ 99
   Your AI Coding Assistant's Long-Term Memory

2086. **[mysql-mcp-server-sse](https://github.com/mangooer/mysql-mcp-server-sse)** - ⭐ 99
...
2087. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 99
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

2088. **[agent-bridge](https://github.com/raysonmeng/agent-bridge)** - ⭐ 99
   A local bridge for bidirectional collaboration between Claude Code and Codex. 连接 Claude Code 与 Codex 的本地实时协作桥接工具。

2089. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 99
   A Model Context Protocol (MCP) server for square

2090. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 98
...
2091. **[atomic-red-team-mcp](https://github.com/cyberbuff/atomic-red-team-mcp)** - ⭐ 98
   MCP server for Atomic Red Team

2092. **[editor-mcp-server](https://github.com/playcanvas/editor-mcp-server)** - ⭐ 98
   MCP Server for AI automation of the PlayCanvas Editor

2093. **[Vibe-Coder-MCP](https://github.com/freshtechbro/Vibe-Coder-MCP)** - ⭐ 98
    Vibe-Coder-MCP server extends AI assistants with specialized software development tools.

2094. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

2095. **[zed-mcp-server-context7](https://github.com/akbxr/zed-mcp-server-context7)** - ⭐ 98
   Context7 MCP Server for Zed

2096. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 98
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

2097. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 98
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

2098. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 98
...
2099. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 98
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

2100. **[mcp-image](https://github.com/shinpr/mcp-image)** - ⭐ 98
...
2101. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 97
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

2102. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 97
   claude mcp sse demo with server and client(cli、web)

2103. **[fhir-mcp-server](https://github.com/wso2/fhir-mcp-server)** - ⭐ 97
   FHIR MCP Server – helping you expose any FHIR Server or API as a MCP Server.

2104. **[z-image-studio](https://github.com/iconben/z-image-studio)** - ⭐ 97
...
2105. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 97
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

2106. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 97
...
2107. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 97
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

2108. **[mcp-dock](https://github.com/OldJii/mcp-dock)** - ⭐ 97
...
2109. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 96
...
2110. **[api2mcp4j](https://github.com/TheEterna/api2mcp4j)** - ⭐ 96
...
2111. **[gossiphs](https://github.com/williamfzc/gossiphs)** - ⭐ 96
...
2112. **[sparql-llm](https://github.com/sib-swiss/sparql-llm)** - ⭐ 96
   🦜✨ Chat system, MCP server, and reusable components to improve LLMs capabilities when generating SPARQL queries

2113. **[needle-mcp](https://github.com/needle-ai/needle-mcp)** - ⭐ 96
   Needle MCP Server for easy RAG.Long-term memory for LLMs.

2114. **[AgentUp](https://github.com/always-further/AgentUp)** - ⭐ 96
   Portable , scalable , secure AI Agents

2115. **[NetworkOps_Platform](https://github.com/E-Conners-Lab/NetworkOps_Platform)** - ⭐ 96
...
2116. **[obsidian-web-mcp](https://github.com/jimprosser/obsidian-web-mcp)** - ⭐ 96
...
2117. **[leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server)** - ⭐ 95
   An MCP server enabling automated access to LeetCode's problems, solutions, and public data with optional authentication for user-specific features, supporting leetcode.com & leetcode.cn sites.

2118. **[schedcp](https://github.com/eunomia-bpf/schedcp)** - ⭐ 95
   MCP Server for Linux Scheduler Management and Auto optimization

2119. **[agent-toolkit](https://github.com/sanity-io/agent-toolkit)** - ⭐ 95
   Collection of resources to help AI agents build better with Sanity.

2120. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 95
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

2121. **[fullstack-langgraph-nextjs-agent](https://github.com/agentailor/fullstack-langgraph-nextjs-agent)** - ⭐ 95
...
2122. **[mcp-canvas-lms](https://github.com/DMontgomery40/mcp-canvas-lms)** - ⭐ 95
...
2123. **[omega-memory](https://github.com/omega-memory/omega-memory)** - ⭐ 95
   Persistent memory for AI coding agents

2124. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 95
   Model Context Protocol for YNAB (you need a budget)

2125. **[bouvet](https://github.com/vrn21/bouvet)** - ⭐ 94
   Sandbox for Agents 

2126. **[semantic-scholar-fastmcp-mcp-server](https://github.com/zongmin-yu/semantic-scholar-fastmcp-mcp-server)** - ⭐ 94
   A FastMCP server implementation for the Semantic Scholar API, providing comprehensive access to academic paper data, author information, and citation networks.

2127. **[generative-ui-playground](https://github.com/CopilotKit/generative-ui-playground)** - ⭐ 94
   Interact with all three types of generative UI, all in one interface

2128. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 94
   Model Context Protocol server for Replicate's API

2129. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 94
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

2130. **[us-gov-open-data-mcp](https://github.com/lzinga/us-gov-open-data-mcp)** - ⭐ 94
...
2131. **[oxylabs-mcp](https://github.com/oxylabs/oxylabs-mcp)** - ⭐ 94
   Official Oxylabs MCP integration

2132. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 94
   A Model Context Protocol (MCP) server for querying the CVE-Search API

2133. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

2134. **[elektron-mcp](https://github.com/zerubeus/elektron-mcp)** - ⭐ 93
   MCP sever for controlling Elektron devices using LLMs

2135. **[gospy](https://github.com/monsterxx03/gospy)** - ⭐ 93
   Non-Invasive goroutine inspector

2136. **[tiger-cli](https://github.com/timescale/tiger-cli)** - ⭐ 93
   Tiger CLI is the command-line interface for Tiger Cloud. It includes an MCP server for helping coding agents write production-level Postgres code.

2137. **[mcp-server](https://github.com/OctopusDeploy/mcp-server)** - ⭐ 93
   Octopus Deploy Official MCP Server

2138. **[mcpcat-typescript-sdk](https://github.com/MCPCat/mcpcat-typescript-sdk)** - ⭐ 93
   MCPcat is an analytics platform for MCP server owners 🐱.

2139. **[awsome_kali_MCPServers](https://github.com/ccq1/awsome_kali_MCPServers)** - ⭐ 93
   awsome kali MCPServers is a set of MCP servers tailored for Kali Linux

2140. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 93
...
2141. **[mcp-gateway](https://github.com/hyprmcp/mcp-gateway)** - ⭐ 93
...
2142. **[mcp-auth-proxy](https://github.com/sigbit/mcp-auth-proxy)** - ⭐ 93
   MCP Auth Proxy is a secure OAuth 2.1 authentication proxy for Model Context Protocol (MCP) servers

2143. **[awesome-mcp-servers-devops](https://github.com/WagnerAgent/awesome-mcp-servers-devops)** - ⭐ 92
...
2144. **[open-mcp-auth-proxy](https://github.com/wso2/open-mcp-auth-proxy)** - ⭐ 92
   Authentication and Authorization Proxy for MCP Servers

2145. **[mem0-mcp](https://github.com/pinkpixel-dev/mem0-mcp)** - ⭐ 92
   ✨ mem0 MCP Server: A memory system using mem0 for AI applications with model context protocl (MCP) integration. Enables long-term memory for AI agents as a drop-in MCP server.

2146. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 91
   A Model Context Protocol (MCP) server for working with TradingView PineScript

2147. **[litegraph](https://github.com/litegraphdb/litegraph)** - ⭐ 91
...
2148. **[vibe](https://github.com/michiosw/vibe)** - ⭐ 91
   Open-Source AI-powered web browser. Browse the web with your own LLM API key. Alternative to Dia / Comet.

2149. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 91
   A Model Context Protocol server that provides knowledge graph management capabilities.

2150. **[identity](https://github.com/agntcy/identity)** - ⭐ 91
...
2151. **[ogham-mcp](https://github.com/ogham-mcp/ogham-mcp)** - ⭐ 91
   Shared memory MCP server — persistent, searchable, cross-client Claude, Opencode

2152. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 90
   A model-context-protocol server for molecules.

2153. **[chat-ui](https://github.com/AI-QL/chat-ui)** - ⭐ 90
...
2154. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 90
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

2155. **[agenticmail](https://github.com/agenticmail/agenticmail)** - ⭐ 90
   Email & SMS infrastructure for AI agents — send and receive real email and text messages programmatically

2156. **[memex](https://github.com/iamtouchskyer/memex)** - ⭐ 90
...
2157. **[mcp-rest-api](https://github.com/dkmaker/mcp-rest-api)** - ⭐ 89
   A TypeScript-based MCP server that enables testing of REST APIs through Cline. This tool allows you to test and interact with any REST API endpoints directly from your development environment.

2158. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 89
...
2159. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 88
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

2160. **[apps-sdk-template](https://github.com/alpic-ai/apps-sdk-template)** - ⭐ 88
   A minimalist Typescript ChatGPT App based on the Skybridge framework

2161. **[amap-mcp-server](https://github.com/sugarforever/amap-mcp-server)** - ⭐ 88
   高德地图MCP Server，支持stdio, sse和streamable-http

2162. **[mcpgen](https://github.com/lyeslabs/mcpgen)** - ⭐ 88
   Generate Go MCP server boilerplate from OpenAPI 3 specifications

2163. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 88
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

2164. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 88
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

2165. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 88
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

2166. **[surrealmcp](https://github.com/surrealdb/surrealmcp)** - ⭐ 88
   The official MCP server for SurrealDB

2167. **[adloop](https://github.com/kLOsk/adloop)** - ⭐ 88
...
2168. **[achatbot](https://github.com/ai-bot-pro/achatbot)** - ⭐ 87
...
2169. **[awesome-openid-connect](https://github.com/cerberauth/awesome-openid-connect)** - ⭐ 87
...
2170. **[slidev-mcp](https://github.com/LSTM-Kirigaya/slidev-mcp)** - ⭐ 87
   mcp server for slidev to make web ppt quickly and elegantly

2171. **[mcp-dbutils](https://github.com/donghao1393/mcp-dbutils)** - ⭐ 87
...
2172. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 87
   Ragie Model Context Protocol Server

2173. **[one-search-mcp](https://github.com/yokingma/one-search-mcp)** - ⭐ 87
   🚀 OneSearch MCP Server: Web Search & Scraper & Extract,  Support agent-browser, SearXNG, Tavily, DuckDuckGo, Bing, etc.

2174. **[sdl-mcp](https://github.com/GlitterKill/sdl-mcp)** - ⭐ 87
...
2175. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 87
...
2176. **[tradingview-chart-mcp](https://github.com/ertugrul59/tradingview-chart-mcp)** - ⭐ 87
...
2177. **[blender-open-mcp](https://github.com/dhakalnirajan/blender-open-mcp)** - ⭐ 87
   Open Models MCP for Blender Using Ollama

2178. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 87
   CLI & API for MCP management

2179. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 87
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

2180. **[mcpmu](https://github.com/Bigsy/mcpmu)** - ⭐ 87
   TUI-based MCP server multiplexer, configure all your MCP's in a single MCP with profiles

2181. **[mcp-agent](https://github.com/Haohao-end/mcp-agent)** - ⭐ 86
   A modular Python framework implementing the Model Context Protocol (MCP). It features a standardized client-server architecture over StdIO, integrating LLMs with external tools, real-time weather data fetching, and an advanced RAG (Retrieval-Augmented Generation) system.

2182. **[react-agent-hooks](https://github.com/chuanqisun/react-agent-hooks)** - ⭐ 86
   Turn React hooks into LLM tools

2183. **[mcp-server-llamacloud](https://github.com/run-llama/mcp-server-llamacloud)** - ⭐ 86
   A MCP server connecting to managed indexes on LlamaCloud

2184. **[vggt-mps](https://github.com/jmanhype/vggt-mps)** - ⭐ 86
   VGGT 3D Vision Agent optimized for Apple Silicon with Metal Performance Shaders

2185. **[FrontAgent](https://github.com/ceilf6/FrontAgent)** - ⭐ 86
   AI agent platform for frontend engineering with SDD constraints & MCP-controlled automation. | 面向前端工程的企业级 AI Agent 平台

2186. **[agent-tool-protocol](https://github.com/mondaycom/agent-tool-protocol)** - ⭐ 86
   Agent Tool Protocol

2187. **[mcp-server](https://github.com/cap-js/mcp-server)** - ⭐ 86
   MCP server for AI-assisted development of CAP applications

2188. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 86
...
2189. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 86
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

2190. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 85
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

2191. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

2192. **[mcp](https://github.com/twilio-labs/mcp)** - ⭐ 85
   Monorepo providing 1) OpenAPI to MCP Tool generator 2) Exposing all of Twilio's API as MCP Tools

2193. **[fabric-mcp](https://github.com/ksylvan/fabric-mcp)** - ⭐ 85
   Fabric MCP Server: Seamlessly integrate Fabric AI capabilities into MCP-enabled tools like IDEs and chat interfaces.

2194. **[rohlik-mcp](https://github.com/tomaspavlin/rohlik-mcp)** - ⭐ 85
   MCP server that lets you shop groceries across the Rohlik Group platforms (Rohlik.cz, Knuspr.de, Gurkerl.at, Kifli.hu, Sezamo.ro)

2195. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 85
   A WooCommerce (MCP) Model Context Protocol server

2196. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 85
...
2197. **[photon](https://github.com/portel-dev/photon)** - ⭐ 85
   Define intent once. Photon turns a single TypeScript file into CLI tools, MCP servers, and web interfaces.

2198. **[mcp-dockmaster](https://github.com/dcSpark/mcp-dockmaster)** - ⭐ 84
...
2199. **[spiceflow-framework](https://github.com/remorses/spiceflow-framework)** - ⭐ 84
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

2200. **[cursor-rust-tools](https://github.com/terhechte/cursor-rust-tools)** - ⭐ 84
   A MCP server to allow the LLM in Cursor to access Rust Analyzer, Crate Docs and Cargo Commands.

2201. **[mcp-github-project-manager](https://github.com/kunwarVivek/mcp-github-project-manager)** - ⭐ 84
   a mcp server to manage github project's functionality 

2202. **[advanced-unity-mcp](https://github.com/codemaestroai/advanced-unity-mcp)** - ⭐ 84
   Public repository for Advanced Unity MCP by Code Maestro (www.code-maestro.com).

2203. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 84
...
2204. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 84
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

2205. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 84
   Model Context Protocol (MCP) Server for the Keboola Platform

2206. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 84
...
2207. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 83
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

2208. **[mcp-node](https://github.com/algolia/mcp-node)** - ⭐ 83
   MCP server for interacting with Algolia

2209. **[claude-swarm](https://github.com/cj-vana/claude-swarm)** - ⭐ 83
...
2210. **[xiaozhi-mcp-ha](https://github.com/mac8005/xiaozhi-mcp-ha)** - ⭐ 83
   A Home Assistant Custom Integration (HACS) that connects Xiaozhi ESP32 AI chatbot to Home Assistant via MCP

2211. **[viper](https://github.com/ozanunal0/viper)** - ⭐ 83
...
2212. **[gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp)** - ⭐ 83
   Interact seamlessly with GitLab repositories to manage merge requests and issues. Fetch details, add comments, and streamline your code review process with ease.

2213. **[ols4](https://github.com/EBISPOT/ols4)** - ⭐ 83
   The EMBL-EBI Ontology Lookup Service (OLS)

2214. **[zed-mcp-server-github](https://github.com/LoamStudios/zed-mcp-server-github)** - ⭐ 83
   A GitHub MCP Server extension for Zed

2215. **[mcp-forge](https://github.com/achetronic/mcp-forge)** - ⭐ 83
   A complete MCP server template that include vitamins (oauth authentication included)

2216. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 83
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

2217. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 83
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

2218. **[slither-mcp](https://github.com/trailofbits/slither-mcp)** - ⭐ 83
   MCP server for Slither static analysis of Solidity smart contracts

2219. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 83
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

2220. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 83
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

2221. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 83
...
2222. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 83
...
2223. **[Alicization-Town](https://github.com/ceresOPA/Alicization-Town)** - ⭐ 83
...
2224. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 83
   A Model Context Protocol server for Zendesk

2225. **[mcp-n8n-builder](https://github.com/spences10/mcp-n8n-builder)** - ⭐ 82
   🪄 MCP server for programmatic creation and management of n8n workflows. Enables AI assistants to build, modify, and manage workflows without direct user intervention through a comprehensive set of tools and resources for interacting with n8n's REST API.

2226. **[agentic-stock-research-system](https://github.com/rooneyrulz/agentic-stock-research-system)** - ⭐ 82
...
2227. **[ramparts](https://github.com/highflame-ai/ramparts)** - ⭐ 82
   mcp scan that scans any mcp server for indirect attack vectors and security or configuration vulnerabilities

2228. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 82
   Model Context Protocol (MCP) CLI server template for Rust

2229. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 82
...
2230. **[claude-mermaid](https://github.com/veelenga/claude-mermaid)** - ⭐ 82
   MCP Server to previewing mermaid diagrams with live reload

2231. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 82
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

2232. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 82
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

2233. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 82
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

2234. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 82
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

2235. **[aivectormemory](https://github.com/Edlineas/aivectormemory)** - ⭐ 82
...
2236. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 82
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

2237. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

2238. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

2239. **[mcp-openapi](https://github.com/ReAPI-com/mcp-openapi)** - ⭐ 81
   OpenAPI specification MCP server.

2240. **[code-to-tree](https://github.com/micl2e2/code-to-tree)** - ⭐ 81
   A runtime-free MCP server that converts source code into AST🌲, regardless of language.

2241. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 81
   A model context protocol server that connects to Anki through AnkiConnect

2242. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 81
...
2243. **[teams-mcp](https://github.com/floriscornel/teams-mcp)** - ⭐ 81
...
2244. **[mcp-server-apple-events](https://github.com/FradSer/mcp-server-apple-events)** - ⭐ 81
   MCP server providing native macOS integration with Apple Reminders and Calendar via EventKit

2245. **[bridge4simulator](https://github.com/AppGram/bridge4simulator)** - ⭐ 81
...
2246. **[MCPay](https://github.com/microchipgnu/MCPay)** - ⭐ 80
   Open-source Infrastructure for MCP and x402

2247. **[mcp-server-any-openapi](https://github.com/baryhuang/mcp-server-any-openapi)** - ⭐ 80
...
2248. **[ophis](https://github.com/njayp/ophis)** - ⭐ 80
   Transform any Cobra CLI into an MCP server

2249. **[mcpc](https://github.com/mcpc-tech/mcpc)** - ⭐ 80
   Build agentic-MCP servers by composing existing MCP tools.

2250. **[tauri-plugin-mcp](https://github.com/P3GLEG/tauri-plugin-mcp)** - ⭐ 80
...
2251. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 80
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

2252. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 80
   Model Context Protocol server for OpenStreetMap data

2253. **[ls-mcp](https://github.com/lirantal/ls-mcp)** - ⭐ 80
   List MCP Server configurations in your system used by AI applications like Cursor, Claude Desktop, VS Code and others

2254. **[xc-mcp](https://github.com/conorluddy/xc-mcp)** - ⭐ 80
...
2255. **[fred-mcp-server](https://github.com/stefanoamorelli/fred-mcp-server)** - ⭐ 80
   Open-source FRED MCP Server (Federal Reserve Economic Data)

2256. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 80
   An extension of MCP for SillyTavern.

2257. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 80
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

2258. **[Embody](https://github.com/dylanroscover/Embody)** - ⭐ 80
   MCP + open network format for TouchDesigner. Create at the speed of thought

2259. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 79
...
2260. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 79
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

2261. **[fastmcp-boilerplate](https://github.com/punkpeye/fastmcp-boilerplate)** - ⭐ 79
   A simple MCP server built using FastMCP, TypeScript, ESLint, and Prettier.

2262. **[codemirror-mcp](https://github.com/marimo-team/codemirror-mcp)** - ⭐ 79
   CodeMirror extension to hook up a Model Context Provider (MCP)

2263. **[jira-mcp](https://github.com/nguyenvanduocit/jira-mcp)** - ⭐ 79
...
2264. **[glif-mcp-server](https://github.com/glifxyz/glif-mcp-server)** - ⭐ 79
   Easily run glif.app AI workflows inside your LLM: image generators, memes, selfies, and more. Glif supports all major multimedia AI models inside one app

2265. **[terminal_server](https://github.com/theailanguage/terminal_server)** - ⭐ 79
   MCP server that can execute terminal commands

2266. **[django-ai-boost](https://github.com/vintasoftware/django-ai-boost)** - ⭐ 79
   A MCP server for Django applications, inspired by Laravel Boost.

2267. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 79
...
2268. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 79
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

2269. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 79
   Model Context Protocol implementation for retrieving codebases using RepoMix

2270. **[bing-search-mcp](https://github.com/leehanchung/bing-search-mcp)** - ⭐ 78
   MCP Server for Bing Search API

2271. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 78
...
2272. **[Fusion-360-MCP-Server](https://github.com/AuraFriday/Fusion-360-MCP-Server)** - ⭐ 78
   Control Fusion 360 with any AI through Model Context Protocol (MCP)

2273. **[askimo](https://github.com/haiphucnguyen/askimo)** - ⭐ 78
...
2274. **[mcp-1c](https://github.com/feenlace/mcp-1c)** - ⭐ 78
...
2275. **[dramacraft](https://github.com/whatyun/dramacraft)** - ⭐ 78
   DramaCraft 是一个专业的短剧视频编辑 MCP (Model Context Protocol) 服务，集成国产中文大模型 API，实现剪映的智能自动化编辑功能。项目已完成从视频分析到草稿生成的完整解决方案

2276. **[transit-agent](https://github.com/ruby-verma/transit-agent)** - ⭐ 78
...
2277. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 78
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

2278. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 78
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

2279. **[line-desktop-mcp](https://github.com/dtwang/line-desktop-mcp)** - ⭐ 78
...
2280. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 77
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

2281. **[rtfmbro-mcp](https://github.com/marckrenn/rtfmbro-mcp)** - ⭐ 77
   rtfmbro provides always-up-to-date, version-specific package documentation as context for coding agents. An alternative to context7

2282. **[lucidity-mcp](https://github.com/hyperb1iss/lucidity-mcp)** - ⭐ 77
...
2283. **[visual-ui-debug-agent-mcp](https://github.com/samihalawa/visual-ui-debug-agent-mcp)** - ⭐ 77
   VUDA is an autonomous debugging agent that empowers AI models to visually analyze, test, and debug web

2284. **[devex](https://github.com/ParthKapoor-dev/devex)** - ⭐ 77
   ⚡️ Devex — A Fast, Secure, and Scalable Repl-as-a-Service Platform built for Developers 🚀

2285. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 77
   Model Context Protocol (MCP) Client for Apify's Actors

2286. **[mcp-reticle](https://github.com/LabTerminal/mcp-reticle)** - ⭐ 77
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

2287. **[mcp-llm](https://github.com/sammcj/mcp-llm)** - ⭐ 77
    An MCP server that provides LLMs access to other LLMs

2288. **[ExternalAttacker-MCP](https://github.com/MorDavid/ExternalAttacker-MCP)** - ⭐ 77
   A modular external attack surface mapping tool integrating tools for automated reconnaissance and bug bounty workflows.

2289. **[agent-security-scanner-mcp](https://github.com/sinewaveai/agent-security-scanner-mcp)** - ⭐ 77
   Security scanner MCP server for AI coding agents. Prompt injection firewall, package hallucination detection (4.3M+ packages), 1000+ vulnerability rules with AST & taint analysis, auto-fix.

2290. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 77
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

2291. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 77
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

2292. **[Ludus-FastMCP](https://github.com/tjnull/Ludus-FastMCP)** - ⭐ 77
...
2293. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 77
   A Model Context Protocol (MCP) server for Microsoft Clarity

2294. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 77
...
2295. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 77
   A full featured, enterprise grade rust MCP SDK

2296. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 77
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

2297. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 77
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

2298. **[mcp-gemini-google-search](https://github.com/yukukotani/mcp-gemini-google-search)** - ⭐ 76
   MCP server for Google Search integration using Gemini's built-in search capabilities

2299. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 76
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

2300. **[cursor10x-mcp](https://github.com/aiurda/cursor10x-mcp)** - ⭐ 76
   The Cursor10x MCP is a persistent multi-dimensional memory system for Cursor that enhances AI assistants with conversation context, project history, and code relationships across sessions.

2301. **[perplexity-mcp-zerver](https://github.com/wysh3/perplexity-mcp-zerver)** - ⭐ 76
   MCP web search using perplexity without any API KEYS 

2302. **[lazy-mcp](https://github.com/voicetreelab/lazy-mcp)** - ⭐ 76
     MCP proxy server with lazy loading support - reduces context usage through on-demand tool activation

2303. **[apitap](https://github.com/n1byn1kt/apitap)** - ⭐ 76
   The MCP server that turns any website into an API — no docs, no SDK, no browser. npm: @apitap/core

2304. **[sublinear-time-solver](https://github.com/ruvnet/sublinear-time-solver)** - ⭐ 76
...
2305. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 76
...
2306. **[hulunote](https://github.com/hulunote/hulunote)** - ⭐ 76
   AI + Note Hippocampus — Your second brain, powered by AI

2307. **[crawl4ai-mcp-server](https://github.com/sadiuysal/crawl4ai-mcp-server)** - ⭐ 76
...
2308. **[cesium-mcp](https://github.com/gaopengbin/cesium-mcp)** - ⭐ 76
...
2309. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 75
   A Model Context Protocol Server to perform Kafka client operations

2310. **[agentic-coding](https://github.com/sammcj/agentic-coding)** - ⭐ 75
   Agentic Coding Rules, Templates etc...

2311. **[mcp-llms-txt-explorer](https://github.com/thedaviddias/mcp-llms-txt-explorer)** - ⭐ 75
   MCP to explore websites with llms.txt files

2312. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 75
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

2313. **[unitree-go2-mcp-server](https://github.com/lpigeon/unitree-go2-mcp-server)** - ⭐ 75
   The Unitree Go2 MCP Server is a server built on the MCP that enables users to control the Unitree Go2 robot using natural language commands interpreted by a LLM.

2314. **[openfoam-mcp-server](https://github.com/webworn/openfoam-mcp-server)** - ⭐ 75
   LLM-powered OpenFOAM MCP server for intelligent CFD education with Socratic questioning and expert error resolution

2315. **[roundtable](https://github.com/askbudi/roundtable)** - ⭐ 75
...
2316. **[interactive-brokers-mcp](https://github.com/code-rabi/interactive-brokers-mcp)** - ⭐ 75
   Interactive Brokers MCP Server

2317. **[masquerade](https://github.com/postralai/masquerade)** - ⭐ 75
   The Privacy Firewall for LLMs

2318. **[Sephera](https://github.com/Reim-developer/Sephera)** - ⭐ 75
   Fast local-first Rust CLI for codebase metrics, AST-compressed LLM context bundles, and built-in MCP server.

2319. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 75
   Index of all Model Context Protocol (MCP) clients and their capabilities

2320. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 75
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

2321. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 75
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

2322. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 75
...
2323. **[conductor-tasks](https://github.com/hridaya423/conductor-tasks)** - ⭐ 74
   A task management system designed for AI development

2324. **[unreal-mcp](https://github.com/runreal/unreal-mcp)** - ⭐ 74
   MCP server for Unreal Engine that uses Unreal Python Remote Execution

2325. **[gdai-mcp-plugin-godot](https://github.com/3ddelano/gdai-mcp-plugin-godot)** - ⭐ 74
...
2326. **[UnrealMotionGraphicsMCP](https://github.com/winyunq/UnrealMotionGraphicsMCP)** - ⭐ 74
...
2327. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 74
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

2328. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 74
   Unified execution environment for Python code, shell commands, and programmatic MCP tool calls.

2329. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 74
...
2330. **[windbg-mcp](https://github.com/gengstah/windbg-mcp)** - ⭐ 74
...
2331. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 74
...
2332. **[bitcoin-mcp](https://github.com/AbdelStark/bitcoin-mcp)** - ⭐ 73
   Bitcoin & Lightning Network MCP Server.

2333. **[sanity-mcp-server](https://github.com/sanity-io/sanity-mcp-server)** - ⭐ 73
   Deprecated: Use the remote MCP server at https://mcp.sanity.io instead.

2334. **[Custom-MCP-Server](https://github.com/Sharan-Kumar-R/Custom-MCP-Server)** - ⭐ 73
   MCP server for scraping LinkedIn, Facebook, Instagram profiles and Google search.

2335. **[firefox-devtools-mcp](https://github.com/globau/firefox-devtools-mcp)** - ⭐ 73
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2336. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 73
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

2337. **[youtube-connector-mcp](https://github.com/ShellyDeng08/youtube-connector-mcp)** - ⭐ 73
...
2338. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 73
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

2339. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 73
...
2340. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 73
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

2341. **[awesome-mcp-best-practices](https://github.com/lirantal/awesome-mcp-best-practices)** - ⭐ 73
   Build Awesome MCPs with Awesome Best Practices for MCP Servers and MCP Clients

2342. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 72
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

2343. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 72
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

2344. **[github-brain](https://github.com/wham/github-brain)** - ⭐ 72
   An experimental GitHub MCP server with local database.

2345. **[mcp-openmemory](https://github.com/baryhuang/mcp-openmemory)** - ⭐ 72
   Simple standalone MCP server giving Claude the ability to remember your conversations and learn from them over time.

2346. **[joplin-mcp](https://github.com/alondmnt/joplin-mcp)** - ⭐ 72
   MCP server for the Joplin note taking app

2347. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 72
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2348. **[railway-mcp](https://github.com/jason-tan-swe/railway-mcp)** - ⭐ 72
   An unofficial and community-built MCP server for integrating with https://railway.app

2349. **[anilist-mcp](https://github.com/yuna0x0/anilist-mcp)** - ⭐ 72
   AniList MCP server for accessing anime and manga data

2350. **[Meting-Agent](https://github.com/ELDment/Meting-Agent)** - ⭐ 72
   🪐 面向 AI 的多音乐平台的 API 代理 • 网易云 • QQ音乐 • 酷狗 • 酷我 🎻 Multi-platform music API agent for AI • NetEase • QQ Music • KuGou • Kuwo

2351. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 72
   Model Context Protocol (MCP) server for Gmail

2352. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 72
...
2353. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 72
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

2354. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 72
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

2355. **[AutoGenesis](https://github.com/microsoft/AutoGenesis)** - ⭐ 72
...
2356. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 71
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

2357. **[adb-tui](https://github.com/alanisme/adb-tui)** - ⭐ 71
   🤖 Full-featured Android Debug Bridge TUI and MCP server. Control any device by keystroke or AI.

2358. **[ytt-mcp](https://github.com/cottongeeks/ytt-mcp)** - ⭐ 71
   MCP server to fetch YouTube transcripts

2359. **[MCP-wolfram-alpha](https://github.com/SecretiveShell/MCP-wolfram-alpha)** - ⭐ 71
   Connect your chat repl to wolfram alpha computational intelligence

2360. **[template-mcp-server](https://github.com/mcpdotdirect/template-mcp-server)** - ⭐ 71
   Template to quickly set up your own MCP server 

2361. **[sub-agents-mcp](https://github.com/shinpr/sub-agents-mcp)** - ⭐ 71
   Define task-specific AI sub-agents in Markdown for any MCP-compatible tool.

2362. **[medical-mcp](https://github.com/JamesANZ/medical-mcp)** - ⭐ 71
...
2363. **[trading-mcp](https://github.com/netanelavr/trading-mcp)** - ⭐ 71
   The MCP server that will help you trade smarter (or at least try)

2364. **[mcp-toolbox-sdk-js](https://github.com/googleapis/mcp-toolbox-sdk-js)** - ⭐ 71
   Javascript SDK for interacting with the MCP Toolbox for Databases.

2365. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 71
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resource Templates for client-side exploration.

2366. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 71
   MCP client for local ollama models

2367. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 71
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

2368. **[lc2mcp](https://github.com/xiaotonng/lc2mcp)** - ⭐ 70
   Convert LangChain tools to FastMCP tools

2369. **[join.cloud](https://github.com/kushneryk/join.cloud)** - ⭐ 70
...
2370. **[mcp-discord](https://github.com/barryyip0625/mcp-discord)** - ⭐ 70
   Implement Discord MCP server enabling AI assistants to interact with the Discord platform.

2371. **[ableton-copilot-mcp](https://github.com/xiaolaa2/ableton-copilot-mcp)** - ⭐ 70
...
2372. **[ros2_mcp](https://github.com/wise-vision/ros2_mcp)** - ⭐ 70
   Advanced MCP Server ROS 2 bridging AI agents straight into robotics

2373. **[CodeMCP](https://github.com/SimplyLiz/CodeMCP)** - ⭐ 70
   Code intelligence for AI assistants - MCP server, CLI, and HTTP API with symbol navigation, impact analysis, and architecture mapping

2374. **[mcd-mcp-server](https://github.com/M-China/mcd-mcp-server)** - ⭐ 70
   McDonald's China MCP Server Integration Guide

2375. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 70
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

2376. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 70
...
2377. **[mcp-shell](https://github.com/sonirico/mcp-shell)** - ⭐ 70
   Give hands to AI. MCP server to run shell commands securely, auditably, and on demand.

2378. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 70
   可视化的配置和管理，给xiaozhi接入mcp

2379. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 70
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

2380. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 70
...
2381. **[MCP-server-Deepseek_R1](https://github.com/kamelirzouni/MCP-server-Deepseek_R1)** - ⭐ 70
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

2382. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 70
   Python 实现 MCP client / service

2383. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 70
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

2384. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 69
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

2385. **[wasmcp](https://github.com/wasmcp/wasmcp)** - ⭐ 69
   Build MCP servers with WebAssembly components

2386. **[robot_MCP](https://github.com/IliaLarchenko/robot_MCP)** - ⭐ 69
   A simple MCP server for the SO-ARM100 control

2387. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 69
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

2388. **[mealie-mcp-server](https://github.com/rldiao/mealie-mcp-server)** - ⭐ 69
   MCP server that exposes Mealie APIs to MCP clients such as Claude Desktop

2389. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 69
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

2390. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 69
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

2391. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 69
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

2392. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 68
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

2393. **[QuickMCP](https://github.com/gunpal5/QuickMCP)** - ⭐ 68
   Effortlessly Build Model Context Protocol Servers with OpenAPI or Swagger or Google Discovery Specifications

2394. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 68
...
2395. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 68

2396. **[ClueoMCP](https://github.com/ClueoFoundation/ClueoMCP)** - ⭐ 68
...
2397. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 68
...
2398. **[mcp-server-node](https://github.com/lucianoayres/mcp-server-node)** - ⭐ 68
...
2399. **[deep-research-mcp-server](https://github.com/ssdeanx/deep-research-mcp-server)** - ⭐ 68
   MCP Deep Research Server using Gemini creating a Research AI Agent

2400. **[pydantic-rpc](https://github.com/i2y/pydantic-rpc)** - ⭐ 68
...
2401. **[vesta-mac-dist](https://github.com/scouzi1966/vesta-mac-dist)** - ⭐ 68
...
2402. **[hyperterse](https://github.com/hyperterse/hyperterse)** - ⭐ 68
   The MCP framework. Connect your data to your agents.

2403. **[nothumanallowed](https://github.com/adoslabsproject-gif/nothumanallowed)** - ⭐ 68
...
2407. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 68
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

2408. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 68
...
2409. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 68
...
2410. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

2411. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

2412. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 67
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

2413. **[shinzo-ts](https://github.com/shinzo-labs/shinzo-ts)** - ⭐ 67
...
2414. **[nav2_mcp_server](https://github.com/ajtudela/nav2_mcp_server)** - ⭐ 67
   MCP server that provides tools and resources to control and monitor robots using Nav2.

2415. **[mcp-bear](https://github.com/jkawamoto/mcp-bear)** - ⭐ 67
   A MCP server for interacting with Bear note-taking software.

2416. **[nautex](https://github.com/hmldns/nautex)** - ⭐ 67
   MCP server for guiding Coding Agents via end-to-end requirements to implementation plan pipeline

2417. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 67
...
2418. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 67
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

2419. **[Skills-ContextManager](https://github.com/One-Man-Company/Skills-ContextManager)** - ⭐ 67
...
2420. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 67
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

2421. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 67
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2422. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 67
   Model Context Protocol (MCP) server implementation for Autodesk Maya

2423. **[openscad-mcp](https://github.com/quellant/openscad-mcp)** - ⭐ 67
   A Model Context Protocol (MCP) server for OpenSCAD 3D modeling and rendering

2424. **[flapi](https://github.com/DataZooDE/flapi)** - ⭐ 66
...
2425. **[VibeShift](https://github.com/GroundNG/VibeShift)** - ⭐ 66
   [MCP Server] The Security Agent for AI assisted coding

2426. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 66
...
2427. **[amazon-mcp](https://github.com/Fewsats/amazon-mcp)** - ⭐ 66
   Amazon MCP server to search & buy products using the L402

2428. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 66
   Model Context Protocol(MCP) 中文教程讲解

2429. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 66
...
2432. **[houtini-lm](https://github.com/houtini-ai/houtini-lm)** - ⭐ 66
...
2433. **[mcp4k](https://github.com/ondrsh/mcp4k)** - ⭐ 65
   Compiler-driven MCP framework for Kotlin Multiplatform

2434. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 65
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

2435. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 65
   A Model Context Protocol implementation for FHIR

2436. **[fhir-mcp-server](https://github.com/the-momentum/fhir-mcp-server)** - ⭐ 65
   FHIR MCP Server for handling medical data standard.

2437. **[academia_mcp](https://github.com/IlyaGusev/academia_mcp)** - ⭐ 65
   Academia MCP server: Tools for automatic scientific research

2438. **[ClaudeHistoryMCP](https://github.com/jhammant/ClaudeHistoryMCP)** - ⭐ 65
   MCP server for searching and surfacing Claude Code conversation history

2439. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 65
...
2447. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 65
   Attio Model Context Protocol (MCP) server implementation

2448. **[mcp-victorialogs](https://github.com/VictoriaMetrics/mcp-victorialogs)** - ⭐ 65
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2449. **[gdal-mcp](https://github.com/JordanGunn/gdal-mcp)** - ⭐ 65
...
2450. **[zabbix-mcp-server](https://github.com/initMAX/zabbix-mcp-server)** - ⭐ 65
...
2458. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 64
...
2459. **[mirroir-mcp](https://github.com/jfarcand/mirroir-mcp)** - ⭐ 64
...
2460. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 64
   Altium Model Context Protocol server and Altium API script

2461. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 63
   MCP server for the ClinicalTrials.gov v2 API. Search trials, retrieve study details and results, and match patients to eligible trials.

2462. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 63
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

2463. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 63
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

2464. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 63
...
2465. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 63
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

2466. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 63
   A Model Context Protocol (MCP) server for Rember.

2467. **[mcp-server-atlassian-jira](https://github.com/aashari/mcp-server-atlassian-jira)** - ⭐ 63
...
2468. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 63
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

2469. **[CornMCP](https://github.com/yuki-20/CornMCP)** - ⭐ 63
...
2470. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 62
   Miro integration for Model Context Protocol

2471. **[mcp-server-ccxt](https://github.com/Nayshins/mcp-server-ccxt)** - ⭐ 62
   Cryptocurrency Market Data MCP Server

2472. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

2473. **[data-gov-il-mcp](https://github.com/DavidOsherdiagnostica/data-gov-il-mcp)** - ⭐ 62
   Advanced MCP server for seamless access to Israeli Government Open Data

2474. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 62
   Model Context Protocol server and client for R

2475. **[mcp-server-security-standard](https://github.com/mcp-security-standard/mcp-server-security-standard)** - ⭐ 62
...
2476. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 62
...
2477. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 62
   🗓️ A CalDAV Model Context Protocol (MCP) server to expose calendar operations as tools for AI assistants.

2478. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 62
...
2479. **[cortex-scout](https://github.com/cortex-works/cortex-scout)** - ⭐ 62
...
2480. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 62
...
2481. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 62
   ABAP MCP - Model Context Protocol - Server SDK

2482. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 62
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

2483. **[MiniMax-Coding-Plan-MCP](https://github.com/MiniMax-AI/MiniMax-Coding-Plan-MCP)** - ⭐ 62
...
2484. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 62
...
2485. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 62
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

2486. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 62
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

2487. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 62
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

2488. **[Alph](https://github.com/Aqualia/Alph)** - ⭐ 61
   Universal MCP Server Configuration Manager

2489. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

2490. **[identity-service](https://github.com/agntcy/identity-service)** - ⭐ 61
...
2491. **[nocodb-mcp-server](https://github.com/edwinbernadus/nocodb-mcp-server)** - ⭐ 61
   nocodb mcp server

2492. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 61
   A Clojure SDK to create MCP servers (and eventually clients)

2493. **[zeromcp](https://github.com/mrexodia/zeromcp)** - ⭐ 61
   Zero-dependency MCP server implementation.

2494. **[MCP-Dandan](https://github.com/82ch/MCP-Dandan)** - ⭐ 61
   MCP Security Solution for Agentic AI — real-time proxying, behavior analysis, and malicious tool detection

2495. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 61
   A curated list of awesome Model Context Protocol (MCP) servers.

2496. **[godoctor](https://github.com/danicat/godoctor)** - ⭐ 61
   A Model Context Protocol server for Go developers

2497. **[aguara](https://github.com/garagon/aguara)** - ⭐ 61
...
2498. **[Unity-AI-Animation](https://github.com/IvanMurzak/Unity-AI-Animation)** - ⭐ 61
...
2499. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 61
...
2500. **[1c-mcp](https://github.com/Untru/1c-mcp)** - ⭐ 61
   Curated list of MCP servers for 1C:Enterprise ecosystem | Каталог MCP-серверов для экосистемы 1С:Предприятие

2501. **[estonia-ai-kit](https://github.com/stefanoamorelli/estonia-ai-kit)** - ⭐ 61
...
2502. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 61
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

2503. **[devto-mcp](https://github.com/Arindam200/devto-mcp)** - ⭐ 60
   MCP Server of DevTo

2504. **[autosteer](https://github.com/notch-ai/autosteer)** - ⭐ 60
   Desktop app for multi-workspace Claude Code management

2505. **[mcp-server-echart](https://github.com/cnkanwei/mcp-server-echart)** - ⭐ 60
   基于 mcp-go 框架构建的 mcp 服务，它提供了一个能动态生成 ECharts 图表页面的工具。

2506. **[time-mcp](https://github.com/yokingma/time-mcp)** - ⭐ 60
   ⏰ Time MCP Server: Giving LLMs Time Awareness Capabilities

2507. **[blockbench-mcp-plugin](https://github.com/jasonjgardner/blockbench-mcp-plugin)** - ⭐ 60
   Adds MCP server to Blockbench

2508. **[mcp-bridgekit](https://github.com/mkbhardwas12/mcp-bridgekit)** - ⭐ 60
...
2509. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 60
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

2510. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 60
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

2511. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 60
...
2512. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 60
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the Anysite API, enabling not only data retrieval but also robust management of user accounts.

2513. **[SageFs](https://github.com/WillEhrendreich/SageFs)** - ⭐ 60
...
2514. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 60
   A Model Context Protocol server for Ashra

2515. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 60
   Unblock, scrape, and search tools for MCP clients

2516. **[metabase-mcp](https://github.com/hluaguo/metabase-mcp)** - ⭐ 60
...
2517. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 60
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

2518. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 60
...
2519. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 59
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

2520. **[mcp-ssh](https://github.com/shuakami/mcp-ssh)** - ⭐ 59
   🔐 SSH MCP Tool - AI-powered SSH management through MCP protocol | 基于MCP协议的SSH工具，为AI提供SSH远程操作能力

2521. **[mcp-difyworkflow-server](https://github.com/gotoolkits/mcp-difyworkflow-server)** - ⭐ 59
   mcp-difyworkflow-server is an mcp server Tools application that implements the query and invocation of Dify workflows, supporting the on-demand operation of multiple custom Dify workflows.

2522. **[cline-mcp-memory-bank](https://github.com/dazeb/cline-mcp-memory-bank)** - ⭐ 59
   A memory system for Cline that tracks progress between conversations.

2523. **[shadcn-ui-mcp-server](https://github.com/ymadd/shadcn-ui-mcp-server)** - ⭐ 59
   MCP server for shadcn/ui component references

2524. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 59
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

2525. **[mcp_server_gdb](https://github.com/pansila/mcp_server_gdb)** - ⭐ 59
   MCP Server to expose the GDB debugging capabilities

2526. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 59
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

2527. **[mono-mcp](https://github.com/sin4ch/mono-mcp)** - ⭐ 59
   A comprehensive Model Context Protocol (MCP) server for Nigerian banking operations using the Mono Open Banking API.

2528. **[ask-user-questions-mcp](https://github.com/paulp-o/ask-user-questions-mcp)** - ⭐ 59
...
2529. **[trpc-mcp-go](https://github.com/trpc-group/trpc-mcp-go)** - ⭐ 59
   Go implementation of the Model Context Protocol (MCP) with comprehensive Streamable HTTP, STDIO, and SSE support. 

2530. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 59
   MCP Server for IBKR Client

2531. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 59
   Model Context Protocol server for ActivityWatch time tracking data

2532. **[agent-architecture-review-sample](https://github.com/Azure-Samples/agent-architecture-review-sample)** - ⭐ 59
...
2533. **[adeu](https://github.com/dealfluence/adeu)** - ⭐ 59
...
2534. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 58
   MCP router and Web Based MCP client

2535. **[mcpserver](https://github.com/2234839/mcpserver)** - ⭐ 58
   为claude code+glm 添加上眼睛

2536. **[job-searchoor](https://github.com/0xDAEF0F/job-searchoor)** - ⭐ 58
   A simple MCP server that delivers you jobs based on your needs

2537. **[scrapegraph-mcp](https://github.com/ScrapeGraphAI/scrapegraph-mcp)** - ⭐ 58
   ScapeGraph MCP Server

2538. **[vscode-mcp](https://github.com/tjx666/vscode-mcp)** - ⭐ 58
...
2539. **[chucknorris](https://github.com/pollinations/chucknorris)** - ⭐ 58
...
2540. **[mcp-batchit](https://github.com/ryanjoachim/mcp-batchit)** - ⭐ 58
...
2541. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 58
   MCP (Model Context Protocol) server plugin for CAP NodeJS

2542. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 58
...
2543. **[gtm-mcp-server](https://github.com/paolobietolini/gtm-mcp-server)** - ⭐ 58
   An MCP server for Google Tag Manager. Connect it to your LLM, authenticate once, and start managing GTM through natural language.

2544. **[unity-mcp-plugin](https://github.com/AnkleBreaker-Studio/unity-mcp-plugin)** - ⭐ 58
...
2545. **[unreal-api-mcp](https://github.com/Codeturion/unreal-api-mcp)** - ⭐ 58
...
2546. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 58
...
2547. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 58
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

2548. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 57
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

2549. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 57
   Model Context Protocol server for Daipendency

2550. **[Archive-Agent](https://github.com/shredEngineer/Archive-Agent)** - ⭐ 57
   Find your files with natural language and ask questions.

2551. **[adbfriend](https://github.com/mikepenz/adbfriend)** - ⭐ 57
   Android ADB CLI tool including integrated MCP Server with common adb actions used during development

2552. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 57
   MKP is a Model Context Protocol (MCP) server for Kubernetes

2553. **[MCP_Atom_of_Thoughts](https://github.com/kbsooo/MCP_Atom_of_Thoughts)** - ⭐ 57
...
2554. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 57
   A Nasdaq Data Link MCP (Model Context Protocol) Server

2555. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 57
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

2556. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 57
   OCaml implementation of the Model Context Protocol (MCP)

2557. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 57
...
2558. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 57
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

2559. **[pentestMCP](https://github.com/RamKansal/pentestMCP)** - ⭐ 57
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2560. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 57
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

2561. **[cesium-ai-integrations](https://github.com/CesiumGS/cesium-ai-integrations)** - ⭐ 57
...
2562. **[powerpoint-mcp](https://github.com/Ayushmaniar/powerpoint-mcp)** - ⭐ 57
   Open Source Model Context Protocol server for PowerPoint automation on Windows via pywin32

2563. **[naver-search-mcp](https://github.com/isnow890/naver-search-mcp)** - ⭐ 56
...
2564. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 56
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

2565. **[mcp-thinking](https://github.com/mattzcarey/mcp-thinking)** - ⭐ 56
   thinking tool for claude desktop/mcp clients using Deepseek reasoner

2566. **[solana-mcp-server](https://github.com/openSVM/solana-mcp-server)** - ⭐ 56
   solana mcp sever to enable solana rpc methods

2567. **[web2mcp](https://github.com/neelsomani/web2mcp)** - ⭐ 56
   Generate an MCP for any web app

2568. **[mcp-server-flomo](https://github.com/chatmcp/mcp-server-flomo)** - ⭐ 56
   Write notes to Flomo

2569. **[MegaMemory](https://github.com/0xK3vin/MegaMemory)** - ⭐ 56
   Persistent project knowledge graph for coding agents. MCP server with semantic search, in-process embeddings, and web explorer.

2570. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 56
...
2571. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 56
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

2572. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 56
...
2573. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 56
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

2574. **[mcpshim](https://github.com/mcpshim/mcpshim)** - ⭐ 56
   Turn remote MCP servers into local command workflows.

2575. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 56
   A powerful Model Context Protocol server for LinkedIn API integration

2576. **[Intelli](https://github.com/intelligentnode/Intelli)** - ⭐ 55
   Build multi-model chatbots and agents from intent.

2577. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 55
...
2578. **[Memory-Plus](https://github.com/Yuchen20/Memory-Plus)** - ⭐ 55
...
2579. **[deploystack](https://github.com/deploystackio/deploystack)** - ⭐ 55
   Open source MCP hosting - deploy MCP servers to HTTP endpoints for n8n, Dify, Voiceflow, and any MCP client.

2580. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 55
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

2581. **[astro-mcp](https://github.com/morinokami/astro-mcp)** - ⭐ 55
   MCP server to support Astro project development

2582. **[mcp-secrets-plugin](https://github.com/amirshk/mcp-secrets-plugin)** - ⭐ 55
...
2583. **[trellis_blender](https://github.com/FishWoWater/trellis_blender)** - ⭐ 55
   Blender plugin for TRELLIS and TRELLIS.2 (3D AIGC Model, Text-to-3D, Image-to-3D)

2584. **[powhttp-mcp](https://github.com/usestring/powhttp-mcp)** - ⭐ 55
   MCP server enabling agents to debug HTTP requests better (using powhttp)

2585. **[python](https://github.com/mcp-auth/python)** - ⭐ 55
   🔐 Plug-and-play auth for Python MCP servers.

2586. **[cosmotop](https://github.com/bjia56/cosmotop)** - ⭐ 55
   Multiplatform system monitoring tool using Cosmopolitan Libc

2587. **[AfdianToMarkdown](https://github.com/PhiFever/AfdianToMarkdown)** - ⭐ 55
   爱发电爬虫(afdian.com)

2588. **[go-crx3](https://github.com/mmadfox/go-crx3)** - ⭐ 55
...
2589. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 55
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

2590. **[mcp-duckdb-memory-server](https://github.com/IzumiSy/mcp-duckdb-memory-server)** - ⭐ 55
   MCP Memory Server with DuckDB backend

2591. **[unraid-mcp](https://github.com/jmagar/unraid-mcp)** - ⭐ 55
...
2592. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 55
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

2593. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 55
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

2594. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 55
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

2595. **[client](https://github.com/php-mcp/client)** - ⭐ 55
   Core PHP implementation for the Model Context Protocol (MCP) Client

2596. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 55
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

2597. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 55
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

2598. **[openzim-mcp](https://github.com/cameronrye/openzim-mcp)** - ⭐ 54
...
2599. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 54
...
2600. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

2601. **[minibridge](https://github.com/acuvity/minibridge)** - ⭐ 54
   Make your MCP servers secure and production ready

2602. **[temporal-mcp](https://github.com/Mocksi/temporal-mcp)** - ⭐ 54
   Empowering AI with Workflow Orchestration

2603. **[sympy-mcp](https://github.com/sdiehl/sympy-mcp)** - ⭐ 54
   A MCP server for symbolic manipulation of mathematical expressions

2604. **[swift-mcp-gui](https://github.com/NakaokaRei/swift-mcp-gui)** - ⭐ 54
   MCP server that can execute commands such as keyboard input and mouse movement on macOS

2605. **[talkito](https://github.com/robdmac/talkito)** - ⭐ 54
...
2606. **[Navidrome-MCP](https://github.com/Blakeem/Navidrome-MCP)** - ⭐ 54
...
2607. **[claude-code-emacs](https://github.com/yuya373/claude-code-emacs)** - ⭐ 54
...
2608. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 54
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

2609. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 54
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

2610. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 54
   Go SDK for interacting with the MCP Toolbox for Databases.

2611. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 54
   A Model Context Protocol server that validates and renders Mermaid diagrams.

2612. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 54
...
2613. **[brainstorm-mcp](https://github.com/spranab/brainstorm-mcp)** - ⭐ 54
   MCP server for multi-round AI brainstorming debates between multiple models (GPT, DeepSeek, Groq, Ollama, etc.)

2614. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 54
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

2615. **[UnrealMCPBridge](https://github.com/appleweed/UnrealMCPBridge)** - ⭐ 54
   An Unreal Engine plugin that implements an MCP server allowing MCP clients to access the UE Editor Python API.

2616. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 54
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

2617. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 53
   Model Context Protocol Servers for Azure AI Search

2618. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 53
...
2619. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

2620. **[user-feedback-mcp](https://github.com/mrexodia/user-feedback-mcp)** - ⭐ 53
   Simple MCP Server to enable a human-in-the-loop workflow in tools like Cline and Cursor.

2621. **[Multi-Agent-System-A2A-ADK-MCP](https://github.com/RubensZimbres/Multi-Agent-System-A2A-ADK-MCP)** - ⭐ 53
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2622. **[skrills](https://github.com/athola/skrills)** - ⭐ 53
...
2623. **[ntfy-me-mcp](https://github.com/gitmotion/ntfy-me-mcp)** - ⭐ 53
...
2624. **[mcp-dap-server](https://github.com/go-delve/mcp-dap-server)** - ⭐ 53
   MCP server to communicate with DAP servers allowing AI Agents the ability to debug live programs.

2625. **[mcp-guard](https://github.com/General-Analysis/mcp-guard)** - ⭐ 53
   MCP Guard secures your MCP client from prompt injection attacks and more.

2626. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 53
...
2632. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 53
...
2633. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 52
   Unofficial Golang SDK for Anthropic Model Context Protocol

2634. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 52
...
2635. **[A2A_ADK_MCP](https://github.com/RubensZimbres/A2A_ADK_MCP)** - ⭐ 52
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2636. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 52
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2637. **[baba_is_eval](https://github.com/lennart-finke/baba_is_eval)** - ⭐ 52
   Claude  et al. play the brilliant puzzle title "Baba is You"

2638. **[us-census-bureau-data-api-mcp](https://github.com/uscensusbureau/us-census-bureau-data-api-mcp)** - ⭐ 52
   The U.S. Census Bureau Data API MCP connects AI Assistants with official Census Bureau statistics.

2639. **[youtube-mcp-server](https://github.com/mourad-ghafiri/youtube-mcp-server)** - ⭐ 52
   A powerful Model Context Protocol (MCP) server for YouTube video transcription and metadata extraction.

2640. **[gemini-cloud-assist-mcp](https://github.com/GoogleCloudPlatform/gemini-cloud-assist-mcp)** - ⭐ 52
   An MCP Server for Gemini Cloud Assist; provides tools to assist with your tasks on GCP

2641. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 52
   Inkdrop Model Context Protocol Server

2642. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 52
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

2643. **[rs-utcp](https://github.com/universal-tool-calling-protocol/rs-utcp)** - ⭐ 52
   Official Rust implementation of the UTCP

2644. **[youtrack-mcp](https://github.com/devstroop/youtrack-mcp)** - ⭐ 52
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2645. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 52
   MCP client for Discourse sites

2646. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 52
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

2647. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 52
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

2648. **[unity-api-mcp](https://github.com/Codeturion/unity-api-mcp)** - ⭐ 52
...
2649. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 52
...
2650. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 52
   Implementation of Model Context Protocol server for Mailgun APIs

2651. **[mcp-stata](https://github.com/tmonk/mcp-stata)** - ⭐ 52
...
2652. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 52
...
2653. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 52
...
2654. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 52
...
2655. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 52
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

2656. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 52
   Amadeus MCP(Model Context Protocol) Server

2657. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 52
...
2658. **[go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql)** - ⭐ 51
   Zero burden, ready-to-use Model Context Protocol (MCP) server for interacting with MySQL and automation. No Node.js or Python environment needed.

2659. **[mcp-app-demo](https://github.com/pomerium/mcp-app-demo)** - ⭐ 51
...
2660. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 51
...
2661. **[gdal-mcp](https://github.com/Wayfinder-Foundry/gdal-mcp)** - ⭐ 51
   Model Context Protocol server that packages GDAL-style geospatial workflows through Python-native libraries (Rasterio, GeoPandas, PyProj, etc.) to give AI agents catalog discovery, metadata intelligence, and raster/vector processing with built-in reasoning guidance and reference resources.

2662. **[whois-mcp](https://github.com/bharathvaj-ganesan/whois-mcp)** - ⭐ 51
   MCP Server for whois lookups.

2663. **[mcp-atlassian-server](https://github.com/phuc-nt/mcp-atlassian-server)** - ⭐ 51
   MCP server connecting AI assistants with Jira & Confluence for smart project management.

2664. **[ShadowCrawl](https://github.com/DevsHero/ShadowCrawl)** - ⭐ 51
...
2665. **[hmr](https://github.com/promplate/hmr)** - ⭐ 51
   Real hot-module reload for Python—side effects handled reactively. https://py3.online/hmr

2666. **[matlab-mcp-server](https://github.com/subspace-lab/matlab-mcp-server)** - ⭐ 51
   Matlab MCP Server in python

2667. **[mcp-auth-servers](https://github.com/Azure-Samples/mcp-auth-servers)** - ⭐ 51
   🔒 Reference MCP servers that demo how authentication works with the current Model Context Protocol spec.

2668. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 51
...
2669. **[luma-mcp](https://github.com/JochenYang/luma-mcp)** - ⭐ 51
...
2670. **[tokio-prompt-orchestrator](https://github.com/Mattbusel/tokio-prompt-orchestrator)** - ⭐ 51
   Multi-core, Tokio-native orchestration for LLM pipelines.

2671. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 51
...
2677. **[template-mcp-server](https://github.com/redhat-data-and-ai/template-mcp-server)** - ⭐ 51
   Production-ready Python template for building MCP servers with FastMCP, FastAPI, OAuth, and OpenShift deployment.

2678. **[openclaw-superpowers](https://github.com/ArchieIndian/openclaw-superpowers)** - ⭐ 51
   44 plug-and-play skills for OpenClaw — self-modifying AI agent with cron scheduling, security guardrails, persistent memory, knowledge graphs, and MCP health monitoring. Your agent teaches itself new behaviors during conversation.

2679. **[wp-mcp-ultimate](https://github.com/AgriciDaniel/wp-mcp-ultimate)** - ⭐ 51
...
2680. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 50

2681. **[Perigon.CLI](https://github.com/AterDev/Perigon.CLI)** - ⭐ 50
...
2685. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 50
...
2686. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 50
   An implementation of the Model Context Protocol in Ruby.

2687. **[mcp-server-atlassian-confluence](https://github.com/aashari/mcp-server-atlassian-confluence)** - ⭐ 50
   Node.js/TypeScript MCP server for Atlassian Confluence. Provides tools enabling AI systems (LLMs) to list/get spaces & pages (content formatted as Markdown) and search via CQL. Connects AI seamlessly to Confluence knowledge bases using the standard MCP interface.

2688. **[gimp-mcp](https://github.com/maorcc/gimp-mcp)** - ⭐ 50
   GIMP MCP server

2689. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 50
   vMCP - Virtual Model Context Protocol

2690. **[mcp-tts](https://github.com/blacktop/mcp-tts)** - ⭐ 50
   MCP Server for Text to Speech

2691. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 50
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

2692. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 50
   MCP (Model Context Protocol) server for the Contentful Management API

2693. **[sample-agentic-ai-web](https://github.com/aws-samples/sample-agentic-ai-web)** - ⭐ 50
...
2694. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 50
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

2695. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 50
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2696. **[civyk-winwright](https://github.com/civyk-official/civyk-winwright)** - ⭐ 50
...
2697. **[reaper-mcp](https://github.com/bonfire-audio/reaper-mcp)** - ⭐ 50
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2698. **[n8n-workflow-builder-mcp](https://github.com/ifmelate/n8n-workflow-builder-mcp)** - ⭐ 49
   MCP server that allow LLM in agent mode builds n8n workflows for you

2699. **[oatpp-mcp](https://github.com/oatpp/oatpp-mcp)** - ⭐ 49
   Anthropic’s Model Context Protocol implementation for Oat++

2700. **[linux-do-mcp](https://github.com/Pleasurecruise/linux-do-mcp)** - ⭐ 49
   A MCP Server For LINUX DO community

2701. **[agent-os](https://github.com/imran-siddique/agent-os)** - ⭐ 49
   A Safety-First Kernel for Autonomous AI Agents - POSIX-inspired primitives with 0% policy violation guarantee

2702. **[cinema4d-mcp](https://github.com/ttiimmaacc/cinema4d-mcp)** - ⭐ 49
   Cinema 4D plugin integrating Claude AI for prompt-driven 3D modeling, scene creation, and manipulation.

2703. **[image-gen-mcp](https://github.com/lansespirit/image-gen-mcp)** - ⭐ 49
   An MCP server that integrates with gpt-image-1 & Gemini imagen4 model for text-to-image generation services

2704. **[mcp](https://github.com/goplus/mcp)** - ⭐ 49
...
2705. **[mcp_server_notify](https://github.com/Cactusinhand/mcp_server_notify)** - ⭐ 49
   Send system notification when Agent task is done.

2706. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 49
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

2707. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 49
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

2708. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 49

2709. **[MCPwner](https://github.com/Pigyon/MCPwner)** - ⭐ 49
   Model Context Protocol server for autonomous vulnerability discovery

2710. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 49
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

2711. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 49
...
2715. **[notebooklm-mcp](https://github.com/roomi-fields/notebooklm-mcp)** - ⭐ 49
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

2716. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 49
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

2717. **[gtm-mcp](https://github.com/impecablemee/gtm-mcp)** - ⭐ 49
...
2718. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 48
   IMAP Model Context Protocol server for interactive email processing

2719. **[mcp-codebase-index](https://github.com/MikeRecognex/mcp-codebase-index)** - ⭐ 48
...
2720. **[Koppla](https://github.com/ruudmens/Koppla)** - ⭐ 48
   A Model-Context-Protocol (MCP) Server for Active Directory

2721. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 48
...
2722. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
2723. **[mcp-server-chart-minio](https://github.com/zaizaizhao/mcp-server-chart-minio)** - ⭐ 48
   mcp-server-chart私有化部署方案

2724. **[lakevision](https://github.com/lakevision-project/lakevision)** - ⭐ 48
   Lakevision is a tool which provides insights into your Apache Iceberg based Data Lakehouse.

2725. **[buildkite-mcp-server](https://github.com/buildkite/buildkite-mcp-server)** - ⭐ 48
   Official MCP Server for Buildkite.

2726. **[mcp-metabase-server](https://github.com/easecloudio/mcp-metabase-server)** - ⭐ 48
   A comprehensive MCP server for Metabase with 70+ tools.

2727. **[globalping-mcp-server](https://github.com/jsdelivr/globalping-mcp-server)** - ⭐ 48
   Remote MCP server that gives LLMs access to run network commands

2728. **[advanced-homeassistant-mcp](https://github.com/jango-blockchained/advanced-homeassistant-mcp)** - ⭐ 48
   An advanced MCP server for Home Assistant. 🔋 Batteries included.

2729. **[codex-specialized-subagents](https://github.com/leonardsellem/codex-specialized-subagents)** - ⭐ 48
   MCP server that lets Codex delegate to isolated codex exec sub-agents, selecting repo+global skills automatically

2730. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

2731. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 48
...
2732. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 48
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

2733. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 48
   Model Context Protocol to fetch youtube transcript

2734. **[illustrator-mcp-server](https://github.com/spencerhhubert/illustrator-mcp-server)** - ⭐ 48
   mcp server to run scripts on adobe illustrator

2735. **[lisply-mcp](https://github.com/gornskew/lisply-mcp)** - ⭐ 48
   Model Context Protocol (MCP) server to manage and talk to compliant "Lisply" lisp-speaking backend services

2736. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 48
   Un-official Serper Google search server for Cline and other MCP clients

2737. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

2738. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

2739. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 48
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

2740. **[evernote-mcp-server](https://github.com/brentmid/evernote-mcp-server)** - ⭐ 48
   Evernote MCP server - allows LLMs that support MCP (like Claude Desktop) to query your notes in Evernote

2741. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 48
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

2742. **[claude-plugins](https://github.com/2389-research/claude-plugins)** - ⭐ 48
...
2743. **[Kaimon.jl](https://github.com/kahliburke/Kaimon.jl)** - ⭐ 48
...
2744. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 48
...
2745. **[reddit-mcp-server](https://github.com/jordanburke/reddit-mcp-server)** - ⭐ 48
   ⚙️ A Model Context Protocol (MCP) that provides tools for fetching and creating Reddit content

2746. **[shadowgit-mcp](https://github.com/aflsolutions/shadowgit-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides AI assistants with secure, read-only access to your ShadowGit repositories. This enables powerful debugging and code analysis capabilities by giving AI access to your project's fine-grained git history.

2747. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 47
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

2748. **[mcp-mail](https://github.com/shuakami/mcp-mail)** - ⭐ 47
   📧 MCP Mail Tool - AI-powered email management tool | 基于 MCP 的智能邮件管理工具

2749. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 47
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

2750. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 47
   A simple example of building an MCP client using C#.

2751. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
2752. **[spec-coding-mcp](https://github.com/feiyun0112/spec-coding-mcp)** - ⭐ 47
...
2753. **[gnome-mcp-server](https://github.com/bilelmoussaoui/gnome-mcp-server)** - ⭐ 47
   Grant the AI octopus access to a portion of your desktop

2754. **[dremio-mcp](https://github.com/dremio/dremio-mcp)** - ⭐ 47
   Dremio MCP server

2755. **[Reversecore_MCP](https://github.com/sjkim1127/Reversecore_MCP)** - ⭐ 47
...
2756. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 47
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

2757. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 47
   OpenAPI Schema Model Context Protocol Server

2758. **[MDB-MCP](https://github.com/smadi0x86/MDB-MCP)** - ⭐ 47
   Multi Debugger MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

2759. **[mcp-zen](https://github.com/199-mcp/mcp-zen)** - ⭐ 47
   Enhanced Zen MCP Server with 'zen' default tool and improvements

2760. **[ai-software-architect](https://github.com/codenamev/ai-software-architect)** - ⭐ 47
...
2761. **[RivalSearchMCP](https://github.com/damionrashford/RivalSearchMCP)** - ⭐ 47
...
2762. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 47
   Sample MCP Server and MCP client with Aspire

2763. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 47
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

2764. **[mcp-ai-memory](https://github.com/scanadi/mcp-ai-memory)** - ⭐ 47
   A production-ready Model Context Protocol (MCP) server for semantic memory management

2765. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 47
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2766. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 47
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

2767. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 47
...
2768. **[npm-packages](https://github.com/WebMCP-org/npm-packages)** - ⭐ 47
   NPM packages for MCP-B: Transport layers, React hooks, and browser tools for the Model Context Protocol

2769. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 47
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

2770. **[oh-my-codex](https://github.com/scalarian/oh-my-codex)** - ⭐ 47
...
2771. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 47
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

2772. **[ferris-search](https://github.com/lispking/ferris-search)** - ⭐ 47
   A blazing-fast MCP (Model Context Protocol) server for multi-engine web search, written in Rust.

2773. **[qgis-mcp](https://github.com/nkarasiak/qgis-mcp)** - ⭐ 47
   Connect QGIS to Claude AI through the Model Context Protocol (MCP)

2774. **[minimax_search](https://github.com/MiniMax-AI/minimax_search)** - ⭐ 47
   MiniMax Search is an MCP (Model Context Protocol) server that provides web search and browsing capabilities.

2775. **[MCP-Trust-Kit](https://github.com/aak204/MCP-Trust-Kit)** - ⭐ 46
   Deterministic CI scanner and surface-risk scoring for MCP (Model Context Protocol) servers.

2776. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 46
   共学《MCP极简开发》项目代码

2777. **[steel-mcp-server](https://github.com/steel-dev/steel-mcp-server)** - ⭐ 46
   MCP Server for interacting with a Steel web browser

2778. **[tiger-slack](https://github.com/timescale/tiger-slack)** - ⭐ 46
   Real-time Slack ingest and MCP server to power your agentic Slack bots

2779. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 46
   Model Context Protocol server for Flight Tracking

2780. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 46
   MCPcat is an analytics platform for MCP server owners 🐱.

2781. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 46
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

2782. **[inAI-wiki](https://github.com/inai-sandy/inAI-wiki)** - ⭐ 46
   🌍 The open-source Wikipedia of AI — 2M+ apps, agents, LLMs & datasets. Updated daily with tools, tutorials & news.

2783. **[lighthouse-mcp-server](https://github.com/danielsogl/lighthouse-mcp-server)** - ⭐ 46
   MCP server that enables AI agents to perform comprehensive web audits using Google Lighthouse with 13+ tools for performance, accessibility, SEO, and security analysis.

2784. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 46
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2785. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 46
...
2786. **[sharedcontext](https://github.com/Eversmile12/sharedcontext)** - ⭐ 46
...
2787. **[claude-additional-models-mcp](https://github.com/Arkya-AI/claude-additional-models-mcp)** - ⭐ 46
...
2788. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

2789. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 46
   An implementation of the Model Context Protocol for the World Bank open data API

2790. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 46
...
2791. **[Generative-UI-MCP](https://github.com/op7418/Generative-UI-MCP)** - ⭐ 46
   MCP server that teaches AI models to generate interactive visualizations — charts, diagrams, mockups, and more.

2792. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 46
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

2793. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 46
   An opinionated starter template for making Model Context Protocol (MCP) servers

2794. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 46
...
2795. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2796. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 46
...
2797. **[native-devtools-mcp](https://github.com/sh3ll3x3c/native-devtools-mcp)** - ⭐ 46
...
2798. **[RoslynMCP](https://github.com/carquiza/RoslynMCP)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides C# code analysis capabilities using Microsoft Roslyn

2799. **[unity-mcp-pro-plugin](https://github.com/youichi-uda/unity-mcp-pro-plugin)** - ⭐ 46
...
2800. **[dataworkers-claw-community](https://github.com/DataWorkersProject/dataworkers-claw-community)** - ⭐ 45
   We’re build a swarm of agents for all data tasks. That anyone can use for free, open-source community version.  

2801. **[octave-mcp](https://github.com/elevanaltd/octave-mcp)** - ⭐ 45
...
2802. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 45
...
2803. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 45
   ElizaOS plugin allowing agents to connect to MCP servers

2804. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

2805. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 45
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

2806. **[js](https://github.com/mcp-auth/js)** - ⭐ 45
   🔐 Plug-and-play auth for Node.js MCP servers.

2807. **[mcp-yfinance-server](https://github.com/Adity-star/mcp-yfinance-server)** - ⭐ 45
   Real-time stock API with Python, MCP server example, yfinance stock analysis dashboard

2808. **[mcp_server_filesystem](https://github.com/MarcusJellinghaus/mcp_server_filesystem)** - ⭐ 45
   MCP File System Server: A secure Model Context Protocol server that provides file operations for AI assistants. Enables Claude and other assistants to safely read, write, and list files in a designated project directory with robust path validation and security controls.

2809. **[ainovelprompter](https://github.com/danielsobrado/ainovelprompter)** - ⭐ 45
   Create the prompts you need to write your Novel using AI

2810. **[kanban-mcp](https://github.com/bradrisse/kanban-mcp)** - ⭐ 45
...
2811. **[gopls-mcp](https://github.com/xieyuschen/gopls-mcp)** - ⭐ 45
   MCP server for golang projects development: Expand AI Code Agent ability boundary to have a semantic understanding and determinisic information for golang projects.

2812. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 45
...
2813. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 45
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

2814. **[mcp-workspace](https://github.com/MarcusJellinghaus/mcp-workspace)** - ⭐ 45
...
2815. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 45
...
2816. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 45
   GraphQL Schema Model Context Protocol Server

2817. **[bonnard-cli](https://github.com/bonnard-data/bonnard-cli)** - ⭐ 45
   Open-source agentic schema CLI. Optimised for claude code, gemini, codex and co-pilot. Skills included.

2818. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 45
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

2819. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 45
...
2820. **[aitour26-WRK542-prototype-agents-with-the-ai-toolkit-and-model-context-protocol](https://github.com/microsoft/aitour26-WRK542-prototype-agents-with-the-ai-toolkit-and-model-context-protocol)** - ⭐ 45

2821. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

2822. **[mcpx](https://github.com/lydakis/mcpx)** - ⭐ 45
   Turn MCP servers into composable CLIs.

2823. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 45
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

2824. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 45
   A Model Context Protocol (MCP) server for NATS messaging system integration

2825. **[cheat-engine-server-python](https://github.com/bethington/cheat-engine-server-python)** - ⭐ 45
...
2826. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 45
...
2827. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 45
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

2828. **[omnifocus-mcp-enhanced](https://github.com/jqlts1/omnifocus-mcp-enhanced)** - ⭐ 45
...
2829. **[mcp](https://github.com/supadata-ai/mcp)** - ⭐ 45
   Official Supadata MCP Server - Adds powerful video & web scraping to Cursor, Claude and any other LLM clients.

2830. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 44
   Model Context Protocol server for Salesforce REST API integration

2831. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 44
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

2832. **[moondream-mcp](https://github.com/ColeMurray/moondream-mcp)** - ⭐ 44
   Moondream MCP Server in Python

2833. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
2834. **[mcp-typescribe](https://github.com/yWorks/mcp-typescribe)** - ⭐ 44
   An MCP server implementation enabling LLMs to work with new APIs and frameworks

2835. **[code-screenshot-mcp](https://github.com/MoussaabBadla/code-screenshot-mcp)** - ⭐ 44
   MCP server for generating beautiful code screenshots directly from Claude

2836. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 44
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

2837. **[chrome-debug-mcp](https://github.com/robertheadley/chrome-debug-mcp)** - ⭐ 44
   An MCP server to allow you to debug webpages using LLMs

2838. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 44
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

2839. **[yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp)** - ⭐ 44
   Yandex Tracker MCP Server with OAuth2 support

2840. **[adal-cli](https://github.com/SylphAI-Inc/adal-cli)** - ⭐ 44
...
2841. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 44
   Model Context Protocol Platform，统一管理你的MCP服务

2842. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 44
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

2843. **[prism-mcp-rs](https://github.com/prismworks-ai/prism-mcp-rs)** - ⭐ 44
   Enterprise-grade Rust implementation of Anthropic's MCP protocol

2844. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 44
   Generic MCP Client to use any MCP tool in a chat

2845. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 44
...
2846. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 44
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

2847. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 44
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

2848. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 44
...
2849. **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** - ⭐ 44
...
2850. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 44
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

2851. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 44
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

2852. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 44
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2853. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 44
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

2854. **[yahoo-finance-server](https://github.com/AgentX-ai/yahoo-finance-server)** - ⭐ 44
...
2855. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 44
   A curated list of excellent Model Context Protocol (MCP) servers.

2856. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 44
   Algorand Local Model Context Protocol (Server & Client)

2857. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 44
...
2858. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 44
   A Model Context Protocol server implementation for Kagi's API

2859. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 44
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

2860. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 43
   Quantum-proof MCP Server and Client Interactions

2861. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 43
...
2862. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 43
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

2863. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 43
   Model Context Protocol for WeChat

2864. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

2865. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

2866. **[mcp-rquest](https://github.com/xxxbrian/mcp-rquest)** - ⭐ 43
...
2871. **[nia](https://github.com/nozomio-labs/nia)** - ⭐ 43
...
2872. **[lastsaas](https://github.com/jonradoff/lastsaas)** - ⭐ 43
...
2873. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 43
   Solana Model Context Protocol (MCP) Demo

2874. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 43
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

2875. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 43
   Model Context Protocol (MCP) server for LinkedIn API integration

2876. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 43
...
2877. **[Dragon-Brain](https://github.com/iikarus/Dragon-Brain)** - ⭐ 43
...
2884. **[mobile-dev-mcp-server](https://github.com/jsuarezruiz/mobile-dev-mcp-server)** - ⭐ 42
   This is a MCP designed to manage and interact with mobile devices and simulators.

2885. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 42
   Model Context Protocol Clojure support including REPL integration with development tools.

2886. **[zed-mcp-server-sequential-thinking](https://github.com/LoamStudios/zed-mcp-server-sequential-thinking)** - ⭐ 42
   A sequential thinking MCP server extension for Zed

2887. **[whatsapp-mcp](https://github.com/felipeadeildo/whatsapp-mcp)** - ⭐ 42
   WhatsApp Unofficial MCP Server

2888. **[linkedapi-mcp](https://github.com/Linked-API/linkedapi-mcp)** - ⭐ 42
   MCP server that lets AI assistants control LinkedIn accounts and retrieve real-time data.

2889. **[TWSEMCPServer](https://github.com/twjackysu/TWSEMCPServer)** - ⭐ 42
   台灣證交所OpenAPI 的 MCP Server

2890. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 42
   Bluesky MCP (Model Context Protocol) Server

2891. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 42
...
2892. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 42
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

2893. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 42
   Rimworld Coding RAG MCP server

2894. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 42
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

2895. **[fal-mcp-server](https://github.com/raveenb/fal-mcp-server)** - ⭐ 42
   MCP server for Fal.ai - Generate images, videos, music and audio with Claude

2896. **[getnote-mcp](https://github.com/iswalle/getnote-mcp)** - ⭐ 42
   GetNote For MCP

2897. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 42
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

2898. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 42
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

2899. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 42
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

2900. **[devswarm](https://github.com/justrach/devswarm)** - ⭐ 42
...
2901. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 42
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

2902. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 42
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

2903. **[PowerShell.MCP](https://github.com/yotsuda/PowerShell.MCP)** - ⭐ 42
...
2904. **[codesys-mcp-toolkit](https://github.com/johannesPettersson80/codesys-mcp-toolkit)** - ⭐ 42
   Model Context Protocol server for CODESYS automation platform

2905. **[email-mcp](https://github.com/TimeCyber/email-mcp)** - ⭐ 42
   一个让AI轻松接管邮箱的MCP服务，基于 Model Context Protocol (MCP) 构建，支持在 MCP-X,Claude Desktop 等 MCP 客户端中使用。

2906. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 42
   Sync MCP (Model Context Protocol) configurations across AI tools

2907. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 41
   Model Context Protocol (MCP) implementation for iOS simulators

2908. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
   MCP server that exposes YepCode processes as callable tools for AI platforms. Securely connect AI assistants to your YepCode workflows, APIs, and automations.

2909. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 41
   Dynamic Shell Command MCP Server

2910. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 41
   A Model Context Protocol server for Dify

2911. **[ZMCPTools](https://github.com/ZachHandley/ZMCPTools)** - ⭐ 41
   A custom TypeScript MCP Server intended to be used with Claude Code

2912. **[locallama-mcp](https://github.com/Heratiki/locallama-mcp)** - ⭐ 41
...
2913. **[seekcode](https://github.com/seekrays/seekcode)** - ⭐ 41
   A clean and efficient code snippet and clipboard management tool designed for developers

2914. **[platform-context-exporter](https://github.com/alkoleft/platform-context-exporter)** - ⭐ 41
   Инструмент для выгрузки синтаксис помощника в файлы

2915. **[mcp-obsidian](https://github.com/fazer-ai/mcp-obsidian)** - ⭐ 41
   MCP server for Obsidian (TypeScript + Bun)

2916. **[unreal-mcp](https://github.com/runeape-sats/unreal-mcp)** - ⭐ 41
   Unreal Engine MCP server for Claude Desktop (early alpha preview)

2917. **[neurondb](https://github.com/neurondb/neurondb)** - ⭐ 41
   PostgreSQL extension for vector search, embeddings, and ML, plus NeuronAgent runtime and NeuronMCP server.

2918. **[processhacker-mcp](https://github.com/illegal-instruction-co/processhacker-mcp)** - ⭐ 41
   your ai debugger, vibe hacking tool

2919. **[mermaid-mcp](https://github.com/Narasimhaponnada/mermaid-mcp)** - ⭐ 41

2920. **[gatekit](https://github.com/gatekit-ai/gatekit)** - ⭐ 41
   A hackable Model Context Protocol (MCP) gateway

2921. **[memcord](https://github.com/ukkit/memcord)** - ⭐ 41
   🧠 Privacy-first MCP server for AI memory management. Save, search & organize chat history with intelligent  summarization.

2922. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 41
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

2923. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 41
...
2924. **[kirby-mcp](https://github.com/bnomei/kirby-mcp)** - ⭐ 41
...
2925. **[mie](https://github.com/kraklabs/mie)** - ⭐ 41
...
2926. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 41
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

2927. **[arifOS](https://github.com/ariffazil/arifOS)** - ⭐ 41
...
2928. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 41
   A generic, modular server for implementing the Model Context Protocol (MCP). 

2929. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 41
...
2930. **[foundry-vtt-mcp](https://github.com/adambdooley/foundry-vtt-mcp)** - ⭐ 41
...
2931. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 41
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

2932. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 41
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

2933. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 41
   Learn Model Context Protocol with Python, published by Packt

2934. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 41
   A Model Context Protocol server that provides access to Shodan API functionality

2935. **[AgentTools](https://github.com/WolframResearch/AgentTools)** - ⭐ 41
   Implements a model context protocol server using Wolfram Language

2936. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 41
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

2937. **[mcp-zero](https://github.com/zeromicro/mcp-zero)** - ⭐ 41
   Model Context Protocol (MCP) server for go-zero framework - Generate APIs, RPC services, and models with AI assistance.

2938. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 40
   Model Context Protocol server for Sitecore

2939. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 40
...
2940. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 40
   a mcp server for polymarket

2941. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

2942. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 40
   A MCP client for browser-use

2943. **[just-mcp](https://github.com/toolprint/just-mcp)** - ⭐ 40
   Share the same project justfile tasks with your AI Coding Agent.

2944. **[scraps](https://github.com/boykush/scraps)** - ⭐ 40
   Scraps is a portable CLI knowledge hub for managing interconnected Markdown documentation with Wiki-link notation.

2945. **[mcp-panther](https://github.com/panther-labs/mcp-panther)** - ⭐ 40
   Write detections, investigate alerts, and query logs from your favorite AI agents

2946. **[forgejo-mcp](https://github.com/raohwork/forgejo-mcp)** - ⭐ 40
   A MCP server that enables you to manage Gitea/Forgejo repositories through AI assistants

2947. **[pdf-rag-mcp-server](https://github.com/hyson666/pdf-rag-mcp-server)** - ⭐ 40
   PDF RAG server for cursor.

2948. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 40
...
2949. **[bonnard-cli](https://github.com/meal-inc/bonnard-cli)** - ⭐ 40
   Agent-native analytics. MCP server, dashboards, SDK, and semantic layer CLI.

2950. **[apple-books-mcp](https://github.com/vgnshiyer/apple-books-mcp)** - ⭐ 40
   Apple Books MCP Server

2951. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 40
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2952. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 40
   It shows how to use model-context-protocol. 

2953. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 40
...
2954. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 40
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

2955. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 40
...
2956. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 40
   Claude Unified Model Context Interaction Protocol

2957. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 40
...
2958. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 40
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

2959. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 40
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

2960. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 40
...
2961. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 40
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

2962. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 40
   An MCP server for querying Solana transactions using natural language with Solscan API

2963. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 40
...
2964. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 40
...
2965. **[mcp-tasks](https://github.com/flesler/mcp-tasks)** - ⭐ 40
   A comprehensive and efficient MCP server for task management with multi-format support (Markdown, JSON, YAML)

2966. **[rustchain-mcp](https://github.com/Scottcjn/rustchain-mcp)** - ⭐ 40
...
2967. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

2968. **[keycloak-mcp-server](https://github.com/sshaaf/keycloak-mcp-server)** - ⭐ 40
...
2969. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 40
   model context protocol for Autodesk Revit

2970. **[TalkToFigmaDesktop](https://github.com/grab/TalkToFigmaDesktop)** - ⭐ 40
...
2971. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 40
   http4k MCP Desktop Client

2972. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 39
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

2973. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 39
   MCP server for anki

2974. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 39
   A simple NextJS MCP client with sensible keybindings

2975. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

2976. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

2977. **[mssql-mcp](https://github.com/daobataotie/mssql-mcp)** - ⭐ 39
   mssql mcp server

2978. **[vscode-agent-todos](https://github.com/digitarald/vscode-agent-todos)** - ⭐ 39
   Gives VS Code agent mode planning superpowers with dynamic todo lists

2979. **[pbixray-mcp-server](https://github.com/jonaolden/pbixray-mcp-server)** - ⭐ 39
...
2980. **[search-scrape](https://github.com/DevsHero/search-scrape)** - ⭐ 39
...
2981. **[steampipe-mcp](https://github.com/turbot/steampipe-mcp)** - ⭐ 39
   Enable AI assistants to explore and query your Steampipe data!

2982. **[storybook-mcp](https://github.com/mcpland/storybook-mcp)** - ⭐ 39
   A MCP server for Storybook.

2983. **[music-composer-webmcp](https://github.com/Leanmcp-Community/music-composer-webmcp)** - ⭐ 39
...
2984. **[best-of-mcp-servers](https://github.com/tolkonepiu/best-of-mcp-servers)** - ⭐ 39
   🏆  A ranked list of MCP servers. Updated weekly.

2985. **[arifosmcp](https://github.com/ariffazil/arifosmcp)** - ⭐ 39
   ArifOS — AAA MCP-governed constitutional kernel for AI agents.

2986. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

2987. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 39
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

2988. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 39
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

2989. **[mcp-server](https://github.com/Aayush9029/mcp-server)** - ⭐ 39
   MCP SERVER

2990. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 39
   Model Context Protocol Minecraft Server

2991. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 39
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

2992. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 39
...
2993. **[roampal-core](https://github.com/roampal-ai/roampal-core)** - ⭐ 39
...
2997. **[touchdesigner-mcp-server](https://github.com/bottobot/touchdesigner-mcp-server)** - ⭐ 39
...
2998. **[amazon_ads_mcp](https://github.com/KuudoAI/amazon_ads_mcp)** - ⭐ 39
   Amazon Ads MCP - Model Context Protocol server for Amazon Advertising API

2999. **[roblox-executor-mcp](https://github.com/notpoiu/roblox-executor-mcp)** - ⭐ 39
   A MCP Server which allows for direct access to the roblox game client

3000. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 39
   ElysiaJS plugin for Model Context Protocol with HTTP transport

3001. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 38
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

3002. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 38
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

3003. **[mcp_ctl](https://github.com/runablehq/mcp_ctl)** - ⭐ 38
   A package manager to manage all your mcp servers across platforms

3004. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 38
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

3005. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

3006. **[prompt-decorators](https://github.com/synaptiai/prompt-decorators)** - ⭐ 38
...
3007. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 38
   A Chat Client for LLMs, written in Compose Multiplatform.

3008. **[vancouver](https://github.com/jameslong/vancouver)** - ⭐ 38
   Simple MCP server library for Elixir.

3009. **[cdk_pywrapper](https://github.com/sebotic/cdk_pywrapper)** - ⭐ 38
   A Python wrapper for the Chemistry Development Kit (CDK)

3010. **[mocxykit](https://github.com/shunseven/mocxykit)** - ⭐ 38
...
3011. **[comfy-mcp-server](https://github.com/lalanikarim/comfy-mcp-server)** - ⭐ 38
   A server using FastMCP framework to generate images based on prompts via a remote Comfy server.

3012. **[kitwork](https://github.com/kitwork/kitwork)** - ⭐ 38
...
3013. **[nostr-mcp](https://github.com/AbdelStark/nostr-mcp)** - ⭐ 38
   A Nostr MCP server that allows to interact with Nostr, enabling posting notes, and more.

3014. **[octomind](https://github.com/Muvon/octomind)** - ⭐ 38
   Highly configurable autonomous efficient-first agentic AI framework for CLI

3015. **[reactbits-mcp-server](https://github.com/ceorkm/reactbits-mcp-server)** - ⭐ 38
   MCP server providing access to 135+ animated React components from ReactBits.dev (9.2/10 test score)

3016. **[mcp-gitlab-server](https://github.com/yoda-digital/mcp-gitlab-server)** - ⭐ 38
   Enhanced MCP server for GitLab: group projects listing and activity tracking

3017. **[context-awesome](https://github.com/bh-rat/context-awesome)** - ⭐ 38
   awesome-lists now available as MCP server for you agent.

3018. **[Web-Algebra](https://github.com/AtomGraph/Web-Algebra)** - ⭐ 38
   Suite of generic Linked Data/SPARQL as well as LinkedDataHub-specific MCP tools

3019. **[MCP-Microsoft-Office](https://github.com/Aanerud/MCP-Microsoft-Office)** - ⭐ 38
   an local MCP server you can run on your env, connecting you to Microsoft Graph, and the complete M365 eco system.

3020. **[mcp-appstore](https://github.com/appreply-co/mcp-appstore)** - ⭐ 38
...
3021. **[nestjs-starter](https://github.com/hmake98/nestjs-starter)** - ⭐ 38
...
3026. **[dexpaprika-mcp](https://github.com/coinpaprika/dexpaprika-mcp)** - ⭐ 38
...
3027. **[matrix-mcp-server](https://github.com/mjknowles/matrix-mcp-server)** - ⭐ 38
   MCP Server for a Matrix home server integration; chat, manage rooms, etc.

3028. **[trainingpeaks-mcp](https://github.com/JamsusMaximus/trainingpeaks-mcp)** - ⭐ 38
...
3029. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 38
...
3030. **[tinyagent](https://github.com/askbudi/tinyagent)** - ⭐ 38
   Tiny Agent: Production-Ready LLM Agent SDK for Every Developer

3031. **[paraview_mcp](https://github.com/llnl/paraview_mcp)** - ⭐ 38
...
3032. **[mcp-musescore](https://github.com/ghchen99/mcp-musescore)** - ⭐ 38
   A Model Context Protocol (MCP) server that provides programmatic control over MuseScore!

3033. **[xero-agent-toolkit](https://github.com/XeroAPI/xero-agent-toolkit)** - ⭐ 38
...
3034. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 38
...
3035. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 38
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

3036. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 38
   Emacs Lisp implementation of the Model Context Protocol

3037. **[trivy-mcp](https://github.com/aquasecurity/trivy-mcp)** - ⭐ 37
   Trivy plugin for starting an MCP server

3038. **[mcp-summarization-functions](https://github.com/Braffolk/mcp-summarization-functions)** - ⭐ 37
   Provides summarised output from various actions that could otherwise eat up tokens and cause crashes for AI agents 

3039. **[mcp-server-webcrawl](https://github.com/pragmar/mcp-server-webcrawl)** - ⭐ 37
   MCP server tailored to connecting web crawler data and archives

3040. **[gemini-superclaude-mcp-server](https://github.com/Dianel555/gemini-superclaude-mcp-server)** - ⭐ 37
...
3041. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 37
   Learn how to implement MCP client with SwiftUI and Anthropic API

3042. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 37
   Build tools for LLMs in Rust using Model Context Protocol

3043. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

3044. **[GDB-MCP](https://github.com/smadi0x86/GDB-MCP)** - ⭐ 37
   An MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

3045. **[agentic-commerce-protocol-demo](https://github.com/locus-technologies/agentic-commerce-protocol-demo)** - ⭐ 37
   Reference implementation of OpenAI's Agentic Commerce Protocol (ACP)

3046. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 37
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

3047. **[google-workspace-mcp](https://github.com/dguido/google-workspace-mcp)** - ⭐ 37
   MCP server for Google Drive, Docs, Sheets, Slides, Calendar, Gmail, and Contacts

3048. **[tasker-mcp](https://github.com/dceluis/tasker-mcp)** - ⭐ 37
   An MCP server for Android's Tasker automation app.

3049. **[MCPNotes](https://github.com/9Ninety/MCPNotes)** - ⭐ 37
   A simple note-taking MCP server for recording and managing notes with AI models.

3050. **[godot-mcp](https://github.com/HaD0Yun/godot-mcp)** - ⭐ 37
   GoPeak — The most comprehensive MCP server for Godot Engine. 95+ tools: scene management, GDScript LSP, DAP debugger, screenshot capture, input injection, ClassDB introspection, CC0 asset library. npx gopeak

3051. **[pyrestoolbox-mcp](https://github.com/gabrielserrao/pyrestoolbox-mcp)** - ⭐ 37
...
3052. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 37
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

3053. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 37
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

3054. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 37
...
3055. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 37
   Model Context Protocol (MCP) server that interacts with a Debugger

3056. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 37
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

3057. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

3058. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 37
   Build Model Context Protocol (MCP) servers in Go

3059. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 37
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

3060. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 37
   Demonstrate how to implement MCP Client in Flutter application with AI.

3061. **[fast-mcp-telegram](https://github.com/leshchenko1979/fast-mcp-telegram)** - ⭐ 37
   Telegram MCP Server and HTTP-MTProto bridge | Multi-user, web setup, Docker and MTProto-Proxy ready

3062. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 37
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

3063. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 37
...
3064. **[agent-trace](https://github.com/Siddhant-K-code/agent-trace)** - ⭐ 37
   strace for AI agents. Capture and replay every tool call, prompt, and response from Claude Code, Cursor, or any MCP client

3065. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 36
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

3066. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 36
   Model Context Protocol (MCP) Server for Mistral OCR API

3067. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

3068. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
3069. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 36
   A Model Context Protocol for checking domain name registration status in bulk.

3070. **[mcp-debug](https://github.com/giantswarm/mcp-debug)** - ⭐ 36

3071. **[mcp-server-antv](https://github.com/antvis/mcp-server-antv)** - ⭐ 36
...
3072. **[mcp-crew-ai](https://github.com/adam-paterson/mcp-crew-ai)** - ⭐ 36
   MCP Crew AI Server is a lightweight Python-based server designed to run, manage and create CrewAI workflows.

3073. **[Handler](https://github.com/alDuncanson/Handler)** - ⭐ 36
   A2A Protocol client and developer toolkit.

3074. **[ai-workshop](https://github.com/dotnet-presentations/ai-workshop)** - ⭐ 36
   Building GenAI Apps in C#: AI Templates, GitHub Models, Azure OpenAI & More

3075. **[mcp-sandbox](https://github.com/JohanLi233/mcp-sandbox)** - ⭐ 36
   Python sandboxes for llms

3076. **[awesome-mcp-personas](https://github.com/toolprint/awesome-mcp-personas)** - ⭐ 36
   A curated collection of persona-based mcp server & tool groupings.

3077. **[mcp-server](https://github.com/VapiAI/mcp-server)** - ⭐ 36
   Vapi MCP Server

3078. **[workflowy](https://github.com/mholzen/workflowy)** - ⭐ 36
   Powerful CLI and MCP server for WorkFlowy: reports, search/replace, backup support, and AI integration (Claude, LLMs)

3079. **[pfsense-mcp-server](https://github.com/gensecaihq/pfsense-mcp-server)** - ⭐ 36
   pfSense MCP Server enables security administrators to manage their pfSense firewalls using natural language through AI assistants like Claude Desktop. Simply ask "Show me blocked IPs" or "Run a PCI compliance check" instead of navigating complex interfaces. Supports REST/XML-RPC/SSH connections, and includes built-in complian

3080. **[apple-mail-mcp](https://github.com/patrickfreyer/apple-mail-mcp)** - ⭐ 36
   MCP server giving AI assistants full access to Apple Mail - read, search, compose, organize & analyze emails via natural language

3081. **[copilot-security-instructions](https://github.com/Robotti-io/copilot-security-instructions)** - ⭐ 36
...
3082. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 36
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

3083. **[mitre-attack-mcp](https://github.com/stoyky/mitre-attack-mcp)** - ⭐ 36
   A Model-Context Protocol server for the MITRE ATT&CK knowledge base

3084. **[ronykit](https://github.com/clubpay/ronykit)** - ⭐ 36
   API Framework supporting REST and RPC.

3085. **[agience-core](https://github.com/Agience/agience-core)** - ⭐ 36
   An open, extensible runtime for agentic AI. Shared artifacts, structured state, and provenance by default.

3086. **[vulnerablemcp](https://github.com/vineethsai/vulnerablemcp)** - ⭐ 36
   A comprehensive database of Model Context Protocol vulnerabilities, security research, and exploits

3087. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 36
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

3088. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 36
   List of Awesome MCP Servers and Clients for building Agentic Devops 

3089. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 36
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

3090. **[mcp-starter](https://github.com/instructa/mcp-starter)** - ⭐ 36
   A super simple Starter to build your own MCP Server

3091. **[kimi-code-mcp](https://github.com/howardpen9/kimi-code-mcp)** - ⭐ 36
...
3092. **[ckan-mcp-server](https://github.com/ondata/ckan-mcp-server)** - ⭐ 36
   MCP server for querying CKAN open data portals (package search, DataStore SQL, organizations, groups, tags)

3093. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 36
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

3094. **[arch-mcp](https://github.com/nihalxkumar/arch-mcp)** - ⭐ 36
   Arch Linux MCP (Model Context Protocol) Server

3095. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 36
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

3096. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 36
   Zillow MCP Server for real estate data access via the Model Context Protocol

3097. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 36
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

3098. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 36
...
3099. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 36
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

3100. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 36
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

3101. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 36
   Model Context Protocol (MCP) server for openBIM

3102. **[synapse-ai](https://github.com/naveenraj-17/synapse-ai)** - ⭐ 36
...
3103. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 35
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

3104. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 35
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

3105. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 35
...
3106. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 35
   OpenAI Code Assistant Model Context Protocol (MCP) Server

3107. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 35
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

3108. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

3109. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

3110. **[mcp-tung-shing](https://github.com/baranwang/mcp-tung-shing)** - ⭐ 35
   中国传统黄历 MCP 服务 | Chinese Traditional Almanac MCP Service

3111. **[mcp](https://github.com/screenshotone/mcp)** - ⭐ 35
   A simple implementation of an MCP server for the ScreenshotOne API

3112. **[atlas-docs-mcp](https://github.com/CartographAI/atlas-docs-mcp)** - ⭐ 35
   Provide LLMs hosted, clean markdown documentation of libraries and frameworks

3113. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 35
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

3114. **[mcp-server-text-editor](https://github.com/bhouston/mcp-server-text-editor)** - ⭐ 35
   An open source implementation of the Claude built-in text editor tool

3115. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 35
   a lib to build MCP clients and MCP servers in Clojure(script)

3116. **[daisyui-mcp](https://github.com/birdseyevue/daisyui-mcp)** - ⭐ 35
   🌼 A token-friendly local MCP server for DaisyUI component documentation using their public llms.txt.

3117. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 35
   Turn any MCP Client into a "multi-agent" system (via prompting)

3118. **[awesome-mcp-servers](https://github.com/ever-works/awesome-mcp-servers)** - ⭐ 35
   A curated list of the best MCP Servers, featuring top solutions, libraries, tools, and more. - https://mcpserver.works

3119. **[mcp-tools](https://github.com/clerk/mcp-tools)** - ⭐ 35
   Tools for building modern & secure MCP integrations across the client and server side

3120. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 35
...
3121. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 35
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

3122. **[help-scout-mcp-server](https://github.com/drewburchfield/help-scout-mcp-server)** - ⭐ 35
   MCP server for Help Scout - search conversations, threads, and inboxes with AI agents

3123. **[Blender-MCP-Server](https://github.com/poly-mcp/Blender-MCP-Server)** - ⭐ 35
...
3124. **[mcp](https://github.com/fastly/mcp)** - ⭐ 35
   Model Context Protocol (MCP) server for AI-powered Fastly CDN management.

3125. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 35
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

3126. **[MCPbundler](https://github.com/eugenepyvovarov/MCPbundler)** - ⭐ 35

3127. **[lets-learn-mcp-java](https://github.com/microsoft/lets-learn-mcp-java)** - ⭐ 35
   Learn how to build Java-based MCP Servers and Clients with LangChain4J and Quarkus

3128. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 35
...
3129. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 35
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

3130. **[jdwp-mcp](https://github.com/navicore/jdwp-mcp)** - ⭐ 35
   Java debugging for LLMs via JDWP and Model Context Protocol

3131. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 35
   About A Model Context Protocol server that executes commands in the current WezTerm session

3132. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 35
...
3133. **[NepseAPI-Unofficial](https://github.com/surajrimal07/NepseAPI-Unofficial)** - ⭐ 35
...
3134. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 35
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

3135. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 35
...
3136. **[SpecialAgentPlugin](https://github.com/ArtisanGameworks/SpecialAgentPlugin)** - ⭐ 35
...
3137. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 34
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

3138. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 34
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

3139. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
3140. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 34
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

3141. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 34
   Model Context Protocol Server for Apache OpenDAL™

3142. **[godoc-mcp-server](https://github.com/yikakia/godoc-mcp-server)** - ⭐ 34
   A mcp server provide infomation from pkg.go.dev. For all golang programmers

3143. **[DBJavaGenix](https://github.com/ZhaoXingPeng/DBJavaGenix)** - ⭐ 34
...
3144. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 34
...
3145. **[chessagineweb](https://github.com/jalpp/chessagineweb)** - ⭐ 34
   The most underrated FOSS chess interface that combines AI agents and chess engines into one unified platform. 

3146. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 34
...
3147. **[codelogic-mcp-server](https://github.com/CodeLogicIncEngineering/codelogic-mcp-server)** - ⭐ 34
   An MCP Server to utilize Codelogic's rich software dependency data in your AI programming assistant.

3148. **[any-script-mcp](https://github.com/izumin5210/any-script-mcp)** - ⭐ 34
   An MCP server that exposes arbitrary CLI tools and shell scripts as MCP Tools

3149. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 34
   Model Context Protocol server written in Scala

3150. **[iotdb-mcp-server](https://github.com/apache/iotdb-mcp-server)** - ⭐ 34
   Apache IoTDB MCP Server

3151. **[1mcp](https://github.com/buremba/1mcp)** - ⭐ 34
   Let your agent write code and execute code directly in the browser with WASM

3152. **[kanban-mcp](https://github.com/eyalzh/kanban-mcp)** - ⭐ 34
   MCP server providing kanban-based task management memory for complex multi-session workflows with AI agents

3153. **[diy-tools-mcp](https://github.com/hesreallyhim/diy-tools-mcp)** - ⭐ 34
   An MCP server that allows users to dynamically add custom tools/functions at runtime

3154. **[pushover-mcp](https://github.com/AshikNesin/pushover-mcp)** - ⭐ 34
   A MCP implementation for sending notifications via Pushover

3155. **[capacities-mcp](https://github.com/jem-computer/capacities-mcp)** - ⭐ 34
   Capacities×MCP

3156. **[mcp-searxng-enhanced](https://github.com/OvertliDS/mcp-searxng-enhanced)** - ⭐ 34
   Enhanced MCP server for SearXNG: category-aware web-search, web-scraping, and date/time retrieval.

3157. **[mcp-probe-kit](https://github.com/mybolide/mcp-probe-kit)** - ⭐ 34
   一个强大的 MCP (Model Context Protocol) 服务器，提20个实用工具，覆盖代码质量、开发效率、项目管理、生成skills文档全流程。

3158. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 34
...
3159. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 34
...
3160. **[fantasy-football-mcp-public](https://github.com/derekrbreese/fantasy-football-mcp-public)** - ⭐ 34
...
3161. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 34
...
3162. **[MCPServer](https://github.com/rhennigan/MCPServer)** - ⭐ 34
   Implements a model context protocol server using Wolfram Language

3163. **[mcp-server-fuzzer](https://github.com/Agent-Hellboy/mcp-server-fuzzer)** - ⭐ 34
   A generic mcp server fuzzer

3164. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 34
   Model Context Protocol extension for Azure Functions.

3165. **[review-flow](https://github.com/DGouron/review-flow)** - ⭐ 34
...
3170. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 34
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

3171. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 34
...
3172. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 34
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

3173. **[browser-use-rs](https://github.com/BB-fat/browser-use-rs)** - ⭐ 34
...
3180. **[iota-agent-mcp](https://github.com/Scottcjn/iota-agent-mcp)** - ⭐ 33
...
3181. **[claude-code-mcp](https://github.com/KunihiroS/claude-code-mcp)** - ⭐ 33
   MCP Server connects with claude code local command.

3182. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 33
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

3183. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 33
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

3184. **[DMCPServer](https://github.com/Daniel09Fernandes/DMCPServer)** - ⭐ 33
   Dinos MCP Server, make your code, on MCP Action and execute by AI

3185. **[mcp-veo2](https://github.com/mario-andreschak/mcp-veo2)** - ⭐ 33
   MCP for Video- or Image-Generation with Google VEO2

3186. **[kaggle-mcp](https://github.com/arrismo/kaggle-mcp)** - ⭐ 33
   MCP server for Kaggle

3187. **[mcp-launcher](https://github.com/moeru-ai/mcp-launcher)** - ⭐ 33
   🐳🧩 Easy to use MCP builder & launcher for all possible MCP servers, just like Ollama for models!

3188. **[mcp-server](https://github.com/membranehq/mcp-server)** - ⭐ 33
   MCP Server for Membrane

3189. **[devduck](https://github.com/cagataycali/devduck)** - ⭐ 33
   Minimalist AI agent that fixes itself when things break.

3190. **[fastmcp-threatintel](https://github.com/4R9UN/fastmcp-threatintel)** - ⭐ 33
   AI-Powered Threat Intelligence MCP tool

3191. **[bitrise-mcp](https://github.com/bitrise-io/bitrise-mcp)** - ⭐ 33
   MCP Server for the Bitrise API, enabling app management, build operations, artifact management and more.

3192. **[prediction-market-mcp](https://github.com/JamesANZ/prediction-market-mcp)** - ⭐ 33
   A simple MCP server that grabs prediction market data from polymarket, PredictIt, & Kalshi. 

3193. **[ddg_search](https://github.com/OEvortex/ddg_search)** - ⭐ 33
   A powerful Model Context Protocol (MCP) server for web search and URL content extraction using DuckDuckGo.

3194. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 33
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

3195. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 33
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

3196. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 33
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

3197. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 33
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

3198. **[Amazing-Marvin-MCP](https://github.com/bgheneti/Amazing-Marvin-MCP)** - ⭐ 33
   Model Context Provider for Amazing Marvin productivity app - Access your tasks, projects, and categories in AI assistants

3199. **[AskUserQuestionPlus](https://github.com/JoJoJotarou/AskUserQuestionPlus)** - ⭐ 33
...
3200. **[bear-notes-mcp](https://github.com/bejaminjones/bear-notes-mcp)** - ⭐ 33
   MCP server for Bear app - Full Read + Write AI-powered note management with Claude Desktop

3201. **[awesome-finance-mcp](https://github.com/BlockRunAI/awesome-finance-mcp)** - ⭐ 33
   A curated list of MCP servers for AI finance agents

3202. **[ue5-mcp-bridge](https://github.com/Natfii/ue5-mcp-bridge)** - ⭐ 33
   MCP server bridging AI assistants to Unreal Engine 5 editor

3203. **[mcp-ollama](https://github.com/emgeee/mcp-ollama)** - ⭐ 33
   Query model running with Ollama from within Claude Desktop or other MCP clients

3204. **[inkmcp](https://github.com/Shriinivas/inkmcp)** - ⭐ 33
   Inkscape MCP Server - Control Inkscape through AI assistants via Model Context Protocol

3205. **[apipost-mcp](https://github.com/jlcodes99/apipost-mcp)** - ⭐ 33
...
3206. **[chabeau](https://github.com/permacommons/chabeau)** - ⭐ 33
   OpenAI-API compatible terminal chatbot and MCP client in Rust

3207. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 32
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

3208. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 32
...
3209. **[turbomcpstudio](https://github.com/Epistates/turbomcpstudio)** - ⭐ 32
   A native desktop application for developing, testing, and debugging Model Context Protocol servers.

3210. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 32
...
3211. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 32
...
3212. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 32
...
3213. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

3214. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 32
...
3215. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 32
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

3216. **[Direwolf](https://github.com/Framebuffers/Direwolf)** - ⭐ 32
   Distributed Data Processing Pipeline for MCP.

3217. **[imagegen-mcp](https://github.com/spartanz51/imagegen-mcp)** - ⭐ 32
   MCP server for OpenAI Image Generation & Editing — text-to-image, image-to-image (with mask), no extra plugins.

3218. **[ptt_mcp_server](https://github.com/PyPtt/ptt_mcp_server)** - ⭐ 32
   The best PTT MCP server

3219. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 32
...
3220. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 32
...
3221. **[mcp-server](https://github.com/HuaweiCloudDeveloper/mcp-server)** - ⭐ 32
   Provide different cloud products  MCP Server tools to  help developers  manage cloud resources  with AI-agent

3222. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 32
   A Model Context Protocol server starter template

3223. **[mcp-java-sdk-examples](https://github.com/thought2code/mcp-java-sdk-examples)** - ⭐ 32
   A collection of MCP server examples developed by various Java SDKs

3224. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 32
...
3225. **[protonmail-mcp](https://github.com/amotivv/protonmail-mcp)** - ⭐ 32
   This MCP server provides email sending functionality using Protonmail's SMTP service. It allows both Claude Desktop and Cline VSCode extension to send emails on your behalf using your Protonmail credentials.

3226. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 32
   Asterisk Model Context Protocol (MCP) server.

3227. **[myBrAIn](https://github.com/lilium360/myBrAIn)** - ⭐ 32
...
3228. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 32
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

3229. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 32
...
3230. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 32
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

3231. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 32
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

3232. **[mcp-hacker-news](https://github.com/paabloLC/mcp-hacker-news)** - ⭐ 32
...
3233. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 32
...
3238. **[orionbelt-semantic-layer](https://github.com/ralfbecher/orionbelt-semantic-layer)** - ⭐ 32
...
3239. **[dassian-adt](https://github.com/DassianInc/dassian-adt)** - ⭐ 32
...
3240. **[mcp-aoai-web-browsing](https://github.com/kimtth/mcp-aoai-web-browsing)** - ⭐ 32
   A minimal Model Context Protocol 🖥️ server/client🧑‍💻with OpenAI and 🌐 web browser control via Playwright.

3241. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 32
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

3242. **[lucide-icons-mcp](https://github.com/SeeYangZhi/lucide-icons-mcp)** - ⭐ 32
...
3243. **[Wwise-MCP](https://github.com/BilkentAudio/Wwise-MCP)** - ⭐ 32
...
3244. **[mcp-gateway](https://github.com/openziti/mcp-gateway)** - ⭐ 32
...
3245. **[mcp-dblp](https://github.com/szeider/mcp-dblp)** - ⭐ 32
...
3246. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 32
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

3247. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 32
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

3248. **[deep-research](https://github.com/ssdeanx/deep-research)** - ⭐ 32
...
3249. **[fusion-mcp-server](https://github.com/Joe-Spencer/fusion-mcp-server)** - ⭐ 32
...
3250. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

3251. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 31
   MCP (Model Context Protocol) Server for postgres Database

3252. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 31
...
3253. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 31
   Model Context Protocol Server of Rod

3254. **[jlcpcb-parts-mcp](https://github.com/nvsofts/jlcpcb-parts-mcp)** - ⭐ 31
   JLCPCB PCBA向けの、部品探しを補助するためのMCPサーバー

3255. **[unplugin-mcp](https://github.com/situ2001/unplugin-mcp)** - ⭐ 31
...
3256. **[ez-mcp](https://github.com/intellectronica/ez-mcp)** - ⭐ 31
   The easiest path to getting an MCP server going

3257. **[ESP32MCPServer](https://github.com/navado/ESP32MCPServer)** - ⭐ 31
   Allow AI models connect to ESP32 exposed interfaces. AI generated MCP server for ESP32. 

3258. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 31
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

3259. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 31
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

3260. **[mcp-server-weibo](https://github.com/Selenium39/mcp-server-weibo)** - ⭐ 31
   Model Context Protocol服务器，用于抓取微博用户信息、动态和搜索功能

3261. **[cca-mcp-configurator](https://github.com/doggy8088/cca-mcp-configurator)** - ⭐ 31
   一個簡單易用的網頁工具，用於管理 GitHub Copilot 的 MCP (Model Context Protocol) 設定

3262. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 31
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

3263. **[rss-mcp](https://github.com/veithly/rss-mcp)** - ⭐ 31
...
3264. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 31
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

3265. **[mcpmcp-server](https://github.com/glenngillen/mcpmcp-server)** - ⭐ 31
   Discover, setup, and integrate MCP servers with your favorite clients. Unlock the full potential of AI in your daily workflow.

3266. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 31
   MCP (Model Context Protocol) server for biothings

3267. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 31
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

3268. **[mcp-klever-vm](https://github.com/klever-io/mcp-klever-vm)** - ⭐ 31
   MCP server for Klever blockchain smart contract development

3269. **[src-to-kb](https://github.com/vezlo/src-to-kb)** - ⭐ 31
   Convert source code to LLM ready knowledge base

3270. **[apifox-mcp](https://github.com/iwen-conf/apifox-mcp)** - ⭐ 31
   Apifox MCP 服务器 - 让 Claude 等 AI 助手通过自然语言管理你的 Apifox 项目，轻松创建、更新和审计 API 接口

3271. **[codingbuddy](https://github.com/JeremyDev87/codingbuddy)** - ⭐ 31
...
3272. **[mcp_xpp](https://github.com/ccampora/mcp_xpp)** - ⭐ 31
...
3273. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 31
   PowerPlatform Model Context Protocol server

3274. **[clap-mcp](https://github.com/gakonst/clap-mcp)** - ⭐ 31
   A Rust framework that bridges clap command-line applications with the Model Context Protocol (MCP)

3275. **[mcp-marketplace](https://github.com/aiagenta2z/mcp-marketplace)** - ⭐ 31
   OpenSource MCP Marketplace | MCP Servers Tools Meta Dataset | Web API | Web Client Integration

3276. **[claude-image-gen](https://github.com/guinacio/claude-image-gen)** - ⭐ 31
...
3277. **[email-mcp](https://github.com/codefuturist/email-mcp)** - ⭐ 31
...
3278. **[unplugin-devpilot](https://github.com/zcf0508/unplugin-devpilot)** - ⭐ 31
...
3279. **[zapier-mcp](https://github.com/zapier/zapier-mcp)** - ⭐ 31
   Connect your AI to thousands of apps with the Model Context Protocol.

3280. **[ApkMCP-Auto](https://github.com/kggzs/ApkMCP-Auto)** - ⭐ 31
   本项目是一个 Android 逆向工程工具集合，通过 MCP (Model Context Protocol) 协议将 AI 助手（如 Claude）与专业的 Android 反编译工具连接起来，实现智能化的 APK 分析与修改。

3281. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 30
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

3282. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 30
...
3288. **[airflow-mcp-server](https://github.com/abhishekbhakat/airflow-mcp-server)** - ⭐ 30
   MCP Server for Apache Airflow

3289. **[kafka-schema-reg-mcp](https://github.com/aywengo/kafka-schema-reg-mcp)** - ⭐ 30
   A comprehensive Message Control Protocol (MCP) server for Kafka Schema Registry.

3290. **[itential-mcp](https://github.com/itential/itential-mcp)** - ⭐ 30
   🔌 Itential Platform MCP Server

3291. **[ros-mcp](https://github.com/Yutarop/ros-mcp)** - ⭐ 30
   MCP server for ROS to control robots via topics, services, and actions.

3292. **[chrome-extension-bridge-mcp](https://github.com/Oanakiaja/chrome-extension-bridge-mcp)** - ⭐ 30
   A chrome extension bridge that allows you to connect to a mcp server to use global window object.

3293. **[turbovault](https://github.com/Epistates/turbovault)** - ⭐ 30
   MCP server that transforms your Obsidian vault into an intelligent knowledge system

3294. **[pubnub-mcp-server](https://github.com/pubnub/pubnub-mcp-server)** - ⭐ 30
   PubNub MCP Model Context Protocol Server for use in Cursor, Windsurf, Claude Desktop, Claude Code and OpenAI Codex and more!

3295. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 30
   A simple Model Context Protocol (MCP) server for Clay.

3296. **[wiki-js-mcp](https://github.com/talosdeus/wiki-js-mcp)** - ⭐ 30
   Model Context Protocol (MCP) server for Wiki.js with hierarchical documentation & Docker setup

3297. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 30
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

3298. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 30
...
3302. **[mcp_espn_ff](https://github.com/KBThree13/mcp_espn_ff)** - ⭐ 30
   ESPN Fantasy API with LLMs!

3303. **[kratos-mcp](https://github.com/ceorkm/kratos-mcp)** - ⭐ 30
...
3304. **[rlm-claude](https://github.com/EncrEor/rlm-claude)** - ⭐ 30
   Recursive Language Models for Claude Code - Infinite memory solution inspired by MIT CSAIL paper

3305. **[mindbridge-mcp](https://github.com/pinkpixel-dev/mindbridge-mcp)** - ⭐ 30
...
3309. **[aura](https://github.com/mezmo/aura)** - ⭐ 30
...
3310. **[OmniClip-RAG](https://github.com/msjsc001/OmniClip-RAG)** - ⭐ 30
...
3311. **[tally-mcp-server](https://github.com/dhananjay1405/tally-mcp-server)** - ⭐ 30
...
3312. **[stitch-mcp-auto](https://github.com/GreenSheep01201/stitch-mcp-auto)** - ⭐ 30
   Automated installer for Stitch MCP - The easiest way to set up your Universal MCP server for Google Stitch.

3313. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 30
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

3314. **[CE-MCP-Plugin](https://github.com/Eruditi/CE-MCP-Plugin)** - ⭐ 30
...
3315. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 30
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

3316. **[douyin-mcp-server](https://github.com/lancelin111/douyin-mcp-server)** - ⭐ 30
   🎥 Douyin (TikTok China) MCP Server - Automated video upload service via Model Context Protocol for AI integration

3317. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 30
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

3318. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 30
   A Model Context Protocol server for 3D Slicer integration

3319. **[binance-mcp-server](https://github.com/ethancod1ng/binance-mcp-server)** - ⭐ 30
...
3320. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 30
...
3321. **[awesome-mcp-lists](https://github.com/collabnix/awesome-mcp-lists)** - ⭐ 30
   A Curated List of MCP Servers, Clients and Toolkits

3322. **[awesome-mcp-hardware](https://github.com/beriberikix/awesome-mcp-hardware)** - ⭐ 30
   Awesome list of MCP servers for interacting with hardware and the physical world.

3323. **[MCP-Scorecard](https://github.com/aak204/MCP-Scorecard)** - ⭐ 29
   Deterministic CI scanner and surface-risk scoring for MCP (Model Context Protocol) servers.

3324. **[mcp-inception](https://github.com/tanevanwifferen/mcp-inception)** - ⭐ 29
   Call another MCP client from your MCP client. Offload context windows, delegate tasks, split between models

3325. **[demo-mcp-server-client-implementation](https://github.com/mschwarzmueller/demo-mcp-server-client-implementation)** - ⭐ 29
   A demo implementation of a MCP server (consuming a dummy API) and basic client.

3326. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

3327. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

3328. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

3329. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 29
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

3330. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 29
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

3331. **[telegram-mcp-server](https://github.com/kfastov/telegram-mcp-server)** - ⭐ 29
   MCP server implementation for Telegram

3332. **[agent-pm](https://github.com/gannonh/agent-pm)** - ⭐ 29
   MCP server for the planning and execution of AI-assisted development projects.

3333. **[mcp-notify](https://github.com/aahl/mcp-notify)** - ⭐ 29
   💬  MCP Server for notify to Weixin, Telegram, Bark, Lark, 飞书, 钉钉

3334. **[rdkit-mcp-server](https://github.com/tandemai-inc/rdkit-mcp-server)** - ⭐ 29
   MCP server that enables language models to interact with RDKit through natural language

3335. **[robinhood-mcp-server](https://github.com/rohitsingh-iitd/robinhood-mcp-server)** - ⭐ 29
...
3336. **[alibabacloud-dms-mcp-server](https://github.com/aliyun/alibabacloud-dms-mcp-server)** - ⭐ 29
...
3337. **[tgcli](https://github.com/kfastov/tgcli)** - ⭐ 29
   Telegram user console client and archiver

3338. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 29
...
3339. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 29
...
3340. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 29
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

3341. **[deno-mcp-template](https://github.com/phughesmcr/deno-mcp-template)** - ⭐ 29
   A template repo for writing and publishing local, remote, DXT, and binary MCP servers using Deno.

3342. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 29
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

3343. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 29
...
3344. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 29
...
3345. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 29
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

3346. **[izan.io](https://github.com/ekingunoncu/izan.io)** - ⭐ 29
   Turn Any Browser Action & Data Extraction into an AI Tool in 60 Seconds

3347. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 29
   Testing framework for Model Context Protocol (MCP)

3348. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 29
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

3349. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 29
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

3350. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 29
...
3351. **[drawio-mcp-extension](https://github.com/lgazo/drawio-mcp-extension)** - ⭐ 29
   Draw.io Model Context Protocol (MCP) Browser Extension

3352. **[emcp](https://github.com/PJUllrich/emcp)** - ⭐ 29
   A Model Context Protocol (MCP) Server for Elixir

3353. **[mcp-gateway](https://github.com/lucky-aeon/mcp-gateway)** - ⭐ 29
...
3354. **[ai-foundry-agents-samples](https://github.com/Azure-Samples/ai-foundry-agents-samples)** - ⭐ 29
   Azure AI Foundry - Agents related sample code

3355. **[autotask-mcp](https://github.com/wyre-technology/autotask-mcp)** - ⭐ 29
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

3356. **[nimbletools-core](https://github.com/NimbleBrainInc/nimbletools-core)** - ⭐ 29
   NimbleTools is an open-source MCP runtime. Infrastructure for the agentic web.

3357. **[Go-High-Level-MCP-2026-Complete](https://github.com/BusyBee3333/Go-High-Level-MCP-2026-Complete)** - ⭐ 29
...
3358. **[FerrumMCP](https://github.com/Eth3rnit3/FerrumMCP)** - ⭐ 29
...
3359. **[SSH-MCP](https://github.com/mixelpixx/SSH-MCP)** - ⭐ 29
...
3360. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 29
   Fast rust MCP proxy between stdio and SSE

3361. **[mdk-mcp-server](https://github.com/SAP/mdk-mcp-server)** - ⭐ 29
   Model Context Protocol (MCP) server for AI-assisted development ("vibe coding") of MDK applications.

3362. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

3363. **[substack-mcp](https://github.com/marcomoauro/substack-mcp)** - ⭐ 29
...
3364. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 29
   ClickUp MCP Server - Integrate ClickUp project management with AI through Model Context Protocol

3365. **[relace-mcp](https://github.com/possible055/relace-mcp)** - ⭐ 28
   Unofficial Relace MCP client with AI features. Personal project; not affiliated with or endorsed by Relace

3366. **[postmancer](https://github.com/hijaz/postmancer)** - ⭐ 28
   An experimental MCP server Rest Client intended to be a replacement of tools postman & insomnia

3367. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 28
   A library for declaratively building Model Context Protocol servers.

3368. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 28
...
3369. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

3370. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

3371. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 28
...
3372. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 28
...
3373. **[gemsuite-mcp](https://github.com/PV-Bhat/gemsuite-mcp)** - ⭐ 28
...
3374. **[tempo-mcp-server](https://github.com/ivelin-web/tempo-mcp-server)** - ⭐ 28
   MCP server for managing Tempo worklogs in Jira

3375. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 28
...
3376. **[mcp-log-proxy](https://github.com/emicklei/mcp-log-proxy)** - ⭐ 28
   a web logging proxy for MCP client-server communication

3377. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 28
   Model Context Protocol to bridge in Substack writings to Claude.

3378. **[laravel-mcp-companion](https://github.com/brianirish/laravel-mcp-companion)** - ⭐ 28
...
3379. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 28
   An implementation of Giphy integration with Model Context Protocol

3380. **[mcp-config-manager](https://github.com/holstein13/mcp-config-manager)** - ⭐ 28
...
3381. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 28
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

3382. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 28
...
3383. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 28
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

3384. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 28
...
3385. **[mcp-wireshark](https://github.com/khuynh22/mcp-wireshark)** - ⭐ 28
...
3386. **[php-mcp](https://github.com/dtyq/php-mcp)** - ⭐ 28
...
3387. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 28
...
3388. **[agent-twitter-client-mcp](https://github.com/ryanmac/agent-twitter-client-mcp)** - ⭐ 28
...
3389. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 28
   Antrophics Model context protocol to edit powerpoint files

3390. **[chat](https://github.com/repaera/chat)** - ⭐ 28
   Chat Client for Your Service's MCP Server

3391. **[congressMCP](https://github.com/amurshak/congressMCP)** - ⭐ 28
   An MCP server allowing AI agents and MCP clients to interface with the Congress.gov API

3392. **[kernel-mcp-server](https://github.com/kernel/kernel-mcp-server)** - ⭐ 28
   Open-source MCP server for secure, low-latency cloud-browser automation on Kernel.

3393. **[mcp-simple-timeserver](https://github.com/andybrandt/mcp-simple-timeserver)** - ⭐ 28
...
3394. **[computeruseprotocol](https://github.com/computeruseprotocol/computeruseprotocol)** - ⭐ 28
   Computer Use Protocol is a universal schema for AI agents to perceive and interact with any desktop UI.

3395. **[UCAI](https://github.com/nirholas/UCAI)** - ⭐ 28
...
3396. **[qdrant-mcp-server](https://github.com/mhalder/qdrant-mcp-server)** - ⭐ 28
   MCP server for semantic search using local Qdrant vector database and OpenAI embeddings

3397. **[Unity-AI-ParticleSystem](https://github.com/IvanMurzak/Unity-AI-ParticleSystem)** - ⭐ 28
   AI-powered tools for Unity Particle System. Create and modify Particle System directly through natural language commands.

3398. **[mcp-anything](https://github.com/Type-MCP/mcp-anything)** - ⭐ 28
   One command to turn any codebase into an MCP server

3399. **[langchain-mcp-tools-py](https://github.com/hideya/langchain-mcp-tools-py)** - ⭐ 28
   MCP to LangChain Tools Conversion Utility / Python

3400. **[raybridge](https://github.com/jlokos/raybridge)** - ⭐ 28
   MCP server that bridges Raycast extensions to any MCP-compatible client

3401. **[google-search-console-mcp](https://github.com/surendranb/google-search-console-mcp)** - ⭐ 28
   Google Search Console MCP Server for Claude, Cursor, Windsurf and other MCP Clients

3402. **[MiAO-MCP-for-Unity](https://github.com/MiAO-AI-Lab/MiAO-MCP-for-Unity)** - ⭐ 27
...
3403. **[gaia-x](https://github.com/YFGaia/gaia-x)** - ⭐ 27
...
3404. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

3405. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

3406. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 27
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

3407. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 27
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

3408. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 27
   Model Context Protocol server for Directus

3409. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 27
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

3410. **[mcp-stytch-consumer-todo-list](https://github.com/stytchauth/mcp-stytch-consumer-todo-list)** - ⭐ 27
   Workers + Stytch TODO App MCP Server

3411. **[pulse-editor](https://github.com/ClayPulse/pulse-editor)** - ⭐ 27
...
3412. **[mcp-local-dev](https://github.com/txbm/mcp-local-dev)** - ⭐ 27
   Let LLMs manage your local dev environments

3413. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 27
   Model Context Protocol Server for NebulaGraph 3.x

3414. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 27
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

3415. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

3416. **[MalwareBazaar_MCP](https://github.com/mytechnotalent/MalwareBazaar_MCP)** - ⭐ 27
   An AI-driven MCP server that autonomously interfaces with Malware Bazaar, delivering real-time threat intel and sample metadata for authorized cybersecurity research workflows.

3417. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 27
...
3418. **[janee](https://github.com/rsdouglas/janee)** - ⭐ 27
   Secrets management for AI agents via MCP • @janeesecure

3419. **[openzeppelin-mcp](https://github.com/OpenZeppelin/openzeppelin-mcp)** - ⭐ 27
   Model Context Protocol Servers Repository for OpenZeppelin products

3420. **[leanmcp-sdk](https://github.com/LeanMCP/leanmcp-sdk)** - ⭐ 27
   Production-ready TypeScript SDK for MCP servers: auth, multi-tenant, observability. Build enterprise AI agents fast.

3421. **[mcp_streamable_http](https://github.com/theailanguage/mcp_streamable_http)** - ⭐ 27
   Educational repo for MCP streamable HTTP servers and clients

3422. **[Palmos](https://github.com/ClayPulse/Palmos)** - ⭐ 27
   The Runtime Where AI Agents Build, Ship, and Evolve. Pulse Editor is a modular, cross-platform, AI-powered productivity platform with federated app collaboration and extensible workflows. 

3423. **[mcp-annotated-java-sdk](https://github.com/thought2code/mcp-annotated-java-sdk)** - ⭐ 27
   Annotation-driven MCP dev 🚀 No Spring, Zero Boilerplate, Pure Java

3424. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

3425. **[novyx-mcp](https://github.com/novyxlabs/novyx-mcp)** - ⭐ 27
...
3426. **[silverbullet-mcp](https://github.com/Ahmad-A0/silverbullet-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server to interact with your SilverBullet notes and data.

3427. **[Excel-MCP-Server-Master](https://github.com/guillehr2/Excel-MCP-Server-Master)** - ⭐ 27
...
3428. **[universal-crypto-mcp](https://github.com/nirholas/universal-crypto-mcp)** - ⭐ 27
...
3429. **[ChatSpatial](https://github.com/cafferychen777/ChatSpatial)** - ⭐ 27
...
3430. **[codex-claude-bridge](https://github.com/abhishekgahlot2/codex-claude-bridge)** - ⭐ 27
...
3431. **[d365fo-client](https://github.com/mafzaal/d365fo-client)** - ⭐ 27
...
3432. **[NiFiMCP](https://github.com/ms82119/NiFiMCP)** - ⭐ 27
   An MCP Server and client for communicating with Nifi (v1.28)

3433. **[minimal-godot-mcp](https://github.com/ryanmazzolini/minimal-godot-mcp)** - ⭐ 27
   Lightweight MCP server bridging Godot LSP to MCP clients for GDScript validation

3434. **[unity-editor-mcp](https://github.com/ozankasikci/unity-editor-mcp)** - ⭐ 27
   An MCP server and client for LLMs to interact with Unity Projects

3435. **[glade-mcp-unity](https://github.com/Glade-tool/glade-mcp-unity)** - ⭐ 27
...
3436. **[chatbot_Shopify](https://github.com/Mobeen-Dev/chatbot_Shopify)** - ⭐ 26
   Agentic Shopify Chatbot with MCP integration, embedded directly into Shopify via a Theme Extension

3437. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 26
...
3438. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

3439. **[mcp-client-x](https://github.com/RGGH/mcp-client-x)** - ⭐ 26
   Python MCP client + server example

3440. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

3441. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 26
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

3442. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 26
...
3443. **[mcp-auth](https://github.com/famma-ai/mcp-auth)** - ⭐ 26
   MCP Auth via Reverse Proxy 

3444. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 26
...
3458. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 26
...
3459. **[webmcp-bridge](https://github.com/holon-run/webmcp-bridge)** - ⭐ 25
...
3460. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 25
...
3461. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

3462. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

3463. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

3464. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

3465. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

3466. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

3467. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 25
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

3468. **[puzzlebox](https://github.com/cliffhall/puzzlebox)** - ⭐ 25
...
3469. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 25
   A Model Context Protocol Server for Interacting with Slack

3470. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 25
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

3471. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 25
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

3472. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 25
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

3473. **[openai-copilot](https://github.com/feiskyer/openai-copilot)** - ⭐ 25
   Your life Copilot powered by LLM models (CLI interface for LLM models with MCP tools).

3474. **[json2video-mcp-server](https://github.com/omergocmen/json2video-mcp-server)** - ⭐ 25
   Message Communication Protocol server for json2video API integration

3475. **[mcp-playground](https://github.com/zanetworker/mcp-playground)** - ⭐ 25
   Simple MCP Client for remote MCP Servers 🌐

3476. **[aj-mcp](https://github.com/lightweight-component/aj-mcp)** - ⭐ 25
   Simple MCP SDK in Java

3477. **[cfbd-mcp-server](https://github.com/lenwood/cfbd-mcp-server)** - ⭐ 25
   An MCP server enabling CFBD API queries within Claude Desktop.

3478. **[microsoft_fabric_mcp](https://github.com/Augustab/microsoft_fabric_mcp)** - ⭐ 25
   MCP server wrapping around the Fabric Rest API

3479. **[azure-diagram-mcp](https://github.com/dminkovski/azure-diagram-mcp)** - ⭐ 25
...
3480. **[gemini-webapi-mcp](https://github.com/AndyShaman/gemini-webapi-mcp)** - ⭐ 25
   MCP server for Google Gemini — free image generation, editing & chat via browser cookies. No API keys needed.

3481. **[Screenhand](https://github.com/manushi4/Screenhand)** - ⭐ 25
...
3485. **[stata-workbench](https://github.com/tmonk/stata-workbench)** - ⭐ 25
...
3486. **[rollbar-mcp-server](https://github.com/rollbar/rollbar-mcp-server)** - ⭐ 25
   Pre-release - Model Context Protocol server for Rollbar

3487. **[buddy](https://github.com/fiorastudio/buddy)** - ⭐ 25
   Your persistent AI coding companion — the /buddy rescue mission. A tamagotchi. 21 species, personality stats, code feedback. Works with Claude Code, Cursor CLI, Codex CLI & any MCP compatible CLI client.

3488. **[skill-mcp](https://github.com/fkesheh/skill-mcp)** - ⭐ 24
...
3489. **[mcp-chain-of-draft-server](https://github.com/bsmi021/mcp-chain-of-draft-server)** - ⭐ 24
   Chain of Draft Server is a powerful AI-driven tool that helps developers make better decisions through systematic, iterative refinement of thoughts and designs. It integrates seamlessly with popular AI agents and provides a structured approach to reasoning, API design, architecture decisions, code reviews, and implementation planning.

3490. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

3491. **[GenomeMCP](https://github.com/Eldergenix/GenomeMCP)** - ⭐ 24
...
3492. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

3493. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
3494. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
3495. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

3496. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
3497. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

3498. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
3499. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

3500. **[Awesome-MCP](https://github.com/Albertchamberlain/Awesome-MCP)** - ⭐ 24
   Awesome-MCP Servers & Clients & Funny things

3501. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 24
...
3502. **[readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db)** - ⭐ 24
...
3503. **[k6-mcp-server](https://github.com/QAInsights/k6-mcp-server)** - ⭐ 24
   k6 MCP server

3504. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 24
   Official BlazeMeter MCP Server for AI-driven performance testing

3505. **[mcp-client-agent](https://github.com/shane-kercheval/mcp-client-agent)** - ⭐ 24
   CLI that uses DSPy to interact with MCP servers.

3506. **[roo-logger](https://github.com/annenpolka/roo-logger)** - ⭐ 24
   An MCP server for logging activity in Roo Code/Cline.

3507. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 24
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

3508. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 24
   Model Context Protocol server for querying Cursor chat history

3509. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 24
   Model Context Protocol SDK implemented in Lua for OpenResty

3510. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 24
...
3511. **[mcp-mesh](https://github.com/dhyansraj/mcp-mesh)** - ⭐ 24
...
3512. **[Claude-Code-MCP-Manager](https://github.com/qdhenry/Claude-Code-MCP-Manager)** - ⭐ 24
    A comprehensive tool to manage Model Context Protocol (MCP) configurations for Claude code

3513. **[metmuseum-mcp](https://github.com/mikechao/metmuseum-mcp)** - ⭐ 24
   Met Museum MCP integration to discover the art collection at The Metropolitan Museum of Art in New York

3514. **[html-to-markdown-mcp](https://github.com/levz0r/html-to-markdown-mcp)** - ⭐ 24
...
3515. **[agentgate](https://github.com/agentkitai/agentgate)** - ⭐ 24
   Approval workflows for AI agents

3516. **[ib-mcp-cache-server](https://github.com/ibproduct/ib-mcp-cache-server)** - ⭐ 24
   Memory Cache Server for use with supported MCP API Clients.

3517. **[WikidataMCP](https://github.com/philippesaade-wmde/WikidataMCP)** - ⭐ 24
   Model Context Protocol for Wikidata

3518. **[WikidataMCP](https://github.com/wmde/WikidataMCP)** - ⭐ 24
   Model Context Protocol for Wikidata

3519. **[mcp-cmd](https://github.com/developit/mcp-cmd)** - ⭐ 24
   CLI for calling successive MCP Server tools

3520. **[Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine](https://github.com/cortexaiofficial/Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine)** - ⭐ 24
...
3521. **[Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine](https://github.com/Cortex-AI-Software/Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine)** - ⭐ 24
   🧠 Autonomous AI Trading Agent & Multi-Chain Flash-Arb Engine (v2.0 Beta). Powered by MCP-Protocol & LLM reasoning. High-frequency arbitrage on Solana, Base, and EVM L2s. Built by Cortex Software Labs.

3522. **[codemesh](https://github.com/kiliman/codemesh)** - ⭐ 24
   The Self-Improving MCP Server - Agents write code to orchestrate multiple MCP servers with intelligent TypeScript execution and auto-augmentation

3523. **[mcp-rss-aggregator](https://github.com/imprvhub/mcp-rss-aggregator)** - ⭐ 24
   Model Context Protocol Server for aggregating RSS feeds in Claude Desktop

3524. **[local-skills-mcp](https://github.com/kdpa-llc/local-skills-mcp)** - ⭐ 24
   Universal MCP server enabling any LLM or AI agent to utilize expert skills from your local filesystem. Reduces context consumption through lazy loading. Works with Claude, Cline, and any MCP-compatible client.

3525. **[cf-mcp-client](https://github.com/cpage-pivotal/cf-mcp-client)** - ⭐ 24
   Tanzu Platform Chat

3526. **[coworker](https://github.com/Array-Ventures/coworker)** - ⭐ 24
...
3527. **[jsonv-ts](https://github.com/dswbx/jsonv-ts)** - ⭐ 23
   JSON Schema builder and validator for TypeScript with static type inference, Hono middleware for OpenAPI generation and validation, and MCP server/client implementation. Lightweight, dependency-free, and built on Web Standards.

3528. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 23
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

3529. **[mcp-server-amazon-bedrock](https://github.com/zxkane/mcp-server-amazon-bedrock)** - ⭐ 23
   Model Context Procotol(MCP) server for using Amazon Bedrock Nova Canvas to generate images

3530. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

3531. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

3532. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
3533. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

3534. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
3535. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
3536. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

3537. **[mcp-community](https://github.com/Mirascope/mcp-community)** - ⭐ 23
   Easily run, deploy, and connect to MCP servers

3538. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 23
...
3539. **[nlweb-net](https://github.com/nlweb-ai/nlweb-net)** - ⭐ 23
...
3540. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 23
   A personal assistant AI agent built with the Model Context Protocol (MCP)

3541. **[lightdash-mcp-server](https://github.com/syucream/lightdash-mcp-server)** - ⭐ 23
   A MCP(Model Context Protocol) server that accesses to Lightdash

3542. **[balldontlie-mcp](https://github.com/mikechao/balldontlie-mcp)** - ⭐ 23
   An MCP Server implementation that integrates the Balldontlie API, to provide information about players, teams and games for the NBA, NFL and MLB

3543. **[slack-mcp-client](https://github.com/csonigo/slack-mcp-client)** - ⭐ 23
   An MCP client for slack in Typescript

3544. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 23
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

3545. **[autotask-mcp](https://github.com/asachs01/autotask-mcp)** - ⭐ 23
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

3546. **[nix-mcp-servers](https://github.com/ismail-kattakath/nix-mcp-servers)** - ⭐ 23
   A nix flake for configuring Model Context Protocol (MCP) servers across supported AI assistant clients

3547. **[codeprism](https://github.com/rustic-ai/codeprism)** - ⭐ 23
...
3548. **[agent-studio-starter](https://github.com/nsphung/agent-studio-starter)** - ⭐ 23
   Stop building AI agents from scratch. Bootstrap starter Agent app with LangGraph, CopilotKit, and beautiful Generative UIs.

3549. **[MCP-Mastery-with-Claude-and-Langchain](https://github.com/laxmimerit/MCP-Mastery-with-Claude-and-Langchain)** - ⭐ 23
   Build MCP servers & clients with Python, Streamlit, ChromaDB, LangChain, LangGraph agents, and Ollama integrations

3550. **[langchain-mcp-tools-ts](https://github.com/hideya/langchain-mcp-tools-ts)** - ⭐ 23
   MCP to LangChain Tools Conversion Utility / TypeScript

3551. **[ai-cli](https://github.com/manusa/ai-cli)** - ⭐ 23
   ai-cli lets you go from zero to AI-powered in seconds in a safe, automated and tailored way.

3552. **[twincat-validator-mcp](https://github.com/agenticcontrolio/twincat-validator-mcp)** - ⭐ 23
...
3565. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
3566. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

3567. **[biznagafest-mcp](https://github.com/0GiS0/biznagafest-mcp)** - ⭐ 22
   MCP Servers en Málaga con salero

3568. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 22
   MCP (model context protocol) server for interacting with dbt Docs

3569. **[your-money-left-the-chat](https://github.com/Rayato159/your-money-left-the-chat)** - ⭐ 22
   A Rust + MCP powered financial tracker that knows exactly where your money ghosted you.

3570. **[mcp-framework](https://github.com/koki7o/mcp-framework)** - ⭐ 22
   Rust MCP framework for building AI agents

3571. **[GUI-MCP](https://github.com/PhialsBasement/GUI-MCP)** - ⭐ 22
...
3572. **[suse-ai-up](https://github.com/SUSE/suse-ai-up)** - ⭐ 22
...
3573. **[awesome-mcp](https://github.com/MCPHubCloud/awesome-mcp)** - ⭐ 22
   A collection of mcp servers/client/sdks

3574. **[mcp-ai-agent](https://github.com/fkesheh/mcp-ai-agent)** - ⭐ 22
...
3579. **[teamcity-mcp](https://github.com/Daghis/teamcity-mcp)** - ⭐ 22
...
3580. **[mcp-prompt-optimizer](https://github.com/Bubobot-Team/mcp-prompt-optimizer)** - ⭐ 22
   Advanced MCP server providing cutting-edge prompt optimization tools with research-backed strategies

3581. **[perplexity-mcp-server](https://github.com/cyanheads/perplexity-mcp-server)** - ⭐ 22
...
3582. **[jenkins-mcp-enterprise](https://github.com/Jordan-Jarvis/jenkins-mcp-enterprise)** - ⭐ 22
...
3583. **[IoT-Edge-MCP-Server](https://github.com/poly-mcp/IoT-Edge-MCP-Server)** - ⭐ 22
...
3587. **[mcp-superset](https://github.com/bintocher/mcp-superset)** - ⭐ 22
   MCP server for managing Apache Superset — 128+ tools for dashboards, charts, datasets, SQL Lab, access control

3588. **[Jiva](https://github.com/KarmaloopAI/Jiva)** - ⭐ 22
...
3589. **[room-mcp](https://github.com/agree-able/room-mcp)** - ⭐ 22
   Allow MCP clients like claude-desktop to use rooms to coordinate with other agents

3590. **[linux-command-mcp](https://github.com/xkiranj/linux-command-mcp)** - ⭐ 22
   MCP server and client for running Linux commands

3591. **[Agentic-MCP-Skill](https://github.com/cablate/Agentic-MCP-Skill)** - ⭐ 22
   Agentic-MCP, Progressive MCP client with three-layer lazy loading. Validates AgentSkills.io pattern for efficient token usage. Use MCP without pre-install & wasting full-loading

3592. **[mcp-scan](https://github.com/rodolfboctor/mcp-scan)** - ⭐ 22
...
3593. **[opencode-mcp](https://github.com/AlaeddineMessadi/opencode-mcp)** - ⭐ 22
...
3594. **[typescript-mcp-client](https://github.com/CodelyTV/typescript-mcp-client)** - ⭐ 22

3595. **[slack-mcp-server](https://github.com/jtalk22/slack-mcp-server)** - ⭐ 22
   Session-based Slack MCP for Claude and MCP clients: local-first workflows, secure-default HTTP.

3596. **[overleaf-mcp-server](https://github.com/YounesBensafia/overleaf-mcp-server)** - ⭐ 22
...
3597. **[awesome-agent-skills-mcp](https://github.com/shadowrootdev/awesome-agent-skills-mcp)** - ⭐ 22
...
3598. **[engram-memory-community](https://github.com/EngramMemory/engram-memory-community)** - ⭐ 22
...
3599. **[pixelpanda-mcp](https://github.com/RyanKramer/pixelpanda-mcp)** - ⭐ 21
   MCP server for PixelPanda — 31 AI image processing tools for Claude Desktop, Cursor & other MCP clients

3600. **[ffmpeg-mcp-lite](https://github.com/kevinwatt/ffmpeg-mcp-lite)** - ⭐ 21
   MCP server for video/audio processing via FFmpeg - convert, compress, trim, extract audio, add subtitles

3601. **[supabase-mcp-client](https://github.com/tambo-ai/supabase-mcp-client)** - ⭐ 21
   Supabase MCP client react app with Tambo

3602. **[MCP_A2A](https://github.com/regismesquita/MCP_A2A)** - ⭐ 21
...
3603. **[grumpydev-mcp](https://github.com/sinedied/grumpydev-mcp)** - ⭐ 21
   Let the grumpy senior dev review your code with this MCP server

3604. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
3605. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

3606. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

3607. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

3608. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

3609. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

3610. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

3611. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
3612. **[code-context-mcp](https://github.com/fkesheh/code-context-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) server for providing code context from git repositories

3613. **[plux](https://github.com/milisp/plux)** - ⭐ 21
   💡AI finder/explorer. One click @files via a visual filetree and save insights in a notepad. build with Tauri

3614. **[mcp-deepseek-demo](https://github.com/Ulanxx/mcp-deepseek-demo)** - ⭐ 21
   deepseek 结合 mcp 场景，最小用例，包括 client and server

3615. **[hs-mcp](https://github.com/buecking/hs-mcp)** - ⭐ 21
   Haskell server/client for MCP (Model Context Protocol)

3616. **[aws-s3-mcp](https://github.com/samuraikun/aws-s3-mcp)** - ⭐ 21
   MCP server to integrate AWS S3 and LLM

3617. **[mcp-server-memos-py](https://github.com/RyoJerryYu/mcp-server-memos-py)** - ⭐ 21
   A Python package enabling LLM models to interact with the Memos server via the MCP interface for searching, creating, retrieving, and managing memos.

3618. **[Air-Quality-Trends-Analysis-Project](https://github.com/dyneth02/Air-Quality-Trends-Analysis-Project)** - ⭐ 21
...
3619. **[guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks](https://github.com/aws-solutions-library-samples/guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks)** - ⭐ 21
...
3620. **[heuristic-mcp](https://github.com/softerist/heuristic-mcp)** - ⭐ 21
...
3621. **[lotus-wisdom-mcp](https://github.com/linxule/lotus-wisdom-mcp)** - ⭐ 21
...
3622. **[mcp-link](https://github.com/AuraFriday/mcp-link)** - ⭐ 21
...
3623. **[PDB-MCP-Server](https://github.com/Augmented-Nature/PDB-MCP-Server)** - ⭐ 21
...
3624. **[codex-mcp-tool](https://github.com/x51xxx/codex-mcp-tool)** - ⭐ 21

3625. **[mcp-diagnostics-extension](https://github.com/newbpydev/mcp-diagnostics-extension)** - ⭐ 21
   VS Code extension that exposes diagnostic problems via Model Context Protocol (MCP) for AI agents and tools

3626. **[registry](https://github.com/biocontext-ai/registry)** - ⭐ 21
   The BioContextAI Registry for biomedical MCP servers

3627. **[archmcp](https://github.com/dejo1307/archmcp)** - ⭐ 21
   archmcp - MCP Architectural Snapshot Server and Knowledge Graph

3628. **[predictive-maintenance-mcp](https://github.com/LGDiMaggio/predictive-maintenance-mcp)** - ⭐ 21
...
3629. **[agentidentityprotocol](https://github.com/openagentidentityprotocol/agentidentityprotocol)** - ⭐ 21
...
3633. **[knowledgebase-mcp](https://github.com/biocontext-ai/knowledgebase-mcp)** - ⭐ 21
   BioContextAI Knowledgebase MCP server for biomedical agentic AI 

3634. **[mcp-kling](https://github.com/199-mcp/mcp-kling)** - ⭐ 21
   🎬 The FIRST MCP server for Kling AI video generation! Generate stunning AI videos directly from Claude.

3635. **[skill-to-mcp](https://github.com/biocontext-ai/skill-to-mcp)** - ⭐ 21
   Convert AI Skills (Claude Skills format) to MCP server resources - Part of BioContextAI

3636. **[dsers-mcp-product](https://github.com/lofder/dsers-mcp-product)** - ⭐ 21
...
3637. **[agentic-tools](https://github.com/meta-quest/agentic-tools)** - ⭐ 21
   Agent Tool and Skills for VR Development on Meta Quest 

3638. **[ARBuilder](https://github.com/Quantum3-Labs/ARBuilder)** - ⭐ 21
   AI-powered code generator for Arbitrum Stylus, SDK bridging, dApps & Orbit chains — 19 MCP tools with RAG

3639. **[onec-client-mcp-devkit](https://github.com/1c-neurofish/onec-client-mcp-devkit)** - ⭐ 21
   Реализация MCP сервера, который запускается в клиенте 1С:Предприятие

3640. **[mlb-mcp](https://github.com/etweisberg/mlb-mcp)** - ⭐ 21
   MCP server for advanced baseball analytics (statcast, fangraphs, baseball reference, mlb stats API)

3641. **[eleven.shopping](https://github.com/elevenlabs/eleven.shopping)** - ⭐ 21
   ElevenLabs Agent with Storefront MCP UI Server & MCP UI client

3642. **[gemini-mcp-client](https://github.com/angrysky56/gemini-mcp-client)** - ⭐ 21
...
3643. **[MCP-DB-Client](https://github.com/DitriXNew/MCP-DB-Client)** - ⭐ 21
   MCP layer for 1C

3644. **[manceps](https://github.com/zarpay/manceps)** - ⭐ 21
   Ruby client for the Model Context Protocol (MCP). Latin: one who takes in hand.

3645. **[screaming-frog-mcp](https://github.com/bzsasson/screaming-frog-mcp)** - ⭐ 21
...
3646. **[mcp-server-runner](https://github.com/yonaka15/mcp-server-runner)** - ⭐ 20
...
3647. **[mcp-free-usdc-transfer](https://github.com/magnetai/mcp-free-usdc-transfer)** - ⭐ 20
   MCP (Model Context Protocol) server - free usdc transfer powered by Coinbase CDP

3648. **[mcp-file-operations-server](https://github.com/bsmi021/mcp-file-operations-server)** - ⭐ 20
   A Model Context Protocol (MCP) server that provides enhanced file operation capabilities with streaming, patching, and change tracking support.

3649. **[cucumberstudio-mcp](https://github.com/HeroSizy/cucumberstudio-mcp)** - ⭐ 20
   MCP Server for Cucumber Studio

3650. **[agent-mcp](https://github.com/grupa-ai/agent-mcp)** - ⭐ 20
   MCPAgent for Grupa.AI Multi-agent Collaboration Network (MACNET) with Model Context Protocol (MCP) capabilities baked in

3651. **[mcp-frontend](https://github.com/shaharia-lab/mcp-frontend)** - ⭐ 20
   Frontend for MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

3652. **[mcp-yfinance](https://github.com/9nate-drake/mcp-yfinance)** - ⭐ 20
   MCP Server for fething yfinance financial data into Claude Desktop

3653. **[eraser-io-mcp-server](https://github.com/buck-0x/eraser-io-mcp-server)** - ⭐ 20
   A Python MCP (Model Context Protocol) server and CLI tool to render diagrams using the Eraser API.

3654. **[MCP-Agent](https://github.com/CursorTouch/MCP-Agent)** - ⭐ 20
   Connect to any MCP servers using agents

3655. **[context-lens](https://github.com/cornelcroi/context-lens)** - ⭐ 20
...
3656. **[mcp-libsql](https://github.com/Xexr/mcp-libsql)** - ⭐ 20
...
3657. **[hasmcp-ce](https://github.com/hasmcp/hasmcp-ce)** - ⭐ 20
   HasMCP Community Edition

3658. **[google-scholar-mcp](https://github.com/mochow13/google-scholar-mcp)** - ⭐ 20
   An MCP server for Google Scholar written in TypeScript with Streamable HTTP

3659. **[muster](https://github.com/giantswarm/muster)** - ⭐ 20
   MCP tool management and workflow proxy

3660. **[gh-mcp](https://github.com/shuymn/gh-mcp)** - ⭐ 20
...
3661. **[mcp-server-amazon](https://github.com/rigwild/mcp-server-amazon)** - ⭐ 20
   🛍📦 Unofficial Amazon Model Context Protocol Server (MCP) - Search products and purchase directly from Claude AI! ✨

3662. **[starbase](https://github.com/metorial/starbase)** - ⭐ 20
   Connect, explore, and test any MCP server with AI models 🤖 ⚡

3663. **[gpt2099.nu](https://github.com/cablehead/gpt2099.nu)** - ⭐ 20
   a Nushell cross.stream extension to interact with LLMs and MCP servers

3664. **[lyra-tool-discovery](https://github.com/nirholas/lyra-tool-discovery)** - ⭐ 20
...
3665. **[hass-mcp-server](https://github.com/ganhammar/hass-mcp-server)** - ⭐ 20
...
3666. **[mcp-server-microsoft-paint](https://github.com/ghuntley/mcp-server-microsoft-paint)** - ⭐ 20

3667. **[mcpx](https://github.com/AIGC-Hackers/mcpx)** - ⭐ 20
...
3668. **[github-repos-manager-mcp](https://github.com/kurdin/github-repos-manager-mcp)** - ⭐ 20
...
3669. **[unity-mcp](https://github.com/wondeks/unity-mcp)** - ⭐ 20
   A Unity MCP server that allows MCP clients like Claude Desktop or Cursor to perform Unity Editor actions.

3670. **[atxp](https://github.com/atxp-dev/atxp)** - ⭐ 20
...
3671. **[mcp-oauth-proxy](https://github.com/obot-platform/mcp-oauth-proxy)** - ⭐ 20
   Oauth 2.1 proxy server that can autheticate client and proxy requests to mcp server

3672. **[MicrosoftGraph_Transcript_MCP](https://github.com/ITSpecialist111/MicrosoftGraph_Transcript_MCP)** - ⭐ 20
...
3673. **[swift-mcp](https://github.com/DePasqualeOrg/swift-mcp)** - ⭐ 20
   Full-featured Swift SDK for Model Context Protocol servers and clients

3674. **[mcp_documents_reader](https://github.com/xt765/mcp_documents_reader)** - ⭐ 20
...
3675. **[askr](https://github.com/Sweatent/askr)** - ⭐ 20
   MCP Q&A Assistant - Async Q&A capabilities for AI clients via MCP protocol

3676. **[DecisionNode](https://github.com/decisionnode/DecisionNode)** - ⭐ 20
...
3677. **[easymcp](https://github.com/promptmesh/easymcp)** - ⭐ 19
   A high performance MCP client sdk for python

3678. **[mcp](https://github.com/EmilLindfors/mcp)** - ⭐ 19
    A crate for making MCP (Model Context Protocol) compatible programs with rust

3679. **[mcp-server-mariadb](https://github.com/abel9851/mcp-server-mariadb)** - ⭐ 19
   An mcp server that provides read-only access to MariaDB.

3680. **[mcp-server-client-demo](https://github.com/S1LV3RJ1NX/mcp-server-client-demo)** - ⭐ 19
   Streamable HTTP based MCP server and Client demo with auto registry, Dockerfile setup and env. 

3681. **[openapi2mcptools](https://github.com/2013xile/openapi2mcptools)** - ⭐ 19
   OpenAPI specifications => MCP (Model Context Protocol) tools

3682. **[termlink](https://github.com/chu2bard/termlink)** - ⭐ 19
   MCP server for shell and terminal operations

3683. **[it-tools-mcp](https://github.com/wrenchpilot/it-tools-mcp)** - ⭐ 19
...
3684. **[mcpbi](https://github.com/jonaolden/mcpbi)** - ⭐ 19
   PowerBI MCP server to give LLM clients (Claude, GH Copilot,etc) context from locally running PowerBI Desktop instances.

3685. **[mcp](https://github.com/yandex-cloud/mcp)** - ⭐ 19
   Yandex Cloud MCP Servers

3686. **[short-url](https://github.com/fengzhongsen/short-url)** - ⭐ 19
   简单易用的短链接生成工具，完全开源、免费、无需登录，可私有化部署，链接永久有效！

3687. **[bonnard](https://github.com/bonnard-data/bonnard)** - ⭐ 19
...
3688. **[toolkit-mcp-server](https://github.com/cyanheads/toolkit-mcp-server)** - ⭐ 19
   A Model Context Protocol server providing LLM Agents with system utilities and tools, including IP geolocation, network diagnostics, system monitoring, cryptographic operations, and QR code generation.

3689. **[spectrawl](https://github.com/FayAndXan/spectrawl)** - ⭐ 19
   The unified web layer for AI agents. Search (8 engines), stealth browse, auth, and act on 24 platforms. One npm install, self-hosted.

3690. **[mcp-agent](https://github.com/joshuaalpuerto/mcp-agent)** - ⭐ 19
...
3691. **[unified-gateway-mcp](https://github.com/mcp360/unified-gateway-mcp)** - ⭐ 19
   Unified MCP Gateway Platform, Marketplace & Custom MCPs

3692. **[subcog](https://github.com/zircote/subcog)** - ⭐ 19
...
3693. **[builtwith-api](https://github.com/zcaceres/builtwith-api)** - ⭐ 19
   TypeScript library, MCP, and agent-friendly CLI for the BuiltWith API.

3694. **[better-notion-mcp](https://github.com/n24q02m/better-notion-mcp)** - ⭐ 19
   Markdown-first MCP server for Notion API - composite tools optimized for AI agents

3695. **[mcp-anything](https://github.com/gabrielekarra/mcp-anything)** - ⭐ 19
   One command to turn any codebase into an MCP server

3696. **[nanobanana-mcp](https://github.com/YCSE/nanobanana-mcp)** - ⭐ 19
   Gemini Vision & Image Generation MCP for Claude Desktop and Claude Code

3697. **[awesome-mcp-security](https://github.com/AgentSeal/awesome-mcp-security)** - ⭐ 19
...
3698. **[pophive-mcp-server](https://github.com/Cicatriiz/pophive-mcp-server)** - ⭐ 19
...
3699. **[resonant](https://github.com/codependentai/resonant)** - ⭐ 19
...
3700. **[emceepee](https://github.com/eastlondoner/emceepee)** - ⭐ 19
...
3701. **[mcp-server-zotero-dev](https://github.com/introfini/mcp-server-zotero-dev)** - ⭐ 19
...
3702. **[Unreal-MCP](https://github.com/aadeshrao123/Unreal-MCP)** - ⭐ 19
...
3703. **[mitmproxy-mcp](https://github.com/snapspecter/mitmproxy-mcp)** - ⭐ 19
...
3704. **[bruno-mcp](https://github.com/macarthy/bruno-mcp)** - ⭐ 19
...
3705. **[daiv](https://github.com/srtab/daiv)** - ⭐ 18
   Your AI-powered SWE teammate, built into your git workflow

3706. **[Augmented-Nature-UniProt-MCP-Server](https://github.com/Augmented-Nature/Augmented-Nature-UniProt-MCP-Server)** - ⭐ 18
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the UniProt protein database. 

3707. **[mcp](https://github.com/zuplo/mcp)** - ⭐ 18
   A fetch API based TypeScript SDK for MCP

3708. **[openpyxl-mcp-server](https://github.com/jonemo/openpyxl-mcp-server)** - ⭐ 18
...
3709. **[sufetch](https://github.com/productdevbook/sufetch)** - ⭐ 18
   Type-safe OpenAPI clients with MCP server for AI-driven API exploration

3710. **[SimpleMcp.Demo](https://github.com/hassanhabib/SimpleMcp.Demo)** - ⭐ 18
   Simplest Possible Demo for Building MCP Server & Client

3711. **[mcp-copilot](https://github.com/tshu-w/mcp-copilot)** - ⭐ 18
   A meta MCP server that seamlessly scales LLMs to 1000+ MCP servers through automatic routing.

3712. **[Devmind-MCP](https://github.com/JochenYang/Devmind-MCP)** - ⭐ 18
...
3713. **[seedream-image-mcp](https://github.com/wearzdk/seedream-image-mcp)** - ⭐ 18
   🚀 PixelMCP | 为你的 Cursor、Claude Code 等集成AI绘画能力，让AI生成的页面不再单调！

3714. **[mcp-chat-studio](https://github.com/JoeCastrom/mcp-chat-studio)** - ⭐ 18
...
3715. **[mcp-chain-of-draft-prompt-tool](https://github.com/brendancopley/mcp-chain-of-draft-prompt-tool)** - ⭐ 18
   MCP prompt tool applying Chain-of-Draft (CoD) reasoning - BYOLLM

3716. **[model-context-protocol-survey](https://github.com/asinghcsu/model-context-protocol-survey)** - ⭐ 18
   Model Context Protocol (MCP)

3717. **[MCP-Development-with-Rust](https://github.com/RustSandbox/MCP-Development-with-Rust)** - ⭐ 18
...
3718. **[titanmind-whatsapp-mcp](https://github.com/TitanmindAGI/titanmind-whatsapp-mcp)** - ⭐ 18
...
3719. **[awesome-dxt-mcp](https://github.com/MCPStar/awesome-dxt-mcp)** - ⭐ 18
...
3720. **[gumroad-mcp](https://github.com/rmarescu/gumroad-mcp)** - ⭐ 18
   A Model Context Protocol (MCP) server implementation for Gumroad API

3721. **[cmcp](https://github.com/RussellLuo/cmcp)** - ⭐ 18
   A command-line utility for interacting with MCP servers.

3722. **[mcp-chatbot](https://github.com/mctrinh/mcp-chatbot)** - ⭐ 18
...
3723. **[toolhive-catalog](https://github.com/stacklok/toolhive-catalog)** - ⭐ 18
   ToolHive's registry catalog of MCP servers

3724. **[rigour](https://github.com/rigour-labs/rigour)** - ⭐ 18
   The immune system for AI coding agents

3725. **[robotmem](https://github.com/robotmem/robotmem)** - ⭐ 18
   Robot Memory - Persistent memory system for AI robots. MCP Server + hybrid search + spatial retrieval.

3726. **[speclock](https://github.com/sgroy10/speclock)** - ⭐ 18
...
3727. **[agentify](https://github.com/koriyoshi2041/agentify)** - ⭐ 18
...
3728. **[arxiv-mcp-server](https://github.com/anuj0456/arxiv-mcp-server)** - ⭐ 18
...
3729. **[mcp-gateway](https://github.com/unrelated-ai/mcp-gateway)** - ⭐ 18
...
3730. **[scopus-mcp](https://github.com/qwe4559999/scopus-mcp)** - ⭐ 18
...
3731. **[mcp-obsidian](https://github.com/Piotr1215/mcp-obsidian)** - ⭐ 18
   simple mcp server for interacting with local obsidian notes

3732. **[ContextOS](https://github.com/itallstartedwithaidea/ContextOS)** - ⭐ 18
...
3733. **[local-mcp-gateway](https://github.com/DXHeroes/local-mcp-gateway)** - ⭐ 18
   Aggregate multiple MCP servers into a single endpoint with web UI, OAuth 2.1, and profile-based tool management

3734. **[openrouter-mcp-multimodal](https://github.com/stabgan/openrouter-mcp-multimodal)** - ⭐ 18
   MCP server for OpenRouter providing text chat and image analysis tools

3735. **[GUARDRAIL](https://github.com/nshkrdotcom/GUARDRAIL)** - ⭐ 18
   GUARDRAIL - MCP Security - Gateway for Unified Access, Resource Delegation, and Risk-Attenuating Information Limits

3736. **[sveltekit-mcp-starter](https://github.com/axel-rock/sveltekit-mcp-starter)** - ⭐ 18

3737. **[muxi](https://github.com/ranaroussi/muxi)** - ⭐ 18
   An extensible AI agents framework

3738. **[XcodeMCPWrapper](https://github.com/SoundBlaster/XcodeMCPWrapper)** - ⭐ 18
   MCP that makes Xcode 26.3's MCP compatible with Cursor and other strict MCP-spec-compliant clients

3739. **[signal-mcp-client](https://github.com/piebro/signal-mcp-client)** - ⭐ 18
   An MCP client that uses signal for sending and receiving messages.

3740. **[hoot](https://github.com/Portkey-AI/hoot)** - ⭐ 18
   MCP Testing Tool — Like Postman, but for the Model Context Protocol.

3741. **[mcp-spotify-player](https://github.com/vsaez/mcp-spotify-player)** - ⭐ 18
   MCP server to manage Spotify from MCP clients

3742. **[mcp-email-client](https://github.com/gamalan/mcp-email-client)** - ⭐ 17
   Email Client as MCP Server. Feature: multiple configuration, more than just gmail

3743. **[smartlead-mcp-server](https://github.com/jonathan-politzki/smartlead-mcp-server)** - ⭐ 17
   Local version of Smartlead MCP for quick download and deployment to MCP compatible clients or n8n.

3744. **[mcp-http-client-example](https://github.com/slavashvets/mcp-http-client-example)** - ⭐ 17
   Simple example client demonstrating how to connect to MCP servers over HTTP (SSE)

3745. **[jiki](https://github.com/teilomillet/jiki)** - ⭐ 17

3746. **[askit](https://github.com/johnrobinsn/askit)** - ⭐ 17
   LLM Function Calling Library and CLI with Support for MCP Servers

3747. **[youtube-mcp-server](https://github.com/0GiS0/youtube-mcp-server)** - ⭐ 17
   Cómo crear MCP Servers y usarlos con GitHub Copilot Chat 🚀💻🤖

3748. **[mcp-server-prometheus](https://github.com/loglmhq/mcp-server-prometheus)** - ⭐ 17
   MCP server for interacting with Prometheus

3749. **[mcp-koii](https://github.com/benjaminr/mcp-koii)** - ⭐ 17
   MCP Server for Teenage Engineering EP-133 KO-II

3750. **[context-engineering](https://github.com/timothywarner-org/context-engineering)** - ⭐ 17
...
3751. **[docmole](https://github.com/Vigtu/docmole)** - ⭐ 17
   Dig through any documentation with AI - MCP server for Claude, Cursor, and other AI assistants

3752. **[autowpmcp](https://github.com/Njengah/autowpmcp)** - ⭐ 17
...
3753. **[rpc-nodes-mcp](https://github.com/chainstacklabs/rpc-nodes-mcp)** - ⭐ 17
   Minimal, fast, and extensible MCP server for interactions with JSON-RPC blockchain nodes

3754. **[mcp-server-codegraph](https://github.com/CartographAI/mcp-server-codegraph)** - ⭐ 17
   MCP server for graph representation of a codebase

3755. **[mcpforge](https://github.com/lorenzosaraiva/mcpforge)** - ⭐ 17

3756. **[mcp-ecosystem](https://github.com/SynkraAI/mcp-ecosystem)** - ⭐ 17
   MCP Ecosystem: Docker MCP Toolkit, IDE Configs & Presets for AIOS

3757. **[lightdash_mcp](https://github.com/poddubnyoleg/lightdash_mcp)** - ⭐ 17
   mcp server for lightdash

3758. **[mcp-graphql-forge](https://github.com/toolprint/mcp-graphql-forge)** - ⭐ 17
   MCP that can proxy any GraphQL API and expose graphql operations as mcp tools.

3759. **[mistr-agent](https://github.com/itisaevalex/mistr-agent)** - ⭐ 17
...
3760. **[osmmcp](https://github.com/NERVsystems/osmmcp)** - ⭐ 17
...
3761. **[CereBro](https://github.com/rob1997/CereBro)** - ⭐ 17
   A model-agnostic MCP Client-Server for .Net and Unity

3762. **[github-to-mcp](https://github.com/nirholas/github-to-mcp)** - ⭐ 17
   Convert GitHub repositories to MCP servers automatically. Extract tools from OpenAPI, GraphQL & REST APIs for Claude Desktop, Cursor, Windsurf, Cline & VS Code. AI-powered code generation creates type-safe TypeScript/Python MCP servers. Zero config setup - just paste a repo URL. Built for AI assistants & LLM tool integration.

3763. **[FocusRelayMCP](https://github.com/deverman/FocusRelayMCP)** - ⭐ 17
...
3764. **[extract-llms-docs](https://github.com/nirholas/extract-llms-docs)** - ⭐ 17
...
3765. **[video-research-mcp](https://github.com/Galbaz1/video-research-mcp)** - ⭐ 17
...
3766. **[opencode-browser](https://github.com/michaljach/opencode-browser)** - ⭐ 17
...
3767. **[Frontapp-MCP](https://github.com/zqushair/Frontapp-MCP)** - ⭐ 17
   MCP server and client for Frontapp

3768. **[nasa](https://github.com/peteretelej/nasa)** - ⭐ 17
...
3769. **[ida-codex-mcp](https://github.com/Iamgublin/ida-codex-mcp)** - ⭐ 17
...
3770. **[mcp_client](https://github.com/app-appplayer/mcp_client)** - ⭐ 17

3771. **[asc-mcp](https://github.com/zelentsov-dev/asc-mcp)** - ⭐ 17
...
3776. **[mcp-client-cli](https://github.com/addity3/mcp-client-cli)** - ⭐ 16
   cli-based program to run llm prompt and mcp

3777. **[claude-vigil-mcp](https://github.com/Vvkmnn/claude-vigil-mcp)** - ⭐ 16
   🏺 An MCP server for checkpointing and file recovery in Claude Code

3778. **[oneshot](https://github.com/Destiner/oneshot)** - ⭐ 16
   Anthropic MCP client for macOS

3779. **[lite-mcp-client](https://github.com/sligter/lite-mcp-client)** - ⭐ 16
   Lite-MCP-Client是一个基于命令行的轻量级MCP客户端工具

3780. **[EasyMCP](https://github.com/mshojaei77/EasyMCP)** - ⭐ 16
...
3781. **[mcp-installer](https://github.com/joobisb/mcp-installer)** - ⭐ 16
   Simplifies the installation and management of MCP (Model Context Protocol) servers across different AI clients.

3782. **[appvector-mcp](https://github.com/Multivariate-AI-Inc/appvector-mcp)** - ⭐ 16
...
3783. **[protocols-io-mcp-server](https://github.com/hqn21/protocols-io-mcp-server)** - ⭐ 16
   An MCP server that enables MCP clients like Claude Desktop to interact with data from protocols.io.

3784. **[mcp-progressive-agentskill](https://github.com/cablate/mcp-progressive-agentskill)** - ⭐ 16
...
3785. **[create-mcp](https://github.com/fefergrgrgrg/create-mcp)** - ⭐ 16
   CLI to set up and deploy MCP Servers to Cloudflare Workers in seconds. Just write TypeScript functions to make Cursor MCP tools.

3786. **[videocapture-mcp](https://github.com/13rac1/videocapture-mcp)** - ⭐ 16
   Model Context Protocol (MCP) server to capture images from an OpenCV-compatible webcam or video source

3787. **[aica](https://github.com/dotneet/aica)** - ⭐ 16
   aica(AI Code Analyzer) reviews your code using AI. Supports CLI and GitHub Actions.

3788. **[go-mcp](https://github.com/dstotijn/go-mcp)** - ⭐ 16
   Go library for implementing the Model Context Protocol (MCP).

3789. **[QCX](https://github.com/QueueLab/QCX)** - ⭐ 16
   Language to Maps

3790. **[qmt-mcp-server](https://github.com/jm12138/qmt-mcp-server)** - ⭐ 16
   基于 QMT 平台股票行情的 MCP 服务器，用于提供股票市场数据下载和查询的功能。

3791. **[grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp)** - ⭐ 16
   MCP server for xAI Grok — read and serve .faf project context. npm: grok-faf-mcp

3792. **[mcp-jest](https://github.com/josharsh/mcp-jest)** - ⭐ 16
   Automated testing for Model Context Protocol servers. Ship MCP Servers with confidence.

3793. **[mcp-client-gen](https://github.com/kriasoft/mcp-client-gen)** - ⭐ 16
   Turn any MCP server into a type-safe TypeScript SDK in seconds - with    OAuth 2.1 and multi-provider support

3794. **[penpot-mcp-server](https://github.com/zcube/penpot-mcp-server)** - ⭐ 16
   MCP server for Penpot - Connect AI assistants to Penpot design platform via Model Context Protocol

3795. **[pentest-mcp-server](https://github.com/LayeSec006/pentest-mcp-server)** - ⭐ 16
   MCP server for penetration testing

3796. **[MCP-Analyzer](https://github.com/klara-research/MCP-Analyzer)** - ⭐ 16
   An MCP server to read MCP logs to debug directly inside the client

3797. **[drf-mcp-docs](https://github.com/Abdulkhalek-1/drf-mcp-docs)** - ⭐ 16
   API documentation via MCP for AI coding agents

3798. **[mcp-this](https://github.com/shane-kercheval/mcp-this)** - ⭐ 16
...
3799. **[LSP4J-MCP](https://github.com/stephanj/LSP4J-MCP)** - ⭐ 16
...
3800. **[outlook-mcp](https://github.com/XenoXilus/outlook-mcp)** - ⭐ 16
...
3801. **[mcpdog](https://github.com/kinhunt/mcpdog)** - ⭐ 16
...
3802. **[puppeteer-mcp-server](https://github.com/sultannaufal/puppeteer-mcp-server)** - ⭐ 16
...
3803. **[mcp-salesforce](https://github.com/AiondaDotCom/mcp-salesforce)** - ⭐ 16
...
3804. **[shodan-mcp](https://github.com/Vorota-ai/shodan-mcp)** - ⭐ 16
...
3805. **[deep-research](https://github.com/troyhantech/deep-research)** - ⭐ 16
   A minimalist deep research framework for any OpenAI API compatible LLMs. 

3806. **[webmcp-react](https://github.com/MCPCat/webmcp-react)** - ⭐ 16
...
3807. **[capture-mcp-server](https://github.com/blencorp/capture-mcp-server)** - ⭐ 16
...
3808. **[vite-plugin-mcp-client-tools](https://github.com/atesgoral/vite-plugin-mcp-client-tools)** - ⭐ 16
   Pluggable Vite MCP plugin that brings client-side tools to your existing Vite setup

3809. **[kanboard-mcp](https://github.com/ChristianJStarr/kanboard-mcp)** - ⭐ 16
...
3810. **[davinci-mcp-professional](https://github.com/Positronikal/davinci-mcp-professional)** - ⭐ 16
...
3811. **[openapi-to-mcp](https://github.com/EvilFreelancer/openapi-to-mcp)** - ⭐ 16
...
3812. **[ia-na-pratica](https://github.com/Code4Delphi/ia-na-pratica)** - ⭐ 16
   IA na Prática: LLM, RAG, MCP, Agents, Function Calling, Multimodal, TTS/STT e mais

3813. **[MCP-Manager-GUI](https://github.com/gabrielbacha/MCP-Manager-GUI)** - ⭐ 16
   MCP Toggle is a simple GUI tool to help you manage MCP servers across clients seamlessly.

3814. **[mcp-client-for-weather-example](https://github.com/a-persimmons/mcp-client-for-weather-example)** - ⭐ 15
   一个MCP客户端实践：实现LLM调用天气MCP服务端查询天气的快速示例

3815. **[faf](https://github.com/Wolfe-Jam/faf)** - ⭐ 15
   FAF specification — IANA-registered AI context format (application/vnd.faf+yaml)

3816. **[mcp-server](https://github.com/HarperFast/mcp-server)** - ⭐ 15
   An MCP server providing an interface for MCP clients to access data within Harper.

3817. **[django-firebase-mcp](https://github.com/raghavdasila/django-firebase-mcp)** - ⭐ 15
...
3818. **[claude-server](https://github.com/davidteren/claude-server)** - ⭐ 15
...
3819. **[pinmeto-location-mcp](https://github.com/PinMeTo/pinmeto-location-mcp)** - ⭐ 15
   PinMeTo MCP server that enables users with authorized credentials to unlock their data 

3820. **[npm-search-mcp-server](https://github.com/btwiuse/npm-search-mcp-server)** - ⭐ 15
   MCP server for searching npm packages

3821. **[mcp-server-python-template](https://github.com/sontallive/mcp-server-python-template)** - ⭐ 15
   This template provides a streamlined foundation for building Model Context Protocol (MCP) servers in Python. It's designed to make AI-assisted development of MCP tools easier and more efficient.

3822. **[mcp-tui](https://github.com/msabramo/mcp-tui)** - ⭐ 15
   MCP host app w/ textual user interface, in Python

3823. **[mcp-server-unitycatalog](https://github.com/ognis1205/mcp-server-unitycatalog)** - ⭐ 15
   Unity Catalog AI Model Context Protocol Server

3824. **[claude-mcp-scheduler](https://github.com/tonybentley/claude-mcp-scheduler)** - ⭐ 15
   Use Claude API to prompt remote agents on a cron interval but use local MCPs to handle tool calls for context

3825. **[mcp-server-templates](https://github.com/Data-Everything/mcp-server-templates)** - ⭐ 15
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs.

3826. **[mcp-turso-cloud](https://github.com/spences10/mcp-turso-cloud)** - ⭐ 15
...
3827. **[mcp-web-client](https://github.com/hemanth/mcp-web-client)** - ⭐ 15
   A web-based client for connecting to MCP servers with OAuth support

3828. **[cursor-feedback-extension](https://github.com/jianger666/cursor-feedback-extension)** - ⭐ 15
   Save your Cursor monthly quota! Unlimited AI interactions in one conversation via MCP feedback loop.

3829. **[the-academy](https://github.com/im-knots/the-academy)** - ⭐ 15
   A Socratic dialogue engine for AI agents. 

3830. **[mcp](https://github.com/local-falcon/mcp)** - ⭐ 15
...
3831. **[opentargets-mcp](https://github.com/nickzren/opentargets-mcp)** - ⭐ 15
   MCP server for Open Targets Data

3832. **[programmatic-tool-calling-ai-sdk](https://github.com/cameronking4/programmatic-tool-calling-ai-sdk)** - ⭐ 15
...
3833. **[Convert-Markdown-PDF-MCP](https://github.com/seanivore/Convert-Markdown-PDF-MCP)** - ⭐ 15
   Markdown To PDF Conversion MCP

3834. **[mcp-server-subagent](https://github.com/dvcrn/mcp-server-subagent)** - ⭐ 15
   MCP for letting agents delegate tasks to sub-agents (Claude Code, Aider, Q)

3835. **[automagik-tools](https://github.com/namastexlabs/automagik-tools)** - ⭐ 15
   From API to AI in 30 Seconds - Transform any API into an intelligent MCP agent that learns, adapts, and speaks human

3836. **[hive-crypto-mcp](https://github.com/hive-intel/hive-crypto-mcp)** - ⭐ 15
...
3837. **[companies-house-mcp](https://github.com/stefanoamorelli/companies-house-mcp)** - ⭐ 15
...
3838. **[chatgpt-app-typescript-template](https://github.com/pomerium/chatgpt-app-typescript-template)** - ⭐ 15
...
3839. **[ultrathink](https://github.com/husniadil/ultrathink)** - ⭐ 15
...
3840. **[django-mcp](https://github.com/hyperb1iss/django-mcp)** - ⭐ 15
...
3841. **[gsd-task-manager](https://github.com/vscarpenter/gsd-task-manager)** - ⭐ 15
...
3842. **[agent-board](https://github.com/quentintou/agent-board)** - ⭐ 15
...
3843. **[cuba-memorys](https://github.com/LeandroPG19/cuba-memorys)** - ⭐ 15
...
3844. **[opentrace](https://github.com/adham90/opentrace)** - ⭐ 15
...
3845. **[gemma-mcp](https://github.com/monatis/gemma-mcp)** - ⭐ 15
   MCP Client for Gemma-3

3846. **[mcp-bundler](https://github.com/wrtnlabs/mcp-bundler)** - ⭐ 15
   Is the MCP configuration too complicated? You can easily share your own simplified setup!

3847. **[SchemaPin](https://github.com/ThirdKeyAI/SchemaPin)** - ⭐ 15
   The SchemaPin protocol for cryptographically signing and verifying AI agent tool schemas to prevent supply-chain attacks.

3848. **[zebbern-kali-mcp](https://github.com/zebbern/zebbern-kali-mcp)** - ⭐ 15
...
3849. **[seats.aero-mcp-server](https://github.com/gavgrego/seats.aero-mcp-server)** - ⭐ 15
   MCP server allowing clients to interface with the seats.aero API

3850. **[conductor](https://github.com/aryabyte21/conductor)** - ⭐ 15
   Manage MCP server configs across AI coding clients

3851. **[mcpskills-cli](https://github.com/dhanababum/mcpskills-cli)** - ⭐ 14
...
3852. **[systemprompt-mcp-core](https://github.com/Ejb503/systemprompt-mcp-core)** - ⭐ 14
   The core MCP extension for Systemprompt MCP multimodal client

3853. **[llm-sse-mcp-demo-2025](https://github.com/nlinhvu/llm-sse-mcp-demo-2025)** - ⭐ 14
...
3854. **[ntfy-mcp-server](https://github.com/cyanheads/ntfy-mcp-server)** - ⭐ 14
   An MCP (Model Context Protocol) server designed to interact with the ntfy push notification service. It enables LLMs and AI agents to send notifications to your devices with extensive customization options.

3855. **[mcpterm](https://github.com/dwrtz/mcpterm)** - ⭐ 14
   An MCP tool server that provides stateful, TUI-compatible terminal sessions.

3856. **[work-memory-mcp](https://github.com/moontmsai/work-memory-mcp)** - ⭐ 14
   Never lose context again - persistent memory management system for AI-powered workflows across multiple tools

3857. **[mcp-ipfs](https://github.com/alexbakers/mcp-ipfs)** - ⭐ 14
   🪐 MCP IPFS Server 

3858. **[google-mcp](https://github.com/vakharwalad23/google-mcp)** - ⭐ 14
   Collection of Google-native tools (e.g., Gmail, Calendar) for the MCP

3859. **[mcp-server-gemini-pro](https://github.com/gurveeer/mcp-server-gemini-pro)** - ⭐ 14
...
3860. **[MCP-Platform](https://github.com/Data-Everything/MCP-Platform)** - ⭐ 14
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs

3861. **[mcp-server](https://github.com/configcat/mcp-server)** - ⭐ 14
   Official ConfigCat Model Context Protocol (MCP) Server 

3862. **[mcp-config-editor](https://github.com/kaichen/mcp-config-editor)** - ⭐ 14
   A simple GUI for managing MCP servers, for easy toggle mcp servers.

3863. **[deep-directory-tree-mcp](https://github.com/andredezzy/deep-directory-tree-mcp)** - ⭐ 14
...
3864. **[mcp-time](https://github.com/TheoBrigitte/mcp-time)** - ⭐ 14
...
3865. **[dx-toolkit](https://github.com/youdotcom-oss/dx-toolkit)** - ⭐ 14
   Open-source toolkit enabling developers to integrate You.com's AI capabilities into their workflows

3866. **[mcp-perplexity-server](https://github.com/PoliTwit1984/mcp-perplexity-server)** - ⭐ 14
...
3867. **[jadx-mcp-server](https://github.com/Qtty/jadx-mcp-server)** - ⭐ 14
   A Pure-Java MCP Server for JaDX Android Reverse Engineering Tool

3868. **[vmware-esxi-mcp](https://github.com/uldyssian-sh/vmware-esxi-mcp)** - ⭐ 14
...
3869. **[webfetch-mcp](https://github.com/manooll/webfetch-mcp)** - ⭐ 14
   Live Web Access for Your Local AI — Tunable Search & Clean Content Extraction

3870. **[domain-search-mcp](https://github.com/dorukardahan/domain-search-mcp)** - ⭐ 14
...
3871. **[dav-mcp](https://github.com/PhilflowIO/dav-mcp)** - ⭐ 14
   Transform AI agents into orchestrating assistants managing calendars, contacts, and tasks

3872. **[mcp-safe-run](https://github.com/ithena-one/mcp-safe-run)** - ⭐ 14
...
3873. **[phabricator-mcp](https://github.com/freelancer/phabricator-mcp)** - ⭐ 14
   MCP server for Phabricator

3874. **[openalex-research-mcp](https://github.com/oksure/openalex-research-mcp)** - ⭐ 14
...
3875. **[claude-praetorian-mcp](https://github.com/Vvkmnn/claude-praetorian-mcp)** - ⭐ 14
   ⚜️ An MCP server for context compaction and recycling in Claude Code

3876. **[servicenow-mcp](https://github.com/aartiq/servicenow-mcp)** - ⭐ 14
...
3877. **[swift-skeleton](https://github.com/1amageek/swift-skeleton)** - ⭐ 14
...
3878. **[arxiv-mcp-server](https://github.com/1Dark134/arxiv-mcp-server)** - ⭐ 14
...
3879. **[mcp-windows-automation](https://github.com/mukul975/mcp-windows-automation)** - ⭐ 14
...
3880. **[memory-visualizer](https://github.com/mjherich/memory-visualizer)** - ⭐ 14
...
3881. **[WAIaaS](https://github.com/minhoyoo-iotrust/WAIaaS)** - ⭐ 14
   Wallet-as-a-Service for all AI agents in the world

3882. **[x402-deploy](https://github.com/nirholas/x402-deploy)** - ⭐ 14
   Turn any API or MCP server into a paid service with x402 

3883. **[ai-mate](https://github.com/symfony/ai-mate)** - ⭐ 14
   AI development assistant MCP server for Symfony projects

3884. **[mcp-security-checklist](https://github.com/Helixar-AI/mcp-security-checklist)** - ⭐ 14
...
3885. **[llms-txt-generator](https://github.com/aircodelabs/llms-txt-generator)** - ⭐ 14
   The ultimate AI-powered generator for llms.txt and llms-full.txt files. 

3886. **[mcp-graph-workflow](https://github.com/DiegoNogueiraDev/mcp-graph-workflow)** - ⭐ 14
...
3887. **[MCPScan](https://github.com/sahiloj/MCPScan)** - ⭐ 14
...
3888. **[toolhive-registry-server](https://github.com/stacklok/toolhive-registry-server)** - ⭐ 14
...
3889. **[amazon-seller-mcp](https://github.com/enginterzi/amazon-seller-mcp)** - ⭐ 14
...
3890. **[KunAvatar](https://github.com/KunLabAI/KunAvatar)** - ⭐ 14
...
3891. **[signoz-mcp-server](https://github.com/DrDroidLab/signoz-mcp-server)** - ⭐ 14
   Connect your Signoz Instance with Cursor, Claude Desktop or any other MCP Compatible Client

3892. **[plumcp](https://github.com/plumce/plumcp)** - ⭐ 14
   Clojure/ClojureScript library for making MCP server and client

3893. **[Rube](https://github.com/dorucioclea/Rube)** - ⭐ 14
   Rube is a Model Context Protocol (MCP) server that connects your AI tools to 500+ apps like Gmail, Slack, GitHub, and Notion. Simply install it in your AI client, authenticate once with your apps, and start asking your AI to perform real actions like "Send an email" or "Create a task."

3894. **[mcphawk](https://github.com/tech4242/mcphawk)** - ⭐ 14
...
3895. **[ckan-mcp-server](https://github.com/ondics/ckan-mcp-server)** - ⭐ 14
...
3896. **[java-xiaohongshu-mcp](https://github.com/bzlrj/java-xiaohongshu-mcp)** - ⭐ 14
   Java 实现的小红书 Model Context Protocol (MCP) 工具服务  为 AI Agent / MCP Client 提供标准化接口，实现： 登录、发图文、发视频、搜索、评论、推荐内容、用户主页 等核心功能

3897. **[SRE-agent](https://github.com/martinimarcello00/SRE-agent)** - ⭐ 14
...
3898. **[mcp-add](https://github.com/paoloricciuti/mcp-add)** - ⭐ 14
   Universal cli to add an MCP server to a variety of clients

3899. **[mendeley-mcp](https://github.com/pallaprolus/mendeley-mcp)** - ⭐ 14
...
3903. **[llmqore](https://github.com/Palm1r/llmqore)** - ⭐ 14
   Qt C++ library for working with AI/LLM Providers and MCP

3904. **[mcp-client-compatibility](https://github.com/tadata-org/mcp-client-compatibility)** - ⭐ 13

3905. **[nest-mcp](https://github.com/btwld/nest-mcp)** - ⭐ 13
   Build Model Context Protocol (MCP) servers, clients, and gateways using the NestJS ecosystem you already know.

3906. **[spring-ai-mcp-deepseek](https://github.com/firefly0512/spring-ai-mcp-deepseek)** - ⭐ 13
   使用 Spring AI 整合 MCP 服务，包括 MCP server 和 deepseek client

3907. **[llamacppMCPClientDemo](https://github.com/brucepro/llamacppMCPClientDemo)** - ⭐ 13
   standalone react MCP client using SSE

3908. **[sample-multi-tenant-saas-mcp-server](https://github.com/aws-samples/sample-multi-tenant-saas-mcp-server)** - ⭐ 13
   Multi-Tenant remote MCP server with Amazon Cognito and remote client with Amazon Bedrock hosted on AWS

3909. **[mcp-chat-client](https://github.com/Ceeon/mcp-chat-client)** - ⭐ 13
   基于高德地图MCP服务的聊天客户端

3910. **[mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel)** - ⭐ 13
...
3911. **[mcp-more](https://github.com/toosean/mcp-more)** - ⭐ 13
   A modern desktop application for managing Model Context Protocol (MCP) servers.

3912. **[easy-mcp-use](https://github.com/dforel/easy-mcp-use)** - ⭐ 13
...
3913. **[mcp-test-client](https://github.com/crazyrabbitLTC/mcp-test-client)** - ⭐ 13
   MCP Test Client is a TypeScript testing utility for Model Context Protocol (MCP) servers.

3914. **[mongo-mcp](https://github.com/1RB/mongo-mcp)** - ⭐ 13
   MCP server that provide tools to LLMs such as claude in cursor to interact with MongoDB

3915. **[memory-mcp-server](https://github.com/hpkv-io/memory-mcp-server)** - ⭐ 13
   A MCP (Model Context Protocol) server providing long-term memory for LLMs

3916. **[mcp-web-search-tool](https://github.com/gabrimatic/mcp-web-search-tool)** - ⭐ 13
   A MCP server providing real-time web search capabilities to any AI model.

3917. **[prompt-engineer-mcp-server](https://github.com/hireshBrem/prompt-engineer-mcp-server)** - ⭐ 13
   Write 10x better prompts using Prompt Engineer MCP server.

3918. **[google-mcp-remote](https://github.com/vakharwalad23/google-mcp-remote)** - ⭐ 13
   Collection of Google-native tools (e.g., Gmail, Calendar) for the MCP

3919. **[mcp_review_code_tool](https://github.com/wenkil/mcp_review_code_tool)** - ⭐ 13
...
3920. **[sherpa](https://github.com/CartographAI/sherpa)** - ⭐ 13
   Chat with any codebase with MCP servers in a single command

3921. **[codepilot](https://github.com/rohittcodes/codepilot)** - ⭐ 13
   A multi-agent CLI tool powered by Swarms-rs and Composio

3922. **[openwebui-mcp-setup](https://github.com/sonzentherevolution/openwebui-mcp-setup)** - ⭐ 13
...
3923. **[mcp-meme-sticky](https://github.com/nkapila6/mcp-meme-sticky)** - ⭐ 13
...
3924. **[AgentStack](https://github.com/ssdeanx/AgentStack)** - ⭐ 13
...
3930. **[taiga-ui-mcp](https://github.com/taiga-family/taiga-ui-mcp)** - ⭐ 13
   Taiga UI MCP server providing documentation search and scaffolding tools.

3931. **[owl-mcp](https://github.com/ai4curation/owl-mcp)** - ⭐ 13
   MCP server for OWL applications

3932. **[mcp-delphi](https://github.com/flydev-fr/mcp-delphi)** - ⭐ 13
   Delphi and Lazarus/FPC MCP server: build/clean pascal projects via MCP tools.

3933. **[mcp-server-weather-js](https://github.com/hideya/mcp-server-weather-js)** - ⭐ 13
   Simple Weather MCP Server Example

3934. **[inspector](https://github.com/mcp-use/inspector)** - ⭐ 13
   Modern MCP Inspector for remote mcp servers with support for Apps SDK

3935. **[istek](https://github.com/istekapp/istek)** - ⭐ 13
   The API client built for AI agents. HTTP, GraphQL, gRPC, WebSocket, MQTT + MCP."

3936. **[mcp-server-template](https://github.com/BearHuddleston/mcp-server-template)** - ⭐ 13
   Spec-driven Go MCP server template for building domain MCPs with AI-agent onboarding.

3937. **[obsidian-mcp-server](https://github.com/smith-and-web/obsidian-mcp-server)** - ⭐ 13
   MCP server for Obsidian vault management - enables Claude and other AI assistants to read, write, search, and organize your notes

3938. **[llama-nexus](https://github.com/LlamaEdge/llama-nexus)** - ⭐ 13
   A gateway service designed to manage and orchestrate OpenAI-compatible API servers with MCP support.

3939. **[claude-tools-mcp](https://github.com/mathematic-inc/claude-tools-mcp)** - ⭐ 13
...
3940. **[sift-gateway](https://github.com/lourencomaciel/sift-gateway)** - ⭐ 13
   Reliability gateway for AI tool output: schema-stable, secret-safe, pagination-complete JSON for MCP and CLI agents.

3941. **[temple-bridge](https://github.com/templetwo/temple-bridge)** - ⭐ 13
...
3942. **[lm](https://github.com/houtini-ai/lm)** - ⭐ 13
...
3943. **[Tinvo](https://github.com/imxcstar/Tinvo)** - ⭐ 13
   LLM AI Client based on Blazor. (openai, chatgpt, llama, ollama, onnx, deepseekr1...)

3944. **[cie](https://github.com/kraklabs/cie)** - ⭐ 13
...
3945. **[claude-faf-mcp](https://github.com/Wolfe-Jam/claude-faf-mcp)** - ⭐ 13
   Anthropic MCP server for .faf — 33 tools, IANA-registered format. npm: claude-faf-mcp. MCP Registry #2759

3946. **[credit-optimizer-v5](https://github.com/rafsilva85/credit-optimizer-v5)** - ⭐ 13
...
3947. **[n8n-coolify-mcp-tools](https://github.com/wrediam/n8n-coolify-mcp-tools)** - ⭐ 13
...
3948. **[mcp-client-langchain-ts](https://github.com/hideya/mcp-client-langchain-ts)** - ⭐ 13
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / TypeScript

3949. **[GitLab-CICD-Agent](https://github.com/shalwin04/GitLab-CICD-Agent)** - ⭐ 13
...
3950. **[ex_mcp](https://github.com/azmaveth/ex_mcp)** - ⭐ 13
   Model Context Protocol (MCP) and Agent Client Protocol (ACP) client/server library for Elixir

3951. **[webmcp-sh](https://github.com/WebMCP-org/webmcp-sh)** - ⭐ 13
   A modern web-based Model Context Protocol (MCP) playground for testing and developing MCP servers and clients

3952. **[openalgo-mcp](https://github.com/marketcalls/openalgo-mcp)** - ⭐ 13
   Documentation

3953. **[agent-hub](https://github.com/nathangtg/agent-hub)** - ⭐ 13
...
3954. **[Cortex](https://github.com/cdeust/Cortex)** - ⭐ 13
   C.O.R.T.E.X. — Cognitive profiling system for Claude Code

3955. **[docdex](https://github.com/bekirdag/docdex)** - ⭐ 13
   A document index with MCP, http and client support. https://docdex.org/ 

3956. **[claude-qdrant-mcp](https://github.com/marlian/claude-qdrant-mcp)** - ⭐ 13
   Local-first TypeScript MCP server for Qdrant with client isolation, LM Studio integration, and scalable document workflows.

3957. **[magento-coding-standard-mcp](https://github.com/Midhun-edv/magento-coding-standard-mcp)** - ⭐ 13
...
3958. **[brightspace-mcp-server](https://github.com/RohanMuppa/brightspace-mcp-server)** - ⭐ 13
...
3964. **[proxy-base-agent](https://github.com/TheProxyCompany/proxy-base-agent)** - ⭐ 12
   A stateful agent with 100% reliable tool use. Build custom agents on any LLM with guaranteed state consistency.

3965. **[create-mcp-server-kit](https://github.com/Epi-1120/create-mcp-server-kit)** - ⭐ 12
   Scaffold a production-ready Model Context Protocol (MCP) server in seconds.

3966. **[MIST](https://github.com/CLoaKY233/MIST)** - ⭐ 12
...
3967. **[PackageFlow](https://github.com/runkids/PackageFlow)** - ⭐ 12
   A visual DevOps hub for npm scripts, Git, workflows, and deploy — controllable by AI via MCP.

3968. **[SQL_MCP_Server](https://github.com/pawankumar94/SQL_MCP_Server)** - ⭐ 12
...
3969. **[nestjs-mcp](https://github.com/orbit-codes/nestjs-mcp)** - ⭐ 12
   An opinionated MCP module for NestJS

3970. **[snowflake-mcp-server](https://github.com/dynamike/snowflake-mcp-server)** - ⭐ 12
   MCP Server for connecting to Snowflake with read-only questions

3971. **[mcp-server-kintone](https://github.com/macrat/mcp-server-kintone)** - ⭐ 12
   MCP server for kintone

3972. **[mcp-server-webscan](https://github.com/bsmi021/mcp-server-webscan)** - ⭐ 12
   A Model Context Protocol (MCP) server for web content scanning and analysis. This server provides tools for fetching, analyzing, and extracting information from web pages.

3973. **[agent-identity-protocol](https://github.com/ArangoGutierrez/agent-identity-protocol)** - ⭐ 12
   Agent Identity Protocol - Zero-trust security layer for AI agents. Policy enforcement proxy for MCP with Human-in-the-Loop approval, DLP scanning, and audit logging.

3974. **[_b00t_](https://github.com/elasticdotventures/_b00t_)** - ⭐ 12
   🥾 _b00t_:  state of the art agentic harness tooling & dynamic context initialization

3975. **[jenkins-mcp-server](https://github.com/AshwiniGhuge3012/jenkins-mcp-server)** - ⭐ 12
...
3976. **[openagentidentityprotocol](https://github.com/openagentidentityprotocol/openagentidentityprotocol)** - ⭐ 12
   Agent Identity Protocol - Zero-trust security layer for AI agents. Policy enforcement proxy for MCP with Human-in-the-Loop approval, DLP scanning, and audit logging.

3977. **[cv-resume-builder-mcp](https://github.com/eyaab/cv-resume-builder-mcp)** - ⭐ 12
...
3978. **[MCPGateway](https://github.com/abdullah1854/MCPGateway)** - ⭐ 12
   Open-source MCP server — progressive tool discovery, code execution, intelligent routing & token optimization across 50+ tools

3979. **[mcp-interactive-terminal](https://github.com/amol21p/mcp-interactive-terminal)** - ⭐ 12
...
3980. **[kiro-powers](https://github.com/praveenc/kiro-powers)** - ⭐ 12
   Repository of custom kiro powers. https://kiro.dev/docs/powers/

3981. **[guildbridge](https://github.com/dend/guildbridge)** - ⭐ 12
   🏰 Remotely hosted MCP server for Discord

3982. **[porkbun-mcp-server](https://github.com/miraclebakelaser/porkbun-mcp-server)** - ⭐ 12
   MCP server implementation for managing domains, DNS, and SSL via the Porkbun API.

3983. **[local-history-mcp](https://github.com/xxczaki/local-history-mcp)** - ⭐ 12
   MCP server for accessing VS Code/Cursor's Local History

3984. **[claude-context-local](https://github.com/MikeO-AI/claude-context-local)** - ⭐ 12
...
3985. **[biomed-agent](https://github.com/nickzren/biomed-agent)** - ⭐ 12
   Connecting AI agent to biomedical data

3986. **[nodebench-ai](https://github.com/HomenShum/nodebench-ai)** - ⭐ 12
...
3987. **[mcp-for-woocommerce](https://github.com/iOSDevSK/mcp-for-woocommerce)** - ⭐ 12
...
3988. **[asap-protocol](https://github.com/adriannoes/asap-protocol)** - ⭐ 12
...
3989. **[scorable-mcp](https://github.com/root-signals/scorable-mcp)** - ⭐ 12
   MCP for Scorable Evaluation Platform

3990. **[Hoofy](https://github.com/HendryAvila/Hoofy)** - ⭐ 12
...
3991. **[wamcp](https://github.com/delltrak/wamcp)** - ⭐ 12
...
3992. **[actual-mcp-server](https://github.com/agigante80/actual-mcp-server)** - ⭐ 12
...
3993. **[bookmark-manager-mcp](https://github.com/infinitepi-io/bookmark-manager-mcp)** - ⭐ 12
...
3994. **[mcp-client-langchain-py](https://github.com/hideya/mcp-client-langchain-py)** - ⭐ 12
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / Python

3995. **[ggMCP4VSCode](https://github.com/n2ns/ggMCP4VSCode)** - ⭐ 12
   Google Gemini Model Context Protocol (MCP) Client for VS Code. Connect AI assistants to local context & tools.

3996. **[langchain-mcp-tools-ts-usage](https://github.com/hideya/langchain-mcp-tools-ts-usage)** - ⭐ 12
   MCP Tools Usage From LangChain ReAct Agent / Example in TypeScript

3997. **[XcodeMCPKit](https://github.com/lynnswap/XcodeMCPKit)** - ⭐ 12
   Xcode MCP proxy with multi-client sessions

3998. **[langgraph-mcp-dataanalysis](https://github.com/gongwon-nayeon/langgraph-mcp-dataanalysis)** - ⭐ 12
   DataAnalysis Agent using LangGraph & MCP server and client

3999. **[mcp-chat-widget](https://github.com/aimdoc-ai/mcp-chat-widget)** - ⭐ 12
...
4000. **[mcpup](https://github.com/mohammedsamin/mcpup)** - ⭐ 12
   MCP configuration manager — enable, disable, and sync MCP servers across AI clients from one place

4001. **[vibeshell](https://github.com/veithly/vibeshell)** - ⭐ 12
...
4002. **[Opencollab-mcp](https://github.com/prakhar1605/Opencollab-mcp)** - ⭐ 12
   AI-powered open source contribution matchmaker — finds perfect "good first issues" matched to YOUR skills

4003. **[openclaw-mcp-server](https://github.com/Helms-AI/openclaw-mcp-server)** - ⭐ 12
   MCP server exposing OpenClaw Gateway tools to Claude Code and other MCP-compatible clients

4004. **[mcp-trace](https://github.com/zabirauf/mcp-trace)** - ⭐ 12
   A TUI to probe the calls between MCP client and server

4005. **[salesforce-mcp-lib](https://github.com/Damecek/salesforce-mcp-lib)** - ⭐ 12
...
4006. **[Ai-doctor](https://github.com/Jevon-Zhong/Ai-doctor)** - ⭐ 12
...
4007. **[openclaw-mcp-bridge](https://github.com/AIWerk/openclaw-mcp-bridge)** - ⭐ 12
   OpenClaw MCP Client Plugin - bridges MCP servers into OpenClaw via registerTool

4008. **[md2confluence-mcp](https://github.com/Gyeom/md2confluence-mcp)** - ⭐ 11
   MCP server to upload Markdown to Confluence. Auto-converts Mermaid diagrams, code blocks, images, and tables.

4009. **[swift-context-protocol](https://github.com/1amageek/swift-context-protocol)** - ⭐ 11
...
4010. **[context-kit](https://github.com/eyalzh/context-kit)** - ⭐ 11
   A CLI tool and MCP client, used to create spec files for AI coding agents with context baked in

4011. **[MCP_Client](https://github.com/andrewdeng318/MCP_Client)** - ⭐ 11

4012. **[trebuchet](https://github.com/fuzzball-muck/trebuchet)** - ⭐ 11
   A MUD/MUCK/MUSH chat client with MCP/GUI support.

4013. **[systemprompt-mcp-gmail](https://github.com/Ejb503/systemprompt-mcp-gmail)** - ⭐ 11
...
4014. **[mcp-client-app](https://github.com/RegiByte/mcp-client-app)** - ⭐ 11
   A mcp client chat application built for learning purposes

4015. **[mcp-browser-automation](https://github.com/hrmeetsingh/mcp-browser-automation)** - ⭐ 11
   Model Context Protocol based AI Agent that runs a browser from Claude desktop

4016. **[simple-nodejs-mcp-client](https://github.com/sawa-zen/simple-nodejs-mcp-client)** - ⭐ 11
...
4017. **[oauth-callback](https://github.com/kriasoft/oauth-callback)** - ⭐ 11
   Lightweight OAuth 2.0 authorization code capture for CLI tools & desktop   apps. Works with Node.js, Deno, Bun. MCP SDK ready.

4018. **[semantictool](https://github.com/promptmesh/semantictool)** - ⭐ 11
   tool management service for performing vector tool calling at scale.

4019. **[mcpconnect](https://github.com/rocket-connect/mcpconnect)** - ⭐ 11
   Inspect and debug Model Context Protocol servers directly in your browser.

4020. **[locust-mcp-server](https://github.com/QAInsights/locust-mcp-server)** - ⭐ 11
   A Model Context Protocol (MCP) server implementation for running Locust load tests. This server enables seamless integration of Locust load testing capabilities with AI-powered development environments.

4021. **[mcp-boilerplate](https://github.com/iamsrikanthnani/mcp-boilerplate)** - ⭐ 11
...
4022. **[emcp](https://github.com/joeymeere/emcp)** - ⭐ 11
   A framework for building simple MCP servers with custom middleware

4023. **[polaris](https://github.com/octu0/polaris)** - ⭐ 11
   Distributed AI Agent Framework

4024. **[glm5-mcp](https://github.com/Arkya-AI/glm5-mcp)** - ⭐ 11
...
4025. **[french-tax-mcp](https://github.com/cornelcroi/french-tax-mcp)** - ⭐ 11
   MCP server for French tax calculations and information - enables AI assistants to provide accurate French tax guidance

4026. **[springboot-ai-mcp-example](https://github.com/duongminhhieu/springboot-ai-mcp-example)** - ⭐ 11
   Example Spring AI Model Context Protocol (MCP)

4027. **[mcp-space](https://github.com/tharuneshwar-s/mcp-space)** - ⭐ 11
...
4028. **[druid-mcp-server](https://github.com/iunera/druid-mcp-server)** - ⭐ 11
...
4029. **[mcpkit](https://github.com/cybertheory/mcpkit)** - ⭐ 11
   Easy to use Official MCP Registry Client UI. npx @cybertheory/mcpkit

4030. **[robotmcp_client](https://github.com/robotmcp/robotmcp_client)** - ⭐ 11
   Connect AI models like Claude & GPT with robots using MCP and ROS.

4031. **[prometheus-protocol](https://github.com/prometheus-protocol/prometheus-protocol)** - ⭐ 11
...
4038. **[miro-mcp-server](https://github.com/olgasafonova/miro-mcp-server)** - ⭐ 11
   MCP server for controlling Miro whiteboards with AI assistants

4039. **[qurio](https://github.com/irahardianto/qurio)** - ⭐ 11
...
4040. **[fathom-mcp](https://github.com/Dot-Fun/fathom-mcp)** - ⭐ 11
   Model Context Protocol server for Fathom AI - access meeting recordings, transcripts, summaries, teams, and webhooks

4041. **[auto-mcp-client](https://github.com/down-to-earth1994/auto-mcp-client)** - ⭐ 11
...
4042. **[unity-mcp-template](https://github.com/dunward/unity-mcp-template)** - ⭐ 11
   Simple template project for controlling Unity via MCP

4043. **[keycloak-mcp](https://github.com/HaithamOumerzoug/keycloak-mcp)** - ⭐ 11
...
4044. **[AMS](https://github.com/LastEld/AMS)** - ⭐ 11
   Audit Memory System (AMS): Durable orchestration and memory layer for MCP clients.

4045. **[mcp_client_rust](https://github.com/darinkishore/mcp_client_rust)** - ⭐ 11

4046. **[mcp-oidc-provider](https://github.com/tigrisdata/mcp-oidc-provider)** - ⭐ 11
...
4052. **[ux-mcp-server](https://github.com/elsahafy/ux-mcp-server)** - ⭐ 11
...
4053. **[mcp-optimizer](https://github.com/StacklokLabs/mcp-optimizer)** - ⭐ 11
   MCP server that acts as an intelligent intermediary between AI clients and multiple MCP servers

4054. **[llmcore](https://github.com/Palm1r/llmcore)** - ⭐ 11
   Qt C++ library for working with AI/LLM Providers and MCP

4055. **[mcp-shopline](https://github.com/asgard-ai-platform/mcp-shopline)** - ⭐ 11
...
4056. **[AIFoundry-MCPConnector-FabricGraphQL](https://github.com/LazaUK/AIFoundry-MCPConnector-FabricGraphQL)** - ⭐ 11
...
4057. **[mcp-client](https://github.com/EuclideanAI/mcp-client)** - ⭐ 10
...
4058. **[kroki-mcp](https://github.com/utain/kroki-mcp)** - ⭐ 10
...
4059. **[mcp-wikipedia](https://github.com/algonacci/mcp-wikipedia)** - ⭐ 10
   MCP server to give client the ability to access Wikipedia pages

4060. **[taskboard](https://github.com/tcarac/taskboard)** - ⭐ 10
...
4061. **[langchain-mcp-client](https://github.com/datalayer/langchain-mcp-client)** - ⭐ 10
   🦜🔗 LangChain Model Context Protocol (MCP) Client

4062. **[mcp_client_openai](https://github.com/liangpn/mcp_client_openai)** - ⭐ 10
   适配Openai SDK构建MCP Client

4063. **[mcp-serverman](https://github.com/benhaotang/mcp-serverman)** - ⭐ 10
   a cli/mcp server tool for managing mcp server json config file with version control, profiles and multi-client support

4064. **[py-mcp-sse](https://github.com/jayliangdl/py-mcp-sse)** - ⭐ 10
   MCP Client 与 MCP Server基于SSE方式的样例实现（Python版本）

4065. **[emotion_ai](https://github.com/angrysky56/emotion_ai)** - ⭐ 10
...
4066. **[mcp-server-blog](https://github.com/portal-labs-infrastructure/mcp-server-blog)** - ⭐ 10
   Example of a MCP implementation using TypeScript and OAuth.

4067. **[mcp-agent-proxy](https://github.com/mashh-lab/mcp-agent-proxy)** - ⭐ 10
   An MCP server that exposes local and remote agents across different servers as MCP tools.

4068. **[mcp-kit](https://github.com/shaharia-lab/mcp-kit)** - ⭐ 10
   MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

4069. **[CodeCompass](https://github.com/alvinveroy/CodeCompass)** - ⭐ 10
...
4070. **[mode-manager-mcp](https://github.com/NiclasOlofsson/mode-manager-mcp)** - ⭐ 10
   MCP Memory Agent Server - A VS Code chatmode and instruction manager with library integration

4071. **[mcp-reporter](https://github.com/cyanheads/mcp-reporter)** - ⭐ 10
...
4072. **[mcp-starter-template-ts](https://github.com/onamfc/mcp-starter-template-ts)** - ⭐ 10
...
4073. **[rec-us-mcp-server](https://github.com/elizabethsiegle/rec-us-mcp-server)** - ⭐ 10
   Book a San Francisco tennis court via MCP server w/ auth

4074. **[mcp-demo](https://github.com/sshh12/mcp-demo)** - ⭐ 10
...
4075. **[AgentX-mcp-servers](https://github.com/AgentX-ai/AgentX-mcp-servers)** - ⭐ 10
   List of open sourced MCP servers. MIT license. Managed by AgentX with love.

4076. **[mcp-tradovate](https://github.com/0xjmp/mcp-tradovate)** - ⭐ 10
   MCP server for the Tradovate platform

4077. **[mcp-claude-hackernews](https://github.com/imprvhub/mcp-claude-hackernews)** - ⭐ 10
   An integration that allows Claude Desktop to interact with Hacker News using the Model Context Protocol (MCP).

4078. **[glasses-mcp](https://github.com/gourraguis/glasses-mcp)** - ⭐ 10
   Glasses MCP is a simple MCP server that lets your AI agent see and capture the web 👓

4079. **[ObsidianMCPServer](https://github.com/otaviocc/ObsidianMCPServer)** - ⭐ 10
   A Model Context Protocol (MCP) server that enables AI assistants to interact with your Obsidian vault 

4080. **[mcp-sys-bridge](https://github.com/leynier/mcp-sys-bridge)** - ⭐ 10
...
4081. **[sec-edgar-agentkit](https://github.com/stefanoamorelli/sec-edgar-agentkit)** - ⭐ 10
...
4082. **[context-engineering-mcp](https://github.com/bralca/context-engineering-mcp)** - ⭐ 10
...
4083. **[mcp-sqlite-server](https://github.com/prayanks/mcp-sqlite-server)** - ⭐ 10
...
4084. **[mcp-go](https://github.com/XiaoConstantine/mcp-go)** - ⭐ 10
   Golang impl of mcp protocol

4085. **[mcpet](https://github.com/shreyaskarnik/mcpet)** - ⭐ 10
...
4086. **[miniflux-mcp](https://github.com/tssujt/miniflux-mcp)** - ⭐ 10
   A Model Context Protocol (MCP) server for interacting with Miniflux RSS reader.

4087. **[mcp-spring-ai-mcp-client](https://github.com/chaozai0304/mcp-spring-ai-mcp-client)** - ⭐ 10
   使用java实现mcp client了解底层的调用机制，demo示例

4088. **[awesome-mcp](https://github.com/timunbasah3/awesome-mcp)** - ⭐ 10
...
4089. **[Simple_MCP_Client](https://github.com/Avento/Simple_MCP_Client)** - ⭐ 10
   Simple MCP Client for OpenAI/Deepseek R1/V3

4090. **[awesome-mcp](https://github.com/gauravfs-14/awesome-mcp)** - ⭐ 10
...
4091. **[openapi-mcp-swagger](https://github.com/salacoste/openapi-mcp-swagger)** - ⭐ 10
...
4092. **[mcp-chaos-rig](https://github.com/Typewise/mcp-chaos-rig)** - ⭐ 10
...
4098. **[Azure-Foundry-Webinar](https://github.com/ShivamGoyal03/Azure-Foundry-Webinar)** - ⭐ 10
...
4099. **[Cognio](https://github.com/0xReLogic/Cognio)** - ⭐ 10
...
4100. **[systemprompt-template](https://github.com/systempromptio/systemprompt-template)** - ⭐ 10
   Production AI agent mesh in 3 commands. MCP servers, playbooks, and multi-agent orchestration built on systemprompt-core.

4101. **[cheatengine-mcp-bridge](https://github.com/beamstar/cheatengine-mcp-bridge)** - ⭐ 10
   🔗 Connect AI to Cheat Engine for fast memory analysis, enabling quick mods and audits without the tedious manual work.

4102. **[toolhive-cloud-ui](https://github.com/stacklok/toolhive-cloud-ui)** - ⭐ 10
...
4103. **[mcpd](https://github.com/pouriya/mcpd)** - ⭐ 10
   A ~3MB MCP daemon that exposes any script as a tool for Claude, Cursor & AI assistants

4104. **[whatsapp-mcp-extended](https://github.com/FelixIsaac/whatsapp-mcp-extended)** - ⭐ 10
...
4105. **[chessmata](https://github.com/jonradoff/chessmata)** - ⭐ 10
   Chessmata: chess game for humans and AI agents

4106. **[storybook-mcp-server](https://github.com/stefanoamorelli/storybook-mcp-server)** - ⭐ 10
...
4107. **[dbt-core-mcp](https://github.com/NiclasOlofsson/dbt-core-mcp)** - ⭐ 10
   dbt Core MCP Server: Interact with dbt projects via Model Context Protocol

4108. **[chatgpt2md](https://github.com/NextStat/chatgpt2md)** - ⭐ 10
   Convert ChatGPT export to Markdown with full-text search and MCP server for Claude

4109. **[mini_claude](https://github.com/20alexl/mini_claude)** - ⭐ 10
...
4110. **[statelessagent](https://github.com/sgx-labs/statelessagent)** - ⭐ 10
   Your AI forgets everything between sessions. SAME fixes that. Local-first, no API keys, single binary.

4111. **[MCP-Penetration-testing](https://github.com/Mr-Infect/MCP-Penetration-testing)** - ⭐ 10
...
4112. **[caltrain-mcp](https://github.com/davidyen1124/caltrain-mcp)** - ⭐ 10
...
4113. **[shellguard](https://github.com/fawdyinc/shellguard)** - ⭐ 10
   MCP server that gives LLM agents read-only shell access over SSH

4114. **[PsMCP-MCP-Server-for-Photoshop](https://github.com/Chandrahas455/PsMCP-MCP-Server-for-Photoshop)** - ⭐ 10
...
4115. **[ollama-mcp-example](https://github.com/kirillsaidov/ollama-mcp-example)** - ⭐ 10
   Ollama MCP example for dummies. 

4116. **[civitai-mcp-server](https://github.com/Cicatriiz/civitai-mcp-server)** - ⭐ 10
   A Model Context Protocol server for browsing and discovering AI models on Civitai

4117. **[openapi-to-mcp](https://github.com/agentic-community/openapi-to-mcp)** - ⭐ 10
...
4118. **[world-intel-mcp](https://github.com/marc-shade/world-intel-mcp)** - ⭐ 10
...
4119. **[ILSpy-Mcp](https://github.com/bivex/ILSpy-Mcp)** - ⭐ 10
...
4120. **[aichat](https://github.com/Hayashi-Yudai/aichat)** - ⭐ 10
   A customizable AI chat application powered by Flet.

4121. **[mcp-document-converter](https://github.com/xt765/mcp-document-converter)** - ⭐ 10
...
4122. **[mcpHTTPClient](https://github.com/matlab-deep-learning/mcpHTTPClient)** - ⭐ 10
   An MCP client in pure MATLAB code

4123. **[DevoChat](https://github.com/gws8820/DevoChat)** - ⭐ 10
   Unified Web AI Chat UI & MCP Client

4124. **[simple-mcp-server](https://github.com/dataworkshop/simple-mcp-server)** - ⭐ 10
...
4125. **[cubbi](https://github.com/Monadical-SAS/cubbi)** - ⭐ 10
   Monadical container CLI tool for running sandboxed MCP clients & servers

4126. **[team-memory-mcp](https://github.com/gustavolira/team-memory-mcp)** - ⭐ 10
...
4127. **[ai-assistant-vui](https://github.com/mgoltzsche/ai-assistant-vui)** - ⭐ 10
   Experimental voice user interface (VUI) to interact with an agentic AI assistant

4128. **[mcp-client](https://github.com/CopilotKit/mcp-client)** - ⭐ 10

4129. **[tupac](https://github.com/tkellogg/tupac)** - ⭐ 10
   A terminal MCP client based on the OpenAI responses API.

4130. **[vault-sync](https://github.com/alexjbarnes/vault-sync)** - ⭐ 10
   Headless Obsidian Sync client with MCP server for AI assistants

4131. **[bio-agents-mcp](https://github.com/dogeplusplus/bio-agents-mcp)** - ⭐ 10
   MCP servers for Protein Data Bank, ChemBL, and other life science data (WIP), with Ollama client for local testing.

4132. **[ai-mcp-bridge](https://github.com/xiaozhug/ai-mcp-bridge)** - ⭐ 10
   rest to mcp & mcp Registry & mcp Loadbalancer & ai mcp & Multiple Registries & 多注册中心 

4133. **[cli](https://github.com/inboxapi/cli)** - ⭐ 10
   🤖 Your Agents' personal email 📧  

4134. **[league-client-mcp](https://github.com/rumi-chan/league-client-mcp)** - ⭐ 10
   Connect Claude, Antigravity to League Client via MCP & Pengu Loader.

4135. **[mcp-shell](https://github.com/Prat011/mcp-shell)** - ⭐ 10
   terminal based MCP Client 

4136. **[mcp-google-calendar](https://github.com/guinacio/mcp-google-calendar)** - ⭐ 10
...
4137. **[discogs-mcp](https://github.com/rianvdm/discogs-mcp)** - ⭐ 10
...
4138. **[mcp-dashboards](https://github.com/KyuRish/mcp-dashboards)** - ⭐ 10
   Turn your data into interactive dashboards inside any AI client - MCP Apps powered

4139. **[capacities-mcp-bridge-unofficial](https://github.com/natkitten/capacities-mcp-bridge-unofficial)** - ⭐ 10
   Unofficial MCP tools and bridges for Capacities.io, for use with Claude Desktop, Genspark, and other clients.

4140. **[local-voice-mcp](https://github.com/CodeCraftersLLC/local-voice-mcp)** - ⭐ 10
   Give your MCP clients the ability to speak by running local voice models

4141. **[mcpmate](https://github.com/loocor/mcpmate)** - ⭐ 10
...
4142. **[mcp-bibliotheque_nationale_de_France](https://github.com/Kryzo/mcp-bibliotheque_nationale_de_France)** - ⭐ 10
...
4143. **[pipulate](https://github.com/pipulate/pipulate)** - ⭐ 10
   Local First AI SEO Software on Nix, FastHTML & HTMX

4144. **[kiro-professional-toolkit](https://github.com/gkhantyln/kiro-professional-toolkit)** - ⭐ 10
...
1. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 45,435
   LocalAI is the open-source AI engine. Run any model - LLMs, vision, voice, image, video - on any hardware. No GPU required.

2. **[CowAgent](https://github.com/zhayujie/CowAgent)** - ⭐ 43,284
...
4. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 10,349
   ValueCell is a community-driven, multi-agent platform for financial applications.

5. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,675
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

6. **[magic](https://github.com/dtyq/magic)** - ⭐ 4,752
...
7. **[koog](https://github.com/JetBrains/koog)** - ⭐ 4,071
...
8. **[shippie](https://github.com/mattzcarey/shippie)** - ⭐ 2,347
   extendable code review and QA agent 🚢

9. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,262
...
10. **[nono](https://github.com/always-further/nono)** - ⭐ 1,932
...
11. **[supermemory-mcp](https://github.com/supermemoryai/supermemory-mcp)** - ⭐ 1,678
   Your memories are in ChatGPT... But nowhere else. Universal Memory MCP makes your memories available to every single LLM. No logins or paywall. One command to set it up.

12. **[open-mcp-client](https://github.com/CopilotKit/open-mcp-client)** - ⭐ 1,641

13. **[ragent](https://github.com/nageoffer/ragent)** - ⭐ 1,544
   企业级 Agentic RAG 智能体 - 全链路覆盖文档解析、多路检索、意图识别、问题重写、会话记忆、MCP 工具调用与深度思考。面向真实业务场景，从 0 到 1 完整工程实现。

14. **[openinference](https://github.com/Arize-ai/openinference)** - ⭐ 922
   OpenTelemetry Instrumentation for AI Observability

15. **[VectorCode](https://github.com/Davidyz/VectorCode)** - ⭐ 850
   A code repository indexing tool to supercharge your LLM experience.

16. **[HyperChat](https://github.com/BigSweetPotatoStudio/HyperChat)** - ⭐ 712
   HyperChat is a Chat client that strives for openness, utilizing APIs from various LLMs to achieve the best Chat experience, as well as implementing productivity tools through the MCP protocol.

17. **[GalwayBus](https://github.com/joreilly/GalwayBus)** - ⭐ 582
   Galway Bus Kotlin Multiplatform project using Jetpack Compose and SwiftUI 

18. **[casbin-gateway](https://github.com/apache/casbin-gateway)** - ⭐ 557
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

19. **[comunica](https://github.com/comunica/comunica)** - ⭐ 549
   📬 A knowledge graph querying framework for JavaScript

20. **[fleur](https://github.com/fleuristes/fleur)** - ⭐ 534
   The easiest way to discover and install MCPs

21. **[a2a-x402](https://github.com/google-agentic-commerce/a2a-x402)** - ⭐ 485
   The A2A x402 Extension brings cryptocurrency payments to the Agent-to-Agent (A2A) protocol, enabling agents to monetize their services through on-chain payments. This extension revives the spirit of HTTP 402 "Payment Required" for the decentralized agent ecosystem.

22. **[self-dify](https://github.com/datawhalechina/self-dify)** - ⭐ 408
...
23. **[pwno-mcp](https://github.com/pwno-io/pwno-mcp)** - ⭐ 244
   MCP for Pwn

24. **[openclaw.net](https://github.com/clawdotnet/openclaw.net)** - ⭐ 243
   Self-hosted OpenClaw gateway + agent runtime in .NET (NativeAOT-friendly)

25. **[mangaba_ai](https://github.com/Mangaba-ai/mangaba_ai)** - ⭐ 191
...
26. **[ai](https://github.com/WordPress/ai)** - ⭐ 177
   AI features and experiments for WordPress. Modular framework for testing AI capabilities.

27. **[terminal-ai](https://github.com/dwmkerr/terminal-ai)** - ⭐ 158
...
28. **[web-hacker](https://github.com/VectorlyApp/web-hacker)** - ⭐ 153
   Reverse engineer web apps

29. **[airbyte-agent-connectors](https://github.com/airbytehq/airbyte-agent-connectors)** - ⭐ 109
   🐙 Drop-in tools that give AI agents reliable, permission-aware access to external systems.

30. **[uxc](https://github.com/holon-run/uxc)** - ⭐ 102
   A unified CLI for discovering and invoking tools across OpenAPI, MCP, GraphQL, gRPC, and JSON-RPC

31. **[FlowUpdater](https://github.com/FlowArg/FlowUpdater)** - ⭐ 98
   The free and open source solution to update Minecraft.

32. **[mcp-manager](https://github.com/petiky/mcp-manager)** - ⭐ 95
...
33. **[ai-microcore](https://github.com/Nayjest/ai-microcore)** - ⭐ 95
   A handy lib for smooth interaction with large language models (LLMs) and crafting AI apps.

34. **[hm_editor](https://github.com/huimeicloud/hm_editor)** - ⭐ 88
   一款轻量级、可扩展的、跨平台的、专为医疗信息化设计的电子病历编辑器内核，为EMR（电子病历系统）提供专业的结构化病历编辑与AI接入解决方案。

35. **[researcher_agent](https://github.com/lgesuellip/researcher_agent)** - ⭐ 63
...
36. **[MCPE-Client-Sources](https://github.com/Turkeii/MCPE-Client-Sources)** - ⭐ 57

37. **[deepsecure](https://github.com/DeepTrail/deepsecure)** - ⭐ 48
...
38. **[revit-mcp-commandset](https://github.com/revit-mcp/revit-mcp-commandset)** - ⭐ 47
...
39. **[mcp-client-python-example](https://github.com/alejandro-ao/mcp-client-python-example)** - ⭐ 38

40. **[ziya](https://github.com/ziya-ai/ziya)** - ⭐ 36
...
41. **[flowllm](https://github.com/FlowLLM-AI/flowllm)** - ⭐ 32
   FlowLLM: Simplifying LLM-based HTTP/MCP Service Development

42. **[mcp-web-client](https://github.com/jinruoxinchen/mcp-web-client)** - ⭐ 28
   MCP Web Client project

43. **[mcpx4j](https://github.com/dylibso/mcpx4j)** - ⭐ 28
   Java client library for https://mcp.run - call portable and secure tools for your AI Agents and Apps

44. **[axonflow](https://github.com/getaxonflow/axonflow)** - ⭐ 26
   AxonFlow — Source-available AI control plane for production LLM systems

45. **[mcpx-py](https://github.com/dylibso/mcpx-py)** - ⭐ 25
   Python client library for https://mcp.run - call portable & secure tools for your AI Agents and Apps

46. **[mcp-client](https://github.com/liuwenzhoa/mcp-client)** - ⭐ 23

47. **[awesome-netsuite-ai](https://github.com/michoelchaikin/awesome-netsuite-ai)** - ⭐ 22
...
48. **[luma-api-mcp](https://github.com/lumalabs/luma-api-mcp)** - ⭐ 21
   Powered by Ray (video) and Photon (image) models by Luma AI

49. **[desktop4mistral](https://github.com/hathibelagal-dev/desktop4mistral)** - ⭐ 19
   A desktop client with MCP support for Mistral LLMs

50. **[ai](https://github.com/JoakimCarlsson/ai)** - ⭐ 16
...
51. **[fast-mcp-client](https://github.com/aswincandra/fast-mcp-client)** - ⭐ 11
   MCP Client Implemented to FastAPI

52. **[chatbot-spring-ai-mcp-telegram-client](https://github.com/mohamedYoussfi/chatbot-spring-ai-mcp-telegram-client)** - ⭐ 11

53. **[novelcrafter-mcp](https://github.com/deadshot465/novelcrafter-mcp)** - ⭐ 10
   An experimental desktop client for using Claude Desktop's MCP with Novelcrafter codices.

54. **[ArcaMCP](https://github.com/Yoryoboy/ArcaMCP)** - ⭐ 10
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 184,251
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 43,200
   🦍 The API and AI Gateway

3. **[goose](https://github.com/aaif-goose/goose)** - ⭐ 42,222
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

4. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 38,988
   Query Engine for AI Analytics: Build self-reasoning agents across all your live data

5. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 27,728
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

6. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,614
   Your ultimate Go microservices framework for the cloud-native era.

7. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,472
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

8. **[plate](https://github.com/udecode/plate)** - ⭐ 16,147
...
11. **[ui](https://github.com/creativetimofficial/ui)** - ⭐ 11,812
   Open-source components, blocks, and AI agents designed to speed up your workflow. Import them seamlessly into your favorite tools through Registry and MCPs.

12. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 11,622
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

13. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 11,255
   A cross-platform Markdown AI note-taking software.

14. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 10,902
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

15. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 9,356
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

16. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,825
   Build autonomous AI agents in Python.

17. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,721
    The most powerful Android RPA agent framework, next generation mobile automation.

18. **[adk-go](https://github.com/google/adk-go)** - ⭐ 7,572
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

19. **[codefather](https://github.com/liyupi/codefather)** - ⭐ 7,062
...
20. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 6,760
...
21. **[easy-vibe](https://github.com/datawhalechina/easy-vibe)** - ⭐ 5,796
   💻 vibe coding 2026 | Your first modern programming course for beginners to master step by step.

22. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 5,101
...
23. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 5,028
   Adversary simulation and Red teaming platform with AI

24. **[Yuxi](https://github.com/xerrors/Yuxi)** - ⭐ 4,924
...
26. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,402
   AG2 (formerly AutoGen): The Open-Source AgentOS.Join us at: https://discord.gg/sNGSwQME3x

27. **[ENScan_GO](https://github.com/wgpsec/ENScan_GO)** - ⭐ 4,331
   一款基于各大企业信息API的工具，解决在遇到的各种针对国内企业信息收集难题。一键收集控股公司ICP备案、APP、小程序、微信公众号等信息聚合导出。支持MCP接入

28. **[nexent](https://github.com/ModelEngine-Group/nexent)** - ⭐ 4,328
   Nexent is a zero-code platform for auto-generating production-grade AI agents using Harness Engineering principles — unified tools, skills, memory, and orchestration with built-in constraints, feedback loops, and control planes.

29. **[kubefwd](https://github.com/txn2/kubefwd)** - ⭐ 4,089
   Bulk port forwarding Kubernetes services for local development.

30. **[API-mega-list](https://github.com/cporter202/API-mega-list)** - ⭐ 3,975
...
31. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 3,716
...
33. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,886
   A highly opinionated, zero-configuration linter and formatter.

34. **[claude-code-book](https://github.com/lintsinghua/claude-code-book)** - ⭐ 2,742
   《御舆：解码 Agent Harness》42万字拆解 AI Agent 的Harness骨架与神经 —— Claude Code 架构深度剖析，15 章从对话循环到构建你自己的 Agent Harness。在线阅读网站：

35. **[solon](https://github.com/opensolon/solon)** - ⭐ 2,713
...
36. **[holaOS](https://github.com/holaboss-ai/holaOS)** - ⭐ 2,531
   The agent environment for long-horizon work, continuity, and self-evolution.

37. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 2,218
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

38. **[jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)** - ⭐ 2,055
...
39. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,935
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

40. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,735
   Plugin for IntelliJ IDEA that gives special support for Minecraft modding projects.

41. **[Klee](https://github.com/signerlabs/Klee)** - ⭐ 1,720
   A native macOS AI chat app powered by MLX. 100% local inference on Apple Silicon, no cloud required. Built with ShipSwift.

42. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,639
   D2X | Modern C++ Core Language Features - "A C++ tutorial project focused on practical"

43. **[DataDesigner](https://github.com/NVIDIA-NeMo/DataDesigner)** - ⭐ 1,625
   🎨 NeMo Data Designer: Generate high-quality synthetic data from scratch or from seed data.

44. **[MultiAgentPPT](https://github.com/johnson7788/MultiAgentPPT)** - ⭐ 1,527
...
45. **[Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills)** - ⭐ 1,515
   VibeSkills is a new kind of super skill that organizes 340+ governed skills into one stable AI work system.

46. **[mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest)** - ⭐ 1,499
   The main repository for the Linux and Mac OS Bedrock edition Minecraft launcher.

47. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,442
...
50. **[NagaAgent](https://github.com/Xxiii8322766509/NagaAgent)** - ⭐ 1,325
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

51. **[awesome-hacking-lists](https://github.com/taielab/awesome-hacking-lists)** - ⭐ 1,322
   A curated collection of top-tier penetration testing tools and productivity utilities across multiple domains. Join us to explore, contribute, and enhance your hacking toolkit!

52. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 1,261
   Korea Investment & Securities Open API Github

53. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,242
   基于AI的工作效率提升工具（聊天、绘画、知识库、工作流、 MCP服务市场、语音输入输出、长期记忆） | Ai-based productivity tools (Chat,Draw,RAG,Workflow,MCP marketplace, ASR,TTS, Long-term memory etc)

54. **[BuildingAI](https://github.com/BidingCC/BuildingAI)** - ⭐ 1,229
...
55. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 1,217
   Local first codebase intelligence

56. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,177
   Search, understand, reproduce, and improve an idea with ease

57. **[any-agent](https://github.com/mozilla-ai/any-agent)** - ⭐ 1,148
   A single interface to use and evaluate different agent frameworks 

58. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 1,126
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

59. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 1,076
   Selfhosted notes app. Single golang binary, notes stored as markdown within SQLite, full-text search, very low resource usage

60. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 1,054
   Natural (2-way) voice conversations with Claude Code

61. **[openops](https://github.com/openops-cloud/openops)** - ⭐ 1,014
   The batteries-included, No-Code FinOps automation platform, with the AI you trust.

62. **[rulesync](https://github.com/dyoshikawa/rulesync)** - ⭐ 1,008
   A Utility CLI for AI Coding Agents

63. **[arduino-mcp2515](https://github.com/autowp/arduino-mcp2515)** - ⭐ 984
...
65. **[LightAgent](https://github.com/wanxingai/LightAgent)** - ⭐ 850
...
66. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 797
...
67. **[eDBG](https://github.com/ShinoLeah/eDBG)** - ⭐ 795
   eBPF-based lightweight debugger for Android with MCP support

68. **[WHartTest](https://github.com/MGdaasLab/WHartTest)** - ⭐ 790
...
69. **[claude-chatgpt-mcp](https://github.com/syedazharmbnr1/claude-chatgpt-mcp)** - ⭐ 778
   A Claude MCP tool to interact with the ChatGPT desktop app on macOS

70. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 777
   原 [chatlog]项目（一个微信数据库读取及提供mcp服务开源软件）的二次开发，会尽可能同步最新开源解密源码

71. **[aderyn](https://github.com/Cyfrin/aderyn)** - ⭐ 757
   Solidity Static Analyzer that easily integrates into your editor

72. **[bytechef](https://github.com/bytechefhq/bytechef)** - ⭐ 743
...
73. **[axi](https://github.com/kunchenguid/axi)** - ⭐ 739
   Design principles for agent ergonomics. Higher accuracy with lower token cost than both MCP and regular CLI.

74. **[MCPELauncher](https://github.com/zhuowei/MCPELauncher)** - ⭐ 735
   Source code for BlockLauncher, a launcher that patches Minecraft for Android

75. **[JiwuChat](https://github.com/KiWi233333/JiwuChat)** - ⭐ 710
...
76. **[openyak](https://github.com/openyak/openyak)** - ⭐ 710
...
77. **[Sentient](https://github.com/existence-master/Sentient)** - ⭐ 678
   A personal AI assistant for everyone

78. **[infio-copilot](https://github.com/infiolab/infio-copilot)** - ⭐ 659
   A Cursor-inspired AI assistant for Obsidian that offers smart autocomplete and interactive chat with your selected notes

79. **[tool-ui](https://github.com/assistant-ui/tool-ui)** - ⭐ 630
   UI components for AI interfaces

80. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 607
...
81. **[cloudsword](https://github.com/wgpsec/cloudsword)** - ⭐ 601
   一款帮助云租户发现和测试云上风险、增强云上防护能力的综合性开源工具

82. **[vocotype-cli](https://github.com/233stone/vocotype-cli)** - ⭐ 568
   VocoType 是一款运行在本地端侧的隐私安全语音输入工具，通过快捷键即可将语音实时转换为文字并自动输入到当前应用。支持语音转文字MCP、AI 优化文本、自定义替换词典、录音视频转文字等功能，让语音输入更高效、更安全。

83. **[how-to-vibecoding](https://github.com/1EchA/how-to-vibecoding)** - ⭐ 567
   Vibecoding 系列教程：从环境搭建到多智能体协作，涵盖 MCP、Skills、Agent 分工治理

84. **[auto-commenter](https://github.com/rokpiy/auto-commenter)** - ⭐ 554
   A Claude skill that automatically posts personalized, authentic comments in your target communities.

85. **[claude-code-cli](https://github.com/huangserva/claude-code-cli)** - ⭐ 552
...
86. **[marmot](https://github.com/marmotdata/marmot)** - ⭐ 537
...
87. **[ChattyPlay-Agent](https://github.com/P1kaj1uu/ChattyPlay-Agent)** - ⭐ 507
...
88. **[browser-operator-core](https://github.com/BrowserOperator/browser-operator-core)** - ⭐ 472
...
90. **[CookHero](https://github.com/Decade-qiu/CookHero)** - ⭐ 441
...
91. **[aimock](https://github.com/CopilotKit/aimock)** - ⭐ 438
   Mock everything your AI app talks to — LLM APIs, MCP, A2A, AG-UI, vector DBs, search. One package, one port, zero dependencies.

92. **[mcp-cn-a-stock](https://github.com/elsejj/mcp-cn-a-stock)** - ⭐ 434
   这是一个为大模型提供 A 股数据的的 MCP(Model Content Protocol) 服务。

93. **[LightAgent](https://github.com/wxai-space/LightAgent)** - ⭐ 430
   LightAgent: Lightweight AI agent framework with memory, tools & tree-of-thought. Supports multi-agent collaboration, self-learning, and major LLMs (OpenAI/DeepSeek/Qwen). Open-source with MCP/SSE protocol integration.

94. **[bridle](https://github.com/neiii/bridle)** - ⭐ 417
   TUI / CLI config manager for agentic harnesses (Amp, Claude Code, Opencode, Goose, Copilot CLI, Crush, Droid)

95. **[groundhog](https://github.com/ghuntley/groundhog)** - ⭐ 401
   Groundhog's primary purpose is to teach people how Cursor and all these other coding agents work under the hood. If you understand how these coding assistants work from first principles, then you can drive these tools harder (or perhaps make your own!).

96. **[mcpi](https://github.com/martinohanlon/mcpi)** - ⭐ 391
   Minecraft: Pi Edition API Python Library

97. **[volcano-agent-sdk](https://github.com/Kong/volcano-agent-sdk)** - ⭐ 390
   🌋 Build AI agents that seamlessly combine LLM reasoning with real-world actions via MCP tools — in just a few lines of TypeScript.

98. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 389
   MCP for Unreal Engine 5

99. **[pokemon-chat](https://github.com/skygazer42/pokemon-chat)** - ⭐ 387
   基于 LightRAG、LangGraph、MCP、RagFlow、微调LLMs宝可梦主题的智能聊天助手

100. **[volcano-sdk](https://github.com/Kong/volcano-sdk)** - ⭐ 386
   🌋 Build AI agents that seamlessly combine LLM reasoning with real-world actions via MCP tools — in just a few lines of TypeScript.

101. **[graphrag-toolkit](https://github.com/awslabs/graphrag-toolkit)** - ⭐ 386
   Python toolkit for building graph-enhanced GenAI applications

102. **[azan-mcp](https://github.com/ahmedeltaher/azan-mcp)** - ⭐ 380
...
103. **[Adafruit-MCP23017-Arduino-Library](https://github.com/adafruit/Adafruit-MCP23017-Arduino-Library)** - ⭐ 378
   Arduino Library for Adafruit MCP23017

104. **[MCprep](https://github.com/Moo-Ack-Productions/MCprep)** - ⭐ 355
   Blender python addon to increase workflow for creating minecraft renders and animations

105. **[machi](https://github.com/qntx/machi)** - ⭐ 354
...
108. **[eechat](https://github.com/Lucassssss/eechat)** - ⭐ 337
...
114. **[ai4eh](https://github.com/ethiack/ai4eh)** - ⭐ 282
   AI for Ethical Hacking - Workshop

115. **[genie](https://github.com/automagik-dev/genie)** - ⭐ 280
   Wishes in, PRs out. CLI agent that interviews you, plans the work, dispatches parallel agents in isolated worktrees, and reviews code before you see it.

116. **[spool](https://github.com/spool-lab/spool)** - ⭐ 273
...
122. **[MCP-Defender](https://github.com/MCP-Defender/MCP-Defender)** - ⭐ 250
...
138. **[mcpat](https://github.com/HewlettPackard/mcpat)** - ⭐ 209
   An integrated power, area, and timing modeling framework for multicore and manycore architectures

139. **[BaseLayer](https://github.com/zwgnr/BaseLayer)** - ⭐ 202
   Re-usable multi part components built on React Aria and TailwindCSS. 

140. **[MCP-919](https://github.com/Marcelektro/MCP-919)** - ⭐ 190
   Fully working & decompiled MCP for Minecraft 1.8.9 

141. **[MCPScan](https://github.com/antgroup/MCPScan)** - ⭐ 189

142. **[codecompanion-history.nvim](https://github.com/ravitemer/codecompanion-history.nvim)** - ⭐ 178
   A history management extension for codecompanion AI chat plugin that enables saving, browsing and restoring chat sessions.

143. **[edumcp](https://github.com/aieducations/edumcp)** - ⭐ 171
   EDUMCP is a protocol that integrates the Model Context Protocol (MCP) with applications in the education field, dedicated to achieving seamless interconnection and interoperability among different AI models, educational applications, smart hardware, and teaching AGENTs.

144. **[bluebox-sdk](https://github.com/VectorlyApp/bluebox-sdk)** - ⭐ 169
   Reverse engineer web apps

145. **[claude-android-skill](https://github.com/dpconde/claude-android-skill)** - ⭐ 164
   Claude Code skill for building modern Android apps following best practices.

146. **[selene](https://github.com/tercumantanumut/selene)** - ⭐ 164
...
148. **[skene](https://github.com/SkeneTechnologies/skene)** - ⭐ 160
   Product-Led Growth (PLG) analysis toolkit that detects tech stacks, plans growth loops and builds the loop iteratively.

149. **[mcp-audit](https://github.com/apisec-inc/mcp-audit)** - ⭐ 146
   See what your AI agents can access. Scan MCP configs for exposed secrets, shadow APIs, and AI models. Generate AI-BOMs for compliance.

150. **[seline](https://github.com/tercumantanumut/seline)** - ⭐ 143
...
151. **[toon-java](https://github.com/toon-format/toon-java)** - ⭐ 142
   ☕ Community-driven Java implementation of TOON

152. **[rocketship](https://github.com/rocketship-ai/rocketship)** - ⭐ 140
   A QA testing framework for your coding agent.

153. **[mcp-toolkit](https://github.com/charIesding/mcp-toolkit)** - ⭐ 137
   utilities for mcp

154. **[Z.ai2api](https://github.com/hmjz100/Z.ai2api)** - ⭐ 134
...
155. **[awesome-ai-repositories](https://github.com/altengineer/awesome-ai-repositories)** - ⭐ 128
   A curated list of open source repositories for AI Engineers

156. **[claude-ipc-mcp](https://github.com/jdez427/claude-ipc-mcp)** - ⭐ 127
   AI-to-AI communication protocol for Claude, Gemini, and other AI assistants

157. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/sdivyanshu90/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 119
   5-Day Gen AI Intensive Course with Google

158. **[mcp-in-action](https://github.com/huangjia2019/mcp-in-action)** - ⭐ 116
   极客时间MCP新课已经上线！超2000同学一起开启MCP学习之旅！

159. **[STAMP](https://github.com/KatherLab/STAMP)** - ⭐ 115
   Solid Tumor Associative Modeling in Pathology

160. **[AgentNexus](https://github.com/wozhenbang2004/AgentNexus)** - ⭐ 114
   Multi-Agent,MCP,RAG,SpringAI1.0.0,RE-ACT

161. **[coplay-unity-plugin](https://github.com/CoplayDev/coplay-unity-plugin)** - ⭐ 114
   Unity plugin for Coplay

162. **[AgentFly](https://github.com/Agent-One-Lab/AgentFly)** - ⭐ 111
   Scalable and extensible reinforcement learning for LM agents.

163. **[Gearcoleco](https://github.com/drhelius/Gearcoleco)** - ⭐ 110
   ColecoVision emulator and debugger for macOS, Windows, Linux, BSD and RetroArch.

164. **[protocol-launcher](https://github.com/zhensherlock/protocol-launcher)** - ⭐ 110
   One-click launch URL generator for protocol-based apps

165. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/anxiong2025/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 109
   谷歌5天AI Agents强化课程

166. **[kalouk-mcp](https://github.com/fabianabarca/kalouk-mcp)** - ⭐ 106
   Servidor de contexto de Kalouk para agentes de inteligencia artificial.

167. **[Manifold](https://github.com/Garume/Manifold)** - ⭐ 102
   Operation-first .NET foundation for generating fast CLI and MCP surfaces from a single definition.

168. **[Squirrel](https://github.com/hakoniwaa/Squirrel)** - ⭐ 92
   ai memory for coding

169. **[Complementarity.jl](https://github.com/chkwon/Complementarity.jl)** - ⭐ 79
   provides a modeling interface for mixed complementarity problems (MCP) and math programs with equilibrium problems (MPEC) via JuMP 

170. **[smart-customer-service-system](https://github.com/traveler-leon/smart-customer-service-system)** - ⭐ 78
   构建一个基于大模型的智能客服系统，可提供静态知识问答(静态数据)、动态知识问答（数据库），业务办理（api调用）等功能，同时系统具有自我学习能力。定期的反思可让系统变得更强大。

171. **[open-skills](https://github.com/besoeasy/open-skills)** - ⭐ 78
   Battle-tested skill library for AI agents. Save 98% of API costs with ready-to-use code for crypto, PDFs, search, web scraping & more. No trial-and-error, no expensive APIs.

172. **[TensorBlock-Studio](https://github.com/TensorBlock/TensorBlock-Studio)** - ⭐ 78
   A lightweight, open, and extensible multi-LLM interaction studio.

173. **[nvim-gemini-companion](https://github.com/gutsavgupta/nvim-gemini-companion)** - ⭐ 77
   A Neovim plugin to integrate Gemini CLI well (+ Qwen-code now)

174. **[yes-ue-mcp](https://github.com/softdaddy-o/yes-ue-mcp)** - ⭐ 77
   Native C++ Model Context Protocol (MCP) plugin for Unreal Engine 5.4+

175. **[quarkus-workshop-langchain4j](https://github.com/quarkusio/quarkus-workshop-langchain4j)** - ⭐ 75
   Quarkus Langchain4J Workshop

176. **[lycoris](https://github.com/solaoi/lycoris)** - ⭐ 75
...
193. **[xiaozhi-MCPTools](https://github.com/ZhongZiTongXue/xiaozhi-MCPTools)** - ⭐ 35
   一个图形化界面的小智MCP服务连接器，包含多种工具！ 自动部署服务，方便小白给小智Ai添加MCP工具

194. **[mini-coder](https://github.com/sacenox/mini-coder)** - ⭐ 34
   A good idea 👾

195. **[advanced-reason-mcp](https://github.com/Kuon-dev/advanced-reason-mcp)** - ⭐ 33
   Enhanced version of "Sequential Thinking" MCP

196. **[zentrun](https://github.com/andrewsky-labs/zentrun)** - ⭐ 32
   Prompt-driven automation platform - Transform natural language into executable workflows

197. **[hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298](https://github.com/LinkedInLearning/hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298)** - ⭐ 31
...
198. **[shebe](https://github.com/shebe-oss/shebe)** - ⭐ 30
   Fast BM25 full-text search for code repositories with MCP integration for AI coding agents.

199. **[awesome-mcp-list](https://github.com/notedit/awesome-mcp-list)** - ⭐ 28
   Awesome Model Context Protocol Service List

200. **[adk-mcp-gemma3](https://github.com/arjunprabhulal/adk-mcp-gemma3)** - ⭐ 27
   Build AI Agent using Google ADK , MCP and Gemma 3 model

201. **[shebe](https://github.com/rhobimd-oss/shebe)** - ⭐ 26
   Fast BM25 full-text search for code repositories with MCP integration for AI coding agents.

202. **[codai](https://github.com/codai-agent/codai)** - ⭐ 24
...
203. **[minime-mcp](https://github.com/manujbawa/minime-mcp)** - ⭐ 21
...
204. **[codectx](https://github.com/hey-granth/codectx)** - ⭐ 17
...
205. **[cursor-like-pro](https://github.com/gifflet/cursor-like-pro)** - ⭐ 17
   Cursor IDE like Pro

206. **[n8n-operator](https://github.com/jakub-k-slys/n8n-operator)** - ⭐ 17
   Kubernetes Operator for N8n, a fair-code workflow automation platform with native AI capabilities.

207. **[MCPStack](https://github.com/MCP-Pipeline/MCPStack)** - ⭐ 16
   Stack & Orchestrate MCP Tools — The Scikit-Learn-Pipeline Way , For LLMs

208. **[mcp-labs](https://github.com/thangchung/mcp-labs)** - ⭐ 16
   All things about MCP experiments.⭐️ Star to support our work!

209. **[ai-tools](https://github.com/elsejj/ai-tools)** - ⭐ 15
   ai-tools  call your llm based tools through shortcut (ctrl-q) in any application

210. **[ai-agents](https://github.com/rjmurillo/ai-agents)** - ⭐ 14
   Multi-agent system for software development

211. **[pic-standard](https://github.com/madeinplutofabio/pic-standard)** - ⭐ 14
   The industry standard for Provenance & Intent Contracts (PIC) in Agentic AI. Bridging the Causal Gap in autonomous systems.

212. **[feather_wand_agent](https://github.com/QAInsights/feather_wand_agent)** - ⭐ 13
...
213. **[mkinf-run](https://github.com/mkinf-io/mkinf-run)** - ⭐ 13
   mkinf run API

214. **[Unity-AI-Tools-Template](https://github.com/IvanMurzak/Unity-AI-Tools-Template)** - ⭐ 12
   Unity MCP Tool template project

215. **[Tapnow-Studio--](https://github.com/Menaelz/Tapnow-Studio--)** - ⭐ 12
...
216. **[mcp-tools](https://github.com/shaharia-lab/mcp-tools)** - ⭐ 11
   Tools for MCP (Model Context Protocol) written in Go

217. **[claude-colony](https://github.com/MakingJamie/claude-colony)** - ⭐ 10
...
218. **[Ai_agents](https://github.com/jenasuraj/Ai_agents)** - ⭐ 10
...
1. **[JavaGuide](https://github.com/Snailclimb/JavaGuide)** - ⭐ 154,981
   Java 面试 & 后端通用面试指南，覆盖计算机基础、数据库、分布式、高并发、系统设计与 AI 应用开发

2. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 11,933
...
3. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 7,830
   Specification and documentation for the Model Context Protocol

4. **[wechatDownload](https://github.com/qiye45/wechatDownload)** - ⭐ 7,247
...
7. **[forksilly.doc](https://github.com/fatsnk/forksilly.doc)** - ⭐ 87
