...
1. **[dify](https://github.com/langgenius/dify)** - ⭐ 133,474
   Production-ready platform for agentic workflow development.

2. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 127,774
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

3. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 98,299
   An open-source AI agent that brings the power of Gemini directly into your terminal.

4. **[everything-claude-code](https://github.com/affaan-m/everything-claude-code)** - ⭐ 86,114
   The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.

5. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 83,497
   A collection of MCP servers.

6. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 81,471
   Model Context Protocol Servers

7. **[netdata](https://github.com/netdata/netdata)** - ⭐ 78,124
   The fastest path to AI-powered full stack observability, even for lean teams.

8. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 75,462
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

9. **[lobehub](https://github.com/lobehub/lobehub)** - ⭐ 73,946
...
11. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 56,437
   The all-in-one AI productivity accelerator. On device and privacy first with no annoying setup or configuration.

12. **[context7](https://github.com/upstash/context7)** - ⭐ 49,674
   Context7 Platform -- Up-to-date code documentation for LLMs and AI code editors

13. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 49,267
   ⭐AI-driven public opinion & trend monitor with multi-platform aggregation, RSS, and smart alerts.🎯 告别信息过载，你的 AI 舆情监控助手与热点筛选工具！聚合多平台热点 +  RSS 订阅，支持关键词精准筛选。AI 智能筛选新闻 + AI 翻译 +  AI 分析简报直推手机，也支持接入 MCP 架构，赋能 AI 自然语言对话分析、情感洞察与趋势预测等。支持 Docker ，数据本地/云端自持。集成微信/飞书/钉钉/Telegram/邮件/ntfy/bark/slack 等渠道智能推送。

14. **[awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)** - ⭐ 45,833
   A curated list of awesome Claude Skills, resources, and tools for customizing Claude AI workflows

15. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 45,449
...
17. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 34,762
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

18. **[goose](https://github.com/block/goose)** - ⭐ 33,227
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

19. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 33,113
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

20. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,740
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

21. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 32,324
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

22. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 32,275
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

23. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 31,098
   🕷️ An adaptive Web Scraping framework that handles everything from a single request to a full-scale crawl!

24. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 30,151
   Chrome DevTools for coding agents

25. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 30,106
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex, OpenCode, openclaw & Gemini CLI.

26. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 29,232
   Playwright MCP server

27. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 28,917
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

28. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 28,047
   GitHub's official MCP Server

29. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 27,434
   Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed workbench to help you build AI agents that turn intent into action.

30. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 25,860
   Agentic IM Chatbot infrastructure that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨

31. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 25,833
   An autonomous agent that conducts deep research on any data using any LLM providers

32. **[antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills)** - ⭐ 25,735
...
33. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 24,900
   An MCP-based chatbot | 一个基于MCP的聊天机器人

34. **[gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin)** - ⭐ 24,465
...
35. **[fastmcp](https://github.com/PrefectHQ/fastmcp)** - ⭐ 23,799
   🚀 The fast, Pythonic way to build MCP servers and clients.

36. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 22,902
   🚀 The fast, Pythonic way to build MCP servers and clients

37. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 22,516
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

38. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 22,206
   The official Python SDK for Model Context Protocol servers and clients

39. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 22,124
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

40. **[serena](https://github.com/oraios/serena)** - ⭐ 21,735
   A powerful coding agent toolkit providing semantic retrieval and editing capabilities (MCP server & other integrations)

41. **[ruflo](https://github.com/ruvnet/ruflo)** - ⭐ 21,697
   🌊 The leading agent orchestration platform for Claude. Deploy intelligent multi-agent swarms, coordinate autonomous workflows, and build conversational AI systems. Features    enterprise-grade architecture, distributed swarm intelligence, RAG integration, and native Claude Code / Codex Integration

42. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 21,282
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

43. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 20,441
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

44. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 18,310
   Build and run agents you can see, understand and trust.

45. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 17,841

46. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 15,672
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

47. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 15,466
   This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) through real-world, cross-language examples in .NET, Java, TypeScript, JavaScript, Rust and Python. Designed for developers, it focuses on practical techniques for building modular, scalable, and secure AI workflows from session setup to service orchestration.

48. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 15,393
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

49. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 15,103
   🌊 The leading agent orchestration platform for Claude. Deploy intelligent multi-agent swarms, coordinate autonomous workflows, and build conversational AI systems. Features    enterprise-grade architecture, distributed swarm intelligence, RAG integration, and native Claude Code / Codex Integration

50. **[openfang](https://github.com/RightNow-AI/openfang)** - ⭐ 14,925
   Open-source Agent Operating System

51. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 14,072
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

52. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 13,778
   MCP server to provide Figma layout information to AI coding agents like Cursor

53. **[electerm](https://github.com/electerm/electerm)** - ⭐ 13,736
   📻Terminal/ssh/sftp/ftp/telnet/serialport/RDP/VNC/Spice client(linux, mac, win)

54. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 13,458
...
56. **[casdoor](https://github.com/casdoor/casdoor)** - ⭐ 13,191
...
57. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 13,041
   Memory for 24/7 proactive agents like openclaw (moltbot, clawdbot).

58. **[claude-plugins-official](https://github.com/anthropics/claude-plugins-official)** - ⭐ 12,688
   Official, Anthropic-managed directory of high quality Claude Code Plugins.

59. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 11,886
   The official TypeScript SDK for Model Context Protocol servers and clients

60. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 11,873
   MCP for xiaohongshu.com

61. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,661
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

62. **[page-agent](https://github.com/alibaba/page-agent)** - ⭐ 11,457
   JavaScript in-page GUI agent. Control web interfaces with natural language.

63. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 11,277
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

64. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 11,004
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

65. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 10,959
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

66. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 10,880
   Yet another WebUI for Nginx

67. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 10,825
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

68. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 10,436
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书作品文件

69. **[Agent-Reach](https://github.com/Panniantong/Agent-Reach)** - ⭐ 9,919
   Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.

70. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

71. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 9,455
   The fullstack MCP framework to develop MCP Apps for ChatGPT / Claude & MCP Servers for AI Agents.

72. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 9,298
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

73. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 9,108
   Visual testing tool for MCP servers

74. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 8,930
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

75. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 8,482
   Official MCP Servers for AWS

76. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 8,382
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

77. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 8,109
   Build effective agents using Model Context Protocol and simple workflow patterns

78. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 7,960
   MCP Server for Ghidra

79. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,794
   Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project

80. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 7,789
   🧑‍🚀 全世界最好的LLM资料总结（多模态生成、Agent、辅助编程、AI审稿、数据处理、模型训练、模型推理、o1 模型、MCP、小语言模型、视觉语言模型） | Summary of the world's best LLM resources. 

81. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 7,545
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

82. **[superset](https://github.com/superset-sh/superset)** - ⭐ 7,409
   IDE for the AI Agents Era - Run an army of Claude Code, Codex, etc. on your machine

83. **[oh-my-opencode](https://github.com/code-yeongyu/oh-my-opencode)** - ⭐ 7,289
...
84. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 7,263
   Unity MCP acts as a bridge, allowing AI assistants (like Claude, Cursor) to interact directly with your Unity Editor via a local MCP (Model Context Protocol) Client. Give your LLM tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

85. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 7,130
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

86. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 7,107
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

87. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 6,827
   AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework

88. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 6,749
...
89. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,564
   A community driven registry service for Model Context Protocol (MCP) servers.

90. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 6,561
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

91. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 6,506
   TalkToFigma: MCP integration between AI Agent (Cursor, Claude Code) and Figma, allowing Agentic AI to communicate with Figma for reading designs and modifying them programmatically.

92. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 6,487
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

93. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,363
   A collection of MCP clients.

94. **[refly](https://github.com/refly-ai/refly)** - ⭐ 6,135
   The first open-source agent skills builder. 🦞

95. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 6,092
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

96. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 5,803
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

97. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,727
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

98. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 5,682
   Context-aware AI assistant for your desktop. Ready to respond intelligently, seamlessly integrating multiple LLMs and MCP tools.

99. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 5,681
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

100. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,667
   Klavis AI:  MCP integration platforms that let AI agents use tools reliably at any scale

101. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 5,479
   A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines

102. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,422
   WhatsApp MCP server

103. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 5,326
   A model-driven approach to building AI agents in just a few lines of code.

104. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,320
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

105. **[context-mode](https://github.com/mksglu/context-mode)** - ⭐ 5,264
   Privacy-first. MCP is the protocol for tool access. We're the virtualization layer for context.

106. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,249
   Awesome MCP Servers - A curated list of Model Context Protocol servers

107. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 5,163
   Learn AI and LLMs from scratch using free resources

108. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 5,119
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

109. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 5,025
...
111. **[unidbg](https://github.com/zhkl0228/unidbg)** - ⭐ 4,840
   Allows you to emulate an Android native library, and an experimental  iOS emulation

112. **[XcodeBuildMCP](https://github.com/getsentry/XcodeBuildMCP)** - ⭐ 4,795
   A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.

113. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 4,771
   MCP Server for Computer Use in Windows

114. **[aci](https://github.com/aipotheosis-labs/aci)** - ⭐ 4,732
   ACI.dev is the open source tool-calling platform that hooks up 600+ tools into any agentic IDE or custom AI agent through direct function calling or a unified MCP server. The birthplace of VibeOps.

115. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,710
   Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset management, MCP, and more.

116. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 4,658
   MCP server for Atlassian tools (Confluence, Jira)

117. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 4,556
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

118. **[deep-research](https://github.com/u14app/deep-research)** - ⭐ 4,519
   Use any LLMs (Large Language Models) for Deep Research. Support SSE API and MCP server.

119. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,485
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

120. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,471
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

121. **[osaurus](https://github.com/osaurus-ai/osaurus)** - ⭐ 4,356
   Own your AI. The native macOS harness for AI agents -- any model, persistent memory, autonomous execution, cryptographic identity. Built in Swift. Fully offline. Open source.

122. **[httprunner](https://github.com/httprunner/httprunner)** - ⭐ 4,265
   HttpRunner 是一款开源的 API/UI 测试框架，简单易用，功能强大，具有丰富的插件化机制和高度的可扩展能力。

123. **[Olares](https://github.com/beclab/Olares)** - ⭐ 4,238
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

124. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 4,172
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

125. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 4,145
   A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.

126. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 4,106
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

127. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 4,068
   A simple, secure MCP-to-OpenAPI proxy server

128. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 4,067
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

129. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 4,063
   Official Notion MCP Server

130. **[easy-vibe](https://github.com/datawhalechina/easy-vibe)** - ⭐ 4,049
...
131. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 4,045
   Exa MCP for web search and web crawling!

132. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 4,029
   A Model Context Protocol (MCP) server that provides structured spec-driven development workflow tools for AI-assisted software development, featuring a real-time web dashboard and VSCode extension for monitoring and managing your project's progress directly in your development environment.

133. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 3,990
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

134. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 3,931
...
137. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,835
   🤖 A visualization mcp & skills contains 25+ visual charts using @antvis. Using for chart generation and data analysis.

138. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,833
   🔍 导出并模糊搜索 Telegram 聊天记录 | Export and fuzzy search your Telegram chat history

139. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,770
   A curated list of Model Context Protocol (MCP) servers

140. **[atmosphere](https://github.com/Atmosphere/atmosphere)** - ⭐ 3,745
   The transport-agnostic real-time framework for the JVM. WebSocket, SSE, Long-Polling, gRPC, MCP — one API, any transport.

141. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,712
   Code, Build and Evaluate agents - excellent Model and Skills/MCP/ACP Support

142. **[MemOS](https://github.com/MemTensor/MemOS)** - ⭐ 3,710
...
143. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,681
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP, and Chatwoot. Built with Golang for efficient memory use. 

144. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 3,671
...
145. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 3,664
   Claude Code Guide - Setup, Commands, workflows, agents, skills & tips-n-tricks go from beginner to power user!

146. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 3,642
   An Agentic Framework for Reflective PowerPoint Generation

147. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,633
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

148. **[core](https://github.com/opensumi/core)** - ⭐ 3,613
   A framework helps you quickly build AI Native IDE products. MCP Client, supports Model Context Protocol (MCP) tools via MCP server.

149. **[Continuous-Claude-v3](https://github.com/parcadei/Continuous-Claude-v3)** - ⭐ 3,611
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

150. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,592
...
151. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 3,561
   RikkaHub is an Android APP that supports for multiple LLM providers.

152. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 3,548
...
153. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,548

154. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 3,542
   Enterprise AI Platform with guardrails, MCP registry, gateway & orchestrator

155. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,489
   A Model Context Protocol server for Excel file manipulation

156. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,488
...
158. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,436
   An AI Gateway, registry, and proxy that sits in front of any MCP, A2A, or REST/gRPC APIs, exposing a unified endpoint with centralized discovery, guardrails and management. Optimizes Agent & Tool calling, and supports plugins.

159. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,423
   LangChain 🔌 MCP

160. **[mcp](https://github.com/google/mcp)** - ⭐ 3,414
   Google 💚 MCP

161. **[excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp)** - ⭐ 3,402
   Fast and streamable Excalidraw MCP App

162. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,394
   Model Context Protocol(MCP) 编程极速入门

163. **[boost](https://github.com/laravel/boost)** - ⭐ 3,341
   Laravel-focused MCP server for augmenting your AI powered local development experience.

164. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,311
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

165. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,280
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

166. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 3,260
   A full-stack AI Red Teaming platform securing AI ecosystems via OpenClaw Security Scan, Agent Scan, Skills Scan, MCP scan, AI Infra scan and LLM jailbreak evaluation.

167. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,238
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

168. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,228
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

169. **[SimpleMem](https://github.com/aiming-lab/SimpleMem)** - ⭐ 3,227
   SimpleMem: Efficient Lifelong Memory for LLM Agents

170. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,195
   Allow LLMs to control a browser with Browserbase and Stagehand

171. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 3,189
   The official Rust SDK for the Model Context Protocol

172. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 3,158
...
173. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 3,100
   A curated list of skills, tools, tutorials, and capabilities for AI coding agents (Claude, Codex, Antigravity, Copilot, VS Code)

174. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 3,097
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

175. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 3,031
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

176. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 3,017
   Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

177. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 3,009
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

178. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 3,001
   A TypeScript framework for building MCP servers.

179. **[n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp)** - ⭐ 2,999
   n8n custom node for MCP

180. **[core](https://github.com/cheshire-cat-ai/core)** - ⭐ 2,994
   AI agent microservice

181. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 2,969
   CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security tools, an intelligent orchestration engine, role-based testing with predefined security roles, a skills system with specialized testing skills, and comprehensive lifecycle management capabilities.

182. **[Generative-Media-Skills](https://github.com/SamurAIGPT/Generative-Media-Skills)** - ⭐ 2,939
   Multi-modal Generative Media Skills for AI Agents (Claude Code, Cursor, Gemini CLI). High-quality image, video, and audio generation powered by muapi.ai.

183. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 2,865
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

184. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,808
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

185. **[EverMemOS](https://github.com/EverMind-AI/EverMemOS)** - ⭐ 2,738
   A memory OS that makes your OpenClaw agents more personal while saving tokens.

186. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,710
   A mcp server to allow LLMS gain context about shadcn ui component structure,usage and installation,compaitable with react,svelte 5,vue & React Native

187. **[notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli)** - ⭐ 2,672

188. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,669
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

189. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,602
   A single hub to find Claude Skills, Agents, Commands, Hooks, Plugins, and Marketplace collections to extend Claude Code, Claude Desktop, Agent SDK and OpenClaw

190. **[claude-seo](https://github.com/AgriciDaniel/claude-seo)** - ⭐ 2,590
...
191. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 2,586
   MCP server for Grafana

192. **[kreuzberg](https://github.com/Goldziher/kreuzberg)** - ⭐ 2,561
...
193. **[nunu](https://github.com/go-nunu/nunu)** - ⭐ 2,550
   A CLI tool for building Go applications.

194. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,541
   Connect Supabase to your AI assistants

195. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 2,530
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

196. **[claude-context-mode](https://github.com/mksglu/claude-context-mode)** - ⭐ 2,522
   MCP is the protocol for tool access. We're the virtualization layer for context.

197. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,510
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

198. **[slackdump](https://github.com/rusq/slackdump)** - ⭐ 2,474
   Save or export your private and public Slack messages, threads, files, and users locally without admin privileges.

199. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,473
   A Model Context Protocol server for converting almost anything to Markdown

200. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 2,444
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

201. **[Auto-claude-code-research-in-sleep](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep)** - ⭐ 2,400
   ARIS ⚔️ (Auto-Research-In-Sleep) — Lightweight Markdown-only skills for autonomous ML research: cross-model review loops, idea discovery, and experiment automation. No framework, no lock-in — works with Claude Code, Codex, OpenClaw, or any LLM agent.

202. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,386
   A Model Context Protocol server for searching and analyzing arXiv papers

203. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 2,379
   An event-driven framework designed to build and orchestrate multi-agent AI systems. It enables seamless integration of AI agents with real-world data sources and systems, facilitating complex, multi-step workflows.

204. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 2,366
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

205. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 2,365
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

206. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,354
   A bridge between Streamable HTTP and stdio MCP transports

207. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,350
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

208. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 2,345
   Zero-dependency, token-efficient database MCP server for Postgres, MySQL, SQL Server, MariaDB, SQLite.

209. **[CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext)** - ⭐ 2,331
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

210. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,326

211. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,314
   A metasearch library that aggregates results from diverse web search services

212. **[moltis](https://github.com/moltis-org/moltis)** - ⭐ 2,277
...
213. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 2,214
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

214. **[chatmcp](https://github.com/daodao97/chatmcp)** - ⭐ 2,186
   ChatMCP is an AI chat client implementing the Model Context Protocol (MCP).

215. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,178
...
216. **[code-graph-rag](https://github.com/vitali87/code-graph-rag)** - ⭐ 2,148
   The ultimate RAG for your monorepo. Query, understand, and edit multi-language codebases with the power of AI and knowledge graphs

217. **[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** - ⭐ 2,139
   LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

218. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 2,128
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

219. **[oh-my-pi](https://github.com/can1357/oh-my-pi)** - ⭐ 2,110
   ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more

220. **[claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection)** - ⭐ 2,098
   Claude Code Subagents & Commands Collection + CLI Tool

221. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 2,072
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

222. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 2,065
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

223. **[mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager)** - ⭐ 2,054
   Shrimp Task Manager is a task tool built for AI Agents, emphasizing chain-of-thought, reflection, and style consistency. It converts natural language into structured dev tasks with dependency tracking and iterative refinement, enabling agent-like developer behavior in reasoning AI systems.

224. **[DevDocs](https://github.com/cyberagiinc/DevDocs)** - ⭐ 2,042
   Completely free, private, UI based Tech Documentation MCP server. Designed for coders and software developers in mind. Easily integrate into Cursor, Windsurf, Cline, Roo Code, Claude Desktop App 

225. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 2,034
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

226. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 2,029
   The official MCP server implementation for the Perplexity API Platform

227. **[Aix-DB](https://github.com/apconw/Aix-DB)** - ⭐ 2,006
   Aix-DB 基于 LangChain/LangGraph 框架，结合 MCP Skills 多智能体协作架构，实现自然语言到数据洞察的端到端转换。

228. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 2,000
   Next Generation Agentic Proxy for AI Agents and MCP servers

229. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 1,995
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

230. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,980
   directory for Awesome MCP Servers

231. **[agent-scan](https://github.com/snyk/agent-scan)** - ⭐ 1,924
   Security scanner for AI agents, MCP servers and agent skills.

232. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,918
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

233. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 1,915
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

234. **[mcp-cli](https://github.com/IBM/mcp-cli)** - ⭐ 1,913

235. **[witsy](https://github.com/nbonamy/witsy)** - ⭐ 1,913
   Witsy: desktop AI assistant / universal MCP client

236. **[beelzebub](https://github.com/mariocandela/beelzebub)** - ⭐ 1,904
   A secure low code honeypot framework, leveraging AI for System Virtualization.

237. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 1,896
   A unified hub for centrally managing and dynamically orchestrating multiple MCP servers/APIs into separate endpoints with flexible routing strategies

238. **[yomo](https://github.com/yomorun/yomo)** - ⭐ 1,893
   🦖 Serverless AI Agent Framework with Geo-distributed Edge AI Infra.

239. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,891

240. **[ext-apps](https://github.com/modelcontextprotocol/ext-apps)** - ⭐ 1,880
   Official repo for spec & SDK of MCP Apps protocol - standard for UIs embedded AI chatbots, served by MCP servers

241. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 1,877
   ⭐ All-in-one AI companion! Super Agent Party = Self hosted neuro sama + openclaw! ⭐ 全能AI伴侣！超级智能体派对 = 自托管neuro sama + openclaw!

242. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,875
   A Unified MCP Server Management App (MCP Manager).

243. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 1,874
...
244. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 1,851
   Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tasks, Search & Drive with AI - Comprehensive Google Workspace / G Suite MCP Server & CLI Tool

245. **[esp32_nat_router](https://github.com/martin-ger/esp32_nat_router)** - ⭐ 1,841
   An AI-enabled NAT Router/Firewall for the ESP32

246. **[sanic-web](https://github.com/apconw/sanic-web)** - ⭐ 1,817
...
247. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,816
   Asynchronous coordination layer for AI coding agents: identities, inboxes, searchable threads, and advisory file leases over FastMCP + Git + SQLite

248. **[vexa](https://github.com/Vexa-ai/vexa)** - ⭐ 1,813
   Open-source meeting transcription API for Google Meet, Microsoft Teams & Zoom. Auto-join bots, real-time WebSocket transcripts, MCP server for AI agents. Self-host or use hosted SaaS.

249. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,811
   Test & Debug MCP servers, ChatGPT apps, and MCP Apps (ext-apps)

250. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,784
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

251. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,782
   Desktop Extensions: One-click local MCP server installation in desktop apps

252. **[skills](https://github.com/microsoft/skills)** - ⭐ 1,779
   Skills, MCP servers, Custom Agents, Agents.md for SDKs to ground Coding Agents

253. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,776
...
254. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,753
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

255. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,753
   MCP server for interacting with the iOS simulator

256. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,748
   MAI-UI: Real-World Centric Foundation GUI Agents ranging from 2B to 235B

257. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,746
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

258. **[plik](https://github.com/root-gg/plik)** - ⭐ 1,714
   Plik is a temporary file upload system (Wetransfer like) in Go.

259. **[claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar)** - ⭐ 1,700
...
260. **[interactive-feedback-mcp](https://github.com/noopstudios/interactive-feedback-mcp)** - ⭐ 1,697
   Interactive User Feedback MCP

261. **[py-gpt](https://github.com/szczyglis-dev/py-gpt)** - ⭐ 1,690
   Desktop AI Assistant powered by GPT-5, GPT-4, o1, o3, Gemini, Claude, Ollama, DeepSeek, Perplexity, Grok, Bielik, chat, vision, voice, RAG, image and video generation, agents, tools, MCP, plugins, speech synthesis and recognition, web search, memory, presets, assistants,and more. Linux, Windows, Mac

262. **[mcp-server](https://github.com/financial-datasets/mcp-server)** - ⭐ 1,665
   An MCP server for interacting with the Financial Datasets stock market API.

263. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,664
   Make RSS 📰 great again with AI 🧠✨!! [网页监控工具-预定送会员：https://waitlist.dingding.glidea.app]

264. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,660
   ToolHive is an enterprise-grade platform for running and managing Model Context Protocol (MCP) servers.

265. **[kubb](https://github.com/kubb-labs/kubb)** - ⭐ 1,659
   🧩 The Ultimate Toolkit for Generating Type-Safe API Clients, Hooks, and Validators.

266. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 1,649
...
267. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,645
   Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatGPT, Claude) connect to using MCP

268. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,632
   MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

269. **[codemcp](https://github.com/ezyang/codemcp)** - ⭐ 1,616
   Coding assistant MCP for Claude Desktop

270. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 1,614
   The Unofficial and Awesome Home Assistant MCP Server

271. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 1,607
   This is the official website for TuriX Computer-use-Agent

272. **[agent-deck](https://github.com/asheshgoplani/agent-deck)** - ⭐ 1,591
   Terminal session manager for AI coding agents. One TUI for Claude, Gemini, OpenCode, Codex, and more.

273. **[unreal-mcp](https://github.com/chongdashu/unreal-mcp)** - ⭐ 1,585
   Enable AI assistant clients like Cursor, Windsurf and Claude Desktop to control Unreal Engine through natural language using the Model Context Protocol (MCP).

274. **[engram](https://github.com/Gentleman-Programming/engram)** - ⭐ 1,583
   Persistent memory system for AI coding agents. Agent-agnostic Go binary with SQLite + FTS5, MCP server, HTTP API, CLI, and TUI.

275. **[n8n-mcp-server](https://github.com/leonardsellem/n8n-mcp-server)** - ⭐ 1,582
   MCP server that provides tools and resources for interacting with n8n API

276. **[mcphost](https://github.com/mark3labs/mcphost)** - ⭐ 1,581
   A CLI host application that enables Large Language Models (LLMs) to interact with external tools through the Model Context Protocol (MCP).

277. **[Continuous-Claude-v2](https://github.com/parcadei/Continuous-Claude-v2)** - ⭐ 1,575
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

278. **[pilot-shell](https://github.com/maxritter/pilot-shell)** - ⭐ 1,554
   The professional development environment for Claude Code. Tests enforced, context preserved, quality automated.

279. **[mcptools](https://github.com/f/mcptools)** - ⭐ 1,527
   A command-line interface for interacting with MCP (Model Context Protocol) servers using both stdio and HTTP transport.

280. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,516
   Open-source persistent memory for AI agent pipelines (LangGraph, CrewAI, AutoGen) and Claude. REST API + knowledge graph + autonomous consolidation.

281. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,512
   An MCP server that installs other MCP servers for you

282. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 1,512

283. **[ouroboros](https://github.com/Q00/ouroboros)** - ⭐ 1,509
   Stop prompting. Start specifying.

284. **[better-agents](https://github.com/langwatch/better-agents)** - ⭐ 1,507
   Standards for building agents, better

285. **[claudian](https://github.com/YishenTu/claudian)** - ⭐ 1,493
   An Obsidian plugin that embeds Claude Code as an AI collaborator in your vault

286. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,493
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

287. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,493
   Plugin for JADX to integrate MCP server

288. **[NagaAgent](https://github.com/RTGS2017/NagaAgent)** - ⭐ 1,489
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

289. **[grepai](https://github.com/yoanbernabeu/grepai)** - ⭐ 1,487
   Semantic Search & Call Graphs for AI Agents (100% Local)

290. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 1,479
...
291. **[MCP-Reborn](https://github.com/Hexeption/MCP-Reborn)** - ⭐ 1,473
   MCP-Reborn is an MCP (Mod Coder Pack) for Minecraft for making modded clients and researching its code. (1.13-1.21.4)

292. **[contextplus](https://github.com/ForLoopCodes/contextplus)** - ⭐ 1,473
   Semantic Intelligence for Large-Scale Engineering. Context+ is an MCP server designed for developers who demand 99% accuracy. By combining RAG, Tree-sitter AST, Spectral Clustering, and Obsidian-style linking, Context+ turns a massive codebase into a searchable, hierarchical feature graph.

293. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,471
...
294. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 1,465
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

295. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,461
   The most powerful MCP Slack Server with no permission requirements, Apps support, GovSlack, DMs, Group DMs and smart history fetch logic.

296. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,458
   Security scanner for AI agents, MCP servers and agent skills.

297. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,439
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

298. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,429
   Model Context Protocol (MCP) plugin to connect with Unity Editor — designed for Cursor, Claude Code, Codex, Windsurf and other IDEs

299. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,428
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

300. **[mcp2cli](https://github.com/knowsuchagency/mcp2cli)** - ⭐ 1,419
   Turn any MCP, OpenAPI, or GraphQL server into a CLI — at runtime, with zero codegen

301. **[claude-pilot](https://github.com/maxritter/claude-pilot)** - ⭐ 1,418
...
302. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,418
   The official PHP SDK for Model Context Protocol servers and clients. Maintained in collaboration with The PHP Foundation.

303. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,416
   Production ready MCP server with real-time search, extract, map & crawl.

304. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,403
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

305. **[code-review-graph](https://github.com/tirth8205/code-review-graph)** - ⭐ 1,399
   Local knowledge graph for Claude Code. Builds a persistent map of your codebase so Claude reads only what matters — 6.8× fewer tokens on reviews and up to 49× on daily coding tasks.

306. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,392
   🔌 Plug-and-play library to enable agents to call MCP and UTCP tools via code execution. 

307. **[ai](https://github.com/stripe/ai)** - ⭐ 1,376
   One-stop shop for building AI-powered products and businesses with Stripe.

308. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,368
   A Model Context Protocol server that provides read-only access to MySQL databases. This server enables LLMs to inspect database schemas and execute read-only queries.

309. **[drawio-mcp](https://github.com/jgraph/drawio-mcp)** - ⭐ 1,366

310. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,360
   Make your own story. User-friendly software for LLM roleplaying

311. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 1,358
   AI Skills, MCP Tools, and CLI for Unity Engine. Full AI develop and test loop. Use cli for quick setup. Efficient token usage, advanced tools. Any C# method may be turned into a tool by a single line. Works with Claude Code, Gemini, Copilot, Cursor and any other absolutely for free.

312. **[mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes)** - ⭐ 1,356
   MCP Server for kubernetes management commands

313. **[mcp-obsidian](https://github.com/smithery-ai/mcp-obsidian)** - ⭐ 1,351
   A connector for Claude Desktop to read and search an Obsidian vault.

314. **[hotpath-rs](https://github.com/pawurb/hotpath-rs)** - ⭐ 1,350
   Rust Performance Profiler & Channels Monitoring Toolkit (TUI, MCP)

315. **[data-api-builder](https://github.com/Azure/data-api-builder)** - ⭐ 1,338
   Data API builder provides modern REST, GraphQL endpoints and MCP tools to your Azure Databases and on-prem stores.

316. **[LitterBox](https://github.com/BlackSnufkin/LitterBox)** - ⭐ 1,329
   A secure sandbox environment for malware developers and red teamers to test payloads against detection mechanisms before deployment. Integrates with LLM agents via MCP for enhanced analysis capabilities.

317. **[bb-browser](https://github.com/epiral/bb-browser)** - ⭐ 1,328
   Your browser is the API. CLI + MCP server for AI agents to control Chrome with your login state.

318. **[Claude-Code-Development-Kit](https://github.com/peterkrueck/Claude-Code-Development-Kit)** - ⭐ 1,327
   Handle context at scale - my custom Claude Code workflow including hooks, mcp and sub agents

319. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,322

320. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,317
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

321. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,313
   The official Swift SDK for Model Context Protocol servers and clients.

322. **[tavily-key-generator](https://github.com/skernelx/tavily-key-generator)** - ⭐ 1,311
   Multi-service toolkit for Tavily and Firecrawl signup automation, key validation, and isolated proxy pools.

323. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,308
   docker mcp CLI plugin / MCP Gateway

324. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,301
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

325. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 1,297
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

326. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,288
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

327. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,288
   An official Qdrant Model Context Protocol (MCP) server implementation

328. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 1,283
   The ultimate all-in-one guide to mastering Claude Code. From setup, prompt engineering, commands, hooks, workflows, automation, and integrations, to MCP servers, tools, and the BMAD method—packed with step-by-step tutorials, real-world examples, and expert strategies to make this the global go-to repo for Claude mastery.

329. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,280
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

330. **[damn-vulnerable-MCP-server](https://github.com/harishsg993010/damn-vulnerable-MCP-server)** - ⭐ 1,269
   Damn Vulnerable MCP Server

331. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,268
   The official ElevenLabs MCP server

332. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,247
   告别AI提前终止烦恼，助力AI更加持久

333. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,245
   The python library for research and development in NLP, multimodal LLMs, Agents, ML, Knowledge Graphs, and more.

334. **[sre](https://github.com/SmythOS/sre)** - ⭐ 1,243
   The SmythOS Runtime Environment (SRE) is an open-source, cloud-native runtime for agentic AI. Secure, modular, and production-ready, it lets developers build, run, and manage intelligent agents across local, cloud, and edge environments.

335. **[OpenContracts](https://github.com/Open-Source-Legal/OpenContracts)** - ⭐ 1,238
...
336. **[web-eval-agent](https://github.com/refreshdotdev/web-eval-agent)** - ⭐ 1,236
   An MCP server that autonomously evaluates web applications. 

337. **[web-eval-agent](https://github.com/withRefresh/web-eval-agent)** - ⭐ 1,226
   An MCP server that autonomously evaluates web applications. 

338. **[RisuAI](https://github.com/kwaroran/RisuAI)** - ⭐ 1,222
   Make your own story. User-friendly software for LLM roleplaying

339. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,222
   The TypeScript MCP framework

340. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,222
   The Grafbase GraphQL Federation Gateway

341. **[cli](https://github.com/TanStack/cli)** - ⭐ 1,212
   The official TanStack CLI - Project Scaffolding, MCP Server, Agent Skills Installation, etc

342. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 1,209
   First gitlab mcp for you

343. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,208
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

344. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 1,207
   Build MCP Agents

345. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,201
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

346. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 1,201
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

347. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,201
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

348. **[awesome-claude-plugins](https://github.com/ComposioHQ/awesome-claude-plugins)** - ⭐ 1,197
...
349. **[ShipSwift](https://github.com/signerlabs/ShipSwift)** - ⭐ 1,196
   AI-native SwiftUI component library with full-stack recipes — connect via MCP for instant access.

350. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,195
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

351. **[paperbanana](https://github.com/llmsresearch/paperbanana)** - ⭐ 1,190
   Open source implementation and extension of Google Research’s PaperBanana for automated academic figures, diagrams, and research visuals, expanded to new domains like slide generation.

352. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 1,179
   Claude Code as one-shot MCP server to have an agent in your agent.

353. **[jcodemunch-mcp](https://github.com/jgravelle/jcodemunch-mcp)** - ⭐ 1,178
   The leading, most token-efficient MCP server for GitHub source code exploration via tree-sitter AST parsing

354. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,174
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

355. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,169
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

356. **[FireRed-OpenStoryline](https://github.com/FireRedTeam/FireRed-OpenStoryline)** - ⭐ 1,162
...
357. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 1,156
...
358. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 1,154
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

359. **[fast-mcp](https://github.com/yjacquin/fast-mcp)** - ⭐ 1,154
   A Ruby Implementation of the Model Context Protocol

360. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 1,153
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

361. **[cui](https://github.com/wbopan/cui)** - ⭐ 1,151
   A web UI for Claude Code agents

362. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 1,147
   Programmable Context for the AI Stack. Build. Version. Deploy. The full lifecycle platform for Context Graphs.

363. **[awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents)** - ⭐ 1,144
   162 production-ready AI agent templates for OpenClaw. SOUL.md configs across 19 categories. Submit yours!

364. **[nono](https://github.com/always-further/nono)** - ⭐ 1,140
...
365. **[browserwing](https://github.com/browserwing/browserwing)** - ⭐ 1,139
...
366. **[tuui](https://github.com/AI-QL/tuui)** - ⭐ 1,135
   A desktop MCP client designed as a tool unitary utility integration, accelerating AI adoption through the Model Context Protocol (MCP) and enabling cross-vendor LLM API orchestration.

367. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 1,127
   Claude Code 中文开发套件 - 为中国开发者定制的零门槛 AI 编程环境。一键安装完整中文化体验，集成 MCP 服务器、智能上下文管理、安全扫描，支持免翻墙访问。让 AI 编程更简单。

368. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 1,119
   Model Context Protocol for WinDBG

369. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 1,113
   文颜 MCP Server 可以让 AI 自动将 Markdown 文章排版后发布至微信公众号。

370. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 1,104
...
371. **[figma-console-mcp](https://github.com/southleft/figma-console-mcp)** - ⭐ 1,103
   Your design system as an API. Connect AI to Figma for extraction, creation, and debugging.

372. **[ros-mcp-server](https://github.com/robotmcp/ros-mcp-server)** - ⭐ 1,089
   Connect AI models like Claude & GPT with robots using MCP and ROS.

373. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,083
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

374. **[ghost-os](https://github.com/ghostwright/ghost-os)** - ⭐ 1,080
   Full computer-use for AI agents. Self-learning workflows. Native macOS. No screenshots required.

375. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 1,074
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

376. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 1,074
...
377. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 1,055
   MCP integration for Google Calendar to manage events.

378. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 1,052
   Draw.io Model Context Protocol (MCP) Server

379. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 1,047
   Official data.gouv.fr Model Context Protocol (MCP) server that allows AI chatbots to search, explore, and analyze datasets from the French national Open Data platform, directly through conversation.

380. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 1,046
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

381. **[WebMCP](https://github.com/MiguelsPizza/WebMCP)** - ⭐ 1,043
   Bringing the power of MCP to the web

382. **[SearChat](https://github.com/sear-chat/SearChat)** - ⭐ 1,041
   Search + Chat = SearChat(AI Chat with Search), Support OpenAI/Anthropic/VertexAI/Gemini, DeepResearch, SearXNG, Docker.  AI对话式搜索引擎，支持DeepResearch, 支持OpenAI/Anthropic/VertexAI/Gemini接口、聚合搜索引擎SearXNG，支持Docker一键部署。

383. **[minima](https://github.com/dmayboroda/minima)** - ⭐ 1,039
   On-premises conversational RAG with configurable containers

384. **[lets-learn-mcp-python](https://github.com/microsoft/lets-learn-mcp-python)** - ⭐ 1,038
   MCP Python Tutorial 

385. **[mcp-server-chatsum](https://github.com/chatmcp/mcp-server-chatsum)** - ⭐ 1,036
   Query and Summarize your chat messages.

386. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 1,033
   A curated list of Model Context Protocol (MCP) servers 

387. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 1,031
   A repository of servers and clients from the Model Context Protocol tutorials

388. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 1,027
   Remote MCP Servers

389. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 1,026
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

390. **[search_with_ai](https://github.com/yokingma/search_with_ai)** - ⭐ 1,025
...
391. **[mcp-cli](https://github.com/philschmid/mcp-cli)** - ⭐ 1,024
   Lighweight CLI to interact with MCP servers

392. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 1,021
   trpc-agent-go is a powerful Go framework for building intelligent agent systems using large language models (LLMs) and tools.

393. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 1,019
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

394. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 1,016
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

395. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 1,016
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

396. **[amical](https://github.com/amicalhq/amical)** - ⭐ 1,014
   🎙️ AI Dictation App - Open Source and Local-first ⚡ Type 3x faster, no keyboard needed. 🆓 Powered by open source models, works offline, fast and accurate.

397. **[openpencil](https://github.com/ZSeven-W/openpencil)** - ⭐ 1,013
   The world's first open-source AI-native vector design tool and the first to feature concurrent Agent Teams. Design-as-Code. Turn prompts into UI directly on the live canvas. A modern alternative to Pencil.

398. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 1,012
   MCP server for fetch web page content using Playwright headless browser.

399. **[cocoindex-code](https://github.com/cocoindex-io/cocoindex-code)** - ⭐ 1,010
...
400. **[agents](https://github.com/inkeep/agents)** - ⭐ 1,007
   Create AI Agents in a No-Code Visual Builder or TypeScript SDK with full 2-way sync. For shipping AI assistants and multi-agent AI workflows.

401. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 1,000
...
402. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 990
...
403. **[GrokSearch](https://github.com/GuDaStudio/GrokSearch)** - ⭐ 980
   Integrate Grok's powerful real-time search capabilities into Claude via the MCP protocol!

404. **[CloudBase-MCP](https://github.com/TencentCloudBase/CloudBase-MCP)** - ⭐ 975
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app. 

405. **[muapi-cli](https://github.com/SamurAIGPT/muapi-cli)** - ⭐ 973
   Official CLI for muapi.ai — generate images, videos & audio from the terminal. MCP server, 14 AI models, npm + pip installable.

406. **[tools](https://github.com/strands-agents/tools)** - ⭐ 971
   A set of tools that gives agents powerful capabilities.

407. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 969
   Bridge between Ollama and MCP servers, enabling local LLMs to use Model Context Protocol tools

408. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 965
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

409. **[reactuse](https://github.com/childrentime/reactuse)** - ⭐ 964
...
410. **[awesome-devops-mcp-servers](https://github.com/rohitg00/awesome-devops-mcp-servers)** - ⭐ 961
   A curated list of awesome MCP servers focused on DevOps tools and capabilities.

411. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 959
...
412. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 954
   Expose llms-txt to IDEs for development

413. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 947
   🪐 🔧 Model Context Protocol (MCP) Server for Jupyter.

414. **[mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains)** - ⭐ 944
   A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio

415. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 935
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

416. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 928
   A security scanner for your LLM agentic workflows

417. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 922
   A middleware to provide an openAI compatible endpoint that can call MCP tools

418. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 920
   Neo4j Labs Model Context Protocol servers

419. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 919
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

420. **[mcp-browser-use](https://github.com/Saik0s/mcp-browser-use)** - ⭐ 912

421. **[CloudBase-AI-ToolKit](https://github.com/TencentCloudBase/CloudBase-AI-ToolKit)** - ⭐ 909
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app in one click.

422. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 909
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

423. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 909
   Self-hosted MCP Gateway for AI agents

424. **[claude-delegator](https://github.com/jarrodwatts/claude-delegator)** - ⭐ 908
   Delegate tasks to Codex and Gemini directly from within Claude Code.

425. **[mcpvault](https://github.com/bitbonsai/mcpvault)** - ⭐ 907
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

426. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 906
   A framework for writing MCP (Model Context Protocol) servers in Typescript

427. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 904
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

428. **[chatgpt-cli](https://github.com/kardolus/chatgpt-cli)** - ⭐ 901
...
429. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 899
   MCP server helping models to understand your Vite/Nuxt app better.

430. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 888
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

431. **[AI-Gateway](https://github.com/Azure-Samples/AI-Gateway)** - ⭐ 887
...
432. **[openapi-mcp-server](https://github.com/janwilmake/openapi-mcp-server)** - ⭐ 887
   Allow AI to wade through complex OpenAPIs using Simple Language

433. **[shellfirm](https://github.com/kaplanelad/shellfirm)** - ⭐ 883
   Safety guardrails for ai coding agents and human terminal commands

434. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 883
...
435. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 883
   OpenAPI Tool Servers

436. **[goclaw](https://github.com/nextlevelbuilder/goclaw)** - ⭐ 883
   Multi-agent AI gateway with teams, delegation & orchestration. Single Go binary, 11+ LLM providers, 5 channels.

437. **[MCProtocolLib](https://github.com/GeyserMC/MCProtocolLib)** - ⭐ 881
   A library for communication with a Minecraft client/server.

438. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 880
...
439. **[memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp)** - ⭐ 877
   A Model Context Protocol (MCP) server implementation for remote memory bank management, inspired by Cline Memory Bank.

440. **[excalidraw-mcp-app](https://github.com/antonpk1/excalidraw-mcp-app)** - ⭐ 876
   Excalidraw MCP App Server — hand-drawn diagrams for Claude

441. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 876

442. **[awesome-mcp-list](https://github.com/MobinX/awesome-mcp-list)** - ⭐ 873
   A concise list for mcp servers

443. **[hyper-mcp](https://github.com/hyper-mcp-rs/hyper-mcp)** - ⭐ 870
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

444. **[mcp-notion-server](https://github.com/suekou/mcp-notion-server)** - ⭐ 869

445. **[mcp-sequential-thinking](https://github.com/arben-adm/mcp-sequential-thinking)** - ⭐ 861

446. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 861
   Wassette: A security-oriented runtime that runs WebAssembly Components via MCP

447. **[mcp-scanner](https://github.com/cisco-ai-defense/mcp-scanner)** - ⭐ 852
   Scan MCP servers for potential threats & security findings.

448. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 851
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

449. **[awesome-claude-code-toolkit](https://github.com/rohitg00/awesome-claude-code-toolkit)** - ⭐ 850
...
453. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 842
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

454. **[hyper-mcp](https://github.com/tuananh/hyper-mcp)** - ⭐ 835
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

455. **[hyper-mcp](https://github.com/joseph-wortmann/hyper-mcp)** - ⭐ 834
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

456. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 833
   A minimalistic MCP client with a good feature set.

457. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 829
   A MCP for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

458. **[arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)** - ⭐ 827
   The best way to create, deploy, and share MCP Servers

459. **[statespace](https://github.com/statespace-tech/statespace)** - ⭐ 824
   Interactive web apps for AI agents.

460. **[server](https://github.com/php-mcp/server)** - ⭐ 823
   Core PHP implementation for the Model Context Protocol (MCP) server

461. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 822
   Simple, modular, and observable Go framework for backend applications.

462. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 819
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

463. **[golf](https://github.com/golf-mcp/golf)** - ⭐ 819
   Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents 

464. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 817
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

465. **[supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server)** - ⭐ 815
   Query MCP enables end-to-end management of Supabase via chat interface: read & write query executions, management API support, automatic migration versioning, access to logs and much more.

466. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 812
   Browse the web, directly from Cursor etc.

467. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 812
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

468. **[toolfront](https://github.com/statespace-tech/toolfront)** - ⭐ 809
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

469. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 807
   Model-agnostic plug-n-play LangChain/LangGraph agents powered entirely by MCP tools over HTTP/SSE.

470. **[context-space](https://github.com/context-space/context-space)** - ⭐ 806
   Ultimate Context Engineering Infrastructure, starting from MCPs and Integrations

471. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 806
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

472. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 806
   A local sandbox for your AI agents

473. **[awesome-openclaw](https://github.com/SamurAIGPT/awesome-openclaw)** - ⭐ 805
   A curated list of OpenClaw resources, tools, skills, tutorials & articles. OpenClaw (formerly Moltbot / Clawdbot) — open-source self-hosted AI agent for WhatsApp, Telegram, Discord & 50+ integrations.

474. **[bank-api](https://github.com/erwinkramer/bank-api)** - ⭐ 802
   The Bank API is a design reference project suitable to bootstrap development for a compliant and modern API.

475. **[burp-ai-agent](https://github.com/six2dez/burp-ai-agent)** - ⭐ 800
   Burp Suite extension that adds built-in MCP tooling, AI-assisted analysis, privacy controls, passive and active scanning and more

476. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 799
   一个将ACE(Augment Context Engine) 做成MCP的项目

477. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 794
   一款轻量级、跨平台的 Mini Kubernetes AI Dashboard，支持大模型+智能体+MCP(支持设置操作权限)，集成多集群管理、智能分析、实时异常检测等功能，支持多架构并可单文件部署，助力高效集群管理与运维优化。

478. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 793

479. **[glean](https://github.com/LeslieLeung/glean)** - ⭐ 792
   A self-hosted RSS reader and personal knowledge management tool.

480. **[douyin-mcp-server](https://github.com/yzfly/douyin-mcp-server)** - ⭐ 788
   提取抖音无水印视频链接，视频文案，douyin-mcp-server，mcp，claude skill

481. **[better-icons](https://github.com/better-auth/better-icons)** - ⭐ 788
   Skill and MCP server for searching and retrieving icons

482. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 786
   A flexible multi-interface AI agent framework for building agents with reasoning, tool use, memory, deep research, blockchain interaction, MCP, and agents-as-a-service.

483. **[vllora](https://github.com/vllora/vllora)** - ⭐ 785
   Debug your AI agents

484. **[annas-mcp](https://github.com/iosifache/annas-mcp)** - ⭐ 781
   MCP server and CLI tool for searching and downloading documents from Anna's Archive

485. **[Context](https://github.com/indragiek/Context)** - ⭐ 778
   Native macOS client for Model Context Protocol (MCP)

486. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 778
   Vibetest MCP - automated QA testing using Browser-Use agents

487. **[runno](https://github.com/taybenlor/runno)** - ⭐ 762
   Sandboxed runtime for programming languages and WASI binaries. Works in the browser, on your server, or via MCP.

488. **[drift](https://github.com/dadbodgeoff/drift)** - ⭐ 762
   Codebase intelligence for AI. Detects patterns & conventions + remembers decisions across sessions. MCP server for any IDE. Offline CLI.

489. **[tabularis](https://github.com/debba/tabularis)** - ⭐ 759
...
490. **[mcp-marketplace](https://github.com/cline/mcp-marketplace)** - ⭐ 758
...
491. **[context-portal](https://github.com/GreatScottyMac/context-portal)** - ⭐ 757
...
492. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 754
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

493. **[AITreasureBox](https://github.com/superiorlu/AITreasureBox)** - ⭐ 754
   🤖 Collect practical AI repos, tools, websites, papers and tutorials on AI. 实用的AI百宝箱 💎 

494. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 753
   The official Ruby SDK for the Model Context Protocol.

495. **[nocturne_memory](https://github.com/Dataojitori/nocturne_memory)** - ⭐ 750
   A lightweight, rollbackable, and visual Long-Term Memory Server for MCP Agents. Say goodbye to Vector RAG and amnesia. Empower your AI with persistent, graph-like structured memory across any model, session, or tool. Drop-in replacement for OpenClaw.

496. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 749
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

497. **[mcp](https://github.com/hyperbrowserai/mcp)** - ⭐ 749
   A MCP server implementation for hyperbrowser

498. **[headroom](https://github.com/chopratejas/headroom)** - ⭐ 747
   The Context Optimization Layer for LLM Applications

499. **[skybridge](https://github.com/alpic-ai/skybridge)** - ⭐ 746
   Skybridge is a framework for building ChatGPT & MCP Apps

500. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 745
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

501. **[lisa.py](https://github.com/ant4g0nist/lisa.py)** - ⭐ 742
   LLDB MCP Integration + other helpful commands

502. **[openmcp-client](https://github.com/LSTM-Kirigaya/openmcp-client)** - ⭐ 738
   All in one vscode plugin for mcp developer

503. **[codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)** - ⭐ 729
...
504. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 724
   Connect ClickHouse to your AI assistants.

505. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 722
   A flexible HTTP fetching Model Context Protocol server.

506. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 722
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

507. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 721
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

508. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 721
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

509. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 718
...
510. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 716
...
511. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 715
   Clojure MCP

512. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 715
...
513. **[keeper.sh](https://github.com/ridafkih/keeper.sh)** - ⭐ 715
...
514. **[passage-of-time-mcp](https://github.com/jlumbroso/passage-of-time-mcp)** - ⭐ 713
...
515. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 709
   gcloud MCP server

516. **[mcp](https://github.com/laravel/mcp)** - ⭐ 706
   Rapidly build MCP servers for your Laravel applications.

517. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 705
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

518. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 704
   An MCP server that provides control over Android devices via adb

519. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 701
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

520. **[samples](https://github.com/strands-agents/samples)** - ⭐ 694
   Agent samples built using the Strands Agents SDK.

521. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 693
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

522. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 692
...
523. **[langgraph-mcp-agents](https://github.com/teddynote-lab/langgraph-mcp-agents)** - ⭐ 689
...
524. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 689
   MCP server for Docker

525. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 686
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

526. **[opennews-mcp](https://github.com/6551Team/opennews-mcp)** - ⭐ 685
   Crypto News Aggregation · AI Ratings · Trading Signals · Real-time Updates

527. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 681
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

528. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 681
   Next.js Development for Coding Agent

529. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 677
   MCP Server For Turkish Legal Databases

530. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 672
   A simple CLI to run LLM prompt and implement MCP client.

531. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 670
   MCP server integration for DaVinci Resolve

532. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 668
...
533. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 667
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

534. **[mcp-proxy](https://github.com/tbxark/mcp-proxy)** - ⭐ 663
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

535. **[Wax](https://github.com/christopherkarani/Wax)** - ⭐ 662
...
536. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 662
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

537. **[universal-db-mcp](https://github.com/Anarkh-Lee/universal-db-mcp)** - ⭐ 659
...
538. **[RAGLight](https://github.com/Bessouat40/RAGLight)** - ⭐ 657
   RAGLight is a modular framework for Retrieval-Augmented Generation (RAG). It makes it easy to plug in different LLMs, embeddings, and vector stores, and now includes seamless MCP integration to connect external tools and data sources.

539. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 657
   A simple MCP server for Obsidian

540. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 656
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

541. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 655
   The YaCy Grid Master Connect Program

542. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 651
   Shell and coding agent on mcp clients

543. **[obot](https://github.com/obot-platform/obot)** - ⭐ 651
   Complete MCP Platform -- Hosting, Registry, Gateway, and Chat Client

544. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 650
   Laravel API for Ai Agents and humans.

545. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 650
   A simple, locally hosted Web Search MCP server for use with Local LLMs

546. **[llm-search](https://github.com/snexus/llm-search)** - ⭐ 648
   Querying local documents, powered by LLM

547. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 645
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

548. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 643
   EnrichMCP is a python framework for building data driven MCP servers

549. **[room](https://github.com/quoroom-ai/room)** - ⭐ 643
...
550. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 643
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

551. **[claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus)** - ⭐ 641
...
552. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 640
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

553. **[mem0-mcp](https://github.com/mem0ai/mem0-mcp)** - ⭐ 637

554. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 635
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

555. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 632

556. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 628
   Talk to a Cloudflare Worker from Claude Desktop!

557. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 627

558. **[mcp-proxy](https://github.com/TBXark/mcp-proxy)** - ⭐ 624
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

559. **[notebooklm-mcp](https://github.com/jacob-bd/notebooklm-mcp)** - ⭐ 624

560. **[vllm-mlx](https://github.com/waybarrios/vllm-mlx)** - ⭐ 623
   OpenAI and Anthropic compatible server for Apple Silicon. Run LLMs and vision-language models (Llama, Qwen-VL, LLaVA) with continuous batching, MCP tool calling, and multimodal support. Native MLX backend, 400+ tok/s. Works with Claude Code.

561. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 622
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

562. **[clihub](https://github.com/thellimist/clihub)** - ⭐ 622
   Turn any MCP server into CLI

563. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 619
   FreeCAD MCP(Model Context Protocol) server

564. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 618
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

565. **[cupertino](https://github.com/mihaelamj/cupertino)** - ⭐ 617
   A local Apple Documentation crawler and MCP server. Written in Swift.

566. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 614
   mem-agent mcp server

567. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 613
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

568. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 612
...
569. **[flow-like](https://github.com/TM9657/flow-like)** - ⭐ 610
   Flow-Like: Strongly Typed Enterprise Scale Workflows. Built for scalability, speed, seamless AI integration and rich customization.

570. **[FofaMap](https://github.com/asaotomo/FofaMap)** - ⭐ 607
...
571. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 606
...
572. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 605
   Daydreams is a set of tools for building agents for commerce

573. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 605
   Convert Any OpenAPI V3 API to MCP Server

574. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 605
   "AnyTool: Universal Tool-Use Layer for AI Agents"

575. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 605
...
576. **[MCP-Nest](https://github.com/rekog-labs/MCP-Nest)** - ⭐ 604
   A NestJS module to effortlessly create Model Context Protocol (MCP) servers for exposing AI tools, resources, and prompts.

577. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 602
   An MCP server for interacting with Sentry via LLMs.

578. **[awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers)** - ⭐ 602
...
579. **[generative-ui](https://github.com/CopilotKit/generative-ui)** - ⭐ 601
   Generative UI examples for: AG-UI, A2UI/Open-JSON-UI, and MCP Apps.

580. **[tome](https://github.com/runebookai/tome)** - ⭐ 599
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

581. **[Overture](https://github.com/SixHq/Overture)** - ⭐ 597
   Overture is an open-source, locally running web interface delivered as an MCP (Model Context Protocol) server that visually maps out the execution plan of any AI coding agent as an interactive flowchart/graph before the agent begins writing code. 

582. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 597
...
583. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 596
   A coding agent and general agent harness for building and orchestrating agentic applications.

584. **[FantasyPremierLeague](https://github.com/joreilly/FantasyPremierLeague)** - ⭐ 593
   Fantasy Premier League Kotlin/Compose Multiplatform sample 

585. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 592
   Claude Code LSP: enhance your Claude Code experience with non-IDE dependent LSP integration.

586. **[spotify-mcp](https://github.com/varunneal/spotify-mcp)** - ⭐ 588
   MCP to connect your LLM with Spotify.

587. **[FLUJO](https://github.com/mario-andreschak/FLUJO)** - ⭐ 587
   MCP-Hub and -Inspector, Multi-Model Workflow and Chat Interface 

588. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 586
   Diagram generation for understanding codebases and system architecture using Nano Banana Pro.

589. **[apple-doc-mcp](https://github.com/MightyDillah/apple-doc-mcp)** - ⭐ 582
   MCP server providing seamless access to Apple Developer Documentation with smart search and wildcard support

590. **[work-iq](https://github.com/microsoft/work-iq)** - ⭐ 582
   MCP Server and CLI for accessing Work IQ

591. **[cli](https://github.com/smithery-ai/cli)** - ⭐ 581
   Install, manage and develop MCP servers and skills for agents

592. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 579
   LangGraph solution template for MCP

593. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 578
   MCP configuration to connect AI agent to a Linux machine.

594. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 578
   The .NET library to build AI agents with 30+ built-in connectors.

595. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 574
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

596. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 571
   A comprehensive collection of Model Context Protocol (MCP) servers

597. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 570

598. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 570
   MCP-Universe is a comprehensive framework designed for developing, testing, and benchmarking AI agents

599. **[axon](https://github.com/harshkedia177/axon)** - ⭐ 570
...
600. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 570
   飞书/Lark官方 OpenAPI MCP

601. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 569
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

602. **[mcp-pointer](https://github.com/etsd-tech/mcp-pointer)** - ⭐ 569
   MCP tool: let you point at DOM elements for your favorite agentic coding tool. Let AI see what you see.

603. **[wren-engine](https://github.com/Canner/wren-engine)** - ⭐ 567
   The open context engine for AI agents

604. **[mcp-for-security](https://github.com/cyproxio/mcp-for-security)** - ⭐ 567
   MCP for Security: A collection of Model Context Protocol servers for popular security tools like SQLMap, FFUF, NMAP, Masscan and more. Integrate security testing and penetration testing into AI workflows.

605. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 567
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

606. **[anything-to-notebooklm](https://github.com/joeseesun/anything-to-notebooklm)** - ⭐ 567
   Claude Skill: Multi-source content processor for NotebookLM. Supports WeChat articles, web pages, YouTube, PDF, Markdown, search queries → Podcast/PPT/MindMap/Quiz etc.

607. **[mcp-server](https://github.com/PortSwigger/mcp-server)** - ⭐ 566
   MCP Server for Burp

608. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 565
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

609. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 565
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

610. **[mcp-server-neon](https://github.com/neondatabase/mcp-server-neon)** - ⭐ 564
   MCP server for interacting with Neon Management API and databases

611. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 563
   MCP server to deploy apps to Cloud Run

612. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 562
   Official Jina AI Remote MCP Server

613. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 561
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

614. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 560
   GitOps on Autopilot Mode

615. **[evo-ai](https://github.com/EvolutionAPI/evo-ai)** - ⭐ 557
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

616. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 556
   A MCP server for Home Assistant

617. **[caswaf](https://github.com/casbin/caswaf)** - ⭐ 555
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

618. **[casbin-gateway](https://github.com/casbin/casbin-gateway)** - ⭐ 555
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

619. **[casbin-gateway](https://github.com/apache/casbin-gateway)** - ⭐ 555
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

620. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 554
   AgentX 致力于让小白也能无门槛通过自然语言打造属于自己的 Agent。AgentX 采用了自研 MCP 网关，模型高可用组件打造高可用

621. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 552
   An Mcp client inside Emacs

622. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 552
   Vite plugin that enables a MCP server helping models to understand your Vue app better.

623. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 551
   Open Source Voice Agent Platform

624. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 551
   Google Search Console Insights with Claude AI for SEOs

625. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 548
   An MCP Multimodal AI Agent with eyes and ears!

626. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 548
   Security scanner for MCP servers

627. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 545
   A tool that converts OpenAPI specifications to MCP server

628. **[Mantic.sh](https://github.com/marcoaapfortes/Mantic.sh)** - ⭐ 542
   A structural code search engine for Al agents.

629. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 542
   MCP Server for SearXNG

630. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 541
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

631. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 540
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

632. **[tda](https://github.com/irockel/tda)** - ⭐ 539
   TDA - Thread Dump Analyzer (for Java). Analyze your Thread Dumps with a GUI or use it as MCP Server.

633. **[GhidrAssistMCP](https://github.com/symgraph/GhidrAssistMCP)** - ⭐ 539
   An MCP extension for Ghidra

634. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 536
   MCP to allow AI agents to control Unreal

635. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 535
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

636. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 535

637. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 535
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

638. **[work-iq-mcp](https://github.com/microsoft/work-iq-mcp)** - ⭐ 534
   MCP Server and CLI for accessing Work IQ

639. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 534
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

640. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 533
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

641. **[dolphin-mcp](https://github.com/QuixiAI/dolphin-mcp)** - ⭐ 533

642. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 533
   A Model Context Protocol server for IDA

643. **[line-bot-mcp-server](https://github.com/line/line-bot-mcp-server)** - ⭐ 530
   MCP server that integrates the LINE Messaging API to connect an AI Agent to the LINE Official Account.

644. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 530
   为 Cursor、Windsurf、Cline 和其他 AI 驱动的编码工具提供访问、编辑和结构化处理飞书文档的能力，并支持飞书任务管理，基于 Model Context Protocol 服务器实现。

645. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 530
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

646. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 529
   微信读书MCP

647. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 528

648. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 528
   MCP Server for Turkish & American Stock Exchange and Fund Data

649. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 527
   MCP Server for Metasploit

650. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 526
   An MCP server to query any Postgres database in natural language.

651. **[bm.md](https://github.com/miantiao-me/bm.md)** - ⭐ 526
   更好用的 Markdown 排版助手｜一键适配微信公众号、网页与图片。

652. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 525
   A model-driven approach to building AI agents in just a few lines of code. 

653. **[tsidp](https://github.com/tailscale/tsidp)** - ⭐ 525
   A simple OIDC / OAuth Identity Provider (IdP) server for your tailnet.

654. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 523
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

655. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 523
   A Model Context Protocol (MCP) that allows Claude Desktop and other AI tools (Claude Code, Cursor, Antigravity, etc.) to read, analyze, and modify Figma designs

656. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 522
   MCP server for querying Apple Health data with natural language and SQL

657. **[ethora](https://github.com/dappros/ethora)** - ⭐ 522
...
658. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 521
   Universal MCP-Server for your Databases optimized for LLMs and AI-Agents.

659. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 517
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

660. **[docling-mcp](https://github.com/docling-project/docling-mcp)** - ⭐ 517
   Making docling agentic through MCP

661. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 516
   MCP server for document format conversion using pandoc.

662. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 516

663. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 515
...
664. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 515
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

665. **[UnityMCP](https://github.com/jackwrichards/UnityMCP)** - ⭐ 515

666. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 515
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

667. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 514
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

668. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 513
   A MCP (Model Context Protocol) server for interacting with dbt.

669. **[talk-to-girlfriend-ai](https://github.com/arlanrakh/talk-to-girlfriend-ai)** - ⭐ 512
   im busy building ai agents so why not let an ai talk to my girlfriend? (i am single) 

670. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 510
   An MCP extension for Ghidra

671. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 508
   LLM + MCP + RAG = Magic

672. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 508
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

673. **[agent-kit](https://github.com/KeyID-AI/agent-kit)** - ⭐ 508
   Give Claude/Cursor email powers. 27 MCP tools — inbox, send, reply, contacts, search. Free, no signup.

674. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

675. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 507

676. **[mcp-youtube](https://github.com/anaisbetts/mcp-youtube)** - ⭐ 505
   A Model-Context Protocol Server for YouTube

677. **[MCPSpy](https://github.com/alex-ilgayev/MCPSpy)** - ⭐ 504
   MCP Monitoring with eBPF

678. **[AgentChat](https://github.com/Shy2593666979/AgentChat)** - ⭐ 504
...
679. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 503
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

680. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 502
   Yes Mcp server in bash

681. **[probe](https://github.com/probelabs/probe)** - ⭐ 501
   AI-friendly semantic code search engine for large codebases. Combines ripgrep speed with tree-sitter AST parsing. Powers AI coding assistants with precise, context-aware code understanding.

682. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 501
...
683. **[FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP)** - ⭐ 500
...
684. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 498
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

685. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 498
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

686. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 497
   AI-based stock analysis and trading system

687. **[claude-debugs-for-you](https://github.com/jasonjmcghee/claude-debugs-for-you)** - ⭐ 496
   Enable any LLM (e.g. Claude) to interactively debug any language for you via MCP and a VS Code Extension

688. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 496
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

689. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 495
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

690. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 495
...
691. **[PentestAgent](https://github.com/GH05TCREW/PentestAgent)** - ⭐ 493
...
692. **[codexia](https://github.com/milisp/codexia)** - ⭐ 493
   Agent Workstation for Codex CLI + Claude Code — with task scheduler, git worktree & remote control, Tauri

693. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 491

694. **[concierge](https://github.com/concierge-hq/concierge)** - ⭐ 488
   🚀 Universal SDK for building next-gen MCP servers

695. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 487
...
696. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 486
   ReMinecraftPE - A custom experience based on Minecraft PE as of 2011.

697. **[argo](https://github.com/xark-argo/argo)** - ⭐ 486
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

698. **[nexus](https://github.com/Nexus-Router/nexus)** - ⭐ 484
   Govern & Secure your AI

699. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 484
   MCP Server to interact with Google Gsuite prodcuts

700. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 483
   MCP-NixOS - Model Context Protocol Server for NixOS resources

701. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 481
   A VSCode extension that lets you find and install Agent Skills and MCP Apps to use with GitHub Copilot, Claude Code, and Codex CLI.

702. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 480
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

703. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 479
   ❤️ Generate mermaid diagram and chart with AI MCP dynamically.

704. **[open-multi-agent-canvas](https://github.com/CopilotKit/open-multi-agent-canvas)** - ⭐ 478
   The open-source multi-agent chat interface that lets you manage multiple agents in one dynamic conversation and add MCP servers for deep research

705. **[mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub)** - ⭐ 478
   A growing collection of MCP servers bringing offensive security tools to AI assistants. Nmap, Ghidra, Nuclei, SQLMap, Hashcat and more.

706. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 478
...
707. **[resend-mcp](https://github.com/resend/resend-mcp)** - ⭐ 474
   The official MCP server to send emails and interact with Resend

708. **[MCP-Zero](https://github.com/xfey/MCP-Zero)** - ⭐ 472
   MCP-Zero: Active Tool Discovery for Autonomous LLM Agents

709. **[laravel](https://github.com/php-mcp/laravel)** - ⭐ 472
   An SDK building Laravel MCP servers

710. **[director](https://github.com/director-run/director)** - ⭐ 472
   MCP Playbooks for AI agents

711. **[joinly](https://github.com/joinly-ai/joinly)** - ⭐ 471
   Make your meetings accessible to AI Agents

712. **[aser](https://github.com/AmeNetwork/aser)** - ⭐ 468
   Aser is a lightweight, self-assembling AI Agent frame.

713. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 467
   The only general AI agent that does NOT requires extra API key, giving you full control on your local and remote MacOs from Claude Desktop App

714. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 467
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

715. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 466
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

716. **[doctor](https://github.com/sisig-ai/doctor)** - ⭐ 464
   Doctor is a tool for discovering, crawl, and indexing web sites to be exposed as an MCP server for LLM agents.

717. **[mcp-google-ads](https://github.com/cohnen/mcp-google-ads)** - ⭐ 464
   An MCP tool that connects Google Ads with Claude AI/Cursor and others, allowing you to analyze your advertising data through natural language conversations. This integration gives you access to campaign information, performance metrics, keyword analytics, and ad management—all through simple chat with Claude, Cursor or Windsurf.

718. **[claude-code-mastery](https://github.com/TheDecipherist/claude-code-mastery)** - ⭐ 463
   The complete guide to Claude Code: CLAUDE.md, hooks, skills, MCP servers, and commands

719. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 463
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

720. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 462
   BioMCP: Biomedical Model Context Protocol

721. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 462
   小红书MCP服务 x-s x-t js逆向

722. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 462
   MCP Server for interacting with Android Devices.

723. **[youtube-mcp-server](https://github.com/ZubeidHendricks/youtube-mcp-server)** - ⭐ 459
   MCP Server for YouTube API, enabling video management, Shorts creation, and advanced analytics

724. **[mcp-bench](https://github.com/Accenture/mcp-bench)** - ⭐ 459
   MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers

725. **[atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server)** - ⭐ 456
   Remote MCP Server that securely connects Jira and Confluence with your LLM, IDE, or agent platform of choice.

726. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 455
   A docker MCP Server (modelcontextprotocol)

727. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 454
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

728. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 453
   Official Docker MCP registry 

729. **[CoexistAI](https://github.com/SPThole/CoexistAI)** - ⭐ 453
   CoexistAI is a modular, developer-friendly research assistant framework . It enables you to build, search, summarize, and automate research workflows using LLMs, web search, Reddit, YouTube, and mapping tools—all with simple MCP tool calls or API calls or Python functions. 

730. **[OpenContext](https://github.com/0xranx/OpenContext)** - ⭐ 451
   A personal context store for AI agents and assistants—reuse your existing coding agent CLI (Codex/Claude/OpenCode) with built‑in Skills/tools and a desktop GUI to capture, search, and reuse project knowledge across agents and repos.

731. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 450

732. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 446
   Govern & Secure your AI

733. **[nexus](https://github.com/nexus-ai-labs/nexus)** - ⭐ 446
   Govern & Secure your AI

734. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 445
...
735. **[mcp-send-email](https://github.com/resend/mcp-send-email)** - ⭐ 444
   Send emails directly from Cursor with this email sending MCP server

736. **[mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck)** - ⭐ 443
   Local MCP server for DuckDB and MotherDuck

737. **[kmcp](https://github.com/kagent-dev/kmcp)** - ⭐ 442
   CLI tool and Kubernetes Controller for building, testing and deploying MCP servers

738. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 440
...
739. **[applescript-mcp](https://github.com/peakmojo/applescript-mcp)** - ⭐ 436
   MCP server that execute applescript giving you full control of your Mac

740. **[awesome-mcp-devtools](https://github.com/punkpeye/awesome-mcp-devtools)** - ⭐ 435
   A curated list of developer tools, SDKs, libraries, and testing utilities for Model Context Protocol (MCP) server development.

741. **[docfork](https://github.com/docfork/docfork)** - ⭐ 433
   Docfork - Up-to-date Docs for AI Agents.

742. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 431
   MaverickMCP - Personal Stock Analysis MCP Server

743. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 431
   SonarQube MCP Server

744. **[mcpstore](https://github.com/whillhill/mcpstore)** - ⭐ 430
   开盒即用的优雅管理mcp服务 | 结合Agent框架 | 作者听劝 | 已发布pypi | Vue页面demo 

745. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 430
...
746. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 430
   A guide on how to use the Figma MCP server

747. **[mcp-server-spec-driven-development](https://github.com/formulahendry/mcp-server-spec-driven-development)** - ⭐ 428
   Spec-Driven Development MCP Server, not just Vibe Coding

748. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 428
   kratos transport layer extension, support: rabbitmq,kafka,rocketmq,activemq,apollo,mcp,tcp,websocket...

749. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 428
   A CLI inspector for the Model Context Protocol

750. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 428
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

751. **[vestige](https://github.com/samvallad33/vestige)** - ⭐ 427
...
752. **[studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)** - ⭐ 426
   Standalone Roblox Studio MCP Server

753. **[stitch-mcp](https://github.com/davideast/stitch-mcp)** - ⭐ 426
   A CLI for moving AI-generated UI designs from Google’s Stitch platform into your development workflow.

754. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 425
...
755. **[roam-code](https://github.com/Cranot/roam-code)** - ⭐ 424
...
756. **[claude-codepro](https://github.com/maxritter/claude-codepro)** - ⭐ 422
...
757. **[deeppowers](https://github.com/deeppowers/deeppowers)** - ⭐ 421
...
758. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 420
   Unlock 650+ MCP servers tools in your favorite agentic framework.

759. **[azure-skills](https://github.com/microsoft/azure-skills)** - ⭐ 420
   Official agent plugin providing skills and MCP server configurations for Azure scenarios.

760. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 418
...
761. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 418

762. **[puppeteer-mcp-server](https://github.com/merajmehrabi/puppeteer-mcp-server)** - ⭐ 412
   This MCP server provides browser automation capabilities through Puppeteer, allowing interaction with both new browser instances and existing Chrome windows.

763. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 411
   Baidu Map MCP Server

764. **[yutu](https://github.com/eat-pray-ai/yutu)** - ⭐ 411
   The AI-powered toolkit that grows your YouTube channel on autopilot.

765. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 410
   Memento MCP: A Knowledge Graph Memory System for LLMs

766. **[opentwitter-mcp](https://github.com/6551Team/opentwitter-mcp)** - ⭐ 409
   Twitter/X Data · User Profiles · Tweet Search · Follower Events · KOL Tracking

767. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 408
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

768. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 407
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

769. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 406
   lunar.dev: Agent native MCP Gateway for governance and security

770. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 406
...
771. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 405
   The safest way to make REST calls in C# with an MCP Generator

772. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 405
...
773. **[aso-skills](https://github.com/Eronred/aso-skills)** - ⭐ 405
...
774. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 401
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

775. **[mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb)** - ⭐ 400
   Search Airbnb using your AI Agent

776. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 397
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

777. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 397
...
778. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 397
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

779. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 397
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

780. **[edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp)** - ⭐ 396
   An MCP service designed for deploying HTML content to EdgeOne Pages and obtaining an accessible public URL.

781. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 396
   An experiment in software planning using MCP

782. **[speakeasy](https://github.com/speakeasy-api/speakeasy)** - ⭐ 396
...
783. **[MimikaStudio](https://github.com/BoltzmannEntropy/MimikaStudio)** - ⭐ 396
   MimikaStudio - A local-first application for macOS (Apple Silicon) + Agentic MCP Support

784. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 394
...
785. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 393
   An example agent demonstrating streaming, tool use, and interactivity from your terminal. This agent builder can help you to build your own agents and tools.

786. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 392
...
787. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 392
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

788. **[mcp-cli](https://github.com/apify/mcp-cli)** - ⭐ 392
...
789. **[station](https://github.com/cloudshipai/station)** - ⭐ 391
   Station is our open-source runtime that lets teams deploy agents on their own infrastructure with full control.

790. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 390
...
791. **[Lynkr](https://github.com/Fast-Editor/Lynkr)** - ⭐ 389
   Streamline your workflow with Lynkr, a CLI tool that acts as an HTTP proxy for efficient code interactions using Claude Code CLI.

792. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 389
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

793. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 387
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

794. **[zypher-agent](https://github.com/corespeed-io/zypher-agent)** - ⭐ 387
   A minimal yet powerful framework for creating AI agents with full control over tools, providers, and execution flow.

795. **[mcp-code-graph](https://github.com/JudiniLabs/mcp-code-graph)** - ⭐ 387
   MCP Server for code graph analysis and visualization by CodeGPT

796. **[prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server)** - ⭐ 386
   A Model Context Protocol (MCP) server that enables AI agents and LLMs to query and analyze Prometheus metrics through standardized interfaces.

797. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 386
   A comprehensive Model Context Protocol (MCP) server that enables AI assistants to control Unreal Engine through the native C++ Automation Bridge plugin. Built with TypeScript and C++.

798. **[open-skills](https://github.com/instavm/open-skills)** - ⭐ 383
   OpenSkills: Run Claude Skills Locally using any LLM

799. **[mcp-server](https://github.com/e2b-dev/mcp-server)** - ⭐ 383
   Giving Claude ability to run code with E2B via MCP (Model Context Protocol)

800. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 383
   Local Groq Desktop chat app with MCP support

801. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 383
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

802. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 383
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

803. **[Agentfy](https://github.com/Agentfy-io/Agentfy)** - ⭐ 383
...
804. **[mcp](https://github.com/mondaycom/mcp)** - ⭐ 383
   Enable AI agents to work reliably - giving them secure access to structured data, tools to take action, and the context needed to make smart decisions.

805. **[todoist-mcp-server](https://github.com/abhiz123/todoist-mcp-server)** - ⭐ 382
   MCP server for Todoist integration enabling natural language task management with Claude

806. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 379
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

807. **[automation-mcp](https://github.com/ashwwwin/automation-mcp)** - ⭐ 379
   Control your Mac with detailed mouse, keyboard, screen, and window management capabilities.

808. **[daymon](https://github.com/daymonio/daymon)** - ⭐ 377
   Daymon puts your favorite AI to work 24/7. It schedules, remembers, and orchestrates your own virtual team. Free.

809. **[mcp-k8s-go](https://github.com/strowk/mcp-k8s-go)** - ⭐ 377
   MCP server connecting to Kubernetes

810. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 377
   An MCP server for loading skills (shim for non-claude clients).

811. **[bagel](https://github.com/Extelligence-ai/bagel)** - ⭐ 377
   Chat with your robotics, drone, and IoT data — ChatGPT for the physical world.

812. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 376
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

813. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 375
   An MCP implementation for Selenium WebDriver

814. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 373
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

815. **[graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server)** - ⭐ 373
   Model Context Protocol (MCP) Server for Graphlit Platform

816. **[lsbot](https://github.com/ruilisi/lsbot)** - ⭐ 373
   Lean & Secure Bot

817. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 372
   Docfork MCP - Up-to-date Docs for AI Agents.

818. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 371
   A macOS AppleScript MCP server

819. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 371
   Model Context Protocol server for GraphQL

820. **[lingti-bot](https://github.com/ruilisi/lingti-bot)** - ⭐ 370
   🐕⚡「极简至上 效率为王 秒级接入 一链即用」的 AI Bot

821. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 370
   F2C MCP Server

822. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 369
   MCP Server implementation for Ableton Live OSC control

823. **[mnemo](https://github.com/MnemoAI/mnemo)** - ⭐ 369
   A MCP-Ready Intelligence Engine for Data & Agent-as-a-Service.

824. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 369
   The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat.

825. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 369
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

826. **[evm-mcp-server](https://github.com/mcpdotdirect/evm-mcp-server)** - ⭐ 369
   MCP server that provides LLMs with tools for interacting with EVM networks

827. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 367
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

828. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 367
   Talk with your notes in Claude. RAG over your Apple Notes using Model Context Protocol.

829. **[MoltBrain](https://github.com/nhevers/MoltBrain)** - ⭐ 367
   Long-term memory layer for OpenClaw & MoltBook agents that learns and recalls your project context automatically.

830. **[Context-Engine](https://github.com/Context-Engine-AI/Context-Engine)** - ⭐ 367
   Context-Engine MCP - Agentic Context Compression Suite

831. **[VTCode](https://github.com/vinhnx/VTCode)** - ⭐ 365
   VT Code - Semantic coding agent in the terminal

832. **[mcp2mqtt](https://github.com/mcp2everything/mcp2mqtt)** - ⭐ 364
   本项目通过将 MCP 协议转换为 MQTT 协议，我们能够利用强大的大型语言模型（LLMs），就能轻松操控您的智能家居、机器人或其他硬件设备。

833. **[devopness](https://github.com/devopness/devopness)** - ⭐ 364
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

834. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 363
   Model Context Protocol SDK for PHP

835. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 363
   MCP Server implementation for Xcode integration

836. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 363
   Xiaozhi MCP sample program

837. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 363
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

838. **[mq](https://github.com/harehare/mq)** - ⭐ 363
   jq-like command-line tool for markdown processing

839. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 363
   Things.app MCP Server

840. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 362
   Control your Android devices with AI using Model Context Protocol

841. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 362
   A centralized reverse-proxy platform for MCP servers — manage, group, and export as Skills from a single endpoint.

842. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 361
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

843. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 361
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

844. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 360

845. **[PlanExe](https://github.com/PlanExeOrg/PlanExe)** - ⭐ 360
   Create a plan from a description in minutes

846. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 359
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

847. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 357
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

848. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 357
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

849. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 357
...
850. **[pinion-os](https://github.com/chu2bard/pinion-os)** - ⭐ 356
   Client SDK, Claude plugin and skill framework for the Pinion protocol. x402 micropayments on Base.

851. **[vtcode](https://github.com/vinhnx/vtcode)** - ⭐ 355
   VT Code - Semantic coding agent in the terminal

852. **[idea-reality-mcp](https://github.com/mnemox-ai/idea-reality-mcp)** - ⭐ 355
   Pre-build reality check for AI coding agents. Scans GitHub, HN, npm, PyPI, Product Hunt. MCP server. 290+ stars.

853. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 354
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

854. **[CAAL](https://github.com/CoreWorxLab/CAAL)** - ⭐ 354
   Local voice assistant that learns new abilities via auto-discovered n8n workflows exposed as tools via MCP

855. **[mcp](https://github.com/IBM/mcp)** - ⭐ 354
   A collection of Model Context Protocol (MCP) servers, clients and developer tools by IBM.

856. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 353
   MCP server for searching and retrieving Claude Agent Skills using vector search

857. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 352
   An implementation of Model Context Protocol (MCP) server for Argo CD.

858. **[studio](https://github.com/decocms/studio)** - ⭐ 351
   Open-source control plane for your AI agents. Connect tools, hire agents, track every token and dollar

859. **[run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda)** - ⭐ 351
   Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda functions

860. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 350
...
861. **[hookdeck-cli](https://github.com/hookdeck/hookdeck-cli)** - ⭐ 350
...
862. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 349

863. **[mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops)** - ⭐ 349
   An MCP server for Azure DevOps

864. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 348
   Elixir Model Context Protocol (MCP) SDK

865. **[OB1](https://github.com/NateBJones-Projects/OB1)** - ⭐ 348
...
866. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 347
   AI-Powered Revit Modeling

867. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 347
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

868. **[js-reverse-mcp](https://github.com/zhizhuodemao/js-reverse-mcp)** - ⭐ 346
   为 AI Agent 设计的 JS 逆向 MCP Server，内置反检测，基于 chrome-devtools-mcp 重构 | JS reverse engineering MCP server with agent-first tool design and built-in anti-detection. Rebuilt from chrome-devtools-mcp.

869. **[MeiGen-AI-Design-MCP](https://github.com/jau123/MeiGen-AI-Design-MCP)** - ⭐ 345
...
870. **[skillport](https://github.com/gotalab/skillport)** - ⭐ 344
   Bring Agent Skills to Any AI Agent and Coding Agent — via CLI or MCP. Manage once, serve anywhere.

871. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 344
   MCP server retrieving transcripts of YouTube videos

872. **[SocratiCode](https://github.com/giancarloerra/SocratiCode)** - ⭐ 344
...
873. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 343
   BloodHound-MCP-AI is integration that connects BloodHound with AI through Model Context Protocol, allowing security professionals to analyze Active Directory attack paths using natural language instead of complex Cypher queries.

874. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 342
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

875. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 342
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

876. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 341
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

877. **[freee-mcp](https://github.com/freee/freee-mcp)** - ⭐ 341
   Model Context Protocol (MCP) server for freee API integration

878. **[Security-Detections-MCP](https://github.com/MHaggis/Security-Detections-MCP)** - ⭐ 340
   MCP to help Defenders Detection Engineer Harder and Smarter

879. **[agent-skills](https://github.com/microsoft/agent-skills)** - ⭐ 340
   Skills, MCP servers, Custom Coding Agents, Agents.md for SDKs to ground Coding Agents

880. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 340
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

881. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 340
   Example of an MCP server with custom tools that can be called directly from cursor

882. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 340
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

883. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 339
   MCP server to expose VS Code editing features to an LLM for AI coding

884. **[skylos](https://github.com/duriantaco/skylos)** - ⭐ 339
   skylos: High-precision Python SAST & Dead Code Remover. Finds unused functions, secrets, and security flaws with hybrid static analysis + local LLM agents. Privacy-first & low noise. MCP server for SAST too. Docs: https://docs.skylos.dev/

885. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 339
   MCP server for JADX-AI Plugin

886. **[mesh](https://github.com/decocms/mesh)** - ⭐ 337
   One secure endpoint for every MCP server. Deploy anywhere.

887. **[mcsmcp](https://github.com/microsoft/mcsmcp)** - ⭐ 337
   Lab for creating an MCP Server and using it in Microsoft Copilot Studio.

888. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 337
   deep, reliable and confidential coding-context

889. **[MemoryMesh](https://github.com/CheMiguel23/MemoryMesh)** - ⭐ 336
   A knowledge graph server that uses the Model Context Protocol (MCP) to provide structured memory persistence for AI models.

890. **[boltmcp](https://github.com/boltmcp/boltmcp)** - ⭐ 335

891. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 335
...
892. **[Gearsystem](https://github.com/drhelius/Gearsystem)** - ⭐ 335
   Sega Master System / Game Gear / SG-1000 emulator, debugger and embedded MCP server for macOS, Windows, Linux, BSD and RetroArch.

893. **[daan](https://github.com/pluveto/daan)** - ⭐ 333
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

894. **[open-mcp](https://github.com/wegotdocs/open-mcp)** - ⭐ 333

895. **[gptr-mcp](https://github.com/assafelovic/gptr-mcp)** - ⭐ 332
   MCP server for enabling LLM applications to perform deep research via the MCP protocol

896. **[moling](https://github.com/gojue/moling)** - ⭐ 332
   MoLing is a computer-use and browser-use based MCP server. It is a locally deployed, dependency-free office AI assistant.

897. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 331
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

898. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 331
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

899. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 331
   Lean Theorem Prover MCP

900. **[laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server)** - ⭐ 330
   A Laravel package for implementing secure Model Context Protocol servers using Streamable HTTP and SSE transport, providing real-time communication and a scalable tool system for enterprise environments.

901. **[redd-archiver](https://github.com/19-84/redd-archiver)** - ⭐ 329
...
902. **[MaaMCP](https://github.com/MAA-AI/MaaMCP)** - ⭐ 329
   基于 MaaFramework 的 MCP 服务器 为 AI 助手提供 Android 设备和 Windows 桌面自动化能力

903. **[css-mcp](https://github.com/stolinski/css-mcp)** - ⭐ 328

904. **[real-estate-mcp](https://github.com/tae0y/real-estate-mcp)** - ⭐ 327
   Ask Claude about Korean apartment prices — powered by MOLIT's open API

905. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 326
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

906. **[memora](https://github.com/agentic-box/memora)** - ⭐ 326
   Give your AI agents persistent memory.

907. **[apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server)** - ⭐ 325
   A MCP Server for APK Tool (Part of Android Reverse Engineering MCP Suites)

908. **[tinystruct](https://github.com/tinystruct/tinystruct)** - ⭐ 324
...
909. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 324
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

910. **[safe-mcp](https://github.com/safe-agentic-framework/safe-mcp)** - ⭐ 324
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

911. **[mcp-database-server](https://github.com/executeautomation/mcp-database-server)** - ⭐ 323
   MCP Database Server is a new MCP Server which helps connect with Sqlite, SqlServer and Posgresql Databases

912. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 322
...
913. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 322
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

914. **[wexin-read-mcp](https://github.com/Bwkyd/wexin-read-mcp)** - ⭐ 322
   能够让大模型阅读微信公众号文章，使用浏览器模拟绕过反爬虫。

915. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 322
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

916. **[mssql_mcp_server](https://github.com/RichardHan/mssql_mcp_server)** - ⭐ 321
...
917. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 321
...
918. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 321
   RhinoMCP connects Rhino 3D to AI Agent through the Model Context Protocol (MCP)

919. **[codex-mcp-server](https://github.com/tuannvm/codex-mcp-server)** - ⭐ 321
   MCP server wrapper for OpenAI Codex CLI that enables Claude Code to leverage Codex's AI capabilities directly.

920. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 320
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

921. **[emcee](https://github.com/mattt/emcee)** - ⭐ 320
   MCP generator for OpenAPIs 🫳🎤💥

922. **[sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh)** - ⭐ 320
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

923. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 319
   This is a Minecraft Base Client

924. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 319
   MCP Server for interacting with Salesforce instances

925. **[cymbal-air-toolbox-demo](https://github.com/GoogleCloudPlatform/cymbal-air-toolbox-demo)** - ⭐ 318
...
926. **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** - ⭐ 318
...
927. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 317
   A Model Context Protocol server for building an investor agent

928. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 317
   An MCP server to create secure code sandbox environment for executing code within Docker containers. This MCP server provides AI applications with a safe and isolated environment for running code while maintaining security through containerization.

929. **[pydantic-resolve](https://github.com/allmonday/pydantic-resolve)** - ⭐ 317
   A tool for building domain layer modeling and use case assembly.

930. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 317
   Mapbox Model Context Protocol (MCP) server

931. **[UnrealClaude](https://github.com/Natfii/UnrealClaude)** - ⭐ 317
   Claude Code CLI integration for Unreal Engine 5.7 - Get AI coding assistance with built-in UE5.7 documentation context directly in the editor.

932. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 316
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

933. **[deep-research-mcp](https://github.com/teelaitila/deep-research-mcp)** - ⭐ 316

934. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 315

935. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 314
   Repo of skills for autogen studio using model context protocol (mcp)

936. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 314
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

937. **[generator](https://github.com/context-hub/generator)** - ⭐ 313
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

938. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 313

939. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 312
...
942. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 309

943. **[RenderDocMCP](https://github.com/halby24/RenderDocMCP)** - ⭐ 308

944. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 306
   api router for MCP Servers

945. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 306
   Model Context Protocol server for DeepSeek's advanced language models

946. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 306
   Source code of minecraft 1.12

947. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 305
   IAM Policy Autopilot is an open source static code analysis tool that helps you quickly create baseline AWS IAM policies that you can refine as your application evolves. This tool is available as a command-line utility and MCP server for use within AI coding assistants for quickly building IAM policies.

948. **[sdk](https://github.com/smithery-ai/sdk)** - ⭐ 305
   Smithery helps AI agents access external services via a unified gateway.

949. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 305
   Turn any openapi file into an mcp server, with just the tools you need.

950. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 305
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

951. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 304
   A working pattern for SSE-based MCP clients and servers

952. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 302
   MCP server for Windows OS automation

953. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 302
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

954. **[telegram-mcp](https://github.com/chaindead/telegram-mcp)** - ⭐ 302
   Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.

955. **[stitch](https://github.com/gemini-cli-extensions/stitch)** - ⭐ 302
   The Stitch extension for Gemini CLI enables you to interact with the Stitch MCP server using natural language commands. 

956. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 301
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

957. **[mcp-neovim-server](https://github.com/bigcodegen/mcp-neovim-server)** - ⭐ 301
   Control Neovim using Model Context Protocol (MCP) and the official neovim/node-client JavaScript library

958. **[Lucid](https://github.com/get-Lucid/Lucid)** - ⭐ 301
   An intelligence layer grounding autonomous agents in verified, real-time knowledge at scale.

959. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 301
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

960. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 300
...
961. **[google-ads-mcp](https://github.com/googleads/google-ads-mcp)** - ⭐ 300

962. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 299
   Agentic RAG for any scenario. Customize sources, depth, and width

963. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 299
   MCP implementation of Claude Code capabilities and more

964. **[ddddocr](https://github.com/86maid/ddddocr)** - ⭐ 298
...
965. **[sentrux](https://github.com/sentrux/sentrux)** - ⭐ 298
...
966. **[ZeroToken](https://github.com/AMOS144/ZeroToken)** - ⭐ 298
...
967. **[mcp-linker](https://github.com/milisp/mcp-linker)** - ⭐ 297
...
968. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 297
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

969. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 296
   Discover Exceptional MCP Servers

970. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 296
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

971. **[robloxstudio-mcp](https://github.com/boshyxd/robloxstudio-mcp)** - ⭐ 295
   Create agentic AI workflows in ROBLOX Studio

972. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 294
   Obsidian MCP (Model Context Protocol) Server

973. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 294
...
974. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 293
   Minimal MCP Server for Aider

975. **[imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp)** - ⭐ 293
   An MCP server providing tools for image processing operations

976. **[mcp-server-12306](https://github.com/drfccv/mcp-server-12306)** - ⭐ 292
   12306 MCP Server​​ 是一个基于 ​​Model Context Protocol (MCP)​​ 的高性能火车票查询后端系统。它通过标准化接口提供官方 12306 的实时数据服务，包括余票查询、车站信息、列车经停站、中转换乘方案等核心功能。

977. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 292
...
978. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 292
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

979. **[consult7](https://github.com/szeider/consult7)** - ⭐ 292
   MCP server to consult a language model with large context size

980. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 291
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

981. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 291

982. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 291

983. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 291
...
984. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 291
   MCP Server for Odoo

985. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 291
   Django MCP Server is a Django extensions to easily enable AI Agents to interact with Django Apps through the Model Context Protocol it works equally well on WSGI and ASGI

986. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 290
   The specification for the Universal Tool Calling Protocol

987. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 290
...
988. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 290
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

989. **[nova-proximity](https://github.com/Nova-Hunting/nova-proximity)** - ⭐ 287
   Nova-Proximity is a MCP and Agent Skills security scanner powered with NOVA

990. **[perplexity-mcp](https://github.com/jsonallen/perplexity-mcp)** - ⭐ 287
   A Model Context Protocol (MCP) server that provides web search functionality using Perplexity AI's API.

991. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 286
   MCP server for OpenAI o3 web search

992. **[mcp-manager](https://github.com/amxv/mcp-manager)** - ⭐ 286
   simple web ui to manage mcp (model context protocol) servers in the claude app

993. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 285
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

994. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 285
   MCP server for Claude to access Outlook data via Microsoft Graph API

995. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 284
...
996. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 284
   🔍 A Model Context Protocol (MCP) server providing unified access to multiple search engines (Tavily, Brave, Kagi), AI tools (Perplexity, FastGPT), and content processing services (Jina AI, Kagi). Combines search, AI responses, content processing, and enhancement features through a single interface.

997. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 284
   Home Assistant MCP Server

998. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 284
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

999. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 284
...
1000. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 283
   Code to process many kinds of content by an author into an MCP server

1001. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 283
   MCP server for browser automation using Playwright

1002. **[alfanous](https://github.com/Alfanous-team/alfanous)** - ⭐ 283
   Alfanous is an Arabic search engine API provides the simple and advanced search in Quran , more features and many interfaces...

1003. **[codemogger](https://github.com/glommer/codemogger)** - ⭐ 283
   Codemogger is a code indexing library and MCP server for AI coding agents

1004. **[memorix](https://github.com/AVIDS2/memorix)** - ⭐ 283
   Local-first memory platform for AI coding agents. Git memory, reasoning memory, and cross-agent recall via MCP.

1005. **[agents](https://github.com/astronomer/agents)** - ⭐ 282
   AI agent tooling for data engineering workflows.

1006. **[gemini-kit](https://github.com/nth5693/gemini-kit)** - ⭐ 282
   🚀 19 AI Agents + 44 Commands for Gemini CLI - Code 10x faster with auto planning, testing, review & security

1007. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 281
   Agentic RAG for any scenario. Customize sources, depth, and width

1008. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 280
   simple web ui to manage mcp (model context protocol) servers in the claude app

1009. **[laravel-claude-code-setup](https://github.com/laraben/laravel-claude-code-setup)** - ⭐ 279
   One-command setup for AI-powered Laravel development with Claude Code and MCP servers

1010. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 279
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

1011. **[garmin_mcp](https://github.com/Taxuspt/garmin_mcp)** - ⭐ 279
   MCP server to access Garmin data

1012. **[MCP-handle](https://github.com/WeatherPal-AI/MCP-handle)** - ⭐ 278
   MCP integration platforms making AI-Agents developers focusing on their own tasks

1013. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 278
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

1014. **[flyto-core](https://github.com/flytohub/flyto-core)** - ⭐ 278
   The open-source execution engine for AI agents. 412 modules, MCP-native, triggers, queue, versioning, metering.

1015. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 277
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

1016. **[next-lens](https://github.com/1weiho/next-lens)** - ⭐ 277
   A CLI that scans Next.js routes and provides quick insights from your terminal, web UI, and MCP.

1017. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 277
   SpringAI，LLM，MCP，Embedding

1018. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 276
   A Model Context Protocol Server for MongoDB

1019. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 276
   Context-Engine MCP - Agentic Context Compression Suite

1020. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 276
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

1021. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 275
   Model Context Protocol (MCP) Server for dify workflows

1022. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 275
   Standardized environment infrastructure for Agentic AI development.

1023. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 274
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

1024. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 274
   Bringing Human Capabilities to AI Agents

1025. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 273
   Apollo MCP Server

1026. **[pageindex-mcp](https://github.com/VectifyAI/pageindex-mcp)** - ⭐ 273
...
1027. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 272
   MCP server for Bazi (八字) information

1028. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 272
   MCP Server for Tree-sitter

1029. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 272
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

1030. **[mcp](https://github.com/cloudflare/mcp)** - ⭐ 272
   MCP server for the Cloudflare API

1031. **[proximity](https://github.com/Nova-Hunting/proximity)** - ⭐ 271
   Proximity is a MCP security scanner powered with NOVA

1032. **[jinni](https://github.com/smat-dev/jinni)** - ⭐ 271
   Bring your project into LLM context - tool and MCP server

1033. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 271
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

1034. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 271
   CAD MCP Server

1035. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 271
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

1036. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 270
   Model Context Protocol server implementation for Reddit

1037. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 270
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

1038. **[BitFun](https://github.com/GCWing/BitFun)** - ⭐ 270
...
1039. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 269
   Proximity is a MCP security scanner powered with NOVA

1040. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 269
   An MCP server for Massive.com Financial Market Data

1041. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 268
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

1042. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 268
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1043. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 268
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

1044. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 267
   Apache Doris MCP Server

1045. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 267
...
1046. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 266
   Volcengine MCP Servers

1047. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 265
   小智AI客户端，目前主要用于MCP的对接

1048. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 265
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

1049. **[meta-ads-analyzer](https://github.com/mathiaschu/meta-ads-analyzer)** - ⭐ 265
   Meta Ads Analyzer skill + MCP server for Claude Code. Breakdown Effect, Learning Phase, and expert-level campaign diagnosis.

1050. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 264
   This MCP server provides documentation about Strands Agents to your GenAI tools, so you can use your favorite AI coding assistant to vibe-code Strands Agents.

1051. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 264
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

1052. **[PerformanceMonitor](https://github.com/erikdarlingdata/PerformanceMonitor)** - ⭐ 264
   Free, open-source SQL Server performance monitoring — 32 collectors, real-time alerts, graphical plan viewer, MCP server for AI analysis. Replaces SentryOne/Solarwinds. Supports SQL 2016-2025, Azure SQL, AWS RDS.

1053. **[MODULAR-RAG-MCP-SERVER](https://github.com/jerry-ai-dev/MODULAR-RAG-MCP-SERVER)** - ⭐ 264
...
1054. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 263
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

1055. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 261
...
1056. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 260
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

1057. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 259
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

1058. **[oreilly-ai-agents](https://github.com/sinanuozdemir/oreilly-ai-agents)** - ⭐ 259
   An introduction to the world of AI Agents

1059. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 259
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

1060. **[api200](https://github.com/API-200/api200)** - ⭐ 258
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

1061. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 258
   Lightweight MCP server for Spotify

1062. **[n8n-claw](https://github.com/freddy-schuetz/n8n-claw)** - ⭐ 258
...
1063. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 257
   A collection of MCP servers

1064. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 257
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

1065. **[api-agent](https://github.com/agoda-com/api-agent)** - ⭐ 257
   Universal MCP server for GraphQL/REST APIs

1066. **[swiss-ai-call-agent](https://github.com/Chrissotino/swiss-ai-call-agent)** - ⭐ 256
...
1067. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 256
   A code reasoning MCP server, a fork of sequential-thinking

1068. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 256
...
1069. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 255

1070. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 255
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

1071. **[claude-code-tool-manager](https://github.com/tylergraydev/claude-code-tool-manager)** - ⭐ 254
   GUI app to manage MCP servers for Claude Code

1072. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 254
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

1073. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

1074. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 253
...
1075. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 252
   hydra-ai

1076. **[domain-check](https://github.com/saidutt46/domain-check)** - ⭐ 252
...
1077. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 252
...
1078. **[appium-mcp](https://github.com/appium/appium-mcp)** - ⭐ 252
   Appium MCP on Steroids!

1079. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 251
   Semantic code searcher and codebase utility

1080. **[Windows-MCP.Net](https://github.com/shuyu-labs/Windows-MCP.Net)** - ⭐ 251
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

1081. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 250
   MCP server(s) for Aipolabs ACI.dev

1082. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 250
...
1083. **[pipelock](https://github.com/luckyPipewrench/pipelock)** - ⭐ 250
...
1084. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 249
   MCP server implementation for Google's Gemini API

1085. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 249
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

1086. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 248
   MCP Interface for Video Jungle

1087. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 248
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

1088. **[claude-recall](https://github.com/nhevers/claude-recall)** - ⭐ 247
   Long-term memory layer for MoltBot & Claude Code that learns and recalls your project context automatically

1089. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 247
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

1090. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 247
   AWS MCP Proxy Server

1091. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 247
...
1092. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 247
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

1093. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 246
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1094. **[DebugMCP](https://github.com/microsoft/DebugMCP)** - ⭐ 246
   Gift your VS Code agent a real debugger: breakpoints, stepping, inspection.

1095. **[coolify-mcp](https://github.com/StuMason/coolify-mcp)** - ⭐ 246
   MCP server for Coolify — 38 optimized tools for managing self-hosted PaaS through AI assistants

1096. **[dat](https://github.com/hexinfo/dat)** - ⭐ 245
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

1097. **[AIDA](https://github.com/Vasco0x4/AIDA)** - ⭐ 245
   AI-Driven Security Assessment - Connect AI to 400+ pentesting tools via MCP

1098. **[Aegis](https://github.com/Justin0504/Aegis)** - ⭐ 245
...
1099. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 244
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

1100. **[chat-mcp](https://github.com/AI-QL/chat-mcp)** - ⭐ 244
   A Desktop Chat App that leverages MCP(Model Context Protocol) to interface with other LLMs.

1101. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 244
   A list of open-source AI projects you can use to generate income easily.

1102. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 244
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

1103. **[octo-terminal-releases](https://github.com/johunsang/octo-terminal-releases)** - ⭐ 244
...
1104. **[ssh-mcp-server](https://github.com/classfang/ssh-mcp-server)** - ⭐ 244
   基于 SSH 的 MCP 服务器 🧙‍♀️。已被MCP官方收录 🎉。 SSH MCP Server 🧙‍♀️. It has been included in the community MCP repository 🎉.

1105. **[embodied-claude](https://github.com/lifemate-ai/embodied-claude)** - ⭐ 243
   Claudeに身体性を与えるMCP群

1106. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 243
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

1107. **[agentrove](https://github.com/Mng-dev-ai/agentrove)** - ⭐ 243
...
1108. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 243
   A TypeScript streamable HTTP and SSE proxy for MCP servers that use stdio transport.

1109. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 242
   An experimental MCP Server for foundry built for Solidity devs

1110. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 242
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

1111. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 242
   MCP stdio server for frida

1112. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 242
   The evaluation benchmark on MCP servers

1113. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 242
   🔥 Model Context Protocol (MCP) server for Firebase.

1114. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 242
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

1115. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 241
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

1116. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 241
   Simplified Gemini for Claude Code. 

1117. **[pi-mcp-adapter](https://github.com/nicobailon/pi-mcp-adapter)** - ⭐ 241
   Token-efficient MCP adapter for Pi coding agent

1118. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 240
   Turn any MCP server into a Python module

1119. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 240
   Easy guide to installing Claude Code MCPs globally on your machine.

1120. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 239
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

1121. **[PIXRA](https://github.com/dodufish/PIXRA)** - ⭐ 239
   Pixelize the real world on-chain

1122. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 239
   Code Runner MCP Server

1123. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 239
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

1124. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 239
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

1125. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 238

1126. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 238
   A MCP server for our beloved terminal multiplexer tmux.

1127. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 237
   MCP Server for Telegram

1128. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 237
   Playwright MCP fork that works with Cloudflare Browser Rendering

1129. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 237
   Zerodha Kite MCP server

1130. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 236
   Lightweight agent orchestration dev tool that lives in your repo

1131. **[kindly-web-search-mcp-server](https://github.com/Shelpuk-AI-Technology-Consulting/kindly-web-search-mcp-server)** - ⭐ 236
...
1132. **[mcp-foundry](https://github.com/microsoft-foundry/mcp-foundry)** - ⭐ 235
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

1133. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 235
...
1134. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 235
   Lightweight C++ MCP (Model Context Protocol) SDK

1135. **[ida-mcp-rs](https://github.com/blacktop/ida-mcp-rs)** - ⭐ 234
   Headless IDA Pro MCP Server

1136. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 233
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

1137. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 232
   A Model Context Protocol (MCP) server that enables natural language queries to databases

1138. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 232
   MCP server for TouchDesigner

1139. **[colab-mcp](https://github.com/googlecolab/colab-mcp)** - ⭐ 232
   An MCP server for interacting with Google Colab

1140. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 231
...
1141. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 231
   Creates a simple MCP tool server with "streaming" HTTP.

1142. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 231
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

1143. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 231
...
1144. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 231
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

1145. **[Dex](https://github.com/davekilleen/Dex)** - ⭐ 231
   Your AI Chief of Staff — a personal operating system starter kit that adapts to your role. No coding required.

1146. **[ScienceClaw](https://github.com/beita6969/ScienceClaw)** - ⭐ 231
   🔬🦞 A self-evolving AI research colleague for scientists. 285 skills, zero hallucination, persistent memory.

1147. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 230
   MCP server for Anki via AnkiConnect

1148. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 230
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

1149. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 230
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

1150. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 230
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

1151. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 230
   A SEC EDGAR MCP (Model Context Protocol) Server

1152. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 229
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

1153. **[remote-swe-agents](https://github.com/aws-samples/remote-swe-agents)** - ⭐ 229
   Autonomous SWE agent working in the cloud! (a.k.a. Vibe coding with Bedrock)

1154. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 229
   A Model Context Protocol (MCP) server for interacting with Twitter.

1155. **[data-go-mcp-servers](https://github.com/Koomook/data-go-mcp-servers)** - ⭐ 229
   Korea public data portal (data.go.kr) API MCP servers

1156. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 228
...
1157. **[lokka](https://github.com/merill/lokka)** - ⭐ 228
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

1158. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 228
...
1159. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 228
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1160. **[claude-config-editor](https://github.com/gagarinyury/claude-config-editor)** - ⭐ 227
...
1161. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

1162. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 227
...
1163. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 227
   Penpot's official MCP Server

1164. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 226
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

1165. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 226
   Model Context Protocol server to run commands (tool: `runProcess`)

1166. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 225
   Penpot MCP server

1167. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 224
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

1168. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 224
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

1169. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 224
   Your own Claude Code UI, sandbox, in-browser VS Code, terminal, multi-provider support (Anthropic, OpenAI, GitHub Copilot, OpenRouter), custom skills, and MCP servers.

1170. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 224
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

1171. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 224
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

1172. **[unity-cli-loop](https://github.com/hatayama/unity-cli-loop)** - ⭐ 224
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1173. **[domainstack.io](https://github.com/jakejarvis/domainstack.io)** - ⭐ 223
   🧰 All-in-one domain name intelligence as a service

1174. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 223
...
1175. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 223
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1176. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 222

1177. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 222
...
1178. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 222

1179. **[overseer](https://github.com/dmmulroy/overseer)** - ⭐ 222
   CLI & Codemode MCP server for agent task management

1180. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 221
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

1181. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 221
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

1182. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 221

1183. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 221
   Model Context Protocol Servers for Milvus

1184. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 221
...
1185. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 221
   MCP Server for ServiceNow

1186. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 221
   mindmap, mcp server, artifact

1187. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 220
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1188. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
1189. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 219
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

1190. **[skyll](https://github.com/assafelovic/skyll)** - ⭐ 219
   A tool for AI agents to discover and learn skills autonomously

1191. **[desktop](https://github.com/agentify-sh/desktop)** - ⭐ 219
...
1192. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 218
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

1193. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 217

1194. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 217
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

1195. **[claude-historian-mcp](https://github.com/Vvkmnn/claude-historian-mcp)** - ⭐ 217
   📜 An MCP server for conversation history search and retrieval in Claude Code

1196. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 217
   Context layer for your product. Connect your agents and chat to 1st and 3rd party MCP servers!

1197. **[mcp-servers](https://github.com/cursor/mcp-servers)** - ⭐ 217
   A list of MCP (Model Context Protocol) servers for developer tools and services

1198. **[jebmcp](https://github.com/flankerhqd/jebmcp)** - ⭐ 217

1199. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 216
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1200. **[tentix](https://github.com/labring/tentix)** - ⭐ 216
...
1201. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 216
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

1202. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 216

1203. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 216
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

1204. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 216
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1205. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 215
   Razorpay's Official MCP Server

1206. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 214
   Agent MCP for ffmpeg

1207. **[airbroke](https://github.com/icoretech/airbroke)** - ⭐ 214
   🔥 Lightweight, Airbrake/Sentry-compatible, PostgreSQL-based Open Source Error Catcher

1208. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 214
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

1209. **[agent-skills](https://github.com/jdrhyne/agent-skills)** - ⭐ 214
   A collection of AI agent skills for Clawdbot, Claude Code, Codex

1210. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 214
   Homeassistant MCP server for 小智AI

1211. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 213
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1212. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 212
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

1213. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 211
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1214. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 211
   Run and monitor MCP servers locally

1215. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 211
   🔎 A MCP server for Unsplash image search.

1216. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 211
   Pure Rust implementation of MCP server for headless terminal 

1217. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 211
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

1218. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 210

1219. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 210
   A Multi-modal MCP client for voice powered agentic workflows

1220. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 210
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

1221. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 210
   An MCP server to use Sora video generation APIs

1222. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 210

1223. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 210
   Hugging Face MCP Server

1224. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 210
...
1225. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 209
   A ReAct-Based Highly Robust Autonomous Agent Framework.

1226. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 209
   ModelContextProtocol for Figma's REST API

1227. **[jetski](https://github.com/hyprmcp/jetski)** - ⭐ 209
...
1228. **[vurb.ts](https://github.com/vinkius-labs/vurb.ts)** - ⭐ 209
...
1229. **[polymarket-mcp-server](https://github.com/caiovicentino/polymarket-mcp-server)** - ⭐ 209
   🤖 AI-Powered MCP Server for Polymarket - Enable Claude to trade prediction markets with 45 tools, real-time monitoring, and enterprise-grade safety features

1230. **[vibing-steampunk](https://github.com/oisee/vibing-steampunk)** - ⭐ 209
   vs-punk: ADT to MCP bridge - Vibe code in ABAP / AMDP

1231. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 208
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

1232. **[lyraios](https://github.com/GalaxyLLMCI/lyraios)** - ⭐ 207
...
1233. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 207
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

1234. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 207
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

1235. **[uLoopMCP](https://github.com/hatayama/uLoopMCP)** - ⭐ 207
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1236. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 207
   interactive programming of melodies, producing MIDI 

1237. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 206
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

1238. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 206
   MCP security wrapper

1239. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 206
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

1240. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 206
   MCP server for Dynatrace Observability

1241. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 206
...
1242. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 205

1243. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

1244. **[AutomatedEmulation](https://github.com/iknowjason/AutomatedEmulation)** - ⭐ 205
...
1245. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 205
   Model Context Protocol tool support for LangChain

1246. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 205
...
1247. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 205
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

1248. **[mcp-fusion](https://github.com/vinkius-labs/mcp-fusion)** - ⭐ 204
   MCP Fusion - The framework for AI-native MCP servers. 

1249. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 204
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

1250. **[claude-self-reflect](https://github.com/ramakay/claude-self-reflect)** - ⭐ 204
   Claude forgets everything. This fixes that. 🔗 www.npmjs.com/package/claude-self-reflect

1251. **[mcp-launchpad](https://github.com/kenneth-liao/mcp-launchpad)** - ⭐ 203
...
1252. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 203
   Self-hosted AI RAG + MCP Platform

1253. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 202
   A Tiny Terminal Chat App for AI Models with MCP Client Support

1254. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 202
   Tableau's official MCP Server. Helping Agents see and understand data.

1255. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 202
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1256. **[forgetful](https://github.com/ScottRBK/forgetful)** - ⭐ 201
   Opensource Memory for Agents

1257. **[marionette_mcp](https://github.com/leancodepl/marionette_mcp)** - ⭐ 201
...
1258. **[unifi-mcp](https://github.com/sirkirby/unifi-mcp)** - ⭐ 201
   MCP servers for the UniFi suite of applications, Network, Protect, Access, and Drive

1259. **[claude-context-local](https://github.com/FarhanAliRaza/claude-context-local)** - ⭐ 200
...
1260. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

1261. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 200
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1262. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 200
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

1263. **[burp-mcp-agents](https://github.com/six2dez/burp-mcp-agents)** - ⭐ 200
   Practical setup guides and helpers to connect Burp Suite MCP Server to multiple AI backends (Codex, Gemini, Ollama, ...).

1264. **[wavefront](https://github.com/rootflo/wavefront)** - ⭐ 200
   🔥🔥🔥 Enterprise AI middleware, alternative to unifyapps, n8n, lyzr

1265. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 200
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1266. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 200
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1267. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 199
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

1268. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 199
   R MCP Server

1269. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 198
   A MCP Server for the RAG Web Browser Actor

1270. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 198
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

1271. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 198
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

1272. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 198
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

1273. **[Geargrafx](https://github.com/drhelius/Geargrafx)** - ⭐ 198
...
1274. **[facebook-ads-library-mcp](https://github.com/proxy-intell/facebook-ads-library-mcp)** - ⭐ 198
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1275. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 197
   这是一个专为开发企业级MCP server而设计的通用开发框架

1276. **[EdgeBox](https://github.com/BIGPPWONG/EdgeBox)** - ⭐ 197
...
1277. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 197
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

1278. **[RelaMind](https://github.com/El-12stu/RelaMind)** - ⭐ 197
   基于 AI 的个人成长轨迹分析系统，通过记录生活、回顾历史、分析模式帮助用户更好地理解自己，实现持续成长。包含智能路由、RAG 检索、自主任务智能体等功能。

1279. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 197
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

1280. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 197
   IMAP and SMTP via MCP Server

1281. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

1282. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 196
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

1283. **[unifi-network-mcp](https://github.com/sirkirby/unifi-network-mcp)** - ⭐ 196
   MCP server implementation for the UniFi network application

1284. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

1285. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 195
...
1286. **[agentregistry](https://github.com/agentregistry-dev/agentregistry)** - ⭐ 195
   Fast-track AI innovation with a centralized, trusted, curated registry

1287. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 194
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

1288. **[mcp-agent-graph](https://github.com/keta1930/mcp-agent-graph)** - ⭐ 194
   MCP Agent Graph is a Multi-Agent System built on the principles of Context Engineering

1289. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 194
   Sketchup Model Context Protocol

1290. **[Context-Engineering-for-Multi-Agent-Systems](https://github.com/Denis2054/Context-Engineering-for-Multi-Agent-Systems)** - ⭐ 194
...
1291. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 193
...
1292. **[bluebox](https://github.com/VectorlyApp/bluebox)** - ⭐ 193
   Index the world's undocumented APIs

1293. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 193
   Manage / Proxy / Secure your MCP Servers

1294. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 192
   Absurdly easy Model Context Protocol Servers in Typescript

1295. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 192

1296. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 192
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1297. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 192
...
1298. **[pasal](https://github.com/ilhamfp/pasal)** - ⭐ 192
...
1299. **[nanobanana-mcp-server](https://github.com/zhongweili/nanobanana-mcp-server)** - ⭐ 192

1300. **[mcp-proxy-server](https://github.com/ptbsare/mcp-proxy-server)** - ⭐ 191
   This server acts as a central hub for Model Context Protocol (MCP) resource servers.

1301. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 191
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

1302. **[markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server)** - ⭐ 191
   An MCP server for converting Markdown to interactive mind maps with export support (PNG/JPG/SVG).

1303. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 191
...
1304. **[JoySafeter](https://github.com/jd-opensource/JoySafeter)** - ⭐ 191
...
1305. **[h1-brain](https://github.com/PatrikFehrenbach/h1-brain)** - ⭐ 191
   MCP server that connects AI assistants to HackerOne for bug bounty hunting

1306. **[rocketride-server](https://github.com/rocketride-org/rocketride-server)** - ⭐ 191
   High-performance AI pipeline engine with a C++ core and 50+ Python-extensible nodes. Build, debug, and scale LLM workflows with 13+ model providers, 8+ vector databases, and agent orchestration, all from your IDE. Includes VS Code extension, TypeScript/Python SDKs, and Docker deployment.

1307. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 190
...
1308. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 190
   Neo4j official MCP Server

1309. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 189
   Supabase MCP server created in Python.

1310. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 189
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

1311. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 189
   Go protobuf compiler extension to turn any gRPC service into an MCP server

1312. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 189
   Connect your AI to your APIs on Postman

1313. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 189
   A Model Context Protocol (MCP) server providing access to Google Search Console

1314. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 189
   Tools to allow LLM clients to interact with Linux systems remotely

1315. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 188
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

1316. **[drawio2go](https://github.com/Menghuan1918/drawio2go)** - ⭐ 188
   A modern DrawIO editor application.  AI-Powered, Human-AI Collaboration | AI 加持，人机共绘drawio

1317. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

1318. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

1319. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

1320. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 187
   Discord MCP Server for Claude Integration

1321. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 187
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1322. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
   多平台 文生图/图生图 等能力接入MCP

1323. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 186

1324. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 186
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

1325. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 185
   A TypeScript framework for building MCP servers elegantly

1326. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 185
   MCP Server for Wazuh SIEM

1327. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

1328. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 184
   Model Context Protocol Servers in Quarkus

1329. **[AutoRedTeam-Orchestrator](https://github.com/Coff0xc/AutoRedTeam-Orchestrator)** - ⭐ 184
...
1330. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 183
   This extension enables developers to implement the MCP server features easily.

1331. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 183
   MCP for calling Siri Shorcuts from LLMs

1332. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 183
   Official Magic UI MCP server.

1333. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 183
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1334. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 183
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1335. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 183
   MCP Server for the Bilibili API, supporting various operations.

1336. **[siconos](https://github.com/siconos/siconos)** - ⭐ 182
   Simulation framework for nonsmooth dynamical systems

1337. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
1338. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

1339. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 182
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

1340. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 182
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

1341. **[4D-ARE](https://github.com/ybeven/4D-ARE)** - ⭐ 181
...
1342. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 181
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1343. **[integrate-mcp-with-copilot](https://github.com/skills/integrate-mcp-with-copilot)** - ⭐ 181
   Learn how to use MCP Servers with GitHub Copilot

1344. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 181
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1345. **[spring-ai-playground](https://github.com/JM-Lab/spring-ai-playground)** - ⭐ 181
...
1346. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 180

1347. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 180
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1348. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 180
   Official MCP server for Tripo

1349. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 180
   A simple CLI to install MCP servers into any client - auth included!

1350. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 179
   An MCP server for Anki

1351. **[opencode-studio](https://github.com/Microck/opencode-studio)** - ⭐ 179
   web GUI for securely managing local OpenCode configuration

1352. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

1353. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

1354. **[lucid-agents](https://github.com/daydreamsai/lucid-agents)** - ⭐ 178
...
1355. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 178
   Examples of using Pipedream's MCP server in your app or AI agent.

1356. **[osint-tools-mcp-server](https://github.com/frishtik/osint-tools-mcp-server)** - ⭐ 178
   MCP server exposing multiple OSINT tools for AI assistants like Claude

1357. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 178
...
1358. **[tradememory-protocol](https://github.com/mnemox-ai/tradememory-protocol)** - ⭐ 178
   Memory layer for AI trading agents. Outcome-weighted recall, autonomous strategy evolution, 15 MCP tools.

1359. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 177
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

1360. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 177
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1361. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 177
...
1362. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 177
   Model Context Protocol for x64dbg & x32dbg

1363. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 177
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1364. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 176
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

1365. **[aleph](https://github.com/Hmbown/aleph)** - ⭐ 176
   Skill + MCP server to turn your agent into an RLM. Load context, iterate with search/code/think tools, converge on answers.

1366. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 176
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1367. **[Revornix](https://github.com/Qingyon-AI/Revornix)** - ⭐ 176
...
1368. **[medusa](https://github.com/Pantheon-Security/medusa)** - ⭐ 176
...
1369. **[docs](https://github.com/strands-agents/docs)** - ⭐ 175
   Documentation for the Strands Agents SDK. A model-driven approach to building AI agents in just a few lines of code. 

1370. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 175
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1371. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 175
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1372. **[corpusos](https://github.com/Corpus-OS/corpusos)** - ⭐ 174
...
1373. **[tomcp](https://github.com/Ami3466/tomcp)** - ⭐ 174
   Turn any website or doc into an MCP server

1374. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 174
   A mongo db server for the model context protocol (MCP)

1375. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 174
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1376. **[memory-graph](https://github.com/memory-graph/memory-graph)** - ⭐ 174
   A graph DB-based MCP memory server for coding agents with intelligent relationship tracking

1377. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 173
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

1378. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 173
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1379. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 173
...
1380. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 173
   Typescript SDK to build MCP servers in an agnostic way

1381. **[command](https://github.com/scopecraft/command)** - ⭐ 172
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

1382. **[open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp)** - ⭐ 172
   An OpenStreetMap MCP server implementation that enhances LLM capabilities with location-based services and geospatial data.

1383. **[Companion](https://github.com/mattt/Companion)** - ⭐ 172
   Your neighborhood friendly MCP utility for macOS, iOS, and visionOS

1384. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 172
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1385. **[radare2-mcp](https://github.com/radareorg/radare2-mcp)** - ⭐ 172
   MCP stdio server for radare2

1386. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 171
   MCP server to work with Telegram through MTProto

1387. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 171
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

1388. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 171
   One MCP Server, All Your Apps, Privacy First

1389. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 171
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1390. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 171
   A MCP server to search for accurate academic articles.

1391. **[gbox](https://github.com/babelcloud/gbox)** - ⭐ 171
   Cli and MCP for gbox. Enable AI agents to operate Android/Browser/Desktop like human.

1392. **[Text2Sql.Net](https://github.com/AIDotNet/Text2Sql.Net)** - ⭐ 170
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1393. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 170

1394. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 170
...
1395. **[SharpToolsMCP](https://github.com/kooshi/SharpToolsMCP)** - ⭐ 170
   A suite of MCP tools for AIs to analyze and modify C# solutions with high signal, Roslyn powered context.

1396. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 170
...
1397. **[everything-claude-code-zh](https://github.com/xu-xiang/everything-claude-code-zh)** - ⭐ 170
...
1398. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 169
   Turn a web server into an MCP server in one click without making any code changes.

1399. **[y-gui](https://github.com/luohy15/y-gui)** - ⭐ 169
   A Tiny Web Chat App for AI Models with MCP Client Support

1400. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 169
   An MCP server to search for flights.

1401. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 169
   MCPSDK.dev(ToolSDK.ai)'s Awesome MCP Servers and Packages Registry and Database with Structured JSON configurations. Supports OAuth2.1, DCR...

1402. **[Text2Sql.Net](https://github.com/shuyu-labs/Text2Sql.Net)** - ⭐ 169
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1403. **[xiaoi](https://github.com/xvhuan/xiaoi)** - ⭐ 169
   小爱音箱语音通知工具：提供 CLI/TUI/MCP/Webhook 一键播报与控制音量，支持 PM2 常驻部署，支持docker部署。

1404. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 168
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1405. **[sibyl-research-system](https://github.com/Sibyl-Research-Team/sibyl-research-system)** - ⭐ 168
   Fully Autonomous AI Research System with Self-Evolution, built natively on Claude Code

1406. **[mevzuat-mcp](https://github.com/saidsurucu/mevzuat-mcp)** - ⭐ 168
   MCP Server for Searching Turkish Legislation

1407. **[gigabrain](https://github.com/legendaryvibecoder/gigabrain)** - ⭐ 168
   Local-first memory layer for OpenClaw, Codex App, and Codex CLI: capture, recall, dedupe, and native sync.

1408. **[AutoResearch-SibylSystem](https://github.com/Sibyl-Research-Team/AutoResearch-SibylSystem)** - ⭐ 168
   Fully Autonomous AI Research System with Self-Evolution, built natively on Claude Code

1409. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 167
   MCP Server for Postgres

1410. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 167
   Command line interface for MCP clients with secure execution and customizable security policies

1411. **[toolbase](https://github.com/Toolbase-AI/toolbase)** - ⭐ 167
   A desktop application that adds powerful tools to Claude and AI platforms

1412. **[gate22](https://github.com/aipotheosis-labs/gate22)** - ⭐ 167
...
1413. **[MCP-Salesforce](https://github.com/smn2gnt/MCP-Salesforce)** - ⭐ 166
   MCP Salesforce connector

1414. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 166
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1415. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 166
   Chat application with multi-agents system supports multi-models and MCP

1416. **[memov](https://github.com/memovai/memov)** - ⭐ 166
...
1417. **[shodh-memory](https://github.com/varun29ankuS/shodh-memory)** - ⭐ 166
...
1418. **[mcp-todoist](https://github.com/greirson/mcp-todoist)** - ⭐ 166
   MCP server that connects Claude to Todoist for natural language task and project   management with bulk operations

1419. **[c4-genai-suite](https://github.com/codecentric/c4-genai-suite)** - ⭐ 165
   c4 GenAI Suite

1420. **[slack-mcp-client](https://github.com/tuannvm/slack-mcp-client)** - ⭐ 165
...
1421. **[mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition)** - ⭐ 165
...
1422. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 165
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1423. **[dify-mcp-client](https://github.com/3dify-project/dify-mcp-client)** - ⭐ 164
   MCP Client as an Agent Strategy Plugin. Support GUI operation via UI-TARS-SDK.

1424. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 164
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1425. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 164
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1426. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 163
   MCP server for searching and querying PubMed medical papers/research database

1427. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 163
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1428. **[binary-ninja-headless-mcp](https://github.com/mrphrazer/binary-ninja-headless-mcp)** - ⭐ 163
   Headless Binary Ninja MCP server — giving AI agents deep reverse-engineering capabilities via 180 tools.

1429. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 163
   Official Railway MCP Server for interacting with your Railway account

1430. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 163
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1431. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 163
   MCP Server for Google Slides

1432. **[recall](https://github.com/joseairosa/recall)** - ⭐ 162
   Persistent cross-session memory for Claude & AI agents. Self-host on Redis/Valkey, or use the managed SaaS at recallmcp.com.

1433. **[mcp-codex-dev](https://github.com/FYZAFH/mcp-codex-dev)** - ⭐ 162
   MCP Server for Codex CLI integration - stateful code writing and review workflows

1434. **[sunpeak](https://github.com/Sunpeak-AI/sunpeak)** - ⭐ 162
   Local-first MCP App framework for ChatGPT Apps, Claude, and more.

1435. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 161
   MCP (Model Context Protocol) server for Weaviate

1436. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 161
...
1437. **[PolyMCP](https://github.com/poly-mcp/PolyMCP)** - ⭐ 161
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1438. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 161
   Model Context Protocol For R

1439. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 161
   Supercharge AI Agents, Safely

1440. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 161

1441. **[data-verify-mcp](https://github.com/CCCpan/data-verify-mcp)** - ⭐ 161
   中国数据核验 MCP Server | 身份核验/企业查询/车辆信息/OCR识别/风险评估 | 10个Tool覆盖5大类 | 微信: chenganp | 邮箱: 345048305@qq.com

1442. **[In-Memoria](https://github.com/pi22by7/In-Memoria)** - ⭐ 161
   Persistent Intelligence Infrastructure for AI Agents

1443. **[awesome-a2a](https://github.com/pab1it0/awesome-a2a)** - ⭐ 161
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place. 

1444. **[Axon.MCP.Server](https://github.com/ali-kamali/Axon.MCP.Server)** - ⭐ 160
...
1445. **[gemini-mcp](https://github.com/RLabs-Inc/gemini-mcp)** - ⭐ 160
   MCP Server that enables Claude code to interact with Gemini

1446. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 160
   DataForSEO API modelcontextprotocol server 

1447. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 159
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1448. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 159
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1449. **[ai-skills](https://github.com/sanjay3290/ai-skills)** - ⭐ 159
   Collection of agent skills for AI coding assistants

1450. **[agent-craft](https://github.com/Annyfee/agent-craft)** - ⭐ 159
   AI Agent 教学仓库 | 系统化 LangChain、RAG、LangGraph、MCP 全栈实战代码 | 万字博客详解 | 开源可运行示例 | 从零构建智能体

1451. **[codex-mcp-server](https://github.com/cexll/codex-mcp-server)** - ⭐ 158
   Codex Mcp Server 

1452. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 158
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1453. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 158
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1454. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 158
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1455. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 158
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1456. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 158
...
1457. **[mcp-client-slackbot](https://github.com/sooperset/mcp-client-slackbot)** - ⭐ 158
   Simple Slackbot MCP Client

1458. **[claude-code-open](https://github.com/kill136/claude-code-open)** - ⭐ 158
   Open source AI coding platform with Web IDE, multi-agent system, 37+ tools, MCP protocol. MIT licensed.

1459. **[eShopLite](https://github.com/Azure-Samples/eShopLite)** - ⭐ 158
   eShopLite is a set of reference .NET applications implementing an eCommerce site with features like Semantic Search, MCP, Reasoning models and more.

1460. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 158
...
1461. **[mcp-summarizer](https://github.com/0xshellming/mcp-summarizer)** - ⭐ 158
   MCP Server for AI Summarization

1462. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 158
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1463. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 157
   An MCP server for fetching URLs / Youtube video transcript.

1464. **[cachebro](https://github.com/glommer/cachebro)** - ⭐ 157
   File cache with diff tracking for AI coding agents. Drop-in MCP server that cuts token usage by 26%.

1465. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 157
   StarRocks MCP (Model Context Protocol) Server

1466. **[logfire-mcp](https://github.com/pydantic/logfire-mcp)** - ⭐ 157
   The Logfire MCP Server is here! :tada:

1467. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 157
...
1468. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 156
   Scrapeless Mcp Server

1469. **[memorizer](https://github.com/petabridge/memorizer)** - ⭐ 156
   Vector-search powered agent memory MCP server

1470. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 156
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1471. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 156
   Model Context Protocol (MCP) server for constraint optimization and solving"

1472. **[alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server)** - ⭐ 155

1473. **[refref](https://github.com/refrefhq/refref)** - ⭐ 155
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1474. **[fim-one](https://github.com/fim-ai/fim-one)** - ⭐ 155
   LLM-powered Agent Runtime with Dynamic DAG Planning & Concurrent Execution

1475. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 154
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1476. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 154
   A Model Context Protocol server for MySQL database operations

1477. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 154
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1478. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 154
   Instagram Direct messages MCP

1479. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 154

1480. **[bocha-search-mcp](https://github.com/BochaAI/bocha-search-mcp)** - ⭐ 154
   Bocha Search MCP Server.

1481. **[chatgpt-copilot](https://github.com/feiskyer/chatgpt-copilot)** - ⭐ 153
   ChatGPT Copilot Extension for Visual Studio Code

1482. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 153
   Make MCP Server

1483. **[solana-mcp](https://github.com/sendaifun/solana-mcp)** - ⭐ 153
   A Model Context Protocol server for interacting with the Solana blockchain, powered by the Solana Agent Kit (https://github.com/sendaifun/solana-agent-kit)

1484. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 153
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1485. **[open-responses-server](https://github.com/teabranch/open-responses-server)** - ⭐ 153
   Wraps any OpenAI API interface as Responses with MCPs support so it supports Codex. Adding any missing stateful features. Ollama and Vllm compliant.

1486. **[mcp-server-metamcp](https://github.com/metatool-ai/mcp-server-metamcp)** - ⭐ 153
   MCP Server MetaMCP manages all your other MCPs in one MCP.

1487. **[plan-cascade](https://github.com/Taoidle/plan-cascade)** - ⭐ 153
...
1488. **[hevy-mcp](https://github.com/chrisdoc/hevy-mcp)** - ⭐ 153
   Manage your Hevy workouts, routines, folders, and exercise templates. Create and update sessions faster, organize plans, and search exercises to build workouts quickly. Stay synced with changes so your training log is always up to date.

1489. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 153
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1490. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 152
   A simple MCP server to search for documentation (tutorial)

1491. **[web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp)** - ⭐ 152
   Deep Research for crypto - free & fully local

1492. **[awesome-x402](https://github.com/xpaysh/awesome-x402)** - ⭐ 152
   🚀 Curated list of x402 resources: HTTP 402 Payment Required protocol for blockchain payments, crypto micropayments, AI agents, API monetization. Includes SDKs (TypeScript, Python, Rust), examples, facilitators (Coinbase, Cloudflare), MCP integration, tutorials. Accept USDC payments with one line of code. Perfect for AI agent economy.

1493. **[mcp-gateway](https://github.com/lightconetech/mcp-gateway)** - ⭐ 152
   A gateway demo for MCP SSE Server

1494. **[computer-use-mcp](https://github.com/domdomegg/computer-use-mcp)** - ⭐ 152
   💻 Give AI models complete control of your computer (probably a bad idea)

1495. **[dedalus-mcp-python](https://github.com/dedalus-labs/dedalus-mcp-python)** - ⭐ 152
   A simple and performant Model Context Protocol framework for Python.

1496. **[sap-skills](https://github.com/secondsky/sap-skills)** - ⭐ 152
...
1497. **[GEmojiSharp](https://github.com/hlaueriksson/GEmojiSharp)** - ⭐ 151
   :octocat: GitHub Emoji for C#, dotnet and beyond

1498. **[relay](https://github.com/prism-php/relay)** - ⭐ 151
   An MCP client tool for Prism

1499. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 151
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1500. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 151
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1501. **[ClaudeR](https://github.com/IMNMV/ClaudeR)** - ⭐ 151
...
1502. **[nextcloud-mcp-server](https://github.com/cbcoutinho/nextcloud-mcp-server)** - ⭐ 151
   Nextcloud MCP Server

1503. **[mcp-redmine](https://github.com/runekaagaard/mcp-redmine)** - ⭐ 151
   A redmine MCP server covering close to 100% of redmines API

1504. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 150
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1505. **[seo-research-mcp](https://github.com/egebese/seo-research-mcp)** - ⭐ 150
...
1506. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 150
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1507. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 150
   Manage Your Kubernetes Cluster with k8s mcp-server

1508. **[claude-in-mobile](https://github.com/AlexGladkov/claude-in-mobile)** - ⭐ 150
...
1509. **[Express-REST-API-and-MCP-Server-Framework](https://github.com/iolufemi/Express-REST-API-and-MCP-Server-Framework)** - ⭐ 149
...
1510. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 149
   🚀🎬灵活、高效、可扩展，专属剪辑配音工具箱，释放创作潜力 . Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1511. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 149
   Let LLMs control embedded devices via the Model Context Protocol.

1512. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 149
   MCP Server for using any LLM as a Tool

1513. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 149
   MCP server to download entire websites

1514. **[aicode-toolkit](https://github.com/AgiFlow/aicode-toolkit)** - ⭐ 149
   Toolkit for Coding Agents to work reliably with repo of any size.

1515. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 149
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1516. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 149

1517. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 149
   MariaDB MCP (Model Context Protocol) server implementation

1518. **[MCPHub-Desktop](https://github.com/Jeamee/MCPHub-Desktop)** - ⭐ 148
   Desktop APP for Discover and Install MCP Servers

1519. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 148
   MCP server for discord bot

1520. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 148
   Catch MCP server issues before your agents do.

1521. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 148
   A Model Context Protocol server for calculating.

1522. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 148
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1523. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 147
   Dynamically expose tools from proxied servers based on an Agent Persona

1524. **[ultimate_mcp_client](https://github.com/Dicklesworthstone/ultimate_mcp_client)** - ⭐ 147
...
1525. **[kom](https://github.com/weibaohui/kom)** - ⭐ 147
   kom 是一个用于 Kubernetes 操作的工具，SDK级的kubectl、client-go的使用封装。并且支持作为管理k8s 的 MCP server。 它提供了一系列功能来管理 Kubernetes 资源，包括创建、更新、删除和获取资源，甚至使用SQL查询k8s资源。这个项目支持多种 Kubernetes 资源类型的操作，并能够处理自定义资源定义（CRD）。 通过使用 kom，你可以轻松地进行资源的增删改查和日志获取以及操作POD内文件等动作。

1526. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 147
   Model Context Protocol server implementation for Figma API

1527. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 147
   A WhatsApp bot that can participate in group conversations, powered by AI. The bot monitors group messages and responds when mentioned.

1528. **[quick-data-mcp](https://github.com/disler/quick-data-mcp)** - ⭐ 147
   Prompt focused MCP Server for .json and .csv agentic data analytics for Claude Code

1529. **[eion](https://github.com/eiondb/eion)** - ⭐ 147
   Shared Memory Storage for Multi-Agent Systems

1530. **[deterministic-agent-control-protocol](https://github.com/elliot35/deterministic-agent-control-protocol)** - ⭐ 147
...
1531. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 147
   Serper MCP Server supporting search and webpage scraping

1532. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 147
   MCP server for Unreal Engine 5

1533. **[agentshield](https://github.com/affaan-m/agentshield)** - ⭐ 147
   AI agent security scanner. Detect vulnerabilities in agent configurations, MCP servers, and tool permissions. Available as CLI, GitHub Action, ECC plugin, and GitHub App integration. 🛡️

1534. **[clix](https://github.com/spideystreet/clix)** - ⭐ 147
   X from terminal. No API keys needed. Just plug your AI Agent.

1535. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 146
   A PubMed MCP server.

1536. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 146

1537. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 146
...
1538. **[registry-broker-skills](https://github.com/hashgraph-online/registry-broker-skills)** - ⭐ 146
   AI agent skills for the Universal Registry - search, chat, and register 72,000+ agents across 14+ protocols. Works with Claude, Codex, Cursor, OpenClaw, and any AI assistant.

1539. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 146
   小红书MCP服务器 | 秒级工具调用执行，笔记用户搜索、通知消息监控等；打造2026最简单、最快速、最精准、最好用的小红书MCPServer！

1540. **[CoWork-OS](https://github.com/CoWork-OS/CoWork-OS)** - ⭐ 146
...
1541. **[decipher-research-agent](https://github.com/mtwn105/decipher-research-agent)** - ⭐ 145
   Turn topics, links, and files into AI-generated research notebooks — summarize, explore, and ask anything.

1542. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 145
   Goku is an HTTP load testing application written in Rust 

1543. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 145
   Connect any Open Data to any LLM with Model Context Protocol.

1544. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 145
   An MCP server that provides access to Postman.

1545. **[ollama-mcp](https://github.com/rawveg/ollama-mcp)** - ⭐ 145
   An MCP Server for Ollama

1546. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 145
   A MCP Server for creating Powerpoint Presentations

1547. **[claude-emporium](https://github.com/Vvkmnn/claude-emporium)** - ⭐ 145
   🏛 [UNDER CONSTRUCTION] A (roman) claude plugin marketplace 

1548. **[UnityMCPIntegration](https://github.com/quazaai/UnityMCPIntegration)** - ⭐ 144
   Enable AI Agents to Control Unity

1549. **[uaip](https://github.com/concierge-hq/uaip)** - ⭐ 144
...
1550. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 144
   TypeScript-first framework for the Model Context Protocol (MCP). You write clean, typed code; FrontMCP handles the protocol, transport, DI, session/auth, and execution flow.

1551. **[mcp-crash-course](https://github.com/emarco177/mcp-crash-course)** - ⭐ 144
...
1552. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 144
...
1553. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 144
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1554. **[LMStudio-MCP](https://github.com/infinitimeless/LMStudio-MCP)** - ⭐ 144
   A Model Control Protocol (MCP) server that allows Claude to communicate with locally running LLM models via LM Studio.

1555. **[mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck)** - ⭐ 144
   An MCP server that acts as a bridge to query multiple OpenAI-compatible LLMs with MCP tool access. Just like rubber duck debugging, explain your problems to various AI "ducks" who can actually research and get different perspectives!

1556. **[comfy-pilot](https://github.com/ConstantineB6/comfy-pilot)** - ⭐ 144
   MCP server + embedded terminal that lets Claude Code see and edit your ComfyUI workflows

1557. **[Gemini-mcp](https://github.com/LKbaba/Gemini-mcp)** - ⭐ 143
   MCP server implementation for Google's Gemini API

1558. **[mcp-servers](https://github.com/charIesding/mcp-servers)** - ⭐ 143
   mcp server implementations

1559. **[claude-prompts](https://github.com/minipuft/claude-prompts)** - ⭐ 143
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1560. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 143
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1561. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 143
...
1562. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 143
...
1563. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 143
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1564. **[FirstData](https://github.com/MLT-OSS/FirstData)** - ⭐ 143
   The World's Most Comprehensive, Authoritative, and Structured Open Source Data Source Knowledge Base

1565. **[turbo-flow](https://github.com/marcuspat/turbo-flow)** - ⭐ 143
...
1566. **[mcp-k8s](https://github.com/silenceper/mcp-k8s)** - ⭐ 142
   A Kubernetes MCP (Model Control Protocol) server that enables interaction with Kubernetes clusters through MCP tools.

1567. **[openagent](https://github.com/Th0rgal/openagent)** - ⭐ 142
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

1568. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 142
   MSSQL Server MCP implementation written in C#

1569. **[akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp)** - ⭐ 142
   MCP server that provides access to Chinese stock market data using akshare-one

1570. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 141
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1571. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 141
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1572. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 141
...
1573. **[paiml-mcp-agent-toolkit](https://github.com/paiml/paiml-mcp-agent-toolkit)** - ⭐ 141
   Pragmatic AI Labs MCP Agent Toolkit - An MCP Server designed to make code with agents more deterministic

1574. **[harnss](https://github.com/OpenSource03/harnss)** - ⭐ 141
   Open-source, blazing-fast desktop client/UI build to harness Claude Code, Codex and any other Agent accepting Agent Client Protocol. Run multiple AI coding agents side by side with rich tool visualization, MCP integrations, built-in terminal, git, browser and just about anything else you may need.

1575. **[copilot-plugins](https://github.com/github/copilot-plugins)** - ⭐ 141
   The official GitHub Copilot plugins collection — MCP servers, skills, hooks, and other extensibility tools for GitHub Copilot.

1576. **[graphiti-mcp-server](https://github.com/gifflet/graphiti-mcp-server)** - ⭐ 140
   Graphiti MCP Server

1577. **[mcpd](https://github.com/mozilla-ai/mcpd)** - ⭐ 140
...
1578. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 140
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1579. **[Wazuh-MCP-Server](https://github.com/gensecaihq/Wazuh-MCP-Server)** - ⭐ 140
...
1580. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 140
   Salesforce MCP Server

1581. **[jupyter-ai-agents](https://github.com/datalayer/jupyter-ai-agents)** - ⭐ 140
   🪐 🤖 AI Agents for JupyterLab with 🔧 MCP tools - Chat interface for optimized notebook interaction and code execution.

1582. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 139
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1583. **[MCP-X](https://github.com/TimeCyber/MCP-X)** - ⭐ 139
...
1584. **[ksail](https://github.com/devantler-tech/ksail)** - ⭐ 139
   Tool for creating, maintaining and operating Kubernetes clusters with ease.

1585. **[mcp-server-datadog](https://github.com/winor30/mcp-server-datadog)** - ⭐ 139

1586. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 139
   MCP server for Israel Government Data

1587. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 139
...
1588. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 139
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1589. **[openchrome](https://github.com/shaun0927/openchrome)** - ⭐ 139
   Open-source browser automation MCP server. Control your real Chrome from any AI agent.

1590. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 139
   MCP Server for Apache Spark History Server. The bridge between Agentic AI and Apache Spark.

1591. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 139
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1592. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 139
   Model Context Protocol (MCP) with TikTok integration

1593. **[agentseal](https://github.com/AgentSeal/agentseal)** - ⭐ 139
   Security toolkit for AI agents. Scan your machine for dangerous skills and MCP configs, monitor for supply chain attacks, test prompt injection resistance, and audit live MCP servers for tool poisoning.

1594. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 138
   Simple MCP Server Implementation

1595. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 138
   MCP server for seamless document format conversion and processing

1596. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 138
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1597. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 138
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1598. **[forgemax](https://github.com/postrv/forgemax)** - ⭐ 138
   Code Mode inspired local sandboxed MCP Gateway - collapses N servers x M tools into 2 tools (~1,000 tokens)

1599. **[rust-mcp-filesystem](https://github.com/rust-mcp-stack/rust-mcp-filesystem)** - ⭐ 138
   Blazing-fast, asynchronous MCP server for seamless filesystem operations.

1600. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 138
   Model Context Protocol (MCP) server for the Zotero API, in Python

1601. **[isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)** - ⭐ 138
   Isaac Simulation MCP Extension and Server

1602. **[meta_skill](https://github.com/Dicklesworthstone/meta_skill)** - ⭐ 138
...
1603. **[Hegelion](https://github.com/Hmbown/Hegelion)** - ⭐ 138
   Dialectical reasoning architecture for LLMs (Thesis → Antithesis → Synthesis)

1604. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 138
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1605. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 137
   Quickly reads webpages and converts to markdown for fast, token efficient web scraping

1606. **[apple-health-mcp-server](https://github.com/the-momentum/apple-health-mcp-server)** - ⭐ 137
   MCP server for querying Apple Health data with natural language using DuckDB under the hood.

1607. **[mikrotik-mcp](https://github.com/jeff-nasseri/mikrotik-mcp)** - ⭐ 137
   MCP server for Mikrotik

1608. **[agent-skills-hub](https://github.com/zhuyansen/agent-skills-hub)** - ⭐ 137
...
1609. **[comet-mcp](https://github.com/hanzili/comet-mcp)** - ⭐ 137
   MCP Server connecting to Perplexity Comet browser

1610. **[Gitingest-MCP](https://github.com/puravparab/Gitingest-MCP)** - ⭐ 136
   mcp server for gitingest

1611. **[mcp_server_exe](https://github.com/shadowcz007/mcp_server_exe)** - ⭐ 136
   小智 & Cursor 的 MCP 启动器 - MCP For Cursor&xiaozhi。打包成可执行文件。Turn MCP server into an executable file

1612. **[Awesome-MCP](https://github.com/AlexMili/Awesome-MCP)** - ⭐ 136
   Awesome ModelContextProtocol resources - A curated list of MCP resources

1613. **[zig-mcp](https://github.com/zig-wasm/zig-mcp)** - ⭐ 136
   Model Context Protocol (MCP) server that provides up-to-date documentation for the Zig programming language standard library and builtin functions

1614. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 135
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1615. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 135
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1616. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 135
   MCP server for interaction with Bitwarden.

1617. **[claude-desktop-extension-bear-notes](https://github.com/vasylenko/claude-desktop-extension-bear-notes)** - ⭐ 135
   Claude Desktop extension with bundled MCP Server for Bear note taking app

1618. **[codefire-app](https://github.com/websitebutlers/codefire-app)** - ⭐ 135
...
1619. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1620. **[mcp-endpoint-server](https://github.com/xinnan-tech/mcp-endpoint-server)** - ⭐ 134
   xiaozhi mcp接入点服务器，用于自定义mcp服务注册，方便拓展小智服务端工具调用

1621. **[ChatPPT-MCP](https://github.com/YOOTeam/ChatPPT-MCP)** - ⭐ 134
...
1622. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 134
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1623. **[raindrop-mcp](https://github.com/adeze/raindrop-mcp)** - ⭐ 134
   Raindrop MCP Server

1624. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 134
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1625. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 134
   MCP server for interacting with the Aseprite API

1626. **[-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)** - ⭐ 134
      Convert any MCP server into a Claude Skill with 90% context savings

1627. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 133
   An MCP server implementing the think tool for Claude

1628. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1629. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 133
...
1630. **[mcp-linear](https://github.com/tacticlaunch/mcp-linear)** - ⭐ 133
...
1631. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 133
   A powerful MCP server for intelligently reading Java source code (For Jar and local project).

1632. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 133
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1633. **[ragrabbit](https://github.com/madarco/ragrabbit)** - ⭐ 132
   Open Source, Self-Hosted, AI Search and LLM.txt for your website

1634. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 132
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1635. **[mcp-victoriametrics](https://github.com/VictoriaMetrics/mcp-victoriametrics)** - ⭐ 132
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1636. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 132
...
1637. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 132
   Docker Hub MCP Server

1638. **[magg](https://github.com/sitbon/magg)** - ⭐ 131
   Magg: The MCP Aggregator

1639. **[design-systems-mcp](https://github.com/southleft/design-systems-mcp)** - ⭐ 131
   I'm your specialized design systems assistant. Ask me about components, tokens, patterns, and best practices.

1640. **[mcp-server-asana](https://github.com/roychri/mcp-server-asana)** - ⭐ 131

1641. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 131
...
1642. **[dify-plugin-agent-mcp_sse](https://github.com/junjiem/dify-plugin-agent-mcp_sse)** - ⭐ 131
   Dify 1.0 Plugin Support MCP Tools Agent strategies

1643. **[ironcurtain](https://github.com/provos/ironcurtain)** - ⭐ 131
   A secure* runtime for autonomous AI agents. Policy from plain-English constitutions. (*https://ironcurtain.dev)

1644. **[mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket)** - ⭐ 131
   Node.js/TypeScript MCP server for Atlassian Bitbucket. Enables AI systems (LLMs) to interact with workspaces, repositories, and pull requests via tools (list, get, comment, search). Connects AI directly to version control workflows through the standard MCP interface.

1645. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 130
   BrowserStack's Official MCP Server

1646. **[mcp-server-ccxt](https://github.com/doggybee/mcp-server-ccxt)** - ⭐ 130
   High-performance CCXT MCP server for cryptocurrency exchange integration

1647. **[mcp-devtools](https://github.com/sammcj/mcp-devtools)** - ⭐ 130
   A modular MCP server that provides commonly used developer tools for AI coding agents

1648. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 130
   It's time to push beyond MCP Servers... Right?

1649. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 130
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1650. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 129
   A collection of crypto MCP servers.

1651. **[exstruct](https://github.com/harumiWeb/exstruct)** - ⭐ 129
...
1652. **[laravel-toon](https://github.com/mischasigtermans/laravel-toon)** - ⭐ 129
   TOON encoding for Laravel. Encode data for AI/LLMs with ~50% fewer tokens than JSON.

1653. **[indonesia-gov-apis](https://github.com/suryast/indonesia-gov-apis)** - ⭐ 129
...
1654. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 129
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1655. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 129
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1656. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 128
   A Model Context Protocol server implementation for operations on AWS resources

1657. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 128
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1658. **[specs-workflow-mcp](https://github.com/kingkongshot/specs-workflow-mcp)** - ⭐ 128
   Intelligent spec workflow management MCP server

1659. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 128
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1660. **[linear-mcp](https://github.com/cline/linear-mcp)** - ⭐ 128
   a private MCP server for accessing Linear

1661. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 128
   Model Context Protocol Server for Swift

1662. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 128
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1663. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 128
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1664. **[claude-code-karma](https://github.com/JayantDevkar/claude-code-karma)** - ⭐ 128
   Dashboard for monitoring claude code sessions. 

1665. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 127
   JetBrains MCP Server Plugin

1666. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 127
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1667. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 127
   MCP server for understanding AWS spend

1668. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 127

1669. **[portainer-mcp](https://github.com/portainer/portainer-mcp)** - ⭐ 127
   Portainer MCP server

1670. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 127
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1671. **[QMT-MCP](https://github.com/guangxiangdebizi/QMT-MCP)** - ⭐ 127
    QMT-MCP 模块化量化交易助手

1672. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 126
   Dart AI Model Context Protocol (MCP) server

1673. **[claude-prompts-mcp](https://github.com/minipuft/claude-prompts-mcp)** - ⭐ 126
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1674. **[sysplant](https://github.com/x42en/sysplant)** - ⭐ 126
   Your Windows syscall hooking factory - feat Canterlot's Gate - All accessible over MCP

1675. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 126
   Buttplug.io Model Context Protocol (MCP) Server

1676. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 126
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1677. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 126
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1678. **[narsil-mcp](https://github.com/postrv/narsil-mcp)** - ⭐ 126
   Rust MCP server for comprehensive code intelligence - 90 tools, 32 languages, security scanning, call graphs, and more

1679. **[orchestkit](https://github.com/yonatangross/orchestkit)** - ⭐ 126
...
1680. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1681. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 125
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1682. **[aws-lambda-mcp-cookbook](https://github.com/ran-isenberg/aws-lambda-mcp-cookbook)** - ⭐ 125
...
1683. **[cloudflare-mcp](https://github.com/mattzcarey/cloudflare-mcp)** - ⭐ 125
   unofficial mcp server for cloudflare api

1684. **[web-scout-mcp](https://github.com/pinkpixel-dev/web-scout-mcp)** - ⭐ 125
   A powerful MCP server extension providing web search and content extraction capabilities. Integrates DuckDuckGo search functionality and URL content extraction into your MCP environment, enabling AI assistants to search the web and extract webpage content programmatically.

1685. **[mcp-client-server](https://github.com/willccbb/mcp-client-server)** - ⭐ 124
   An MCP Server that's also an MCP Client. Useful for letting Claude develop and test MCPs without needing to reset the application.

1686. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 124
   🐉 The fast, PHP way to build MCP servers

1687. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 124
...
1688. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 124
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1689. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 124
   A Model Context Protocol (MCP) for Jupyter Notebook

1690. **[computer-control-mcp](https://github.com/AB498/computer-control-mcp)** - ⭐ 124
   MCP server that provides computer control capabilities, like mouse, keyboard, OCR, etc. using PyAutoGUI, RapidOCR, ONNXRuntime. Similar to 'computer-use' by Anthropic. With Zero External Dependencies.

1691. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 123
   A Model Context Protocol server that provides access to BigQuery

1692. **[mcp-glootie](https://github.com/AnEntrypoint/mcp-glootie)** - ⭐ 123
   wanna develop an app ❓

1693. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 123
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1694. **[openapi](https://github.com/samchon/openapi)** - ⭐ 123
   OpenAPI definitions, converters and LLM function calling schema composer.

1695. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 123
...
1696. **[gm-exec](https://github.com/AnEntrypoint/gm-exec)** - ⭐ 123
   wanna develop an app ❓

1697. **[google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server)** - ⭐ 123
   MCP server for Google Tag Manager

1698. **[mcp-gm](https://github.com/AnEntrypoint/mcp-gm)** - ⭐ 122
   wanna develop an app ❓

1699. **[MCP-Workspace-Server](https://github.com/answerlink/MCP-Workspace-Server)** - ⭐ 122
...
1700. **[remote-mcp-functions-dotnet](https://github.com/Azure-Samples/remote-mcp-functions-dotnet)** - ⭐ 122
...
1701. **[env-doctor](https://github.com/mitulgarg/env-doctor)** - ⭐ 122
   Debug your GPU, CUDA, and AI stacks across local, Docker, and CI/CD (CLI and MCP server)

1702. **[ASI](https://github.com/vNeeL-code/ASI)** - ⭐ 122
   Android ✧ Gemma Integration into Android System Intelligence

1703. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 122
   A Model Context Protocol Server to manipulate *.xcodeproj

1704. **[mcp-mianshiya-server](https://github.com/yuyuanweb/mcp-mianshiya-server)** - ⭐ 122
   基于 Spring AI 的面试鸭搜索题目的 MCP Server 服务，快速让 AI 搜索企业面试真题和答案

1705. **[mcp-package-version](https://github.com/sammcj/mcp-package-version)** - ⭐ 122
   An MCP server that provides LLMs with the latest stable package versions when coding

1706. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 122
...
1707. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 122
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1708. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 122
...
1709. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 122
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1710. **[openwebui-extensions](https://github.com/Fu-Jie/openwebui-extensions)** - ⭐ 122
...
1711. **[muppet](https://github.com/muppet-dev/muppet)** - ⭐ 121
   MCP Servers SDK for TypeScript

1712. **[n8n-mcp-server](https://github.com/illuminaresolutions/n8n-mcp-server)** - ⭐ 121
   MCP server implementation for n8n workflow automation

1713. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 121
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1714. **[Taiwan-Health-MCP](https://github.com/healthymind-tech/Taiwan-Health-MCP)** - ⭐ 121

1715. **[XActions](https://github.com/nirholas/XActions)** - ⭐ 121
...
1716. **[ffmpeg-mcp](https://github.com/egoist/ffmpeg-mcp)** - ⭐ 120
   An MCP server for FFmpeg

1717. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 120
   Google Sheets MCP Server 📊🤖

1718. **[mcp](https://github.com/frappe/mcp)** - ⭐ 120
   Frappe MCP allows Frappe apps to function as MCP servers

1719. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 119

1720. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 119
   TypeScript template for building Model Context Protocol (MCP) servers. Ships with declarative tools/resources, pluggable auth, multi-backend storage, OpenTelemetry observability, and first-class support for both local and edge (Cloudflare Workers) runtimes.

1721. **[mcp-ts-core](https://github.com/cyanheads/mcp-ts-core)** - ⭐ 119
   TypeScript template for building Model Context Protocol (MCP) servers. Ships with declarative tools/resources, pluggable auth, multi-backend storage, OpenTelemetry observability, and first-class support for both local and edge (Cloudflare Workers) runtimes.

1722. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 119
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1723. **[context-sync](https://github.com/Intina47/context-sync)** - ⭐ 118
...
1724. **[memorizer-v1](https://github.com/petabridge/memorizer-v1)** - ⭐ 118
   Vector-search powered agent memory MCP server

1725. **[polymarket-mcp](https://github.com/berlinbra/polymarket-mcp)** - ⭐ 118
   MCP Server for PolyMarket API

1726. **[falcon-mcp](https://github.com/CrowdStrike/falcon-mcp)** - ⭐ 118
   Connect AI agents to CrowdStrike Falcon for automated security analysis and threat hunting

1727. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 118
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1728. **[mcp-toolkit](https://github.com/nuxt-modules/mcp-toolkit)** - ⭐ 118
   Create MCP servers directly in your Nuxt application. Define tools, resources, and prompts with a simple and intuitive API.

1729. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 118
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1730. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 118
   Universal AI Development Platform with MCP server integration, multi-provider support, and professional CLI. Build, test, and deploy AI applications with multiple ai providers.

1731. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 118
...
1732. **[VisionCraft-MCP-Server](https://github.com/augmentedstartups/VisionCraft-MCP-Server)** - ⭐ 117
...
1733. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 117
   An MCP server for InterviewReady

1734. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 117
   A proxy to use HTTP/SSE MCPs from STDIO clients

1735. **[kodit](https://github.com/helixml/kodit)** - ⭐ 117
   👩‍💻 MCP server to index external repositories

1736. **[outline-mcp-server](https://github.com/mmmeff/outline-mcp-server)** - ⭐ 117
   It's an MCP server... for Outline (the documentation platform!)

1737. **[diagram-mcp-server](https://github.com/andrewmoshu/diagram-mcp-server)** - ⭐ 117
   An MCP server that seamlessly creates infrastructure diagrams for AWS, Azure, GCP, Kubernetes and more

1738. **[augments-mcp-server](https://github.com/augmnt/augments-mcp-server)** - ⭐ 117
   Comprehensive MCP server providing real-time framework documentation access for Claude Code with intelligent caching, multi-source integration, and context-aware assistance.

1739. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 117
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1740. **[pocketbase-mcp](https://github.com/mrwyndham/pocketbase-mcp)** - ⭐ 116
   MCP server for building PocketBase apps really quickly - Need a front end quick consider FastPocket

1741. **[EDT-MCP](https://github.com/DitriXNew/EDT-MCP)** - ⭐ 116
   MCP for 1C:EDT

1742. **[mcp](https://github.com/taskade/mcp)** - ⭐ 116
   🤖 Taskade MCP · Official MCP server and OpenAPI to MCP codegen. Build AI agent tools from any OpenAPI API and connect to Claude, Cursor, and more.

1743. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 116
   blazigly fast gRPC/MCP client & server implementation in zig

1744. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 116
...
1745. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 116
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1746. **[mcp-reticle](https://github.com/soth-ai/mcp-reticle)** - ⭐ 115
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

1747. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 115
   Fast and super efficient Minecraft Server written in C++

1748. **[remote-mcp-apim-functions-python](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)** - ⭐ 115
   Azure API Management as AI Gateway to Remote MCP servers.

1749. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 115
   MCP Server for working with large Oracle databases

1750. **[remote-mcp-functions-python](https://github.com/Azure-Samples/remote-mcp-functions-python)** - ⭐ 115
   Getting Started with Remote MCP Servers using Azure Functions (Python)

1751. **[template-repo](https://github.com/AndrewAltimit/template-repo)** - ⭐ 115
...
1752. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 115
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1753. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 115
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1754. **[swagger-mcp](https://github.com/dcolley/swagger-mcp)** - ⭐ 114
   Swagger to MCP server

1755. **[mcp-server-tauri](https://github.com/hypothesi/mcp-server-tauri)** - ⭐ 114
   A Model Context Protocol (MCP) server and plugin for Tauri v2 development

1756. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 114
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1757. **[esankhyiki-mcp](https://github.com/nso-india/esankhyiki-mcp)** - ⭐ 114
...
1758. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 114
...
1759. **[cli](https://github.com/mcpgod/cli)** - ⭐ 113
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1760. **[MCP-oura](https://github.com/YuzeHao2023/MCP-oura)** - ⭐ 113
   MCP server for Oura API integration

1761. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 113
   Foxy contexts is a library for building context servers supporting Model Context Protocol

1762. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 113
...
1763. **[AgenticGoKit](https://github.com/AgenticGoKit/AgenticGoKit)** - ⭐ 113
...
1764. **[crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp)** - ⭐ 112
   An MCP server providing a range of cryptocurrency technical analysis indicators and strategies.

1765. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 112
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

1766. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 112
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1767. **[yfinance-mcp](https://github.com/narumiruna/yfinance-mcp)** - ⭐ 112

1768. **[modex](https://github.com/theronic/modex)** - ⭐ 112
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1769. **[Matryoshka](https://github.com/yogthos/Matryoshka)** - ⭐ 112
   MCP server for token-efficient large document analysis via the use of REPL state

1770. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 112
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

1771. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
1772. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 111
   MCP server for connecting agentic systems to search systems via searXNG

1773. **[spring-documentation-mcp-server](https://github.com/andrlange/spring-documentation-mcp-server)** - ⭐ 111
   Spring Boot based MCP Server provide full Spring Ecosystem Documentation for LLMs

1774. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 111
...
1775. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 111
...
1776. **[mcpauth](https://github.com/mcpauth/mcpauth)** - ⭐ 111
   Authentication for MCP Servers

1777. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 111

1778. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 111
   Open Source MCP Servers for Scientific Research

1779. **[idun-agent-platform](https://github.com/Idun-Group/idun-agent-platform)** - ⭐ 111
...
1780. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 111
   A Google Tasks Model Context Protocol Server for Claude

1781. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 111
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

1782. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 110
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1783. **[livebook_tools](https://github.com/thmsmlr/livebook_tools)** - ⭐ 110
   Powertools for livebook.dev — AI Code Editing, MCP Servers, and Running Livebooks from the CLI

1784. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 110
   MCP server for Dash, the macOS documentation browser

1785. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 110
    MCP server providing AI agents with instant access to Apple developer documentation via RAG technology

1786. **[code-pathfinder](https://github.com/shivasurya/code-pathfinder)** - ⭐ 110
...
1787. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 110
...
1788. **[brave-search-mcp](https://github.com/mikechao/brave-search-mcp)** - ⭐ 110
...
1789. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 110
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1790. **[server-wp-mcp](https://github.com/emzimmer/server-wp-mcp)** - ⭐ 109

1791. **[game-asset-mcp](https://github.com/MubarakHAlketbi/game-asset-mcp)** - ⭐ 109
   An MCP server for creating 2D/3D game assets from text using Hugging Face AI models.

1792. **[mcp_client](https://github.com/theailanguage/mcp_client)** - ⭐ 109
   MCP Client Implementation using Python, LangGraph and Gemini

1793. **[kibitz](https://github.com/nick1udwig/kibitz)** - ⭐ 109
   The coding agent for professionals

1794. **[browser-debugger-cli](https://github.com/szymdzum/browser-debugger-cli)** - ⭐ 109
   CLI tool for agents to quickly access browser telemetry (DOM, network, console) via Chrome DevTools Protocol.

1795. **[flexible-graphrag](https://github.com/stevereiner/flexible-graphrag)** - ⭐ 109
...
1796. **[rust-docs-mcp](https://github.com/snowmead/rust-docs-mcp)** - ⭐ 109
   MCP server for agents to explore rust docs, analyze source code, and build with confidence

1797. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 109
...
1798. **[PerformanceStudio](https://github.com/erikdarlingdata/PerformanceStudio)** - ⭐ 109
...
1799. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

1800. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

1801. **[asyncmcp](https://github.com/bh-rat/asyncmcp)** - ⭐ 108
   Async transport layers for MCP

1802. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 108
   An MCP client for Node.js.

1803. **[payloadcmsmcp](https://github.com/disruption-hub/payloadcmsmcp)** - ⭐ 108
   Payload CMS MCP Server

1804. **[sourcerer-mcp](https://github.com/st3v3nmw/sourcerer-mcp)** - ⭐ 108
   MCP for semantic code search & navigation that reduces token waste

1805. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 108
   Model Context Protocol (MCP) server for the Webflow Data API.

1806. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 108
   Model Context Protocol for Actual Budget API

1807. **[slack-mcp-server](https://github.com/ubie-oss/slack-mcp-server)** - ⭐ 107
   A Slack MCP server

1808. **[selfhosted-supabase-mcp](https://github.com/HenkDz/selfhosted-supabase-mcp)** - ⭐ 107
   An MCP Server for your Self Hosted Supabase

1809. **[mcp-tool-kit](https://github.com/getfounded/mcp-tool-kit)** - ⭐ 107
   Agentic abstraction layer for building high precision vertical AI agents written in python for Model Context Protocol.

1810. **[arxiv-latex-mcp](https://github.com/takashiishida/arxiv-latex-mcp)** - ⭐ 107
   MCP server that uses arxiv-to-prompt to fetch and process arXiv LaTeX sources for precise interpretation of mathematical expressions in scientific papers.

1811. **[csharp-runner](https://github.com/sdcb/csharp-runner)** - ⭐ 107
   fast, secure c# runner

1812. **[snippy](https://github.com/Azure-Samples/snippy)** - ⭐ 107
...
1813. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 107
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

1814. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 107
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1815. **[agent-trade-kit](https://github.com/okx/agent-trade-kit)** - ⭐ 107
   OKX trading MCP server — connect AI agents to spot, swap, futures, options & grid bots via the Model Context Protocol.  

1816. **[mcpm](https://github.com/MCP-Club/mcpm)** - ⭐ 106
...
1817. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 106
...
1818. **[xclaude-plugin](https://github.com/conorluddy/xclaude-plugin)** - ⭐ 106
...
1819. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 106
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1820. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 106
   Simple API & React framework, type safe, OpenAPI, RSC, MCP, type safe client, streaming with SSE

1821. **[flowlens-mcp-server](https://github.com/magentic/flowlens-mcp-server)** - ⭐ 105
...
1822. **[typescript-utcp](https://github.com/universal-tool-calling-protocol/typescript-utcp)** - ⭐ 105
...
1826. **[linggen-memory](https://github.com/linggen/linggen-memory)** - ⭐ 105
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

1827. **[academic-search-mcp-server](https://github.com/afrise/academic-search-mcp-server)** - ⭐ 105
...
1828. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 105
   An md file as a chat interface and editable history in one.

1829. **[agentcare-mcp](https://github.com/Kartha-AI/agentcare-mcp)** - ⭐ 104
   MCP Server for EMRs with FHIR

1830. **[freqtrade-mcp](https://github.com/kukapay/freqtrade-mcp)** - ⭐ 104
   An MCP server that integrates with the Freqtrade cryptocurrency trading bot.

1831. **[linggen](https://github.com/linggen/linggen)** - ⭐ 104
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

1832. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 104
   simple web ui to manage mcp (model context protocol) servers in the claude app

1833. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 104
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

1834. **[vectorize-mcp-server](https://github.com/vectorize-io/vectorize-mcp-server)** - ⭐ 104
   Official Vectorize MCP Server

1835. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 104
   A Model Context Protocol server that provides knowledge graph management capabilities. 

1836. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 104
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

1837. **[forge-orchestrator](https://github.com/nxtg-ai/forge-orchestrator)** - ⭐ 104
   Forge Orchestrator: Multi-AI task orchestration. File locking, knowledge capture, drift detection. Rust.

1838. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 104
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1839. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 103
...
1840. **[solana-mcp](https://github.com/solanamcp/solana-mcp)** - ⭐ 103
   Solana Agent Kit MCP Server 

1841. **[ARIES](https://github.com/Chieko-Seren/ARIES)** - ⭐ 103
...
1842. **[http-oauth-mcp-server](https://github.com/NapthaAI/http-oauth-mcp-server)** - ⭐ 103
...
1843. **[chronulus-mcp](https://github.com/ChronulusAI/chronulus-mcp)** - ⭐ 103
   MCP Server for Chronulus AI Forecasting and Prediction Agents

1844. **[alibabacloud-ack-mcp-server](https://github.com/aliyun/alibabacloud-ack-mcp-server)** - ⭐ 103
...
1845. **[alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server)** - ⭐ 103
   AlibabaCloud CloudOps MCP Server

1846. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 103
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1847. **[wanaku](https://github.com/wanaku-ai/wanaku)** - ⭐ 103
   Wanaku MCP Router

1848. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 103
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

1849. **[powerbi-mcp](https://github.com/sulaiman013/powerbi-mcp)** - ⭐ 103
   MCP server for natural language interaction with Power BI datasets

1850. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 102
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

1851. **[remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions)** - ⭐ 102
   Landing page for Remote MCP Server efforts in Azure Functions with links to all language stack specific repos.

1852. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

1853. **[godoc-mcp](https://github.com/mrjoshuak/godoc-mcp)** - ⭐ 102
   go doc mcp server

1854. **[mcp-screenshot-website-fast](https://github.com/just-every/mcp-screenshot-website-fast)** - ⭐ 102
   Quickly screenshots webpages and converts to an LLM friendly size

1855. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 102
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1856. **[charlotte](https://github.com/TickTockBent/charlotte)** - ⭐ 102
   Token-efficient browser MCP server — structured web pages for AI agents, not raw accessibility dumps

1857. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 102
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1858. **[arbor](https://github.com/Anandb71/arbor)** - ⭐ 102
   Graph-native code intelligence that replaces embedding-based RAG with deterministic program understanding.

1859. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 102
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1860. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 101
...
1861. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 101
   BTP CloudFoundry Node.js MCP server for SAP OData services integration

1862. **[go-utcp](https://github.com/universal-tool-calling-protocol/go-utcp)** - ⭐ 101
    Official Go implementation of the UTCP 

1863. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 101
   Collection of examples of how to use Model Context Protocol with AWS.

1864. **[nowledge-mem](https://github.com/nowledge-co/nowledge-mem)** - ⭐ 101
   Memory and context manager just works.

1865. **[stock-mcp](https://github.com/huweihua123/stock-mcp)** - ⭐ 101
   专业的金融市场数据 MCP 服务器 - 支持A股/美股/加密货币，原生 MCP 协议，AI Agent 友好

1866. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 101
   Node.js Client Implementation for Model Context Protocol (MCP)

1867. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 100
...
1868. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

1869. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 100
...
1870. **[autodev-codebase](https://github.com/anrgct/autodev-codebase)** - ⭐ 100
...
1871. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 100
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

1872. **[mpm-vibe-coding](https://github.com/halflifezyf2680/mpm-vibe-coding)** - ⭐ 100
...
1873. **[langgraph-ai](https://github.com/piyushagni5/langgraph-ai)** - ⭐ 100
   LangGraph AI Repository

1874. **[mcp-memory-keeper](https://github.com/mkreyman/mcp-memory-keeper)** - ⭐ 100
   MCP server for persistent context management in AI coding assistants

1875. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 100
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

1876. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 100
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

1877. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 100
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1878. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 100
...
1879. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 100
...
1880. **[claudeus-wp-mcp](https://github.com/deus-h/claudeus-wp-mcp)** - ⭐ 100
   Claudeus WordPress MCP Server

1881. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

1882. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

1883. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

1884. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

1885. **[lapras-mcp-server](https://github.com/lapras-inc/lapras-mcp-server)** - ⭐ 99
   lapras.com 公式MCP Server

1886. **[heimdall-mcp-server](https://github.com/lcbcFoo/heimdall-mcp-server)** - ⭐ 99
   Your AI Coding Assistant's Long-Term Memory

1887. **[mysql-mcp-server-sse](https://github.com/mangooer/mysql-mcp-server-sse)** - ⭐ 99
...
1888. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 99
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

1889. **[monarch-mcp-server](https://github.com/robcerda/monarch-mcp-server)** - ⭐ 99
   MCP Server for use with Monarch Money

1890. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 99
...
1891. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 99
   From Java Dev to AI Engineer: Spring AI Fast Track

1892. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 99
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1893. **[atomic-red-team-mcp](https://github.com/cyberbuff/atomic-red-team-mcp)** - ⭐ 98
   MCP server for Atomic Red Team

1894. **[editor-mcp-server](https://github.com/playcanvas/editor-mcp-server)** - ⭐ 98
   MCP Server for AI automation of the PlayCanvas Editor

1895. **[Vibe-Coder-MCP](https://github.com/freshtechbro/Vibe-Coder-MCP)** - ⭐ 98
    Vibe-Coder-MCP server extends AI assistants with specialized software development tools.

1896. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

1897. **[zed-mcp-server-context7](https://github.com/akbxr/zed-mcp-server-context7)** - ⭐ 98
   Context7 MCP Server for Zed

1898. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 98
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

1899. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 98
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

1900. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 98
   first gemini based desktop client for MCP

1901. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 98
...
1902. **[QuickDesk](https://github.com/barry-ran/QuickDesk)** - ⭐ 98
...
1903. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 97
   claude mcp sse demo with server and client(cli、web)

1904. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 97
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

1905. **[fhir-mcp-server](https://github.com/wso2/fhir-mcp-server)** - ⭐ 97
   FHIR MCP Server – helping you expose any FHIR Server or API as a MCP Server.

1906. **[z-image-studio](https://github.com/iconben/z-image-studio)** - ⭐ 97
...
1907. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 97
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

1908. **[Pare](https://github.com/Dave-London/Pare)** - ⭐ 97
   Dev tools, optimized for agents. Structured, token-efficient MCP servers for git, test runners, npm, Docker, and more.

1909. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 96
...
1910. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 96
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

1911. **[api2mcp4j](https://github.com/TheEterna/api2mcp4j)** - ⭐ 96
...
1912. **[gossiphs](https://github.com/williamfzc/gossiphs)** - ⭐ 96
...
1913. **[sparql-llm](https://github.com/sib-swiss/sparql-llm)** - ⭐ 96
   🦜✨ Chat system, MCP server, and reusable components to improve LLMs capabilities when generating SPARQL queries

1914. **[needle-mcp](https://github.com/needle-ai/needle-mcp)** - ⭐ 96
   Needle MCP Server for easy RAG.Long-term memory for LLMs.

1915. **[AgentUp](https://github.com/always-further/AgentUp)** - ⭐ 96
   Portable , scalable , secure AI Agents

1916. **[mcp-arr](https://github.com/aplaceforallmystuff/mcp-arr)** - ⭐ 96
   MCP server for *arr media management suite

1917. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 95
   This is a Ruby implementation of MCP (Model Context Protocol) client

1918. **[leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server)** - ⭐ 95
   An MCP server enabling automated access to LeetCode's problems, solutions, and public data with optional authentication for user-specific features, supporting leetcode.com & leetcode.cn sites.

1919. **[schedcp](https://github.com/eunomia-bpf/schedcp)** - ⭐ 95
   MCP Server for Linux Scheduler Management and Auto optimization

1920. **[agent-toolkit](https://github.com/sanity-io/agent-toolkit)** - ⭐ 95
   Collection of resources to help AI agents build better with Sanity.

1921. **[meta-mcp](https://github.com/brijr/meta-mcp)** - ⭐ 95
   MCP Server for connecting to the Meta Marketing API

1922. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 95
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

1923. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 95
   A Model Context Protocol (MCP) server for square

1924. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 95
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

1925. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 95
...
1926. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 95
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1927. **[mcp-bridge](https://github.com/firekula/mcp-bridge)** - ⭐ 95
   这是一个为 Cocos Creator 设计的 MCP (Model Context Protocol) 桥接插件，用于连接外部 AI 工具与 Cocos Creator 编辑器，实现对场景、节点等资源的自动化操作。

1928. **[bouvet](https://github.com/vrn21/bouvet)** - ⭐ 94
   Sandbox for Agents 

1929. **[semantic-scholar-fastmcp-mcp-server](https://github.com/zongmin-yu/semantic-scholar-fastmcp-mcp-server)** - ⭐ 94
   A FastMCP server implementation for the Semantic Scholar API, providing comprehensive access to academic paper data, author information, and citation networks.

1930. **[generative-ui-playground](https://github.com/CopilotKit/generative-ui-playground)** - ⭐ 94
   Interact with all three types of generative UI, all in one interface

1931. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 94
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

1932. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 94
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

1933. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 94
...
1934. **[uxc](https://github.com/holon-run/uxc)** - ⭐ 94
   Universal API calling CLI for URL-first discovery and invocation across OpenAPI, gRPC, GraphQL, MCP, and JSON-RPC.

1935. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

1936. **[elektron-mcp](https://github.com/zerubeus/elektron-mcp)** - ⭐ 93
   MCP sever for controlling Elektron devices using LLMs

1937. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 93
   Model Context Protocol server for Replicate's API

1938. **[gospy](https://github.com/monsterxx03/gospy)** - ⭐ 93
   Non-Invasive goroutine inspector

1939. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 93
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

1940. **[tiger-cli](https://github.com/timescale/tiger-cli)** - ⭐ 93
   Tiger CLI is the command-line interface for Tiger Cloud. It includes an MCP server for helping coding agents write production-level Postgres code.

1941. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 93
   Rails Engine with MCP compliant Spec.

1942. **[mcp-server](https://github.com/OctopusDeploy/mcp-server)** - ⭐ 93
   Octopus Deploy Official MCP Server

1943. **[mcpcat-typescript-sdk](https://github.com/MCPCat/mcpcat-typescript-sdk)** - ⭐ 93
   MCPcat is an analytics platform for MCP server owners 🐱.

1944. **[awsome_kali_MCPServers](https://github.com/ccq1/awsome_kali_MCPServers)** - ⭐ 93
   awsome kali MCPServers is a set of MCP servers tailored for Kali Linux

1945. **[awesome-mcp-servers-devops](https://github.com/WagnerAgent/awesome-mcp-servers-devops)** - ⭐ 93
...
1946. **[NetworkOps_Platform](https://github.com/E-Conners-Lab/NetworkOps_Platform)** - ⭐ 93
...
1947. **[open-mcp-auth-proxy](https://github.com/wso2/open-mcp-auth-proxy)** - ⭐ 92
   Authentication and Authorization Proxy for MCP Servers

1948. **[awesome-osint-mcp-servers](https://github.com/soxoj/awesome-osint-mcp-servers)** - ⭐ 92
   A curated list of OSINT MCP servers. Pull requests are welcomed!

1949. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 92
...
1950. **[litegraph](https://github.com/litegraphdb/litegraph)** - ⭐ 91
...
1951. **[vibe](https://github.com/michiosw/vibe)** - ⭐ 91
   Open-Source AI-powered web browser. Browse the web with your own LLM API key. Alternative to Dia / Comet.

1952. **[reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp)** - ⭐ 91
...
1953. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 91
   A Model Context Protocol (MCP) server for querying the CVE-Search API

1954. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 91
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

1955. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 91
...
1956. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 90
   A model-context-protocol server for molecules.

1957. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 90
   A Model Context Protocol server that provides knowledge graph management capabilities.

1958. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 90
   A Model Context Protocol (MCP) server for working with TradingView PineScript

1959. **[mcp-canvas-lms](https://github.com/DMontgomery40/mcp-canvas-lms)** - ⭐ 90
...
1960. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 90
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

1961. **[mcp-rest-api](https://github.com/dkmaker/mcp-rest-api)** - ⭐ 89
   A TypeScript-based MCP server that enables testing of REST APIs through Cline. This tool allows you to test and interact with any REST API endpoints directly from your development environment.

1962. **[us-gov-open-data-mcp](https://github.com/lzinga/us-gov-open-data-mcp)** - ⭐ 89
...
1963. **[fullstack-langgraph-nextjs-agent](https://github.com/agentailor/fullstack-langgraph-nextjs-agent)** - ⭐ 89
...
1964. **[google-ai-mode-mcp](https://github.com/PleasePrompto/google-ai-mode-mcp)** - ⭐ 89
...
1965. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 88
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

1966. **[apps-sdk-template](https://github.com/alpic-ai/apps-sdk-template)** - ⭐ 88
   A minimalist Typescript ChatGPT App based on the Skybridge framework

1967. **[amap-mcp-server](https://github.com/sugarforever/amap-mcp-server)** - ⭐ 88
   高德地图MCP Server，支持stdio, sse和streamable-http

1968. **[mcpgen](https://github.com/lyeslabs/mcpgen)** - ⭐ 88
   Generate Go MCP server boilerplate from OpenAPI 3 specifications

1969. **[chat-ui](https://github.com/AI-QL/chat-ui)** - ⭐ 88
...
1970. **[identity](https://github.com/agntcy/identity)** - ⭐ 88
...
1971. **[mem0-mcp](https://github.com/pinkpixel-dev/mem0-mcp)** - ⭐ 88
   ✨ mem0 MCP Server: A memory system using mem0 for AI applications with model context protocl (MCP) integration. Enables long-term memory for AI agents as a drop-in MCP server.

1972. **[mcp-gateway](https://github.com/hyprmcp/mcp-gateway)** - ⭐ 88
...
1973. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 87
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

1974. **[achatbot](https://github.com/ai-bot-pro/achatbot)** - ⭐ 87
...
1975. **[awesome-openid-connect](https://github.com/cerberauth/awesome-openid-connect)** - ⭐ 87
...
1976. **[slidev-mcp](https://github.com/LSTM-Kirigaya/slidev-mcp)** - ⭐ 87
   mcp server for slidev to make web ppt quickly and elegantly

1977. **[mcp-dbutils](https://github.com/donghao1393/mcp-dbutils)** - ⭐ 87
...
1978. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 87
   Ragie Model Context Protocol Server

1979. **[one-search-mcp](https://github.com/yokingma/one-search-mcp)** - ⭐ 87
   🚀 OneSearch MCP Server: Web Search & Scraper & Extract,  Support agent-browser, SearXNG, Tavily, DuckDuckGo, Bing, etc.

1980. **[sdl-mcp](https://github.com/GlitterKill/sdl-mcp)** - ⭐ 87
...
1981. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 87
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

1982. **[mcp-agent](https://github.com/Haohao-end/mcp-agent)** - ⭐ 86
   A modular Python framework implementing the Model Context Protocol (MCP). It features a standardized client-server architecture over StdIO, integrating LLMs with external tools, real-time weather data fetching, and an advanced RAG (Retrieval-Augmented Generation) system.

1983. **[oxylabs-mcp](https://github.com/oxylabs/oxylabs-mcp)** - ⭐ 86
   Official Oxylabs MCP integration

1984. **[react-agent-hooks](https://github.com/chuanqisun/react-agent-hooks)** - ⭐ 86
   Turn React hooks into LLM tools

1985. **[mcp-server-llamacloud](https://github.com/run-llama/mcp-server-llamacloud)** - ⭐ 86
   A MCP server connecting to managed indexes on LlamaCloud

1986. **[vggt-mps](https://github.com/jmanhype/vggt-mps)** - ⭐ 86
   VGGT 3D Vision Agent optimized for Apple Silicon with Metal Performance Shaders

1987. **[FrontAgent](https://github.com/ceilf6/FrontAgent)** - ⭐ 86
   AI agent platform for frontend engineering with SDD constraints & MCP-controlled automation. | 面向前端工程的企业级 AI Agent 平台

1988. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 86
   CLI & API for MCP management

1989. **[agent-tool-protocol](https://github.com/mondaycom/agent-tool-protocol)** - ⭐ 86
   Agent Tool Protocol

1990. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 86
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

1991. **[mcp-server](https://github.com/cap-js/mcp-server)** - ⭐ 86
   MCP server for AI-assisted development of CAP applications

1992. **[WeChat-MCP](https://github.com/BiboyQG/WeChat-MCP)** - ⭐ 86
   WeChat-MCP: let Claude/ChatGPT and other AI assistants read and reply to WeChat for you

1993. **[mcp-image](https://github.com/shinpr/mcp-image)** - ⭐ 86
...
1994. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1995. **[mcp](https://github.com/twilio-labs/mcp)** - ⭐ 85
   Monorepo providing 1) OpenAPI to MCP Tool generator 2) Exposing all of Twilio's API as MCP Tools

1996. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 85
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

1997. **[fabric-mcp](https://github.com/ksylvan/fabric-mcp)** - ⭐ 85
   Fabric MCP Server: Seamlessly integrate Fabric AI capabilities into MCP-enabled tools like IDEs and chat interfaces.

1998. **[rohlik-mcp](https://github.com/tomaspavlin/rohlik-mcp)** - ⭐ 85
   MCP server that lets you shop groceries across the Rohlik Group platforms (Rohlik.cz, Knuspr.de, Gurkerl.at, Kifli.hu, Sezamo.ro)

1999. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 85
...
2000. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 85
...
2001. **[reddit-mcp-server](https://github.com/eliasbiondo/reddit-mcp-server)** - ⭐ 85
...
2002. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 84
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

2003. **[mcp-dockmaster](https://github.com/dcSpark/mcp-dockmaster)** - ⭐ 84
...
2004. **[spiceflow-framework](https://github.com/remorses/spiceflow-framework)** - ⭐ 84
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

2005. **[cursor-rust-tools](https://github.com/terhechte/cursor-rust-tools)** - ⭐ 84
   A MCP server to allow the LLM in Cursor to access Rust Analyzer, Crate Docs and Cargo Commands.

2006. **[mcp-github-project-manager](https://github.com/kunwarVivek/mcp-github-project-manager)** - ⭐ 84
   a mcp server to manage github project's functionality 

2007. **[surrealmcp](https://github.com/surrealdb/surrealmcp)** - ⭐ 84
   The official MCP server for SurrealDB

2008. **[advanced-unity-mcp](https://github.com/codemaestroai/advanced-unity-mcp)** - ⭐ 84
   Public repository for Advanced Unity MCP by Code Maestro (www.code-maestro.com).

2009. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 84
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

2010. **[mcp-server-excel](https://github.com/sbroenne/mcp-server-excel)** - ⭐ 84
   Excel MCP Server & CLI - 23 tools, 214 operations for AI-powered Excel automation via COM API

2011. **[yuque-mcp-server](https://github.com/yuque/yuque-mcp-server)** - ⭐ 84
   Yuque MCP Server - Model Context Protocol server for Yuque API

2012. **[mcp-node](https://github.com/algolia/mcp-node)** - ⭐ 83
   MCP server for interacting with Algolia

2013. **[claude-swarm](https://github.com/cj-vana/claude-swarm)** - ⭐ 83
...
2014. **[xiaozhi-mcp-ha](https://github.com/mac8005/xiaozhi-mcp-ha)** - ⭐ 83
   A Home Assistant Custom Integration (HACS) that connects Xiaozhi ESP32 AI chatbot to Home Assistant via MCP

2015. **[viper](https://github.com/ozanunal0/viper)** - ⭐ 83
...
2016. **[gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp)** - ⭐ 83
   Interact seamlessly with GitLab repositories to manage merge requests and issues. Fetch details, add comments, and streamline your code review process with ease.

2017. **[ols4](https://github.com/EBISPOT/ols4)** - ⭐ 83
   The EMBL-EBI Ontology Lookup Service (OLS)

2018. **[zed-mcp-server-github](https://github.com/LoamStudios/zed-mcp-server-github)** - ⭐ 83
   A GitHub MCP Server extension for Zed

2019. **[mcp-forge](https://github.com/achetronic/mcp-forge)** - ⭐ 83
   A complete MCP server template that include vitamins (oauth authentication included)

2020. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 83
   Model Context Protocol (MCP) Server for the Keboola Platform

2021. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 83
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

2022. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 83
...
2023. **[mcp-n8n-builder](https://github.com/spences10/mcp-n8n-builder)** - ⭐ 82
   🪄 MCP server for programmatic creation and management of n8n workflows. Enables AI assistants to build, modify, and manage workflows without direct user intervention through a comprehensive set of tools and resources for interacting with n8n's REST API.

2024. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 82
   A WooCommerce (MCP) Model Context Protocol server

2025. **[agentic-stock-research-system](https://github.com/rooneyrulz/agentic-stock-research-system)** - ⭐ 82
...
2026. **[ramparts](https://github.com/highflame-ai/ramparts)** - ⭐ 82
   mcp scan that scans any mcp server for indirect attack vectors and security or configuration vulnerabilities

2027. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 82
   Model Context Protocol (MCP) CLI server template for Rust

2028. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 82
...
2029. **[claude-mermaid](https://github.com/veelenga/claude-mermaid)** - ⭐ 82
   MCP Server to previewing mermaid diagrams with live reload

2030. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 82
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

2031. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 82
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

2032. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 82
...
2033. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 82
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

2034. **[awesome-openclaw](https://github.com/vincentkoc/awesome-openclaw)** - ⭐ 82
...
2035. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 81
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

2036. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

2037. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

2038. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 81
   A model context protocol server that connects to Anki through AnkiConnect

2039. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 81
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

2040. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 81
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

2041. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 81
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

2042. **[mcp-openapi](https://github.com/ReAPI-com/mcp-openapi)** - ⭐ 81
   OpenAPI specification MCP server.

2043. **[code-to-tree](https://github.com/micl2e2/code-to-tree)** - ⭐ 81
   A runtime-free MCP server that converts source code into AST🌲, regardless of language.

2044. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 81
...
2045. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 81
   Model Context Protocol for YNAB (you need a budget)

2046. **[MCPay](https://github.com/microchipgnu/MCPay)** - ⭐ 80
   Open-source Infrastructure for MCP and x402

2047. **[mcp-server-any-openapi](https://github.com/baryhuang/mcp-server-any-openapi)** - ⭐ 80
...
2048. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 80
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

2049. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 80
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

2050. **[ophis](https://github.com/njayp/ophis)** - ⭐ 80
   Transform any Cobra CLI into an MCP server

2051. **[mcpc](https://github.com/mcpc-tech/mcpc)** - ⭐ 80
   Build agentic-MCP servers by composing existing MCP tools.

2052. **[tauri-plugin-mcp](https://github.com/P3GLEG/tauri-plugin-mcp)** - ⭐ 80
...
2053. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 80
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

2054. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 80
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

2055. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 80
...
2056. **[mcp-ssh-manager](https://github.com/bvisible/mcp-ssh-manager)** - ⭐ 80
...
2057. **[flutter-skill](https://github.com/ai-dashboad/flutter-skill)** - ⭐ 80
...
2058. **[fastmcp-boilerplate](https://github.com/punkpeye/fastmcp-boilerplate)** - ⭐ 79
   A simple MCP server built using FastMCP, TypeScript, ESLint, and Prettier.

2059. **[codemirror-mcp](https://github.com/marimo-team/codemirror-mcp)** - ⭐ 79
   CodeMirror extension to hook up a Model Context Provider (MCP)

2060. **[jira-mcp](https://github.com/nguyenvanduocit/jira-mcp)** - ⭐ 79
...
2061. **[ls-mcp](https://github.com/lirantal/ls-mcp)** - ⭐ 79
   List MCP Server configurations in your system used by AI applications like Cursor, Claude Desktop, VS Code and others

2062. **[glif-mcp-server](https://github.com/glifxyz/glif-mcp-server)** - ⭐ 79
   Easily run glif.app AI workflows inside your LLM: image generators, memes, selfies, and more. Glif supports all major multimedia AI models inside one app

2063. **[terminal_server](https://github.com/theailanguage/terminal_server)** - ⭐ 79
   MCP server that can execute terminal commands

2064. **[bridge4simulator](https://github.com/AppGram/bridge4simulator)** - ⭐ 79
...
2065. **[django-ai-boost](https://github.com/vintasoftware/django-ai-boost)** - ⭐ 79
   A MCP server for Django applications, inspired by Laravel Boost.

2066. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 79
...
2067. **[slither-mcp](https://github.com/trailofbits/slither-mcp)** - ⭐ 79
   MCP server for Slither static analysis of Solidity smart contracts

2068. **[bing-search-mcp](https://github.com/leehanchung/bing-search-mcp)** - ⭐ 78
   MCP Server for Bing Search API

2069. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 78
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

2070. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 78
...
2071. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 78
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

2072. **[aivectormemory](https://github.com/Edlineas/aivectormemory)** - ⭐ 77
...
2073. **[rtfmbro-mcp](https://github.com/marckrenn/rtfmbro-mcp)** - ⭐ 77
   rtfmbro provides always-up-to-date, version-specific package documentation as context for coding agents. An alternative to context7

2074. **[lucidity-mcp](https://github.com/hyperb1iss/lucidity-mcp)** - ⭐ 77
...
2075. **[visual-ui-debug-agent-mcp](https://github.com/samihalawa/visual-ui-debug-agent-mcp)** - ⭐ 77
   VUDA is an autonomous debugging agent that empowers AI models to visually analyze, test, and debug web

2076. **[devex](https://github.com/ParthKapoor-dev/devex)** - ⭐ 77
   ⚡️ Devex — A Fast, Secure, and Scalable Repl-as-a-Service Platform built for Developers 🚀

2077. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 77
   Model Context Protocol (MCP) Client for Apify's Actors

2078. **[mcp-reticle](https://github.com/LabTerminal/mcp-reticle)** - ⭐ 77
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

2079. **[mcp-llm](https://github.com/sammcj/mcp-llm)** - ⭐ 77
    An MCP server that provides LLMs access to other LLMs

2080. **[ExternalAttacker-MCP](https://github.com/MorDavid/ExternalAttacker-MCP)** - ⭐ 77
   A modular external attack surface mapping tool integrating tools for automated reconnaissance and bug bounty workflows.

2081. **[agent-security-scanner-mcp](https://github.com/sinewaveai/agent-security-scanner-mcp)** - ⭐ 77
   Security scanner MCP server for AI coding agents. Prompt injection firewall, package hallucination detection (4.3M+ packages), 1000+ vulnerability rules with AST & taint analysis, auto-fix.

2082. **[blender-open-mcp](https://github.com/dhakalnirajan/blender-open-mcp)** - ⭐ 77
   Open Models MCP for Blender Using Ollama

2083. **[mcp-auth-proxy](https://github.com/sigbit/mcp-auth-proxy)** - ⭐ 77
   MCP Auth Proxy is a secure OAuth 2.1 authentication proxy for Model Context Protocol (MCP) servers

2084. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 76
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

2085. **[mcp-gemini-google-search](https://github.com/yukukotani/mcp-gemini-google-search)** - ⭐ 76
   MCP server for Google Search integration using Gemini's built-in search capabilities

2086. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 76
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

2087. **[cursor10x-mcp](https://github.com/aiurda/cursor10x-mcp)** - ⭐ 76
   The Cursor10x MCP is a persistent multi-dimensional memory system for Cursor that enhances AI assistants with conversation context, project history, and code relationships across sessions.

2088. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 76
   A Model Context Protocol Server to perform Kafka client operations

2089. **[perplexity-mcp-zerver](https://github.com/wysh3/perplexity-mcp-zerver)** - ⭐ 76
   MCP web search using perplexity without any API KEYS 

2090. **[lazy-mcp](https://github.com/voicetreelab/lazy-mcp)** - ⭐ 76
     MCP proxy server with lazy loading support - reduces context usage through on-demand tool activation

2091. **[apitap](https://github.com/n1byn1kt/apitap)** - ⭐ 76
   The MCP server that turns any website into an API — no docs, no SDK, no browser. npm: @apitap/core

2092. **[elementor-mcp](https://github.com/msrbuilds/elementor-mcp)** - ⭐ 76
   Comprehensive Elementor MCP Server plugin with 90+ Tools.

2093. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 76
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

2094. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 76
   A full featured, enterprise grade rust MCP SDK

2095. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 76
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

2096. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 76
   Model Context Protocol server for OpenStreetMap data

2097. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 76
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

2098. **[mcp-dock](https://github.com/OldJii/mcp-dock)** - ⭐ 76
...
2099. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 75
   A Model Context Protocol server for Hopper Disassembler

2100. **[agentic-coding](https://github.com/sammcj/agentic-coding)** - ⭐ 75
   Agentic Coding Rules, Templates etc...

2101. **[mcp-llms-txt-explorer](https://github.com/thedaviddias/mcp-llms-txt-explorer)** - ⭐ 75
   MCP to explore websites with llms.txt files

2102. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 75
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

2103. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 75
...
2104. **[unitree-go2-mcp-server](https://github.com/lpigeon/unitree-go2-mcp-server)** - ⭐ 75
   The Unitree Go2 MCP Server is a server built on the MCP that enables users to control the Unitree Go2 robot using natural language commands interpreted by a LLM.

2105. **[openfoam-mcp-server](https://github.com/webworn/openfoam-mcp-server)** - ⭐ 75
   LLM-powered OpenFOAM MCP server for intelligent CFD education with Socratic questioning and expert error resolution

2106. **[roundtable](https://github.com/askbudi/roundtable)** - ⭐ 75
...
2107. **[interactive-brokers-mcp](https://github.com/code-rabi/interactive-brokers-mcp)** - ⭐ 75
   Interactive Brokers MCP Server

2108. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 75
   Model Context Protocol implementation for retrieving codebases using RepoMix

2109. **[tradingview-chart-mcp](https://github.com/ertugrul59/tradingview-chart-mcp)** - ⭐ 75
...
2110. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 75
...
2111. **[masquerade](https://github.com/postralai/masquerade)** - ⭐ 74
   The Privacy Firewall for LLMs

2112. **[conductor-tasks](https://github.com/hridaya423/conductor-tasks)** - ⭐ 74
   A task management system designed for AI development

2113. **[unreal-mcp](https://github.com/runreal/unreal-mcp)** - ⭐ 74
   MCP server for Unreal Engine that uses Unreal Python Remote Execution

2114. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 74
   Index of all Model Context Protocol (MCP) clients and their capabilities

2115. **[gdai-mcp-plugin-godot](https://github.com/3ddelano/gdai-mcp-plugin-godot)** - ⭐ 74
...
2116. **[UnrealMotionGraphicsMCP](https://github.com/winyunq/UnrealMotionGraphicsMCP)** - ⭐ 74
...
2117. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 74
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

2118. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 74
   An extension of MCP for SillyTavern.

2119. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 74
...
2120. **[hulunote](https://github.com/hulunote/hulunote)** - ⭐ 74
   AI + Note Hippocampus — Your second brain, powered by AI

2121. **[google-drive-mcp](https://github.com/piotr-agier/google-drive-mcp)** - ⭐ 74
...
2122. **[bitcoin-mcp](https://github.com/AbdelStark/bitcoin-mcp)** - ⭐ 73
   Bitcoin & Lightning Network MCP Server.

2123. **[sanity-mcp-server](https://github.com/sanity-io/sanity-mcp-server)** - ⭐ 73
   Deprecated: Use the remote MCP server at https://mcp.sanity.io instead.

2124. **[Custom-MCP-Server](https://github.com/Sharan-Kumar-R/Custom-MCP-Server)** - ⭐ 73
   MCP server for scraping LinkedIn, Facebook, Instagram profiles and Google search.

2125. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 73
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

2126. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 73
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

2127. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 73
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

2128. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 73
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

2129. **[adb-tui](https://github.com/alanisme/adb-tui)** - ⭐ 73
   🤖 Full-featured Android Debug Bridge TUI and MCP server. Control any device by keystroke or AI.

2130. **[github-brain](https://github.com/wham/github-brain)** - ⭐ 72
   An experimental GitHub MCP server with local database.

2131. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 72
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

2132. **[mcp-openmemory](https://github.com/baryhuang/mcp-openmemory)** - ⭐ 72
   Simple standalone MCP server giving Claude the ability to remember your conversations and learn from them over time.

2133. **[joplin-mcp](https://github.com/alondmnt/joplin-mcp)** - ⭐ 72
   MCP server for the Joplin note taking app

2134. **[mengram](https://github.com/alibaizhanov/mengram)** - ⭐ 72
...
2135. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 72
...
2136. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 72
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

2137. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 72
   Python code execution sandbox with programmatic MCP tool calling (PTC)

2138. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 72
   A Model Context Protocol server for Zendesk

2139. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 72
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2140. **[railway-mcp](https://github.com/jason-tan-swe/railway-mcp)** - ⭐ 72
   An unofficial and community-built MCP server for integrating with https://railway.app

2141. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 72
...
2142. **[ytt-mcp](https://github.com/cottongeeks/ytt-mcp)** - ⭐ 71
   MCP server to fetch YouTube transcripts

2143. **[MCP-wolfram-alpha](https://github.com/SecretiveShell/MCP-wolfram-alpha)** - ⭐ 71
   Connect your chat repl to wolfram alpha computational intelligence

2144. **[template-mcp-server](https://github.com/mcpdotdirect/template-mcp-server)** - ⭐ 71
   Template to quickly set up your own MCP server 

2145. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 71
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

2146. **[anilist-mcp](https://github.com/yuna0x0/anilist-mcp)** - ⭐ 71
   AniList MCP server for accessing anime and manga data

2147. **[sub-agents-mcp](https://github.com/shinpr/sub-agents-mcp)** - ⭐ 71
   Define task-specific AI sub-agents in Markdown for any MCP-compatible tool.

2148. **[medical-mcp](https://github.com/JamesANZ/medical-mcp)** - ⭐ 71
...
2149. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 71
...
2150. **[youtube-connector-mcp](https://github.com/ShellyDeng08/youtube-connector-mcp)** - ⭐ 71
   MCP server for YouTube — search videos, get transcripts, channels, and playlists. Works with Claude, Cursor & any MCP client.

2151. **[agenticmail](https://github.com/agenticmail/agenticmail)** - ⭐ 71
   Email & SMS infrastructure for AI agents — send and receive real email and text messages programmatically

2152. **[Gopeak-godot-mcp](https://github.com/HaD0Yun/Gopeak-godot-mcp)** - ⭐ 71
...
2153. **[trading-mcp](https://github.com/netanelavr/trading-mcp)** - ⭐ 70
   The MCP server that will help you trade smarter (or at least try)

2154. **[mcp-discord](https://github.com/barryyip0625/mcp-discord)** - ⭐ 70
   Implement Discord MCP server enabling AI assistants to interact with the Discord platform.

2155. **[ableton-copilot-mcp](https://github.com/xiaolaa2/ableton-copilot-mcp)** - ⭐ 70
...
2156. **[ros2_mcp](https://github.com/wise-vision/ros2_mcp)** - ⭐ 70
   Advanced MCP Server ROS 2 bridging AI agents straight into robotics

2157. **[CodeMCP](https://github.com/SimplyLiz/CodeMCP)** - ⭐ 70
   Code intelligence for AI assistants - MCP server, CLI, and HTTP API with symbol navigation, impact analysis, and architecture mapping

2158. **[mcd-mcp-server](https://github.com/M-China/mcd-mcp-server)** - ⭐ 70
   McDonald's China MCP Server Integration Guide

2159. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 70
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

2160. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 70
   Model Context Protocol (MCP) server for Gmail

2161. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 70
   A Model Context Protocol (MCP) server for Microsoft Clarity

2162. **[dramacraft](https://github.com/whatyun/dramacraft)** - ⭐ 70
   DramaCraft 是一个专业的短剧视频编辑 MCP (Model Context Protocol) 服务，集成国产中文大模型 API，实现剪映的智能自动化编辑功能。项目已完成从视频分析到草稿生成的完整解决方案

2163. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 70
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

2164. **[fred-mcp-server](https://github.com/stefanoamorelli/fred-mcp-server)** - ⭐ 70
   Open-source FRED MCP Server (Federal Reserve Economic Data)

2165. **[teams-mcp](https://github.com/floriscornel/teams-mcp)** - ⭐ 70
...
2166. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 69
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

2167. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 69
   MCP client for local ollama models

2168. **[wasmcp](https://github.com/wasmcp/wasmcp)** - ⭐ 69
   Build MCP servers with WebAssembly components

2169. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 69
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

2170. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 69
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

2171. **[robot_MCP](https://github.com/IliaLarchenko/robot_MCP)** - ⭐ 69
   A simple MCP server for the SO-ARM100 control

2172. **[xc-mcp](https://github.com/conorluddy/xc-mcp)** - ⭐ 69
...
2173. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 69
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

2174. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 69
...
2175. **[lc2mcp](https://github.com/xiaotonng/lc2mcp)** - ⭐ 69
   Convert LangChain tools to FastMCP tools

2176. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 68

2177. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 68
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

2178. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 68
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

2179. **[ClueoMCP](https://github.com/ClueoFoundation/ClueoMCP)** - ⭐ 68
...
2180. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 68
...
2181. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 68
...
2182. **[mcp-server-node](https://github.com/lucianoayres/mcp-server-node)** - ⭐ 68
...
2183. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 68
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

2184. **[deep-research-mcp-server](https://github.com/ssdeanx/deep-research-mcp-server)** - ⭐ 68
   MCP Deep Research Server using Gemini creating a Research AI Agent

2185. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 68
   Python 实现 MCP client / service

2186. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 68
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

2187. **[pydantic-rpc](https://github.com/i2y/pydantic-rpc)** - ⭐ 68
...
2188. **[vesta-mac-dist](https://github.com/scouzi1966/vesta-mac-dist)** - ⭐ 68
...
2189. **[hyperterse](https://github.com/hyperterse/hyperterse)** - ⭐ 68
   The MCP framework. Connect your data to your agents.

2190. **[regenerator2000](https://github.com/ricardoquesada/regenerator2000)** - ⭐ 68
...
2191. **[nothumanallowed](https://github.com/adoslabsproject-gif/nothumanallowed)** - ⭐ 68
...
2192. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 68
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

2193. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 68
...
2194. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 68
...
2195. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 68
...
2196. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 68
...
2197. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 67
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

2198. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

2199. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

2200. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 67
...
2201. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 67
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

2202. **[shinzo-ts](https://github.com/shinzo-labs/shinzo-ts)** - ⭐ 67
...
2203. **[nav2_mcp_server](https://github.com/ajtudela/nav2_mcp_server)** - ⭐ 67
   MCP server that provides tools and resources to control and monitor robots using Nav2.

2204. **[QuickMCP](https://github.com/gunpal5/QuickMCP)** - ⭐ 67
   Effortlessly Build Model Context Protocol Servers with OpenAPI or Swagger or Google Discovery Specifications

2205. **[mcp-bear](https://github.com/jkawamoto/mcp-bear)** - ⭐ 67
   A MCP server for interacting with Bear note-taking software.

2206. **[nautex](https://github.com/hmldns/nautex)** - ⭐ 67
   MCP server for guiding Coding Agents via end-to-end requirements to implementation plan pipeline

2207. **[crash-mcp](https://github.com/nikkoxgonzales/crash-mcp)** - ⭐ 67
   MCP server for structured and efficient reasoning with step validation, branching, and revisions.

2208. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 67
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

2209. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 67
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

2210. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 67
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resource Templates for client-side exploration.

2211. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 67
...
2212. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 66
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

2213. **[awesome-mcp-best-practices](https://github.com/lirantal/awesome-mcp-best-practices)** - ⭐ 66
   Build Awesome MCPs with Awesome Best Practices for MCP Servers and MCP Clients

2214. **[flapi](https://github.com/DataZooDE/flapi)** - ⭐ 66
...
2215. **[VibeShift](https://github.com/GroundNG/VibeShift)** - ⭐ 66
   [MCP Server] The Security Agent for AI assisted coding

2216. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 66
...
2217. **[amazon-mcp](https://github.com/Fewsats/amazon-mcp)** - ⭐ 66
   Amazon MCP server to search & buy products using the L402

2218. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 66
   Model Context Protocol(MCP) 中文教程讲解

2219. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 66
...
2220. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 66
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

2221. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 66
...
2222. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 66
   Headless IDA Pro binary analysis via Model Context Protocol

2223. **[obsidian-web-mcp](https://github.com/jimprosser/obsidian-web-mcp)** - ⭐ 66
...
2224. **[mcp4k](https://github.com/ondrsh/mcp4k)** - ⭐ 65
   Compiler-driven MCP framework for Kotlin Multiplatform

2225. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 65
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

2226. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 65
   A Model Context Protocol implementation for FHIR

2227. **[fhir-mcp-server](https://github.com/the-momentum/fhir-mcp-server)** - ⭐ 65
   FHIR MCP Server for handling medical data standard.

2228. **[academia_mcp](https://github.com/IlyaGusev/academia_mcp)** - ⭐ 65
   Academia MCP server: Tools for automatic scientific research

2229. **[usolver](https://github.com/sdiehl/usolver)** - ⭐ 65
   A model context protocol server for solving combinatorial optimization problems with logical and numerical constraints.

2230. **[mcp-shell](https://github.com/sonirico/mcp-shell)** - ⭐ 65
   Give hands to AI. MCP server to run shell commands securely, auditably, and on demand.

2231. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 65
   可视化的配置和管理，给xiaozhi接入mcp

2232. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 65
...
2233. **[ClaudeHistoryMCP](https://github.com/jhammant/ClaudeHistoryMCP)** - ⭐ 65
   MCP server for searching and surfacing Claude Code conversation history

2234. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 65
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

2235. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 64
   LSD Model Context Protocol

2236. **[ollama-mcp-client](https://github.com/anjor/ollama-mcp-client)** - ⭐ 64

2237. **[mcp-config](https://github.com/marcusschiesser/mcp-config)** - ⭐ 64
   A CLI tool for easy installation of MCP servers and managing their configuration

2238. **[mcp-server](https://github.com/UI5/mcp-server)** - ⭐ 64
   The UI5 MCP server improves the developer experience when working with agentic AI and the UI5 framework.

2239. **[mcp-sdk](https://github.com/AntigmaLabs/mcp-sdk)** - ⭐ 64
   Minimalistic Rust Implementation Of Model Context Protocol from Anthropic

2240. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 64
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

2241. **[winremote-mcp](https://github.com/dddabtc/winremote-mcp)** - ⭐ 64
   Windows Remote MCP Server — 40+ tools for desktop automation, process management, file operations via FastMCP

2242. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 63
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

2243. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 63
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

2244. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 63
...
2245. **[sublinear-time-solver](https://github.com/ruvnet/sublinear-time-solver)** - ⭐ 63
...
2246. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 63
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

2247. **[crawl4ai-mcp-server](https://github.com/sadiuysal/crawl4ai-mcp-server)** - ⭐ 63
...
2248. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 62
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

2249. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 62
   Miro integration for Model Context Protocol

2250. **[mcp-server-ccxt](https://github.com/Nayshins/mcp-server-ccxt)** - ⭐ 62
   Cryptocurrency Market Data MCP Server

2251. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

2252. **[data-gov-il-mcp](https://github.com/DavidOsherdiagnostica/data-gov-il-mcp)** - ⭐ 62
   Advanced MCP server for seamless access to Israeli Government Open Data

2253. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 62
   Model Context Protocol server and client for R

2254. **[fli](https://github.com/punitarani/fli)** - ⭐ 62
   Google Flights MCP and Python Library

2255. **[mcp-server-security-standard](https://github.com/mcp-security-standard/mcp-server-security-standard)** - ⭐ 62
...
2256. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 62
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

2257. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 62
...
2258. **[Alph](https://github.com/Aqualia/Alph)** - ⭐ 62
   Universal MCP Server Configuration Manager

2259. **[mcp-manager](https://github.com/MediaPublishing/mcp-manager)** - ⭐ 62
   A web-based GUI tool for managing Model Context Protocol (MCP) servers in Claude and Cursor

2260. **[linkedin-mcp-server](https://github.com/eliasbiondo/linkedin-mcp-server)** - ⭐ 62
...
2261. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

2262. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 61
...
2263. **[yamcp](https://github.com/hamidra/yamcp)** - ⭐ 61
   Organize your MCP servers in local workspaces, share them as Yet-Another-MCP through a single command

2264. **[identity-service](https://github.com/agntcy/identity-service)** - ⭐ 61
...
2265. **[nocodb-mcp-server](https://github.com/edwinbernadus/nocodb-mcp-server)** - ⭐ 61
   nocodb mcp server

2266. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 61
   A Clojure SDK to create MCP servers (and eventually clients)

2267. **[zeromcp](https://github.com/mrexodia/zeromcp)** - ⭐ 61
   Zero-dependency MCP server implementation.

2268. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 61
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

2269. **[baml-agents](https://github.com/Elijas/baml-agents)** - ⭐ 61
   Building Agents with LLM structured generation (BAML), MCP Tools, and 12-Factor Agents principles

2270. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 61
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

2271. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 61
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

2272. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 61
   A Model Context Protocol (MCP) server for Rember.

2273. **[godoctor](https://github.com/danicat/godoctor)** - ⭐ 61
   A Model Context Protocol server for Go developers

2274. **[Skills-ContextManager](https://github.com/One-Man-Company/Skills-ContextManager)** - ⭐ 61
...
2275. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 60
   A curated list of awesome Model Context Protocol (MCP) servers.

2276. **[devto-mcp](https://github.com/Arindam200/devto-mcp)** - ⭐ 60
   MCP Server of DevTo

2277. **[autosteer](https://github.com/notch-ai/autosteer)** - ⭐ 60
   Desktop app for multi-workspace Claude Code management

2278. **[mcp-server-echart](https://github.com/cnkanwei/mcp-server-echart)** - ⭐ 60
   基于 mcp-go 框架构建的 mcp 服务，它提供了一个能动态生成 ECharts 图表页面的工具。

2279. **[time-mcp](https://github.com/yokingma/time-mcp)** - ⭐ 60
   ⏰ Time MCP Server: Giving LLMs Time Awareness Capabilities

2280. **[blockbench-mcp-plugin](https://github.com/jasonjgardner/blockbench-mcp-plugin)** - ⭐ 60
   Adds MCP server to Blockbench

2281. **[mcp-server-atlassian-jira](https://github.com/aashari/mcp-server-atlassian-jira)** - ⭐ 60
...
2282. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 60
...
2283. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 60
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

2284. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 60
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

2285. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 60
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the Anysite API, enabling not only data retrieval but also robust management of user accounts.

2286. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 60
...
2287. **[MCP-Dandan](https://github.com/82ch/MCP-Dandan)** - ⭐ 60
   MCP Security Solution for Agentic AI — real-time proxying, behavior analysis, and malicious tool detection

2288. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 60
...
2289. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 60
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2290. **[mcp-difyworkflow-server](https://github.com/gotoolkits/mcp-difyworkflow-server)** - ⭐ 59
   mcp-difyworkflow-server is an mcp server Tools application that implements the query and invocation of Dify workflows, supporting the on-demand operation of multiple custom Dify workflows.

2291. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 59
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

2292. **[cline-mcp-memory-bank](https://github.com/dazeb/cline-mcp-memory-bank)** - ⭐ 59
   A memory system for Cline that tracks progress between conversations.

2293. **[shadcn-ui-mcp-server](https://github.com/ymadd/shadcn-ui-mcp-server)** - ⭐ 59
   MCP server for shadcn/ui component references

2294. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 59
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

2295. **[mcp_server_gdb](https://github.com/pansila/mcp_server_gdb)** - ⭐ 59
   MCP Server to expose the GDB debugging capabilities

2296. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 59
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

2297. **[mono-mcp](https://github.com/sin4ch/mono-mcp)** - ⭐ 59
   A comprehensive Model Context Protocol (MCP) server for Nigerian banking operations using the Mono Open Banking API.

2298. **[ask-user-questions-mcp](https://github.com/paulp-o/ask-user-questions-mcp)** - ⭐ 59
...
2299. **[trpc-mcp-go](https://github.com/trpc-group/trpc-mcp-go)** - ⭐ 59
   Go implementation of the Model Context Protocol (MCP) with comprehensive Streamable HTTP, STDIO, and SSE support. 

2300. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 59
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

2301. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 59
   MCP router and Web Based MCP client

2302. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 59
   ABAP MCP - Model Context Protocol - Server SDK

2303. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 59
   A Model Context Protocol server for Ashra

2304. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 59
...
2305. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 59
   Attio Model Context Protocol (MCP) server implementation

2306. **[stackoverflow-mcp](https://github.com/gscalzo/stackoverflow-mcp)** - ⭐ 59
   A Model Context Protocol server for querying Stack Overflow to help AI models find programming solutions

2307. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 59
...
2308. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 59
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

2309. **[mcpserver](https://github.com/2234839/mcpserver)** - ⭐ 58
   为claude code+glm 添加上眼睛

2310. **[job-searchoor](https://github.com/0xDAEF0F/job-searchoor)** - ⭐ 58
   A simple MCP server that delivers you jobs based on your needs

2311. **[scrapegraph-mcp](https://github.com/ScrapeGraphAI/scrapegraph-mcp)** - ⭐ 58
   ScapeGraph MCP Server

2312. **[vscode-mcp](https://github.com/tjx666/vscode-mcp)** - ⭐ 58
...
2313. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 58
...
2314. **[mcp-ssh](https://github.com/shuakami/mcp-ssh)** - ⭐ 58
   🔐 SSH MCP Tool - AI-powered SSH management through MCP protocol | 基于MCP协议的SSH工具，为AI提供SSH远程操作能力

2315. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 58
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

2316. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 58
   Unblock, scrape, and search tools for MCP clients

2317. **[gdal-mcp](https://github.com/JordanGunn/gdal-mcp)** - ⭐ 58
...
2318. **[cortex-scout](https://github.com/cortex-works/cortex-scout)** - ⭐ 58
...
2319. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 57
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

2320. **[sugar](https://github.com/roboticforce/sugar)** - ⭐ 57
   Persistent memory for AI coding agents. Cross-session context, global knowledge, and autonomous task execution.

2321. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 57
   Model Context Protocol server for Daipendency

2322. **[Archive-Agent](https://github.com/shredEngineer/Archive-Agent)** - ⭐ 57
   Find your files with natural language and ask questions.

2323. **[adbfriend](https://github.com/mikepenz/adbfriend)** - ⭐ 57
   Android ADB CLI tool including integrated MCP Server with common adb actions used during development

2324. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 57
   MKP is a Model Context Protocol (MCP) server for Kubernetes

2325. **[MCP_Atom_of_Thoughts](https://github.com/kbsooo/MCP_Atom_of_Thoughts)** - ⭐ 57
...
2326. **[chucknorris](https://github.com/pollinations/chucknorris)** - ⭐ 57
...
2327. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 57
   Model Context Protocol (MCP) server implementation for Autodesk Maya

2328. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 57
   A Nasdaq Data Link MCP (Model Context Protocol) Server

2329. **[mcp-batchit](https://github.com/ryanjoachim/mcp-batchit)** - ⭐ 57
...
2330. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 57
   A CalDAV client using Model Context Protocol (MCP) to expose calendar operations as tools for AI assistants.

2331. **[naver-search-mcp](https://github.com/isnow890/naver-search-mcp)** - ⭐ 56
...
2332. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 56
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

2333. **[Intelli](https://github.com/intelligentnode/Intelli)** - ⭐ 56
   Build multi-model chatbots and agents from intent.

2334. **[mcp-thinking](https://github.com/mattzcarey/mcp-thinking)** - ⭐ 56
   thinking tool for claude desktop/mcp clients using Deepseek reasoner

2335. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 56
...
2336. **[solana-mcp-server](https://github.com/openSVM/solana-mcp-server)** - ⭐ 56
   solana mcp sever to enable solana rpc methods

2337. **[web2mcp](https://github.com/neelsomani/web2mcp)** - ⭐ 56
   Generate an MCP for any web app

2338. **[mcp-server-flomo](https://github.com/chatmcp/mcp-server-flomo)** - ⭐ 56
   Write notes to Flomo

2339. **[MegaMemory](https://github.com/0xK3vin/MegaMemory)** - ⭐ 56
   Persistent project knowledge graph for coding agents. MCP server with semantic search, in-process embeddings, and web explorer.

2340. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 56
...
2341. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 56
   OCaml implementation of the Model Context Protocol (MCP)

2342. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 56
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

2343. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 56
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

2344. **[mcp-victorialogs](https://github.com/VictoriaMetrics/mcp-victorialogs)** - ⭐ 56
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2345. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 56
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

2346. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 56
...
2347. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 56
   MCP (Model Context Protocol) server plugin for CAP NodeJS

2348. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 56
   MCP Server for IBKR Client

2349. **[mealie-mcp-server](https://github.com/rldiao/mealie-mcp-server)** - ⭐ 56
   MCP server that exposes Mealie APIs to MCP clients such as Claude Desktop

2350. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 55
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

2351. **[astro-mcp](https://github.com/morinokami/astro-mcp)** - ⭐ 55
   MCP server to support Astro project development

2352. **[mcp-secrets-plugin](https://github.com/amirshk/mcp-secrets-plugin)** - ⭐ 55
...
2353. **[trellis_blender](https://github.com/FishWoWater/trellis_blender)** - ⭐ 55
   Blender plugin for TRELLIS and TRELLIS.2 (3D AIGC Model, Text-to-3D, Image-to-3D)

2354. **[powhttp-mcp](https://github.com/usestring/powhttp-mcp)** - ⭐ 55
   MCP server enabling agents to debug HTTP requests better (using powhttp)

2355. **[python](https://github.com/mcp-auth/python)** - ⭐ 55
   🔐 Plug-and-play auth for Python MCP servers.

2356. **[cosmotop](https://github.com/bjia56/cosmotop)** - ⭐ 55
   Multiplatform system monitoring tool using Cosmopolitan Libc

2357. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 55
...
2358. **[AfdianToMarkdown](https://github.com/PhiFever/AfdianToMarkdown)** - ⭐ 55
   爱发电爬虫(afdian.com)

2359. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 55
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

2360. **[deploystack](https://github.com/deploystackio/deploystack)** - ⭐ 55
   Open source MCP hosting - deploy MCP servers to HTTP endpoints for n8n, Dify, Voiceflow, and any MCP client.

2361. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 55
...
2362. **[mcp-server-apple-events](https://github.com/FradSer/mcp-server-apple-events)** - ⭐ 55
   MCP server providing native macOS integration with Apple Reminders and Calendar via EventKit

2363. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 55
...
2364. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 55
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

2365. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 55
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

2366. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 55
...
2367. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

2368. **[minibridge](https://github.com/acuvity/minibridge)** - ⭐ 54
   Make your MCP servers secure and production ready

2369. **[temporal-mcp](https://github.com/Mocksi/temporal-mcp)** - ⭐ 54
   Empowering AI with Workflow Orchestration

2370. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 54
   Model Context Protocol Servers for Azure AI Search

2371. **[mcp-duckdb-memory-server](https://github.com/IzumiSy/mcp-duckdb-memory-server)** - ⭐ 54
   MCP Memory Server with DuckDB backend

2372. **[sympy-mcp](https://github.com/sdiehl/sympy-mcp)** - ⭐ 54
   A MCP server for symbolic manipulation of mathematical expressions

2373. **[swift-mcp-gui](https://github.com/NakaokaRei/swift-mcp-gui)** - ⭐ 54
   MCP server that can execute commands such as keyboard input and mouse movement on macOS

2374. **[talkito](https://github.com/robdmac/talkito)** - ⭐ 54
...
2375. **[Navidrome-MCP](https://github.com/Blakeem/Navidrome-MCP)** - ⭐ 54
...
2376. **[claude-code-emacs](https://github.com/yuya373/claude-code-emacs)** - ⭐ 54
...
2377. **[client](https://github.com/php-mcp/client)** - ⭐ 54
   Core PHP implementation for the Model Context Protocol (MCP) Client

2378. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 54
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

2379. **[gno](https://github.com/gmickel/gno)** - ⭐ 54
...
2380. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 54
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

2381. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 54
...
2382. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 54
...
2383. **[aguara](https://github.com/garagon/aguara)** - ⭐ 54
...
2384. **[Memory-Plus](https://github.com/Yuchen20/Memory-Plus)** - ⭐ 54
...
2385. **[mcp](https://github.com/getAlby/mcp)** - ⭐ 54
   Connect a bitcoin lightning wallet to your LLM using Nostr Wallet Connect and Model Context Protocol

2386. **[Fusion-360-MCP-Server](https://github.com/AuraFriday/Fusion-360-MCP-Server)** - ⭐ 54
   Control Fusion 360 with any AI through Model Context Protocol (MCP)

2387. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 54
   Altium Model Context Protocol server and Altium API script

2388. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 53
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

2389. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 53
...
2390. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

2391. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 53
   Unofficial Golang SDK for Anthropic Model Context Protocol

2392. **[user-feedback-mcp](https://github.com/mrexodia/user-feedback-mcp)** - ⭐ 53
   Simple MCP Server to enable a human-in-the-loop workflow in tools like Cline and Cursor.

2393. **[Multi-Agent-System-A2A-ADK-MCP](https://github.com/RubensZimbres/Multi-Agent-System-A2A-ADK-MCP)** - ⭐ 53
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2394. **[skrills](https://github.com/athola/skrills)** - ⭐ 53
...
2395. **[ntfy-me-mcp](https://github.com/gitmotion/ntfy-me-mcp)** - ⭐ 53
...
2396. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 53
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

2397. **[mcp-dap-server](https://github.com/go-delve/mcp-dap-server)** - ⭐ 53
   MCP server to communicate with DAP servers allowing AI Agents the ability to debug live programs.

2398. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 53
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

2399. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 53
   A Model Context Protocol server that validates and renders Mermaid diagrams.

2400. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 53
...
2401. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 53
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

2402. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 53
...
2403. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 53
...
2404. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 53
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

2405. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 53
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

2406. **[mcp-guard](https://github.com/General-Analysis/mcp-guard)** - ⭐ 53
   MCP Guard secures your MCP client from prompt injection attacks and more.

2407. **[mcp-app-demo](https://github.com/pomerium/mcp-app-demo)** - ⭐ 52
...
2408. **[A2A_ADK_MCP](https://github.com/RubensZimbres/A2A_ADK_MCP)** - ⭐ 52
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2409. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 52
...
2410. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 52
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2411. **[baba_is_eval](https://github.com/lennart-finke/baba_is_eval)** - ⭐ 52
   Claude  et al. play the brilliant puzzle title "Baba is You"

2412. **[us-census-bureau-data-api-mcp](https://github.com/uscensusbureau/us-census-bureau-data-api-mcp)** - ⭐ 52
   The U.S. Census Bureau Data API MCP connects AI Assistants with official Census Bureau statistics.

2413. **[youtube-mcp-server](https://github.com/mourad-ghafiri/youtube-mcp-server)** - ⭐ 52
   A powerful Model Context Protocol (MCP) server for YouTube video transcription and metadata extraction.

2414. **[gemini-cloud-assist-mcp](https://github.com/GoogleCloudPlatform/gemini-cloud-assist-mcp)** - ⭐ 52
   An MCP Server for Gemini Cloud Assist; provides tools to assist with your tasks on GCP

2415. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 52
   Inkdrop Model Context Protocol Server

2416. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 52
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

2417. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 52
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

2418. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 52
   A powerful Model Context Protocol server for LinkedIn API integration

2419. **[crawlbase-mcp](https://github.com/crawlbase/crawlbase-mcp)** - ⭐ 52
   Crawlbase MCP Server connects AI agents and LLMs with real-time web data. It powers Claude, Cursor, and Windsurf integrations with battle-tested web scraping, JavaScript rendering, and anti-bot protection enabling structured, live data inside your AI workflows.

2420. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 52
   Model Context Protocol server for ActivityWatch time tracking data

2421. **[adeu](https://github.com/dealfluence/adeu)** - ⭐ 52
...
2422. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 51
...
2423. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 51
   Quantum-proof MCP Server and Client Interactions

2424. **[gdal-mcp](https://github.com/Wayfinder-Foundry/gdal-mcp)** - ⭐ 51
   Model Context Protocol server that packages GDAL-style geospatial workflows through Python-native libraries (Rasterio, GeoPandas, PyProj, etc.) to give AI agents catalog discovery, metadata intelligence, and raster/vector processing with built-in reasoning guidance and reference resources.

2425. **[whois-mcp](https://github.com/bharathvaj-ganesan/whois-mcp)** - ⭐ 51
   MCP Server for whois lookups.

2426. **[mcp-atlassian-server](https://github.com/phuc-nt/mcp-atlassian-server)** - ⭐ 51
   MCP server connecting AI assistants with Jira & Confluence for smart project management.

2427. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 51
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

2428. **[ShadowCrawl](https://github.com/DevsHero/ShadowCrawl)** - ⭐ 51
...
2429. **[rs-utcp](https://github.com/universal-tool-calling-protocol/rs-utcp)** - ⭐ 51
   Official Rust implementation of the UTCP

2430. **[hmr](https://github.com/promplate/hmr)** - ⭐ 51
   Real hot-module reload for Python—side effects handled reactively. https://py3.online/hmr

2431. **[matlab-mcp-server](https://github.com/subspace-lab/matlab-mcp-server)** - ⭐ 51
   Matlab MCP Server in python

2432. **[mcp-auth-servers](https://github.com/Azure-Samples/mcp-auth-servers)** - ⭐ 51
   🔒 Reference MCP servers that demo how authentication works with the current Model Context Protocol spec.

2433. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 51
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

2434. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 51
...
2435. **[go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql)** - ⭐ 51
   Zero burden, ready-to-use Model Context Protocol (MCP) server for interacting with MySQL and automation. No Node.js or Python environment needed.

2436. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 51
   Go SDK for interacting with the MCP Toolbox for Databases.

2437. **[SageFs](https://github.com/WillEhrendreich/SageFs)** - ⭐ 51
...
2438. **[metabase-mcp](https://github.com/hluaguo/metabase-mcp)** - ⭐ 51
...
2439. **[askimo](https://github.com/haiphucnguyen/askimo)** - ⭐ 51
   Open-source AI desktop app with built-in knowledge base, MCP support, and multi-provider models like OpenAI, Gemini, and Ollama.

2440. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 50

2441. **[Perigon.CLI](https://github.com/AterDev/Perigon.CLI)** - ⭐ 50
...
2445. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 50
...
2446. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 50
...
2447. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 50
   An implementation of the Model Context Protocol in Ruby.

2448. **[mcp-server-atlassian-confluence](https://github.com/aashari/mcp-server-atlassian-confluence)** - ⭐ 50
   Node.js/TypeScript MCP server for Atlassian Confluence. Provides tools enabling AI systems (LLMs) to list/get spaces & pages (content formatted as Markdown) and search via CQL. Connects AI seamlessly to Confluence knowledge bases using the standard MCP interface.

2449. **[gimp-mcp](https://github.com/maorcc/gimp-mcp)** - ⭐ 50
   GIMP MCP server

2450. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 50
   vMCP - Virtual Model Context Protocol

2451. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 50
...
2452. **[mcp-tts](https://github.com/blacktop/mcp-tts)** - ⭐ 50
   MCP Server for Text to Speech

2453. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 50
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

2454. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 50
   Amadeus MCP(Model Context Protocol) Server

2455. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

2456. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

2457. **[rulego-server](https://github.com/rulego/rulego-server)** - ⭐ 50
   A lightweight dependency-free workflow automation platform. Supports iPaaS, stream computing, MCP, and AI capabilities. 

2458. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 50
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

2459. **[mcpshim](https://github.com/mcpshim/mcpshim)** - ⭐ 50
   Turn remote MCP servers into local command workflows.

2460. **[mcp](https://github.com/40ants/mcp)** - ⭐ 50
   40ANTS-MCP is a framework for building Model Context Protocol servers in Common Lisp

2461. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

2462. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 50
...
2463. **[tokio-prompt-orchestrator](https://github.com/Mattbusel/tokio-prompt-orchestrator)** - ⭐ 49
   Multi-core, Tokio-native orchestration for LLM pipelines.

2464. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 49
...
2473. **[sample-agentic-ai-web](https://github.com/aws-samples/sample-agentic-ai-web)** - ⭐ 49
...
2474. **[mcp_server_notify](https://github.com/Cactusinhand/mcp_server_notify)** - ⭐ 49
   Send system notification when Agent task is done.

2475. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 49
...
2476. **[fossil-mcp](https://github.com/yfedoseev/fossil-mcp)** - ⭐ 49
   The code quality toolkit for the agentic AI era. Find dead code, clones, and scaffolding across 15 languages. MCP server + CLI.

2477. **[thoughtbox](https://github.com/Kastalien-Research/thoughtbox)** - ⭐ 49
   Thoughtbox is a Git-inspired workspace for Agent Teams.

2478. **[openscad-mcp](https://github.com/quellant/openscad-mcp)** - ⭐ 49
   A Model Context Protocol (MCP) server for OpenSCAD 3D modeling and rendering

2479. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 49
...
2480. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 49
   MCP (Model Context Protocol) server for the Contentful Management API

2481. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 49
   Implementation of Model Context Protocol server for Mailgun APIs

2482. **[pentestMCP](https://github.com/RamKansal/pentestMCP)** - ⭐ 49
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2483. **[civyk-winwright](https://github.com/civyk-official/civyk-winwright)** - ⭐ 48
...
2484. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
2485. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 48

2486. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

2487. **[mcp-server-chart-minio](https://github.com/zaizaizhao/mcp-server-chart-minio)** - ⭐ 48
   mcp-server-chart私有化部署方案

2488. **[lakevision](https://github.com/lakevision-project/lakevision)** - ⭐ 48
   Lakevision is a tool which provides insights into your Apache Iceberg based Data Lakehouse.

2489. **[buildkite-mcp-server](https://github.com/buildkite/buildkite-mcp-server)** - ⭐ 48
   Official MCP Server for Buildkite.

2490. **[mcp-metabase-server](https://github.com/easecloudio/mcp-metabase-server)** - ⭐ 48
   A comprehensive MCP server for Metabase with 70+ tools.

2491. **[globalping-mcp-server](https://github.com/jsdelivr/globalping-mcp-server)** - ⭐ 48
   Remote MCP server that gives LLMs access to run network commands

2492. **[advanced-homeassistant-mcp](https://github.com/jango-blockchained/advanced-homeassistant-mcp)** - ⭐ 48
   An advanced MCP server for Home Assistant. 🔋 Batteries included.

2493. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

2494. **[codex-specialized-subagents](https://github.com/leonardsellem/codex-specialized-subagents)** - ⭐ 48
   MCP server that lets Codex delegate to isolated codex exec sub-agents, selecting repo+global skills automatically

2495. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 48
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

2496. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 48
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

2497. **[luma-mcp](https://github.com/JochenYang/luma-mcp)** - ⭐ 48
...
2498. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

2499. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 48
   MCP client for Discourse sites

2500. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

2501. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

2502. **[youtrack-mcp](https://github.com/devstroop/youtrack-mcp)** - ⭐ 48
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2503. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 48
...
2504. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 48
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

2505. **[mirroir-mcp](https://github.com/jfarcand/mirroir-mcp)** - ⭐ 48
...
2506. **[drawio-mcp-server](https://github.com/simonkurtz-MSFT/drawio-mcp-server)** - ⭐ 48
...
2507. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 47
   A simple example of building an MCP client using C#.

2508. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
2509. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 47
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

2510. **[spec-coding-mcp](https://github.com/feiyun0112/spec-coding-mcp)** - ⭐ 47
...
2511. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 47
   Model Context Protocol to fetch youtube transcript

2512. **[gnome-mcp-server](https://github.com/bilelmoussaoui/gnome-mcp-server)** - ⭐ 47
   Grant the AI octopus access to a portion of your desktop

2513. **[dremio-mcp](https://github.com/dremio/dremio-mcp)** - ⭐ 47
   Dremio MCP server

2514. **[Reversecore_MCP](https://github.com/sjkim1127/Reversecore_MCP)** - ⭐ 47
...
2515. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 47
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

2516. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 47
   OpenAPI Schema Model Context Protocol Server

2517. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 47
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

2518. **[MDB-MCP](https://github.com/smadi0x86/MDB-MCP)** - ⭐ 47
   Multi Debugger MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

2519. **[mcp-zen](https://github.com/199-mcp/mcp-zen)** - ⭐ 47
   Enhanced Zen MCP Server with 'zen' default tool and improvements

2520. **[ai-software-architect](https://github.com/codenamev/ai-software-architect)** - ⭐ 47
...
2521. **[RivalSearchMCP](https://github.com/damionrashford/RivalSearchMCP)** - ⭐ 47
...
2522. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 47
...
2523. **[mcp-mail](https://github.com/shuakami/mcp-mail)** - ⭐ 47
   📧 MCP Mail Tool - AI-powered email management tool | 基于 MCP 的智能邮件管理工具

2524. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 47
   共学《MCP极简开发》项目代码

2525. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 47
...
2526. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 47
   Sample MCP Server and MCP client with Aspire

2527. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 47
   Un-official Serper Google search server for Cline and other MCP clients

2528. **[1c-mcp](https://github.com/Untru/1c-mcp)** - ⭐ 47
   Curated list of MCP servers for 1C:Enterprise ecosystem | Каталог MCP-серверов для экосистемы 1С:Предприятие

2529. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 47
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

2530. **[illustrator-mcp-server](https://github.com/spencerhhubert/illustrator-mcp-server)** - ⭐ 47
   mcp server to run scripts on adobe illustrator

2531. **[steel-mcp-server](https://github.com/steel-dev/steel-mcp-server)** - ⭐ 46
   MCP Server for interacting with a Steel web browser

2532. **[tiger-slack](https://github.com/timescale/tiger-slack)** - ⭐ 46
   Real-time Slack ingest and MCP server to power your agentic Slack bots

2533. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 46
   Model Context Protocol server for Flight Tracking

2534. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 46
   MCPcat is an analytics platform for MCP server owners 🐱.

2535. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 46
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

2536. **[inAI-wiki](https://github.com/inai-sandy/inAI-wiki)** - ⭐ 46
   🌍 The open-source Wikipedia of AI — 2M+ apps, agents, LLMs & datasets. Updated daily with tools, tutorials & news.

2537. **[lighthouse-mcp-server](https://github.com/danielsogl/lighthouse-mcp-server)** - ⭐ 46
   MCP server that enables AI agents to perform comprehensive web audits using Google Lighthouse with 13+ tools for performance, accessibility, SEO, and security analysis.

2538. **[lisply-mcp](https://github.com/gornskew/lisply-mcp)** - ⭐ 46
   Model Context Protocol (MCP) server to manage and talk to compliant "Lisply" lisp-speaking backend services

2539. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 46
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2540. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 46
   IMAP Model Context Protocol server for interactive email processing

2541. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 46
...
2542. **[sharedcontext](https://github.com/Eversmile12/sharedcontext)** - ⭐ 46
...
2543. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 46
...
2544. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 46
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

2545. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 46
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

2546. **[openzim-mcp](https://github.com/cameronrye/openzim-mcp)** - ⭐ 46
...
2547. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 46
...
2548. **[UnrealMCPBridge](https://github.com/appleweed/UnrealMCPBridge)** - ⭐ 46
   An Unreal Engine plugin that implements an MCP server allowing MCP clients to access the UE Editor Python API.

2549. **[agent-architecture-review-sample](https://github.com/Azure-Samples/agent-architecture-review-sample)** - ⭐ 46
...
2550. **[unreal-api-mcp](https://github.com/Codeturion/unreal-api-mcp)** - ⭐ 46
...
2551. **[mcp-bridgekit](https://github.com/mkbhardwas12/mcp-bridgekit)** - ⭐ 46
...
2552. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 45
   ElizaOS plugin allowing agents to connect to MCP servers

2553. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 45
   An opinionated starter template for making Model Context Protocol (MCP) servers

2554. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

2555. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 45
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

2556. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 45
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

2557. **[js](https://github.com/mcp-auth/js)** - ⭐ 45
   🔐 Plug-and-play auth for Node.js MCP servers.

2558. **[mcp-yfinance-server](https://github.com/Adity-star/mcp-yfinance-server)** - ⭐ 45
   Real-time stock API with Python, MCP server example, yfinance stock analysis dashboard

2559. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 45
   An implementation of the Model Context Protocol for the World Bank open data API

2560. **[mcp_server_filesystem](https://github.com/MarcusJellinghaus/mcp_server_filesystem)** - ⭐ 45
   MCP File System Server: A secure Model Context Protocol server that provides file operations for AI assistants. Enables Claude and other assistants to safely read, write, and list files in a designated project directory with robust path validation and security controls.

2561. **[ainovelprompter](https://github.com/danielsobrado/ainovelprompter)** - ⭐ 45
   Create the prompts you need to write your Novel using AI

2562. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 45
...
2563. **[kanban-mcp](https://github.com/bradrisse/kanban-mcp)** - ⭐ 45
...
2564. **[gopls-mcp](https://github.com/xieyuschen/gopls-mcp)** - ⭐ 45
   MCP server for golang projects development: Expand AI Code Agent ability boundary to have a semantic understanding and determinisic information for golang projects.

2565. **[org-mcp](https://github.com/laurynas-biveinis/org-mcp)** - ⭐ 45
   Emacs Org-mode integration with Model Context Protocol (MCP) for AI-assisted task management

2566. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 45
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

2567. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 45
...
2568. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 45
...
2569. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 45
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

2570. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 45
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

2571. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 45
   Model Context Protocol server for Salesforce REST API integration

2572. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 45
...
2573. **[mcp-workspace](https://github.com/MarcusJellinghaus/mcp-workspace)** - ⭐ 45
...
2574. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 45
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

2575. **[claude-additional-models-mcp](https://github.com/Arkya-AI/claude-additional-models-mcp)** - ⭐ 45
...
2576. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 44
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

2577. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 44
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

2578. **[moondream-mcp](https://github.com/ColeMurray/moondream-mcp)** - ⭐ 44
   Moondream MCP Server in Python

2579. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
2580. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 44
...
2581. **[mcp-typescribe](https://github.com/yWorks/mcp-typescribe)** - ⭐ 44
   An MCP server implementation enabling LLMs to work with new APIs and frameworks

2582. **[code-screenshot-mcp](https://github.com/MoussaabBadla/code-screenshot-mcp)** - ⭐ 44
   MCP server for generating beautiful code screenshots directly from Claude

2583. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 44
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

2584. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 44
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

2585. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 44
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

2586. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 44
...
2587. **[chrome-debug-mcp](https://github.com/robertheadley/chrome-debug-mcp)** - ⭐ 44
   An MCP server to allow you to debug webpages using LLMs

2588. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 44
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

2589. **[mcp-ai-memory](https://github.com/scanadi/mcp-ai-memory)** - ⭐ 44
   A production-ready Model Context Protocol (MCP) server for semantic memory management

2590. **[yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp)** - ⭐ 44
   Yandex Tracker MCP Server with OAuth2 support

2591. **[adal-cli](https://github.com/SylphAI-Inc/adal-cli)** - ⭐ 44
...
2592. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 44
   Model Context Protocol Platform，统一管理你的MCP服务

2593. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 44
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

2594. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 44
...
2595. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 44
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

2596. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 44
   GraphQL Schema Model Context Protocol Server

2597. **[powerpoint-mcp](https://github.com/Ayushmaniar/powerpoint-mcp)** - ⭐ 44
   Open Source Model Context Protocol server for PowerPoint automation on Windows via pywin32

2598. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 44
...
2599. **[omega-memory](https://github.com/omega-memory/omega-memory)** - ⭐ 44
   Persistent memory for AI coding agents

2600. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 44
...
2601. **[brainstorm-mcp](https://github.com/spranab/brainstorm-mcp)** - ⭐ 44
   MCP server for multi-round AI brainstorming debates between multiple models (GPT, DeepSeek, Groq, Ollama, etc.)

2602. **[godot-mcp](https://github.com/tugcantopaloglu/godot-mcp)** - ⭐ 44
   MCP server for full Godot 4.x engine control — 149 tools for AI-driven game development

2603. **[Unity-AI-Animation](https://github.com/IvanMurzak/Unity-AI-Animation)** - ⭐ 44
...
2604. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 43
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

2605. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 43
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

2606. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 43
   Model Context Protocol for WeChat

2607. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 43
   Generic MCP Client to use any MCP tool in a chat

2608. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 43
...
2609. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

2610. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 43
   A Model Context Protocol server implementation for Kagi's API

2611. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

2612. **[mcp-rquest](https://github.com/xxxbrian/mcp-rquest)** - ⭐ 43
...
2619. **[nia](https://github.com/nozomio-labs/nia)** - ⭐ 43
...
2620. **[lastsaas](https://github.com/jonradoff/lastsaas)** - ⭐ 43
...
2621. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 43
   A curated list of excellent Model Context Protocol (MCP) servers.

2622. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 43
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

2623. **[bonnard-cli](https://github.com/bonnard-data/bonnard-cli)** - ⭐ 43
   Open-source agentic schema CLI. Optimised for claude code, gemini, codex and co-pilot. Skills included.

2624. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 43
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

2625. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

2626. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 43
   Model Context Protocol (MCP) server for LinkedIn API integration

2627. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 43
...
2628. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

2629. **[unity-api-mcp](https://github.com/Codeturion/unity-api-mcp)** - ⭐ 43
...
2630. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 43
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2631. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 42
...
2632. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 42
   Solana Model Context Protocol (MCP) Demo

2633. **[mobile-dev-mcp-server](https://github.com/jsuarezruiz/mobile-dev-mcp-server)** - ⭐ 42
   This is a MCP designed to manage and interact with mobile devices and simulators.

2634. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 42
   Model Context Protocol Clojure support including REPL integration with development tools.

2635. **[zed-mcp-server-sequential-thinking](https://github.com/LoamStudios/zed-mcp-server-sequential-thinking)** - ⭐ 42
   A sequential thinking MCP server extension for Zed

2636. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 42
   Model Context Protocol (MCP) implementation for iOS simulators

2637. **[whatsapp-mcp](https://github.com/felipeadeildo/whatsapp-mcp)** - ⭐ 42
   WhatsApp Unofficial MCP Server

2638. **[linkedapi-mcp](https://github.com/Linked-API/linkedapi-mcp)** - ⭐ 42
   MCP server that lets AI assistants control LinkedIn accounts and retrieve real-time data.

2639. **[TWSEMCPServer](https://github.com/twjackysu/TWSEMCPServer)** - ⭐ 42
   台灣證交所OpenAPI 的 MCP Server

2640. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 42
   Bluesky MCP (Model Context Protocol) Server

2641. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 42
...
2642. **[twenty-crm-mcp-server](https://github.com/mhenry3164/twenty-crm-mcp-server)** - ⭐ 42
...
2643. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 42
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

2644. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 42
...
2645. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 42
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

2646. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 42
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

2647. **[evernote-mcp-server](https://github.com/brentmid/evernote-mcp-server)** - ⭐ 42
   Evernote MCP server - allows LLMs that support MCP (like Claude Desktop) to query your notes in Evernote

2648. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
   MCP server that exposes YepCode processes as callable tools for AI platforms. Securely connect AI assistants to your YepCode workflows, APIs, and automations.

2649. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 41
   Dynamic Shell Command MCP Server

2650. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 41
...
2651. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 41
   A Model Context Protocol server for Dify

2652. **[ZMCPTools](https://github.com/ZachHandley/ZMCPTools)** - ⭐ 41
   A custom TypeScript MCP Server intended to be used with Claude Code

2653. **[locallama-mcp](https://github.com/Heratiki/locallama-mcp)** - ⭐ 41
...
2654. **[seekcode](https://github.com/seekrays/seekcode)** - ⭐ 41
   A clean and efficient code snippet and clipboard management tool designed for developers

2655. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 41
...
2656. **[platform-context-exporter](https://github.com/alkoleft/platform-context-exporter)** - ⭐ 41
   Инструмент для выгрузки синтаксис помощника в файлы

2657. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 41
...
2658. **[mcp-obsidian](https://github.com/fazer-ai/mcp-obsidian)** - ⭐ 41
   MCP server for Obsidian (TypeScript + Bun)

2659. **[unreal-mcp](https://github.com/runeape-sats/unreal-mcp)** - ⭐ 41
   Unreal Engine MCP server for Claude Desktop (early alpha preview)

2660. **[neurondb](https://github.com/neurondb/neurondb)** - ⭐ 41
   PostgreSQL extension for vector search, embeddings, and ML, plus NeuronAgent runtime and NeuronMCP server.

2661. **[processhacker-mcp](https://github.com/illegal-instruction-co/processhacker-mcp)** - ⭐ 41
   your ai debugger, vibe hacking tool

2662. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 41
   A Model Context Protocol server that provides access to Shodan API functionality

2663. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 41
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

2664. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 41
   Algorand Local Model Context Protocol (Server & Client)

2665. **[octave-mcp](https://github.com/elevanaltd/octave-mcp)** - ⭐ 41
...
2666. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 41
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

2667. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 41
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

2668. **[adb-mcp](https://github.com/srmorete/adb-mcp)** - ⭐ 41
   An MCP (Model Context Protocol) server for interacting with Android devices through ADB in TypeScript.

2669. **[notebooklm-mcp-secure](https://github.com/Pantheon-Security/notebooklm-mcp-secure)** - ⭐ 41
   Secure NotebookLM MCP Server - Query Google NotebookLM from Claude/AI agents with 17 security hardening layers

2670. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 41
...
2671. **[mcp-codebase-index](https://github.com/MikeRecognex/mcp-codebase-index)** - ⭐ 41
...
2672. **[mermaid-mcp](https://github.com/Narasimhaponnada/mermaid-mcp)** - ⭐ 41

2673. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 41
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

2674. **[reaper-mcp](https://github.com/bonfire-audio/reaper-mcp)** - ⭐ 41
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2675. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 40
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2676. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 40
   a mcp server for polymarket

2677. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 40
   A generic, modular server for implementing the Model Context Protocol (MCP). 

2678. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 40
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

2679. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

2680. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 40
   A MCP client for browser-use

2681. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 40
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

2682. **[just-mcp](https://github.com/toolprint/just-mcp)** - ⭐ 40
   Share the same project justfile tasks with your AI Coding Agent.

2683. **[scraps](https://github.com/boykush/scraps)** - ⭐ 40
   Scraps is a portable CLI knowledge hub for managing interconnected Markdown documentation with Wiki-link notation.

2684. **[mcp-panther](https://github.com/panther-labs/mcp-panther)** - ⭐ 40
   Write detections, investigate alerts, and query logs from your favorite AI agents

2685. **[forgejo-mcp](https://github.com/raohwork/forgejo-mcp)** - ⭐ 40
   A MCP server that enables you to manage Gitea/Forgejo repositories through AI assistants

2686. **[pdf-rag-mcp-server](https://github.com/hyson666/pdf-rag-mcp-server)** - ⭐ 40
   PDF RAG server for cursor.

2687. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 40
...
2688. **[bonnard-cli](https://github.com/meal-inc/bonnard-cli)** - ⭐ 40
   Agent-native analytics. MCP server, dashboards, SDK, and semantic layer CLI.

2689. **[apple-books-mcp](https://github.com/vgnshiyer/apple-books-mcp)** - ⭐ 40
   Apple Books MCP Server

2690. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 40
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2691. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 40
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

2692. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 40
   It shows how to use model-context-protocol. 

2693. **[memcord](https://github.com/ukkit/memcord)** - ⭐ 40
   🧠 Privacy-first MCP server for AI memory management. Save, search & organize chat history with intelligent  summarization.

2694. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 40
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

2695. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 40
   Rimworld Coding RAG MCP server

2696. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 40
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

2697. **[mcp-client-cli](https://github.com/thedotmack/mcp-client-cli)** - ⭐ 40
   Command-line interface for any Model Context Protocol (MCP) server.

2698. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 40
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

2699. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 40
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

2700. **[gatekit](https://github.com/gatekit-ai/gatekit)** - ⭐ 40
   A hackable Model Context Protocol (MCP) gateway

2701. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 40
   Model Context Protocol server for Sitecore

2702. **[open-ghl-mcp](https://github.com/basicmachines-co/open-ghl-mcp)** - ⭐ 40
   An open source Model Context Protocol server for GoHighLevel API v2 with OAuth

2703. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 40
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

2704. **[mcpx](https://github.com/lydakis/mcpx)** - ⭐ 40
   Turn MCP servers into composable CLIs.

2705. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 40
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

2706. **[MCPwner](https://github.com/Pigyon/MCPwner)** - ⭐ 40
   Model Context Protocol server for autonomous vulnerability discovery

2707. **[mcp-stata](https://github.com/tmonk/mcp-stata)** - ⭐ 40
...
2708. **[npm-packages](https://github.com/WebMCP-org/npm-packages)** - ⭐ 40
   NPM packages for MCP-B: Transport layers, React hooks, and browser tools for the Model Context Protocol

2709. **[notebooklm-mcp](https://github.com/roomi-fields/notebooklm-mcp)** - ⭐ 40
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

2710. **[fal-mcp-server](https://github.com/raveenb/fal-mcp-server)** - ⭐ 40
   MCP server for Fal.ai - Generate images, videos, music and audio with Claude

2711. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 39
   MCP server for anki

2712. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 39
   A simple NextJS MCP client with sensible keybindings

2713. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 39
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

2714. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

2715. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 39
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

2716. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

2717. **[mssql-mcp](https://github.com/daobataotie/mssql-mcp)** - ⭐ 39
   mssql mcp server

2718. **[vscode-agent-todos](https://github.com/digitarald/vscode-agent-todos)** - ⭐ 39
   Gives VS Code agent mode planning superpowers with dynamic todo lists

2719. **[pbixray-mcp-server](https://github.com/jonaolden/pbixray-mcp-server)** - ⭐ 39
...
2720. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 39
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

2721. **[search-scrape](https://github.com/DevsHero/search-scrape)** - ⭐ 39
...
2722. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 39
...
2723. **[steampipe-mcp](https://github.com/turbot/steampipe-mcp)** - ⭐ 39
   Enable AI assistants to explore and query your Steampipe data!

2724. **[storybook-mcp](https://github.com/mcpland/storybook-mcp)** - ⭐ 39
   A MCP server for Storybook.

2725. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 39
...
2726. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 39
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

2727. **[mcp-tasks](https://github.com/flesler/mcp-tasks)** - ⭐ 39
   A comprehensive and efficient MCP server for task management with multi-format support (Markdown, JSON, YAML)

2728. **[music-composer-webmcp](https://github.com/Leanmcp-Community/music-composer-webmcp)** - ⭐ 39
...
2729. **[best-of-mcp-servers](https://github.com/tolkonepiu/best-of-mcp-servers)** - ⭐ 39
   🏆  A ranked list of MCP servers. Updated weekly.

2730. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 39
   http4k MCP Desktop Client

2731. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 39
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

2732. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 39
...
2733. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 39
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

2734. **[keycloak-mcp-server](https://github.com/sshaaf/keycloak-mcp-server)** - ⭐ 39
...
2735. **[arifosmcp](https://github.com/ariffazil/arifosmcp)** - ⭐ 39
   ArifOS — AAA MCP-governed constitutional kernel for AI agents.

2736. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 39
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

2737. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 39
   An MCP server for querying Solana transactions using natural language with Solscan API

2738. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

2739. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 39
...
2740. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 39
...
2741. **[kirby-mcp](https://github.com/bnomei/kirby-mcp)** - ⭐ 39
...
2742. **[Generative-UI-MCP](https://github.com/op7418/Generative-UI-MCP)** - ⭐ 39
   MCP server that teaches AI models to generate interactive visualizations — charts, diagrams, mockups, and more.

2743. **[ctxvault](https://github.com/Filippo-Venturini/ctxvault)** - ⭐ 39
   Local memory infrastructure for AI agents. Isolated vaults you compose, control, monitor and query — no cloud, no setup.

2744. **[mcp_ctl](https://github.com/runablehq/mcp_ctl)** - ⭐ 38
   A package manager to manage all your mcp servers across platforms

2745. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 38
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

2746. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

2747. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 38
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

2748. **[prompt-decorators](https://github.com/synaptiai/prompt-decorators)** - ⭐ 38
...
2749. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 38
   A Chat Client for LLMs, written in Compose Multiplatform.

2750. **[vancouver](https://github.com/jameslong/vancouver)** - ⭐ 38
   Simple MCP server library for Elixir.

2751. **[cdk_pywrapper](https://github.com/sebotic/cdk_pywrapper)** - ⭐ 38
   A Python wrapper for the Chemistry Development Kit (CDK)

2752. **[mocxykit](https://github.com/shunseven/mocxykit)** - ⭐ 38
...
2753. **[comfy-mcp-server](https://github.com/lalanikarim/comfy-mcp-server)** - ⭐ 38
   A server using FastMCP framework to generate images based on prompts via a remote Comfy server.

2754. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 38
   Model Context Protocol Minecraft Server

2755. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 38
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

2756. **[kitwork](https://github.com/kitwork/kitwork)** - ⭐ 38
...
2757. **[nostr-mcp](https://github.com/AbdelStark/nostr-mcp)** - ⭐ 38
   A Nostr MCP server that allows to interact with Nostr, enabling posting notes, and more.

2758. **[octomind](https://github.com/Muvon/octomind)** - ⭐ 38
   Highly configurable autonomous efficient-first agentic AI framework for CLI

2759. **[reactbits-mcp-server](https://github.com/ceorkm/reactbits-mcp-server)** - ⭐ 38
   MCP server providing access to 135+ animated React components from ReactBits.dev (9.2/10 test score)

2760. **[mcp-gitlab-server](https://github.com/yoda-digital/mcp-gitlab-server)** - ⭐ 38
   Enhanced MCP server for GitLab: group projects listing and activity tracking

2761. **[context-awesome](https://github.com/bh-rat/context-awesome)** - ⭐ 38
   awesome-lists now available as MCP server for you agent.

2762. **[Web-Algebra](https://github.com/AtomGraph/Web-Algebra)** - ⭐ 38
   Suite of generic Linked Data/SPARQL as well as LinkedDataHub-specific MCP tools

2763. **[MCP-Microsoft-Office](https://github.com/Aanerud/MCP-Microsoft-Office)** - ⭐ 38
   an local MCP server you can run on your env, connecting you to Microsoft Graph, and the complete M365 eco system.

2764. **[mcp-appstore](https://github.com/appreply-co/mcp-appstore)** - ⭐ 38
...
2765. **[nestjs-starter](https://github.com/hmake98/nestjs-starter)** - ⭐ 38
...
2766. **[shadcn-svelte-mcp](https://github.com/Michael-Obele/shadcn-svelte-mcp)** - ⭐ 38
   Mastra MCP server and tooling for the shadcn-svelte component docs and developer utilities.

2767. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 38
   Claude Unified Model Context Interaction Protocol

2768. **[mcp-server](https://github.com/Aayush9029/mcp-server)** - ⭐ 38
   MCP SERVER

2769. **[FastAPI-BitNet](https://github.com/grctest/FastAPI-BitNet)** - ⭐ 38
   Running Microsoft's BitNet inference framework via FastAPI, Uvicorn and Docker.

2770. **[yahoo-finance-server](https://github.com/AgentX-ai/yahoo-finance-server)** - ⭐ 38
...
2771. **[roampal-core](https://github.com/roampal-ai/roampal-core)** - ⭐ 38
...
2772. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 38
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

2773. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 38
   Model Context Protocol server to let LLMs write and execute matlab scripts 

2774. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 38
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

2775. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 38
...
2776. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 38
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

2777. **[omnifocus-mcp-enhanced](https://github.com/jqlts1/omnifocus-mcp-enhanced)** - ⭐ 38
...
2778. **[peta-core](https://github.com/dunialabs/peta-core)** - ⭐ 38
   Peta core: The Control Plane for MCP — secure vault, managed runtime, audit trail, and policy-based approvals.

2779. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 38
...
2780. **[foundry-vtt-mcp](https://github.com/adambdooley/foundry-vtt-mcp)** - ⭐ 38
...
2781. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 38
   SAP HANA MCP server — Model Context Protocol server for SAP HANA. Use with Claude Code, VS Code. npm: hana-mcp-server

2782. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 38
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

2783. **[trivy-mcp](https://github.com/aquasecurity/trivy-mcp)** - ⭐ 37
   Trivy plugin for starting an MCP server

2784. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 37
...
2785. **[mcp-summarization-functions](https://github.com/Braffolk/mcp-summarization-functions)** - ⭐ 37
   Provides summarised output from various actions that could otherwise eat up tokens and cause crashes for AI agents 

2786. **[mcp-server-webcrawl](https://github.com/pragmar/mcp-server-webcrawl)** - ⭐ 37
   MCP server tailored to connecting web crawler data and archives

2787. **[gemini-superclaude-mcp-server](https://github.com/Dianel555/gemini-superclaude-mcp-server)** - ⭐ 37
...
2788. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 37
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

2789. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 37
   Learn how to implement MCP client with SwiftUI and Anthropic API

2790. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 37
   Build tools for LLMs in Rust using Model Context Protocol

2791. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2792. **[dexpaprika-mcp](https://github.com/coinpaprika/dexpaprika-mcp)** - ⭐ 37
...
2793. **[GDB-MCP](https://github.com/smadi0x86/GDB-MCP)** - ⭐ 37
   An MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

2794. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 37
   Model Context Protocol (MCP) Server for Mistral OCR API

2795. **[agentic-commerce-protocol-demo](https://github.com/locus-technologies/agentic-commerce-protocol-demo)** - ⭐ 37
   Reference implementation of OpenAI's Agentic Commerce Protocol (ACP)

2796. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 37
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

2797. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 37
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

2798. **[mcp-zero](https://github.com/zeromicro/mcp-zero)** - ⭐ 37
   Model Context Protocol (MCP) server for go-zero framework - Generate APIs, RPC services, and models with AI assistance.

2799. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 37
...
2800. **[google-workspace-mcp](https://github.com/dguido/google-workspace-mcp)** - ⭐ 37
   MCP server for Google Drive, Docs, Sheets, Slides, Calendar, Gmail, and Contacts

2801. **[tasker-mcp](https://github.com/dceluis/tasker-mcp)** - ⭐ 37
   An MCP server for Android's Tasker automation app.

2802. **[MCPNotes](https://github.com/9Ninety/MCPNotes)** - ⭐ 37
   A simple note-taking MCP server for recording and managing notes with AI models.

2803. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 37
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

2804. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 37
...
2805. **[godot-mcp](https://github.com/HaD0Yun/godot-mcp)** - ⭐ 37
   GoPeak — The most comprehensive MCP server for Godot Engine. 95+ tools: scene management, GDScript LSP, DAP debugger, screenshot capture, input injection, ClassDB introspection, CC0 asset library. npx gopeak

2806. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 37
...
2807. **[RoslynMCP](https://github.com/carquiza/RoslynMCP)** - ⭐ 37
   A Model Context Protocol (MCP) server that provides C# code analysis capabilities using Microsoft Roslyn

2808. **[pyrestoolbox-mcp](https://github.com/gabrielserrao/pyrestoolbox-mcp)** - ⭐ 37
...
2809. **[MiniMax-Coding-Plan-MCP](https://github.com/MiniMax-AI/MiniMax-Coding-Plan-MCP)** - ⭐ 37
...
2810. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 37
   Learn Model Context Protocol with Python, published by Packt

2811. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 37
...
2812. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 37
   Sync MCP (Model Context Protocol) configurations across AI tools

2813. **[Ori-Mnemos](https://github.com/aayoawoyemi/Ori-Mnemos)** - ⭐ 37
...
2814. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 36
   Build Model Context Protocol (MCP) servers in Go

2815. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

2816. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
2817. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 36
   Demonstrate how to implement MCP Client in Flutter application with AI.

2818. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 36
   A Model Context Protocol for checking domain name registration status in bulk.

2819. **[mcp-debug](https://github.com/giantswarm/mcp-debug)** - ⭐ 36

2820. **[mcp-server-antv](https://github.com/antvis/mcp-server-antv)** - ⭐ 36
...
2821. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 36
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

2822. **[mcp-crew-ai](https://github.com/adam-paterson/mcp-crew-ai)** - ⭐ 36
   MCP Crew AI Server is a lightweight Python-based server designed to run, manage and create CrewAI workflows.

2823. **[Handler](https://github.com/alDuncanson/Handler)** - ⭐ 36
   A2A Protocol client and developer toolkit.

2824. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 36
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

2825. **[ai-workshop](https://github.com/dotnet-presentations/ai-workshop)** - ⭐ 36
   Building GenAI Apps in C#: AI Templates, GitHub Models, Azure OpenAI & More

2826. **[mcp-sandbox](https://github.com/JohanLi233/mcp-sandbox)** - ⭐ 36
   Python sandboxes for llms

2827. **[awesome-mcp-personas](https://github.com/toolprint/awesome-mcp-personas)** - ⭐ 36
   A curated collection of persona-based mcp server & tool groupings.

2828. **[mcp-server](https://github.com/VapiAI/mcp-server)** - ⭐ 36
   Vapi MCP Server

2829. **[workflowy](https://github.com/mholzen/workflowy)** - ⭐ 36
   Powerful CLI and MCP server for WorkFlowy: reports, search/replace, backup support, and AI integration (Claude, LLMs)

2830. **[pfsense-mcp-server](https://github.com/gensecaihq/pfsense-mcp-server)** - ⭐ 36
   pfSense MCP Server enables security administrators to manage their pfSense firewalls using natural language through AI assistants like Claude Desktop. Simply ask "Show me blocked IPs" or "Run a PCI compliance check" instead of navigating complex interfaces. Supports REST/XML-RPC/SSH connections, and includes built-in complian

2831. **[apple-mail-mcp](https://github.com/patrickfreyer/apple-mail-mcp)** - ⭐ 36
   MCP server giving AI assistants full access to Apple Mail - read, search, compose, organize & analyze emails via natural language

2832. **[copilot-security-instructions](https://github.com/Robotti-io/copilot-security-instructions)** - ⭐ 36
...
2833. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 36
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

2834. **[arifOS](https://github.com/ariffazil/arifOS)** - ⭐ 36
   ArifOS — AAA MCP-governed constitutional kernel for AI agents.

2835. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 36
...
2836. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 36
   Emacs Lisp implementation of the Model Context Protocol

2837. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 36
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

2838. **[mitre-attack-mcp](https://github.com/stoyky/mitre-attack-mcp)** - ⭐ 36
   A Model-Context Protocol server for the MITRE ATT&CK knowledge base

2839. **[matrix-mcp-server](https://github.com/mjknowles/matrix-mcp-server)** - ⭐ 36
   MCP Server for a Matrix home server integration; chat, manage rooms, etc.

2840. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 36
   Model Context Protocol (MCP) server that interacts with a Debugger

2841. **[mie](https://github.com/kraklabs/mie)** - ⭐ 36
...
2842. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 36
   ElysiaJS plugin for Model Context Protocol with HTTP transport

2843. **[gtm-mcp-server](https://github.com/paolobietolini/gtm-mcp-server)** - ⭐ 36
   An MCP server for Google Tag Manager. Connect it to your LLM, authenticate once, and start managing GTM through natural language.

2844. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 36
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

2845. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 36
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

2846. **[email-mcp](https://github.com/TimeCyber/email-mcp)** - ⭐ 36
   一个让AI轻松接管邮箱的MCP服务，基于 Model Context Protocol (MCP) 构建，支持在 MCP-X,Claude Desktop 等 MCP 客户端中使用。

2847. **[native-devtools-mcp](https://github.com/sh3ll3x3c/native-devtools-mcp)** - ⭐ 36
...
2848. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 36
...
2849. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 35
   OpenAI Code Assistant Model Context Protocol (MCP) Server

2850. **[camofox-mcp](https://github.com/redf0x1/camofox-mcp)** - ⭐ 35
   Anti-detection browser MCP server for AI agents — navigate, interact, and automate the web without getting blocked

2851. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 35
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

2852. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 35
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

2853. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

2854. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

2855. **[mcp-tung-shing](https://github.com/baranwang/mcp-tung-shing)** - ⭐ 35
   中国传统黄历 MCP 服务 | Chinese Traditional Almanac MCP Service

2856. **[mcp](https://github.com/screenshotone/mcp)** - ⭐ 35
   A simple implementation of an MCP server for the ScreenshotOne API

2857. **[atlas-docs-mcp](https://github.com/CartographAI/atlas-docs-mcp)** - ⭐ 35
   Provide LLMs hosted, clean markdown documentation of libraries and frameworks

2858. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 35
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

2859. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 35
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

2860. **[mcp-server-text-editor](https://github.com/bhouston/mcp-server-text-editor)** - ⭐ 35
   An open source implementation of the Claude built-in text editor tool

2861. **[mcp-starter](https://github.com/instructa/mcp-starter)** - ⭐ 35
   A super simple Starter to build your own MCP Server

2862. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 35
   a lib to build MCP clients and MCP servers in Clojure(script)

2863. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 35
   A Model Context Protocol (MCP) server for NATS messaging system integration

2864. **[daisyui-mcp](https://github.com/birdseyevue/daisyui-mcp)** - ⭐ 35
   🌼 A token-friendly local MCP server for DaisyUI component documentation using their public llms.txt.

2865. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 35
   Turn any MCP Client into a "multi-agent" system (via prompting)

2866. **[awesome-mcp-servers](https://github.com/ever-works/awesome-mcp-servers)** - ⭐ 35
   A curated list of the best MCP Servers, featuring top solutions, libraries, tools, and more. - https://mcpserver.works

2867. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 35
   List of Awesome MCP Servers and Clients for building Agentic Devops 

2868. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 35
...
2869. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 35
...
2870. **[tinyagent](https://github.com/askbudi/tinyagent)** - ⭐ 35
   Tiny Agent: Production-Ready LLM Agent SDK for Every Developer

2871. **[vulnerablemcp](https://github.com/vineethsai/vulnerablemcp)** - ⭐ 35
   A comprehensive database of Model Context Protocol vulnerabilities, security research, and exploits

2872. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 35
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

2873. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 35
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

2874. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 35
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

2875. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 35
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2876. **[Meting-Agent](https://github.com/ELDment/Meting-Agent)** - ⭐ 35
   🪐 面向 AI 的多音乐平台的 API 代理 • 网易云 • QQ音乐 • 酷狗 • 酷我 • 千千 🎻 Multi-platform music API agent for AI • NetEase • QQ Music • KuGou • Kuwo • Qianqian

2877. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 34
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

2878. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 34
...
2879. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
2880. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 34
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

2881. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 34
   Model Context Protocol Server for Apache OpenDAL™

2882. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 34
...
2883. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 34
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

2884. **[godoc-mcp-server](https://github.com/yikakia/godoc-mcp-server)** - ⭐ 34
   A mcp server provide infomation from pkg.go.dev. For all golang programmers

2885. **[DBJavaGenix](https://github.com/ZhaoXingPeng/DBJavaGenix)** - ⭐ 34
...
2886. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 34
...
2887. **[chessagineweb](https://github.com/jalpp/chessagineweb)** - ⭐ 34
   The most underrated FOSS chess interface that combines AI agents and chess engines into one unified platform. 

2888. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 34
...
2889. **[codelogic-mcp-server](https://github.com/CodeLogicIncEngineering/codelogic-mcp-server)** - ⭐ 34
   An MCP Server to utilize Codelogic's rich software dependency data in your AI programming assistant.

2890. **[any-script-mcp](https://github.com/izumin5210/any-script-mcp)** - ⭐ 34
   An MCP server that exposes arbitrary CLI tools and shell scripts as MCP Tools

2891. **[claude-code-mcp](https://github.com/KunihiroS/claude-code-mcp)** - ⭐ 34
   MCP Server connects with claude code local command.

2892. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 34
   Model Context Protocol server written in Scala

2893. **[iotdb-mcp-server](https://github.com/apache/iotdb-mcp-server)** - ⭐ 34
   Apache IoTDB MCP Server

2894. **[1mcp](https://github.com/buremba/1mcp)** - ⭐ 34
   Let your agent write code and execute code directly in the browser with WASM

2895. **[kanban-mcp](https://github.com/eyalzh/kanban-mcp)** - ⭐ 34
   MCP server providing kanban-based task management memory for complex multi-session workflows with AI agents

2896. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 34
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

2897. **[diy-tools-mcp](https://github.com/hesreallyhim/diy-tools-mcp)** - ⭐ 34
   An MCP server that allows users to dynamically add custom tools/functions at runtime

2898. **[pushover-mcp](https://github.com/AshikNesin/pushover-mcp)** - ⭐ 34
   A MCP implementation for sending notifications via Pushover

2899. **[capacities-mcp](https://github.com/jem-computer/capacities-mcp)** - ⭐ 34
   Capacities×MCP

2900. **[mcp-searxng-enhanced](https://github.com/OvertliDS/mcp-searxng-enhanced)** - ⭐ 34
   Enhanced MCP server for SearXNG: category-aware web-search, web-scraping, and date/time retrieval.

2901. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 34
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

2902. **[mcp-probe-kit](https://github.com/mybolide/mcp-probe-kit)** - ⭐ 34
   一个强大的 MCP (Model Context Protocol) 服务器，提20个实用工具，覆盖代码质量、开发效率、项目管理、生成skills文档全流程。

2903. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 34
...
2904. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 34
...
2905. **[fantasy-football-mcp-public](https://github.com/derekrbreese/fantasy-football-mcp-public)** - ⭐ 34
...
2906. **[mcp](https://github.com/fastly/mcp)** - ⭐ 34
   Model Context Protocol (MCP) server for AI-powered Fastly CDN management.

2907. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 34
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

2908. **[codebase-context](https://github.com/PatrickSys/codebase-context)** - ⭐ 34
...
2909. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 34
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

2910. **[mcp](https://github.com/supadata-ai/mcp)** - ⭐ 34
   Official Supadata MCP Server - Adds powerful video & web scraping to Cursor, Claude and any other LLM clients.

2911. **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** - ⭐ 34
...
2912. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 34
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

2913. **[golemcore-bot](https://github.com/alexk-dev/golemcore-bot)** - ⭐ 34
...
2914. **[lets-learn-mcp-java](https://github.com/microsoft/lets-learn-mcp-java)** - ⭐ 34
   Learn how to build Java-based MCP Servers and Clients with LangChain4J and Quarkus

2915. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 33
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

2916. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 33
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

2917. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 33
...
2918. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 33
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

2919. **[DMCPServer](https://github.com/Daniel09Fernandes/DMCPServer)** - ⭐ 33
   Dinos MCP Server, make your code, on MCP Action and execute by AI

2920. **[mcp-veo2](https://github.com/mario-andreschak/mcp-veo2)** - ⭐ 33
   MCP for Video- or Image-Generation with Google VEO2

2921. **[kaggle-mcp](https://github.com/arrismo/kaggle-mcp)** - ⭐ 33
   MCP server for Kaggle

2922. **[mcp-launcher](https://github.com/moeru-ai/mcp-launcher)** - ⭐ 33
   🐳🧩 Easy to use MCP builder & launcher for all possible MCP servers, just like Ollama for models!

2923. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 33
...
2924. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 33
   About A Model Context Protocol server that executes commands in the current WezTerm session

2925. **[mcp-server](https://github.com/membranehq/mcp-server)** - ⭐ 33
   MCP Server for Membrane

2926. **[devduck](https://github.com/cagataycali/devduck)** - ⭐ 33
   Minimalist AI agent that fixes itself when things break.

2927. **[fastmcp-threatintel](https://github.com/4R9UN/fastmcp-threatintel)** - ⭐ 33
   AI-Powered Threat Intelligence MCP tool

2928. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 33
...
2929. **[bitrise-mcp](https://github.com/bitrise-io/bitrise-mcp)** - ⭐ 33
   MCP Server for the Bitrise API, enabling app management, build operations, artifact management and more.

2930. **[prediction-market-mcp](https://github.com/JamesANZ/prediction-market-mcp)** - ⭐ 33
   A simple MCP server that grabs prediction market data from polymarket, PredictIt, & Kalshi. 

2931. **[mcp-tools](https://github.com/clerk/mcp-tools)** - ⭐ 33
   Tools for building modern & secure MCP integrations across the client and server side

2932. **[metals-standalone-client](https://github.com/jpablo/metals-standalone-client)** - ⭐ 33
   Minimal Metals stand alone client that allows running the metals mcp server

2933. **[mcp-server-fuzzer](https://github.com/Agent-Hellboy/mcp-server-fuzzer)** - ⭐ 33
   A generic mcp server fuzzer

2934. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 33
...
2935. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 33
   Model Context Protocol (MCP) server for openBIM

2936. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 33
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2937. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 33
...
2938. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 33
...
2939. **[MCPServer](https://github.com/rhennigan/MCPServer)** - ⭐ 33
   Implements a model context protocol server using Wolfram Language

2940. **[arch-mcp](https://github.com/nihalxkumar/arch-mcp)** - ⭐ 33
   Arch Linux MCP (Model Context Protocol)

2941. **[minimax_search](https://github.com/MiniMax-AI/minimax_search)** - ⭐ 33
   MiniMax Search is an MCP (Model Context Protocol) server that provides web search and browsing capabilities.

2942. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 33
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

2943. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 33
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

2944. **[touchdesigner-mcp-server](https://github.com/bottobot/touchdesigner-mcp-server)** - ⭐ 33
...
2945. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 32
...
2946. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 32
...
2947. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 32
   Model Context Protocol extension for Azure Functions.

2948. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

2949. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 32
...
2950. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 32
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

2951. **[Direwolf](https://github.com/Framebuffers/Direwolf)** - ⭐ 32
   Distributed Data Processing Pipeline for MCP.

2952. **[imagegen-mcp](https://github.com/spartanz51/imagegen-mcp)** - ⭐ 32
   MCP server for OpenAI Image Generation & Editing — text-to-image, image-to-image (with mask), no extra plugins.

2953. **[ptt_mcp_server](https://github.com/PyPtt/ptt_mcp_server)** - ⭐ 32
   The best PTT MCP server

2954. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 32
...
2955. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 32
...
2956. **[mcp-server](https://github.com/HuaweiCloudDeveloper/mcp-server)** - ⭐ 32
   Provide different cloud products  MCP Server tools to  help developers  manage cloud resources  with AI-agent

2957. **[univer-mcp](https://github.com/dream-num/univer-mcp)** - ⭐ 32
   AI-powered spreadsheet automation through Model Context Protocol (MCP) server for Univer

2958. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 32
   A Model Context Protocol server starter template

2959. **[mcp-java-sdk-examples](https://github.com/thought2code/mcp-java-sdk-examples)** - ⭐ 32
   A collection of MCP server examples developed by various Java SDKs

2960. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 32
...
2961. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 32
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

2962. **[paraview_mcp](https://github.com/llnl/paraview_mcp)** - ⭐ 32
...
2963. **[Amazing-Marvin-MCP](https://github.com/bgheneti/Amazing-Marvin-MCP)** - ⭐ 32
   Model Context Provider for Amazing Marvin productivity app - Access your tasks, projects, and categories in AI assistants

2964. **[protonmail-mcp](https://github.com/amotivv/protonmail-mcp)** - ⭐ 32
   This MCP server provides email sending functionality using Protonmail's SMTP service. It allows both Claude Desktop and Cline VSCode extension to send emails on your behalf using your Protonmail credentials.

2965. **[chabeau](https://github.com/permacommons/chabeau)** - ⭐ 32
   OpenAI-API compatible terminal chatbot and MCP client in Rust

2966. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 32
   Asterisk Model Context Protocol (MCP) server.

2967. **[myBrAIn](https://github.com/lilium360/myBrAIn)** - ⭐ 32
...
2968. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 32
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

2969. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 32
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

2970. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 32
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

2971. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 32
...
2972. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 32
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

2973. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 32
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

2974. **[ddg_search](https://github.com/OEvortex/ddg_search)** - ⭐ 32
   A powerful Model Context Protocol (MCP) server for web search and URL content extraction using DuckDuckGo.

2975. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 32
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

2976. **[AskUserQuestionPlus](https://github.com/JoJoJotarou/AskUserQuestionPlus)** - ⭐ 32
...
2977. **[help-scout-mcp-server](https://github.com/drewburchfield/help-scout-mcp-server)** - ⭐ 32
   MCP server for Help Scout - search conversations, threads, and inboxes with AI agents

2978. **[File-Organizer-MCP](https://github.com/kridaydave/File-Organizer-MCP)** - ⭐ 32
   This MCP server will organize your files using connections to MCP using clients like Claude, Cursor and Gemini Cli

2979. **[mcp-ollama](https://github.com/emgeee/mcp-ollama)** - ⭐ 32
   Query model running with Ollama from within Claude Desktop or other MCP clients

2980. **[estonia-ai-kit](https://github.com/stefanoamorelli/estonia-ai-kit)** - ⭐ 32
...
2981. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 32
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

2982. **[context-harness](https://github.com/parallax-labs/context-harness)** - ⭐ 32
   Local-first context ingestion and retrieval for AI tools. SQLite + embeddings + MCP server for Cursor & Claude.

2983. **[review-flow](https://github.com/DGouron/review-flow)** - ⭐ 32
...
2984. **[cheat-engine-server-python](https://github.com/bethington/cheat-engine-server-python)** - ⭐ 32
...
2985. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 32
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

2986. **[Embody](https://github.com/dylanroscover/Embody)** - ⭐ 32
   Have a conversation with TouchDesigner

2987. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 31
...
2988. **[browser-use-rs](https://github.com/BB-fat/browser-use-rs)** - ⭐ 31
...
2989. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

2990. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 31
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

2991. **[jlcpcb-parts-mcp](https://github.com/nvsofts/jlcpcb-parts-mcp)** - ⭐ 31
   JLCPCB PCBA向けの、部品探しを補助するためのMCPサーバー

2992. **[unplugin-mcp](https://github.com/situ2001/unplugin-mcp)** - ⭐ 31
...
2998. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 31
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

2999. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 31
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

3000. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 31
...
3001. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 31
...
3002. **[mcp-server-weibo](https://github.com/Selenium39/mcp-server-weibo)** - ⭐ 31
   Model Context Protocol服务器，用于抓取微博用户信息、动态和搜索功能

3003. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 31
   Model Context Protocol Server of Rod

3004. **[cca-mcp-configurator](https://github.com/doggy8088/cca-mcp-configurator)** - ⭐ 31
   一個簡單易用的網頁工具，用於管理 GitHub Copilot 的 MCP (Model Context Protocol) 設定

3005. **[mssqlclient-mcp-server](https://github.com/aadversteeg/mssqlclient-mcp-server)** - ⭐ 31
...
3006. **[codesys-mcp-toolkit](https://github.com/johannesPettersson80/codesys-mcp-toolkit)** - ⭐ 31
   Model Context Protocol server for CODESYS automation platform

3007. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 31
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

3008. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 31
   model context protocol for Autodesk Revit

3009. **[jdwp-mcp](https://github.com/navicore/jdwp-mcp)** - ⭐ 31
   Java debugging for LLMs via JDWP and Model Context Protocol

3010. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 31
   Zillow MCP Server for real estate data access via the Model Context Protocol

3011. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 31
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

3012. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 31
...
3013. **[amazon_ads_mcp](https://github.com/KuudoAI/amazon_ads_mcp)** - ⭐ 31
   Amazon Ads MCP - Model Context Protocol server for Amazon Advertising API

3014. **[fast-mcp-telegram](https://github.com/leshchenko1979/fast-mcp-telegram)** - ⭐ 31
   Telegram MCP Server and HTTP-MTProto bridge | Multi-user auth, intelligent search, file sending, web setup | Docker & PyPI ready

3015. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 31
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

3016. **[MCPbundler](https://github.com/eugenepyvovarov/MCPbundler)** - ⭐ 31

3017. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

3018. **[mini-coder](https://github.com/sacenox/mini-coder)** - ⭐ 31
   A good idea 👾

3019. **[turbomcpstudio](https://github.com/Epistates/turbomcpstudio)** - ⭐ 31
   A native desktop application for developing, testing, and debugging Model Context Protocol servers.

3020. **[xero-agent-toolkit](https://github.com/XeroAPI/xero-agent-toolkit)** - ⭐ 31
...
3030. **[airflow-mcp-server](https://github.com/abhishekbhakat/airflow-mcp-server)** - ⭐ 30
   MCP Server for Apache Airflow

3031. **[kafka-schema-reg-mcp](https://github.com/aywengo/kafka-schema-reg-mcp)** - ⭐ 30
   A comprehensive Message Control Protocol (MCP) server for Kafka Schema Registry.

3032. **[itential-mcp](https://github.com/itential/itential-mcp)** - ⭐ 30
   🔌 Itential Platform MCP Server

3033. **[ros-mcp](https://github.com/Yutarop/ros-mcp)** - ⭐ 30
   MCP server for ROS to control robots via topics, services, and actions.

3034. **[chrome-extension-bridge-mcp](https://github.com/Oanakiaja/chrome-extension-bridge-mcp)** - ⭐ 30
   A chrome extension bridge that allows you to connect to a mcp server to use global window object.

3035. **[turbovault](https://github.com/Epistates/turbovault)** - ⭐ 30
   MCP server that transforms your Obsidian vault into an intelligent knowledge system

3036. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 30
   MCP (Model Context Protocol) Server for postgres Database

3037. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 30
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

3038. **[levante](https://github.com/levante-hub/levante)** - ⭐ 30
   Levante - Personal, Secure, Free, Local AI, MCP Client

3039. **[pubnub-mcp-server](https://github.com/pubnub/pubnub-mcp-server)** - ⭐ 30
   PubNub MCP Model Context Protocol Server for use in Cursor, Windsurf, Claude Desktop, Claude Code and OpenAI Codex and more!

3040. **[bear-notes-mcp](https://github.com/bejaminjones/bear-notes-mcp)** - ⭐ 30
   MCP server for Bear app - Full Read + Write AI-powered note management with Claude Desktop

3041. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 30
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

3042. **[mcp-klever-vm](https://github.com/klever-io/mcp-klever-vm)** - ⭐ 30
   MCP server for Klever blockchain smart contract development

3043. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 30
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

3044. **[rss-mcp](https://github.com/veithly/rss-mcp)** - ⭐ 30
...
3045. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 30
   PowerPlatform Model Context Protocol server

3046. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 30
   MCP (Model Context Protocol) server for biothings

3047. **[opnsense-mcp-server](https://github.com/Pixelworlds/opnsense-mcp-server)** - ⭐ 30
   Modular MCP server for OPNsense firewall management - 88 tools providing access to 2000+ methods through AI assistants

3048. **[Wwise-MCP](https://github.com/BilkentAudio/Wwise-MCP)** - ⭐ 30
...
3049. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 30
...
3050. **[ckan-mcp-server](https://github.com/ondata/ckan-mcp-server)** - ⭐ 30
   MCP server for querying CKAN open data portals (package search, DataStore SQL, organizations, groups, tags)

3051. **[kimi-code-mcp](https://github.com/howardpen9/kimi-code-mcp)** - ⭐ 30
...
3052. **[ogham-mcp](https://github.com/ogham-mcp/ogham-mcp)** - ⭐ 30
   Shared memory MCP server — persistent, searchable, cross-client

3053. **[postmancer](https://github.com/hijaz/postmancer)** - ⭐ 29
   An experimental MCP server Rest Client intended to be a replacement of tools postman & insomnia

3054. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

3055. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

3056. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 29
   A library for declaratively building Model Context Protocol servers.

3057. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

3058. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

3059. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 29
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

3060. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 29
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

3061. **[dockashell](https://github.com/anzax/dockashell)** - ⭐ 29
...
3062. **[telegram-mcp-server](https://github.com/kfastov/telegram-mcp-server)** - ⭐ 29
   MCP server implementation for Telegram

3063. **[agent-pm](https://github.com/gannonh/agent-pm)** - ⭐ 29
   MCP server for the planning and execution of AI-assisted development projects.

3064. **[mcp-notify](https://github.com/aahl/mcp-notify)** - ⭐ 29
   💬  MCP Server for notify to Weixin, Telegram, Bark, Lark, 飞书, 钉钉

3065. **[rdkit-mcp-server](https://github.com/tandemai-inc/rdkit-mcp-server)** - ⭐ 29
   MCP server that enables language models to interact with RDKit through natural language

3066. **[robinhood-mcp-server](https://github.com/rohitsingh-iitd/robinhood-mcp-server)** - ⭐ 29
...
3067. **[alibabacloud-dms-mcp-server](https://github.com/aliyun/alibabacloud-dms-mcp-server)** - ⭐ 29
...
3068. **[tgcli](https://github.com/kfastov/tgcli)** - ⭐ 29
   Telegram user console client and archiver

3069. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 29
...
3070. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 29
...
3071. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 29
...
3072. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 29
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

3073. **[deno-mcp-template](https://github.com/phughesmcr/deno-mcp-template)** - ⭐ 29
   A template repo for writing and publishing local, remote, DXT, and binary MCP servers using Deno.

3074. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 29
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

3075. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 29
...
3076. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 29
...
3077. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 29
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

3078. **[src-to-kb](https://github.com/vezlo/src-to-kb)** - ⭐ 29
   Convert source code to LLM ready knowledge base

3079. **[izan.io](https://github.com/ekingunoncu/izan.io)** - ⭐ 29
   Turn Any Browser Action & Data Extraction into an AI Tool in 60 Seconds

3080. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 29
...
3081. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 29
   Testing framework for Model Context Protocol (MCP)

3082. **[mcpmcp-server](https://github.com/glenngillen/mcpmcp-server)** - ⭐ 29
   Discover, setup, and integrate MCP servers with your favorite clients. Unlock the full potential of AI in your daily workflow.

3083. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 29
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

3084. **[wiki-js-mcp](https://github.com/talosdeus/wiki-js-mcp)** - ⭐ 29
   Model Context Protocol (MCP) server for Wiki.js with hierarchical documentation & Docker setup

3085. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 29
   A simple Model Context Protocol (MCP) server for Clay.

3086. **[mcp_espn_ff](https://github.com/KBThree13/mcp_espn_ff)** - ⭐ 29
   ESPN Fantasy API with LLMs!

3087. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 29
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

3088. **[AI-Tracker](https://github.com/twwch/AI-Tracker)** - ⭐ 29
   本仓库旨在整理关于大语言模型（LLM）底层逻辑、**上下文工程 (Context Engineering)** 以及 **Model Context Protocol (MCP)** 协议的核心学习资源与实战路径。

3089. **[drawio-mcp-extension](https://github.com/lgazo/drawio-mcp-extension)** - ⭐ 29
   Draw.io Model Context Protocol (MCP) Browser Extension

3090. **[cesium-ai-integrations](https://github.com/CesiumGS/cesium-ai-integrations)** - ⭐ 29
...
3091. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 28
...
3092. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 28
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

3093. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

3094. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 28
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

3095. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

3096. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 28
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

3097. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 28
...
3098. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 28
...
3099. **[gemsuite-mcp](https://github.com/PV-Bhat/gemsuite-mcp)** - ⭐ 28
...
3100. **[gaia-x](https://github.com/YFGaia/gaia-x)** - ⭐ 28
...
3101. **[tempo-mcp-server](https://github.com/ivelin-web/tempo-mcp-server)** - ⭐ 28
   MCP server for managing Tempo worklogs in Jira

3102. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 28
...
3103. **[mcp-log-proxy](https://github.com/emicklei/mcp-log-proxy)** - ⭐ 28
   a web logging proxy for MCP client-server communication

3104. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 28
   Model Context Protocol to bridge in Substack writings to Claude.

3105. **[ai-foundry-agents-samples](https://github.com/Azure-Samples/ai-foundry-agents-samples)** - ⭐ 28
   Azure AI Foundry - Agents related sample code

3106. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 28
   Fast rust MCP proxy between stdio and SSE

3107. **[laravel-mcp-companion](https://github.com/brianirish/laravel-mcp-companion)** - ⭐ 28
...
3108. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 28
   An implementation of Giphy integration with Model Context Protocol

3109. **[mindbridge-mcp](https://github.com/pinkpixel-dev/mindbridge-mcp)** - ⭐ 28
...
3110. **[holoviz-mcp](https://github.com/MarcSkovMadsen/holoviz-mcp)** - ⭐ 28
   ✨A MCP server that provides intelligent access to the HoloViz ecosystem for humans and AIs.

3111. **[FerrumMCP](https://github.com/Eth3rnit3/FerrumMCP)** - ⭐ 28
...
3112. **[mcp-config-manager](https://github.com/holstein13/mcp-config-manager)** - ⭐ 28
...
3116. **[Kaimon.jl](https://github.com/kahliburke/Kaimon.jl)** - ⭐ 28
...
3117. **[mcp-loxone](https://github.com/avrabe/mcp-loxone)** - ⭐ 28
   An opinionated Model Context Protocol (MCP) server for controlling Loxone home automation systems.

3118. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 28
...
3119. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 28
...
3120. **[apifox-mcp](https://github.com/iwen-conf/apifox-mcp)** - ⭐ 28
   Apifox MCP 服务器 - 让 Claude 等 AI 助手通过自然语言管理你的 Apifox 项目，轻松创建、更新和审计 API 接口

3121. **[aitour26-WRK542-prototype-agents-with-the-ai-toolkit-and-model-context-protocol](https://github.com/microsoft/aitour26-WRK542-prototype-agents-with-the-ai-toolkit-and-model-context-protocol)** - ⭐ 28

3122. **[kratos-mcp](https://github.com/ceorkm/kratos-mcp)** - ⭐ 28
...
3123. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 28
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

3124. **[autotask-mcp](https://github.com/wyre-technology/autotask-mcp)** - ⭐ 28
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

3125. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

3126. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

3127. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 27
   Universal command-line client for the Model Context Protocol (MCP)

3128. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 27
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

3129. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 27
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

3130. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 27
   Model Context Protocol server for Directus

3131. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 27
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

3132. **[nimbletools-core](https://github.com/NimbleBrainInc/nimbletools-core)** - ⭐ 27
   NimbleTools is an open-source MCP runtime. Infrastructure for the agentic web.

3133. **[mcp-stytch-consumer-todo-list](https://github.com/stytchauth/mcp-stytch-consumer-todo-list)** - ⭐ 27
   Workers + Stytch TODO App MCP Server

3134. **[php-mcp](https://github.com/dtyq/php-mcp)** - ⭐ 27
...
3135. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 27
...
3136. **[pulse-editor](https://github.com/ClayPulse/pulse-editor)** - ⭐ 27
...
3137. **[mcp-local-dev](https://github.com/txbm/mcp-local-dev)** - ⭐ 27
   Let LLMs manage your local dev environments

3138. **[kernel-mcp-server](https://github.com/kernel/kernel-mcp-server)** - ⭐ 27
   Open-source MCP server for secure, low-latency cloud-browser automation on Kernel.

3139. **[chatbot_Shopify](https://github.com/Mobeen-Dev/chatbot_Shopify)** - ⭐ 27
   Agentic Shopify Chatbot with MCP integration, embedded directly into Shopify via a Theme Extension

3140. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 27
   Model Context Protocol Server for NebulaGraph 3.x

3141. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 27
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

3142. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 27
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

3143. **[mcp_xpp](https://github.com/ccampora/mcp_xpp)** - ⭐ 27
...
3144. **[unplugin-devpilot](https://github.com/zcf0508/unplugin-devpilot)** - ⭐ 27
...
3145. **[mcp-simple-timeserver](https://github.com/andybrandt/mcp-simple-timeserver)** - ⭐ 27
...
3146. **[relace-mcp](https://github.com/possible055/relace-mcp)** - ⭐ 27
   Unofficial Relace MCP client with AI features. Personal project; not affiliated with or endorsed by Relace

3147. **[fusion-mcp-server](https://github.com/Joe-Spencer/fusion-mcp-server)** - ⭐ 27
...
3148. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 27
   Antrophics Model context protocol to edit powerpoint files

3149. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 27
...
3150. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

3151. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 27
...
3152. **[MalwareBazaar_MCP](https://github.com/mytechnotalent/MalwareBazaar_MCP)** - ⭐ 27
   An AI-driven MCP server that autonomously interfaces with Malware Bazaar, delivering real-time threat intel and sample metadata for authorized cybersecurity research workflows.

3153. **[lucide-icons-mcp](https://github.com/SeeYangZhi/lucide-icons-mcp)** - ⭐ 27
...
3158. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 27
...
3159. **[mcp-wireshark](https://github.com/khuynh22/mcp-wireshark)** - ⭐ 27
...
3160. **[apipost-mcp](https://github.com/jlcodes99/apipost-mcp)** - ⭐ 27
...
3161. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

3162. **[Unity-AI-ProBuilder](https://github.com/IvanMurzak/Unity-AI-ProBuilder)** - ⭐ 27
...
3163. **[MiAO-MCP-for-Unity](https://github.com/MiAO-AI-Lab/MiAO-MCP-for-Unity)** - ⭐ 27
...
3164. **[langchain-mcp-tools-py](https://github.com/hideya/langchain-mcp-tools-py)** - ⭐ 26
   MCP to LangChain Tools Conversion Utility / Python

3165. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 26
...
3166. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

3167. **[mcp-client-x](https://github.com/RGGH/mcp-client-x)** - ⭐ 26
   Python MCP client + server example

3168. **[mcp-gateway](https://github.com/lucky-aeon/mcp-gateway)** - ⭐ 26
...
3169. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

3170. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 26
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

3171. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 26
...
3172. **[mcp-auth](https://github.com/famma-ai/mcp-auth)** - ⭐ 26
   MCP Auth via Reverse Proxy 

3173. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 26
...
3174. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 26
   A Model Context Protocol (MCP) server for GreptimeDB

3175. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 26
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

3176. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 26
...
3177. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 26
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

3178. **[mcp_streamable_http](https://github.com/theailanguage/mcp_streamable_http)** - ⭐ 26
   Educational repo for MCP streamable HTTP servers and clients

3179. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 26
   A Model Context Protocol server for 3D Slicer integration

3180. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 26
   Model Context Protocol server for Github Repo // Reading Github Repo

3181. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 26
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

3182. **[mcp-annotated-java-sdk](https://github.com/thought2code/mcp-annotated-java-sdk)** - ⭐ 26
   Annotation-driven MCP dev 🚀 No Spring, Zero Boilerplate, Pure Java

3183. **[mcp-desktop-automation](https://github.com/tanob/mcp-desktop-automation)** - ⭐ 26
   A Model Context Protocol server that provides desktop automation capabilities using RobotJS and screenshot capabilities

3184. **[datawrapper-mcp](https://github.com/palewire/datawrapper-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server for creating Datawrapper charts using AI assistants.

3185. **[google-search-console-mcp](https://github.com/surendranb/google-search-console-mcp)** - ⭐ 26
   Google Search Console MCP Server for Claude, Cursor, Windsurf and other MCP Clients

3186. **[markview](https://github.com/paulhkang94/markview)** - ⭐ 26
   Native macOS markdown preview app. Swift/SwiftUI, GitHub Flavored Markdown, syntax highlighting, linting, plugins. No Electron.

3187. **[rlm-claude](https://github.com/EncrEor/rlm-claude)** - ⭐ 26
   Recursive Language Models for Claude Code - Infinite memory solution inspired by MIT CSAIL paper

3188. **[mcp-chain-of-draft-server](https://github.com/bsmi021/mcp-chain-of-draft-server)** - ⭐ 25
   Chain of Draft Server is a powerful AI-driven tool that helps developers make better decisions through systematic, iterative refinement of thoughts and designs. It integrates seamlessly with popular AI agents and provides a structured approach to reasoning, API design, architecture decisions, code reviews, and implementation planning.

3189. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

3190. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

3191. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

3192. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

3193. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

3194. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

3195. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 25
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

3196. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

3197. **[puzzlebox](https://github.com/cliffhall/puzzlebox)** - ⭐ 25
...
3198. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 25
   A Model Context Protocol Server for Interacting with Slack

3199. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 25
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

3200. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 25
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

3201. **[awesome-mcp-lists](https://github.com/collabnix/awesome-mcp-lists)** - ⭐ 25
   A Curated List of MCP Servers, Clients and Toolkits

3202. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 25
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

3203. **[openai-copilot](https://github.com/feiskyer/openai-copilot)** - ⭐ 25
   Your life Copilot powered by LLM models (CLI interface for LLM models with MCP tools).

3204. **[deep-research](https://github.com/ssdeanx/deep-research)** - ⭐ 25
...
3205. **[json2video-mcp-server](https://github.com/omergocmen/json2video-mcp-server)** - ⭐ 25
   Message Communication Protocol server for json2video API integration

3206. **[mcp-playground](https://github.com/zanetworker/mcp-playground)** - ⭐ 25
   Simple MCP Client for remote MCP Servers 🌐

3207. **[d365fo-client](https://github.com/mafzaal/d365fo-client)** - ⭐ 25
...
3208. **[aj-mcp](https://github.com/lightweight-component/aj-mcp)** - ⭐ 25
   Simple MCP SDK in Java

3209. **[skill-mcp](https://github.com/fkesheh/skill-mcp)** - ⭐ 25
...
3210. **[codingbuddy](https://github.com/JeremyDev87/codingbuddy)** - ⭐ 25
...
3211. **[server-sharepoint](https://github.com/Zerg00s/server-sharepoint)** - ⭐ 25
...
3212. **[raybridge](https://github.com/jlokos/raybridge)** - ⭐ 25
   MCP server that bridges Raycast extensions to any MCP-compatible client

3213. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 25
   A Fastify plugin to run Model Context Protocol (MCP) servers

3214. **[silverbullet-mcp](https://github.com/Ahmad-A0/silverbullet-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server to interact with your SilverBullet notes and data.

3215. **[Excel-MCP-Server-Master](https://github.com/guillehr2/Excel-MCP-Server-Master)** - ⭐ 25
...
3216. **[agent-twitter-client-mcp](https://github.com/ryanmac/agent-twitter-client-mcp)** - ⭐ 25
...
3217. **[MCPHammer](https://github.com/praetorian-inc/MCPHammer)** - ⭐ 25
   MCP security testing framework for evaluating Model Context Protocol server vulnerabilities

3218. **[cfbd-mcp-server](https://github.com/lenwood/cfbd-mcp-server)** - ⭐ 25
   An MCP server enabling CFBD API queries within Claude Desktop.

3219. **[microsoft_fabric_mcp](https://github.com/Augustab/microsoft_fabric_mcp)** - ⭐ 25
   MCP server wrapping around the Fabric Rest API

3220. **[azure-diagram-mcp](https://github.com/dminkovski/azure-diagram-mcp)** - ⭐ 25
...
3221. **[nitrostack](https://github.com/nitrocloudofficial/nitrostack)** - ⭐ 24
   The full-stack TypeScript framework to build, test, and deploy production-ready MCP servers and AI-native apps.

3222. **[Tiny-OAI-MCP-Agent](https://github.com/jalr4ever/Tiny-OAI-MCP-Agent)** - ⭐ 24
   A MCP protocol agent that operates a SQLite using natural language by OpenAI-Compatible LLM.

3223. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

3224. **[GenomeMCP](https://github.com/Eldergenix/GenomeMCP)** - ⭐ 24
...
3225. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

3226. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
3227. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
3228. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

3229. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
3230. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

3231. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 24
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

3232. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
3233. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

3234. **[Awesome-MCP](https://github.com/Albertchamberlain/Awesome-MCP)** - ⭐ 24
   Awesome-MCP Servers & Clients & Funny things

3235. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 24
...
3236. **[readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db)** - ⭐ 24
...
3237. **[k6-mcp-server](https://github.com/QAInsights/k6-mcp-server)** - ⭐ 24
   k6 MCP server

3238. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 24
   Official BlazeMeter MCP Server for AI-driven performance testing

3239. **[mcp-client-agent](https://github.com/shane-kercheval/mcp-client-agent)** - ⭐ 24
   CLI that uses DSPy to interact with MCP servers.

3240. **[roo-logger](https://github.com/annenpolka/roo-logger)** - ⭐ 24
   An MCP server for logging activity in Roo Code/Cline.

3241. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 24
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

3242. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 24
   Model Context Protocol server for querying Cursor chat history

3243. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 24
   Model Context Protocol SDK implemented in Lua for OpenResty

3244. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 24
...
3245. **[jsonv-ts](https://github.com/dswbx/jsonv-ts)** - ⭐ 24
   JSON Schema builder and validator for TypeScript with static type inference, Hono middleware for OpenAPI generation and validation, and MCP server/client implementation. Lightweight, dependency-free, and built on Web Standards.

3246. **[mcp-mesh](https://github.com/dhyansraj/mcp-mesh)** - ⭐ 24
...
3251. **[html-to-markdown-mcp](https://github.com/levz0r/html-to-markdown-mcp)** - ⭐ 24
...
3252. **[agentgate](https://github.com/agentkitai/agentgate)** - ⭐ 24
   Approval workflows for AI agents

3253. **[zotero-mcp-server](https://github.com/swairshah/zotero-mcp-server)** - ⭐ 24
   MCP server to expose local zotero repository to MCP clients 

3254. **[local_faiss_mcp](https://github.com/nonatofabio/local_faiss_mcp)** - ⭐ 24
   Local FAISS vector store as an MCP server – Agent Memory, drop-in local semantic search for Claude / Copilot / Agents.

3255. **[UCAI](https://github.com/nirholas/UCAI)** - ⭐ 24
...
3256. **[ib-mcp-cache-server](https://github.com/ibproduct/ib-mcp-cache-server)** - ⭐ 24
   Memory Cache Server for use with supported MCP API Clients.

3257. **[janee](https://github.com/rsdouglas/janee)** - ⭐ 24
   Secrets management for AI agents via MCP • @janeesecure

3258. **[awesome-finance-mcp](https://github.com/BlockRunAI/awesome-finance-mcp)** - ⭐ 24
   A curated list of MCP servers for AI finance agents

3259. **[WikidataMCP](https://github.com/philippesaade-wmde/WikidataMCP)** - ⭐ 24
   Model Context Protocol for Wikidata

3260. **[mcp-server-amazon-bedrock](https://github.com/zxkane/mcp-server-amazon-bedrock)** - ⭐ 23
   Model Context Procotol(MCP) server for using Amazon Bedrock Nova Canvas to generate images

3261. **[mcp-rss-aggregator](https://github.com/imprvhub/mcp-rss-aggregator)** - ⭐ 23
   Model Context Protocol Server for aggregating RSS feeds in Claude Desktop

3262. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

3263. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

3264. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
3265. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

3266. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
3267. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
3268. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

3269. **[mcp-community](https://github.com/Mirascope/mcp-community)** - ⭐ 23
   Easily run, deploy, and connect to MCP servers

3270. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 23
...
3271. **[nlweb-net](https://github.com/nlweb-ai/nlweb-net)** - ⭐ 23
...
3272. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 23
   A personal assistant AI agent built with the Model Context Protocol (MCP)

3273. **[lightdash-mcp-server](https://github.com/syucream/lightdash-mcp-server)** - ⭐ 23
   A MCP(Model Context Protocol) server that accesses to Lightdash

3274. **[balldontlie-mcp](https://github.com/mikechao/balldontlie-mcp)** - ⭐ 23
   An MCP Server implementation that integrates the Balldontlie API, to provide information about players, teams and games for the NBA, NFL and MLB

3275. **[slack-mcp-client](https://github.com/csonigo/slack-mcp-client)** - ⭐ 23
   An MCP client for slack in Typescript

3276. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 23
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

3277. **[MCP-123](https://github.com/Tylersuard/MCP-123)** - ⭐ 23
   The easiest possible implementation of an MCP server and client.  Set up a server or a client in 2 lines of code.

3278. **[cf-mcp-client](https://github.com/cpage-pivotal/cf-mcp-client)** - ⭐ 23
   Tanzu Platform Chat

3279. **[autotask-mcp](https://github.com/asachs01/autotask-mcp)** - ⭐ 23
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

3280. **[nix-mcp-servers](https://github.com/ismail-kattakath/nix-mcp-servers)** - ⭐ 23
   A nix flake for configuring Model Context Protocol (MCP) servers across supported AI assistant clients

3281. **[mcp-cmd](https://github.com/developit/mcp-cmd)** - ⭐ 23
   CLI for calling successive MCP Server tools

3282. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 23
   ClickUp MCP Server - Integrate ClickUp project management with AI through Model Context Protocol

3283. **[codeprism](https://github.com/rustic-ai/codeprism)** - ⭐ 23
...
3284. **[minimal-godot-mcp](https://github.com/ryanmazzolini/minimal-godot-mcp)** - ⭐ 23
   Lightweight MCP server bridging Godot LSP to MCP clients for GDScript validation

3285. **[mTarsier](https://github.com/mcp360/mTarsier)** - ⭐ 23
   mTarsier - The Open Source MCP Manager for Claude, Cursor, VS Code & any AI client.

3286. **[rustchain-mcp](https://github.com/Scottcjn/rustchain-mcp)** - ⭐ 22
...
3298. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
3299. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

3300. **[biznagafest-mcp](https://github.com/0GiS0/biznagafest-mcp)** - ⭐ 22
   MCP Servers en Málaga con salero

3301. **[langchain-mcp-tools-ts](https://github.com/hideya/langchain-mcp-tools-ts)** - ⭐ 22
   MCP to LangChain Tools Conversion Utility / TypeScript

3302. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 22
   MCP (model context protocol) server for interacting with dbt Docs

3303. **[your-money-left-the-chat](https://github.com/Rayato159/your-money-left-the-chat)** - ⭐ 22
   A Rust + MCP powered financial tracker that knows exactly where your money ghosted you.

3304. **[mcp-framework](https://github.com/koki7o/mcp-framework)** - ⭐ 22
   Rust MCP framework for building AI agents

3305. **[GUI-MCP](https://github.com/PhialsBasement/GUI-MCP)** - ⭐ 22
...
3306. **[mcpc](https://github.com/micl2e2/mcpc)** - ⭐ 22
   Cross-platform C SDK for Model Context Protocol (MCP), in modern🚀 C23.

3307. **[suse-ai-up](https://github.com/SUSE/suse-ai-up)** - ⭐ 22
...
3308. **[awesome-mcp](https://github.com/MCPHubCloud/awesome-mcp)** - ⭐ 22
   A collection of mcp servers/client/sdks

3309. **[mcp-ai-agent](https://github.com/fkesheh/mcp-ai-agent)** - ⭐ 22
...
3314. **[teamcity-mcp](https://github.com/Daghis/teamcity-mcp)** - ⭐ 22
...
3315. **[Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine](https://github.com/cortexaiofficial/Autonomous-AI-Trading-Agent-MCP-Flash-Arb-Engine)** - ⭐ 22
...
3316. **[mcp-prompt-optimizer](https://github.com/Bubobot-Team/mcp-prompt-optimizer)** - ⭐ 22
   Advanced MCP server providing cutting-edge prompt optimization tools with research-backed strategies

3317. **[fcpxml-mcp-server](https://github.com/DareDev256/fcpxml-mcp-server)** - ⭐ 22
   🎬 The first AI-powered MCP server for Final Cut Pro XML. Control your edits with natural language.

3318. **[substack-mcp](https://github.com/marcomoauro/substack-mcp)** - ⭐ 22
...
3319. **[universal-crypto-mcp](https://github.com/nirholas/universal-crypto-mcp)** - ⭐ 22
...
3320. **[Blender-MCP-Server](https://github.com/poly-mcp/Blender-MCP-Server)** - ⭐ 22
...
3321. **[gemini-webapi-mcp](https://github.com/AndyShaman/gemini-webapi-mcp)** - ⭐ 22
   MCP server for Google Gemini — free image generation, editing & chat via browser cookies. No API keys needed.

3322. **[rollbar-mcp-server](https://github.com/rollbar/rollbar-mcp-server)** - ⭐ 22
   Pre-release - Model Context Protocol server for Rollbar

3323. **[qdrant-mcp-server](https://github.com/mhalder/qdrant-mcp-server)** - ⭐ 22
   MCP server for semantic search using local Qdrant vector database and OpenAI embeddings

3324. **[local-skills-mcp](https://github.com/kdpa-llc/local-skills-mcp)** - ⭐ 22
   Universal MCP server enabling any LLM or AI agent to utilize expert skills from your local filesystem. Reduces context consumption through lazy loading. Works with Claude, Cline, and any MCP-compatible client.

3325. **[slack-mcp-plugin](https://github.com/slackapi/slack-mcp-plugin)** - ⭐ 22
   Repo containing the configuration information for the Slack MCP to be added to other clients

3326. **[ChatSpatial](https://github.com/cafferychen777/ChatSpatial)** - ⭐ 22
...
3327. **[MCP-Mastery-with-Claude-and-Langchain](https://github.com/laxmimerit/MCP-Mastery-with-Claude-and-Langchain)** - ⭐ 22
   Build MCP servers & clients with Python, Streamlit, ChromaDB, LangChain, LangGraph agents, and Ollama integrations

3328. **[mcp-web-scraper](https://github.com/Decodo/mcp-web-scraper)** - ⭐ 22
   The Decodo MCP server which enables MCP clients to interface with services.

3329. **[ffmpeg-mcp-lite](https://github.com/kevinwatt/ffmpeg-mcp-lite)** - ⭐ 21
   MCP server for video/audio processing via FFmpeg - convert, compress, trim, extract audio, add subtitles

3330. **[supabase-mcp-client](https://github.com/tambo-ai/supabase-mcp-client)** - ⭐ 21
   Supabase MCP client react app with Tambo

3331. **[MCP_A2A](https://github.com/regismesquita/MCP_A2A)** - ⭐ 21
...
3332. **[grumpydev-mcp](https://github.com/sinedied/grumpydev-mcp)** - ⭐ 21
   Let the grumpy senior dev review your code with this MCP server

3333. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
3334. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

3335. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

3336. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

3337. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

3338. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

3339. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

3340. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
3347. **[aws-s3-mcp](https://github.com/samuraikun/aws-s3-mcp)** - ⭐ 21
   MCP server to integrate AWS S3 and LLM

3348. **[mcp-server-memos-py](https://github.com/RyoJerryYu/mcp-server-memos-py)** - ⭐ 21
   A Python package enabling LLM models to interact with the Memos server via the MCP interface for searching, creating, retrieving, and managing memos.

3349. **[Air-Quality-Trends-Analysis-Project](https://github.com/dyneth02/Air-Quality-Trends-Analysis-Project)** - ⭐ 21
...
3350. **[guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks](https://github.com/aws-solutions-library-samples/guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks)** - ⭐ 21
...
3351. **[heuristic-mcp](https://github.com/softerist/heuristic-mcp)** - ⭐ 21
...
3352. **[lotus-wisdom-mcp](https://github.com/linxule/lotus-wisdom-mcp)** - ⭐ 21
...
3353. **[mcp-link](https://github.com/AuraFriday/mcp-link)** - ⭐ 21
...
3354. **[PDB-MCP-Server](https://github.com/Augmented-Nature/PDB-MCP-Server)** - ⭐ 21
...
3355. **[agent-studio-starter](https://github.com/nsphung/agent-studio-starter)** - ⭐ 21
   Stop building AI agents from scratch. Bootstrap starter Agent app with LangGraph, CopilotKit, and beautiful Generative UIs.

3356. **[codex-mcp-tool](https://github.com/x51xxx/codex-mcp-tool)** - ⭐ 21

3357. **[typescript-mcp-client](https://github.com/CodelyTV/typescript-mcp-client)** - ⭐ 21

3358. **[jenkins-mcp-enterprise](https://github.com/Jordan-Jarvis/jenkins-mcp-enterprise)** - ⭐ 21
...
3359. **[IoT-Edge-MCP-Server](https://github.com/poly-mcp/IoT-Edge-MCP-Server)** - ⭐ 21
...
3360. **[mcp-diagnostics-extension](https://github.com/newbpydev/mcp-diagnostics-extension)** - ⭐ 21
   VS Code extension that exposes diagnostic problems via Model Context Protocol (MCP) for AI agents and tools

3361. **[orionbelt-semantic-layer](https://github.com/ralfbecher/orionbelt-semantic-layer)** - ⭐ 21
...
3362. **[adloop](https://github.com/kLOsk/adloop)** - ⭐ 21
...
3363. **[unity-editor-mcp](https://github.com/ozankasikci/unity-editor-mcp)** - ⭐ 21
   An MCP server and client for LLMs to interact with Unity Projects

3364. **[mcp-server](https://github.com/paperinvest/mcp-server)** - ⭐ 21
   Official MCP server for Paper's trading platform - enables AI assistants to interact with Paper's API

3365. **[mcp-server-runner](https://github.com/yonaka15/mcp-server-runner)** - ⭐ 20
...
3366. **[easymcp](https://github.com/promptmesh/easymcp)** - ⭐ 20
   A high performance MCP client sdk for python

3367. **[mcp-free-usdc-transfer](https://github.com/magnetai/mcp-free-usdc-transfer)** - ⭐ 20
   MCP (Model Context Protocol) server - free usdc transfer powered by Coinbase CDP

3368. **[mcp-file-operations-server](https://github.com/bsmi021/mcp-file-operations-server)** - ⭐ 20
   A Model Context Protocol (MCP) server that provides enhanced file operation capabilities with streaming, patching, and change tracking support.

3369. **[cucumberstudio-mcp](https://github.com/HeroSizy/cucumberstudio-mcp)** - ⭐ 20
   MCP Server for Cucumber Studio

3370. **[knowledgebase-mcp](https://github.com/biocontext-ai/knowledgebase-mcp)** - ⭐ 20
   BioContextAI Knowledgebase MCP server for biomedical agentic AI 

3371. **[registry](https://github.com/biocontext-ai/registry)** - ⭐ 20
   The BioContextAI Registry for biomedical MCP servers

3372. **[agent-mcp](https://github.com/grupa-ai/agent-mcp)** - ⭐ 20
   MCPAgent for Grupa.AI Multi-agent Collaboration Network (MACNET) with Model Context Protocol (MCP) capabilities baked in

3373. **[mcp-frontend](https://github.com/shaharia-lab/mcp-frontend)** - ⭐ 20
   Frontend for MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

3374. **[ai-cli](https://github.com/manusa/ai-cli)** - ⭐ 20
   ai-cli lets you go from zero to AI-powered in seconds in a safe, automated and tailored way.

3375. **[mcp-yfinance](https://github.com/9nate-drake/mcp-yfinance)** - ⭐ 20
   MCP Server for fething yfinance financial data into Claude Desktop

3376. **[linux-command-mcp](https://github.com/xkiranj/linux-command-mcp)** - ⭐ 20
   MCP server and client for running Linux commands

3377. **[archmcp](https://github.com/dejo1307/archmcp)** - ⭐ 20
   archmcp - MCP Architectural Snapshot Server and Knowledge Graph

3378. **[eraser-io-mcp-server](https://github.com/buck-0x/eraser-io-mcp-server)** - ⭐ 20
   A Python MCP (Model Context Protocol) server and CLI tool to render diagrams using the Eraser API.

3379. **[Jiva](https://github.com/KarmaloopAI/Jiva)** - ⭐ 20
...
3380. **[MCP-Agent](https://github.com/CursorTouch/MCP-Agent)** - ⭐ 20
   Connect to any MCP servers using agents

3381. **[mcp.zig](https://github.com/muhammad-fiaz/mcp.zig)** - ⭐ 20
   A comprehensive Model Context Protocol (MCP) library for Zig — bringing MCP support to the Zig ecosystem.

3382. **[context-lens](https://github.com/cornelcroi/context-lens)** - ⭐ 20
...
3383. **[mcp-libsql](https://github.com/Xexr/mcp-libsql)** - ⭐ 20
...
3384. **[hasmcp-ce](https://github.com/hasmcp/hasmcp-ce)** - ⭐ 20
   HasMCP Community Edition

3385. **[uk-case-law-mcp-server](https://github.com/georgejeffers/uk-case-law-mcp-server)** - ⭐ 20
   MCP server for UK case law using The National Archives API. Enables LLMs to search, retrieve, and cite UK legal judgments.

3386. **[twincat-validator-mcp](https://github.com/agenticcontrolio/twincat-validator-mcp)** - ⭐ 20
...
3390. **[webmcp-bridge](https://github.com/holon-run/webmcp-bridge)** - ⭐ 20
...
3391. **[muster](https://github.com/giantswarm/muster)** - ⭐ 20
   MCP tool management and workflow proxy

3392. **[gemini-mcp-client](https://github.com/angrysky56/gemini-mcp-client)** - ⭐ 19
...
3393. **[starbase](https://github.com/metorial/starbase)** - ⭐ 19
   Connect, explore, and test any MCP server with AI models 🤖 ⚡

3394. **[mcp](https://github.com/EmilLindfors/mcp)** - ⭐ 19
    A crate for making MCP (Model Context Protocol) compatible programs with rust

3395. **[mcp-server-mariadb](https://github.com/abel9851/mcp-server-mariadb)** - ⭐ 19
   An mcp server that provides read-only access to MariaDB.

3396. **[mcp-server-client-demo](https://github.com/S1LV3RJ1NX/mcp-server-client-demo)** - ⭐ 19
   Streamable HTTP based MCP server and Client demo with auto registry, Dockerfile setup and env. 

3397. **[openapi2mcptools](https://github.com/2013xile/openapi2mcptools)** - ⭐ 19
   OpenAPI specifications => MCP (Model Context Protocol) tools

3398. **[termlink](https://github.com/chu2bard/termlink)** - ⭐ 19
   MCP server for shell and terminal operations

3399. **[it-tools-mcp](https://github.com/wrenchpilot/it-tools-mcp)** - ⭐ 19
...
3404. **[predictive-maintenance-mcp](https://github.com/LGDiMaggio/predictive-maintenance-mcp)** - ⭐ 19
...
3409. **[bonnard](https://github.com/bonnard-data/bonnard)** - ⭐ 19
...
3410. **[Screenhand](https://github.com/manushi4/Screenhand)** - ⭐ 19
...
3411. **[mcp-oauth-proxy](https://github.com/obot-platform/mcp-oauth-proxy)** - ⭐ 19
   Oauth 2.1 proxy server that can autheticate client and proxy requests to mcp server

3412. **[toolkit-mcp-server](https://github.com/cyanheads/toolkit-mcp-server)** - ⭐ 19
   A Model Context Protocol server providing LLM Agents with system utilities and tools, including IP geolocation, network diagnostics, system monitoring, cryptographic operations, and QR code generation.

3413. **[mcp-superset](https://github.com/bintocher/mcp-superset)** - ⭐ 19
   MCP server for managing Apache Superset — 128+ tools for dashboards, charts, datasets, SQL Lab, access control

3414. **[spectrawl](https://github.com/FayAndXan/spectrawl)** - ⭐ 19
...
3415. **[stitch-mcp-auto](https://github.com/GreenSheep01201/stitch-mcp-auto)** - ⭐ 19
   Automated installer for Stitch MCP - The easiest way to set up your Universal MCP server for Google Stitch.

3416. **[godot-mcp-pro](https://github.com/youichi-uda/godot-mcp-pro)** - ⭐ 19
...
3417. **[spectrawl](https://github.com/Pyx-Corp/spectrawl)** - ⭐ 19
   The unified web layer for AI agents. Search (8 engines), stealth browse, auth, and act on 24 platforms. One npm install, self-hosted.

3418. **[mcp-agent](https://github.com/joshuaalpuerto/mcp-agent)** - ⭐ 19
...
3419. **[mcpx](https://github.com/AIGC-Hackers/mcpx)** - ⭐ 19
...
3420. **[skill-to-mcp](https://github.com/biocontext-ai/skill-to-mcp)** - ⭐ 19
   Convert AI Skills (Claude Skills format) to MCP server resources - Part of BioContextAI

3421. **[roblox-executor-mcp](https://github.com/notpoiu/roblox-executor-mcp)** - ⭐ 19
   A MCP Server which allows for direct access to the roblox game client

3422. **[mcp-kling](https://github.com/199-mcp/mcp-kling)** - ⭐ 19
   🎬 The FIRST MCP server for Kling AI video generation! Generate stunning AI videos directly from Claude.

3423. **[daiv](https://github.com/srtab/daiv)** - ⭐ 19
   Your AI-powered SWE teammate, built into your git workflow

3424. **[openclaw-superpowers](https://github.com/ArchieIndian/openclaw-superpowers)** - ⭐ 19
   44 plug-and-play skills for OpenClaw — self-modifying AI agent with cron scheduling, security guardrails, persistent memory, knowledge graphs, and MCP health monitoring. Your agent teaches itself new behaviors during conversation.

3425. **[Intercept](https://github.com/PolicyLayer/Intercept)** - ⭐ 19
   Production Guardrails for AI agents. Intercept enforces hard limits on what agents can do at the MCP transport layer — before execution.

3426. **[unified-gateway-mcp](https://github.com/mcp360/unified-gateway-mcp)** - ⭐ 19
   Unified MCP Gateway Platform, Marketplace & Custom MCPs

3427. **[hass-mcp-server](https://github.com/ganhammar/hass-mcp-server)** - ⭐ 18
...
3428. **[mcp-client-cli](https://github.com/addity3/mcp-client-cli)** - ⭐ 18
   cli-based program to run llm prompt and mcp

3429. **[Augmented-Nature-UniProt-MCP-Server](https://github.com/Augmented-Nature/Augmented-Nature-UniProt-MCP-Server)** - ⭐ 18
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the UniProt protein database. 

3430. **[mcp](https://github.com/zuplo/mcp)** - ⭐ 18
   A fetch API based TypeScript SDK for MCP

3431. **[eleven.shopping](https://github.com/elevenlabs/eleven.shopping)** - ⭐ 18
   ElevenLabs Agent with Storefront MCP UI Server & MCP UI client

3432. **[openpyxl-mcp-server](https://github.com/jonemo/openpyxl-mcp-server)** - ⭐ 18
...
3433. **[sufetch](https://github.com/productdevbook/sufetch)** - ⭐ 18
   Type-safe OpenAPI clients with MCP server for AI-driven API exploration

3434. **[SimpleMcp.Demo](https://github.com/hassanhabib/SimpleMcp.Demo)** - ⭐ 18
   Simplest Possible Demo for Building MCP Server & Client

3435. **[mcp-copilot](https://github.com/tshu-w/mcp-copilot)** - ⭐ 18
   A meta MCP server that seamlessly scales LLMs to 1000+ MCP servers through automatic routing.

3436. **[gpt2099.nu](https://github.com/cablehead/gpt2099.nu)** - ⭐ 18
   a Nushell cross.stream extension to interact with LLMs and MCP servers

3437. **[Devmind-MCP](https://github.com/JochenYang/Devmind-MCP)** - ⭐ 18
...
3438. **[seedream-image-mcp](https://github.com/wearzdk/seedream-image-mcp)** - ⭐ 18
   🚀 PixelMCP | 为你的 Cursor、Claude Code 等集成AI绘画能力，让AI生成的页面不再单调！

3439. **[mcp-chat-studio](https://github.com/JoeCastrom/mcp-chat-studio)** - ⭐ 18
...
3440. **[mcp-server-microsoft-paint](https://github.com/ghuntley/mcp-server-microsoft-paint)** - ⭐ 18

3441. **[mcp-chain-of-draft-prompt-tool](https://github.com/brendancopley/mcp-chain-of-draft-prompt-tool)** - ⭐ 18
   MCP prompt tool applying Chain-of-Draft (CoD) reasoning - BYOLLM

3442. **[model-context-protocol-survey](https://github.com/asinghcsu/model-context-protocol-survey)** - ⭐ 18
   Model Context Protocol (MCP)

3443. **[MCP-Development-with-Rust](https://github.com/RustSandbox/MCP-Development-with-Rust)** - ⭐ 18
...
3444. **[emceepee](https://github.com/eastlondoner/emceepee)** - ⭐ 18
...
3445. **[github-repos-manager-mcp](https://github.com/kurdin/github-repos-manager-mcp)** - ⭐ 18
...
3446. **[titanmind-whatsapp-mcp](https://github.com/TitanmindAGI/titanmind-whatsapp-mcp)** - ⭐ 18
...
3447. **[awesome-dxt-mcp](https://github.com/MCPStar/awesome-dxt-mcp)** - ⭐ 18
...
3448. **[gumroad-mcp](https://github.com/rmarescu/gumroad-mcp)** - ⭐ 18
   A Model Context Protocol (MCP) server implementation for Gumroad API

3449. **[cmcp](https://github.com/RussellLuo/cmcp)** - ⭐ 18
   A command-line utility for interacting with MCP servers.

3450. **[mcp-chatbot](https://github.com/mctrinh/mcp-chatbot)** - ⭐ 18
...
3451. **[agentidentityprotocol](https://github.com/openagentidentityprotocol/agentidentityprotocol)** - ⭐ 18
...
3452. **[toolhive-catalog](https://github.com/stacklok/toolhive-catalog)** - ⭐ 18
   ToolHive's registry catalog of MCP servers

3453. **[rigour](https://github.com/rigour-labs/rigour)** - ⭐ 18
   The immune system for AI coding agents

3454. **[robotmem](https://github.com/robotmem/robotmem)** - ⭐ 18
   Robot Memory - Persistent memory system for AI robots. MCP Server + hybrid search + spatial retrieval.

3455. **[lyra-tool-discovery](https://github.com/nirholas/lyra-tool-discovery)** - ⭐ 18
...
3456. **[subcog](https://github.com/zircote/subcog)** - ⭐ 18
...
3457. **[speclock](https://github.com/sgroy10/speclock)** - ⭐ 18
...
3458. **[trainingpeaks-mcp](https://github.com/JamsusMaximus/trainingpeaks-mcp)** - ⭐ 18
...
3459. **[agentify](https://github.com/koriyoshi2041/agentify)** - ⭐ 18
...
3460. **[arxiv-mcp-server](https://github.com/anuj0456/arxiv-mcp-server)** - ⭐ 18
...
3461. **[better-notion-mcp](https://github.com/n24q02m/better-notion-mcp)** - ⭐ 18
   Markdown-first MCP server for Notion API - composite tools optimized for AI agents

3462. **[Unity-AI-ParticleSystem](https://github.com/IvanMurzak/Unity-AI-ParticleSystem)** - ⭐ 18
   AI-powered tools for Unity Particle System. Create and modify Particle System directly through natural language commands.

3463. **[mcp-gateway](https://github.com/unrelated-ai/mcp-gateway)** - ⭐ 18
...
3464. **[agentic-tools](https://github.com/meta-quest/agentic-tools)** - ⭐ 18
   Agent Tool and Skills for VR Development on Meta Quest 

3465. **[unity-mcp](https://github.com/wondeks/unity-mcp)** - ⭐ 18
   A Unity MCP server that allows MCP clients like Claude Desktop or Cursor to perform Unity Editor actions.

3466. **[smartlead-mcp-server](https://github.com/jonathan-politzki/smartlead-mcp-server)** - ⭐ 17
   Local version of Smartlead MCP for quick download and deployment to MCP compatible clients or n8n.

3467. **[mcp-http-client-example](https://github.com/slavashvets/mcp-http-client-example)** - ⭐ 17
   Simple example client demonstrating how to connect to MCP servers over HTTP (SSE)

3468. **[jiki](https://github.com/teilomillet/jiki)** - ⭐ 17

3469. **[askit](https://github.com/johnrobinsn/askit)** - ⭐ 17
   LLM Function Calling Library and CLI with Support for MCP Servers

3470. **[youtube-mcp-server](https://github.com/0GiS0/youtube-mcp-server)** - ⭐ 17
   Cómo crear MCP Servers y usarlos con GitHub Copilot Chat 🚀💻🤖

3471. **[GUARDRAIL](https://github.com/nshkrdotcom/GUARDRAIL)** - ⭐ 17
   GUARDRAIL - MCP Security - Gateway for Unified Access, Resource Delegation, and Risk-Attenuating Information Limits

3472. **[mcp-server-prometheus](https://github.com/loglmhq/mcp-server-prometheus)** - ⭐ 17
   MCP server for interacting with Prometheus

3473. **[mcp-koii](https://github.com/benjaminr/mcp-koii)** - ⭐ 17
   MCP Server for Teenage Engineering EP-133 KO-II

3474. **[context-engineering](https://github.com/timothywarner-org/context-engineering)** - ⭐ 17
...
3475. **[docmole](https://github.com/Vigtu/docmole)** - ⭐ 17
   Dig through any documentation with AI - MCP server for Claude, Cursor, and other AI assistants

3476. **[Agentic-MCP-Skill](https://github.com/cablate/Agentic-MCP-Skill)** - ⭐ 17
   Agentic-MCP, Progressive MCP client with three-layer lazy loading. Validates AgentSkills.io pattern for efficient token usage. Use MCP without pre-install & wasting full-loading

3477. **[autowpmcp](https://github.com/Njengah/autowpmcp)** - ⭐ 17
...
3478. **[rpc-nodes-mcp](https://github.com/chainstacklabs/rpc-nodes-mcp)** - ⭐ 17
   Minimal, fast, and extensible MCP server for interactions with JSON-RPC blockchain nodes

3479. **[mcp-server-codegraph](https://github.com/CartographAI/mcp-server-codegraph)** - ⭐ 17
   MCP server for graph representation of a codebase

3480. **[pophive-mcp-server](https://github.com/Cicatriiz/pophive-mcp-server)** - ⭐ 17
...
3481. **[mcp-email-client](https://github.com/gamalan/mcp-email-client)** - ⭐ 17
   Email Client as MCP Server. Feature: multiple configuration, more than just gmail

3482. **[mlb-mcp](https://github.com/etweisberg/mlb-mcp)** - ⭐ 17
   MCP server for advanced baseball analytics (statcast, fangraphs, baseball reference, mlb stats API) with client demo 

3483. **[signal-mcp-client](https://github.com/piebro/signal-mcp-client)** - ⭐ 17
   An MCP client that uses signal for sending and receiving messages.

3484. **[mcpforge](https://github.com/lorenzosaraiva/mcpforge)** - ⭐ 17

3485. **[mcp-ecosystem](https://github.com/SynkraAI/mcp-ecosystem)** - ⭐ 17
   MCP Ecosystem: Docker MCP Toolkit, IDE Configs & Presets for AIOS

3486. **[scopus-mcp](https://github.com/qwe4559999/scopus-mcp)** - ⭐ 17
...
3487. **[lightdash_mcp](https://github.com/poddubnyoleg/lightdash_mcp)** - ⭐ 17
   mcp server for lightdash

3488. **[mcp-graphql-forge](https://github.com/toolprint/mcp-graphql-forge)** - ⭐ 17
   MCP that can proxy any GraphQL API and expose graphql operations as mcp tools.

3489. **[sveltekit-mcp-starter](https://github.com/axel-rock/sveltekit-mcp-starter)** - ⭐ 17

3490. **[mcp-obsidian](https://github.com/Piotr1215/mcp-obsidian)** - ⭐ 17
   simple mcp server for interacting with local obsidian notes

3491. **[mistr-agent](https://github.com/itisaevalex/mistr-agent)** - ⭐ 17
...
3492. **[ContextOS](https://github.com/itallstartedwithaidea/ContextOS)** - ⭐ 17
...
3493. **[openrouter-mcp-multimodal](https://github.com/stabgan/openrouter-mcp-multimodal)** - ⭐ 17
   MCP server for OpenRouter providing text chat and image analysis tools

3494. **[osmmcp](https://github.com/NERVsystems/osmmcp)** - ⭐ 17
...
3495. **[local-mcp-gateway](https://github.com/DXHeroes/local-mcp-gateway)** - ⭐ 17
   Aggregate multiple MCP servers into a single endpoint with web UI, OAuth 2.1, and profile-based tool management

3496. **[awesome-mcp-security](https://github.com/AgentSeal/awesome-mcp-security)** - ⭐ 17
...
3497. **[CereBro](https://github.com/rob1997/CereBro)** - ⭐ 17
   A model-agnostic MCP Client-Server for .Net and Unity

3498. **[claude-vigil-mcp](https://github.com/Vvkmnn/claude-vigil-mcp)** - ⭐ 16
   🏺 An MCP server for checkpointing and file recovery in Claude Code

3499. **[muxi](https://github.com/ranaroussi/muxi)** - ⭐ 16
   An extensible AI agents framework

3500. **[oneshot](https://github.com/Destiner/oneshot)** - ⭐ 16
   Anthropic MCP client for macOS

3501. **[lite-mcp-client](https://github.com/sligter/lite-mcp-client)** - ⭐ 16
   Lite-MCP-Client是一个基于命令行的轻量级MCP客户端工具

3502. **[EasyMCP](https://github.com/mshojaei77/EasyMCP)** - ⭐ 16
...
3503. **[mcp-installer](https://github.com/joobisb/mcp-installer)** - ⭐ 16
   Simplifies the installation and management of MCP (Model Context Protocol) servers across different AI clients.

3504. **[appvector-mcp](https://github.com/Multivariate-AI-Inc/appvector-mcp)** - ⭐ 16
...
3505. **[protocols-io-mcp-server](https://github.com/hqn21/protocols-io-mcp-server)** - ⭐ 16
   An MCP server that enables MCP clients like Claude Desktop to interact with data from protocols.io.

3506. **[mcp-progressive-agentskill](https://github.com/cablate/mcp-progressive-agentskill)** - ⭐ 16
...
3507. **[create-mcp](https://github.com/fefergrgrgrg/create-mcp)** - ⭐ 16
   CLI to set up and deploy MCP Servers to Cloudflare Workers in seconds. Just write TypeScript functions to make Cursor MCP tools.

3508. **[videocapture-mcp](https://github.com/13rac1/videocapture-mcp)** - ⭐ 16
   Model Context Protocol (MCP) server to capture images from an OpenCV-compatible webcam or video source

3509. **[aica](https://github.com/dotneet/aica)** - ⭐ 16
   aica(AI Code Analyzer) reviews your code using AI. Supports CLI and GitHub Actions.

3510. **[go-mcp](https://github.com/dstotijn/go-mcp)** - ⭐ 16
   Go library for implementing the Model Context Protocol (MCP).

3511. **[QCX](https://github.com/QueueLab/QCX)** - ⭐ 16
   Language to Maps

3512. **[qmt-mcp-server](https://github.com/jm12138/qmt-mcp-server)** - ⭐ 16
   基于 QMT 平台股票行情的 MCP 服务器，用于提供股票市场数据下载和查询的功能。

3513. **[grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp)** - ⭐ 16
   MCP server for xAI Grok — read and serve .faf project context. npm: grok-faf-mcp

3514. **[mcp-jest](https://github.com/josharsh/mcp-jest)** - ⭐ 16
   Automated testing for Model Context Protocol servers. Ship MCP Servers with confidence.

3515. **[hoot](https://github.com/Portkey-AI/hoot)** - ⭐ 16
   MCP Testing Tool — Like Postman, but for the Model Context Protocol.

3516. **[MicrosoftGraph_Transcript_MCP](https://github.com/ITSpecialist111/MicrosoftGraph_Transcript_MCP)** - ⭐ 16
...
3517. **[mcp-client-for-weather-example](https://github.com/a-persimmons/mcp-client-for-weather-example)** - ⭐ 16
   一个MCP客户端实践：实现LLM调用天气MCP服务端查询天气的快速示例

3518. **[mcp-client-gen](https://github.com/kriasoft/mcp-client-gen)** - ⭐ 16
   Turn any MCP server into a type-safe TypeScript SDK in seconds - with    OAuth 2.1 and multi-provider support

3519. **[penpot-mcp-server](https://github.com/zcube/penpot-mcp-server)** - ⭐ 16
   MCP server for Penpot - Connect AI assistants to Penpot design platform via Model Context Protocol

3520. **[mcp_client](https://github.com/app-appplayer/mcp_client)** - ⭐ 16

3521. **[pentest-mcp-server](https://github.com/LayeSec006/pentest-mcp-server)** - ⭐ 16
   MCP server for penetration testing

3522. **[nanobanana-mcp](https://github.com/YCSE/nanobanana-mcp)** - ⭐ 16
   Gemini Vision & Image Generation MCP for Claude Desktop and Claude Code

3523. **[Frontapp-MCP](https://github.com/zqushair/Frontapp-MCP)** - ⭐ 16
   MCP server and client for Frontapp

3524. **[MCP-Analyzer](https://github.com/klara-research/MCP-Analyzer)** - ⭐ 16
   An MCP server to read MCP logs to debug directly inside the client

3525. **[mcp_documents_reader](https://github.com/xt765/mcp_documents_reader)** - ⭐ 16
...
3526. **[drf-mcp-docs](https://github.com/Abdulkhalek-1/drf-mcp-docs)** - ⭐ 16
   API documentation via MCP for AI coding agents

3527. **[mcp-this](https://github.com/shane-kercheval/mcp-this)** - ⭐ 16
...
3528. **[XcodeMCPWrapper](https://github.com/SoundBlaster/XcodeMCPWrapper)** - ⭐ 16
   MCP that makes Xcode 26.3's MCP compatible with Cursor and other strict MCP-spec-compliant clients

3529. **[github-to-mcp](https://github.com/nirholas/github-to-mcp)** - ⭐ 16
   Convert GitHub repositories to MCP servers automatically. Extract tools from OpenAPI, GraphQL & REST APIs for Claude Desktop, Cursor, Windsurf, Cline & VS Code. AI-powered code generation creates type-safe TypeScript/Python MCP servers. Zero config setup - just paste a repo URL. Built for AI assistants & LLM tool integration.

3530. **[video-research-mcp](https://github.com/Galbaz1/video-research-mcp)** - ⭐ 16
...
3531. **[LSP4J-MCP](https://github.com/stephanj/LSP4J-MCP)** - ⭐ 16
...
3532. **[outlook-mcp](https://github.com/XenoXilus/outlook-mcp)** - ⭐ 16
...
3533. **[mcpdog](https://github.com/kinhunt/mcpdog)** - ⭐ 16
...
3534. **[puppeteer-mcp-server](https://github.com/sultannaufal/puppeteer-mcp-server)** - ⭐ 16
...
3535. **[mcp-salesforce](https://github.com/AiondaDotCom/mcp-salesforce)** - ⭐ 16
...
3536. **[shodan-mcp](https://github.com/Vorota-ai/shodan-mcp)** - ⭐ 16
...
3542. **[claude-server](https://github.com/davidteren/claude-server)** - ⭐ 15
...
3543. **[pinmeto-location-mcp](https://github.com/PinMeTo/pinmeto-location-mcp)** - ⭐ 15
   PinMeTo MCP server that enables users with authorized credentials to unlock their data 

3544. **[npm-search-mcp-server](https://github.com/btwiuse/npm-search-mcp-server)** - ⭐ 15
   MCP server for searching npm packages

3545. **[mcp-server-python-template](https://github.com/sontallive/mcp-server-python-template)** - ⭐ 15
   This template provides a streamlined foundation for building Model Context Protocol (MCP) servers in Python. It's designed to make AI-assisted development of MCP tools easier and more efficient.

3546. **[mcp-tui](https://github.com/msabramo/mcp-tui)** - ⭐ 15
   MCP host app w/ textual user interface, in Python

3547. **[mcp-server-unitycatalog](https://github.com/ognis1205/mcp-server-unitycatalog)** - ⭐ 15
   Unity Catalog AI Model Context Protocol Server

3548. **[claude-mcp-scheduler](https://github.com/tonybentley/claude-mcp-scheduler)** - ⭐ 15
   Use Claude API to prompt remote agents on a cron interval but use local MCPs to handle tool calls for context

3549. **[vite-plugin-mcp-client-tools](https://github.com/atesgoral/vite-plugin-mcp-client-tools)** - ⭐ 15
   Pluggable Vite MCP plugin that brings client-side tools to your existing Vite setup

3550. **[mcp-server-templates](https://github.com/Data-Everything/mcp-server-templates)** - ⭐ 15
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs.

3551. **[mcp-turso-cloud](https://github.com/spences10/mcp-turso-cloud)** - ⭐ 15
...
3552. **[mcp-web-client](https://github.com/hemanth/mcp-web-client)** - ⭐ 15
   A web-based client for connecting to MCP servers with OAuth support

3553. **[cursor-feedback-extension](https://github.com/jianger666/cursor-feedback-extension)** - ⭐ 15
   Save your Cursor monthly quota! Unlimited AI interactions in one conversation via MCP feedback loop.

3554. **[the-academy](https://github.com/im-knots/the-academy)** - ⭐ 15
   A Socratic dialogue engine for AI agents. 

3555. **[mcp](https://github.com/local-falcon/mcp)** - ⭐ 15
...
3556. **[opentargets-mcp](https://github.com/nickzren/opentargets-mcp)** - ⭐ 15
   MCP server for Open Targets Data

3557. **[programmatic-tool-calling-ai-sdk](https://github.com/cameronking4/programmatic-tool-calling-ai-sdk)** - ⭐ 15
...
3558. **[Convert-Markdown-PDF-MCP](https://github.com/seanivore/Convert-Markdown-PDF-MCP)** - ⭐ 15
   Markdown To PDF Conversion MCP

3559. **[opencode-browser](https://github.com/michaljach/opencode-browser)** - ⭐ 15
...
3565. **[companies-house-mcp](https://github.com/stefanoamorelli/companies-house-mcp)** - ⭐ 15
...
3566. **[FocusRelayMCP](https://github.com/deverman/FocusRelayMCP)** - ⭐ 15
...
3567. **[mcp-spotify-player](https://github.com/vsaez/mcp-spotify-player)** - ⭐ 15
   MCP server to manage Spotify from MCP clients

3568. **[chatgpt-app-typescript-template](https://github.com/pomerium/chatgpt-app-typescript-template)** - ⭐ 15
...
3569. **[capture-mcp-server](https://github.com/blencorp/capture-mcp-server)** - ⭐ 15
...
3570. **[swift-mcp](https://github.com/DePasqualeOrg/swift-mcp)** - ⭐ 15
   Full-featured Swift SDK for Model Context Protocol servers and clients

3571. **[davinci-mcp-professional](https://github.com/Positronikal/davinci-mcp-professional)** - ⭐ 15
...
3572. **[mcp-server-zotero-dev](https://github.com/introfini/mcp-server-zotero-dev)** - ⭐ 15
...
3573. **[ultrathink](https://github.com/husniadil/ultrathink)** - ⭐ 15
...
3574. **[django-mcp](https://github.com/hyperb1iss/django-mcp)** - ⭐ 15
...
3575. **[webmcp-react](https://github.com/MCPCat/webmcp-react)** - ⭐ 15
...
3576. **[extract-llms-docs](https://github.com/nirholas/extract-llms-docs)** - ⭐ 15
...
3577. **[gsd-task-manager](https://github.com/vscarpenter/gsd-task-manager)** - ⭐ 15
...
3578. **[agent-board](https://github.com/quentintou/agent-board)** - ⭐ 15
...
3579. **[cuba-memorys](https://github.com/LeandroPG19/cuba-memorys)** - ⭐ 15
...
3580. **[mcp-anything](https://github.com/gabrielekarra/mcp-anything)** - ⭐ 15
   One command to turn any codebase into an MCP server

3581. **[slack-mcp-server](https://github.com/jtalk22/slack-mcp-server)** - ⭐ 15
   Session-based Slack MCP for Claude and MCP clients: local-first workflows, secure-default HTTP.

3582. **[stata-workbench](https://github.com/tmonk/stata-workbench)** - ⭐ 15
...
3583. **[coworker](https://github.com/Array-Ventures/coworker)** - ⭐ 15
...
3584. **[systemprompt-mcp-core](https://github.com/Ejb503/systemprompt-mcp-core)** - ⭐ 14
   The core MCP extension for Systemprompt MCP multimodal client

3585. **[llm-sse-mcp-demo-2025](https://github.com/nlinhvu/llm-sse-mcp-demo-2025)** - ⭐ 14
...
3586. **[mcp-bundler](https://github.com/wrtnlabs/mcp-bundler)** - ⭐ 14
   Is the MCP configuration too complicated? You can easily share your own simplified setup!

3587. **[ntfy-mcp-server](https://github.com/cyanheads/ntfy-mcp-server)** - ⭐ 14
   An MCP (Model Context Protocol) server designed to interact with the ntfy push notification service. It enables LLMs and AI agents to send notifications to your devices with extensive customization options.

3588. **[mcpterm](https://github.com/dwrtz/mcpterm)** - ⭐ 14
   An MCP tool server that provides stateful, TUI-compatible terminal sessions.

3589. **[work-memory-mcp](https://github.com/moontmsai/work-memory-mcp)** - ⭐ 14
   Never lose context again - persistent memory management system for AI-powered workflows across multiple tools

3590. **[mcp-ipfs](https://github.com/alexbakers/mcp-ipfs)** - ⭐ 14
   🪐 MCP IPFS Server 

3591. **[google-mcp](https://github.com/vakharwalad23/google-mcp)** - ⭐ 14
   Collection of Google-native tools (e.g., Gmail, Calendar) for the MCP

3592. **[mcp-server-gemini-pro](https://github.com/gurveeer/mcp-server-gemini-pro)** - ⭐ 14
...
3593. **[MCP-Platform](https://github.com/Data-Everything/MCP-Platform)** - ⭐ 14
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs

3594. **[mcp-server](https://github.com/configcat/mcp-server)** - ⭐ 14
   Official ConfigCat Model Context Protocol (MCP) Server 

3595. **[mcp-config-editor](https://github.com/kaichen/mcp-config-editor)** - ⭐ 14
   A simple GUI for managing MCP servers, for easy toggle mcp servers.

3596. **[deep-directory-tree-mcp](https://github.com/andredezzy/deep-directory-tree-mcp)** - ⭐ 14
...
3597. **[mcp-client-compatibility](https://github.com/tadata-org/mcp-client-compatibility)** - ⭐ 14

3598. **[mcp-time](https://github.com/TheoBrigitte/mcp-time)** - ⭐ 14
...
3599. **[dx-toolkit](https://github.com/youdotcom-oss/dx-toolkit)** - ⭐ 14
   Open-source toolkit enabling developers to integrate You.com's AI capabilities into their workflows

3600. **[mcpskills-cli](https://github.com/dhanababum/mcpskills-cli)** - ⭐ 14
...
3601. **[mcp-perplexity-server](https://github.com/PoliTwit1984/mcp-perplexity-server)** - ⭐ 14
...
3602. **[jadx-mcp-server](https://github.com/Qtty/jadx-mcp-server)** - ⭐ 14
   A Pure-Java MCP Server for JaDX Android Reverse Engineering Tool

3603. **[vmware-esxi-mcp](https://github.com/uldyssian-sh/vmware-esxi-mcp)** - ⭐ 14
...
3604. **[webfetch-mcp](https://github.com/manooll/webfetch-mcp)** - ⭐ 14
   Live Web Access for Your Local AI — Tunable Search & Clean Content Extraction

3605. **[domain-search-mcp](https://github.com/dorukardahan/domain-search-mcp)** - ⭐ 14
...
3609. **[mcp-safe-run](https://github.com/ithena-one/mcp-safe-run)** - ⭐ 14
...
3610. **[phabricator-mcp](https://github.com/freelancer/phabricator-mcp)** - ⭐ 14
   MCP server for Phabricator

3611. **[openalex-research-mcp](https://github.com/oksure/openalex-research-mcp)** - ⭐ 14
...
3612. **[claude-praetorian-mcp](https://github.com/Vvkmnn/claude-praetorian-mcp)** - ⭐ 14
   ⚜️ An MCP server for context compaction and recycling in Claude Code

3613. **[servicenow-mcp](https://github.com/aartiq/servicenow-mcp)** - ⭐ 14
...
3614. **[swift-skeleton](https://github.com/1amageek/swift-skeleton)** - ⭐ 14
...
3615. **[arxiv-mcp-server](https://github.com/1Dark134/arxiv-mcp-server)** - ⭐ 14
...
3616. **[mcp-windows-automation](https://github.com/mukul975/mcp-windows-automation)** - ⭐ 14
...
3617. **[memory-visualizer](https://github.com/mjherich/memory-visualizer)** - ⭐ 14
...
3618. **[awesome-mcp-hardware](https://github.com/beriberikix/awesome-mcp-hardware)** - ⭐ 14
   Awesome list of MCP servers for interacting with hardware and the physical world.

3619. **[WAIaaS](https://github.com/minhoyoo-iotrust/WAIaaS)** - ⭐ 14
   Wallet-as-a-Service for all AI agents in the world

3620. **[x402-deploy](https://github.com/nirholas/x402-deploy)** - ⭐ 14
   Turn any API or MCP server into a paid service with x402 

3621. **[ue5-mcp-bridge](https://github.com/Natfii/ue5-mcp-bridge)** - ⭐ 14
   MCP server bridging AI assistants to Unreal Engine 5 editor

3622. **[ai-mate](https://github.com/symfony/ai-mate)** - ⭐ 14
   AI development assistant MCP server for Symfony projects

3623. **[mcp-security-checklist](https://github.com/Helixar-AI/mcp-security-checklist)** - ⭐ 14
...
3624. **[llms-txt-generator](https://github.com/aircodelabs/llms-txt-generator)** - ⭐ 14
   The ultimate AI-powered generator for llms.txt and llms-full.txt files. 

3625. **[mcp-graph-workflow](https://github.com/DiegoNogueiraDev/mcp-graph-workflow)** - ⭐ 14
...
3626. **[MCPScan](https://github.com/sahiloj/MCPScan)** - ⭐ 14
...
3627. **[toolhive-registry-server](https://github.com/stacklok/toolhive-registry-server)** - ⭐ 14
...
3628. **[dsers-mcp-product](https://github.com/lofder/dsers-mcp-product)** - ⭐ 14
...
3632. **[houtini-lm](https://github.com/houtini-ai/houtini-lm)** - ⭐ 14
...
3633. **[amazon-seller-mcp](https://github.com/enginterzi/amazon-seller-mcp)** - ⭐ 14
...
3634. **[nest-mcp](https://github.com/btwld/nest-mcp)** - ⭐ 13
   Build Model Context Protocol (MCP) servers, clients, and gateways using the NestJS ecosystem you already know.

3635. **[spring-ai-mcp-deepseek](https://github.com/firefly0512/spring-ai-mcp-deepseek)** - ⭐ 13
   使用 Spring AI 整合 MCP 服务，包括 MCP server 和 deepseek client

3636. **[llamacppMCPClientDemo](https://github.com/brucepro/llamacppMCPClientDemo)** - ⭐ 13
   standalone react MCP client using SSE

3637. **[sample-multi-tenant-saas-mcp-server](https://github.com/aws-samples/sample-multi-tenant-saas-mcp-server)** - ⭐ 13
   Multi-Tenant remote MCP server with Amazon Cognito and remote client with Amazon Bedrock hosted on AWS

3638. **[mcp-chat-client](https://github.com/Ceeon/mcp-chat-client)** - ⭐ 13
   基于高德地图MCP服务的聊天客户端

3639. **[mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel)** - ⭐ 13
...
3640. **[mcp-more](https://github.com/toosean/mcp-more)** - ⭐ 13
   A modern desktop application for managing Model Context Protocol (MCP) servers.

3641. **[easy-mcp-use](https://github.com/dforel/easy-mcp-use)** - ⭐ 13
...
3642. **[mcphawk](https://github.com/tech4242/mcphawk)** - ⭐ 13
...
3643. **[mcp-test-client](https://github.com/crazyrabbitLTC/mcp-test-client)** - ⭐ 13
   MCP Test Client is a TypeScript testing utility for Model Context Protocol (MCP) servers.

3644. **[mongo-mcp](https://github.com/1RB/mongo-mcp)** - ⭐ 13
   MCP server that provide tools to LLMs such as claude in cursor to interact with MongoDB

3645. **[memory-mcp-server](https://github.com/hpkv-io/memory-mcp-server)** - ⭐ 13
   A MCP (Model Context Protocol) server providing long-term memory for LLMs

3646. **[mcp-web-search-tool](https://github.com/gabrimatic/mcp-web-search-tool)** - ⭐ 13
   A MCP server providing real-time web search capabilities to any AI model.

3647. **[mcp-client-langchain-ts](https://github.com/hideya/mcp-client-langchain-ts)** - ⭐ 13
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / TypeScript

3648. **[prompt-engineer-mcp-server](https://github.com/hireshBrem/prompt-engineer-mcp-server)** - ⭐ 13
   Write 10x better prompts using Prompt Engineer MCP server.

3649. **[google-mcp-remote](https://github.com/vakharwalad23/google-mcp-remote)** - ⭐ 13
   Collection of Google-native tools (e.g., Gmail, Calendar) for the MCP

3650. **[mcp_review_code_tool](https://github.com/wenkil/mcp_review_code_tool)** - ⭐ 13
...
3651. **[sherpa](https://github.com/CartographAI/sherpa)** - ⭐ 13
   Chat with any codebase with MCP servers in a single command

3652. **[codepilot](https://github.com/rohittcodes/codepilot)** - ⭐ 13
   A multi-agent CLI tool powered by Swarms-rs and Composio

3653. **[openwebui-mcp-setup](https://github.com/sonzentherevolution/openwebui-mcp-setup)** - ⭐ 13
...
3654. **[mcp-meme-sticky](https://github.com/nkapila6/mcp-meme-sticky)** - ⭐ 13
...
3655. **[AgentStack](https://github.com/ssdeanx/AgentStack)** - ⭐ 13
...
3662. **[taiga-ui-mcp](https://github.com/taiga-family/taiga-ui-mcp)** - ⭐ 13
   Taiga UI MCP server providing documentation search and scaffolding tools.

3663. **[owl-mcp](https://github.com/ai4curation/owl-mcp)** - ⭐ 13
   MCP server for OWL applications

3664. **[SchemaPin](https://github.com/ThirdKeyAI/SchemaPin)** - ⭐ 13
   The SchemaPin protocol for cryptographically signing and verifying AI agent tool schemas to prevent supply-chain attacks.

3665. **[mcp-delphi](https://github.com/flydev-fr/mcp-delphi)** - ⭐ 13
   Delphi and Lazarus/FPC MCP server: build/clean pascal projects via MCP tools.

3666. **[mcp-server-weather-js](https://github.com/hideya/mcp-server-weather-js)** - ⭐ 13
   Simple Weather MCP Server Example

3667. **[inspector](https://github.com/mcp-use/inspector)** - ⭐ 13
   Modern MCP Inspector for remote mcp servers with support for Apps SDK

3668. **[istek](https://github.com/istekapp/istek)** - ⭐ 13
   The API client built for AI agents. HTTP, GraphQL, gRPC, WebSocket, MQTT + MCP."

3669. **[mcp-server-template](https://github.com/BearHuddleston/mcp-server-template)** - ⭐ 13
   Spec-driven Go MCP server template for building domain MCPs with AI-agent onboarding.

3670. **[ckan-mcp-server](https://github.com/ondics/ckan-mcp-server)** - ⭐ 13
...
3671. **[ia-na-pratica](https://github.com/Code4Delphi/ia-na-pratica)** - ⭐ 13
   IA na Prática: LLM, RAG, MCP, Agents, Function Calling, Multimodal, TTS/STT e mais

3672. **[obsidian-mcp-server](https://github.com/smith-and-web/obsidian-mcp-server)** - ⭐ 13
   MCP server for Obsidian vault management - enables Claude and other AI assistants to read, write, search, and organize your notes

3673. **[llama-nexus](https://github.com/LlamaEdge/llama-nexus)** - ⭐ 13
   A gateway service designed to manage and orchestrate OpenAI-compatible API servers with MCP support.

3674. **[gemma-mcp](https://github.com/monatis/gemma-mcp)** - ⭐ 13
   MCP Client for Gemma-3

3675. **[claude-tools-mcp](https://github.com/mathematic-inc/claude-tools-mcp)** - ⭐ 13
...
3679. **[lm](https://github.com/houtini-ai/lm)** - ⭐ 13
...
3680. **[plumcp](https://github.com/plumce/plumcp)** - ⭐ 13
   Clojure/ClojureScript library for making MCP server and client

3681. **[ProxmoxMCP-advance](https://github.com/Markermav/ProxmoxMCP-advance)** - ⭐ 13
   ProxmoxMCP (advance): MCP for Proxmox integration in Claude, Goose, Cline, any client.

3682. **[opencode-mcp](https://github.com/AlaeddineMessadi/opencode-mcp)** - ⭐ 13
...
3683. **[Tinvo](https://github.com/imxcstar/Tinvo)** - ⭐ 13
   LLM AI Client based on Blazor. (openai, chatgpt, llama, ollama, onnx, deepseekr1...)

3684. **[overleaf-mcp-server](https://github.com/YounesBensafia/overleaf-mcp-server)** - ⭐ 13
...
3685. **[cie](https://github.com/kraklabs/cie)** - ⭐ 13
...
3686. **[claude-faf-mcp](https://github.com/Wolfe-Jam/claude-faf-mcp)** - ⭐ 13
   Anthropic MCP server for .faf — 33 tools, IANA-registered format. npm: claude-faf-mcp. MCP Registry #2759

3687. **[Go-High-Level-MCP-2026-Complete](https://github.com/BusyBee3333/Go-High-Level-MCP-2026-Complete)** - ⭐ 13
...
3688. **[credit-optimizer-v5](https://github.com/rafsilva85/credit-optimizer-v5)** - ⭐ 13
...
3689. **[st_rag_mcp](https://github.com/digital-duck/st_rag_mcp)** - ⭐ 12
   MCP streamlit client with RAG support for tool search

3690. **[n8n-coolify-mcp-tools](https://github.com/wrediam/n8n-coolify-mcp-tools)** - ⭐ 12
...
3695. **[proxy-base-agent](https://github.com/TheProxyCompany/proxy-base-agent)** - ⭐ 12
   A stateful agent with 100% reliable tool use. Build custom agents on any LLM with guaranteed state consistency.

3696. **[create-mcp-server-kit](https://github.com/Epi-1120/create-mcp-server-kit)** - ⭐ 12
   Scaffold a production-ready Model Context Protocol (MCP) server in seconds.

3697. **[MIST](https://github.com/CLoaKY233/MIST)** - ⭐ 12
...
3698. **[PackageFlow](https://github.com/runkids/PackageFlow)** - ⭐ 12
   A visual DevOps hub for npm scripts, Git, workflows, and deploy — controllable by AI via MCP.

3699. **[SQL_MCP_Server](https://github.com/pawankumar94/SQL_MCP_Server)** - ⭐ 12
...
3700. **[nestjs-mcp](https://github.com/orbit-codes/nestjs-mcp)** - ⭐ 12
   An opinionated MCP module for NestJS

3701. **[snowflake-mcp-server](https://github.com/dynamike/snowflake-mcp-server)** - ⭐ 12
   MCP Server for connecting to Snowflake with read-only questions

3702. **[mcp-server-kintone](https://github.com/macrat/mcp-server-kintone)** - ⭐ 12
   MCP server for kintone

3703. **[mcp-server-webscan](https://github.com/bsmi021/mcp-server-webscan)** - ⭐ 12
   A Model Context Protocol (MCP) server for web content scanning and analysis. This server provides tools for fetching, analyzing, and extracting information from web pages.

3704. **[agent-identity-protocol](https://github.com/ArangoGutierrez/agent-identity-protocol)** - ⭐ 12
   Agent Identity Protocol - Zero-trust security layer for AI agents. Policy enforcement proxy for MCP with Human-in-the-Loop approval, DLP scanning, and audit logging.

3705. **[_b00t_](https://github.com/elasticdotventures/_b00t_)** - ⭐ 12
   🥾 _b00t_:  brians dotfiles aka state of the art agentic tooling & context initialization

3706. **[jenkins-mcp-server](https://github.com/AshwiniGhuge3012/jenkins-mcp-server)** - ⭐ 12
...
3707. **[openagentidentityprotocol](https://github.com/openagentidentityprotocol/openagentidentityprotocol)** - ⭐ 12
   Agent Identity Protocol - Zero-trust security layer for AI agents. Policy enforcement proxy for MCP with Human-in-the-Loop approval, DLP scanning, and audit logging.

3708. **[mcp-add](https://github.com/paoloricciuti/mcp-add)** - ⭐ 12
   Universal cli to add an MCP server to a variety of clients

3709. **[cv-resume-builder-mcp](https://github.com/eyaab/cv-resume-builder-mcp)** - ⭐ 12
...
3710. **[MCPGateway](https://github.com/abdullah1854/MCPGateway)** - ⭐ 12
   Open-source MCP server — progressive tool discovery, code execution, intelligent routing & token optimization across 50+ tools

3711. **[mcp-interactive-terminal](https://github.com/amol21p/mcp-interactive-terminal)** - ⭐ 12
...
3712. **[kiro-powers](https://github.com/praveenc/kiro-powers)** - ⭐ 12
   Repository of custom kiro powers. https://kiro.dev/docs/powers/

3713. **[guildbridge](https://github.com/dend/guildbridge)** - ⭐ 12
   🏰 Remotely hosted MCP server for Discord

3714. **[docdex](https://github.com/bekirdag/docdex)** - ⭐ 12
   A document index with MCP, http and client support. https://docdex.org/ 

3715. **[KunAvatar](https://github.com/KunLabAI/KunAvatar)** - ⭐ 12
...
3716. **[porkbun-mcp-server](https://github.com/miraclebakelaser/porkbun-mcp-server)** - ⭐ 12
   MCP server implementation for managing domains, DNS, and SSL via the Porkbun API.

3717. **[local-history-mcp](https://github.com/xxczaki/local-history-mcp)** - ⭐ 12
   MCP server for accessing VS Code/Cursor's Local History

3718. **[claude-context-local](https://github.com/MikeO-AI/claude-context-local)** - ⭐ 12
...
3719. **[biomed-agent](https://github.com/nickzren/biomed-agent)** - ⭐ 12
   Connecting AI agent to biomedical data

3720. **[nodebench-ai](https://github.com/HomenShum/nodebench-ai)** - ⭐ 12
...
3721. **[mcp-for-woocommerce](https://github.com/iOSDevSK/mcp-for-woocommerce)** - ⭐ 12
...
3722. **[asap-protocol](https://github.com/adriannoes/asap-protocol)** - ⭐ 12
...
3723. **[scorable-mcp](https://github.com/root-signals/scorable-mcp)** - ⭐ 12
   MCP for Scorable Evaluation Platform

3724. **[Hoofy](https://github.com/HendryAvila/Hoofy)** - ⭐ 12
...
3725. **[GitLab-CICD-Agent](https://github.com/shalwin04/GitLab-CICD-Agent)** - ⭐ 12
...
3726. **[wamcp](https://github.com/delltrak/wamcp)** - ⭐ 12
...
3727. **[SRE-agent](https://github.com/martinimarcello00/SRE-agent)** - ⭐ 12
...
3728. **[openapi-to-mcp](https://github.com/EvilFreelancer/openapi-to-mcp)** - ⭐ 12
...
3729. **[magento-coding-standard-mcp](https://github.com/Midhun-edv/magento-coding-standard-mcp)** - ⭐ 12
...
3734. **[context-kit](https://github.com/eyalzh/context-kit)** - ⭐ 11
   A CLI tool and MCP client, used to create spec files for AI coding agents with context baked in

3735. **[mcp_client_rust](https://github.com/darinkishore/mcp_client_rust)** - ⭐ 11

3736. **[mcp-client](https://github.com/EuclideanAI/mcp-client)** - ⭐ 11
...
3737. **[MCP_Client](https://github.com/andrewdeng318/MCP_Client)** - ⭐ 11

3738. **[trebuchet](https://github.com/fuzzball-muck/trebuchet)** - ⭐ 11
   A MUD/MUCK/MUSH chat client with MCP/GUI support.

3739. **[systemprompt-mcp-gmail](https://github.com/Ejb503/systemprompt-mcp-gmail)** - ⭐ 11
...
3740. **[mcp-client-app](https://github.com/RegiByte/mcp-client-app)** - ⭐ 11
   A mcp client chat application built for learning purposes

3741. **[mcp-browser-automation](https://github.com/hrmeetsingh/mcp-browser-automation)** - ⭐ 11
   Model Context Protocol based AI Agent that runs a browser from Claude desktop

3742. **[simple-nodejs-mcp-client](https://github.com/sawa-zen/simple-nodejs-mcp-client)** - ⭐ 11
...
3743. **[langchain-mcp-tools-ts-usage](https://github.com/hideya/langchain-mcp-tools-ts-usage)** - ⭐ 11
   MCP Tools Usage From LangChain ReAct Agent / Example in TypeScript

3744. **[mcp-chat-widget](https://github.com/aimdoc-ai/mcp-chat-widget)** - ⭐ 11
...
3745. **[oauth-callback](https://github.com/kriasoft/oauth-callback)** - ⭐ 11
   Lightweight OAuth 2.0 authorization code capture for CLI tools & desktop   apps. Works with Node.js, Deno, Bun. MCP SDK ready.

3746. **[semantictool](https://github.com/promptmesh/semantictool)** - ⭐ 11
   tool management service for performing vector tool calling at scale.

3747. **[mcpconnect](https://github.com/rocket-connect/mcpconnect)** - ⭐ 11
   Inspect and debug Model Context Protocol servers directly in your browser.

3748. **[locust-mcp-server](https://github.com/QAInsights/locust-mcp-server)** - ⭐ 11
   A Model Context Protocol (MCP) server implementation for running Locust load tests. This server enables seamless integration of Locust load testing capabilities with AI-powered development environments.

3749. **[mcp-boilerplate](https://github.com/iamsrikanthnani/mcp-boilerplate)** - ⭐ 11
...
3750. **[emcp](https://github.com/joeymeere/emcp)** - ⭐ 11
   A framework for building simple MCP servers with custom middleware

3751. **[openalgo-mcp](https://github.com/marketcalls/openalgo-mcp)** - ⭐ 11
   Documentation

3752. **[polaris](https://github.com/octu0/polaris)** - ⭐ 11
   Distributed AI Agent Framework

3753. **[glm5-mcp](https://github.com/Arkya-AI/glm5-mcp)** - ⭐ 11
...
3754. **[french-tax-mcp](https://github.com/cornelcroi/french-tax-mcp)** - ⭐ 11
   MCP server for French tax calculations and information - enables AI assistants to provide accurate French tax guidance

3755. **[springboot-ai-mcp-example](https://github.com/duongminhhieu/springboot-ai-mcp-example)** - ⭐ 11
   Example Spring AI Model Context Protocol (MCP)

3756. **[mcp-space](https://github.com/tharuneshwar-s/mcp-space)** - ⭐ 11
...
3757. **[druid-mcp-server](https://github.com/iunera/druid-mcp-server)** - ⭐ 11
...
3758. **[mcp-client-langchain-py](https://github.com/hideya/mcp-client-langchain-py)** - ⭐ 11
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / Python

3759. **[mcpkit](https://github.com/cybertheory/mcpkit)** - ⭐ 11
   Easy to use Official MCP Registry Client UI. npx @cybertheory/mcpkit

3760. **[robotmcp_client](https://github.com/robotmcp/robotmcp_client)** - ⭐ 11
   Connect AI models like Claude & GPT with robots using MCP and ROS.

3761. **[prometheus-protocol](https://github.com/prometheus-protocol/prometheus-protocol)** - ⭐ 11
...
3768. **[chromadb-remote-mcp](https://github.com/meloncafe/chromadb-remote-mcp)** - ⭐ 11
   Remote MCP server for ChromaDB

3769. **[msty-admin-mcp](https://github.com/M-Pineapple/msty-admin-mcp)** - ⭐ 11
...
3770. **[miro-mcp-server](https://github.com/olgasafonova/miro-mcp-server)** - ⭐ 11
   MCP server for controlling Miro whiteboards with AI assistants

3771. **[qurio](https://github.com/irahardianto/qurio)** - ⭐ 11
...
3772. **[mendeley-mcp](https://github.com/pallaprolus/mendeley-mcp)** - ⭐ 11
...
3781. **[mcp-wikipedia](https://github.com/algonacci/mcp-wikipedia)** - ⭐ 10
   MCP server to give client the ability to access Wikipedia pages

3782. **[taskboard](https://github.com/tcarac/taskboard)** - ⭐ 10
...
3783. **[langchain-mcp-client](https://github.com/datalayer/langchain-mcp-client)** - ⭐ 10
   🦜🔗 LangChain Model Context Protocol (MCP) Client

3784. **[mcp_client_openai](https://github.com/liangpn/mcp_client_openai)** - ⭐ 10
   适配Openai SDK构建MCP Client

3785. **[mcp-serverman](https://github.com/benhaotang/mcp-serverman)** - ⭐ 10
   a cli/mcp server tool for managing mcp server json config file with version control, profiles and multi-client support

3786. **[py-mcp-sse](https://github.com/jayliangdl/py-mcp-sse)** - ⭐ 10
   MCP Client 与 MCP Server基于SSE方式的样例实现（Python版本）

3787. **[AIFoundry-MCPConnector-FabricGraphQL](https://github.com/LazaUK/AIFoundry-MCPConnector-FabricGraphQL)** - ⭐ 10
...
3788. **[kanboard-mcp](https://github.com/ChristianJStarr/kanboard-mcp)** - ⭐ 10
...
3789. **[emotion_ai](https://github.com/angrysky56/emotion_ai)** - ⭐ 10
...
3790. **[mcp-trace](https://github.com/zabirauf/mcp-trace)** - ⭐ 10
   A TUI to probe the calls between MCP client and server

3791. **[mcp-server-blog](https://github.com/portal-labs-infrastructure/mcp-server-blog)** - ⭐ 10
   Example of a MCP implementation using TypeScript and OAuth.

3792. **[mcp-agent-proxy](https://github.com/mashh-lab/mcp-agent-proxy)** - ⭐ 10
   An MCP server that exposes local and remote agents across different servers as MCP tools.

3793. **[mcp-kit](https://github.com/shaharia-lab/mcp-kit)** - ⭐ 10
   MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

3794. **[CodeCompass](https://github.com/alvinveroy/CodeCompass)** - ⭐ 10
...
3795. **[mode-manager-mcp](https://github.com/NiclasOlofsson/mode-manager-mcp)** - ⭐ 10
   MCP Memory Agent Server - A VS Code chatmode and instruction manager with library integration

3796. **[mcp-reporter](https://github.com/cyanheads/mcp-reporter)** - ⭐ 10
...
3797. **[mcp-starter-template-ts](https://github.com/onamfc/mcp-starter-template-ts)** - ⭐ 10
...
3798. **[rec-us-mcp-server](https://github.com/elizabethsiegle/rec-us-mcp-server)** - ⭐ 10
   Book a San Francisco tennis court via MCP server w/ auth

3799. **[mcp-demo](https://github.com/sshh12/mcp-demo)** - ⭐ 10
...
3800. **[AgentX-mcp-servers](https://github.com/AgentX-ai/AgentX-mcp-servers)** - ⭐ 10
   List of open sourced MCP servers. MIT license. Managed by AgentX with love.

3801. **[mcp-tradovate](https://github.com/0xjmp/mcp-tradovate)** - ⭐ 10
   MCP server for the Tradovate platform

3802. **[mcp-claude-hackernews](https://github.com/imprvhub/mcp-claude-hackernews)** - ⭐ 10
   An integration that allows Claude Desktop to interact with Hacker News using the Model Context Protocol (MCP).

3803. **[glasses-mcp](https://github.com/gourraguis/glasses-mcp)** - ⭐ 10
   Glasses MCP is a simple MCP server that lets your AI agent see and capture the web 👓

3804. **[ObsidianMCPServer](https://github.com/otaviocc/ObsidianMCPServer)** - ⭐ 10
   A Model Context Protocol (MCP) server that enables AI assistants to interact with your Obsidian vault 

3805. **[mcp-sys-bridge](https://github.com/leynier/mcp-sys-bridge)** - ⭐ 10
...
3806. **[sec-edgar-agentkit](https://github.com/stefanoamorelli/sec-edgar-agentkit)** - ⭐ 10
...
3807. **[context-engineering-mcp](https://github.com/bralca/context-engineering-mcp)** - ⭐ 10
...
3808. **[mcp-sqlite-server](https://github.com/prayanks/mcp-sqlite-server)** - ⭐ 10
...
3809. **[mcp-go](https://github.com/XiaoConstantine/mcp-go)** - ⭐ 10
   Golang impl of mcp protocol

3810. **[mcpet](https://github.com/shreyaskarnik/mcpet)** - ⭐ 10
...
3811. **[miniflux-mcp](https://github.com/tssujt/miniflux-mcp)** - ⭐ 10
   A Model Context Protocol (MCP) server for interacting with Miniflux RSS reader.

3812. **[mcp-spring-ai-mcp-client](https://github.com/chaozai0304/mcp-spring-ai-mcp-client)** - ⭐ 10
   使用java实现mcp client了解底层的调用机制，demo示例

3813. **[mcp-optimizer](https://github.com/StacklokLabs/mcp-optimizer)** - ⭐ 10
   MCP server that acts as an intelligent intermediary between AI clients and multiple MCP servers

3814. **[awesome-mcp](https://github.com/timunbasah3/awesome-mcp)** - ⭐ 10
...
3815. **[Simple_MCP_Client](https://github.com/Avento/Simple_MCP_Client)** - ⭐ 10
   Simple MCP Client for OpenAI/Deepseek R1/V3

3816. **[awesome-mcp](https://github.com/gauravfs-14/awesome-mcp)** - ⭐ 10
...
3817. **[openapi-mcp-swagger](https://github.com/salacoste/openapi-mcp-swagger)** - ⭐ 10
...
3818. **[mcp-chaos-rig](https://github.com/Typewise/mcp-chaos-rig)** - ⭐ 10
...
3824. **[Azure-Foundry-Webinar](https://github.com/ShivamGoyal03/Azure-Foundry-Webinar)** - ⭐ 10
...
3825. **[Cognio](https://github.com/0xReLogic/Cognio)** - ⭐ 10
...
3826. **[bruno-mcp](https://github.com/macarthy/bruno-mcp)** - ⭐ 10
...
3827. **[systemprompt-template](https://github.com/systempromptio/systemprompt-template)** - ⭐ 10
   Production AI agent mesh in 3 commands. MCP servers, playbooks, and multi-agent orchestration built on systemprompt-core.

3828. **[cheatengine-mcp-bridge](https://github.com/beamstar/cheatengine-mcp-bridge)** - ⭐ 10
   🔗 Connect AI to Cheat Engine for fast memory analysis, enabling quick mods and audits without the tedious manual work.

3829. **[toolhive-cloud-ui](https://github.com/stacklok/toolhive-cloud-ui)** - ⭐ 10
...
3830. **[Rube](https://github.com/dorucioclea/Rube)** - ⭐ 10
   Rube is a Model Context Protocol (MCP) server that connects your AI tools to 500+ apps like Gmail, Slack, GitHub, and Notion. Simply install it in your AI client, authenticate once with your apps, and start asking your AI to perform real actions like "Send an email" or "Create a task."

3831. **[keycloak-mcp](https://github.com/HaithamOumerzoug/keycloak-mcp)** - ⭐ 10
...
3832. **[mcpd](https://github.com/pouriya/mcpd)** - ⭐ 10
   A ~3MB MCP daemon that exposes any script as a tool for Claude, Cursor & AI assistants

3833. **[whatsapp-mcp-extended](https://github.com/FelixIsaac/whatsapp-mcp-extended)** - ⭐ 10
...
3834. **[chessmata](https://github.com/jonradoff/chessmata)** - ⭐ 10
   Chessmata: chess game for humans and AI agents

3835. **[storybook-mcp-server](https://github.com/stefanoamorelli/storybook-mcp-server)** - ⭐ 10
...
3836. **[dbt-core-mcp](https://github.com/NiclasOlofsson/dbt-core-mcp)** - ⭐ 10
   dbt Core MCP Server: Interact with dbt projects via Model Context Protocol

3837. **[chatgpt2md](https://github.com/NextStat/chatgpt2md)** - ⭐ 10
   Convert ChatGPT export to Markdown with full-text search and MCP server for Claude

3838. **[mini_claude](https://github.com/20alexl/mini_claude)** - ⭐ 10
...
3839. **[statelessagent](https://github.com/sgx-labs/statelessagent)** - ⭐ 10
   Your AI forgets everything between sessions. SAME fixes that. Local-first, no API keys, single binary.

3840. **[MCP-Penetration-testing](https://github.com/Mr-Infect/MCP-Penetration-testing)** - ⭐ 10
...
3841. **[caltrain-mcp](https://github.com/davidyen1124/caltrain-mcp)** - ⭐ 10
...
3842. **[shellguard](https://github.com/fawdyinc/shellguard)** - ⭐ 10
   MCP server that gives LLM agents read-only shell access over SSH

3843. **[PsMCP-MCP-Server-for-Photoshop](https://github.com/Chandrahas455/PsMCP-MCP-Server-for-Photoshop)** - ⭐ 10
...
3844. **[ollama-mcp-example](https://github.com/kirillsaidov/ollama-mcp-example)** - ⭐ 10
   Ollama MCP example for dummies. 

3845. **[civitai-mcp-server](https://github.com/Cicatriiz/civitai-mcp-server)** - ⭐ 10
   A Model Context Protocol server for browsing and discovering AI models on Civitai

3846. **[openapi-to-mcp](https://github.com/agentic-community/openapi-to-mcp)** - ⭐ 10
...
3847. **[world-intel-mcp](https://github.com/marc-shade/world-intel-mcp)** - ⭐ 10
...
3848. **[ILSpy-Mcp](https://github.com/bivex/ILSpy-Mcp)** - ⭐ 10
...
3849. **[aichat](https://github.com/Hayashi-Yudai/aichat)** - ⭐ 10
   A customizable AI chat application powered by Flet.

3850. **[mcp-document-converter](https://github.com/xt765/mcp-document-converter)** - ⭐ 10
...
3851. **[pentest-mcp-server](https://github.com/exjskdjsdfks/pentest-mcp-server)** - ⭐ 10
...
3852. **[mcpHTTPClient](https://github.com/matlab-deep-learning/mcpHTTPClient)** - ⭐ 10
   An MCP client in pure MATLAB code

3853. **[XcodeMCPKit](https://github.com/lynnswap/XcodeMCPKit)** - ⭐ 10
   Xcode MCP proxy with multi-client sessions

3854. **[DevoChat](https://github.com/gws8820/DevoChat)** - ⭐ 10
   Unified Web AI Chat UI & MCP Client

3855. **[agent-trace](https://github.com/Siddhant-K-code/agent-trace)** - ⭐ 10
...
1. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 43,987
   :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more. Features: Generate Text, MCP, Audio, Video, Images, Voice Cloning, Distributed, P2P and decentralized inference

2. **[chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)** - ⭐ 42,289
...
3. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 9,674
   ValueCell is a community-driven, multi-agent platform for financial applications.

4. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,598
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

5. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 4,947
...
6. **[koog](https://github.com/JetBrains/koog)** - ⭐ 3,842
...
7. **[shippie](https://github.com/mattzcarey/shippie)** - ⭐ 2,340
   extendable code review and QA agent 🚢

8. **[open-mcp-client](https://github.com/CopilotKit/open-mcp-client)** - ⭐ 1,644

9. **[supermemory-mcp](https://github.com/supermemoryai/supermemory-mcp)** - ⭐ 1,633
   Your memories are in ChatGPT... But nowhere else. Universal Memory MCP makes your memories available to every single LLM. No logins or paywall. One command to set it up.

10. **[openinference](https://github.com/Arize-ai/openinference)** - ⭐ 891
   OpenTelemetry Instrumentation for AI Observability

11. **[ragent](https://github.com/nageoffer/ragent)** - ⭐ 886
   企业级 Agentic RAG 智能体 - 全链路覆盖文档解析、多路检索、意图识别、问题重写、会话记忆、MCP 工具调用与深度思考。面向真实业务场景，从 0 到 1 完整工程实现。

12. **[onecli](https://github.com/onecli/onecli)** - ⭐ 844
   Open-source credential vault, give your AI agents access to services without exposing keys.

13. **[VectorCode](https://github.com/Davidyz/VectorCode)** - ⭐ 828
...
17. **[fleur](https://github.com/fleuristes/fleur)** - ⭐ 534
   The easiest way to discover and install MCPs

18. **[a2a-x402](https://github.com/google-agentic-commerce/a2a-x402)** - ⭐ 474
...
20. **[pwno-mcp](https://github.com/pwno-io/pwno-mcp)** - ⭐ 237
   MCP for Pwn
...
23. **[ai](https://github.com/WordPress/ai)** - ⭐ 159
   AI features and experiments for WordPress. Modular framework for testing AI capabilities.

24. **[terminal-ai](https://github.com/dwmkerr/terminal-ai)** - ⭐ 156
...
35. **[deepsecure](https://github.com/DeepTrail/deepsecure)** - ⭐ 44
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 179,908
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 42,993
   🦍 The API and AI Gateway

3. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 38,788
   Query Engine for AI Analytics: Build self-reasoning agents across all your live data

4. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 27,424
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

5. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,535
   Your ultimate Go microservices framework for the cloud-native era.

6. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,403
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

7. **[plate](https://github.com/udecode/plate)** - ⭐ 16,046
...
10. **[kubeshark](https://github.com/kubeshark/kubeshark)** - ⭐ 11,828
...
11. **[ui](https://github.com/creativetimofficial/ui)** - ⭐ 11,767
   Open-source components, blocks, and AI agents designed to speed up your workflow. Import them seamlessly into your favorite tools through Registry and MCPs.

12. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 11,183
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

13. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 11,090
   A cross-platform Markdown AI note-taking software.

14. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 10,369
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

15. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 9,018
...
16. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 8,960
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

17. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,816
   Agent Framework For Fintech and Banks

18. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,671
    The most powerful Android RPA agent framework, next generation of mobile automation robots.

19. **[adk-go](https://github.com/google/adk-go)** - ⭐ 7,194
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

20. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 5,002
   Adversary simulation and Red teaming platform with AI

21. **[Yuxi-Know](https://github.com/xerrors/Yuxi-Know)** - ⭐ 4,598
...
22. **[magic](https://github.com/dtyq/magic)** - ⭐ 4,493
   Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)

23. **[nexent](https://github.com/ModelEngine-Group/nexent)** - ⭐ 4,331
...
24. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,283
   AG2 (formerly AutoGen): The Open-Source AgentOS.Join us at: https://discord.gg/sNGSwQME3x

25. **[ENScan_GO](https://github.com/wgpsec/ENScan_GO)** - ⭐ 4,257
   一款基于各大企业信息API的工具，解决在遇到的各种针对国内企业信息收集难题。一键收集控股公司ICP备案、APP、小程序、微信公众号等信息聚合导出。支持MCP接入

26. **[kubefwd](https://github.com/txn2/kubefwd)** - ⭐ 4,066
   Bulk port forwarding Kubernetes services for local development.

27. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 3,457
...
29. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,755
   A highly opinionated, zero-configuration linter and formatter.

30. **[solon](https://github.com/opensolon/solon)** - ⭐ 2,711
...
31. **[harbor](https://github.com/av/harbor)** - ⭐ 2,510
   One command brings a complete pre-wired LLM stack with hundreds of services to explore.

32. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 2,123
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

33. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,916
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

34. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,726
   Plugin for IntelliJ IDEA that gives special support for Minecraft modding projects.

35. **[Klee](https://github.com/signerlabs/Klee)** - ⭐ 1,713
   A native macOS AI chat app powered by MLX. 100% local inference on Apple Silicon, no cloud required. Built with ShipSwift.

36. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,597
   D2X | Modern C++ Core Language Features - "A C++ tutorial project focused on practical"

37. **[MultiAgentPPT](https://github.com/johnson7788/MultiAgentPPT)** - ⭐ 1,505
...
38. **[mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest)** - ⭐ 1,475
   The main repository for the Linux and Mac OS Bedrock edition Minecraft launcher.

39. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,413
...
42. **[awesome-hacking-lists](https://github.com/taielab/awesome-hacking-lists)** - ⭐ 1,301
...
44. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,205
   基于AI的工作效率提升工具（聊天、绘画、知识库、工作流、 MCP服务市场、语音输入输出、长期记忆） | Ai-based productivity tools (Chat,Draw,RAG,Workflow,MCP marketplace, ASR,TTS, Long-term memory etc)

45. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,145
   Build, evaluate and train General Multi-Agent Assistance with ease

46. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 1,139
   Local first codebase intelligence

47. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 1,127
   Korea Investment & Securities Open API Github

48. **[any-agent](https://github.com/mozilla-ai/any-agent)** - ⭐ 1,119
   A single interface to use and evaluate different agent frameworks 

49. **[Gearboy](https://github.com/drhelius/Gearboy)** - ⭐ 1,091
   Game Boy / Gameboy Color emulator and debugger for macOS, Windows, Linux, BSD and RetroArch.

50. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 1,065
   Selfhosted notes app. Single golang binary, notes stored as markdown within SQLite, full-text search, very low resource usage

51. **[openops](https://github.com/openops-cloud/openops)** - ⭐ 1,008
   The batteries-included, No-Code FinOps automation platform, with the AI you trust.

52. **[arduino-mcp2515](https://github.com/autowp/arduino-mcp2515)** - ⭐ 974
   Arduino MCP2515 CAN interface library

53. **[rulesync](https://github.com/dyoshikawa/rulesync)** - ⭐ 907
   A Utility CLI for AI Coding Agents

54. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 899
   Natural (2-way) voice conversations with Claude Code

55. **[cursor2api-go](https://github.com/libaxuan/cursor2api-go)** - ⭐ 893
   Free claude-sonnet-4.6  | cursor不倒我不倒🙏 ❌ 不支持 tools / function calling / MCP

56. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 870
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

57. **[DataDesigner](https://github.com/NVIDIA-NeMo/DataDesigner)** - ⭐ 853
   🎨 NeMo Data Designer: A general library for generating high-quality synthetic data from scratch or based on seed data.

58. **[claude-chatgpt-mcp](https://github.com/syedazharmbnr1/claude-chatgpt-mcp)** - ⭐ 774
   A Claude MCP tool to interact with the ChatGPT desktop app on macOS

59. **[weave](https://github.com/Ataraxy-Labs/weave)** - ⭐ 748
...
60. **[aderyn](https://github.com/Cyfrin/aderyn)** - ⭐ 741
   Solidity Static Analyzer that easily integrates into your editor

61. **[bytechef](https://github.com/bytechefhq/bytechef)** - ⭐ 739
...
62. **[MCPELauncher](https://github.com/zhuowei/MCPELauncher)** - ⭐ 733
   Source code for BlockLauncher, a launcher that patches Minecraft for Android

63. **[WHartTest](https://github.com/MGdaasLab/WHartTest)** - ⭐ 722
...
64. **[LightAgent](https://github.com/wanxingai/LightAgent)** - ⭐ 710
...
65. **[JiwuChat](https://github.com/KiWi233333/JiwuChat)** - ⭐ 708
   JiwuChat 🍂 : 轻量级跨平台IM聊天应用，集成AI机器人( DeepSeek/Gemini/Kimi... )、音视频通话及AI购物。支持多端消息同步，自定义主题，高效便捷  🍒

66. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 697
   原 [chatlog]项目（一个微信数据库读取及提供mcp服务开源软件）的二次开发，会尽可能同步最新开源解密源码

67. **[Sentient](https://github.com/existence-master/Sentient)** - ⭐ 677
   A personal AI assistant for everyone

68. **[infio-copilot](https://github.com/infiolab/infio-copilot)** - ⭐ 648
   A Cursor-inspired AI assistant for Obsidian that offers smart autocomplete and interactive chat with your selected notes

69. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 634
...
70. **[cloudsword](https://github.com/wgpsec/cloudsword)** - ⭐ 598
   一款帮助云租户发现和测试云上风险、增强云上防护能力的综合性开源工具

71. **[tool-ui](https://github.com/assistant-ui/tool-ui)** - ⭐ 586
   UI components for AI interfaces

72. **[auto-commenter](https://github.com/rokpiy/auto-commenter)** - ⭐ 543
   A Claude skill that automatically posts personalized, authentic comments in your target communities.

73. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 542
...
74. **[marmot](https://github.com/marmotdata/marmot)** - ⭐ 525
...
75. **[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)** - ⭐ 490
...
76. **[browser-operator-core](https://github.com/BrowserOperator/browser-operator-core)** - ⭐ 470
   Browser Operator - The AI browser with built in Multi-Agent platform! Open source alternative to ChatGPT Atlas, Perplexity Comet, Dia and Microsoft CoPilot Edge Browser

77. **[AIWriteX](https://github.com/iniwap/AIWriteX)** - ⭐ 465
   AIWriteX是基于CrewAI、AIForge的新一代智能内容创作平台，从微信公众号自动化工具起步，正在重新定义AI辅助内容创作的边界，融合"AI+创意+搜索+借鉴"四重能力，多种超绝玩法，内容创作充满无限可能。

78. **[LightAgent](https://github.com/wxai-space/LightAgent)** - ⭐ 430
   LightAgent: Lightweight AI agent framework with memory, tools & tree-of-thought. Supports multi-agent collaboration, self-learning, and major LLMs (OpenAI/DeepSeek/Qwen). Open-source with MCP/SSE protocol integration.

79. **[ChattyPlay-Agent](https://github.com/P1kaj1uu/ChattyPlay-Agent)** - ⭐ 425
   🚀 告别多个App！本项目基于React+TypeScript+Hono+SQLite3+Python，打造“All in One”智能工具集。免会员破解爱奇艺、腾讯视频、优酷、抖音、B站、小红书等20+平台视频，支持4K在线解析与无水印高速下载。集成Google、GitHub授权登录及OpenAI SDK、MCP服务和Agent，支持ChatGPT对话、AI绘画、论文降重、Hugging Face论文爬取；更有实时黄金K线、AI思维导图、闲鱼助手等效率黑科技。内置海量动漫漫画资源，畅享阅读！轻量高效，配置即用，完美适配PC与移动端，快来ChattyPlay开启奇妙之旅吧～✨

80. **[mcp-cn-a-stock](https://github.com/elsejj/mcp-cn-a-stock)** - ⭐ 423
   这是一个为大模型提供 A 股数据的的 MCP(Model Content Protocol) 服务。

81. **[vocotype-cli](https://github.com/233stone/vocotype-cli)** - ⭐ 402
   VocoType 是一款运行在本地端侧的隐私安全语音输入工具，通过快捷键即可将语音实时转换为文字并自动输入到当前应用。支持语音转文字MCP、AI 优化文本、自定义替换词典、录音视频转文字等功能，让语音输入更高效、更安全。

82. **[groundhog](https://github.com/ghuntley/groundhog)** - ⭐ 399
   Groundhog's primary purpose is to teach people how Cursor and all these other coding agents work under the hood. If you understand how these coding assistants work from first principles, then you can drive these tools harder (or perhaps make your own!).

83. **[bridle](https://github.com/neiii/bridle)** - ⭐ 396
   TUI / CLI config manager for agentic harnesses (Amp, Claude Code, Opencode, Goose, Copilot CLI, Crush, Droid)

84. **[mcpi](https://github.com/martinohanlon/mcpi)** - ⭐ 390
   Minecraft: Pi Edition API Python Library

85. **[volcano-agent-sdk](https://github.com/Kong/volcano-agent-sdk)** - ⭐ 389
   🌋 Build AI agents that seamlessly combine LLM reasoning with real-world actions via MCP tools — in just a few lines of TypeScript.

86. **[volcano-sdk](https://github.com/Kong/volcano-sdk)** - ⭐ 386
   🌋 Build AI agents that seamlessly combine LLM reasoning with real-world actions via MCP tools — in just a few lines of TypeScript.

87. **[CookHero](https://github.com/Decade-qiu/CookHero)** - ⭐ 383
...
88. **[azan-mcp](https://github.com/ahmedeltaher/azan-mcp)** - ⭐ 382
...
89. **[pokemon-chat](https://github.com/skygazer42/pokemon-chat)** - ⭐ 377
   基于 LightRAG、LangGraph、MCP、RagFlow、微调LLMs宝可梦主题的智能聊天助手

90. **[Adafruit-MCP23017-Arduino-Library](https://github.com/adafruit/Adafruit-MCP23017-Arduino-Library)** - ⭐ 376
   Arduino Library for Adafruit MCP23017

91. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 373
   MCP for Unreal Engine 5

92. **[graphrag-toolkit](https://github.com/awslabs/graphrag-toolkit)** - ⭐ 366
   Python toolkit for building graph-enhanced GenAI applications

93. **[MCprep](https://github.com/Moo-Ack-Productions/MCprep)** - ⭐ 349
   Blender python addon to increase workflow for creating minecraft renders and animations

94. **[exograph](https://github.com/exograph/exograph)** - ⭐ 345
   Build production-ready backends in minutes

95. **[depyler](https://github.com/paiml/depyler)** - ⭐ 340
   Compiles Python to Rust, helping transition off of Python to Energy Efficient and Safe Rust Code

96. **[codeg](https://github.com/xintaofei/codeg)** - ⭐ 336
...
97. **[eechat](https://github.com/Lucassssss/eechat)** - ⭐ 335
   🚀 Powerful Local AI Chat Application - Mcp, Secure, Efficient, Personalized 本地化部署的大模型客户端

98. **[MCPanelViewController](https://github.com/matthewcheok/MCPanelViewController)** - ⭐ 319
   Drop-in panel control for iOS with blurring background and screen-edge activation gestures.

99. **[news-agents](https://github.com/eugeneyan/news-agents)** - ⭐ 313
   📰 Building News Agents to Summarize News with MCP, Q, and tmux

100. **[awesome-slash](https://github.com/avifenesh/awesome-slash)** - ⭐ 312
   AI writes code. This automates everything else. 9 plugins · 39 agents · 24 skills · for Claude Code, OpenCode, Codex.

101. **[building-an-agentic-system](https://github.com/gerred/building-an-agentic-system)** - ⭐ 298
   An in-depth book and reference on building agentic systems like Claude Code

102. **[napi](https://github.com/nanoapi-io/napi)** - ⭐ 296
   Software architecture tooling for the AI age

103. **[ai4eh](https://github.com/ethiack/ai4eh)** - ⭐ 279
   AI for Ethical Hacking - Workshop

104. **[MCPDict](https://github.com/MaigoAkisame/MCPDict)** - ⭐ 259
   Android App: 漢字古今中外讀音查詢

105. **[genie](https://github.com/automagik-dev/genie)** - ⭐ 257
   Wishes in, PRs out. CLI agent that interviews you, plans the work, dispatches parallel agents in isolated worktrees, and reviews code before you see it.

106. **[x-mcp](https://github.com/xpzouying/x-mcp)** - ⭐ 249
   小红书创作中心

107. **[edumcp](https://github.com/aieducations/edumcp)** - ⭐ 246
   EDUMCP is a protocol that integrates the Model Context Protocol (MCP) with applications in the education field, dedicated to achieving seamless interconnection and interoperability among different AI models, educational applications, smart hardware, and teaching AGENTs.

108. **[agentica](https://github.com/shibing624/agentica)** - ⭐ 246
   Agentica: Lightweight async-first Python framework for AI agents. 轻量级异步优先的AI Agent框架，支持工具调用、RAG、多智能体和MCP。

109. **[MCP-Defender](https://github.com/MCP-Defender/MCP-Defender)** - ⭐ 245
   Desktop app that automatically scans and blocks malicious MCP traffic in AI apps like Cursor, Claude, VS Code and Windsurf.

110. **[MCPMappingViewer](https://github.com/bspkrs/MCPMappingViewer)** - ⭐ 244
   A small GUI for viewing the mappings from Minecraft obfuscated code names to MCP code names.

111. **[MCPConfig](https://github.com/MinecraftForge/MCPConfig)** - ⭐ 240
   Public facing repo for MCP SRG mappings.

112. **[Weave](https://github.com/liaotxcn/Weave)** - ⭐ 237
...
124. **[mcpat](https://github.com/HewlettPackard/mcpat)** - ⭐ 209
   An integrated power, area, and timing modeling framework for multicore and manycore architectures

125. **[agentic-ai-systems](https://github.com/ThibautMelen/agentic-ai-systems)** - ⭐ 203
   🐔 Agentic systems explained with chickens. Workflows, agents & orchestration made simple. Mermaid diagrams included

126. **[BaseLayer](https://github.com/zwgnr/BaseLayer)** - ⭐ 202
   Re-usable multi part components built on React Aria and TailwindCSS. 

127. **[ATaC](https://github.com/ATaC-team/ATaC)** - ⭐ 197
   Recording and Replay AI Agent Trajectory.

128. **[machi](https://github.com/qntx/machi)** - ⭐ 194
   A Web4.0-native AI Agent Framework.

129. **[LAP](https://github.com/Lap-Platform/LAP)** - ⭐ 193
...
130. **[MCP-919](https://github.com/Marcelektro/MCP-919)** - ⭐ 190
   Fully working & decompiled MCP for Minecraft 1.8.9 

131. **[MCPScan](https://github.com/antgroup/MCPScan)** - ⭐ 189

132. **[codecompanion-history.nvim](https://github.com/ravitemer/codecompanion-history.nvim)** - ⭐ 175
   A history management extension for codecompanion AI chat plugin that enables saving, browsing and restoring chat sessions.

133. **[bluebox-sdk](https://github.com/VectorlyApp/bluebox-sdk)** - ⭐ 169
   Reverse engineer web apps

134. **[ZenOps](https://github.com/opsre/ZenOps)** - ⭐ 157
   🧘 通过钉钉、飞书、企微智能机器人用自然语言查询运维资源的工具。

135. **[selene](https://github.com/tercumantanumut/selene)** - ⭐ 151
...
136. **[mcp-audit](https://github.com/apisec-inc/mcp-audit)** - ⭐ 144
   See what your AI agents can access. Scan MCP configs for exposed secrets, shadow APIs, and AI models. Generate AI-BOMs for compliance.

137. **[seline](https://github.com/tercumantanumut/seline)** - ⭐ 143
...
138. **[toon-java](https://github.com/toon-format/toon-java)** - ⭐ 140
   ☕ Community-driven Java implementation of TOON

139. **[rocketship](https://github.com/rocketship-ai/rocketship)** - ⭐ 140
   A QA testing framework for your coding agent.

140. **[mcp-toolkit](https://github.com/charIesding/mcp-toolkit)** - ⭐ 137
   utilities for mcp

141. **[awesome-ai-repositories](https://github.com/altengineer/awesome-ai-repositories)** - ⭐ 127
   A curated list of open source repositories for AI Engineers

142. **[claude-ipc-mcp](https://github.com/jdez427/claude-ipc-mcp)** - ⭐ 127
   AI-to-AI communication protocol for Claude, Gemini, and other AI assistants

143. **[Z.ai2api](https://github.com/hmjz100/Z.ai2api)** - ⭐ 127
...
144. **[how-to-vibecoding](https://github.com/1EchA/how-to-vibecoding)** - ⭐ 124
   Vibecoding 系列教程：从环境搭建到多智能体协作，涵盖 MCP、Skills、Agent 分工治理

145. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/sdivyanshu90/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 119
   5-Day Gen AI Intensive Course with Google

146. **[STAMP](https://github.com/KatherLab/STAMP)** - ⭐ 115
   Solid Tumor Associative Modeling in Pathology

147. **[AgentNexus](https://github.com/wozhenbang2004/AgentNexus)** - ⭐ 114
   Multi-Agent,MCP,RAG,SpringAI1.0.0,RE-ACT

148. **[AgentFly](https://github.com/Agent-One-Lab/AgentFly)** - ⭐ 111
   Scalable and extensible reinforcement learning for LM agents.

149. **[mcp-in-action](https://github.com/huangjia2019/mcp-in-action)** - ⭐ 111
   极客时间MCP新课已经上线！超2000同学一起开启MCP学习之旅！

150. **[Gearcoleco](https://github.com/drhelius/Gearcoleco)** - ⭐ 110
   ColecoVision emulator and debugger for macOS, Windows, Linux, BSD and RetroArch.

151. **[protocol-launcher](https://github.com/zhensherlock/protocol-launcher)** - ⭐ 110
   One-click launch URL generator for protocol-based apps

152. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/anxiong2025/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 109
   谷歌5天AI Agents强化课程

153. **[kalouk-mcp](https://github.com/fabianabarca/kalouk-mcp)** - ⭐ 106
   Servidor de contexto de Kalouk para agentes de inteligencia artificial.

154. **[coplay-unity-plugin](https://github.com/CoplayDev/coplay-unity-plugin)** - ⭐ 101
   Unity plugin for Coplay

155. **[Squirrel](https://github.com/hakoniwaa/Squirrel)** - ⭐ 92
   ai memory for coding

156. **[Complementarity.jl](https://github.com/chkwon/Complementarity.jl)** - ⭐ 79
   provides a modeling interface for mixed complementarity problems (MCP) and math programs with equilibrium problems (MPEC) via JuMP 

157. **[smart-customer-service-system](https://github.com/traveler-leon/smart-customer-service-system)** - ⭐ 78
   构建一个基于大模型的智能客服系统，可提供静态知识问答(静态数据)、动态知识问答（数据库），业务办理（api调用）等功能，同时系统具有自我学习能力。定期的反思可让系统变得更强大。

158. **[open-skills](https://github.com/besoeasy/open-skills)** - ⭐ 78
   Battle-tested skill library for AI agents. Save 98% of API costs with ready-to-use code for crypto, PDFs, search, web scraping & more. No trial-and-error, no expensive APIs.

159. **[nvim-gemini-companion](https://github.com/gutsavgupta/nvim-gemini-companion)** - ⭐ 77
   A Neovim plugin to integrate Gemini CLI well (+ Qwen-code now)

160. **[TensorBlock-Studio](https://github.com/TensorBlock/TensorBlock-Studio)** - ⭐ 76
   A lightweight, open, and extensible multi-LLM interaction studio.

161. **[quarkus-workshop-langchain4j](https://github.com/quarkusio/quarkus-workshop-langchain4j)** - ⭐ 75
   Quarkus Langchain4J Workshop

162. **[onemcp-hub](https://github.com/ipenywis/onemcp-hub)** - ⭐ 74
   OneMCP feature requests, bugs and improvements 

163. **[lycoris](https://github.com/solaoi/lycoris)** - ⭐ 73
...
180. **[xiaozhi-MCPTools](https://github.com/ZhongZiTongXue/xiaozhi-MCPTools)** - ⭐ 35
   一个图形化界面的小智MCP服务连接器，包含多种工具！ 自动部署服务，方便小白给小智Ai添加MCP工具

181. **[advanced-reason-mcp](https://github.com/Kuon-dev/advanced-reason-mcp)** - ⭐ 33
   Enhanced version of "Sequential Thinking" MCP

182. **[zentrun](https://github.com/andrewsky-labs/zentrun)** - ⭐ 32
   Prompt-driven automation platform - Transform natural language into executable workflows

183. **[yes-ue-mcp](https://github.com/softdaddy-o/yes-ue-mcp)** - ⭐ 31
   Native C++ Model Context Protocol (MCP) plugin for Unreal Engine 5.4+

184. **[shebe](https://github.com/shebe-oss/shebe)** - ⭐ 30
   Fast BM25 full-text search for code repositories with MCP integration for AI coding agents.

185. **[hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298](https://github.com/LinkedInLearning/hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298)** - ⭐ 29
...
186. **[awesome-mcp-list](https://github.com/notedit/awesome-mcp-list)** - ⭐ 28
   Awesome Model Context Protocol Service List

187. **[adk-mcp-gemma3](https://github.com/arjunprabhulal/adk-mcp-gemma3)** - ⭐ 27
   Build AI Agent using Google ADK , MCP and Gemma 3 model

188. **[shebe](https://github.com/rhobimd-oss/shebe)** - ⭐ 26
   Fast BM25 full-text search for code repositories with MCP integration for AI coding agents.

189. **[codai](https://github.com/codai-agent/codai)** - ⭐ 24
...
190. **[minime-mcp](https://github.com/manujbawa/minime-mcp)** - ⭐ 21
...
191. **[cursor-like-pro](https://github.com/gifflet/cursor-like-pro)** - ⭐ 17
   Cursor IDE like Pro

192. **[MCPStack](https://github.com/MCP-Pipeline/MCPStack)** - ⭐ 16
   Stack & Orchestrate MCP Tools — The Scikit-Learn-Pipeline Way , For LLMs

193. **[mcp-labs](https://github.com/thangchung/mcp-labs)** - ⭐ 16
   All things about MCP experiments.⭐️ Star to support our work!

194. **[n8n-operator](https://github.com/jakub-k-slys/n8n-operator)** - ⭐ 15
   Kubernetes Operator for N8n, a fair-code workflow automation platform with native AI capabilities.

195. **[ai-agents](https://github.com/rjmurillo/ai-agents)** - ⭐ 14
   Multi-agent system for software development

196. **[ai-tools](https://github.com/elsejj/ai-tools)** - ⭐ 14
   ai-tools  call your llm based tools through shortcut (ctrl-q) in any application

197. **[pic-standard](https://github.com/madeinplutofabio/pic-standard)** - ⭐ 14
   The industry standard for Provenance & Intent Contracts (PIC) in Agentic AI. Bridging the Causal Gap in autonomous systems.

198. **[feather_wand_agent](https://github.com/QAInsights/feather_wand_agent)** - ⭐ 13
...
199. **[mkinf-run](https://github.com/mkinf-io/mkinf-run)** - ⭐ 13
   mkinf run API

200. **[codectx](https://github.com/hey-granth/codectx)** - ⭐ 13
...
201. **[Unity-AI-Tools-Template](https://github.com/IvanMurzak/Unity-AI-Tools-Template)** - ⭐ 12
   Unity MCP Tool template project

202. **[mcp-tools](https://github.com/shaharia-lab/mcp-tools)** - ⭐ 11
   Tools for MCP (Model Context Protocol) written in Go

203. **[claude-colony](https://github.com/MakingJamie/claude-colony)** - ⭐ 10
...
1. **[YC-Killer](https://github.com/sahibzada-allahyar/YC-Killer)** - ⭐ 2,680
...
1. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 9,825
...
2. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 7,546
   Specification and documentation for the Model Context Protocol

3. **[jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)** - ⭐ 1,944
...
4. **[LLM-Agents-Ecosystem-Handbook](https://github.com/oxbshw/LLM-Agents-Ecosystem-Handbook)** - ⭐ 498
